/*
       ...
       Generated on: July 3, 2017 14:54:3.99
...
public final  class a207_pc01_user_mst_chk extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      /* Execute user subroutine: S14154 */
      S14154 ();
      if ( returnInSub )
      {
      }
   ...
   public void S1173( )
   {
      ...
      while ( AV20W_CHK_NO <= 5 )
      {
         ...
         if ( AV20W_CHK_NO == 1 )
         {
            ...
            AV16W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_kbn( ((GXutil.strcmp(AV13P_BC_USER_MST.GetMode(), "INS")==0) ? "STR_ALPNUM" : "STR") );
            AV16W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_nulls( (byte)(1) );
            AV16W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_byte( (short)(200) );
         }
         else if ( AV20W_CHK_NO == 2 )
         {
            ...
            AV16W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_kbn( "STR_ALPNUM" );
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S16179 */
                  S16179 ();
                  if ( returnInSub )
                  {
                     returnInSub = true;
