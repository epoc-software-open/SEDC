/*
       ...
       Generated on: July 3, 2017 14:52:30.43
...
public final  class b805_pc01_work_del extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A596TBW01_APP_ID = P003R2_A596TBW01_APP_ID[0] ;
         A595TBW01_SESSION_ID = P003R2_A595TBW01_SESSION_ID[0] ;
         A597TBW01_DISP_DATETIME = P003R2_A597TBW01_DISP_DATETIME[0] ;
         A598TBW01_LINE_NO = P003R2_A598TBW01_LINE_NO[0] ;
         /* Using cursor P003R3 */
   ...
   public void initialize( )
   {
      ...
      A595TBW01_SESSION_ID = "" ;
      A596TBW01_APP_ID = "" ;
      P003R2_A596TBW01_APP_ID = new String[] {""} ;
      P003R2_A595TBW01_SESSION_ID = new String[] {""} ;
      P003R2_A597TBW01_DISP_DATETIME = new String[] {""} ;
      P003R2_A598TBW01_LINE_NO = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b805_pc01_work_del__default(),
         new Object[] {
             new Object[] {
            P003R2_A596TBW01_APP_ID, P003R2_A595TBW01_SESSION_ID, P003R2_A597TBW01_DISP_DATETIME, P003R2_A598TBW01_LINE_NO
            }
            , new Object[] {
            }
         }
   ...
   private String[] P003R2_A596TBW01_APP_ID ;
   private String[] P003R2_A595TBW01_SESSION_ID ;
   private String[] P003R2_A597TBW01_DISP_DATETIME ;
   private long[] P003R2_A598TBW01_LINE_NO ;
...
{
   protected Object[] conditional_P003R2( com.genexus.internet.HttpContext httpContext ,
                                          String AV9P_APP_ID ,
                                          String A597TBW01_DISP_DATETIME ,
                                          String AV12W_DISP_DATETIME ,
                                          String A595TBW01_SESSION_ID ,
                                          String AV15W_SESSION_ID ,
                                          String A596TBW01_APP_ID ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P003R2(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P003R2", "scmdbuf",true, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
         ,new UpdateCursor("P003R3", "DELETE FROM `TBW01_FREE_WORK`  WHERE `TBW01_SESSION_ID` = ? AND `TBW01_APP_ID` = ? AND `TBW01_DISP_DATETIME` = ? AND `TBW01_LINE_NO` = ?", GX_NOMASK + GX_MASKLOOPLOCK)
      };
   }
