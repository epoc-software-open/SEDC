...
public final  class SdtTBT12_CRF_RESULT extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( long AV315TBT12_STUDY_ID ,
                     int AV316TBT12_SUBJECT_ID ,
                     short AV317TBT12_CRF_ID ,
                     String AV318TBT12_CRF_ITEM_GRP_DIV ,
                     String AV319TBT12_CRF_ITEM_GRP_CD )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {new Long(AV315TBT12_STUDY_ID),new Integer(AV316TBT12_SUBJECT_ID),new Short(AV317TBT12_CRF_ID),AV318TBT12_CRF_ITEM_GRP_DIV,AV319TBT12_CRF_ITEM_GRP_CD});
   }
   ...
   public void tojson( )
   {
      AddObjectProperty("TBT12_STUDY_ID", gxTv_SdtTBT12_CRF_RESULT_Tbt12_study_id);
      AddObjectProperty("TBT12_SUBJECT_ID", gxTv_SdtTBT12_CRF_RESULT_Tbt12_subject_id);
      AddObjectProperty("TBT12_CRF_ID", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crf_id);
      AddObjectProperty("TBT12_CRF_ITEM_GRP_DIV", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crf_item_grp_div);
      AddObjectProperty("TBT12_CRF_ITEM_GRP_CD", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crf_item_grp_cd);
      AddObjectProperty("TBT12_CRF_VALUE", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crf_value);
      AddObjectProperty("TBT12_EDIT_FLG", gxTv_SdtTBT12_CRF_RESULT_Tbt12_edit_flg);
      AddObjectProperty("TBT12_DEL_FLG", gxTv_SdtTBT12_CRF_RESULT_Tbt12_del_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT12_CRT_DATETIME", sDateCnv);
      AddObjectProperty("TBT12_CRT_USER_ID", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_user_id);
      AddObjectProperty("TBT12_CRT_PROG_NM", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_prog_nm);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT12_UPD_DATETIME", sDateCnv);
      AddObjectProperty("TBT12_UPD_USER_ID", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_user_id);
      AddObjectProperty("TBT12_UPD_PROG_NM", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_prog_nm);
      AddObjectProperty("TBT12_UPD_CNT", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_cnt);
      AddObjectProperty("Mode", gxTv_SdtTBT12_CRF_RESULT_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTBT12_CRF_RESULT_Initialized);
      AddObjectProperty("TBT12_STUDY_ID_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_study_id_Z);
      AddObjectProperty("TBT12_SUBJECT_ID_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_subject_id_Z);
      AddObjectProperty("TBT12_CRF_ID_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crf_id_Z);
      AddObjectProperty("TBT12_CRF_ITEM_GRP_DIV_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crf_item_grp_div_Z);
      AddObjectProperty("TBT12_CRF_ITEM_GRP_CD_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crf_item_grp_cd_Z);
      AddObjectProperty("TBT12_CRF_VALUE_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crf_value_Z);
      AddObjectProperty("TBT12_EDIT_FLG_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_edit_flg_Z);
      AddObjectProperty("TBT12_DEL_FLG_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_del_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT12_CRT_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBT12_CRT_USER_ID_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_user_id_Z);
      AddObjectProperty("TBT12_CRT_PROG_NM_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_prog_nm_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT12_UPD_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBT12_UPD_USER_ID_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_user_id_Z);
      AddObjectProperty("TBT12_UPD_PROG_NM_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_prog_nm_Z);
      AddObjectProperty("TBT12_UPD_CNT_Z", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_cnt_Z);
      AddObjectProperty("TBT12_CRF_VALUE_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crf_value_N);
      AddObjectProperty("TBT12_EDIT_FLG_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_edit_flg_N);
      AddObjectProperty("TBT12_DEL_FLG_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_del_flg_N);
      AddObjectProperty("TBT12_CRT_DATETIME_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_datetime_N);
      AddObjectProperty("TBT12_CRT_USER_ID_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_user_id_N);
      AddObjectProperty("TBT12_CRT_PROG_NM_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_crt_prog_nm_N);
      AddObjectProperty("TBT12_UPD_DATETIME_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_datetime_N);
      AddObjectProperty("TBT12_UPD_USER_ID_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_user_id_N);
      AddObjectProperty("TBT12_UPD_PROG_NM_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_prog_nm_N);
      AddObjectProperty("TBT12_UPD_CNT_N", gxTv_SdtTBT12_CRF_RESULT_Tbt12_upd_cnt_N);
   }
