...
public final  class appmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm012( )
   {
      ...
      httpContext.AddJavascriptSource("appmasterpage.js", "?14573576");
   ...
   public void e12012( )
   {
      /* Refresh Routine */
      /* Object Property */
      if ( GXutil.strcmp(WebComp_Wcrecentlinks_Component, "RecentLinks") != 0 )
      {
      ...
      if ( GXutil.strcmp(OldWcrecentlinks, WebComp_Wcrecentlinks_Component) != 0 )
      {
         WebComp_Wcrecentlinks.setjustcreated();
      }
      if ( GXutil.len( WebComp_Wcrecentlinks_Component) != 0 )
      {
         WebComp_Wcrecentlinks.componentprepare(new Object[] {"MPW0034","",getDataAreaObject().getForm().getCaption(),Contentholder.getPgmname()});
   ...
   public void wb_table10_61_012( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         GxWebStd.gx_table_start( httpContext, tblTable10_Internalname, tblTable10_Internalname, "", "HorizontalLine", 0, "", "", 0, 0, sStyleString, "", 0);
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table8_54_012( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr align=\"left\" >") ;
         httpContext.writeText( "<td style=\"text-align:"+httpContext.getCssProperty( "Align", "center")+"\">") ;
         /* Text block */
         ClassString = "SmallText" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock1_Internalname, "Footer Info", "", "", lblTextblock1_Jsonclick, "E_MPAGE.", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_AppMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table6_48_012( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         GxWebStd.gx_table_start( httpContext, tblTable7_Internalname, tblTable7_Internalname, "", "HorizontalLine", 0, "", "", 0, 0, sStyleString, "", 0);
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table3_18_012( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblHome_Internalname, "Home", "", "", lblHome_Jsonclick, "E_MPAGE.", StyleString, ClassString, 0, "", lblHome_Visible, 1, (short)(0), "HLP_AppMasterPage.htm");
         httpContext.writeText( "&nbsp; ") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblFirsttext_Internalname, "First Option", "", "", lblFirsttext_Jsonclick, "E_MPAGE.", StyleString, ClassString, 0, "", lblFirsttext_Visible, 1, (short)(0), "HLP_AppMasterPage.htm");
         httpContext.writeText( "&nbsp; ") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblSecondtext_Internalname, "Second Option", "", "", lblSecondtext_Jsonclick, "E_MPAGE.", StyleString, ClassString, 0, "", lblSecondtext_Visible, 1, (short)(0), "HLP_AppMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblThirdtext_Internalname, "Third Option", "", "", lblThirdtext_Jsonclick, "E_MPAGE.", StyleString, ClassString, 0, "", lblThirdtext_Visible, 1, (short)(0), "HLP_AppMasterPage.htm");
         httpContext.writeText( "&nbsp; ") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblFourthtext_Internalname, "Fourth Option", "", "", lblFourthtext_Jsonclick, "E_MPAGE.", StyleString, ClassString, 0, "", lblFourthtext_Visible, 1, (short)(0), "HLP_AppMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblFifthtext_Internalname, "Last One", "", "", lblFifthtext_Jsonclick, "E_MPAGE.", StyleString, ClassString, 0, "", lblFifthtext_Visible, 1, (short)(0), "HLP_AppMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table2_5_012( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_topl_Internalname, context.getHttpContext().getImagePath( "caf107ad-650e-4e3c-a4ba-1196d220603b", "", "Modern"), "", "", "", "Modern", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_AppMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"td10px\" >") ;
         ...
         ClassString = "ImageTopHeader" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_topr_Internalname, context.getHttpContext().getImagePath( "c7e6c81f-bebf-4d28-b5cd-decdcb627b0a", "", "Modern"), "", "", "", "Modern", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_AppMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblockheader1_Internalname, "Application Header", "", "", lblTextblockheader1_Jsonclick, "E_MPAGE.", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_AppMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"text-align:"+httpContext.getCssProperty( "Align", "right")+"\">") ;
         /* Static images/pictures */
         ClassString = "HeaderImage1" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgImage1_Internalname, context.getHttpContext().getImagePath( "7326b96a-20b7-4973-8d71-35094049767d", "", "Modern"), "", "", "", "Modern", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_AppMasterPage.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   {
      httpContext.AddThemeStyleSheetFile("", "Modern.css", "?14455013");
      if ( ! ( WebComp_Wcrecentlinks == null ) )
      {
         if ( GXutil.len( WebComp_Wcrecentlinks_Component) != 0 )
         {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( getDataAreaObject().getForm().getJscriptsrc().item(idxLst)), "?14573593");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   {
      httpContext.AddJavascriptSource("appmasterpage.js", "?14573593");
