...
public final  class SdtTBM07_AUTH_BEHAVIOR extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( String AV530TBM07_AUTH_CD )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {AV530TBM07_AUTH_CD});
   }
   ...
   public void tojson( )
   {
      AddObjectProperty("TBM07_AUTH_CD", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_auth_cd);
      AddObjectProperty("TBM07_CRF_INP_AUTH_FLG", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crf_inp_auth_flg);
      AddObjectProperty("TBM07_CRF_EDIT_AUTH_FLG", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crf_edit_auth_flg);
      AddObjectProperty("TBM07_OTHER_SITE_VIEW_FLG", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_other_site_view_flg);
      AddObjectProperty("TBM07_DEL_FLG", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_del_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM07_CRT_DATETIME", sDateCnv);
      AddObjectProperty("TBM07_CRT_USER_ID", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_user_id);
      AddObjectProperty("TBM07_CRT_PROG_NM", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_prog_nm);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM07_UPD_DATETIME", sDateCnv);
      AddObjectProperty("TBM07_UPD_USER_ID", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_user_id);
      AddObjectProperty("TBM07_UPD_PROG_NM", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_prog_nm);
      AddObjectProperty("TBM07_UPD_CNT", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_cnt);
      AddObjectProperty("Mode", gxTv_SdtTBM07_AUTH_BEHAVIOR_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTBM07_AUTH_BEHAVIOR_Initialized);
      AddObjectProperty("TBM07_AUTH_CD_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_auth_cd_Z);
      AddObjectProperty("TBM07_CRF_INP_AUTH_FLG_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crf_inp_auth_flg_Z);
      AddObjectProperty("TBM07_CRF_EDIT_AUTH_FLG_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crf_edit_auth_flg_Z);
      AddObjectProperty("TBM07_OTHER_SITE_VIEW_FLG_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_other_site_view_flg_Z);
      AddObjectProperty("TBM07_DEL_FLG_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_del_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM07_CRT_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM07_CRT_USER_ID_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_user_id_Z);
      AddObjectProperty("TBM07_CRT_PROG_NM_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_prog_nm_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM07_UPD_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM07_UPD_USER_ID_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_user_id_Z);
      AddObjectProperty("TBM07_UPD_PROG_NM_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_prog_nm_Z);
      AddObjectProperty("TBM07_UPD_CNT_Z", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_cnt_Z);
      AddObjectProperty("TBM07_CRF_INP_AUTH_FLG_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crf_inp_auth_flg_N);
      AddObjectProperty("TBM07_CRF_EDIT_AUTH_FLG_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crf_edit_auth_flg_N);
      AddObjectProperty("TBM07_OTHER_SITE_VIEW_FLG_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_other_site_view_flg_N);
      AddObjectProperty("TBM07_DEL_FLG_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_del_flg_N);
      AddObjectProperty("TBM07_CRT_DATETIME_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_datetime_N);
      AddObjectProperty("TBM07_CRT_USER_ID_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_user_id_N);
      AddObjectProperty("TBM07_CRT_PROG_NM_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_crt_prog_nm_N);
      AddObjectProperty("TBM07_UPD_DATETIME_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_datetime_N);
      AddObjectProperty("TBM07_UPD_USER_ID_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_user_id_N);
      AddObjectProperty("TBM07_UPD_PROG_NM_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_prog_nm_N);
      AddObjectProperty("TBM07_UPD_CNT_N", gxTv_SdtTBM07_AUTH_BEHAVIOR_Tbm07_upd_cnt_N);
   }
