/*
       ...
       Generated on: July 3, 2017 14:52:37.92
...
public final  class b599_pc25_auth_ptn_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A18TAM04_DEL_FLG = P004M2_A18TAM04_DEL_FLG[0] ;
         n18TAM04_DEL_FLG = P004M2_n18TAM04_DEL_FLG[0] ;
         A17TAM04_AUTH_CD = P004M2_A17TAM04_AUTH_CD[0] ;
         A99TAM04_UPD_CNT = P004M2_A99TAM04_UPD_CNT[0] ;
         n99TAM04_UPD_CNT = P004M2_n99TAM04_UPD_CNT[0] ;
         A42TAM04_UPD_PROG_NM = P004M2_A42TAM04_UPD_PROG_NM[0] ;
         n42TAM04_UPD_PROG_NM = P004M2_n42TAM04_UPD_PROG_NM[0] ;
         A79TAM04_UPD_USER_ID = P004M2_A79TAM04_UPD_USER_ID[0] ;
         n79TAM04_UPD_USER_ID = P004M2_n79TAM04_UPD_USER_ID[0] ;
         A41TAM04_UPD_DATETIME = P004M2_A41TAM04_UPD_DATETIME[0] ;
         n41TAM04_UPD_DATETIME = P004M2_n41TAM04_UPD_DATETIME[0] ;
         A40TAM04_CRT_PROG_NM = P004M2_A40TAM04_CRT_PROG_NM[0] ;
         n40TAM04_CRT_PROG_NM = P004M2_n40TAM04_CRT_PROG_NM[0] ;
         A78TAM04_CRT_USER_ID = P004M2_A78TAM04_CRT_USER_ID[0] ;
         n78TAM04_CRT_USER_ID = P004M2_n78TAM04_CRT_USER_ID[0] ;
         A39TAM04_CRT_DATETIME = P004M2_A39TAM04_CRT_DATETIME[0] ;
         n39TAM04_CRT_DATETIME = P004M2_n39TAM04_CRT_DATETIME[0] ;
         A601TAM04_AUTH_LVL = P004M2_A601TAM04_AUTH_LVL[0] ;
         n601TAM04_AUTH_LVL = P004M2_n601TAM04_AUTH_LVL[0] ;
         A98TAM04_AUTH_NM = P004M2_A98TAM04_AUTH_NM[0] ;
         n98TAM04_AUTH_NM = P004M2_n98TAM04_AUTH_NM[0] ;
         AV20GXLvl31 = (byte)(1) ;
         GXt_char1 = AV13W_STR ;
         GXv_char2[0] = GXt_char1 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A17TAM04_AUTH_CD, GXv_char2) ;
         b599_pc25_auth_ptn_res.this.GXt_char1 = GXv_char2[0] ;
         GXt_char3 = AV13W_STR ;
         GXv_char4[0] = GXt_char3 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A98TAM04_AUTH_NM, GXv_char4) ;
         b599_pc25_auth_ptn_res.this.GXt_char3 = GXv_char4[0] ;
         GXt_char5 = AV13W_STR ;
         GXv_char6[0] = GXt_char5 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A18TAM04_DEL_FLG, GXv_char6) ;
         b599_pc25_auth_ptn_res.this.GXt_char5 = GXv_char6[0] ;
         GXt_char7 = AV13W_STR ;
         GXv_char8[0] = GXt_char7 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A39TAM04_CRT_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char8) ;
         b599_pc25_auth_ptn_res.this.GXt_char7 = GXv_char8[0] ;
         GXt_char9 = AV13W_STR ;
         GXv_char10[0] = GXt_char9 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A78TAM04_CRT_USER_ID, GXv_char10) ;
         b599_pc25_auth_ptn_res.this.GXt_char9 = GXv_char10[0] ;
         GXt_char11 = AV13W_STR ;
         GXv_char12[0] = GXt_char11 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A40TAM04_CRT_PROG_NM, GXv_char12) ;
         b599_pc25_auth_ptn_res.this.GXt_char11 = GXv_char12[0] ;
         GXt_char13 = AV13W_STR ;
         GXv_char14[0] = GXt_char13 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A41TAM04_UPD_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char14) ;
         b599_pc25_auth_ptn_res.this.GXt_char13 = GXv_char14[0] ;
         GXt_char15 = AV13W_STR ;
         GXv_char16[0] = GXt_char15 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A79TAM04_UPD_USER_ID, GXv_char16) ;
         b599_pc25_auth_ptn_res.this.GXt_char15 = GXv_char16[0] ;
         GXt_char17 = AV13W_STR ;
         GXv_char18[0] = GXt_char17 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A42TAM04_UPD_PROG_NM, GXv_char18) ;
         b599_pc25_auth_ptn_res.this.GXt_char17 = GXv_char18[0] ;
         AV13W_STR = GXt_char1 + "," + GXt_char3 + "," + GXutil.trim( GXutil.str( A601TAM04_AUTH_LVL, 10, 0)) + "," + GXt_char5 + "," + GXt_char7 + "," + GXt_char9 + "," + GXt_char11 + "," + GXt_char13 + "," + GXt_char15 + "," + GXt_char17 + "," + GXutil.trim( GXutil.str( A99TAM04_UPD_CNT, 10, 0)) ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P004M2_A18TAM04_DEL_FLG = new String[] {""} ;
      P004M2_n18TAM04_DEL_FLG = new boolean[] {false} ;
      P004M2_A17TAM04_AUTH_CD = new String[] {""} ;
      P004M2_A99TAM04_UPD_CNT = new long[1] ;
      P004M2_n99TAM04_UPD_CNT = new boolean[] {false} ;
      P004M2_A42TAM04_UPD_PROG_NM = new String[] {""} ;
      P004M2_n42TAM04_UPD_PROG_NM = new boolean[] {false} ;
      P004M2_A79TAM04_UPD_USER_ID = new String[] {""} ;
      P004M2_n79TAM04_UPD_USER_ID = new boolean[] {false} ;
      P004M2_A41TAM04_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P004M2_n41TAM04_UPD_DATETIME = new boolean[] {false} ;
      P004M2_A40TAM04_CRT_PROG_NM = new String[] {""} ;
      P004M2_n40TAM04_CRT_PROG_NM = new boolean[] {false} ;
      P004M2_A78TAM04_CRT_USER_ID = new String[] {""} ;
      P004M2_n78TAM04_CRT_USER_ID = new boolean[] {false} ;
      P004M2_A39TAM04_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P004M2_n39TAM04_CRT_DATETIME = new boolean[] {false} ;
      P004M2_A601TAM04_AUTH_LVL = new byte[1] ;
      P004M2_n601TAM04_AUTH_LVL = new boolean[] {false} ;
      P004M2_A98TAM04_AUTH_NM = new String[] {""} ;
      P004M2_n98TAM04_AUTH_NM = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc25_auth_ptn_res__default(),
         new Object[] {
             new Object[] {
            P004M2_A18TAM04_DEL_FLG, P004M2_n18TAM04_DEL_FLG, P004M2_A17TAM04_AUTH_CD, P004M2_A99TAM04_UPD_CNT, P004M2_n99TAM04_UPD_CNT, P004M2_A42TAM04_UPD_PROG_NM, P004M2_n42TAM04_UPD_PROG_NM, P004M2_A79TAM04_UPD_USER_ID, P004M2_n79TAM04_UPD_USER_ID, P004M2_A41TAM04_UPD_DATETIME,
            P004M2_n41TAM04_UPD_DATETIME, P004M2_A40TAM04_CRT_PROG_NM, P004M2_n40TAM04_CRT_PROG_NM, P004M2_A78TAM04_CRT_USER_ID, P004M2_n78TAM04_CRT_USER_ID, P004M2_A39TAM04_CRT_DATETIME, P004M2_n39TAM04_CRT_DATETIME, P004M2_A601TAM04_AUTH_LVL, P004M2_n601TAM04_AUTH_LVL, P004M2_A98TAM04_AUTH_NM,
            P004M2_n98TAM04_AUTH_NM
            }
         }
      );
   ...
   private String[] P004M2_A18TAM04_DEL_FLG ;
   private boolean[] P004M2_n18TAM04_DEL_FLG ;
   private String[] P004M2_A17TAM04_AUTH_CD ;
   private long[] P004M2_A99TAM04_UPD_CNT ;
   private boolean[] P004M2_n99TAM04_UPD_CNT ;
   private String[] P004M2_A42TAM04_UPD_PROG_NM ;
   private boolean[] P004M2_n42TAM04_UPD_PROG_NM ;
   private String[] P004M2_A79TAM04_UPD_USER_ID ;
   private boolean[] P004M2_n79TAM04_UPD_USER_ID ;
   private java.util.Date[] P004M2_A41TAM04_UPD_DATETIME ;
   private boolean[] P004M2_n41TAM04_UPD_DATETIME ;
   private String[] P004M2_A40TAM04_CRT_PROG_NM ;
   private boolean[] P004M2_n40TAM04_CRT_PROG_NM ;
   private String[] P004M2_A78TAM04_CRT_USER_ID ;
   private boolean[] P004M2_n78TAM04_CRT_USER_ID ;
   private java.util.Date[] P004M2_A39TAM04_CRT_DATETIME ;
   private boolean[] P004M2_n39TAM04_CRT_DATETIME ;
   private byte[] P004M2_A601TAM04_AUTH_LVL ;
   private boolean[] P004M2_n601TAM04_AUTH_LVL ;
   private String[] P004M2_A98TAM04_AUTH_NM ;
   private boolean[] P004M2_n98TAM04_AUTH_NM ;
...
{
   protected Object[] conditional_P004M2( com.genexus.internet.HttpContext httpContext ,
                                          String AV9P_AUTH_CD ,
                                          String A17TAM04_AUTH_CD ,
                                          String A18TAM04_DEL_FLG )
   {
      String sWhereString = "" ;
      String scmdbuf ;
      byte[] GXv_int21 ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P004M2(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P004M2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
