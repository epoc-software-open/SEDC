/*
       ...
       Generated on: July 3, 2017 14:51:51.45
...
public final  class ab502_pc01_down_crf_impl extends GXWebProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV25W_EXTRA_INFO", AV25W_EXTRA_INFO);
      ...
      /* Execute user subroutine: S14211 */
      S14211 ();
      if ( returnInSub )
      {
         returnInSub = true;
      ...
      /* Execute user subroutine: S15227 */
      S15227 ();
      if ( returnInSub )
      {
      }
   ...
   public void S13136( )
   {
      ...
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV30W_PARMS_ITEM", AV30W_PARMS_ITEM);
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S16246 */
                  S16246 ();
                  if ( returnInSub )
                  {
                     returnInSub = true;
