...
public final  class a105_wp03_error_impl extends GXWebPanel
{
   public a105_wp03_error_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public a105_wp03_error_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( a105_wp03_error_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeText( "共通エラー画面（DB停止中）") ;
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("a105_wp03_error") +"\" class=\""+"Form"+"\">") ;
   ...
   public void wb_table1_2_062e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
   ...
   public void start062( )
   {
      ...
      Form.getMeta().addItem("Description", "共通エラー画面（DB停止中）", (short)(0)) ;
      httpContext.wjLoc = "" ;
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         OldWebcomp2 = httpContext.cgiGet( "W0028") ;
         if ( (GXutil.strcmp("", WebComp_Webcomp2_Component)==0) && ! (GXutil.strcmp("", OldWebcomp2)==0) )
         {
            WebComp_Webcomp2 = WebUtils.getWebComponent(getClass(), "" + OldWebcomp2 + "_impl", remoteHandle, context);
            WebComp_Webcomp2_Component = OldWebcomp2 ;
            WebComp_Webcomp2.componentrestorestate("W0028", "");
         }
      }
      wbErr = false ;
      strup060( ) ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               else if ( GXutil.strcmp(sEvtType, "W") == 0 )
               {
                  ...
                  else if ( nCmpId == 28 )
                  {
                     ...
                     {
                        WebComp_Webcomp2.componentprocess("W0028", "", sEvt);
                     }
                     WebComp_Webcomp2_Component = OldWebcomp2 ;
                  }
               }
   ...
   public void e11062( )
   {
      ...
      if ( GXutil.len( WebComp_Webcomp2_Component) != 0 )
      {
         WebComp_Webcomp2.componentprepare(new Object[] {"W0028",""});
   ...
   {
      /* Refresh Routine */
      lblTbl_errmsg_Caption = "システムへの接続ができません。<br>" ;
      httpContext.ajax_rsp_assign_prop("", false, lblTbl_errmsg_Internalname, "Caption", lblTbl_errmsg_Caption);
      lblTbl_errmsg_Caption = lblTbl_errmsg_Caption+"現在、システムのメンテナンス中の可能性があります。<br>" ;
      httpContext.ajax_rsp_assign_prop("", false, lblTbl_errmsg_Internalname, "Caption", lblTbl_errmsg_Caption);
      lblTbl_errmsg_Caption = lblTbl_errmsg_Caption+"（AM3:00 ～ AM4:00の間にメンテナンスのために停止<br>" ;
      httpContext.ajax_rsp_assign_prop("", false, lblTbl_errmsg_Internalname, "Caption", lblTbl_errmsg_Caption);
      lblTbl_errmsg_Caption = lblTbl_errmsg_Caption+"することがあります）<br>" ;
      httpContext.ajax_rsp_assign_prop("", false, lblTbl_errmsg_Internalname, "Caption", lblTbl_errmsg_Caption);
      lblTbl_errmsg_Caption = lblTbl_errmsg_Caption+"上記時間帯以外でこの画面が表示される場合などは<br>" ;
      httpContext.ajax_rsp_assign_prop("", false, lblTbl_errmsg_Internalname, "Caption", lblTbl_errmsg_Caption);
      lblTbl_errmsg_Caption = lblTbl_errmsg_Caption+"お問い合わせ頂けますようお願い致します。" ;
      httpContext.ajax_rsp_assign_prop("", false, lblTbl_errmsg_Internalname, "Caption", lblTbl_errmsg_Caption);
   }
   ...
   public void wb_table1_2_062( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table2_5_062( true) ;
      }
      else
      {
         wb_table2_5_062( false) ;
      }
      return  ;
   }

   public void wb_table2_5_062e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void wb_table2_5_062( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table3_9_062( true) ;
      }
      else
      {
         wb_table3_9_062( false) ;
      }
      return  ;
   }

   public void wb_table3_9_062e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_5_062e( true) ;
      }
      else
      {
         wb_table2_5_062e( false) ;
      }
   }

   public void wb_table3_9_062( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table4_17_062( true) ;
      }
      else
      {
         wb_table4_17_062( false) ;
      }
      return  ;
   }

   public void wb_table4_17_062e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<td>") ;
         /* WebComponent */
         GxWebStd.gx_hidden_field( httpContext, "W0028"+"", GXutil.rtrim( WebComp_Webcomp2_Component));
         httpContext.writeText( "<div") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_9_062e( true) ;
      }
      else
      {
         wb_table3_9_062e( false) ;
      }
   }

   public void wb_table4_17_062( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_none_Internalname, GXutil.rtrim( AV7D_NONE), GXutil.rtrim( localUtil.format( AV7D_NONE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(20);\"", "", "", "", "", edtavD_none_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A105_WP03_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\"text-align:"+httpContext.getCssProperty( "Align", "center")+"\">") ;
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTbl_errmsg_Internalname, lblTbl_errmsg_Caption, "", "", lblTbl_errmsg_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(1), "HLP_A105_WP03_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_17_062e( true) ;
      }
      else
      {
         wb_table4_17_062e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?14573699");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a105_wp03_error.js", "?14573699");
