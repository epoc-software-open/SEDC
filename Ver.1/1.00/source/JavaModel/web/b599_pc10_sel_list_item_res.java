/*
       ...
       Generated on: July 3, 2017 14:51:58.62
...
public final  class b599_pc10_sel_list_item_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      pr_default.dynParam(0, new Object[]{ new Object[]{
                                           ...
                                           AV9P_LIST_ITEM_NO ,
                                           A447TBM26_LIST_CD ,
                                           new Short(A448TBM26_LIST_ITEM_NO) ,
                                           new Short(AV11W_LIST_ITEM_NO) ,
                                           A451TBM26_DEL_FLG ,
                                           new Long(AV10P_STUDY_ID) ,
                                           new Long(A446TBM26_STUDY_ID) },
                                           new int[] {
      ...
      {
         A451TBM26_DEL_FLG = P00242_A451TBM26_DEL_FLG[0] ;
         n451TBM26_DEL_FLG = P00242_n451TBM26_DEL_FLG[0] ;
         A448TBM26_LIST_ITEM_NO = P00242_A448TBM26_LIST_ITEM_NO[0] ;
         A447TBM26_LIST_CD = P00242_A447TBM26_LIST_CD[0] ;
         A446TBM26_STUDY_ID = P00242_A446TBM26_STUDY_ID[0] ;
         A458TBM26_UPD_CNT = P00242_A458TBM26_UPD_CNT[0] ;
         n458TBM26_UPD_CNT = P00242_n458TBM26_UPD_CNT[0] ;
         A457TBM26_UPD_PROG_NM = P00242_A457TBM26_UPD_PROG_NM[0] ;
         n457TBM26_UPD_PROG_NM = P00242_n457TBM26_UPD_PROG_NM[0] ;
         A456TBM26_UPD_USER_ID = P00242_A456TBM26_UPD_USER_ID[0] ;
         n456TBM26_UPD_USER_ID = P00242_n456TBM26_UPD_USER_ID[0] ;
         A455TBM26_UPD_DATETIME = P00242_A455TBM26_UPD_DATETIME[0] ;
         n455TBM26_UPD_DATETIME = P00242_n455TBM26_UPD_DATETIME[0] ;
         A454TBM26_CRT_PROG_NM = P00242_A454TBM26_CRT_PROG_NM[0] ;
         n454TBM26_CRT_PROG_NM = P00242_n454TBM26_CRT_PROG_NM[0] ;
         A453TBM26_CRT_USER_ID = P00242_A453TBM26_CRT_USER_ID[0] ;
         n453TBM26_CRT_USER_ID = P00242_n453TBM26_CRT_USER_ID[0] ;
         A452TBM26_CRT_DATETIME = P00242_A452TBM26_CRT_DATETIME[0] ;
         n452TBM26_CRT_DATETIME = P00242_n452TBM26_CRT_DATETIME[0] ;
         A450TBM26_INNER_VALUE = P00242_A450TBM26_INNER_VALUE[0] ;
         n450TBM26_INNER_VALUE = P00242_n450TBM26_INNER_VALUE[0] ;
         A449TBM26_LIST_ITEM_NAME = P00242_A449TBM26_LIST_ITEM_NAME[0] ;
         n449TBM26_LIST_ITEM_NAME = P00242_n449TBM26_LIST_ITEM_NAME[0] ;
         AV22GXLvl33 = (byte)(1) ;
         GXt_char1 = AV15W_STR ;
         GXv_char2[0] = GXt_char1 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A447TBM26_LIST_CD, GXv_char2) ;
         b599_pc10_sel_list_item_res.this.GXt_char1 = GXv_char2[0] ;
         GXt_char3 = AV15W_STR ;
         GXv_char4[0] = GXt_char3 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A449TBM26_LIST_ITEM_NAME, GXv_char4) ;
         b599_pc10_sel_list_item_res.this.GXt_char3 = GXv_char4[0] ;
         GXt_char5 = AV15W_STR ;
         GXv_char6[0] = GXt_char5 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A450TBM26_INNER_VALUE, GXv_char6) ;
         b599_pc10_sel_list_item_res.this.GXt_char5 = GXv_char6[0] ;
         GXt_char7 = AV15W_STR ;
         GXv_char8[0] = GXt_char7 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A451TBM26_DEL_FLG, GXv_char8) ;
         b599_pc10_sel_list_item_res.this.GXt_char7 = GXv_char8[0] ;
         GXt_char9 = AV15W_STR ;
         GXv_char10[0] = GXt_char9 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A452TBM26_CRT_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char10) ;
         b599_pc10_sel_list_item_res.this.GXt_char9 = GXv_char10[0] ;
         GXt_char11 = AV15W_STR ;
         GXv_char12[0] = GXt_char11 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A453TBM26_CRT_USER_ID, GXv_char12) ;
         b599_pc10_sel_list_item_res.this.GXt_char11 = GXv_char12[0] ;
         GXt_char13 = AV15W_STR ;
         GXv_char14[0] = GXt_char13 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A454TBM26_CRT_PROG_NM, GXv_char14) ;
         b599_pc10_sel_list_item_res.this.GXt_char13 = GXv_char14[0] ;
         GXt_char15 = AV15W_STR ;
         GXv_char16[0] = GXt_char15 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A455TBM26_UPD_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char16) ;
         b599_pc10_sel_list_item_res.this.GXt_char15 = GXv_char16[0] ;
         GXt_char17 = AV15W_STR ;
         GXv_char18[0] = GXt_char17 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A456TBM26_UPD_USER_ID, GXv_char18) ;
         b599_pc10_sel_list_item_res.this.GXt_char17 = GXv_char18[0] ;
         GXt_char19 = AV15W_STR ;
         GXv_char20[0] = GXt_char19 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A457TBM26_UPD_PROG_NM, GXv_char20) ;
         b599_pc10_sel_list_item_res.this.GXt_char19 = GXv_char20[0] ;
         AV15W_STR = GXutil.trim( GXutil.str( A446TBM26_STUDY_ID, 10, 0)) + "," + GXt_char1 + "," + GXutil.trim( GXutil.str( A448TBM26_LIST_ITEM_NO, 10, 0)) + "," + GXt_char3 + "," + GXt_char5 + "," + GXt_char7 + "," + GXt_char9 + "," + GXt_char11 + "," + GXt_char13 + "," + GXt_char15 + "," + GXt_char17 + "," + GXt_char19 + "," + GXutil.trim( GXutil.str( A458TBM26_UPD_CNT, 10, 0)) ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P00242_A451TBM26_DEL_FLG = new String[] {""} ;
      P00242_n451TBM26_DEL_FLG = new boolean[] {false} ;
      P00242_A448TBM26_LIST_ITEM_NO = new short[1] ;
      P00242_A447TBM26_LIST_CD = new String[] {""} ;
      P00242_A446TBM26_STUDY_ID = new long[1] ;
      P00242_A458TBM26_UPD_CNT = new long[1] ;
      P00242_n458TBM26_UPD_CNT = new boolean[] {false} ;
      P00242_A457TBM26_UPD_PROG_NM = new String[] {""} ;
      P00242_n457TBM26_UPD_PROG_NM = new boolean[] {false} ;
      P00242_A456TBM26_UPD_USER_ID = new String[] {""} ;
      P00242_n456TBM26_UPD_USER_ID = new boolean[] {false} ;
      P00242_A455TBM26_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P00242_n455TBM26_UPD_DATETIME = new boolean[] {false} ;
      P00242_A454TBM26_CRT_PROG_NM = new String[] {""} ;
      P00242_n454TBM26_CRT_PROG_NM = new boolean[] {false} ;
      P00242_A453TBM26_CRT_USER_ID = new String[] {""} ;
      P00242_n453TBM26_CRT_USER_ID = new boolean[] {false} ;
      P00242_A452TBM26_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P00242_n452TBM26_CRT_DATETIME = new boolean[] {false} ;
      P00242_A450TBM26_INNER_VALUE = new String[] {""} ;
      P00242_n450TBM26_INNER_VALUE = new boolean[] {false} ;
      P00242_A449TBM26_LIST_ITEM_NAME = new String[] {""} ;
      P00242_n449TBM26_LIST_ITEM_NAME = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc10_sel_list_item_res__default(),
         new Object[] {
             new Object[] {
            P00242_A451TBM26_DEL_FLG, P00242_n451TBM26_DEL_FLG, P00242_A448TBM26_LIST_ITEM_NO, P00242_A447TBM26_LIST_CD, P00242_A446TBM26_STUDY_ID, P00242_A458TBM26_UPD_CNT, P00242_n458TBM26_UPD_CNT, P00242_A457TBM26_UPD_PROG_NM, P00242_n457TBM26_UPD_PROG_NM, P00242_A456TBM26_UPD_USER_ID,
            P00242_n456TBM26_UPD_USER_ID, P00242_A455TBM26_UPD_DATETIME, P00242_n455TBM26_UPD_DATETIME, P00242_A454TBM26_CRT_PROG_NM, P00242_n454TBM26_CRT_PROG_NM, P00242_A453TBM26_CRT_USER_ID, P00242_n453TBM26_CRT_USER_ID, P00242_A452TBM26_CRT_DATETIME, P00242_n452TBM26_CRT_DATETIME, P00242_A450TBM26_INNER_VALUE,
            P00242_n450TBM26_INNER_VALUE, P00242_A449TBM26_LIST_ITEM_NAME, P00242_n449TBM26_LIST_ITEM_NAME
            }
         }
      );
   ...
   private String[] P00242_A451TBM26_DEL_FLG ;
   private boolean[] P00242_n451TBM26_DEL_FLG ;
   private short[] P00242_A448TBM26_LIST_ITEM_NO ;
   private String[] P00242_A447TBM26_LIST_CD ;
   private long[] P00242_A446TBM26_STUDY_ID ;
   private long[] P00242_A458TBM26_UPD_CNT ;
   private boolean[] P00242_n458TBM26_UPD_CNT ;
   private String[] P00242_A457TBM26_UPD_PROG_NM ;
   private boolean[] P00242_n457TBM26_UPD_PROG_NM ;
   private String[] P00242_A456TBM26_UPD_USER_ID ;
   private boolean[] P00242_n456TBM26_UPD_USER_ID ;
   private java.util.Date[] P00242_A455TBM26_UPD_DATETIME ;
   private boolean[] P00242_n455TBM26_UPD_DATETIME ;
   private String[] P00242_A454TBM26_CRT_PROG_NM ;
   private boolean[] P00242_n454TBM26_CRT_PROG_NM ;
   private String[] P00242_A453TBM26_CRT_USER_ID ;
   private boolean[] P00242_n453TBM26_CRT_USER_ID ;
   private java.util.Date[] P00242_A452TBM26_CRT_DATETIME ;
   private boolean[] P00242_n452TBM26_CRT_DATETIME ;
   private String[] P00242_A450TBM26_INNER_VALUE ;
   private boolean[] P00242_n450TBM26_INNER_VALUE ;
   private String[] P00242_A449TBM26_LIST_ITEM_NAME ;
   private boolean[] P00242_n449TBM26_LIST_ITEM_NAME ;
...
{
   protected Object[] conditional_P00242( com.genexus.internet.HttpContext httpContext ,
                                          String AV8P_LIST_CD ,
                                          String AV9P_LIST_ITEM_NO ,
                                          String A447TBM26_LIST_CD ,
                                          short A448TBM26_LIST_ITEM_NO ,
                                          short AV11W_LIST_ITEM_NO ,
                                          String A451TBM26_DEL_FLG ,
                                          long AV10P_STUDY_ID ,
                                          long A446TBM26_STUDY_ID )
   {
      String sWhereString = "" ;
      String scmdbuf ;
      byte[] GXv_int23 ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00242(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , ((Number) dynConstraints[3]).shortValue() , ((Number) dynConstraints[4]).shortValue() , (String)dynConstraints[5] , ((Number) dynConstraints[6]).longValue() , ((Number) dynConstraints[7]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00242", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
