/*
               File: A205_PC01_SITE_MST_CHK
        Description: é{ê›É}ÉXÉ^ì¸óÕÉ`ÉFÉbÉN
             Author: GeneXus Java Generator version 10_1_8-58720
       Generated on: July 3, 2017 14:54:16.79
...
public final  class a205_pc01_site_mst_chk extends GXProcedure
{
   public a205_pc01_site_mst_chk( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( a205_pc01_site_mst_chk.class ), "" );
   }
   ...
   public GxObjectCollection executeUdp( SdtTAM08_SITE aP0 ,
                                         GxObjectCollection[] aP1 )
   {
      a205_pc01_site_mst_chk.this.AV13P_BC_SITE = aP0;
      a205_pc01_site_mst_chk.this.aP2 = new GxObjectCollection[] {new GxObjectCollection()};
      initialize();
      privateExecute();
      return aP2[0];
   }

   public void execute( SdtTAM08_SITE aP0 ,
                        GxObjectCollection[] aP1 ,
   ...
   private void execute_int( SdtTAM08_SITE aP0 ,
                             GxObjectCollection[] aP1 ,
                             GxObjectCollection[] aP2 )
   {
      a205_pc01_site_mst_chk.this.AV13P_BC_SITE = aP0;
      a205_pc01_site_mst_chk.this.aP1 = aP1;
      a205_pc01_site_mst_chk.this.aP2 = aP2;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      /* Execute user subroutine: S15145 */
      S15145 ();
      if ( returnInSub )
      {
         returnInSub = true;
      ...
      /* Execute user subroutine: S13131 */
      S13131 ();
      if ( returnInSub )
      {
         returnInSub = true;
      ...
      /* Execute user subroutine: S14138 */
      S14138 ();
      if ( returnInSub )
      {
      }
   ...
   public void S1172( )
   {
      ...
      while ( AV19W_CHK_NO <= 4 )
      {
         ...
         if ( AV19W_CHK_NO == 1 )
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TAM08_SITE_ID" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "é{ê›ID" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_str( AV13P_BC_SITE.getgxTv_SdtTAM08_SITE_Tam08_site_id() );
         ...
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TAM08_SITE_NM" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "é{ê›ñº" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_str( AV13P_BC_SITE.getgxTv_SdtTAM08_SITE_Tam08_site_nm() );
         ...
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TAM08_SITE_SNM" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "é{ê›ñº(ó™èÃ)" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_str( AV13P_BC_SITE.getgxTv_SdtTAM08_SITE_Tam08_site_snm() );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_kbn( "STR" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_nulls( (byte)(1) );
         ...
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TAM08_OUTER_SITE_ID" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "äOïîé{ê›ID" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_str( AV13P_BC_SITE.getgxTv_SdtTAM08_SITE_Tam08_outer_site_id() );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_kbn( "STR" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_nulls( (byte)(1) );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_byte( (short)(20) );
         }
   ...
   public void S15145( )
   {
      ...
      a205_pc01_site_mst_chk.this.AV21W_ERRCD = GXv_char3[0] ;
   ...
   {
      this.aP1[0] = a205_pc01_site_mst_chk.this.AV11P_A_CHK_RESULT_SDT;
      this.aP2[0] = a205_pc01_site_mst_chk.this.AV12P_A_RESULT_MSG_SDT;
      CloseOpenCursors();
      exitApplication();
   }
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S16163 */
                  S16163 ();
                  if ( returnInSub )
                  {
                     returnInSub = true;
   ...
   public void initialize( )
   {
      ...
      GXt_char4 = "" ;
      Gx_emsg = "" ;
      AV28Pgmname = "A205_PC01_SITE_MST_CHK" ;
      /* GeneXus formulas. */
      AV28Pgmname = "A205_PC01_SITE_MST_CHK" ;
      Gx_err = (short)(0) ;
   }
   ...
   private SdtTAM08_SITE AV13P_BC_SITE ;
