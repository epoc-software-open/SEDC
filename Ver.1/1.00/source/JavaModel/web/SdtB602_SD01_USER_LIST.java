...
public final  class SdtB602_SD01_USER_LIST extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "USER") )
            {
               ...
               {
                  gxTv_SdtB602_SD01_USER_LIST_User = new GxObjectCollection(SdtB602_SD01_USER_LIST_USERItem.class, "B602_SD01_USER_LIST.USERItem", "SmartEDC_SHIZUOKA", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public void tojson( )
   {
      if ( gxTv_SdtB602_SD01_USER_LIST_Result != null )
      {
         AddObjectProperty("RESULT", gxTv_SdtB602_SD01_USER_LIST_Result);
      }
      if ( gxTv_SdtB602_SD01_USER_LIST_User != null )
      {
         AddObjectProperty("USER", gxTv_SdtB602_SD01_USER_LIST_User);
      }
   }
   ...
   public void setStruct( StructSdtB602_SD01_USER_LIST struct )
   {
      ...
      setgxTv_SdtB602_SD01_USER_LIST_User(new GxObjectCollection(SdtB602_SD01_USER_LIST_USERItem.class, "B602_SD01_USER_LIST.USERItem", "SmartEDC_SHIZUOKA", struct.getUser(), remoteHandle));
   }
   ...
   public StructSdtB602_SD01_USER_LIST getStruct( )
   {
      ...
      struct.setUser(getgxTv_SdtB602_SD01_USER_LIST_User().getStruct());
      return struct ;
   }
