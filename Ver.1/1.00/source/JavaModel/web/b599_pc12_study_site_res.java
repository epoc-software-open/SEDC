/*
       ...
       Generated on: July 3, 2017 14:52:9.59
...
public final  class b599_pc12_study_site_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A199TBM22_DEL_FLG = P002Q2_A199TBM22_DEL_FLG[0] ;
         n199TBM22_DEL_FLG = P002Q2_n199TBM22_DEL_FLG[0] ;
         A198TBM22_SITE_ID = P002Q2_A198TBM22_SITE_ID[0] ;
         A197TBM22_STUDY_ID = P002Q2_A197TBM22_STUDY_ID[0] ;
         A206TBM22_UPD_CNT = P002Q2_A206TBM22_UPD_CNT[0] ;
         n206TBM22_UPD_CNT = P002Q2_n206TBM22_UPD_CNT[0] ;
         A205TBM22_UPD_PROG_NM = P002Q2_A205TBM22_UPD_PROG_NM[0] ;
         n205TBM22_UPD_PROG_NM = P002Q2_n205TBM22_UPD_PROG_NM[0] ;
         A204TBM22_UPD_USER_ID = P002Q2_A204TBM22_UPD_USER_ID[0] ;
         n204TBM22_UPD_USER_ID = P002Q2_n204TBM22_UPD_USER_ID[0] ;
         A203TBM22_UPD_DATETIME = P002Q2_A203TBM22_UPD_DATETIME[0] ;
         n203TBM22_UPD_DATETIME = P002Q2_n203TBM22_UPD_DATETIME[0] ;
         A202TBM22_CRT_PROG_NM = P002Q2_A202TBM22_CRT_PROG_NM[0] ;
         n202TBM22_CRT_PROG_NM = P002Q2_n202TBM22_CRT_PROG_NM[0] ;
         A201TBM22_CRT_USER_ID = P002Q2_A201TBM22_CRT_USER_ID[0] ;
         n201TBM22_CRT_USER_ID = P002Q2_n201TBM22_CRT_USER_ID[0] ;
         A200TBM22_CRT_DATETIME = P002Q2_A200TBM22_CRT_DATETIME[0] ;
         n200TBM22_CRT_DATETIME = P002Q2_n200TBM22_CRT_DATETIME[0] ;
         AV20GXLvl31 = (byte)(1) ;
         GXt_char1 = AV13W_STR ;
         GXv_char2[0] = GXt_char1 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A198TBM22_SITE_ID, GXv_char2) ;
         b599_pc12_study_site_res.this.GXt_char1 = GXv_char2[0] ;
         GXt_char3 = AV13W_STR ;
         GXv_char4[0] = GXt_char3 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A199TBM22_DEL_FLG, GXv_char4) ;
         b599_pc12_study_site_res.this.GXt_char3 = GXv_char4[0] ;
         GXt_char5 = AV13W_STR ;
         GXv_char6[0] = GXt_char5 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A200TBM22_CRT_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char6) ;
         b599_pc12_study_site_res.this.GXt_char5 = GXv_char6[0] ;
         GXt_char7 = AV13W_STR ;
         GXv_char8[0] = GXt_char7 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A201TBM22_CRT_USER_ID, GXv_char8) ;
         b599_pc12_study_site_res.this.GXt_char7 = GXv_char8[0] ;
         GXt_char9 = AV13W_STR ;
         GXv_char10[0] = GXt_char9 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A202TBM22_CRT_PROG_NM, GXv_char10) ;
         b599_pc12_study_site_res.this.GXt_char9 = GXv_char10[0] ;
         GXt_char11 = AV13W_STR ;
         GXv_char12[0] = GXt_char11 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A203TBM22_UPD_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char12) ;
         b599_pc12_study_site_res.this.GXt_char11 = GXv_char12[0] ;
         GXt_char13 = AV13W_STR ;
         GXv_char14[0] = GXt_char13 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A204TBM22_UPD_USER_ID, GXv_char14) ;
         b599_pc12_study_site_res.this.GXt_char13 = GXv_char14[0] ;
         GXt_char15 = AV13W_STR ;
         GXv_char16[0] = GXt_char15 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A205TBM22_UPD_PROG_NM, GXv_char16) ;
         b599_pc12_study_site_res.this.GXt_char15 = GXv_char16[0] ;
         AV13W_STR = GXutil.trim( GXutil.str( A197TBM22_STUDY_ID, 10, 0)) + "," + GXt_char1 + "," + GXt_char3 + "," + GXt_char5 + "," + GXt_char7 + "," + GXt_char9 + "," + GXt_char11 + "," + GXt_char13 + "," + GXt_char15 + "," + GXutil.trim( GXutil.str( A206TBM22_UPD_CNT, 10, 0)) ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P002Q2_A199TBM22_DEL_FLG = new String[] {""} ;
      P002Q2_n199TBM22_DEL_FLG = new boolean[] {false} ;
      P002Q2_A198TBM22_SITE_ID = new String[] {""} ;
      P002Q2_A197TBM22_STUDY_ID = new long[1] ;
      P002Q2_A206TBM22_UPD_CNT = new long[1] ;
      P002Q2_n206TBM22_UPD_CNT = new boolean[] {false} ;
      P002Q2_A205TBM22_UPD_PROG_NM = new String[] {""} ;
      P002Q2_n205TBM22_UPD_PROG_NM = new boolean[] {false} ;
      P002Q2_A204TBM22_UPD_USER_ID = new String[] {""} ;
      P002Q2_n204TBM22_UPD_USER_ID = new boolean[] {false} ;
      P002Q2_A203TBM22_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P002Q2_n203TBM22_UPD_DATETIME = new boolean[] {false} ;
      P002Q2_A202TBM22_CRT_PROG_NM = new String[] {""} ;
      P002Q2_n202TBM22_CRT_PROG_NM = new boolean[] {false} ;
      P002Q2_A201TBM22_CRT_USER_ID = new String[] {""} ;
      P002Q2_n201TBM22_CRT_USER_ID = new boolean[] {false} ;
      P002Q2_A200TBM22_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P002Q2_n200TBM22_CRT_DATETIME = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc12_study_site_res__default(),
         new Object[] {
             new Object[] {
            P002Q2_A199TBM22_DEL_FLG, P002Q2_n199TBM22_DEL_FLG, P002Q2_A198TBM22_SITE_ID, P002Q2_A197TBM22_STUDY_ID, P002Q2_A206TBM22_UPD_CNT, P002Q2_n206TBM22_UPD_CNT, P002Q2_A205TBM22_UPD_PROG_NM, P002Q2_n205TBM22_UPD_PROG_NM, P002Q2_A204TBM22_UPD_USER_ID, P002Q2_n204TBM22_UPD_USER_ID,
            P002Q2_A203TBM22_UPD_DATETIME, P002Q2_n203TBM22_UPD_DATETIME, P002Q2_A202TBM22_CRT_PROG_NM, P002Q2_n202TBM22_CRT_PROG_NM, P002Q2_A201TBM22_CRT_USER_ID, P002Q2_n201TBM22_CRT_USER_ID, P002Q2_A200TBM22_CRT_DATETIME, P002Q2_n200TBM22_CRT_DATETIME
            }
         }
      );
   ...
   private String[] P002Q2_A199TBM22_DEL_FLG ;
   private boolean[] P002Q2_n199TBM22_DEL_FLG ;
   private String[] P002Q2_A198TBM22_SITE_ID ;
   private long[] P002Q2_A197TBM22_STUDY_ID ;
   private long[] P002Q2_A206TBM22_UPD_CNT ;
   private boolean[] P002Q2_n206TBM22_UPD_CNT ;
   private String[] P002Q2_A205TBM22_UPD_PROG_NM ;
   private boolean[] P002Q2_n205TBM22_UPD_PROG_NM ;
   private String[] P002Q2_A204TBM22_UPD_USER_ID ;
   private boolean[] P002Q2_n204TBM22_UPD_USER_ID ;
   private java.util.Date[] P002Q2_A203TBM22_UPD_DATETIME ;
   private boolean[] P002Q2_n203TBM22_UPD_DATETIME ;
   private String[] P002Q2_A202TBM22_CRT_PROG_NM ;
   private boolean[] P002Q2_n202TBM22_CRT_PROG_NM ;
   private String[] P002Q2_A201TBM22_CRT_USER_ID ;
   private boolean[] P002Q2_n201TBM22_CRT_USER_ID ;
   private java.util.Date[] P002Q2_A200TBM22_CRT_DATETIME ;
   private boolean[] P002Q2_n200TBM22_CRT_DATETIME ;
...
{
   protected Object[] conditional_P002Q2( com.genexus.internet.HttpContext httpContext ,
                                          String AV8P_SITE_ID ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P002Q2(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P002Q2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
