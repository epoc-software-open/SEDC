/*
               File: gx0060_impl
        Description: Selection List 和暦元号マスタ
...
public final  class gx0060_impl extends GXDataArea
{
   ...
   public void start0F2( )
   {
      ...
      Form.getMeta().addItem("Description", "Selection List 和暦元号マスタ", (short)(0)) ;
      httpContext.wjLoc = "" ;
   ...
   {
      /* Start Routine */
      Form.setCaption( GXutil.format( "選択リスト %1", "和暦元号マスタ", "", "", "", "", "", "", "", "") );
   ...
   public void wb_table2_11_0F2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         if ( Grid1Container.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "開始年月日（西暦）") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" width="+GXutil.ltrim( GXutil.str( 140, 4, 0))+"px"+" class=\""+subGrid1_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
            httpContext.writeValue( "終了年月日（西暦）") ;
            httpContext.writeTextNL( "</th>") ;
   ...
   public void wb_table3_22_0F2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 14, 3, 0)+","+"null"+");", "終了", bttBtn_cancel_Jsonclick, 1, "終了", "", StyleString, ClassString, 1, 1, "standard", "ECANCEL.", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0060.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void sendrow_142( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_14_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         Grid1Row.AddColumnProperties("edit", 1, httpContext.isAjaxCallMode( ), new Object[] {edtTAS02_GNGO_NM_Internalname,GXutil.rtrim( A23TAS02_GNGO_NM),"","","",edtTAS02_GNGO_NM_Link,"","選択",edtTAS02_GNGO_NM_Jsonclick,new Integer(0),ClassString,StyleString,ROClassString,new Integer(-1),new Integer(0),new Integer(0),new Integer(150),"px",new Integer(17),"px",new Integer(10),new Integer(0),new Integer(0),new Integer(14),new Integer(1),new Integer(1),new Boolean(true),"left"});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((-1==0) ? "display:none;" : "")+"\">") ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List 和暦元号マスタ" );
