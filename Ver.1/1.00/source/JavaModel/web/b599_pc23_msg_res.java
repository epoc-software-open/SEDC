/*
       ...
       Generated on: July 3, 2017 14:52:33.60
...
public final  class b599_pc23_msg_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A110TAM06_DEL_FLG = P00482_A110TAM06_DEL_FLG[0] ;
         n110TAM06_DEL_FLG = P00482_n110TAM06_DEL_FLG[0] ;
         A21TAM06_MSG_CD = P00482_A21TAM06_MSG_CD[0] ;
         A111TAM06_UPD_CNT = P00482_A111TAM06_UPD_CNT[0] ;
         n111TAM06_UPD_CNT = P00482_n111TAM06_UPD_CNT[0] ;
         A46TAM06_UPD_PROG_NM = P00482_A46TAM06_UPD_PROG_NM[0] ;
         n46TAM06_UPD_PROG_NM = P00482_n46TAM06_UPD_PROG_NM[0] ;
         A80TAM06_UPD_USER_ID = P00482_A80TAM06_UPD_USER_ID[0] ;
         n80TAM06_UPD_USER_ID = P00482_n80TAM06_UPD_USER_ID[0] ;
         A45TAM06_UPD_DATETIME = P00482_A45TAM06_UPD_DATETIME[0] ;
         n45TAM06_UPD_DATETIME = P00482_n45TAM06_UPD_DATETIME[0] ;
         A44TAM06_CRT_PROG_NM = P00482_A44TAM06_CRT_PROG_NM[0] ;
         n44TAM06_CRT_PROG_NM = P00482_n44TAM06_CRT_PROG_NM[0] ;
         A125TAM06_CRT_USER_ID = P00482_A125TAM06_CRT_USER_ID[0] ;
         n125TAM06_CRT_USER_ID = P00482_n125TAM06_CRT_USER_ID[0] ;
         A43TAM06_CRT_DATETIME = P00482_A43TAM06_CRT_DATETIME[0] ;
         n43TAM06_CRT_DATETIME = P00482_n43TAM06_CRT_DATETIME[0] ;
         A20TAM06_MSG = P00482_A20TAM06_MSG[0] ;
         n20TAM06_MSG = P00482_n20TAM06_MSG[0] ;
         AV21GXLvl31 = (byte)(1) ;
         GXt_char1 = AV14W_STR ;
         GXv_char2[0] = GXt_char1 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A21TAM06_MSG_CD, GXv_char2) ;
         b599_pc23_msg_res.this.GXt_char1 = GXv_char2[0] ;
         GXt_char3 = AV14W_STR ;
         GXv_char4[0] = GXt_char3 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A20TAM06_MSG, GXv_char4) ;
         b599_pc23_msg_res.this.GXt_char3 = GXv_char4[0] ;
         GXt_char5 = AV14W_STR ;
         GXv_char6[0] = GXt_char5 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A43TAM06_CRT_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char6) ;
         b599_pc23_msg_res.this.GXt_char5 = GXv_char6[0] ;
         GXt_char7 = AV14W_STR ;
         GXv_char8[0] = GXt_char7 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A125TAM06_CRT_USER_ID, GXv_char8) ;
         b599_pc23_msg_res.this.GXt_char7 = GXv_char8[0] ;
         GXt_char9 = AV14W_STR ;
         GXv_char10[0] = GXt_char9 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A44TAM06_CRT_PROG_NM, GXv_char10) ;
         b599_pc23_msg_res.this.GXt_char9 = GXv_char10[0] ;
         GXt_char11 = AV14W_STR ;
         GXv_char12[0] = GXt_char11 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A45TAM06_UPD_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char12) ;
         b599_pc23_msg_res.this.GXt_char11 = GXv_char12[0] ;
         GXt_char13 = AV14W_STR ;
         GXv_char14[0] = GXt_char13 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A80TAM06_UPD_USER_ID, GXv_char14) ;
         b599_pc23_msg_res.this.GXt_char13 = GXv_char14[0] ;
         GXt_char15 = AV14W_STR ;
         GXv_char16[0] = GXt_char15 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A46TAM06_UPD_PROG_NM, GXv_char16) ;
         b599_pc23_msg_res.this.GXt_char15 = GXv_char16[0] ;
         AV14W_STR = GXt_char1 + "," + GXt_char3 + "," + A110TAM06_DEL_FLG + "," + GXt_char5 + "," + GXt_char7 + "," + GXt_char9 + "," + GXt_char11 + "," + GXt_char13 + "," + GXt_char15 + "," + GXutil.trim( GXutil.str( A111TAM06_UPD_CNT, 10, 0)) ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P00482_A110TAM06_DEL_FLG = new String[] {""} ;
      P00482_n110TAM06_DEL_FLG = new boolean[] {false} ;
      P00482_A21TAM06_MSG_CD = new String[] {""} ;
      P00482_A111TAM06_UPD_CNT = new long[1] ;
      P00482_n111TAM06_UPD_CNT = new boolean[] {false} ;
      P00482_A46TAM06_UPD_PROG_NM = new String[] {""} ;
      P00482_n46TAM06_UPD_PROG_NM = new boolean[] {false} ;
      P00482_A80TAM06_UPD_USER_ID = new String[] {""} ;
      P00482_n80TAM06_UPD_USER_ID = new boolean[] {false} ;
      P00482_A45TAM06_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P00482_n45TAM06_UPD_DATETIME = new boolean[] {false} ;
      P00482_A44TAM06_CRT_PROG_NM = new String[] {""} ;
      P00482_n44TAM06_CRT_PROG_NM = new boolean[] {false} ;
      P00482_A125TAM06_CRT_USER_ID = new String[] {""} ;
      P00482_n125TAM06_CRT_USER_ID = new boolean[] {false} ;
      P00482_A43TAM06_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P00482_n43TAM06_CRT_DATETIME = new boolean[] {false} ;
      P00482_A20TAM06_MSG = new String[] {""} ;
      P00482_n20TAM06_MSG = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc23_msg_res__default(),
         new Object[] {
             new Object[] {
            P00482_A110TAM06_DEL_FLG, P00482_n110TAM06_DEL_FLG, P00482_A21TAM06_MSG_CD, P00482_A111TAM06_UPD_CNT, P00482_n111TAM06_UPD_CNT, P00482_A46TAM06_UPD_PROG_NM, P00482_n46TAM06_UPD_PROG_NM, P00482_A80TAM06_UPD_USER_ID, P00482_n80TAM06_UPD_USER_ID, P00482_A45TAM06_UPD_DATETIME,
            P00482_n45TAM06_UPD_DATETIME, P00482_A44TAM06_CRT_PROG_NM, P00482_n44TAM06_CRT_PROG_NM, P00482_A125TAM06_CRT_USER_ID, P00482_n125TAM06_CRT_USER_ID, P00482_A43TAM06_CRT_DATETIME, P00482_n43TAM06_CRT_DATETIME, P00482_A20TAM06_MSG, P00482_n20TAM06_MSG
            }
         }
      );
   ...
   private String[] P00482_A110TAM06_DEL_FLG ;
   private boolean[] P00482_n110TAM06_DEL_FLG ;
   private String[] P00482_A21TAM06_MSG_CD ;
   private long[] P00482_A111TAM06_UPD_CNT ;
   private boolean[] P00482_n111TAM06_UPD_CNT ;
   private String[] P00482_A46TAM06_UPD_PROG_NM ;
   private boolean[] P00482_n46TAM06_UPD_PROG_NM ;
   private String[] P00482_A80TAM06_UPD_USER_ID ;
   private boolean[] P00482_n80TAM06_UPD_USER_ID ;
   private java.util.Date[] P00482_A45TAM06_UPD_DATETIME ;
   private boolean[] P00482_n45TAM06_UPD_DATETIME ;
   private String[] P00482_A44TAM06_CRT_PROG_NM ;
   private boolean[] P00482_n44TAM06_CRT_PROG_NM ;
   private String[] P00482_A125TAM06_CRT_USER_ID ;
   private boolean[] P00482_n125TAM06_CRT_USER_ID ;
   private java.util.Date[] P00482_A43TAM06_CRT_DATETIME ;
   private boolean[] P00482_n43TAM06_CRT_DATETIME ;
   private String[] P00482_A20TAM06_MSG ;
   private boolean[] P00482_n20TAM06_MSG ;
...
{
   protected Object[] conditional_P00482( com.genexus.internet.HttpContext httpContext ,
                                          String AV9P_MSG_CD ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00482(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00482", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
