...
public final  class a101_wp01_login_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("a101_wp01_login") +"\" class=\""+"Form"+"\">") ;
   ...
   public void wb_table1_2_0A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_55_0A2( true) ;
      }
      else
      {
         wb_table2_55_0A2( false) ;
      }
      return  ;
   }

   public void wb_table2_55_0A2e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
   ...
   public void rf0A2( )
   {
      ...
      if ( (GXutil.strcmp("", httpContext.wjLoc)==0) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A117TAT01_DEL_FLG = H000A2_A117TAT01_DEL_FLG[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A117TAT01_DEL_FLG", A117TAT01_DEL_FLG);
            n117TAT01_DEL_FLG = H000A2_n117TAT01_DEL_FLG[0] ;
            A6TAT01_INFO = H000A2_A6TAT01_INFO[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A6TAT01_INFO", A6TAT01_INFO);
            n6TAT01_INFO = H000A2_n6TAT01_INFO[0] ;
            A867TAT01_INFO_KBN = H000A2_A867TAT01_INFO_KBN[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A867TAT01_INFO_KBN", A867TAT01_INFO_KBN);
            n867TAT01_INFO_KBN = H000A2_n867TAT01_INFO_KBN[0] ;
            A5TAT01_DATE_END = H000A2_A5TAT01_DATE_END[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A5TAT01_DATE_END", localUtil.format(A5TAT01_DATE_END, "9999/99/99"));
            n5TAT01_DATE_END = H000A2_n5TAT01_DATE_END[0] ;
            A4TAT01_DATE_START = H000A2_A4TAT01_DATE_START[0] ;
            n4TAT01_DATE_START = H000A2_n4TAT01_DATE_START[0] ;
            /* Execute user event: e140A2 */
            e140A2 ();
   ...
   public void e120A2( )
   {
      ...
      AV7C_PGNM = "Smart EDCシステム管理者ログイン" ;
   ...
   private void e140A2( )
   {
      ...
      a101_wp01_login_impl.this.GXt_char3 = GXv_char4[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "A6TAT01_INFO", A6TAT01_INFO);
   ...
   public void S142( )
   {
      ...
      {
         A16TAM07_DEL_FLG = H000A3_A16TAM07_DEL_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A16TAM07_DEL_FLG", A16TAM07_DEL_FLG);
         n16TAM07_DEL_FLG = H000A3_n16TAM07_DEL_FLG[0] ;
         A7TAM07_PWD = H000A3_A7TAM07_PWD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A7TAM07_PWD", A7TAM07_PWD);
         n7TAM07_PWD = H000A3_n7TAM07_PWD[0] ;
         A8TAM07_USER_ID = H000A3_A8TAM07_USER_ID[0] ;
      ...
      if ( AV23GXLvl162 == 0 )
      {
         ...
         GXt_char3 = AV18W_MSG ;
         GXv_char4[0] = GXt_char3 ;
         new a805_pc01_msg_get(remoteHandle, context).execute( "AE00029", "", "", "", "", "", GXv_char4) ;
         a101_wp01_login_impl.this.GXt_char3 = GXv_char4[0] ;
         AV18W_MSG = GXt_char3 ;
   ...
   public void S152( )
   {
      ...
      {
         A8TAM07_USER_ID = H000A4_A8TAM07_USER_ID[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A8TAM07_USER_ID", A8TAM07_USER_ID);
         A2TAM07_USER_NM = H000A4_A2TAM07_USER_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A2TAM07_USER_NM", A2TAM07_USER_NM);
         n2TAM07_USER_NM = H000A4_n2TAM07_USER_NM[0] ;
         A126TAM07_USER_KANA_NM = H000A4_A126TAM07_USER_KANA_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A126TAM07_USER_KANA_NM", A126TAM07_USER_KANA_NM);
         n126TAM07_USER_KANA_NM = H000A4_n126TAM07_USER_KANA_NM[0] ;
         A14TAM07_AUTH_CD = H000A4_A14TAM07_AUTH_CD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A14TAM07_AUTH_CD", A14TAM07_AUTH_CD);
         n14TAM07_AUTH_CD = H000A4_n14TAM07_AUTH_CD[0] ;
   ...
   public void wb_table2_55_0A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_js_event_Internalname, lblTxt_js_event_Caption, "", "", lblTxt_js_event_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(1), "HLP_A101_WP01_LOGIN.htm");
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV13H_INIT_FLG", AV13H_INIT_FLG);
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 59,'',false,'" + sGXsfl_40_idx + "',0)\"" ;
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV13H_INIT_FLG), GXutil.rtrim( localUtil.format( AV13H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(59);\"", "", "", "", "", edtavH_init_flg_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A101_WP01_LOGIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_55_0A2e( true) ;
      }
      else
      {
         wb_table2_55_0A2e( false) ;
      }
   }
   ...
   public void wb_table1_2_0A2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table3_5_0A2( true) ;
      }
      else
      {
         wb_table3_5_0A2( false) ;
      }
      return  ;
   }

   public void wb_table3_5_0A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table3_5_0A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table4_9_0A2( true) ;
      }
      else
      {
         wb_table4_9_0A2( false) ;
      }
      return  ;
   }

   public void wb_table4_9_0A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_5_0A2e( true) ;
      }
      else
      {
         wb_table3_5_0A2e( false) ;
      }
   }

   public void wb_table4_9_0A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table5_19_0A2( true) ;
      }
      else
      {
         wb_table5_19_0A2( false) ;
      }
      return  ;
   }

   public void wb_table5_19_0A2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
      ...
      if ( wbEnd == 40 )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_9_0A2e( true) ;
      }
      else
      {
         wb_table4_9_0A2e( false) ;
      }
   }

   public void wb_table5_19_0A2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"ItemTitle\"  style=\"text-align:"+httpContext.getCssProperty( "Align", "center")+";width:150px\">") ;
         /* Text block */
         ClassString = "TextBlockItemTitle" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock2_Internalname, "ユーザーID", "", "", lblTextblock2_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A101_WP01_LOGIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV12D_TAM07_USER_ID", AV12D_TAM07_USER_ID);
         ...
         ClassString = "TextBlockItemTitle" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock3_Internalname, "パスワード", "", "", lblTextblock3_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A101_WP01_LOGIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV11D_TAM07_PWD", AV11D_TAM07_PWD);
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_pwd_Internalname, GXutil.rtrim( AV11D_TAM07_PWD), GXutil.rtrim( localUtil.format( AV11D_TAM07_PWD, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(29);\"", "", "", "", "", edtavD_tam07_pwd_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 20, "chr", 1, "row", 128, (byte)(-1), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A101_WP01_LOGIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock1_Internalname, "ログイン（F3）", "", "", lblTextblock1_Jsonclick, "E\\'BTN_LOGIN\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A101_WP01_LOGIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_19_0A2e( true) ;
      }
      else
      {
         wb_table5_19_0A2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?14573771");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a101_wp01_login.js", "?14573772");
   ...
   public void sendrow_402( )
   {
      ...
      Grid1Row.AddColumnProperties("cell", -1, httpContext.isAjaxCallMode( ), new Object[] {"",""+" style=\"height:36px;width:110px\""});
      /* Single line edit */
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S17296 */
                  S17296 ();
                  break;
         }
      }
   ...
   public void initialize( )
   {
      ...
      Grid1Container = new com.genexus.webpanels.GXWebGrid(context);
      scmdbuf = "" ;
      H000A2_A71TAT01_INFO_NO = new int[1] ;
      H000A2_A117TAT01_DEL_FLG = new String[] {""} ;
      H000A2_n117TAT01_DEL_FLG = new boolean[] {false} ;
      H000A2_A6TAT01_INFO = new String[] {""} ;
      H000A2_n6TAT01_INFO = new boolean[] {false} ;
      H000A2_A867TAT01_INFO_KBN = new String[] {""} ;
      H000A2_n867TAT01_INFO_KBN = new boolean[] {false} ;
      H000A2_A5TAT01_DATE_END = new java.util.Date[] {GXutil.nullDate()} ;
      H000A2_n5TAT01_DATE_END = new boolean[] {false} ;
      H000A2_A4TAT01_DATE_START = new java.util.Date[] {GXutil.nullDate()} ;
      H000A2_n4TAT01_DATE_START = new boolean[] {false} ;
      A117TAT01_DEL_FLG = "" ;
      A867TAT01_INFO_KBN = "" ;
      ...
      GXEncryptionTmp = "" ;
      AV20W_TAM07_PWD = "" ;
      H000A3_A16TAM07_DEL_FLG = new String[] {""} ;
      H000A3_n16TAM07_DEL_FLG = new boolean[] {false} ;
      H000A3_A7TAM07_PWD = new String[] {""} ;
      H000A3_n7TAM07_PWD = new boolean[] {false} ;
      H000A3_A8TAM07_USER_ID = new String[] {""} ;
      A16TAM07_DEL_FLG = "" ;
      A7TAM07_PWD = "" ;
      A8TAM07_USER_ID = "" ;
      GXv_char4 = new String [1] ;
      H000A4_A8TAM07_USER_ID = new String[] {""} ;
      H000A4_A2TAM07_USER_NM = new String[] {""} ;
      H000A4_n2TAM07_USER_NM = new boolean[] {false} ;
      H000A4_A126TAM07_USER_KANA_NM = new String[] {""} ;
      H000A4_n126TAM07_USER_KANA_NM = new boolean[] {false} ;
      H000A4_A14TAM07_AUTH_CD = new String[] {""} ;
      H000A4_n14TAM07_AUTH_CD = new boolean[] {false} ;
      A2TAM07_USER_NM = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new a101_wp01_login__default(),
         new Object[] {
             new Object[] {
            H000A2_A71TAT01_INFO_NO, H000A2_A117TAT01_DEL_FLG, H000A2_n117TAT01_DEL_FLG, H000A2_A6TAT01_INFO, H000A2_n6TAT01_INFO, H000A2_A867TAT01_INFO_KBN, H000A2_n867TAT01_INFO_KBN, H000A2_A5TAT01_DATE_END, H000A2_n5TAT01_DATE_END, H000A2_A4TAT01_DATE_START,
            H000A2_n4TAT01_DATE_START
            }
            , new Object[] {
            H000A3_A16TAM07_DEL_FLG, H000A3_n16TAM07_DEL_FLG, H000A3_A7TAM07_PWD, H000A3_n7TAM07_PWD, H000A3_A8TAM07_USER_ID
            }
            , new Object[] {
            H000A4_A8TAM07_USER_ID, H000A4_A2TAM07_USER_NM, H000A4_n2TAM07_USER_NM, H000A4_A126TAM07_USER_KANA_NM, H000A4_n126TAM07_USER_KANA_NM, H000A4_A14TAM07_AUTH_CD, H000A4_n14TAM07_AUTH_CD
            }
         }
      );
   ...
   private int[] H000A2_A71TAT01_INFO_NO ;
   private String[] H000A2_A117TAT01_DEL_FLG ;
   private boolean[] H000A2_n117TAT01_DEL_FLG ;
   private String[] H000A2_A6TAT01_INFO ;
   private boolean[] H000A2_n6TAT01_INFO ;
   private String[] H000A2_A867TAT01_INFO_KBN ;
   private boolean[] H000A2_n867TAT01_INFO_KBN ;
   private java.util.Date[] H000A2_A5TAT01_DATE_END ;
   private boolean[] H000A2_n5TAT01_DATE_END ;
   private java.util.Date[] H000A2_A4TAT01_DATE_START ;
   private boolean[] H000A2_n4TAT01_DATE_START ;
   private String[] H000A3_A16TAM07_DEL_FLG ;
   private boolean[] H000A3_n16TAM07_DEL_FLG ;
   private String[] H000A3_A7TAM07_PWD ;
   private boolean[] H000A3_n7TAM07_PWD ;
   private String[] H000A3_A8TAM07_USER_ID ;
   private String[] H000A4_A8TAM07_USER_ID ;
   private String[] H000A4_A2TAM07_USER_NM ;
   private boolean[] H000A4_n2TAM07_USER_NM ;
   private String[] H000A4_A126TAM07_USER_KANA_NM ;
   private boolean[] H000A4_n126TAM07_USER_KANA_NM ;
   private String[] H000A4_A14TAM07_AUTH_CD ;
   private boolean[] H000A4_n14TAM07_AUTH_CD ;
...
final  class a101_wp01_login__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000A2", "SELECT `TAT01_INFO_NO`, `TAT01_DEL_FLG`, `TAT01_INFO`, `TAT01_INFO_KBN`, `TAT01_DATE_END`, `TAT01_DATE_START` FROM `TAT01_INFO` WHERE (`TAT01_DATE_START` <= ?) AND (`TAT01_DATE_START` <= ?) AND (`TAT01_DATE_END` >= ? or (`TAT01_DATE_END` = '1000-01-01')) AND (( `TAT01_INFO_KBN` = '2' or `TAT01_INFO_KBN` = '9')) AND (`TAT01_DEL_FLG` = '0') ORDER BY `TAT01_DATE_START` DESC ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H000A3", "SELECT `TAM07_DEL_FLG`, `TAM07_PWD`, `TAM07_USER_ID` FROM `TAM07_USER` WHERE (`TAM07_USER_ID` = ?) AND (`TAM07_PWD` = ?) AND (`TAM07_DEL_FLG` = '0') ORDER BY `TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H000A4", "SELECT `TAM07_USER_ID`, `TAM07_USER_NM`, `TAM07_USER_KANA_NM`, `TAM07_AUTH_CD` FROM `TAM07_USER` WHERE `TAM07_USER_ID` = ? ORDER BY `TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
