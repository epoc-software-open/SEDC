/*
               File: ab518_pc01_down_site_impl
...
public final  class ab518_pc01_down_site_impl extends GXWebProcedure
{
   public ab518_pc01_down_site_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      ab518_pc01_down_site_impl.this.GXt_char1 = GXv_char2[0] ;
      ...
      if ( AV12W_ERR_CD == 0 )
      {
         ...
         new b599_pc32_site_res(remoteHandle, context).execute( "", GXv_objcol_svchar3, GXv_int4, GXv_char2) ;
         AV21W_RTN_CSV = GXv_objcol_svchar3[0] ;
         ab518_pc01_down_site_impl.this.AV12W_ERR_CD = GXv_int4[0] ;
         ab518_pc01_down_site_impl.this.AV13W_ERR_MSG = GXv_char2[0] ;
      }
   ...
   public void S1277( )
   {
      ...
      ab518_pc01_down_site_impl.this.AV10P_USER_ID = GXv_char2[0] ;
      ab518_pc01_down_site_impl.this.AV12W_ERR_CD = GXv_int4[0] ;
      ab518_pc01_down_site_impl.this.AV13W_ERR_MSG = GXv_char6[0] ;
   }
   ...
   public void S1393( )
   {
      ...
      if ( AV12W_ERR_CD == 0 )
      {
         Application.commit(context, remoteHandle, "DEFAULT", "ab518_pc01_down_site");
      }
      else
      {
         Application.rollback(context, remoteHandle, "DEFAULT", "ab518_pc01_down_site");
      }
   ...
   public void initialize( )
   {
      ...
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new ab518_pc01_down_site__default(),
         new Object[] {
         }
      );
      pr_default.setErrorHandler(this);
      AV25Pgmdesc = "施設マスタダウンロード" ;
      AV24Pgmname = "AB518_PC01_DOWN_SITE" ;
      /* GeneXus formulas. */
      AV25Pgmdesc = "施設マスタダウンロード" ;
      AV24Pgmname = "AB518_PC01_DOWN_SITE" ;
      Gx_err = (short)(0) ;
...
final  class ab518_pc01_down_site__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
