/*
       ...
       Generated on: July 3, 2017 14:53:5.30
...
public final  class b799_pc02_image_url_get extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A414TBM11_DEL_FLG = P005N2_A414TBM11_DEL_FLG[0] ;
         n414TBM11_DEL_FLG = P005N2_n414TBM11_DEL_FLG[0] ;
         A411TBM11_IMAGE_CD = P005N2_A411TBM11_IMAGE_CD[0] ;
         A412TBM11_IMAGE = P005N2_A412TBM11_IMAGE[0] ;
         n412TBM11_IMAGE = P005N2_n412TBM11_IMAGE[0] ;
         AV11W_TBM11_IMAGE = A412TBM11_IMAGE ;
         AV9W_FLG = "1" ;
   ...
   public void initialize( )
   {
      ...
      AV9W_FLG = "" ;
      scmdbuf = "" ;
      P005N2_A414TBM11_DEL_FLG = new String[] {""} ;
      P005N2_n414TBM11_DEL_FLG = new boolean[] {false} ;
      P005N2_A411TBM11_IMAGE_CD = new String[] {""} ;
      P005N2_A412TBM11_IMAGE = new String[] {""} ;
      P005N2_n412TBM11_IMAGE = new boolean[] {false} ;
      A414TBM11_DEL_FLG = "" ;
      A411TBM11_IMAGE_CD = "" ;
      A412TBM11_IMAGE = "" ;
      AV11W_TBM11_IMAGE = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new b799_pc02_image_url_get__default(),
         new Object[] {
             new Object[] {
            P005N2_A414TBM11_DEL_FLG, P005N2_n414TBM11_DEL_FLG, P005N2_A411TBM11_IMAGE_CD, P005N2_A412TBM11_IMAGE, P005N2_n412TBM11_IMAGE
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] P005N2_A414TBM11_DEL_FLG ;
   private boolean[] P005N2_n414TBM11_DEL_FLG ;
   private String[] P005N2_A411TBM11_IMAGE_CD ;
   private String[] P005N2_A412TBM11_IMAGE ;
   private boolean[] P005N2_n412TBM11_IMAGE ;
}
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[3])[0] = rslt.getBLOBFile(3, "", "") ;
