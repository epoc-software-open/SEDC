/*
               File: a206_wp01_user_mst_list_impl
...
public final  class a206_wp01_user_mst_list_impl extends GXWebPanel
{
   public a206_wp01_user_mst_list_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public a206_wp01_user_mst_list_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( a206_wp01_user_mst_list_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeText( "ユーザーマスタメンテナンス（一覧）") ;
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("a206_wp01_user_mst_list") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey)+"\" class=\""+"Form"+"\">") ;
   ...
   public void renderHtmlCloseForm0T2( )
   {
      ...
      GxWebStd.gx_hidden_field( httpContext, "GXH_vH_TAM07_USER_ID", GXutil.rtrim( AV17H_TAM07_USER_ID));
      GxWebStd.gx_hidden_field( httpContext, "GXH_vH_TAM07_USER_NM", GXutil.rtrim( AV18H_TAM07_USER_NM));
      /* Send saved values. */
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      GxWebStd.gx_hidden_field( httpContext, "TAM07_DEL_FLG", GXutil.rtrim( A16TAM07_DEL_FLG));
      GxWebStd.gx_hidden_field( httpContext, "vW_F7FLG", GXutil.booltostr( AV25W_F7FLG));
   ...
   public void wb_table1_2_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_189_0T2( true) ;
      }
      else
      {
         wb_table2_189_0T2( false) ;
      }
      return  ;
   }

   public void wb_table2_189_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
   ...
   public void start0T2( )
   {
      ...
      Form.getMeta().addItem("Description", "ユーザーマスタメンテナンス（一覧）", (short)(0)) ;
      httpContext.wjLoc = "" ;
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         if ( (GXutil.strcmp("", httpContext.wjLoc)==0) && ( httpContext.nUserReturn != 1 ) && ! wbErr )
         {
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vH_TAM07_USER_ID"), AV17H_TAM07_USER_ID) != 0 )
               {
                  GRID1_nFirstRecordOnPage = 0 ;
               }
               if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vH_TAM07_USER_NM"), AV18H_TAM07_USER_NM) != 0 )
               {
                  GRID1_nFirstRecordOnPage = 0 ;
               }
               if ( GXutil.strcmp(sEvtType, "E") == 0 )
               {
                  ...
                  else
                  {
                     ...
                     if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 10), "GRID1.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "'BTN_SEL'") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "'BTN_SEL'") == 0 ) )
                     {
                        ...
                        edtTAM07_USER_ID_Internalname = "TAM07_USER_ID_"+sGXsfl_171_idx ;
                        edtTAM07_USER_NM_Internalname = "TAM07_USER_NM_"+sGXsfl_171_idx ;
                        ...
                        if ( GXutil.strcmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                           {
                              ...
                              if ( ! wbErr )
                              {
                                 ...
                                 /* Set Refresh If H_tam07_user_id Changed */
                                 if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vH_TAM07_USER_ID"), AV17H_TAM07_USER_ID) != 0 )
                                 {
                                    Rfr0gs = true ;
                                 }
                                 /* Set Refresh If H_tam07_user_nm Changed */
                                 if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vH_TAM07_USER_NM"), AV18H_TAM07_USER_NM) != 0 )
                                 {
                                    Rfr0gs = true ;
                                 }
   ...
   public void rf0T2( )
   {
      ...
      if ( (GXutil.strcmp("", httpContext.wjLoc)==0) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV17H_TAM07_USER_ID = GXutil.padr( GXutil.rtrim( AV17H_TAM07_USER_ID), 128, "%") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV17H_TAM07_USER_ID", AV17H_TAM07_USER_ID);
         lV18H_TAM07_USER_NM = GXutil.padr( GXutil.rtrim( AV18H_TAM07_USER_NM), 30, "%") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV18H_TAM07_USER_NM", AV18H_TAM07_USER_NM);
         /* Using cursor H000T2 */
         pr_default.execute(0, new Object[] {AV16H_SRCH_FLG, lV17H_TAM07_USER_ID, lV18H_TAM07_USER_NM});
         nGXsfl_171_idx = (short)(1) ;
         GRID1_nEOF = (byte)(0) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subgrid1_recordsperpage( ) ) ) ) )
         {
            A16TAM07_DEL_FLG = H000T2_A16TAM07_DEL_FLG[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A16TAM07_DEL_FLG", A16TAM07_DEL_FLG);
            n16TAM07_DEL_FLG = H000T2_n16TAM07_DEL_FLG[0] ;
            A2TAM07_USER_NM = H000T2_A2TAM07_USER_NM[0] ;
            n2TAM07_USER_NM = H000T2_n2TAM07_USER_NM[0] ;
            A8TAM07_USER_ID = H000T2_A8TAM07_USER_ID[0] ;
            /* Execute user event: e320T2 */
            e320T2 ();
   ...
   public int subgrid1_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV18H_TAM07_USER_NM", AV18H_TAM07_USER_NM);
      /* Using cursor H000T3 */
      pr_default.execute(1, new Object[] {AV16H_SRCH_FLG, lV17H_TAM07_USER_ID, lV18H_TAM07_USER_NM});
   ...
   public void strup0T0( )
   {
      ...
      AV59Pgmname = "A206_WP01_USER_MST_LIST" ;
      AV58Pgmdesc = "ユーザーマスタメンテナンス（一覧）" ;
      Gx_err = (short)(0) ;
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11D_TAM07_USER_ID = httpContext.cgiGet( edtavD_tam07_user_id_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV11D_TAM07_USER_ID", AV11D_TAM07_USER_ID);
         AV12D_TAM07_USER_NM = httpContext.cgiGet( edtavD_tam07_user_nm_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV12D_TAM07_USER_NM", AV12D_TAM07_USER_NM);
         ...
         AV17H_TAM07_USER_ID = httpContext.cgiGet( edtavH_tam07_user_id_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV17H_TAM07_USER_ID", AV17H_TAM07_USER_ID);
         AV18H_TAM07_USER_NM = httpContext.cgiGet( edtavH_tam07_user_nm_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV18H_TAM07_USER_NM", AV18H_TAM07_USER_NM);
   ...
   {
      /* Start Routine */
      AV6C_TAM02_APP_ID = "A206" ;
      AV5C_GAMEN_TITLE = AV58Pgmdesc ;
      ...
      if ( GXutil.len( WebComp_Webcomp1_Component) != 0 )
      {
         WebComp_Webcomp1.componentprepare(new Object[] {"W0009","",AV20W_A_LOGIN_SDT,AV6C_TAM02_APP_ID,AV5C_GAMEN_TITLE,""});
   ...
   public void e310T2( )
   {
      ...
      {
         new a804_pc01_syslog(remoteHandle, context).execute( AV59Pgmname, "INFO", "画面起動") ;
   ...
   private void e320T2( )
   {
      ...
      if ( GXutil.strcmp(A16TAM07_DEL_FLG, "0") == 0 )
      {
         AV7D_GRD_DEL = "利用可能" ;
      }
      else if ( GXutil.strcmp(A16TAM07_DEL_FLG, "1") == 0 )
      {
         AV7D_GRD_DEL = "利用不可" ;
      }
      else
   ...
   public void e110T2( )
   {
      ...
      {
         AV28W_SESSION.setValue("A206_PAGE", GXutil.str( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no(), 10, 0));
         GXKey = context.getSiteKey( ) ;
   ...
   public void e120T2( )
   {
      ...
      S192 ();
      if (returnInSub) return;
      if ( (GXutil.strcmp("", AV27W_RTN_MSG)==0) )
      {
         GXKey = context.getSiteKey( ) ;
         GXEncryptionTmp = GXutil.URLEncode(GXutil.rtrim(AV17H_TAM07_USER_ID)) + "," + GXutil.URLEncode(GXutil.rtrim(AV18H_TAM07_USER_NM)) + "," + GXutil.URLEncode(GXutil.rtrim(AV27W_RTN_MSG)) ;
         httpContext.wjLoc = formatLink("aa206_pc01_user_mst_csv") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey) ;
         if ( ! (GXutil.strcmp("", AV27W_RTN_MSG)==0) )
         {
            httpContext.GX_msglist.addItem(AV27W_RTN_MSG);
         }
      }
      else
      {
   ...
   public void e150T2( )
   {
      ...
      if ( subgrid1_recordcount( ) > 0 )
      {
         ...
         a206_wp01_user_mst_list_impl.this.GXt_char2 = GXv_char3[0] ;
         AV26W_MSG = GXt_char2 ;
         if ( new a807_pc01_cha_num_check(remoteHandle, context).executeUdp( AV10D_LINE) == 1 )
         {
            ...
            while ( nGXsfl_171_fel_idx < nRC_Grid1 )
            {
               ...
               edtTAM07_USER_ID_Internalname = "TAM07_USER_ID_"+sGXsfl_171_fel_idx ;
               edtTAM07_USER_NM_Internalname = "TAM07_USER_NM_"+sGXsfl_171_fel_idx ;
               ...
               if ( AV8D_GRD_LINE == GXutil.val( AV10D_LINE, ".") )
               {
                  AV29W_TAM07_USER_ID = A8TAM07_USER_ID ;
                  AV26W_MSG = "" ;
         ...
         if ( (GXutil.strcmp("", AV26W_MSG)==0) )
         {
            AV28W_SESSION.setValue("A206_PAGE", GXutil.str( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no(), 10, 0));
            GXKey = context.getSiteKey( ) ;
            GXEncryptionTmp = GXutil.URLEncode(GXutil.rtrim(AV29W_TAM07_USER_ID)) ;
            httpContext.wjLoc = formatLink("a207_wp01_user_mst") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey) ;
         }
         else
         {
   ...
   public void e330T2( )
   {
      ...
      AV28W_SESSION.setValue("A206_PAGE", GXutil.str( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no(), 10, 0));
      GXKey = context.getSiteKey( ) ;
      GXEncryptionTmp = GXutil.URLEncode(GXutil.rtrim(A8TAM07_USER_ID)) ;
      httpContext.wjLoc = formatLink("a207_wp01_user_mst") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey) ;
   }
   ...
   public void S212( )
   {
      ...
      AV28W_SESSION.setValue("A206_USER_ID", AV11D_TAM07_USER_ID);
      AV28W_SESSION.setValue("A206_USER_NM", AV12D_TAM07_USER_NM);
      AV28W_SESSION.setValue("A206_SRCH_FLG", AV16H_SRCH_FLG);
   }

   public void S242( )
   {
      /* 'SUB_SESSION_GET' Routine */
      AV11D_TAM07_USER_ID = AV28W_SESSION.getValue("A206_USER_ID") ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11D_TAM07_USER_ID", AV11D_TAM07_USER_ID);
      AV12D_TAM07_USER_NM = AV28W_SESSION.getValue("A206_USER_NM") ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12D_TAM07_USER_NM", AV12D_TAM07_USER_NM);
      AV13H_A_PAGING_SDT.setgxTv_SdtA_PAGING_SDT_Page_no( (short)(GXutil.lval( AV28W_SESSION.getValue("A206_PAGE"))) );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV13H_A_PAGING_SDT", AV13H_A_PAGING_SDT);
      AV16H_SRCH_FLG = AV28W_SESSION.getValue("A206_SRCH_FLG") ;
      httpContext.ajax_rsp_assign_attri("", false, "AV16H_SRCH_FLG", AV16H_SRCH_FLG);
   }
   ...
   public void S232( )
   {
      ...
      AV28W_SESSION.remove("A206_USER_ID");
      AV28W_SESSION.remove("A206_USER_NM");
      AV28W_SESSION.remove("A206_PAGE");
      AV28W_SESSION.remove("A206_SRCH_FLG");
   }

   public void S222( )
   {
      /* 'SUB_SAVE_CONDITION' Routine */
      AV17H_TAM07_USER_ID = AV11D_TAM07_USER_ID ;
      httpContext.ajax_rsp_assign_attri("", false, "AV17H_TAM07_USER_ID", AV17H_TAM07_USER_ID);
      AV18H_TAM07_USER_NM = AV12D_TAM07_USER_NM ;
      httpContext.ajax_rsp_assign_attri("", false, "AV18H_TAM07_USER_NM", AV18H_TAM07_USER_NM);
   }
   ...
   public void S192( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV18H_TAM07_USER_NM", AV18H_TAM07_USER_NM);
      /* Using cursor H000T4 */
      pr_default.execute(2, new Object[] {lV17H_TAM07_USER_ID, lV18H_TAM07_USER_NM});
      while ( (pr_default.getStatus(2) != 101) )
      {
         A2TAM07_USER_NM = H000T4_A2TAM07_USER_NM[0] ;
         n2TAM07_USER_NM = H000T4_n2TAM07_USER_NM[0] ;
         A8TAM07_USER_ID = H000T4_A8TAM07_USER_ID[0] ;
         AV61GXLvl407 = (byte)(1) ;
         AV27W_RTN_MSG = "" ;
         /* Exit For each command. Update data (if necessary), close cursors & exit. */
         if (true) break;
   ...
   public void S112( )
   {
      ...
      a206_wp01_user_mst_list_impl.this.AV23W_ERRCD = GXv_char3[0] ;
   ...
   public void S132( )
   {
      ...
      a206_wp01_user_mst_list_impl.this.AV15H_KNGN_FLG = GXv_char3[0] ;
      a206_wp01_user_mst_list_impl.this.AV23W_ERRCD = GXv_char5[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15H_KNGN_FLG", AV15H_KNGN_FLG);
      if ( GXutil.strcmp(AV23W_ERRCD, "0") != 0 )
      {
         GXKey = context.getSiteKey( ) ;
   ...
   {
      /* 'SUB_ERROR' Routine */
      new a804_pc01_syslog(remoteHandle, context).execute( AV59Pgmname, "ERR", GXutil.trim( GXutil.str( context.globals.Gx_dbe, 10, 0))+":"+context.globals.Gx_dbt) ;
      GXKey = context.getSiteKey( ) ;
      GXEncryptionTmp = GXutil.URLEncode(GXutil.rtrim("9")) ;
      httpContext.wjLoc = formatLink("a105_wp01_error") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey) ;
      Application.rollback(context, remoteHandle, "DEFAULT", "a206_wp01_user_mst_list");
   }
   ...
   public void S182( )
   {
      ...
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV13H_A_PAGING_SDT", AV13H_A_PAGING_SDT);
      GXv_SdtA_PAGING_SDT6[0] = AV13H_A_PAGING_SDT;
      new a820_pc01_paging(remoteHandle, context).execute( GXv_SdtA_PAGING_SDT6) ;
      AV13H_A_PAGING_SDT = GXv_SdtA_PAGING_SDT6[0] ;
      ...
      if ( subgrid1_recordcount( ) <= 0 )
      {
         ...
         if ( ( GXutil.strcmp(AV16H_SRCH_FLG, "1") == 0 ) && ! AV24W_ERRFLG )
         {
            GXt_char2 = AV26W_MSG ;
            GXv_char5[0] = GXt_char2 ;
            new a805_pc01_msg_get(remoteHandle, context).execute( "AE00024", "", "", "", "", "", GXv_char5) ;
            a206_wp01_user_mst_list_impl.this.GXt_char2 = GXv_char5[0] ;
            AV26W_MSG = GXt_char2 ;
            httpContext.GX_msglist.addItem(AV26W_MSG);
         }
      }
   ...
   public void S162( )
   {
      ...
      new a402_pc02_btn_kengn_check(remoteHandle, context).execute( "REG", AV15H_KNGN_FLG, "", GXv_boolean8) ;
      a206_wp01_user_mst_list_impl.this.GXt_boolean7 = GXv_boolean8[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15H_KNGN_FLG", AV15H_KNGN_FLG);
   ...
   public void wb_table2_189_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_js_event_Internalname, lblTxt_js_event_Caption, "", "", lblTxt_js_event_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(1), "HLP_A206_WP01_USER_MST_LIST.htm");
         ...
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV14H_INIT_FLG), GXutil.rtrim( localUtil.format( AV14H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(193);\"", "", "", "", "", edtavH_init_flg_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV16H_SRCH_FLG", AV16H_SRCH_FLG);
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_srch_flg_Internalname, GXutil.rtrim( AV16H_SRCH_FLG), GXutil.rtrim( localUtil.format( AV16H_SRCH_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(194);\"", "", "", "", "", edtavH_srch_flg_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV17H_TAM07_USER_ID", AV17H_TAM07_USER_ID);
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_tam07_user_id_Internalname, GXutil.rtrim( AV17H_TAM07_USER_ID), GXutil.rtrim( localUtil.format( AV17H_TAM07_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(195);\"", "", "", "", "", edtavH_tam07_user_id_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV18H_TAM07_USER_NM", AV18H_TAM07_USER_NM);
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_tam07_user_nm_Internalname, GXutil.rtrim( AV18H_TAM07_USER_NM), GXutil.rtrim( localUtil.format( AV18H_TAM07_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(196);\"", "", "", "", "", edtavH_tam07_user_nm_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV15H_KNGN_FLG", AV15H_KNGN_FLG);
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV15H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV15H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(197);\"", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         wb_table3_198_0T2( true) ;
      }
      else
      {
         wb_table3_198_0T2( false) ;
      }
      return  ;
   }

   public void wb_table3_198_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         wb_table2_189_0T2e( true) ;
      }
      else
      {
         wb_table2_189_0T2e( false) ;
      }
   }

   public void wb_table3_198_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock1_Internalname, "MAX_ROW", "", "", lblTextblock1_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlmax_row_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Max_row(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Max_row()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Max_row()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(203);\"", "", "", "", "", edtavCtlmax_row_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock2_Internalname, "REC_CNT", "", "", lblTextblock2_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlrec_cnt_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Rec_cnt(), (byte)(10), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Rec_cnt()), "ZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Rec_cnt()), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(208);\"", "", "", "", "", edtavCtlrec_cnt_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock3_Internalname, "PAGE_KBN", "", "", lblTextblock3_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock4_Internalname, "PAGE_NO", "", "", lblTextblock4_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_no_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(218);\"", "", "", "", "", edtavCtlpage_no_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock5_Internalname, "PAGE01", "", "", lblTextblock5_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage01_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page01(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page01()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page01()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(223);\"", "", "", "", "", edtavCtlpage01_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock6_Internalname, "PAGE02", "", "", lblTextblock6_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage02_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page02(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page02()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page02()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(228);\"", "", "", "", "", edtavCtlpage02_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock7_Internalname, "PAGE03", "", "", lblTextblock7_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage03_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page03(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page03()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page03()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(233);\"", "", "", "", "", edtavCtlpage03_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock8_Internalname, "PAGE04", "", "", lblTextblock8_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock9_Internalname, "PAGE05", "", "", lblTextblock9_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage05_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page05(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page05()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page05()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(243);\"", "", "", "", "", edtavCtlpage05_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock10_Internalname, "PAGE06", "", "", lblTextblock10_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage06_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page06(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page06()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page06()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(248);\"", "", "", "", "", edtavCtlpage06_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock11_Internalname, "PAGE07", "", "", lblTextblock11_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage07_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page07(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page07()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page07()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(253);\"", "", "", "", "", edtavCtlpage07_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock12_Internalname, "PAGE08", "", "", lblTextblock12_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage08_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page08(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page08()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page08()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(258);\"", "", "", "", "", edtavCtlpage08_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock13_Internalname, "PAGE09", "", "", lblTextblock13_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock14_Internalname, "PAGE10", "", "", lblTextblock14_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage10_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page10(), (byte)(4), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page10()), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page10()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(268);\"", "", "", "", "", edtavCtlpage10_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock15_Internalname, "PAGE_DISP01", "", "", lblTextblock15_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp01_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp01(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp01()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp01()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(273);\"", "", "", "", "", edtavCtlpage_disp01_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock16_Internalname, "PAGE_DISP02", "", "", lblTextblock16_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp02_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp02(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp02()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp02()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(278);\"", "", "", "", "", edtavCtlpage_disp02_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock17_Internalname, "PAGE_DISP03", "", "", lblTextblock17_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp03_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp03(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp03()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp03()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(283);\"", "", "", "", "", edtavCtlpage_disp03_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock18_Internalname, "PAGE_DISP04", "", "", lblTextblock18_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock19_Internalname, "PAGE_DISP05", "", "", lblTextblock19_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp05_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp05(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp05()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp05()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(293);\"", "", "", "", "", edtavCtlpage_disp05_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock20_Internalname, "PAGE_DISP06", "", "", lblTextblock20_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp06_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp06(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp06()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp06()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(298);\"", "", "", "", "", edtavCtlpage_disp06_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock21_Internalname, "PAGE_DISP07", "", "", lblTextblock21_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp07_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp07(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp07()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp07()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(303);\"", "", "", "", "", edtavCtlpage_disp07_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock22_Internalname, "PAGE_DISP08", "", "", lblTextblock22_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp08_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp08(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp08()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp08()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(308);\"", "", "", "", "", edtavCtlpage_disp08_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock23_Internalname, "PAGE_DISP09", "", "", lblTextblock23_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock24_Internalname, "PAGE_DISP10", "", "", lblTextblock24_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp10_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp10(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp10()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp10()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(318);\"", "", "", "", "", edtavCtlpage_disp10_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock25_Internalname, "PAGE_DISP_BACK", "", "", lblTextblock25_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp_back_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp_back(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp_back()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp_back()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(323);\"", "", "", "", "", edtavCtlpage_disp_back_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock26_Internalname, "PAGE_DISP_NEXT", "", "", lblTextblock26_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlpage_disp_next_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp_next(), (byte)(1), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp_next()), "9")) : localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_disp_next()), "9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(328);\"", "", "", "", "", edtavCtlpage_disp_next_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock27_Internalname, "PAGE_DISP_AREA", "", "", lblTextblock27_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_198_0T2e( true) ;
      }
      else
      {
         wb_table3_198_0T2e( false) ;
      }
   }
   ...
   public void wb_table1_2_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table4_6_0T2( true) ;
      }
      else
      {
         wb_table4_6_0T2( false) ;
      }
      return  ;
   }

   public void wb_table4_6_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table4_6_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table5_12_0T2( true) ;
      }
      else
      {
         wb_table5_12_0T2( false) ;
      }
      return  ;
   }

   public void wb_table5_12_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td valign=\"top\"  style=\"height:100%\">") ;
         wb_table6_22_0T2( true) ;
      }
      else
      {
         wb_table6_22_0T2( false) ;
      }
      return  ;
   }

   public void wb_table6_22_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_6_0T2e( true) ;
      }
      else
      {
         wb_table4_6_0T2e( false) ;
      }
   }

   public void wb_table6_22_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table7_25_0T2( true) ;
      }
      else
      {
         wb_table7_25_0T2( false) ;
      }
      return  ;
   }

   public void wb_table7_25_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table6_22_0T2e( true) ;
      }
      else
      {
         wb_table6_22_0T2e( false) ;
      }
   }

   public void wb_table7_25_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table8_28_0T2( true) ;
      }
      else
      {
         wb_table8_28_0T2( false) ;
      }
      return  ;
   }

   public void wb_table8_28_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table9_50_0T2( true) ;
      }
      else
      {
         wb_table9_50_0T2( false) ;
      }
      return  ;
   }

   public void wb_table9_50_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"text-align:"+httpContext.getCssProperty( "Align", "right")+"\">") ;
         wb_table10_142_0T2( true) ;
      }
      else
      {
         wb_table10_142_0T2( false) ;
      }
      return  ;
   }

   public void wb_table10_142_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td colspan=\"2\" >") ;
         wb_table11_155_0T2( true) ;
      }
      else
      {
         wb_table11_155_0T2( false) ;
      }
      return  ;
   }

   public void wb_table11_155_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
      ...
      if ( wbEnd == 171 )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table7_25_0T2e( true) ;
      }
      else
      {
         wb_table7_25_0T2e( false) ;
      }
   }

   public void wb_table11_155_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table12_158_0T2( true) ;
      }
      else
      {
         wb_table12_158_0T2( false) ;
      }
      return  ;
   }

   public void wb_table12_158_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table11_155_0T2e( true) ;
      }
      else
      {
         wb_table11_155_0T2e( false) ;
      }
   }

   public void wb_table12_158_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock34_Internalname, "行", "", "", lblTextblock34_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:200px\">") ;
         /* Text block */
         ClassString = "TextBlockGridHeader" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock30_Internalname, "ユーザーID", "", "", lblTextblock30_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:300px\">") ;
         /* Text block */
         ClassString = "TextBlockGridHeader" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock31_Internalname, "氏名", "", "", lblTextblock31_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:100px\">") ;
         /* Text block */
         ClassString = "TextBlockGridHeader" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock33_Internalname, "削除フラグ", "", "", lblTextblock33_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table12_158_0T2e( true) ;
      }
      else
      {
         wb_table12_158_0T2e( false) ;
      }
   }

   public void wb_table10_142_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock29_Internalname, "行番号：", "", "", lblTextblock29_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV10D_LINE", AV10D_LINE);
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavD_line_Internalname, GXutil.rtrim( AV10D_LINE), GXutil.rtrim( localUtil.format( AV10D_LINE, "XXXX")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(147);\"", "", "", "", "", edtavD_line_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock28_Internalname, "編集（F7）", "", "", lblTextblock28_Jsonclick, "E\\'BTN_EDIT\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table10_142_0T2e( true) ;
      }
      else
      {
         wb_table10_142_0T2e( false) ;
      }
   }

   public void wb_table9_50_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_rec_cnt_Internalname, lblTxt_rec_cnt_Caption, "", "", lblTxt_rec_cnt_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table13_56_0T2( true) ;
      }
      else
      {
         wb_table13_56_0T2( false) ;
      }
      return  ;
   }

   public void wb_table13_56_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table9_50_0T2e( true) ;
      }
      else
      {
         wb_table9_50_0T2e( false) ;
      }
   }

   public void wb_table13_56_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table14_59_0T2( true) ;
      }
      else
      {
         wb_table14_59_0T2( false) ;
      }
      return  ;
   }

   public void wb_table14_59_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:46px\">") ;
         wb_table15_65_0T2( true) ;
      }
      else
      {
         wb_table15_65_0T2( false) ;
      }
      return  ;
   }

   public void wb_table15_65_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table16_71_0T2( true) ;
      }
      else
      {
         wb_table16_71_0T2( false) ;
      }
      return  ;
   }

   public void wb_table16_71_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table17_77_0T2( true) ;
      }
      else
      {
         wb_table17_77_0T2( false) ;
      }
      return  ;
   }

   public void wb_table17_77_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table18_83_0T2( true) ;
      }
      else
      {
         wb_table18_83_0T2( false) ;
      }
      return  ;
   }

   public void wb_table18_83_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table19_89_0T2( true) ;
      }
      else
      {
         wb_table19_89_0T2( false) ;
      }
      return  ;
   }

   public void wb_table19_89_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table20_95_0T2( true) ;
      }
      else
      {
         wb_table20_95_0T2( false) ;
      }
      return  ;
   }

   public void wb_table20_95_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table21_101_0T2( true) ;
      }
      else
      {
         wb_table21_101_0T2( false) ;
      }
      return  ;
   }

   public void wb_table21_101_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table22_107_0T2( true) ;
      }
      else
      {
         wb_table22_107_0T2( false) ;
      }
      return  ;
   }

   public void wb_table22_107_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table23_113_0T2( true) ;
      }
      else
      {
         wb_table23_113_0T2( false) ;
      }
      return  ;
   }

   public void wb_table23_113_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table24_119_0T2( true) ;
      }
      else
      {
         wb_table24_119_0T2( false) ;
      }
      return  ;
   }

   public void wb_table24_119_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table25_125_0T2( true) ;
      }
      else
      {
         wb_table25_125_0T2( false) ;
      }
      return  ;
   }

   public void wb_table25_125_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table26_131_0T2( true) ;
      }
      else
      {
         wb_table26_131_0T2( false) ;
      }
      return  ;
   }

   public void wb_table26_131_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table27_137_0T2( true) ;
      }
      else
      {
         wb_table27_137_0T2( false) ;
      }
      return  ;
   }

   public void wb_table27_137_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table13_56_0T2e( true) ;
      }
      else
      {
         wb_table13_56_0T2e( false) ;
      }
   }

   public void wb_table27_137_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_last_Internalname, "最後へ", "", "", lblTxt_last_Jsonclick, "E\\'PAGE_LAST\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table27_137_0T2e( true) ;
      }
      else
      {
         wb_table27_137_0T2e( false) ;
      }
   }

   public void wb_table26_131_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_next_Internalname, "次へ", "", "", lblTxt_next_Jsonclick, "E\\'PAGE_NEXT\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table26_131_0T2e( true) ;
      }
      else
      {
         wb_table26_131_0T2e( false) ;
      }
   }

   public void wb_table25_125_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page10_Internalname, lblTxt_page10_Caption, "", "", lblTxt_page10_Jsonclick, "E\\'PAGE10\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table25_125_0T2e( true) ;
      }
      else
      {
         wb_table25_125_0T2e( false) ;
      }
   }

   public void wb_table24_119_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page09_Internalname, lblTxt_page09_Caption, "", "", lblTxt_page09_Jsonclick, "E\\'PAGE09\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table24_119_0T2e( true) ;
      }
      else
      {
         wb_table24_119_0T2e( false) ;
      }
   }

   public void wb_table23_113_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page08_Internalname, lblTxt_page08_Caption, "", "", lblTxt_page08_Jsonclick, "E\\'PAGE08\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table23_113_0T2e( true) ;
      }
      else
      {
         wb_table23_113_0T2e( false) ;
      }
   }

   public void wb_table22_107_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page07_Internalname, lblTxt_page07_Caption, "", "", lblTxt_page07_Jsonclick, "E\\'PAGE07\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table22_107_0T2e( true) ;
      }
      else
      {
         wb_table22_107_0T2e( false) ;
      }
   }

   public void wb_table21_101_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page06_Internalname, lblTxt_page06_Caption, "", "", lblTxt_page06_Jsonclick, "E\\'PAGE06\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table21_101_0T2e( true) ;
      }
      else
      {
         wb_table21_101_0T2e( false) ;
      }
   }

   public void wb_table20_95_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page05_Internalname, lblTxt_page05_Caption, "", "", lblTxt_page05_Jsonclick, "E\\'PAGE05\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table20_95_0T2e( true) ;
      }
      else
      {
         wb_table20_95_0T2e( false) ;
      }
   }

   public void wb_table19_89_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page04_Internalname, lblTxt_page04_Caption, "", "", lblTxt_page04_Jsonclick, "E\\'PAGE04\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table19_89_0T2e( true) ;
      }
      else
      {
         wb_table19_89_0T2e( false) ;
      }
   }

   public void wb_table18_83_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page03_Internalname, lblTxt_page03_Caption, "", "", lblTxt_page03_Jsonclick, "E\\'PAGE03\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table18_83_0T2e( true) ;
      }
      else
      {
         wb_table18_83_0T2e( false) ;
      }
   }

   public void wb_table17_77_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page02_Internalname, lblTxt_page02_Caption, "", "", lblTxt_page02_Jsonclick, "E\\'PAGE02\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table17_77_0T2e( true) ;
      }
      else
      {
         wb_table17_77_0T2e( false) ;
      }
   }

   public void wb_table16_71_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page01_Internalname, lblTxt_page01_Caption, "", "", lblTxt_page01_Jsonclick, "E\\'PAGE01\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table16_71_0T2e( true) ;
      }
      else
      {
         wb_table16_71_0T2e( false) ;
      }
   }

   public void wb_table15_65_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_back_Internalname, "前へ", "", "", lblTxt_back_Jsonclick, "E\\'PAGE_BACK\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table15_65_0T2e( true) ;
      }
      else
      {
         wb_table15_65_0T2e( false) ;
      }
   }

   public void wb_table14_59_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_first_Internalname, "最初へ", "", "", lblTxt_first_Jsonclick, "E\\'PAGE_FIRST\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table14_59_0T2e( true) ;
      }
      else
      {
         wb_table14_59_0T2e( false) ;
      }
   }

   public void wb_table8_28_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:265px\">") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV11D_TAM07_USER_ID", AV11D_TAM07_USER_ID);
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 32,'',false,'" + sGXsfl_171_idx + "',0)\"" ;
         ClassString = "AttributeImeOff" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_user_id_Internalname, GXutil.rtrim( AV11D_TAM07_USER_ID), GXutil.rtrim( localUtil.format( AV11D_TAM07_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(32);\"", "", "", "", "", edtavD_tam07_user_id_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\"  style=\"width:70px\">") ;
         ...
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_user_nm_Internalname, GXutil.rtrim( AV12D_TAM07_USER_NM), GXutil.rtrim( localUtil.format( AV12D_TAM07_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(35);\"", "", "", "", "", edtavD_tam07_user_nm_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"Submit\" colspan=\"4\"  style=\"text-align:"+httpContext.getCssProperty( "Align", "center")+"\">") ;
         wb_table28_38_0T2( true) ;
      }
      else
      {
         wb_table28_38_0T2( false) ;
      }
      return  ;
   }

   public void wb_table28_38_0T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table8_28_0T2e( true) ;
      }
      else
      {
         wb_table8_28_0T2e( false) ;
      }
   }

   public void wb_table28_38_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock45_Internalname, "検索（F5）", "", "", lblTextblock45_Jsonclick, "E\\'BTN_SRCH\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock44_Internalname, "クリア（F6）", "", "", lblTextblock44_Jsonclick, "E\\'BTN_CLER\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table28_38_0T2e( true) ;
      }
      else
      {
         wb_table28_38_0T2e( false) ;
      }
   }

   public void wb_table5_12_0T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_reg_Internalname, "新規（F3）", "", "", lblTxt_btn_reg_Jsonclick, "E\\'BTN_REG\\'.", StyleString, ClassString, 5, "", lblTxt_btn_reg_Visible, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         /* Text block */
         ClassString = "TextBlockBtnList100_Disabled" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_reg2_Internalname, "新規（F3）", "", "", lblTxt_btn_reg2_Jsonclick, "", StyleString, ClassString, 0, "", lblTxt_btn_reg2_Visible, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock43_Internalname, "CSV出力（F4）", "", "", lblTextblock43_Jsonclick, "E\\'BTN_CSV\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_12_0T2e( true) ;
      }
      else
      {
         wb_table5_12_0T2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?14591034");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a206_wp01_user_mst_list.js", "?14591034");
   ...
   public void sendrow_1712( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_171_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         StyleString = "" ;
         ROClassString = ClassString ;
         Grid1Row.AddColumnProperties("edit", 1, httpContext.isAjaxCallMode( ), new Object[] {edtTAM07_USER_ID_Internalname,GXutil.rtrim( A8TAM07_USER_ID),"","","","","","",edtTAM07_USER_ID_Jsonclick,new Integer(0),ClassString,StyleString,ROClassString,new Integer(1),new Integer(0),new Integer(0),new Integer(10),"chr",new Integer(1),"row",new Integer(128),new Integer(0),new Integer(0),new Integer(171),new Integer(1),new Integer(1),new Boolean(true),"left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         StyleString = "" ;
         ROClassString = ClassString ;
         Grid1Row.AddColumnProperties("edit", 1, httpContext.isAjaxCallMode( ), new Object[] {edtTAM07_USER_NM_Internalname,GXutil.rtrim( A2TAM07_USER_NM),"","","","","","",edtTAM07_USER_NM_Jsonclick,new Integer(0),ClassString,StyleString,ROClassString,new Integer(1),new Integer(0),new Integer(0),new Integer(30),"chr",new Integer(1),"row",new Integer(30),new Integer(0),new Integer(0),new Integer(171),new Integer(1),new Integer(1),new Boolean(true),"left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
   ...
   public void init_default_properties( )
   {
      ...
      edtavD_tam07_user_nm_Internalname = "vD_TAM07_USER_NM" ;
      ...
      edtavH_tam07_user_id_Internalname = "vH_TAM07_USER_ID" ;
      edtavH_tam07_user_nm_Internalname = "vH_TAM07_USER_NM" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavD_tam07_user_nm_Jsonclick = "" ;
      ...
      edtavH_tam07_user_nm_Jsonclick = "" ;
      edtavH_tam07_user_id_Jsonclick = "" ;
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S26541 */
                  S26541 ();
                  break;
         }
      }
   ...
   public void initialize( )
   {
      ...
      lV17H_TAM07_USER_ID = "" ;
      lV18H_TAM07_USER_NM = "" ;
      H000T2_A16TAM07_DEL_FLG = new String[] {""} ;
      H000T2_n16TAM07_DEL_FLG = new boolean[] {false} ;
      H000T2_A2TAM07_USER_NM = new String[] {""} ;
      H000T2_n2TAM07_USER_NM = new boolean[] {false} ;
      H000T2_A8TAM07_USER_ID = new String[] {""} ;
      ...
      AV28W_SESSION = httpContext.getWebSession();
      AV27W_RTN_MSG = "" ;
      AV26W_MSG = "" ;
      AV29W_TAM07_USER_ID = "" ;
      H000T4_A2TAM07_USER_NM = new String[] {""} ;
      H000T4_n2TAM07_USER_NM = new boolean[] {false} ;
      H000T4_A8TAM07_USER_ID = new String[] {""} ;
      ...
      GXt_char2 = "" ;
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new a206_wp01_user_mst_list__default(),
         new Object[] {
             new Object[] {
            H000T2_A16TAM07_DEL_FLG, H000T2_n16TAM07_DEL_FLG, H000T2_A2TAM07_USER_NM, H000T2_n2TAM07_USER_NM, H000T2_A8TAM07_USER_ID
            }
            , new Object[] {
            H000T3_AGRID1_nRecordCount
            }
            , new Object[] {
            H000T4_A2TAM07_USER_NM, H000T4_n2TAM07_USER_NM, H000T4_A8TAM07_USER_ID
            }
         }
      );
   ...
   private String edtavD_tam07_user_nm_Internalname ;
   private String AV10D_LINE ;
   private String edtavD_line_Internalname ;
   private String edtavH_init_flg_Internalname ;
   private String edtavH_srch_flg_Internalname ;
   private String edtavH_tam07_user_id_Internalname ;
   private String edtavH_tam07_user_nm_Internalname ;
   ...
   private String edtavH_tam07_user_id_Jsonclick ;
   private String edtavH_tam07_user_nm_Jsonclick ;
   ...
   private String edtavD_tam07_user_nm_Jsonclick ;
   ...
   private String AV17H_TAM07_USER_ID ;
   private String AV18H_TAM07_USER_NM ;
   private String A16TAM07_DEL_FLG ;
   private String A8TAM07_USER_ID ;
   private String A2TAM07_USER_NM ;
   private String AV7D_GRD_DEL ;
   private String lV17H_TAM07_USER_ID ;
   private String lV18H_TAM07_USER_NM ;
   private String AV11D_TAM07_USER_ID ;
   private String AV12D_TAM07_USER_NM ;
   ...
   private String AV27W_RTN_MSG ;
   private String AV26W_MSG ;
   private String AV29W_TAM07_USER_ID ;
   ...
   private String[] H000T2_A16TAM07_DEL_FLG ;
   private boolean[] H000T2_n16TAM07_DEL_FLG ;
   private String[] H000T2_A2TAM07_USER_NM ;
   private boolean[] H000T2_n2TAM07_USER_NM ;
   private String[] H000T2_A8TAM07_USER_ID ;
   private int[] H000T3_AGRID1_nRecordCount ;
   private String[] H000T4_A2TAM07_USER_NM ;
   private boolean[] H000T4_n2TAM07_USER_NM ;
   private String[] H000T4_A8TAM07_USER_ID ;
   private com.genexus.webpanels.WebSession AV28W_SESSION ;
...
final  class a206_wp01_user_mst_list__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000T2( com.genexus.internet.HttpContext httpContext ,
                                          String AV17H_TAM07_USER_ID ,
                                          String AV18H_TAM07_USER_NM ,
                                          String A8TAM07_USER_ID ,
                                          String A2TAM07_USER_NM ,
                                          String AV16H_SRCH_FLG )
   {
      String sWhereString = "" ;
      String scmdbuf ;
      byte[] GXv_int9 ;
      ...
      scmdbuf = "SELECT `TAM07_DEL_FLG`, `TAM07_USER_NM`, `TAM07_USER_ID` FROM `TAM07_USER`" ;
      scmdbuf = scmdbuf + " WHERE (? = '1')" ;
      if ( ! (GXutil.strcmp("", AV17H_TAM07_USER_ID)==0) )
      {
      ...
      if ( ! (GXutil.strcmp("", AV18H_TAM07_USER_NM)==0) )
      {
   ...
   protected Object[] conditional_H000T3( com.genexus.internet.HttpContext httpContext ,
                                          String AV17H_TAM07_USER_ID ,
                                          String AV18H_TAM07_USER_NM ,
                                          String A8TAM07_USER_ID ,
                                          String A2TAM07_USER_NM ,
                                          String AV16H_SRCH_FLG )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM `TAM07_USER`" ;
      scmdbuf = scmdbuf + " WHERE (? = '1')" ;
      if ( ! (GXutil.strcmp("", AV17H_TAM07_USER_ID)==0) )
      {
         sWhereString = sWhereString + " and (`TAM07_USER_ID` like CONCAT(?, '%'))" ;
   ...
   protected Object[] conditional_H000T4( com.genexus.internet.HttpContext httpContext ,
                                          String AV17H_TAM07_USER_ID ,
                                          String AV18H_TAM07_USER_NM ,
                                          String A8TAM07_USER_ID ,
                                          String A2TAM07_USER_NM )
   {
      ...
      scmdbuf = "SELECT `TAM07_USER_NM`, `TAM07_USER_ID` FROM `TAM07_USER`" ;
      if ( ! (GXutil.strcmp("", AV17H_TAM07_USER_ID)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000T2(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] );
            case 1 :
                  return conditional_H000T3(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] );
            case 2 :
                  return conditional_H000T4(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] );
      }
   ...
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H000T4", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,true )
      };
   }
