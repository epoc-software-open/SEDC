...
public final  class promptmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm032( )
   {
      ...
      httpContext.AddJavascriptSource("promptmasterpage.js", "?1457361");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( getDataAreaObject().getForm().getJscriptsrc().item(idxLst)), "?1457362");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("promptmasterpage.js", "?1457362");
      }
