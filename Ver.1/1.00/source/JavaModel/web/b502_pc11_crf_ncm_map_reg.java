/*
       ...
       Generated on: July 3, 2017 14:52:8.23
...
public final  class b502_pc11_crf_ncm_map_reg extends GXProcedure
{
   ...
   public void S1175( )
   {
      ...
      {
         A261TBM41_CRF_ITEM_GRP_CD = P002M2_A261TBM41_CRF_ITEM_GRP_CD[0] ;
         A378TBM41_CRF_ITEM_GRP_DIV = P002M2_A378TBM41_CRF_ITEM_GRP_DIV[0] ;
         A260TBM41_CRF_ID = P002M2_A260TBM41_CRF_ID[0] ;
         A259TBM41_STUDY_ID = P002M2_A259TBM41_STUDY_ID[0] ;
         A264TBM41_CRT_DATETIME = P002M2_A264TBM41_CRT_DATETIME[0] ;
         n264TBM41_CRT_DATETIME = P002M2_n264TBM41_CRT_DATETIME[0] ;
         A265TBM41_CRT_USER_ID = P002M2_A265TBM41_CRT_USER_ID[0] ;
         n265TBM41_CRT_USER_ID = P002M2_n265TBM41_CRT_USER_ID[0] ;
         A266TBM41_CRT_PROG_NM = P002M2_A266TBM41_CRT_PROG_NM[0] ;
         n266TBM41_CRT_PROG_NM = P002M2_n266TBM41_CRT_PROG_NM[0] ;
         A270TBM41_UPD_CNT = P002M2_A270TBM41_UPD_CNT[0] ;
         n270TBM41_UPD_CNT = P002M2_n270TBM41_UPD_CNT[0] ;
         A262TBM41_NCM_METADATA_ID = P002M2_A262TBM41_NCM_METADATA_ID[0] ;
         n262TBM41_NCM_METADATA_ID = P002M2_n262TBM41_NCM_METADATA_ID[0] ;
         A263TBM41_DEL_FLG = P002M2_A263TBM41_DEL_FLG[0] ;
         n263TBM41_DEL_FLG = P002M2_n263TBM41_DEL_FLG[0] ;
         A267TBM41_UPD_DATETIME = P002M2_A267TBM41_UPD_DATETIME[0] ;
         n267TBM41_UPD_DATETIME = P002M2_n267TBM41_UPD_DATETIME[0] ;
         A268TBM41_UPD_USER_ID = P002M2_A268TBM41_UPD_USER_ID[0] ;
         n268TBM41_UPD_USER_ID = P002M2_n268TBM41_UPD_USER_ID[0] ;
         A269TBM41_UPD_PROG_NM = P002M2_A269TBM41_UPD_PROG_NM[0] ;
         n269TBM41_UPD_PROG_NM = P002M2_n269TBM41_UPD_PROG_NM[0] ;
         if ( GXutil.strcmp(A378TBM41_CRF_ITEM_GRP_DIV, (String)AV14W_CSV_COL.elementAt(-1+3)) == 0 )
         {
            if ( GXutil.strcmp(A261TBM41_CRF_ITEM_GRP_CD, (String)AV14W_CSV_COL.elementAt(-1+4)) == 0 )
            {
               AV41GXLvl89 = (byte)(1) ;
               AV37P_LOGKBN = "UPD" ;
               AV30W_CRT_DATETIME = A264TBM41_CRT_DATETIME ;
               AV31W_CRT_USER_ID = A265TBM41_CRT_USER_ID ;
               AV32W_CRT_PROG_NM = A266TBM41_CRT_PROG_NM ;
               AV29W_UPD_CNT = (long)(A270TBM41_UPD_CNT+1) ;
               A262TBM41_NCM_METADATA_ID = (String)AV14W_CSV_COL.elementAt(-1+5) ;
               n262TBM41_NCM_METADATA_ID = false ;
               A263TBM41_DEL_FLG = (String)AV14W_CSV_COL.elementAt(-1+6) ;
               n263TBM41_DEL_FLG = false ;
               A267TBM41_UPD_DATETIME = GXutil.now( ) ;
               n267TBM41_UPD_DATETIME = false ;
               A268TBM41_UPD_USER_ID = AV27W_USER_ID ;
               n268TBM41_UPD_USER_ID = false ;
               A269TBM41_UPD_PROG_NM = AV40Pgmname ;
               n269TBM41_UPD_PROG_NM = false ;
               A270TBM41_UPD_CNT = AV29W_UPD_CNT ;
               n270TBM41_UPD_CNT = false ;
               Gx_ope = "Update" ;
               Gx_etb = "TBM41_CRF_NCM_MAP" ;
               /* Using cursor P002M3 */
               pr_default.execute(1, new Object[] {new Boolean(n270TBM41_UPD_CNT), new Long(A270TBM41_UPD_CNT), new Boolean(n262TBM41_NCM_METADATA_ID), A262TBM41_NCM_METADATA_ID, new Boolean(n263TBM41_DEL_FLG), A263TBM41_DEL_FLG, new Boolean(n267TBM41_UPD_DATETIME), A267TBM41_UPD_DATETIME, new Boolean(n268TBM41_UPD_USER_ID), A268TBM41_UPD_USER_ID, new Boolean(n269TBM41_UPD_PROG_NM), A269TBM41_UPD_PROG_NM, new Long(A259TBM41_STUDY_ID), new Short(A260TBM41_CRF_ID), A378TBM41_CRF_ITEM_GRP_DIV, A261TBM41_CRF_ITEM_GRP_CD});
            }
         }
      ...
      if ( AV41GXLvl89 == 0 )
      {
         ...
         */
         A259TBM41_STUDY_ID = GXutil.lval( (String)AV14W_CSV_COL.elementAt(-1+1)) ;
         A260TBM41_CRF_ID = (short)(GXutil.lval( (String)AV14W_CSV_COL.elementAt(-1+2))) ;
         A378TBM41_CRF_ITEM_GRP_DIV = (String)AV14W_CSV_COL.elementAt(-1+3) ;
         A261TBM41_CRF_ITEM_GRP_CD = (String)AV14W_CSV_COL.elementAt(-1+4) ;
         A262TBM41_NCM_METADATA_ID = (String)AV14W_CSV_COL.elementAt(-1+5) ;
         n262TBM41_NCM_METADATA_ID = false ;
         A263TBM41_DEL_FLG = (String)AV14W_CSV_COL.elementAt(-1+6) ;
         n263TBM41_DEL_FLG = false ;
         ...
         A265TBM41_CRT_USER_ID = AV27W_USER_ID ;
         n265TBM41_CRT_USER_ID = false ;
         A266TBM41_CRT_PROG_NM = AV40Pgmname ;
         ...
         Gx_etb = "TBM41_CRF_NCM_MAP" ;
         /* Using cursor P002M4 */
         pr_default.execute(2, new Object[] {new Long(A259TBM41_STUDY_ID), new Short(A260TBM41_CRF_ID), A378TBM41_CRF_ITEM_GRP_DIV, A261TBM41_CRF_ITEM_GRP_CD, new Boolean(n262TBM41_NCM_METADATA_ID), A262TBM41_NCM_METADATA_ID, new Boolean(n263TBM41_DEL_FLG), A263TBM41_DEL_FLG, new Boolean(n264TBM41_CRT_DATETIME), A264TBM41_CRT_DATETIME, new Boolean(n265TBM41_CRT_USER_ID), A265TBM41_CRT_USER_ID, new Boolean(n266TBM41_CRT_PROG_NM), A266TBM41_CRT_PROG_NM, new Boolean(n267TBM41_UPD_DATETIME), A267TBM41_UPD_DATETIME, new Boolean(n268TBM41_UPD_USER_ID), A268TBM41_UPD_USER_ID, new Boolean(n269TBM41_UPD_PROG_NM), A269TBM41_UPD_PROG_NM, new Boolean(n270TBM41_UPD_CNT), new Long(A270TBM41_UPD_CNT)});
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P002M2_A261TBM41_CRF_ITEM_GRP_CD = new String[] {""} ;
      P002M2_A378TBM41_CRF_ITEM_GRP_DIV = new String[] {""} ;
      P002M2_A260TBM41_CRF_ID = new short[1] ;
      P002M2_A259TBM41_STUDY_ID = new long[1] ;
      P002M2_A264TBM41_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P002M2_n264TBM41_CRT_DATETIME = new boolean[] {false} ;
      P002M2_A265TBM41_CRT_USER_ID = new String[] {""} ;
      P002M2_n265TBM41_CRT_USER_ID = new boolean[] {false} ;
      P002M2_A266TBM41_CRT_PROG_NM = new String[] {""} ;
      P002M2_n266TBM41_CRT_PROG_NM = new boolean[] {false} ;
      P002M2_A270TBM41_UPD_CNT = new long[1] ;
      P002M2_n270TBM41_UPD_CNT = new boolean[] {false} ;
      P002M2_A262TBM41_NCM_METADATA_ID = new String[] {""} ;
      P002M2_n262TBM41_NCM_METADATA_ID = new boolean[] {false} ;
      P002M2_A263TBM41_DEL_FLG = new String[] {""} ;
      P002M2_n263TBM41_DEL_FLG = new boolean[] {false} ;
      P002M2_A267TBM41_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P002M2_n267TBM41_UPD_DATETIME = new boolean[] {false} ;
      P002M2_A268TBM41_UPD_USER_ID = new String[] {""} ;
      P002M2_n268TBM41_UPD_USER_ID = new boolean[] {false} ;
      P002M2_A269TBM41_UPD_PROG_NM = new String[] {""} ;
      P002M2_n269TBM41_UPD_PROG_NM = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b502_pc11_crf_ncm_map_reg__default(),
         new Object[] {
             new Object[] {
            P002M2_A261TBM41_CRF_ITEM_GRP_CD, P002M2_A378TBM41_CRF_ITEM_GRP_DIV, P002M2_A260TBM41_CRF_ID, P002M2_A259TBM41_STUDY_ID, P002M2_A264TBM41_CRT_DATETIME, P002M2_n264TBM41_CRT_DATETIME, P002M2_A265TBM41_CRT_USER_ID, P002M2_n265TBM41_CRT_USER_ID, P002M2_A266TBM41_CRT_PROG_NM, P002M2_n266TBM41_CRT_PROG_NM,
            P002M2_A270TBM41_UPD_CNT, P002M2_n270TBM41_UPD_CNT, P002M2_A262TBM41_NCM_METADATA_ID, P002M2_n262TBM41_NCM_METADATA_ID, P002M2_A263TBM41_DEL_FLG, P002M2_n263TBM41_DEL_FLG, P002M2_A267TBM41_UPD_DATETIME, P002M2_n267TBM41_UPD_DATETIME, P002M2_A268TBM41_UPD_USER_ID, P002M2_n268TBM41_UPD_USER_ID,
            P002M2_A269TBM41_UPD_PROG_NM, P002M2_n269TBM41_UPD_PROG_NM
            }
            , new Object[] {
            }
            , new Object[] {
   ...
   private String[] P002M2_A261TBM41_CRF_ITEM_GRP_CD ;
   private String[] P002M2_A378TBM41_CRF_ITEM_GRP_DIV ;
   private short[] P002M2_A260TBM41_CRF_ID ;
   private long[] P002M2_A259TBM41_STUDY_ID ;
   private java.util.Date[] P002M2_A264TBM41_CRT_DATETIME ;
   private boolean[] P002M2_n264TBM41_CRT_DATETIME ;
   private String[] P002M2_A265TBM41_CRT_USER_ID ;
   private boolean[] P002M2_n265TBM41_CRT_USER_ID ;
   private String[] P002M2_A266TBM41_CRT_PROG_NM ;
   private boolean[] P002M2_n266TBM41_CRT_PROG_NM ;
   private long[] P002M2_A270TBM41_UPD_CNT ;
   private boolean[] P002M2_n270TBM41_UPD_CNT ;
   private String[] P002M2_A262TBM41_NCM_METADATA_ID ;
   private boolean[] P002M2_n262TBM41_NCM_METADATA_ID ;
   private String[] P002M2_A263TBM41_DEL_FLG ;
   private boolean[] P002M2_n263TBM41_DEL_FLG ;
   private java.util.Date[] P002M2_A267TBM41_UPD_DATETIME ;
   private boolean[] P002M2_n267TBM41_UPD_DATETIME ;
   private String[] P002M2_A268TBM41_UPD_USER_ID ;
   private boolean[] P002M2_n268TBM41_UPD_USER_ID ;
   private String[] P002M2_A269TBM41_UPD_PROG_NM ;
   private boolean[] P002M2_n269TBM41_UPD_PROG_NM ;
...
final  class b502_pc11_crf_ncm_map_reg__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P002M2", "SELECT `TBM41_CRF_ITEM_GRP_CD`, `TBM41_CRF_ITEM_GRP_DIV`, `TBM41_CRF_ID`, `TBM41_STUDY_ID`, `TBM41_CRT_DATETIME`, `TBM41_CRT_USER_ID`, `TBM41_CRT_PROG_NM`, `TBM41_UPD_CNT`, `TBM41_NCM_METADATA_ID`, `TBM41_DEL_FLG`, `TBM41_UPD_DATETIME`, `TBM41_UPD_USER_ID`, `TBM41_UPD_PROG_NM` FROM `TBM41_CRF_NCM_MAP` WHERE `TBM41_STUDY_ID` = ? and `TBM41_CRF_ID` = ? ORDER BY `TBM41_STUDY_ID`, `TBM41_CRF_ID`  FOR UPDATE ",true, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
         ,new UpdateCursor("P002M3", "UPDATE `TBM41_CRF_NCM_MAP` SET `TBM41_UPD_CNT`=?, `TBM41_NCM_METADATA_ID`=?, `TBM41_DEL_FLG`=?, `TBM41_UPD_DATETIME`=?, `TBM41_UPD_USER_ID`=?, `TBM41_UPD_PROG_NM`=?  WHERE `TBM41_STUDY_ID` = ? AND `TBM41_CRF_ID` = ? AND `TBM41_CRF_ITEM_GRP_DIV` = ? AND `TBM41_CRF_ITEM_GRP_CD` = ?", GX_NOMASK + GX_MASKLOOPLOCK)
         ,new UpdateCursor("P002M4", "INSERT INTO `TBM41_CRF_NCM_MAP` (`TBM41_STUDY_ID`, `TBM41_CRF_ID`, `TBM41_CRF_ITEM_GRP_DIV`, `TBM41_CRF_ITEM_GRP_CD`, `TBM41_NCM_METADATA_ID`, `TBM41_DEL_FLG`, `TBM41_CRT_DATETIME`, `TBM41_CRT_USER_ID`, `TBM41_CRT_PROG_NM`, `TBM41_UPD_DATETIME`, `TBM41_UPD_USER_ID`, `TBM41_UPD_PROG_NM`, `TBM41_UPD_CNT`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", GX_NOMASK + GX_MASKLOOPLOCK)
      };
   }
