/*
       ...
       Generated on: July 3, 2017 15:3:56.47
...
public final  class b202_wp01_image_mst_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeText( "画像マスタメンテナンス（入力）") ;
      ...
      GXEncryptionTmp = GXutil.URLEncode(GXutil.rtrim(AV14P_IMAGE_CD)) ;
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("b202_wp01_image_mst") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey)+"\" class=\""+"Form"+"\">") ;
   ...
   public void start192( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         OldWebcomp2 = httpContext.cgiGet( "W0102") ;
         if ( (GXutil.strcmp("", WebComp_Webcomp2_Component)==0) && ! (GXutil.strcmp("", OldWebcomp2)==0) )
         {
            WebComp_Webcomp2 = WebUtils.getWebComponent(getClass(), "" + OldWebcomp2 + "_impl", remoteHandle, context);
            WebComp_Webcomp2_Component = OldWebcomp2 ;
            WebComp_Webcomp2.componentrestorestate("W0102", "");
         }
      }
      wbErr = false ;
      strup190( ) ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               else if ( GXutil.strcmp(sEvtType, "W") == 0 )
               {
                  ...
                  else if ( nCmpId == 102 )
                  {
                     ...
                     {
                        WebComp_Webcomp2.componentprocess("W0102", "", sEvt);
                     }
                     WebComp_Webcomp2_Component = OldWebcomp2 ;
                  }
               }
   ...
   public void strup190( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( localUtil.vcdtime( httpContext.cgiGet( edtavCtltbm11_crt_datetime_Internalname), (byte)(6), (byte)(0)) == 0 )
         {
            httpContext.GX_msglist.addItem(localUtil.getMessages().getMessage("GXM_baddatetime", new Object[] {"作成日時"}), 1, "CTLTBM11_CRT_DATETIME");
         ...
         if ( localUtil.vcdtime( httpContext.cgiGet( edtavCtltbm11_upd_datetime_Internalname), (byte)(6), (byte)(0)) == 0 )
         {
            httpContext.GX_msglist.addItem(localUtil.getMessages().getMessage("GXM_baddatetime", new Object[] {"更新日時"}), 1, "CTLTBM11_UPD_DATETIME");
   ...
   public void e15192( )
   {
      ...
      if ( GXutil.len( WebComp_Webcomp2_Component) != 0 )
      {
         WebComp_Webcomp2.componentprepare(new Object[] {"W0102",""});
   ...
   public void e16192( )
   {
      ...
      new a803_pc01_htmlescape(remoteHandle, context).execute( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_file_name(), GXv_char3) ;
      b202_wp01_image_mst_impl.this.GXt_char2 = GXv_char3[0] ;
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_IMAGE", AV5BC_IMAGE);
      lblTxt_file_name_Caption = GXt_char2 ;
   ...
   public void e17192( )
   {
      ...
      if ( new a402_pc02_btn_kengn_check(remoteHandle, context).executeUdp( "REG", AV12H_KNGN_FLG, "") )
      {
         ...
         else
         {
            ...
            GXt_char2 = AV28W_MSG ;
            GXv_char3[0] = GXt_char2 ;
            new b803_pc01_get_bcmsg(remoteHandle, context).execute( AV5BC_IMAGE.GetMessages(), (byte)(0), GXv_char3) ;
            b202_wp01_image_mst_impl.this.GXt_char2 = GXv_char3[0] ;
            AV28W_MSG = GXt_char2 ;
   ...
   public void S172( )
   {
      ...
      S182 ();
      if (returnInSub) return;
      GXv_boolean4[0] = AV25W_FILEUP_ERR_FLG ;
      ...
      new b202_pc01_image_mst_chk(remoteHandle, context).execute( AV5BC_IMAGE, AV30W_DEL_FLG, GXv_boolean4, GXv_objcol_SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem5, GXv_objcol_SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem6) ;
      b202_wp01_image_mst_impl.this.AV25W_FILEUP_ERR_FLG = GXv_boolean4[0] ;
      ...
      if ( ! (GXutil.strcmp("", AV14P_IMAGE_CD)==0) )
      {
         ...
         else
         {
            ...
            else
            {
               ...
               {
                  A8TAM07_USER_ID = H00193_A8TAM07_USER_ID[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A8TAM07_USER_ID", A8TAM07_USER_ID);
                  A2TAM07_USER_NM = H00193_A2TAM07_USER_NM[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A2TAM07_USER_NM", A2TAM07_USER_NM);
                  n2TAM07_USER_NM = H00193_n2TAM07_USER_NM[0] ;
                  AV47GXLvl467 = (byte)(1) ;
                  GXt_char2 = AV10D_UPD_USER_NM ;
                  GXv_char3[0] = GXt_char2 ;
                  new a803_pc01_htmlescape(remoteHandle, context).execute( A2TAM07_USER_NM, GXv_char3) ;
                  b202_wp01_image_mst_impl.this.GXt_char2 = GXv_char3[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A2TAM07_USER_NM", A2TAM07_USER_NM);
                  AV10D_UPD_USER_NM = GXt_char2 ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV10D_UPD_USER_NM", AV10D_UPD_USER_NM);
                  /* Exit For each command. Update data (if necessary), close cursors & exit. */
                  if (true) break;
                  /* Exiting from a For First loop. */
   ...
   public void S112( )
   {
      /* 'SUB_INIT' Routine */
      GXActiveErrHndl = 1 ;
      GXv_SdtA_LOGIN_SDT7[0] = AV17W_A_LOGIN_SDT;
      GXv_char3[0] = AV22W_ERRCD ;
      new a401_pc01_login_check(remoteHandle, context).execute( GXv_SdtA_LOGIN_SDT7, GXv_char3) ;
      AV17W_A_LOGIN_SDT = GXv_SdtA_LOGIN_SDT7[0] ;
      b202_wp01_image_mst_impl.this.AV22W_ERRCD = GXv_char3[0] ;
   ...
   public void S132( )
   {
      ...
      GXv_char8[0] = AV22W_ERRCD ;
      new a402_pc01_kengen_check(remoteHandle, context).execute( AV6C_APP_ID, GXv_char3, GXv_char8) ;
      b202_wp01_image_mst_impl.this.AV12H_KNGN_FLG = GXv_char3[0] ;
      b202_wp01_image_mst_impl.this.AV22W_ERRCD = GXv_char8[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12H_KNGN_FLG", AV12H_KNGN_FLG);
      if ( GXutil.strcmp(AV22W_ERRCD, "0") != 0 )
      {
         GXKey = context.getSiteKey( ) ;
   ...
   public void S212( )
   {
      ...
      {
         GXt_boolean9 = false ;
         GXv_boolean4[0] = GXt_boolean9 ;
         new a402_pc02_btn_kengn_check(remoteHandle, context).execute( "UPD", AV12H_KNGN_FLG, "", GXv_boolean4) ;
         b202_wp01_image_mst_impl.this.GXt_boolean9 = GXv_boolean4[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "AV12H_KNGN_FLG", AV12H_KNGN_FLG);
         ...
         GXt_boolean9 = false ;
         GXv_boolean4[0] = GXt_boolean9 ;
         new a402_pc02_btn_kengn_check(remoteHandle, context).execute( "DLT", AV12H_KNGN_FLG, "", GXv_boolean4) ;
         b202_wp01_image_mst_impl.this.GXt_boolean9 = GXv_boolean4[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "AV12H_KNGN_FLG", AV12H_KNGN_FLG);
      ...
      else
      {
         GXt_boolean9 = false ;
         GXv_boolean4[0] = GXt_boolean9 ;
         new a402_pc02_btn_kengn_check(remoteHandle, context).execute( "REG", AV12H_KNGN_FLG, "", GXv_boolean4) ;
         b202_wp01_image_mst_impl.this.GXt_boolean9 = GXv_boolean4[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "AV12H_KNGN_FLG", AV12H_KNGN_FLG);
   ...
   public void wb_table1_2_192( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table2_6_192( true) ;
      }
      else
      {
         wb_table2_6_192( false) ;
      }
      return  ;
   }

   public void wb_table2_6_192e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table2_6_192( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table3_12_192( true) ;
      }
      else
      {
         wb_table3_12_192( false) ;
      }
      return  ;
   }

   public void wb_table3_12_192e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table4_20_192( true) ;
      }
      else
      {
         wb_table4_20_192( false) ;
      }
      return  ;
   }

   public void wb_table4_20_192e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         wb_table5_34_192( true) ;
      }
      else
      {
         wb_table5_34_192( false) ;
      }
      return  ;
   }

   public void wb_table5_34_192e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table6_92_192( true) ;
      }
      else
      {
         wb_table6_92_192( false) ;
      }
      return  ;
   }

   public void wb_table6_92_192e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<td>") ;
         /* WebComponent */
         GxWebStd.gx_hidden_field( httpContext, "W0102"+"", GXutil.rtrim( WebComp_Webcomp2_Component));
         httpContext.writeText( "<div") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_6_192e( true) ;
      }
      else
      {
         wb_table2_6_192e( false) ;
      }
   }

   public void wb_table6_92_192( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_js_event_Internalname, lblTxt_js_event_Caption, "", "", lblTxt_js_event_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(1), "HLP_B202_WP01_IMAGE_MST.htm");
         ...
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV11H_INIT_FLG), GXutil.rtrim( localUtil.format( AV11H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(96);\"", "", "", "", "", edtavH_init_flg_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV13H_MODE", AV13H_MODE);
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_mode_Internalname, GXutil.rtrim( AV13H_MODE), GXutil.rtrim( localUtil.format( AV13H_MODE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(97);\"", "", "", "", "", edtavH_mode_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV12H_KNGN_FLG", AV12H_KNGN_FLG);
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV12H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV12H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(98);\"", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_file_name()", AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_file_name());
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 99,'',false,'',0)\"" ;
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm11_file_name_Internalname, GXutil.rtrim( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_file_name()), GXutil.rtrim( localUtil.format( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_file_name(), "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(99);\"", "", "", "", "", edtavCtltbm11_file_name_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table6_92_192e( true) ;
      }
      else
      {
         wb_table6_92_192e( false) ;
      }
   }

   public void wb_table5_34_192( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table7_40_192( true) ;
      }
      else
      {
         wb_table7_40_192( false) ;
      }
      return  ;
   }

   public void wb_table7_40_192e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_34_192e( true) ;
      }
      else
      {
         wb_table5_34_192e( false) ;
      }
   }

   public void wb_table7_40_192( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         ClassString = "Image" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgImage4_Internalname, context.getHttpContext().getImagePath( "d5d6aaa9-3daa-4e25-b702-e0d1b5ef483e", "", "Style2"), "", "", "", "Style2", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "&nbsp;画像コード ") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:295px\">") ;
         httpContext.writeText( "<div style=\"WIDTH: 290px\" class=\"SectionWordBreak\" id=\"Section2\">") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_image_cd()", AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_image_cd());
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 47,'',false,'',0)\"" ;
         ClassString = "AttributeImeOff" ;
         StyleString = "background:" + WebUtils.getHTMLColor( edtavCtltbm11_image_cd_Backcolor) + ";" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm11_image_cd_Internalname, GXutil.rtrim( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_image_cd()), GXutil.rtrim( localUtil.format( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_image_cd(), "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(47);\"", "", "", "", "", edtavCtltbm11_image_cd_Jsonclick, 0, ClassString, StyleString, "", 1, edtavCtltbm11_image_cd_Enabled, 1, 35, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</div>") ;
         httpContext.writeText( "</td>") ;
         ...
         ClassString = "Image" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgImage5_Internalname, context.getHttpContext().getImagePath( "d5d6aaa9-3daa-4e25-b702-e0d1b5ef483e", "", "Style2"), "", "", "", "Style2", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "&nbsp;画像名") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_image_nm()", AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_image_nm());
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 51,'',false,'',0)\"" ;
         ClassString = "AttributeImeOn" ;
         StyleString = "background:" + WebUtils.getHTMLColor( edtavCtltbm11_image_nm_Backcolor) + ";" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm11_image_nm_Internalname, GXutil.rtrim( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_image_nm()), GXutil.rtrim( localUtil.format( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_image_nm(), "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(51);\"", "", "", "", "", edtavCtltbm11_image_nm_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         ClassString = "Image" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgImage3_Internalname, context.getHttpContext().getImagePath( "d5d6aaa9-3daa-4e25-b702-e0d1b5ef483e", "", "Style2"), "", "", "", "Style2", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "&nbsp;画像ファイル") ;
         httpContext.writeText( "<br>") ;
         /* Text block */
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_size_Internalname, lblTxt_size_Caption, "", "", lblTxt_size_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "<div style=\"WIDTH: 290px; HEIGHT: 160px\" class=\"SectionScroll\" id=\"Section3\">") ;
         /* Text block */
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_image_Internalname, lblTxt_image_Caption, "", "", lblTxt_image_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(2), "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</div>") ;
         ClassString = "Image" ;
         StyleString = "" ;
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "<div style=\"WIDTH: 420px\" class=\"SectionWordBreak\" id=\"Section1\">") ;
         /* Text block */
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_file_name_Internalname, lblTxt_file_name_Caption, "", "", lblTxt_file_name_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(1), "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</div>") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_study_id()", GXutil.ltrim( GXutil.str( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_study_id(), 10, 0)));
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 65,'',false,'',0)\"" ;
         ClassString = "AttributeNum" ;
         StyleString = "background:" + WebUtils.getHTMLColor( edtavCtltbm11_study_id_Backcolor) + ";" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm11_study_id_Internalname, GXutil.ltrim( localUtil.ntoc( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_study_id(), (byte)(10), (byte)(0), ".", "")), ((1!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_study_id()), "ZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_study_id()), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(65);\"", "", "", "", "", edtavCtltbm11_study_id_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Radio button */
         httpContext.ajax_rsp_assign_attri("", false, "AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_del_flg()", AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_del_flg());
         ClassString = "ReadonlyAttributeImeOff" ;
         StyleString = "" ;
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 68,'',false,'',0)\"" ;
         GxWebStd.gx_radio_ctrl( httpContext, radavCtltbm11_del_flg, radavCtltbm11_del_flg.getInternalname(), AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_del_flg(), "", 1, 1, 0, 0, StyleString, ClassString, 0, radavCtltbm11_del_flg.getJsonclick(), "", TempTags+" onclick=\"gx.evt.onchange(this);\" "+" onblur=\""+""+";gx.evt.onblur(68);\"", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"FormTitle\" colspan=\"4\" >") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_crt_datetime()", localUtil.ttoc( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_crt_datetime(), 10, 8, 0, 1, "/", ":", " "));
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm11_crt_datetime_Internalname, localUtil.format(AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_crt_datetime(), "9999/99/99 99:99:99"), localUtil.format( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_crt_datetime(), "9999/99/99 99:99:99"), "", "", "", "", "", edtavCtltbm11_crt_datetime_Jsonclick, 0, ClassString, StyleString, "", edtavCtltbm11_crt_datetime_Visible, edtavCtltbm11_crt_datetime_Enabled, 0, 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(1), true, "right", "HLP_B202_WP01_IMAGE_MST.htm");
         GxWebStd.gx_bitmap( httpContext, edtavCtltbm11_crt_datetime_Internalname+"_dp_trigger", "calendar-img.gif", "", "", "", "", ((edtavCtltbm11_crt_datetime_Visible==0)||(edtavCtltbm11_crt_datetime_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_B202_WP01_IMAGE_MST.htm");
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime()", localUtil.ttoc( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime(), 10, 8, 0, 1, "/", ":", " "));
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm11_upd_datetime_Internalname, localUtil.format(AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime(), "9999/99/99 99:99:99"), localUtil.format( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime(), "9999/99/99 99:99:99"), "", "", "", "", "", edtavCtltbm11_upd_datetime_Jsonclick, 0, ClassString, StyleString, "", edtavCtltbm11_upd_datetime_Visible, edtavCtltbm11_upd_datetime_Enabled, 0, 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(1), true, "right", "HLP_B202_WP01_IMAGE_MST.htm");
         GxWebStd.gx_bitmap( httpContext, edtavCtltbm11_upd_datetime_Internalname+"_dp_trigger", "calendar-img.gif", "", "", "", "", ((edtavCtltbm11_upd_datetime_Visible==0)||(edtavCtltbm11_upd_datetime_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeTextNL( "</div>") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_crt_user_nm_Internalname, GXutil.rtrim( AV8D_CRT_USER_NM), GXutil.rtrim( localUtil.format( AV8D_CRT_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(81);\"", "", "", "", "", edtavD_crt_user_nm_Jsonclick, 0, ClassString, StyleString, "", 1, edtavD_crt_user_nm_Enabled, 0, 30, "chr", 1, "row", 30, (byte)(0), (short)(1), 0, (byte)(1), (byte)(1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         ...
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_upd_user_nm_Internalname, GXutil.rtrim( AV10D_UPD_USER_NM), GXutil.rtrim( localUtil.format( AV10D_UPD_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(84);\"", "", "", "", "", edtavD_upd_user_nm_Jsonclick, 0, ClassString, StyleString, "", 1, edtavD_upd_user_nm_Enabled, 0, 30, "chr", 1, "row", 30, (byte)(0), (short)(1), 0, (byte)(1), (byte)(1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"ItemTitle\"  style=\"height:25px\">") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_crt_prog_nm()", AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_crt_prog_nm());
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm11_crt_prog_nm_Internalname, GXutil.rtrim( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_crt_prog_nm()), GXutil.rtrim( localUtil.format( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_crt_prog_nm(), "")), "", "", "", "", "", edtavCtltbm11_crt_prog_nm_Jsonclick, 0, ClassString, StyleString, "", 1, edtavCtltbm11_crt_prog_nm_Enabled, 0, 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_upd_prog_nm()", AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_upd_prog_nm());
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm11_upd_prog_nm_Internalname, GXutil.rtrim( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_upd_prog_nm()), GXutil.rtrim( localUtil.format( AV5BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_upd_prog_nm(), "")), "", "", "", "", "", edtavCtltbm11_upd_prog_nm_Jsonclick, 0, ClassString, StyleString, "", 1, edtavCtltbm11_upd_prog_nm_Enabled, 0, 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(1), true, "left", "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table7_40_192e( true) ;
      }
      else
      {
         wb_table7_40_192e( false) ;
      }
   }

   public void wb_table4_20_192( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_upd_Internalname, "更新（F4）", "", "", lblTxt_btn_upd_Jsonclick, "E\\'BTN_UPD\\'.", StyleString, ClassString, 5, "", lblTxt_btn_upd_Visible, 1, (short)(0), "HLP_B202_WP01_IMAGE_MST.htm");
         /* Text block */
         ClassString = "TextBlockBtnList100_Disabled" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_upd2_Internalname, "更新（F4）", "", "", lblTxt_btn_upd2_Jsonclick, "", StyleString, ClassString, 0, "", lblTxt_btn_upd2_Visible, 1, (short)(0), "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_dlt_Internalname, "削除（F6）", "", "", lblTxt_btn_dlt_Jsonclick, "E\\'BTN_DLT\\'.", StyleString, ClassString, 5, "", lblTxt_btn_dlt_Visible, 1, (short)(0), "HLP_B202_WP01_IMAGE_MST.htm");
         /* Text block */
         ClassString = "TextBlockBtnList100_Disabled" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_dlt2_Internalname, "削除（F6）", "", "", lblTxt_btn_dlt2_Jsonclick, "", StyleString, ClassString, 0, "", lblTxt_btn_dlt2_Visible, 1, (short)(0), "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock46_Internalname, "戻る（F11）", "", "", lblTextblock46_Jsonclick, "E\\'BTN_CAN\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_20_192e( true) ;
      }
      else
      {
         wb_table4_20_192e( false) ;
      }
   }

   public void wb_table3_12_192( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_reg_Internalname, "登録（F3）", "", "", lblTxt_btn_reg_Jsonclick, "E\\'BTN_REG\\'.", StyleString, ClassString, 5, "", lblTxt_btn_reg_Visible, 1, (short)(0), "HLP_B202_WP01_IMAGE_MST.htm");
         /* Text block */
         ClassString = "TextBlockBtnList100_Disabled" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_reg2_Internalname, "登録（F3）", "", "", lblTxt_btn_reg2_Jsonclick, "", StyleString, ClassString, 0, "", lblTxt_btn_reg2_Visible, 1, (short)(0), "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock44_Internalname, "戻る（F11）", "", "", lblTextblock44_Jsonclick, "E\\'BTN_CAN\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_B202_WP01_IMAGE_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_12_192e( true) ;
      }
      else
      {
         wb_table3_12_192e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?1535918");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b202_wp01_image_mst.js", "?1535918");
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S22657 */
                  S22657 ();
                  break;
         }
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00192_A8TAM07_USER_ID = new String[] {""} ;
      H00192_A2TAM07_USER_NM = new String[] {""} ;
      H00192_n2TAM07_USER_NM = new boolean[] {false} ;
      A8TAM07_USER_ID = "" ;
      A2TAM07_USER_NM = "" ;
      H00193_A8TAM07_USER_ID = new String[] {""} ;
      H00193_A2TAM07_USER_NM = new String[] {""} ;
      H00193_n2TAM07_USER_NM = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b202_wp01_image_mst__default(),
         new Object[] {
             new Object[] {
            H00192_A8TAM07_USER_ID, H00192_A2TAM07_USER_NM, H00192_n2TAM07_USER_NM
            }
            , new Object[] {
            H00193_A8TAM07_USER_ID, H00193_A2TAM07_USER_NM, H00193_n2TAM07_USER_NM
            }
         }
      );
   ...
   private String[] H00192_A8TAM07_USER_ID ;
   private String[] H00192_A2TAM07_USER_NM ;
   private boolean[] H00192_n2TAM07_USER_NM ;
   private String[] H00193_A8TAM07_USER_ID ;
   private String[] H00193_A2TAM07_USER_NM ;
   private boolean[] H00193_n2TAM07_USER_NM ;
...
final  class b202_wp01_image_mst__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00192", "SELECT `TAM07_USER_ID`, `TAM07_USER_NM` FROM `TAM07_USER` WHERE `TAM07_USER_ID` = ? ORDER BY `TAM07_USER_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H00193", "SELECT `TAM07_USER_ID`, `TAM07_USER_NM` FROM `TAM07_USER` WHERE `TAM07_USER_ID` = ? ORDER BY `TAM07_USER_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
