/*
       ...
       Generated on: July 3, 2017 14:55:6.15
...
public final  class b404_pc02_crfcond_chk extends GXProcedure
{
   ...
   {
      AV8C_APP_ID = "B404" ;
      /* Execute user subroutine: S16239 */
      S16239 ();
      if ( returnInSub )
      {
         returnInSub = true;
      ...
      if ( ! AV11P_DEL_FLG )
      {
         ...
         /* Execute user subroutine: S14200 */
         S14200 ();
         if ( returnInSub )
         {
            returnInSub = true;
   ...
   public void S1149( )
   {
      ...
      if ( ! (0==AV26BC_CRF_COND.getgxTv_SdtTBM33_CRF_COND_Tbm33_study_id()) )
      {
         ...
         else
         {
            ...
            {
               A248TBM33_COND_NO = P005D2_A248TBM33_COND_NO[0] ;
               A247TBM33_CRF_ID = P005D2_A247TBM33_CRF_ID[0] ;
               A246TBM33_STUDY_ID = P005D2_A246TBM33_STUDY_ID[0] ;
               A255TBM33_UPD_DATETIME = P005D2_A255TBM33_UPD_DATETIME[0] ;
               n255TBM33_UPD_DATETIME = P005D2_n255TBM33_UPD_DATETIME[0] ;
               AV30GXLvl58 = (byte)(1) ;
               if ( !( AV26BC_CRF_COND.getgxTv_SdtTBM33_CRF_COND_Tbm33_upd_datetime().equals( A255TBM33_UPD_DATETIME ) ) )
               {
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S17257 */
                  S17257 ();
                  if ( returnInSub )
                  {
                     returnInSub = true;
   ...
   {
      AV16W_A_CHK_RESULT_SDT = new GxObjectCollection(SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem.class, "A_CHK_RESULT_SDT.A_CHK_RESULT_SDTItem", "SmartEDC_SHIZUOKA", remoteHandle);
      AV19W_A_RESULT_MSG_SDT = new GxObjectCollection(SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem.class, "A_RESULT_MSG_SDT.A_RESULT_MSG_SDTItem", "SmartEDC_SHIZUOKA", remoteHandle);
      AV8C_APP_ID = "" ;
      ...
      scmdbuf = "" ;
      P005D2_A248TBM33_COND_NO = new short[1] ;
      P005D2_A247TBM33_CRF_ID = new short[1] ;
      P005D2_A246TBM33_STUDY_ID = new long[1] ;
      P005D2_A255TBM33_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P005D2_n255TBM33_UPD_DATETIME = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b404_pc02_crfcond_chk__default(),
         new Object[] {
             new Object[] {
            P005D2_A248TBM33_COND_NO, P005D2_A247TBM33_CRF_ID, P005D2_A246TBM33_STUDY_ID, P005D2_A255TBM33_UPD_DATETIME, P005D2_n255TBM33_UPD_DATETIME
            }
         }
      );
   ...
   private short[] P005D2_A248TBM33_COND_NO ;
   private short[] P005D2_A247TBM33_CRF_ID ;
   private long[] P005D2_A246TBM33_STUDY_ID ;
   private java.util.Date[] P005D2_A255TBM33_UPD_DATETIME ;
   private boolean[] P005D2_n255TBM33_UPD_DATETIME ;
