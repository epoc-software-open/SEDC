...
public final  class SdtTBT15_CRF_MEMO_LOC extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( long AV345TBT15_STUDY_ID ,
                     int AV346TBT15_SUBJECT_ID ,
                     short AV925TBT15_MEMO_NO )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {new Long(AV345TBT15_STUDY_ID),new Integer(AV346TBT15_SUBJECT_ID),new Short(AV925TBT15_MEMO_NO)});
   }
   ...
   public void tojson( )
   {
      AddObjectProperty("TBT15_STUDY_ID", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_study_id);
      AddObjectProperty("TBT15_SUBJECT_ID", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_subject_id);
      AddObjectProperty("TBT15_MEMO_NO", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_memo_no);
      AddObjectProperty("TBT15_CRF_ID", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_id);
      AddObjectProperty("TBT15_CRF_VERSION", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_version);
      AddObjectProperty("TBT15_CRF_ITEM_GRP_DIV", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_item_grp_div);
      AddObjectProperty("TBT15_CRF_ITEM_GRP_CD", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_item_grp_cd);
      AddObjectProperty("TBT15_DEL_FLG", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_del_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT15_CRT_DATETIME", sDateCnv);
      AddObjectProperty("TBT15_CRT_USER_ID", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_user_id);
      AddObjectProperty("TBT15_CRT_PROG_NM", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_prog_nm);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT15_UPD_DATETIME", sDateCnv);
      AddObjectProperty("TBT15_UPD_USER_ID", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_user_id);
      AddObjectProperty("TBT15_UPD_PROG_NM", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_prog_nm);
      AddObjectProperty("TBT15_UPD_CNT", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_cnt);
      AddObjectProperty("Mode", gxTv_SdtTBT15_CRF_MEMO_LOC_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTBT15_CRF_MEMO_LOC_Initialized);
      AddObjectProperty("TBT15_STUDY_ID_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_study_id_Z);
      AddObjectProperty("TBT15_SUBJECT_ID_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_subject_id_Z);
      AddObjectProperty("TBT15_MEMO_NO_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_memo_no_Z);
      AddObjectProperty("TBT15_CRF_ID_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_id_Z);
      AddObjectProperty("TBT15_CRF_VERSION_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_version_Z);
      AddObjectProperty("TBT15_CRF_ITEM_GRP_DIV_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_item_grp_div_Z);
      AddObjectProperty("TBT15_CRF_ITEM_GRP_CD_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_item_grp_cd_Z);
      AddObjectProperty("TBT15_DEL_FLG_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_del_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT15_CRT_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBT15_CRT_USER_ID_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_user_id_Z);
      AddObjectProperty("TBT15_CRT_PROG_NM_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_prog_nm_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT15_UPD_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBT15_UPD_USER_ID_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_user_id_Z);
      AddObjectProperty("TBT15_UPD_PROG_NM_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_prog_nm_Z);
      AddObjectProperty("TBT15_UPD_CNT_Z", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_cnt_Z);
      AddObjectProperty("TBT15_CRF_ID_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_id_N);
      AddObjectProperty("TBT15_CRF_VERSION_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_version_N);
      AddObjectProperty("TBT15_CRF_ITEM_GRP_DIV_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_item_grp_div_N);
      AddObjectProperty("TBT15_CRF_ITEM_GRP_CD_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crf_item_grp_cd_N);
      AddObjectProperty("TBT15_DEL_FLG_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_del_flg_N);
      AddObjectProperty("TBT15_CRT_DATETIME_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_datetime_N);
      AddObjectProperty("TBT15_CRT_USER_ID_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_user_id_N);
      AddObjectProperty("TBT15_CRT_PROG_NM_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_crt_prog_nm_N);
      AddObjectProperty("TBT15_UPD_DATETIME_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_datetime_N);
      AddObjectProperty("TBT15_UPD_USER_ID_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_user_id_N);
      AddObjectProperty("TBT15_UPD_PROG_NM_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_prog_nm_N);
      AddObjectProperty("TBT15_UPD_CNT_N", gxTv_SdtTBT15_CRF_MEMO_LOC_Tbt15_upd_cnt_N);
   }
