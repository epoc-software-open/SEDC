/*
       ...
       Generated on: July 3, 2017 14:52:37.42
...
public final  class b599_pc28_meta_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      if ( AV18W_RTN_CD == 0 )
      {
         ...
         {
            A16TAM07_DEL_FLG = P004K2_A16TAM07_DEL_FLG[0] ;
            n16TAM07_DEL_FLG = P004K2_n16TAM07_DEL_FLG[0] ;
            A8TAM07_USER_ID = P004K2_A8TAM07_USER_ID[0] ;
            A7TAM07_PWD = P004K2_A7TAM07_PWD[0] ;
            n7TAM07_PWD = P004K2_n7TAM07_PWD[0] ;
            AV17W_PWD = A7TAM07_PWD ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P004K2_A16TAM07_DEL_FLG = new String[] {""} ;
      P004K2_n16TAM07_DEL_FLG = new boolean[] {false} ;
      P004K2_A8TAM07_USER_ID = new String[] {""} ;
      P004K2_A7TAM07_PWD = new String[] {""} ;
      P004K2_n7TAM07_PWD = new boolean[] {false} ;
      A16TAM07_DEL_FLG = "" ;
      A8TAM07_USER_ID = "" ;
      A7TAM07_PWD = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc28_meta_res__default(),
         new Object[] {
             new Object[] {
            P004K2_A16TAM07_DEL_FLG, P004K2_n16TAM07_DEL_FLG, P004K2_A8TAM07_USER_ID, P004K2_A7TAM07_PWD, P004K2_n7TAM07_PWD
            }
         }
      );
   ...
   private String[] P004K2_A16TAM07_DEL_FLG ;
   private boolean[] P004K2_n16TAM07_DEL_FLG ;
   private String[] P004K2_A8TAM07_USER_ID ;
   private String[] P004K2_A7TAM07_PWD ;
   private boolean[] P004K2_n7TAM07_PWD ;
...
final  class b599_pc28_meta_res__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P004K2", "SELECT `TAM07_DEL_FLG`, `TAM07_USER_ID`, `TAM07_PWD` FROM `TAM07_USER` WHERE (`TAM07_USER_ID` = ?) AND (`TAM07_DEL_FLG` = '0') ORDER BY `TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
