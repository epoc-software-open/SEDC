/*
        ...
        Description: ééå±é¿é{é{ê›ìoò^
             Author: GeneXus Java Generator version 10_1_8-58720
       Generated on: July 3, 2017 14:54:37.66
...
public final  class b402_pc05_study_site_reg extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A597TBW01_DISP_DATETIME = P003V2_A597TBW01_DISP_DATETIME[0] ;
         A596TBW01_APP_ID = P003V2_A596TBW01_APP_ID[0] ;
         A595TBW01_SESSION_ID = P003V2_A595TBW01_SESSION_ID[0] ;
         A599TBW01_FREE_SAVE_1 = P003V2_A599TBW01_FREE_SAVE_1[0] ;
         n599TBW01_FREE_SAVE_1 = P003V2_n599TBW01_FREE_SAVE_1[0] ;
         A598TBW01_LINE_NO = P003V2_A598TBW01_LINE_NO[0] ;
         AV19GXLvl29 = (byte)(1) ;
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      P003V2_A597TBW01_DISP_DATETIME = new String[] {""} ;
      P003V2_A596TBW01_APP_ID = new String[] {""} ;
      P003V2_A595TBW01_SESSION_ID = new String[] {""} ;
      P003V2_A599TBW01_FREE_SAVE_1 = new String[] {""} ;
      P003V2_n599TBW01_FREE_SAVE_1 = new boolean[] {false} ;
      P003V2_A598TBW01_LINE_NO = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_pc05_study_site_reg__default(),
         new Object[] {
             new Object[] {
            P003V2_A597TBW01_DISP_DATETIME, P003V2_A596TBW01_APP_ID, P003V2_A595TBW01_SESSION_ID, P003V2_A599TBW01_FREE_SAVE_1, P003V2_n599TBW01_FREE_SAVE_1, P003V2_A598TBW01_LINE_NO
            }
         }
      );
   ...
   private String[] P003V2_A597TBW01_DISP_DATETIME ;
   private String[] P003V2_A596TBW01_APP_ID ;
   private String[] P003V2_A595TBW01_SESSION_ID ;
   private String[] P003V2_A599TBW01_FREE_SAVE_1 ;
   private boolean[] P003V2_n599TBW01_FREE_SAVE_1 ;
   private long[] P003V2_A598TBW01_LINE_NO ;
