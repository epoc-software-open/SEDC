/*
       ...
       Generated on: July 3, 2017 14:56:19.28
...
public final  class b404_pc01_tbm36_reg extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A486TBM36_COND_NO = P004G2_A486TBM36_COND_NO[0] ;
         A485TBM36_CRF_ID = P004G2_A485TBM36_CRF_ID[0] ;
         A484TBM36_STUDY_ID = P004G2_A484TBM36_STUDY_ID[0] ;
         A487TBM36_SELECT_CRF_ID = P004G2_A487TBM36_SELECT_CRF_ID[0] ;
         AV15WK_TBM36_SELECT_CRF_ID = A487TBM36_SELECT_CRF_ID ;
   ...
   public void initialize( )
   {
      ...
      AV16C_APP_ID = "" ;
      scmdbuf = "" ;
      P004G2_A486TBM36_COND_NO = new short[1] ;
      P004G2_A485TBM36_CRF_ID = new short[1] ;
      P004G2_A484TBM36_STUDY_ID = new long[1] ;
      P004G2_A487TBM36_SELECT_CRF_ID = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b404_pc01_tbm36_reg__default(),
         new Object[] {
             new Object[] {
            P004G2_A486TBM36_COND_NO, P004G2_A485TBM36_CRF_ID, P004G2_A484TBM36_STUDY_ID, P004G2_A487TBM36_SELECT_CRF_ID
            }
         }
      );
   ...
   private short[] P004G2_A486TBM36_COND_NO ;
   private short[] P004G2_A485TBM36_CRF_ID ;
   private long[] P004G2_A484TBM36_STUDY_ID ;
   private short[] P004G2_A487TBM36_SELECT_CRF_ID ;
...
final  class b404_pc01_tbm36_reg__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P004G2", "SELECT `TBM36_COND_NO`, `TBM36_CRF_ID`, `TBM36_STUDY_ID`, `TBM36_SELECT_CRF_ID` FROM `TBM36_CRF_SELECT` WHERE (`TBM36_STUDY_ID` = ?) AND (`TBM36_CRF_ID` = ?) AND (`TBM36_COND_NO` = ?) ORDER BY `TBM36_STUDY_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
