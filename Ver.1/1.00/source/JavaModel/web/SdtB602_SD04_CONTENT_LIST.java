...
public final  class SdtB602_SD04_CONTENT_LIST extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "CONTENT") )
            {
               ...
               {
                  gxTv_SdtB602_SD04_CONTENT_LIST_Content = new GxObjectCollection(SdtB602_SD04_CONTENT_LIST_CONTENTItem.class, "B602_SD04_CONTENT_LIST.CONTENTItem", "SmartEDC_SHIZUOKA", remoteHandle);
               }
               if ( oReader.getIsSimple() == 0 )
               {
   ...
   public void tojson( )
   {
      if ( gxTv_SdtB602_SD04_CONTENT_LIST_Result != null )
      {
         AddObjectProperty("RESULT", gxTv_SdtB602_SD04_CONTENT_LIST_Result);
      }
      if ( gxTv_SdtB602_SD04_CONTENT_LIST_Content != null )
      {
         AddObjectProperty("CONTENT", gxTv_SdtB602_SD04_CONTENT_LIST_Content);
      }
   }
   ...
   public void setStruct( StructSdtB602_SD04_CONTENT_LIST struct )
   {
      ...
      setgxTv_SdtB602_SD04_CONTENT_LIST_Content(new GxObjectCollection(SdtB602_SD04_CONTENT_LIST_CONTENTItem.class, "B602_SD04_CONTENT_LIST.CONTENTItem", "SmartEDC_SHIZUOKA", struct.getContent(), remoteHandle));
   }
   ...
   public StructSdtB602_SD04_CONTENT_LIST getStruct( )
   {
      ...
      struct.setContent(getgxTv_SdtB602_SD04_CONTENT_LIST_Content().getStruct());
      return struct ;
   }
