/*
       ...
       Generated on: July 3, 2017 14:51:56.68
...
public final  class b599_pc07_crf_ncm_map_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A263TBM41_DEL_FLG = P00212_A263TBM41_DEL_FLG[0] ;
         n263TBM41_DEL_FLG = P00212_n263TBM41_DEL_FLG[0] ;
         A261TBM41_CRF_ITEM_GRP_CD = P00212_A261TBM41_CRF_ITEM_GRP_CD[0] ;
         A260TBM41_CRF_ID = P00212_A260TBM41_CRF_ID[0] ;
         A259TBM41_STUDY_ID = P00212_A259TBM41_STUDY_ID[0] ;
         A270TBM41_UPD_CNT = P00212_A270TBM41_UPD_CNT[0] ;
         n270TBM41_UPD_CNT = P00212_n270TBM41_UPD_CNT[0] ;
         A269TBM41_UPD_PROG_NM = P00212_A269TBM41_UPD_PROG_NM[0] ;
         n269TBM41_UPD_PROG_NM = P00212_n269TBM41_UPD_PROG_NM[0] ;
         A268TBM41_UPD_USER_ID = P00212_A268TBM41_UPD_USER_ID[0] ;
         n268TBM41_UPD_USER_ID = P00212_n268TBM41_UPD_USER_ID[0] ;
         A267TBM41_UPD_DATETIME = P00212_A267TBM41_UPD_DATETIME[0] ;
         n267TBM41_UPD_DATETIME = P00212_n267TBM41_UPD_DATETIME[0] ;
         A266TBM41_CRT_PROG_NM = P00212_A266TBM41_CRT_PROG_NM[0] ;
         n266TBM41_CRT_PROG_NM = P00212_n266TBM41_CRT_PROG_NM[0] ;
         A265TBM41_CRT_USER_ID = P00212_A265TBM41_CRT_USER_ID[0] ;
         n265TBM41_CRT_USER_ID = P00212_n265TBM41_CRT_USER_ID[0] ;
         A264TBM41_CRT_DATETIME = P00212_A264TBM41_CRT_DATETIME[0] ;
         n264TBM41_CRT_DATETIME = P00212_n264TBM41_CRT_DATETIME[0] ;
         A262TBM41_NCM_METADATA_ID = P00212_A262TBM41_NCM_METADATA_ID[0] ;
         n262TBM41_NCM_METADATA_ID = P00212_n262TBM41_NCM_METADATA_ID[0] ;
         A378TBM41_CRF_ITEM_GRP_DIV = P00212_A378TBM41_CRF_ITEM_GRP_DIV[0] ;
         AV22GXLvl33 = (byte)(1) ;
         GXt_char1 = AV15W_STR ;
         GXv_char2[0] = GXt_char1 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A378TBM41_CRF_ITEM_GRP_DIV, GXv_char2) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char1 = GXv_char2[0] ;
         GXt_char3 = AV15W_STR ;
         GXv_char4[0] = GXt_char3 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A261TBM41_CRF_ITEM_GRP_CD, GXv_char4) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char3 = GXv_char4[0] ;
         GXt_char5 = AV15W_STR ;
         GXv_char6[0] = GXt_char5 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A262TBM41_NCM_METADATA_ID, GXv_char6) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char5 = GXv_char6[0] ;
         GXt_char7 = AV15W_STR ;
         GXv_char8[0] = GXt_char7 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A263TBM41_DEL_FLG, GXv_char8) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char7 = GXv_char8[0] ;
         GXt_char9 = AV15W_STR ;
         GXv_char10[0] = GXt_char9 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A264TBM41_CRT_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char10) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char9 = GXv_char10[0] ;
         GXt_char11 = AV15W_STR ;
         GXv_char12[0] = GXt_char11 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A265TBM41_CRT_USER_ID, GXv_char12) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char11 = GXv_char12[0] ;
         GXt_char13 = AV15W_STR ;
         GXv_char14[0] = GXt_char13 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A266TBM41_CRT_PROG_NM, GXv_char14) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char13 = GXv_char14[0] ;
         GXt_char15 = AV15W_STR ;
         GXv_char16[0] = GXt_char15 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A267TBM41_UPD_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char16) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char15 = GXv_char16[0] ;
         GXt_char17 = AV15W_STR ;
         GXv_char18[0] = GXt_char17 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A268TBM41_UPD_USER_ID, GXv_char18) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char17 = GXv_char18[0] ;
         GXt_char19 = AV15W_STR ;
         GXv_char20[0] = GXt_char19 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A269TBM41_UPD_PROG_NM, GXv_char20) ;
         b599_pc07_crf_ncm_map_res.this.GXt_char19 = GXv_char20[0] ;
         AV15W_STR = GXutil.trim( GXutil.str( A259TBM41_STUDY_ID, 10, 0)) + "," + GXutil.trim( GXutil.str( A260TBM41_CRF_ID, 10, 0)) + "," + GXt_char1 + "," + GXt_char3 + "," + GXt_char5 + "," + GXt_char7 + "," + GXt_char9 + "," + GXt_char11 + "," + GXt_char13 + "," + GXt_char15 + "," + GXt_char17 + "," + GXt_char19 + "," + GXutil.trim( GXutil.str( A270TBM41_UPD_CNT, 10, 0)) ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P00212_A263TBM41_DEL_FLG = new String[] {""} ;
      P00212_n263TBM41_DEL_FLG = new boolean[] {false} ;
      P00212_A261TBM41_CRF_ITEM_GRP_CD = new String[] {""} ;
      P00212_A260TBM41_CRF_ID = new short[1] ;
      P00212_A259TBM41_STUDY_ID = new long[1] ;
      P00212_A270TBM41_UPD_CNT = new long[1] ;
      P00212_n270TBM41_UPD_CNT = new boolean[] {false} ;
      P00212_A269TBM41_UPD_PROG_NM = new String[] {""} ;
      P00212_n269TBM41_UPD_PROG_NM = new boolean[] {false} ;
      P00212_A268TBM41_UPD_USER_ID = new String[] {""} ;
      P00212_n268TBM41_UPD_USER_ID = new boolean[] {false} ;
      P00212_A267TBM41_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P00212_n267TBM41_UPD_DATETIME = new boolean[] {false} ;
      P00212_A266TBM41_CRT_PROG_NM = new String[] {""} ;
      P00212_n266TBM41_CRT_PROG_NM = new boolean[] {false} ;
      P00212_A265TBM41_CRT_USER_ID = new String[] {""} ;
      P00212_n265TBM41_CRT_USER_ID = new boolean[] {false} ;
      P00212_A264TBM41_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P00212_n264TBM41_CRT_DATETIME = new boolean[] {false} ;
      P00212_A262TBM41_NCM_METADATA_ID = new String[] {""} ;
      P00212_n262TBM41_NCM_METADATA_ID = new boolean[] {false} ;
      P00212_A378TBM41_CRF_ITEM_GRP_DIV = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc07_crf_ncm_map_res__default(),
         new Object[] {
             new Object[] {
            P00212_A263TBM41_DEL_FLG, P00212_n263TBM41_DEL_FLG, P00212_A261TBM41_CRF_ITEM_GRP_CD, P00212_A260TBM41_CRF_ID, P00212_A259TBM41_STUDY_ID, P00212_A270TBM41_UPD_CNT, P00212_n270TBM41_UPD_CNT, P00212_A269TBM41_UPD_PROG_NM, P00212_n269TBM41_UPD_PROG_NM, P00212_A268TBM41_UPD_USER_ID,
            P00212_n268TBM41_UPD_USER_ID, P00212_A267TBM41_UPD_DATETIME, P00212_n267TBM41_UPD_DATETIME, P00212_A266TBM41_CRT_PROG_NM, P00212_n266TBM41_CRT_PROG_NM, P00212_A265TBM41_CRT_USER_ID, P00212_n265TBM41_CRT_USER_ID, P00212_A264TBM41_CRT_DATETIME, P00212_n264TBM41_CRT_DATETIME, P00212_A262TBM41_NCM_METADATA_ID,
            P00212_n262TBM41_NCM_METADATA_ID, P00212_A378TBM41_CRF_ITEM_GRP_DIV
            }
         }
      );
   ...
   private String[] P00212_A263TBM41_DEL_FLG ;
   private boolean[] P00212_n263TBM41_DEL_FLG ;
   private String[] P00212_A261TBM41_CRF_ITEM_GRP_CD ;
   private short[] P00212_A260TBM41_CRF_ID ;
   private long[] P00212_A259TBM41_STUDY_ID ;
   private long[] P00212_A270TBM41_UPD_CNT ;
   private boolean[] P00212_n270TBM41_UPD_CNT ;
   private String[] P00212_A269TBM41_UPD_PROG_NM ;
   private boolean[] P00212_n269TBM41_UPD_PROG_NM ;
   private String[] P00212_A268TBM41_UPD_USER_ID ;
   private boolean[] P00212_n268TBM41_UPD_USER_ID ;
   private java.util.Date[] P00212_A267TBM41_UPD_DATETIME ;
   private boolean[] P00212_n267TBM41_UPD_DATETIME ;
   private String[] P00212_A266TBM41_CRT_PROG_NM ;
   private boolean[] P00212_n266TBM41_CRT_PROG_NM ;
   private String[] P00212_A265TBM41_CRT_USER_ID ;
   private boolean[] P00212_n265TBM41_CRT_USER_ID ;
   private java.util.Date[] P00212_A264TBM41_CRT_DATETIME ;
   private boolean[] P00212_n264TBM41_CRT_DATETIME ;
   private String[] P00212_A262TBM41_NCM_METADATA_ID ;
   private boolean[] P00212_n262TBM41_NCM_METADATA_ID ;
   private String[] P00212_A378TBM41_CRF_ITEM_GRP_DIV ;
...
{
   protected Object[] conditional_P00212( com.genexus.internet.HttpContext httpContext ,
                                          String AV8P_CRF_ID ,
                                          String AV9P_CRF_ITEM_CD ,
                                          short A260TBM41_CRF_ID ,
                                          short AV11W_CRF_ID ,
                                          String A261TBM41_CRF_ITEM_GRP_CD ,
                                          String A263TBM41_DEL_FLG ,
                                          long AV10P_STUDY_ID ,
                                          long A259TBM41_STUDY_ID )
   {
      String sWhereString = "" ;
      String scmdbuf ;
      byte[] GXv_int23 ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00212(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() , ((Number) dynConstraints[3]).shortValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , ((Number) dynConstraints[6]).longValue() , ((Number) dynConstraints[7]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00212", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
