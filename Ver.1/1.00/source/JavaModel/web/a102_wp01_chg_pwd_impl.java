...
public final  class a102_wp01_chg_pwd_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("a102_wp01_chg_pwd") +"\" class=\""+"Form"+"\">") ;
   ...
   public void e110G2( )
   {
      ...
      if ( ! AV17W_ERRFLG )
      {
         ...
         new a805_pc01_msg_get(remoteHandle, context).execute( "AG00016", "", "", "", "", "", GXv_char4) ;
         a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
         AV19W_MSG = GXt_char3 ;
         GXt_char3 = AV15W_A821_JS ;
         GXv_char4[0] = GXt_char3 ;
         new a821_pc01_msgbox(remoteHandle, context).execute( "OK_CANCEL", AV19W_MSG, "", "BTN_UPD_EXEC", "", GXv_char4) ;
         a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
   ...
   public void e150G2( )
   {
      ...
      GXt_char3 = "" ;
      GXv_char4[0] = GXt_char3 ;
      new b801_pc01_md5(remoteHandle, context).execute( AV11D_TAM07_PWD_NEW, GXv_char4) ;
      a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11D_TAM07_PWD_NEW", AV11D_TAM07_PWD_NEW);
      AV5BC_TAM07_USER.setgxTv_SdtTAM07_USER_Tam07_pwd( GXt_char3 );
      ...
      if ( AV5BC_TAM07_USER.Success() )
      {
         ...
         GXt_char3 = AV19W_MSG ;
         GXv_char4[0] = GXt_char3 ;
         new a805_pc01_msg_get(remoteHandle, context).execute( "AG00007", "", "", "", "", "", GXv_char4) ;
         a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
         AV19W_MSG = GXt_char3 ;
         GXt_char3 = AV15W_A821_JS ;
         GXv_char4[0] = GXt_char3 ;
         new a821_pc01_msgbox(remoteHandle, context).execute( "OK", AV19W_MSG, "", "BTN_END", "", GXv_char4) ;
         a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
         AV15W_A821_JS = GXt_char3 ;
      }
      else
      {
         ...
         while ( AV24GXV1 <= AV7C_BCMSGS.size() )
         {
            ...
            if ( GXutil.strcmp(AV6C_BCMSG.getgxTv_SdtMessages_Message_Id(), "DuplicatePrimaryKey") == 0 )
            {
               GXt_char3 = AV19W_MSG ;
               GXv_char4[0] = GXt_char3 ;
               new a805_pc01_msg_get(remoteHandle, context).execute( "AX00100", "", "", "", "", "", GXv_char4) ;
               a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
               AV19W_MSG = GXt_char3 ;
            }
            else
   ...
   public void S152( )
   {
      ...
      if ( (GXutil.strcmp("", AV9D_TAM07_PWD)==0) )
      {
         GXt_char3 = AV19W_MSG ;
         GXv_char4[0] = GXt_char3 ;
         new a805_pc01_msg_get(remoteHandle, context).execute( "AE00001", "現パスワード", "", "", "", "", GXv_char4) ;
         a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
         AV19W_MSG = GXt_char3 ;
         httpContext.GX_msglist.addItem(AV19W_MSG);
      ...
      else
      {
         ...
         {
            A8TAM07_USER_ID = H000G2_A8TAM07_USER_ID[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A8TAM07_USER_ID", A8TAM07_USER_ID);
            A16TAM07_DEL_FLG = H000G2_A16TAM07_DEL_FLG[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A16TAM07_DEL_FLG", A16TAM07_DEL_FLG);
            n16TAM07_DEL_FLG = H000G2_n16TAM07_DEL_FLG[0] ;
            A7TAM07_PWD = H000G2_A7TAM07_PWD[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A7TAM07_PWD", A7TAM07_PWD);
            n7TAM07_PWD = H000G2_n7TAM07_PWD[0] ;
            AV25GXLvl195 = (byte)(1) ;
            if ( GXutil.strcmp(A16TAM07_DEL_FLG, "0") == 0 )
            {
               GXt_char3 = AV20W_TAM07_PWD ;
               GXv_char4[0] = GXt_char3 ;
               new b801_pc01_md5(remoteHandle, context).execute( AV9D_TAM07_PWD, GXv_char4) ;
               a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
               httpContext.ajax_rsp_assign_attri("", false, "AV9D_TAM07_PWD", AV9D_TAM07_PWD);
               AV20W_TAM07_PWD = GXt_char3 ;
               if ( GXutil.strcmp(A7TAM07_PWD, AV20W_TAM07_PWD) != 0 )
               {
                  GXt_char3 = AV19W_MSG ;
                  GXv_char4[0] = GXt_char3 ;
                  new a805_pc01_msg_get(remoteHandle, context).execute( "AE00002", "現パスワード", "", "", "", "", GXv_char4) ;
                  a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
                  AV19W_MSG = GXt_char3 ;
                  httpContext.GX_msglist.addItem(AV19W_MSG);
                  edtavD_tam07_pwd_Backcolor = UIFactory.getColor( 255, 192, 203) ;
            ...
            else
            {
               GXt_char3 = AV19W_MSG ;
               GXv_char4[0] = GXt_char3 ;
               new a805_pc01_msg_get(remoteHandle, context).execute( "AE00013", "", "", "", "", "", GXv_char4) ;
               a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
               AV19W_MSG = GXt_char3 ;
               httpContext.GX_msglist.addItem(AV19W_MSG);
               edtavD_tam07_pwd_Backcolor = UIFactory.getColor( 255, 192, 203) ;
         ...
         if ( AV25GXLvl195 == 0 )
         {
            GXt_char3 = AV19W_MSG ;
            GXv_char4[0] = GXt_char3 ;
            new a805_pc01_msg_get(remoteHandle, context).execute( "AX00102", "", "", "", "", "", GXv_char4) ;
            a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
            AV19W_MSG = GXt_char3 ;
            httpContext.GX_msglist.addItem(AV19W_MSG);
      ...
      if ( (GXutil.strcmp("", AV11D_TAM07_PWD_NEW)==0) )
      {
         GXt_char3 = AV19W_MSG ;
         GXv_char4[0] = GXt_char3 ;
         new a805_pc01_msg_get(remoteHandle, context).execute( "AE00001", "新パスワード", "", "", "", "", GXv_char4) ;
         a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
         AV19W_MSG = GXt_char3 ;
         httpContext.GX_msglist.addItem(AV19W_MSG);
      ...
      else
      {
         if ( new a807_pc02_1byte_check(remoteHandle, context).executeUdp( AV11D_TAM07_PWD_NEW) != 0 )
         {
            GXt_char3 = AV19W_MSG ;
            GXv_char4[0] = GXt_char3 ;
            new a805_pc01_msg_get(remoteHandle, context).execute( "AE00020", "新パスワード", "", "", "", "", GXv_char4) ;
            a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
            AV19W_MSG = GXt_char3 ;
            httpContext.GX_msglist.addItem(AV19W_MSG);
            edtavD_tam07_pwd_new_Backcolor = UIFactory.getColor( 255, 192, 203) ;
      ...
      if ( (GXutil.strcmp("", AV10D_TAM07_PWD_CFM)==0) )
      {
         GXt_char3 = AV19W_MSG ;
         GXv_char4[0] = GXt_char3 ;
         new a805_pc01_msg_get(remoteHandle, context).execute( "AE00001", "確認パスワード", "", "", "", "", GXv_char4) ;
         a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
         AV19W_MSG = GXt_char3 ;
         httpContext.GX_msglist.addItem(AV19W_MSG);
      ...
      else
      {
         if ( new a807_pc02_1byte_check(remoteHandle, context).executeUdp( AV10D_TAM07_PWD_CFM) != 0 )
         {
            GXt_char3 = AV19W_MSG ;
            GXv_char4[0] = GXt_char3 ;
            new a805_pc01_msg_get(remoteHandle, context).execute( "AE00020", "確認パスワード", "", "", "", "", GXv_char4) ;
            a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
            AV19W_MSG = GXt_char3 ;
            httpContext.GX_msglist.addItem(AV19W_MSG);
            edtavD_tam07_pwd_cfm_Backcolor = UIFactory.getColor( 255, 192, 203) ;
      ...
      if ( ( GXutil.strcmp(AV11D_TAM07_PWD_NEW, AV10D_TAM07_PWD_CFM) != 0 ) && ! (GXutil.strcmp("", AV11D_TAM07_PWD_NEW)==0) && ! (GXutil.strcmp("", AV10D_TAM07_PWD_CFM)==0) )
      {
         GXt_char3 = AV19W_MSG ;
         GXv_char4[0] = GXt_char3 ;
         new a805_pc01_msg_get(remoteHandle, context).execute( "AE00009", "", "", "", "", "", GXv_char4) ;
         a102_wp01_chg_pwd_impl.this.GXt_char3 = GXv_char4[0] ;
         AV19W_MSG = GXt_char3 ;
         httpContext.GX_msglist.addItem(AV19W_MSG);
         edtavD_tam07_pwd_new_Backcolor = UIFactory.getColor( 255, 192, 203) ;
   ...
   public void S112( )
   {
      ...
      a102_wp01_chg_pwd_impl.this.AV16W_ERRCD = GXv_char4[0] ;
   ...
   public void wb_table5_53_0G2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_js_event_Internalname, lblTxt_js_event_Caption, "", "", lblTxt_js_event_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(1), "HLP_A102_WP01_CHG_PWD.htm");
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV13H_INIT_FLG", AV13H_INIT_FLG);
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 57,'',false,'',0)\"" ;
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV13H_INIT_FLG), GXutil.rtrim( localUtil.format( AV13H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(57);\"", "", "", "", "", edtavH_init_flg_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A102_WP01_CHG_PWD.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table7_28_0G2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_user_id_Internalname, GXutil.rtrim( AV12D_TAM07_USER_ID), GXutil.rtrim( localUtil.format( AV12D_TAM07_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(31);\"", "", "", "", "", edtavD_tam07_user_id_Jsonclick, 0, ClassString, StyleString, "", 1, edtavD_tam07_user_id_Enabled, 0, 20, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(1), true, "left", "HLP_A102_WP01_CHG_PWD.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<th>") ;
         ...
         ClassString = "Image" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgImage5_Internalname, context.getHttpContext().getImagePath( "d5d6aaa9-3daa-4e25-b702-e0d1b5ef483e", "", "Style2"), "", "", "", "Style2", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_A102_WP01_CHG_PWD.htm");
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_pwd_Internalname, GXutil.rtrim( AV9D_TAM07_PWD), GXutil.rtrim( localUtil.format( AV9D_TAM07_PWD, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(35);\"", "", "", "", "", edtavD_tam07_pwd_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 20, "chr", 1, "row", 20, (byte)(-1), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A102_WP01_CHG_PWD.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<th>") ;
         ...
         ClassString = "Image" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgImage7_Internalname, context.getHttpContext().getImagePath( "d5d6aaa9-3daa-4e25-b702-e0d1b5ef483e", "", "Style2"), "", "", "", "Style2", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_A102_WP01_CHG_PWD.htm");
         ...
         ClassString = "AttributeImeOff" ;
         StyleString = "background:" + WebUtils.getHTMLColor( edtavD_tam07_pwd_new_Backcolor) + ";" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_pwd_new_Internalname, GXutil.rtrim( AV11D_TAM07_PWD_NEW), GXutil.rtrim( localUtil.format( AV11D_TAM07_PWD_NEW, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(39);\"", "", "", "", "", edtavD_tam07_pwd_new_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 20, "chr", 1, "row", 20, (byte)(-1), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A102_WP01_CHG_PWD.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<th>") ;
         ...
         ClassString = "Image" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgImage9_Internalname, context.getHttpContext().getImagePath( "d5d6aaa9-3daa-4e25-b702-e0d1b5ef483e", "", "Style2"), "", "", "", "Style2", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_A102_WP01_CHG_PWD.htm");
         ...
         ClassString = "AttributeImeOff" ;
         StyleString = "background:" + WebUtils.getHTMLColor( edtavD_tam07_pwd_cfm_Backcolor) + ";" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_pwd_cfm_Internalname, GXutil.rtrim( AV10D_TAM07_PWD_CFM), GXutil.rtrim( localUtil.format( AV10D_TAM07_PWD_CFM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(43);\"", "", "", "", "", edtavD_tam07_pwd_cfm_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 20, "chr", 1, "row", 20, (byte)(-1), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A102_WP01_CHG_PWD.htm");
   ...
   public void wb_table8_46_0G2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock44_Internalname, "更新（F4）", "", "", lblTextblock44_Jsonclick, "E\\'BTN_UPD\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A102_WP01_CHG_PWD.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table6_15_0G2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock28_Internalname, "パスワード変更", "", "", lblTextblock28_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_A102_WP01_CHG_PWD.htm");
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table9_20_0G2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock43_Internalname, "閉じる（F9）", "", "", lblTextblock43_Jsonclick, "E\\'BTN_END\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A102_WP01_CHG_PWD.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?14574321");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a102_wp01_chg_pwd.js", "?14574321");
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S17417 */
                  S17417 ();
                  break;
         }
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H000G2_A8TAM07_USER_ID = new String[] {""} ;
      H000G2_A16TAM07_DEL_FLG = new String[] {""} ;
      H000G2_n16TAM07_DEL_FLG = new boolean[] {false} ;
      H000G2_A7TAM07_PWD = new String[] {""} ;
      H000G2_n7TAM07_PWD = new boolean[] {false} ;
      A8TAM07_USER_ID = "" ;
      A16TAM07_DEL_FLG = "" ;
      A7TAM07_PWD = "" ;
      AV20W_TAM07_PWD = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new a102_wp01_chg_pwd__default(),
         new Object[] {
             new Object[] {
            H000G2_A8TAM07_USER_ID, H000G2_A16TAM07_DEL_FLG, H000G2_n16TAM07_DEL_FLG, H000G2_A7TAM07_PWD, H000G2_n7TAM07_PWD
            }
         }
      );
   ...
   private String[] H000G2_A8TAM07_USER_ID ;
   private String[] H000G2_A16TAM07_DEL_FLG ;
   private boolean[] H000G2_n16TAM07_DEL_FLG ;
   private String[] H000G2_A7TAM07_PWD ;
   private boolean[] H000G2_n7TAM07_PWD ;
