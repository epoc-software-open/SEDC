...
public final  class SdtTBM26_SEL_LIST_ITEM extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( long AV446TBM26_STUDY_ID ,
                     String AV447TBM26_LIST_CD ,
                     short AV448TBM26_LIST_ITEM_NO )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {new Long(AV446TBM26_STUDY_ID),AV447TBM26_LIST_CD,new Short(AV448TBM26_LIST_ITEM_NO)});
   }
   ...
   public void tojson( )
   {
      AddObjectProperty("TBM26_STUDY_ID", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_study_id);
      AddObjectProperty("TBM26_LIST_CD", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_list_cd);
      AddObjectProperty("TBM26_LIST_ITEM_NO", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_list_item_no);
      AddObjectProperty("TBM26_LIST_ITEM_NAME", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_list_item_name);
      AddObjectProperty("TBM26_INNER_VALUE", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_inner_value);
      AddObjectProperty("TBM26_DEL_FLG", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_del_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM26_CRT_DATETIME", sDateCnv);
      AddObjectProperty("TBM26_CRT_USER_ID", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_user_id);
      AddObjectProperty("TBM26_CRT_PROG_NM", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_prog_nm);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM26_UPD_DATETIME", sDateCnv);
      AddObjectProperty("TBM26_UPD_USER_ID", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_user_id);
      AddObjectProperty("TBM26_UPD_PROG_NM", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_prog_nm);
      AddObjectProperty("TBM26_UPD_CNT", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_cnt);
      AddObjectProperty("Mode", gxTv_SdtTBM26_SEL_LIST_ITEM_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTBM26_SEL_LIST_ITEM_Initialized);
      AddObjectProperty("TBM26_STUDY_ID_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_study_id_Z);
      AddObjectProperty("TBM26_LIST_CD_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_list_cd_Z);
      AddObjectProperty("TBM26_LIST_ITEM_NO_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_list_item_no_Z);
      AddObjectProperty("TBM26_LIST_ITEM_NAME_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_list_item_name_Z);
      AddObjectProperty("TBM26_INNER_VALUE_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_inner_value_Z);
      AddObjectProperty("TBM26_DEL_FLG_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_del_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM26_CRT_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM26_CRT_USER_ID_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_user_id_Z);
      AddObjectProperty("TBM26_CRT_PROG_NM_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_prog_nm_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM26_UPD_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM26_UPD_USER_ID_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_user_id_Z);
      AddObjectProperty("TBM26_UPD_PROG_NM_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_prog_nm_Z);
      AddObjectProperty("TBM26_UPD_CNT_Z", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_cnt_Z);
      AddObjectProperty("TBM26_LIST_ITEM_NAME_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_list_item_name_N);
      AddObjectProperty("TBM26_INNER_VALUE_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_inner_value_N);
      AddObjectProperty("TBM26_DEL_FLG_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_del_flg_N);
      AddObjectProperty("TBM26_CRT_DATETIME_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_datetime_N);
      AddObjectProperty("TBM26_CRT_USER_ID_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_user_id_N);
      AddObjectProperty("TBM26_CRT_PROG_NM_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_crt_prog_nm_N);
      AddObjectProperty("TBM26_UPD_DATETIME_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_datetime_N);
      AddObjectProperty("TBM26_UPD_USER_ID_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_user_id_N);
      AddObjectProperty("TBM26_UPD_PROG_NM_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_prog_nm_N);
      AddObjectProperty("TBM26_UPD_CNT_N", gxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_upd_cnt_N);
   }
