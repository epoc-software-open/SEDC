/*
               File: A209_PC01_DOMAIN_MST_CHK
        Description: ドメインマスタ入力チェック
             Author: GeneXus Java Generator version 10_1_8-58720
       Generated on: July 3, 2017 14:56:35.60
...
public final  class a209_pc01_domain_mst_chk extends GXProcedure
{
   public a209_pc01_domain_mst_chk( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( a209_pc01_domain_mst_chk.class ), "" );
   }
   ...
   public GxObjectCollection executeUdp( SdtTBM02_CDISC_DOMAIN aP0 ,
                                         GxObjectCollection[] aP1 )
   {
      a209_pc01_domain_mst_chk.this.AV13P_BC_DOMAIN_MST = aP0;
      a209_pc01_domain_mst_chk.this.aP2 = new GxObjectCollection[] {new GxObjectCollection()};
      initialize();
      privateExecute();
      return aP2[0];
   }

   public void execute( SdtTBM02_CDISC_DOMAIN aP0 ,
                        GxObjectCollection[] aP1 ,
   ...
   private void execute_int( SdtTBM02_CDISC_DOMAIN aP0 ,
                             GxObjectCollection[] aP1 ,
                             GxObjectCollection[] aP2 )
   {
      a209_pc01_domain_mst_chk.this.AV13P_BC_DOMAIN_MST = aP0;
      a209_pc01_domain_mst_chk.this.aP1 = aP1;
      a209_pc01_domain_mst_chk.this.aP2 = aP2;
      initialize();
      /* GeneXus formulas */
   ...
   {
      AV10C_TAM020_APP_ID = "A209" ;
      /* Execute user subroutine: S14153 */
      S14153 ();
      if ( returnInSub )
      {
         returnInSub = true;
      ...
      /* Execute user subroutine: S13146 */
      S13146 ();
      if ( returnInSub )
      {
      }
   ...
   public void S1172( )
   {
      ...
      while ( AV19W_CHK_NO <= 6 )
      {
         ...
         if ( AV19W_CHK_NO == 1 )
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TBM02_DOM_CD" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "ドメインコード" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_str( AV13P_BC_DOMAIN_MST.getgxTv_SdtTBM02_CDISC_DOMAIN_Tbm02_dom_cd() );
         ...
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TBM02_DOM_JNM" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "ドメイン日本語名" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_str( AV13P_BC_DOMAIN_MST.getgxTv_SdtTBM02_CDISC_DOMAIN_Tbm02_dom_jnm() );
         ...
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TBM02_DOM_ENM" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "ドメイン英語名" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_str( AV13P_BC_DOMAIN_MST.getgxTv_SdtTBM02_CDISC_DOMAIN_Tbm02_dom_enm() );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_kbn( "STR" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_nulls( (byte)(1) );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_byte( (short)(50) );
         }
         ...
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TBM02_DOM_GRP_NM" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "ドメイングループ名" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_str( AV13P_BC_DOMAIN_MST.getgxTv_SdtTBM02_CDISC_DOMAIN_Tbm02_dom_grp_nm() );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_kbn( "STR" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_nulls( (byte)(1) );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_byte( (short)(50) );
         }
         ...
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TBM02_NOTE" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "備考" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_str( AV13P_BC_DOMAIN_MST.getgxTv_SdtTBM02_CDISC_DOMAIN_Tbm02_note() );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Chk_kbn( "STR" );
         ...
         {
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Id( "TBM02_ORDER" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Item_nm( "表示順" );
            AV15W_A_CHK_INFO_SDT_ITEM.setgxTv_SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem_Val_num( DecimalUtil.doubleToDec(AV13P_BC_DOMAIN_MST.getgxTv_SdtTBM02_CDISC_DOMAIN_Tbm02_order()) );
   ...
   public void S14153( )
   {
      ...
      a209_pc01_domain_mst_chk.this.AV21W_ERRCD = GXv_char3[0] ;
   ...
   {
      this.aP1[0] = a209_pc01_domain_mst_chk.this.AV11P_A_CHK_RESULT_SDT;
      this.aP2[0] = a209_pc01_domain_mst_chk.this.AV12P_A_RESULT_MSG_SDT;
      CloseOpenCursors();
      exitApplication();
   }
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S15171 */
                  S15171 ();
                  if ( returnInSub )
                  {
                     returnInSub = true;
   ...
   public void initialize( )
   {
      ...
      GXt_char4 = "" ;
      Gx_emsg = "" ;
      AV28Pgmname = "A209_PC01_DOMAIN_MST_CHK" ;
      /* GeneXus formulas. */
      AV28Pgmname = "A209_PC01_DOMAIN_MST_CHK" ;
      Gx_err = (short)(0) ;
   }
   ...
   private SdtTBM02_CDISC_DOMAIN AV13P_BC_DOMAIN_MST ;
