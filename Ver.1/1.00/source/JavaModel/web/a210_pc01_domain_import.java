/*
       ...
       Generated on: July 3, 2017 14:56:35.93
...
public final  class a210_pc01_domain_import extends GXProcedure
{
   ...
   {
      AV10C_APP_ID = "A210" ;
      /* Execute user subroutine: S19319 */
      S19319 ();
      if ( returnInSub )
      {
         returnInSub = true;
      ...
      if ( AV37W_RTN_CD == 0 )
      {
         /* Execute user subroutine: S15150 */
         S15150 ();
         if ( returnInSub )
         {
            returnInSub = true;
   ...
   public void S1147( )
   {
      ...
      /* Optimized DELETE. */
      /* Executing LOCK TABLES `TBM02_CDISC_DOMAIN` WRITE */
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S20337 */
                  S20337 ();
                  if ( returnInSub )
                  {
                     returnInSub = true;
   ...
   public void initialize( )
   {
      ...
      AV10C_APP_ID = "" ;
      AV9BC_CDISC_DOMAIN_C = new GxObjectCollection(SdtTBM02_CDISC_DOMAIN.class, "TBM02_CDISC_DOMAIN", "SmartEDC_SHIZUOKA", remoteHandle);
      Gx_ope = "" ;
      Gx_etb = "" ;
...
final  class a210_pc01_domain_import__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new DirectStatement("LOCK TABLES `TBM02_CDISC_DOMAIN` WRITE", GX_MASKLOCKERR + GX_MASKLOOPLOCK,0)
         ,new DirectStatement("UNLOCK TABLES", GX_MASKLOCKERR + GX_MASKLOOPLOCK,0)
         ,new UpdateCursor("P006F2", "DELETE FROM `TBM02_CDISC_DOMAIN` ", GX_NOMASK + GX_MASKLOOPLOCK)
      };
   }
