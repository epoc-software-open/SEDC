/*
       ...
       Generated on: July 3, 2017 14:51:43.90
...
public final  class a801_pc01_sys_config_init extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      /* User Code */
      	AV21W_LANG = "JAVA";
      if ( GXutil.strcmp(AV21W_LANG, "JAVA") == 0 )
      {
         AV23W_MOJI_CD = "MS932" ;
      }
      else
      {
         AV23W_MOJI_CD = "Shift-JIS" ;
      }
      AV15W_DIR.setSource( "." );
      if ( GXutil.strcmp(AV21W_LANG, "JAVA") == 0 )
      {
         ...
         AV28W_DIRPATH = GXutil.substring( AV15W_DIR.getAbsoluteName(), 1, AV24W_NUM) ;
         AV25W_READ_FILE = AV28W_DIRPATH + "/webapps/" + AV26W_SCRIPTPATH + "/static" + "/ini/GXX_SYS_CONFIG.INI" ;
      }
      else
      {
         AV25W_READ_FILE = AV15W_DIR.getAbsoluteName() + "\\ini\\GXX_SYS_CONFIG.INI" ;
      }
   ...
   {
      AV8W_A801_SD01_SYS_CONFIG = new GxObjectCollection(SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem.class, "A801_SD01_SYS_CONFIG.A801_SD01_SYS_CONFIGItem", "SmartEDC_SHIZUOKA", remoteHandle);
      AV13W_DEL_CHR = "" ;
