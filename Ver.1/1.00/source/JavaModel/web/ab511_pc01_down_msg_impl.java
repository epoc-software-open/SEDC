...
public final  class ab511_pc01_down_msg_impl extends GXWebProcedure
{
   public ab511_pc01_down_msg_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      ab511_pc01_down_msg_impl.this.GXt_char1 = GXv_char2[0] ;
      ...
      if ( AV11W_ERR_CD == 0 )
      {
         ...
         new b599_pc23_msg_res(remoteHandle, context).execute( "", GXv_objcol_svchar3, GXv_int4, GXv_char2) ;
         AV16W_RTN_CSV = GXv_objcol_svchar3[0] ;
         ab511_pc01_down_msg_impl.this.AV11W_ERR_CD = GXv_int4[0] ;
         ab511_pc01_down_msg_impl.this.AV12W_ERR_MSG = GXv_char2[0] ;
      }
   ...
   public void S1279( )
   {
      ...
      ab511_pc01_down_msg_impl.this.AV9P_USER_ID = GXv_char2[0] ;
      ab511_pc01_down_msg_impl.this.AV11W_ERR_CD = GXv_int4[0] ;
      ab511_pc01_down_msg_impl.this.AV12W_ERR_MSG = GXv_char6[0] ;
   }
   ...
   public void S1395( )
   {
      ...
      if ( AV11W_ERR_CD == 0 )
      {
         Application.commit(context, remoteHandle, "DEFAULT", "ab511_pc01_down_msg");
      }
      else
      {
         Application.rollback(context, remoteHandle, "DEFAULT", "ab511_pc01_down_msg");
      }
   ...
   public void initialize( )
   {
      ...
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new ab511_pc01_down_msg__default(),
         new Object[] {
         }
      );
      pr_default.setErrorHandler(this);
      AV24Pgmdesc = "メッセージマスタダウンロード" ;
      AV23Pgmname = "AB511_PC01_DOWN_MSG" ;
      /* GeneXus formulas. */
      AV24Pgmdesc = "メッセージマスタダウンロード" ;
      AV23Pgmname = "AB511_PC01_DOWN_MSG" ;
      Gx_err = (short)(0) ;
...
final  class ab511_pc01_down_msg__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
