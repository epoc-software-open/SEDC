/*
               File: A812_PC02_TAB_CSV_OUTPUT
        Description: タブ区切りCSVファイル出力処理
             Author: GeneXus Java Generator version 10_1_8-58720
       Generated on: July 3, 2017 14:51:46.99
...
public final  class a812_pc02_tab_csv_output extends GXProcedure
{
   public a812_pc02_tab_csv_output( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( a812_pc02_tab_csv_output.class ), "" );
   }
   ...
   public String executeUdp( SdtA_LOGIN_SDT aP0 ,
                             ...
                             String[] aP4 )
   {
      a812_pc02_tab_csv_output.this.AV9P_A_LOGIN_SDT = aP0;
      a812_pc02_tab_csv_output.this.AV12P_SYS_ID = aP1;
      a812_pc02_tab_csv_output.this.AV10P_A812_SD01_CSV_OUTPUT = aP2;
      a812_pc02_tab_csv_output.this.AV11P_FILE_NAME = aP3;
      a812_pc02_tab_csv_output.this.aP5 = new String[] {""};
      initialize();
      privateExecute();
      return aP5[0];
   }
                             ...
                             String[] aP5 )
   {
      ...
      a812_pc02_tab_csv_output.this.AV10P_A812_SD01_CSV_OUTPUT = aP2;
      a812_pc02_tab_csv_output.this.AV11P_FILE_NAME = aP3;
      a812_pc02_tab_csv_output.this.aP4 = aP4;
      a812_pc02_tab_csv_output.this.aP5 = aP5;
      initialize();
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      AV23W_PARM_MSG = "" ;
      AV17W_CSV_SDEL = "" ;
      AV16W_CSV_FDEL = GXutil.chr( (short)(9)) ;
      /* User Code */
      	AV8W_LANG = "JAVA";
      ...
      if ( AV20W_HANDLE != 0 )
      {
         ...
         a812_pc02_tab_csv_output.this.GXt_char1 = GXv_char2[0] ;
      ...
      while ( AV26GXV1 <= AV10P_A812_SD01_CSV_OUTPUT.size() )
      {
         ...
         AV20W_HANDLE = (byte)(context.getSessionInstances().getDelimitedFiles().dfwptxt( AV14W_CSV_DATA, (short)(5000))) ;
         /* Execute user subroutine: S11112 */
         S11112 ();
         if ( returnInSub )
         {
            returnInSub = true;
   ...
   {
      this.aP4[0] = a812_pc02_tab_csv_output.this.AV18W_FILE_PATH;
      this.aP5[0] = a812_pc02_tab_csv_output.this.AV23W_PARM_MSG;
      CloseOpenCursors();
      exitApplication();
   }
