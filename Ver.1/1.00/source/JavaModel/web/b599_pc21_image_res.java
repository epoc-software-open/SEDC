/*
       ...
       Generated on: July 3, 2017 14:52:30.12
...
public final  class b599_pc21_image_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A414TBM11_DEL_FLG = P003Q2_A414TBM11_DEL_FLG[0] ;
         n414TBM11_DEL_FLG = P003Q2_n414TBM11_DEL_FLG[0] ;
         A512TBM11_STUDY_ID = P003Q2_A512TBM11_STUDY_ID[0] ;
         n512TBM11_STUDY_ID = P003Q2_n512TBM11_STUDY_ID[0] ;
         A411TBM11_IMAGE_CD = P003Q2_A411TBM11_IMAGE_CD[0] ;
         A412TBM11_IMAGE = P003Q2_A412TBM11_IMAGE[0] ;
         n412TBM11_IMAGE = P003Q2_n412TBM11_IMAGE[0] ;
         A421TBM11_UPD_CNT = P003Q2_A421TBM11_UPD_CNT[0] ;
         n421TBM11_UPD_CNT = P003Q2_n421TBM11_UPD_CNT[0] ;
         A420TBM11_UPD_PROG_NM = P003Q2_A420TBM11_UPD_PROG_NM[0] ;
         n420TBM11_UPD_PROG_NM = P003Q2_n420TBM11_UPD_PROG_NM[0] ;
         A419TBM11_UPD_USER_ID = P003Q2_A419TBM11_UPD_USER_ID[0] ;
         n419TBM11_UPD_USER_ID = P003Q2_n419TBM11_UPD_USER_ID[0] ;
         A418TBM11_UPD_DATETIME = P003Q2_A418TBM11_UPD_DATETIME[0] ;
         n418TBM11_UPD_DATETIME = P003Q2_n418TBM11_UPD_DATETIME[0] ;
         A417TBM11_CRT_PROG_NM = P003Q2_A417TBM11_CRT_PROG_NM[0] ;
         n417TBM11_CRT_PROG_NM = P003Q2_n417TBM11_CRT_PROG_NM[0] ;
         A416TBM11_CRT_USER_ID = P003Q2_A416TBM11_CRT_USER_ID[0] ;
         n416TBM11_CRT_USER_ID = P003Q2_n416TBM11_CRT_USER_ID[0] ;
         A415TBM11_CRT_DATETIME = P003Q2_A415TBM11_CRT_DATETIME[0] ;
         n415TBM11_CRT_DATETIME = P003Q2_n415TBM11_CRT_DATETIME[0] ;
         A413TBM11_FILE_NAME = P003Q2_A413TBM11_FILE_NAME[0] ;
         n413TBM11_FILE_NAME = P003Q2_n413TBM11_FILE_NAME[0] ;
         A542TBM11_IMAGE_NM = P003Q2_A542TBM11_IMAGE_NM[0] ;
         n542TBM11_IMAGE_NM = P003Q2_n542TBM11_IMAGE_NM[0] ;
         AV23GXLvl33 = (byte)(1) ;
         GXt_char1 = AV15W_STR ;
         GXv_char2[0] = GXt_char1 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A411TBM11_IMAGE_CD, GXv_char2) ;
         b599_pc21_image_res.this.GXt_char1 = GXv_char2[0] ;
         GXt_char3 = AV15W_STR ;
         GXv_char4[0] = GXt_char3 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A542TBM11_IMAGE_NM, GXv_char4) ;
         b599_pc21_image_res.this.GXt_char3 = GXv_char4[0] ;
         GXt_char5 = AV15W_STR ;
         GXv_char6[0] = GXt_char5 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A413TBM11_FILE_NAME, GXv_char6) ;
         b599_pc21_image_res.this.GXt_char5 = GXv_char6[0] ;
         GXt_char7 = AV15W_STR ;
         GXv_char8[0] = GXt_char7 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A415TBM11_CRT_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char8) ;
         b599_pc21_image_res.this.GXt_char7 = GXv_char8[0] ;
         GXt_char9 = AV15W_STR ;
         GXv_char10[0] = GXt_char9 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A416TBM11_CRT_USER_ID, GXv_char10) ;
         b599_pc21_image_res.this.GXt_char9 = GXv_char10[0] ;
         GXt_char11 = AV15W_STR ;
         GXv_char12[0] = GXt_char11 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A417TBM11_CRT_PROG_NM, GXv_char12) ;
         b599_pc21_image_res.this.GXt_char11 = GXv_char12[0] ;
         GXt_char13 = AV15W_STR ;
         GXv_char14[0] = GXt_char13 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A418TBM11_UPD_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char14) ;
         b599_pc21_image_res.this.GXt_char13 = GXv_char14[0] ;
         GXt_char15 = AV15W_STR ;
         GXv_char16[0] = GXt_char15 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A419TBM11_UPD_USER_ID, GXv_char16) ;
         b599_pc21_image_res.this.GXt_char15 = GXv_char16[0] ;
         GXt_char17 = AV15W_STR ;
         GXv_char18[0] = GXt_char17 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A420TBM11_UPD_PROG_NM, GXv_char18) ;
         b599_pc21_image_res.this.GXt_char17 = GXv_char18[0] ;
         AV15W_STR = GXt_char1 + "," + GXt_char3 + "," + GXutil.blobToBase64( A412TBM11_IMAGE) + "," + GXt_char5 + "," + GXutil.trim( GXutil.str( A512TBM11_STUDY_ID, 10, 0)) + "," + A414TBM11_DEL_FLG + "," + GXt_char7 + "," + GXt_char9 + "," + GXt_char11 + "," + GXt_char13 + "," + GXt_char15 + "," + GXt_char17 + "," + GXutil.trim( GXutil.str( A421TBM11_UPD_CNT, 10, 0)) ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P003Q2_A414TBM11_DEL_FLG = new String[] {""} ;
      P003Q2_n414TBM11_DEL_FLG = new boolean[] {false} ;
      P003Q2_A512TBM11_STUDY_ID = new long[1] ;
      P003Q2_n512TBM11_STUDY_ID = new boolean[] {false} ;
      P003Q2_A411TBM11_IMAGE_CD = new String[] {""} ;
      P003Q2_A412TBM11_IMAGE = new String[] {""} ;
      P003Q2_n412TBM11_IMAGE = new boolean[] {false} ;
      P003Q2_A421TBM11_UPD_CNT = new long[1] ;
      P003Q2_n421TBM11_UPD_CNT = new boolean[] {false} ;
      P003Q2_A420TBM11_UPD_PROG_NM = new String[] {""} ;
      P003Q2_n420TBM11_UPD_PROG_NM = new boolean[] {false} ;
      P003Q2_A419TBM11_UPD_USER_ID = new String[] {""} ;
      P003Q2_n419TBM11_UPD_USER_ID = new boolean[] {false} ;
      P003Q2_A418TBM11_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P003Q2_n418TBM11_UPD_DATETIME = new boolean[] {false} ;
      P003Q2_A417TBM11_CRT_PROG_NM = new String[] {""} ;
      P003Q2_n417TBM11_CRT_PROG_NM = new boolean[] {false} ;
      P003Q2_A416TBM11_CRT_USER_ID = new String[] {""} ;
      P003Q2_n416TBM11_CRT_USER_ID = new boolean[] {false} ;
      P003Q2_A415TBM11_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P003Q2_n415TBM11_CRT_DATETIME = new boolean[] {false} ;
      P003Q2_A413TBM11_FILE_NAME = new String[] {""} ;
      P003Q2_n413TBM11_FILE_NAME = new boolean[] {false} ;
      P003Q2_A542TBM11_IMAGE_NM = new String[] {""} ;
      P003Q2_n542TBM11_IMAGE_NM = new boolean[] {false} ;
      A412TBM11_IMAGE = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc21_image_res__default(),
         new Object[] {
             new Object[] {
            P003Q2_A414TBM11_DEL_FLG, P003Q2_n414TBM11_DEL_FLG, P003Q2_A512TBM11_STUDY_ID, P003Q2_n512TBM11_STUDY_ID, P003Q2_A411TBM11_IMAGE_CD, P003Q2_A412TBM11_IMAGE, P003Q2_n412TBM11_IMAGE, P003Q2_A421TBM11_UPD_CNT, P003Q2_n421TBM11_UPD_CNT, P003Q2_A420TBM11_UPD_PROG_NM,
            P003Q2_n420TBM11_UPD_PROG_NM, P003Q2_A419TBM11_UPD_USER_ID, P003Q2_n419TBM11_UPD_USER_ID, P003Q2_A418TBM11_UPD_DATETIME, P003Q2_n418TBM11_UPD_DATETIME, P003Q2_A417TBM11_CRT_PROG_NM, P003Q2_n417TBM11_CRT_PROG_NM, P003Q2_A416TBM11_CRT_USER_ID, P003Q2_n416TBM11_CRT_USER_ID, P003Q2_A415TBM11_CRT_DATETIME,
            P003Q2_n415TBM11_CRT_DATETIME, P003Q2_A413TBM11_FILE_NAME, P003Q2_n413TBM11_FILE_NAME, P003Q2_A542TBM11_IMAGE_NM, P003Q2_n542TBM11_IMAGE_NM
            }
         }
      );
   ...
   private String[] P003Q2_A414TBM11_DEL_FLG ;
   private boolean[] P003Q2_n414TBM11_DEL_FLG ;
   private long[] P003Q2_A512TBM11_STUDY_ID ;
   private boolean[] P003Q2_n512TBM11_STUDY_ID ;
   private String[] P003Q2_A411TBM11_IMAGE_CD ;
   private String[] P003Q2_A412TBM11_IMAGE ;
   private boolean[] P003Q2_n412TBM11_IMAGE ;
   private long[] P003Q2_A421TBM11_UPD_CNT ;
   private boolean[] P003Q2_n421TBM11_UPD_CNT ;
   private String[] P003Q2_A420TBM11_UPD_PROG_NM ;
   private boolean[] P003Q2_n420TBM11_UPD_PROG_NM ;
   private String[] P003Q2_A419TBM11_UPD_USER_ID ;
   private boolean[] P003Q2_n419TBM11_UPD_USER_ID ;
   private java.util.Date[] P003Q2_A418TBM11_UPD_DATETIME ;
   private boolean[] P003Q2_n418TBM11_UPD_DATETIME ;
   private String[] P003Q2_A417TBM11_CRT_PROG_NM ;
   private boolean[] P003Q2_n417TBM11_CRT_PROG_NM ;
   private String[] P003Q2_A416TBM11_CRT_USER_ID ;
   private boolean[] P003Q2_n416TBM11_CRT_USER_ID ;
   private java.util.Date[] P003Q2_A415TBM11_CRT_DATETIME ;
   private boolean[] P003Q2_n415TBM11_CRT_DATETIME ;
   private String[] P003Q2_A413TBM11_FILE_NAME ;
   private boolean[] P003Q2_n413TBM11_FILE_NAME ;
   private String[] P003Q2_A542TBM11_IMAGE_NM ;
   private boolean[] P003Q2_n542TBM11_IMAGE_NM ;
...
{
   protected Object[] conditional_P003Q2( com.genexus.internet.HttpContext httpContext ,
                                          String AV9P_IMAGE_CD ,
                                          String AV10P_STUDY_ID ,
                                          String A411TBM11_IMAGE_CD ,
                                          long A512TBM11_STUDY_ID ,
                                          long AV16W_STUDY_ID ,
                                          String A414TBM11_DEL_FLG )
   {
      String sWhereString = "" ;
      String scmdbuf ;
      byte[] GXv_int21 ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P003Q2(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P003Q2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[5])[0] = rslt.getBLOBFile(4, "", "") ;
