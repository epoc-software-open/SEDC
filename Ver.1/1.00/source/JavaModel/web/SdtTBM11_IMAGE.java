...
public final  class SdtTBM11_IMAGE extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( String AV411TBM11_IMAGE_CD )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {AV411TBM11_IMAGE_CD});
   }
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBM11_IMAGE_Z") )
            {
               gxTv_SdtTBM11_IMAGE_Tbm11_image_Z=GXutil.blobFromBase64( oReader.getValue()) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         String sNameSpace )
   {
      ...
      oWriter.writeElement("TBM11_IMAGE_Z", GXutil.blobToBase64( gxTv_SdtTBM11_IMAGE_Tbm11_image_Z));
      if ( GXutil.strcmp(sNameSpace, "SmartEDC_SHIZUOKA") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SmartEDC_SHIZUOKA");
      }
   ...
   public void tojson( )
   {
      AddObjectProperty("TBM11_IMAGE_CD", gxTv_SdtTBM11_IMAGE_Tbm11_image_cd);
      AddObjectProperty("TBM11_IMAGE_NM", gxTv_SdtTBM11_IMAGE_Tbm11_image_nm);
      AddObjectProperty("TBM11_IMAGE", gxTv_SdtTBM11_IMAGE_Tbm11_image);
      AddObjectProperty("TBM11_FILE_NAME", gxTv_SdtTBM11_IMAGE_Tbm11_file_name);
      AddObjectProperty("TBM11_STUDY_ID", gxTv_SdtTBM11_IMAGE_Tbm11_study_id);
      AddObjectProperty("TBM11_DEL_FLG", gxTv_SdtTBM11_IMAGE_Tbm11_del_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM11_IMAGE_Tbm11_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM11_IMAGE_Tbm11_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM11_CRT_DATETIME", sDateCnv);
      AddObjectProperty("TBM11_CRT_USER_ID", gxTv_SdtTBM11_IMAGE_Tbm11_crt_user_id);
      AddObjectProperty("TBM11_CRT_PROG_NM", gxTv_SdtTBM11_IMAGE_Tbm11_crt_prog_nm);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM11_UPD_DATETIME", sDateCnv);
      AddObjectProperty("TBM11_UPD_USER_ID", gxTv_SdtTBM11_IMAGE_Tbm11_upd_user_id);
      AddObjectProperty("TBM11_UPD_PROG_NM", gxTv_SdtTBM11_IMAGE_Tbm11_upd_prog_nm);
      AddObjectProperty("TBM11_UPD_CNT", gxTv_SdtTBM11_IMAGE_Tbm11_upd_cnt);
      AddObjectProperty("Mode", gxTv_SdtTBM11_IMAGE_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTBM11_IMAGE_Initialized);
      AddObjectProperty("TBM11_IMAGE_CD_Z", gxTv_SdtTBM11_IMAGE_Tbm11_image_cd_Z);
      AddObjectProperty("TBM11_IMAGE_NM_Z", gxTv_SdtTBM11_IMAGE_Tbm11_image_nm_Z);
      AddObjectProperty("TBM11_IMAGE_Z", gxTv_SdtTBM11_IMAGE_Tbm11_image_Z);
      AddObjectProperty("TBM11_FILE_NAME_Z", gxTv_SdtTBM11_IMAGE_Tbm11_file_name_Z);
      AddObjectProperty("TBM11_STUDY_ID_Z", gxTv_SdtTBM11_IMAGE_Tbm11_study_id_Z);
      AddObjectProperty("TBM11_DEL_FLG_Z", gxTv_SdtTBM11_IMAGE_Tbm11_del_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM11_IMAGE_Tbm11_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM11_IMAGE_Tbm11_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM11_CRT_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM11_CRT_USER_ID_Z", gxTv_SdtTBM11_IMAGE_Tbm11_crt_user_id_Z);
      AddObjectProperty("TBM11_CRT_PROG_NM_Z", gxTv_SdtTBM11_IMAGE_Tbm11_crt_prog_nm_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM11_UPD_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM11_UPD_USER_ID_Z", gxTv_SdtTBM11_IMAGE_Tbm11_upd_user_id_Z);
      AddObjectProperty("TBM11_UPD_PROG_NM_Z", gxTv_SdtTBM11_IMAGE_Tbm11_upd_prog_nm_Z);
      AddObjectProperty("TBM11_UPD_CNT_Z", gxTv_SdtTBM11_IMAGE_Tbm11_upd_cnt_Z);
      AddObjectProperty("TBM11_IMAGE_NM_N", gxTv_SdtTBM11_IMAGE_Tbm11_image_nm_N);
      AddObjectProperty("TBM11_IMAGE_N", gxTv_SdtTBM11_IMAGE_Tbm11_image_N);
      AddObjectProperty("TBM11_FILE_NAME_N", gxTv_SdtTBM11_IMAGE_Tbm11_file_name_N);
      AddObjectProperty("TBM11_STUDY_ID_N", gxTv_SdtTBM11_IMAGE_Tbm11_study_id_N);
      AddObjectProperty("TBM11_DEL_FLG_N", gxTv_SdtTBM11_IMAGE_Tbm11_del_flg_N);
      AddObjectProperty("TBM11_CRT_DATETIME_N", gxTv_SdtTBM11_IMAGE_Tbm11_crt_datetime_N);
      AddObjectProperty("TBM11_CRT_USER_ID_N", gxTv_SdtTBM11_IMAGE_Tbm11_crt_user_id_N);
      AddObjectProperty("TBM11_CRT_PROG_NM_N", gxTv_SdtTBM11_IMAGE_Tbm11_crt_prog_nm_N);
      AddObjectProperty("TBM11_UPD_DATETIME_N", gxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime_N);
      AddObjectProperty("TBM11_UPD_USER_ID_N", gxTv_SdtTBM11_IMAGE_Tbm11_upd_user_id_N);
      AddObjectProperty("TBM11_UPD_PROG_NM_N", gxTv_SdtTBM11_IMAGE_Tbm11_upd_prog_nm_N);
      AddObjectProperty("TBM11_UPD_CNT_N", gxTv_SdtTBM11_IMAGE_Tbm11_upd_cnt_N);
   }
   ...
   public void setgxTv_SdtTBM11_IMAGE_Tbm11_image_cd( String value )
   {
      if ( GXutil.strcmp(gxTv_SdtTBM11_IMAGE_Tbm11_image_cd, value) != 0 )
      {
         ...
         this.setgxTv_SdtTBM11_IMAGE_Tbm11_image_Z_SetNull( );
   ...
   public String getgxTv_SdtTBM11_IMAGE_Tbm11_image_Z( )
   {
      return gxTv_SdtTBM11_IMAGE_Tbm11_image_Z ;
   }

   public void setgxTv_SdtTBM11_IMAGE_Tbm11_image_Z( String value )
   {
      gxTv_SdtTBM11_IMAGE_Tbm11_image_Z = value ;
   }

   public void setgxTv_SdtTBM11_IMAGE_Tbm11_image_Z_SetNull( )
   {
      gxTv_SdtTBM11_IMAGE_Tbm11_image_Z = "" ;
   }

   public boolean getgxTv_SdtTBM11_IMAGE_Tbm11_image_Z_IsNull( )
   {
      return false ;
   }
   ...
   public void setStruct( StructSdtTBM11_IMAGE struct )
   {
      ...
      setgxTv_SdtTBM11_IMAGE_Tbm11_image_Z(struct.getTbm11_image_Z());
   ...
   public StructSdtTBM11_IMAGE getStruct( )
   {
      ...
      struct.setTbm11_image_Z(getgxTv_SdtTBM11_IMAGE_Tbm11_image_Z());
