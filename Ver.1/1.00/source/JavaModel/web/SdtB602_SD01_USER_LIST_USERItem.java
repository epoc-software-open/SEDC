...
public final  class SdtB602_SD01_USER_LIST_USERItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
   ...
   public void tojson( )
   {
      AddObjectProperty("LOGIN_ID", gxTv_SdtB602_SD01_USER_LIST_USERItem_Login_id);
      AddObjectProperty("PASSWORD", gxTv_SdtB602_SD01_USER_LIST_USERItem_Password);
      AddObjectProperty("HANDLE", gxTv_SdtB602_SD01_USER_LIST_USERItem_Handle);
      AddObjectProperty("ROLE_AUTHORITY_ID", gxTv_SdtB602_SD01_USER_LIST_USERItem_Role_authority_id);
      AddObjectProperty("BELONG", gxTv_SdtB602_SD01_USER_LIST_USERItem_Belong);
      AddObjectProperty("EMAIL", gxTv_SdtB602_SD01_USER_LIST_USERItem_Email);
   }
   ...
   public void setgxTv_SdtB602_SD01_USER_LIST_USERItem_Login_id_SetNull( )
   {
      gxTv_SdtB602_SD01_USER_LIST_USERItem_Login_id = "" ;
   }

   public boolean getgxTv_SdtB602_SD01_USER_LIST_USERItem_Login_id_IsNull( )
   {
      return false ;
   }
   ...
   public void setgxTv_SdtB602_SD01_USER_LIST_USERItem_Password_SetNull( )
   {
      gxTv_SdtB602_SD01_USER_LIST_USERItem_Password = "" ;
   }

   public boolean getgxTv_SdtB602_SD01_USER_LIST_USERItem_Password_IsNull( )
   {
      return false ;
   }
   ...
   public void setgxTv_SdtB602_SD01_USER_LIST_USERItem_Handle_SetNull( )
   {
      gxTv_SdtB602_SD01_USER_LIST_USERItem_Handle = "" ;
   }

   public boolean getgxTv_SdtB602_SD01_USER_LIST_USERItem_Handle_IsNull( )
   {
      return false ;
   }
   ...
   public void setgxTv_SdtB602_SD01_USER_LIST_USERItem_Role_authority_id_SetNull( )
   {
      gxTv_SdtB602_SD01_USER_LIST_USERItem_Role_authority_id = 0 ;
   }

   public boolean getgxTv_SdtB602_SD01_USER_LIST_USERItem_Role_authority_id_IsNull( )
   {
      return false ;
   }
   ...
   public void setgxTv_SdtB602_SD01_USER_LIST_USERItem_Belong_SetNull( )
   {
      gxTv_SdtB602_SD01_USER_LIST_USERItem_Belong = "" ;
   }

   public boolean getgxTv_SdtB602_SD01_USER_LIST_USERItem_Belong_IsNull( )
   {
      return false ;
   }
   ...
   public void setgxTv_SdtB602_SD01_USER_LIST_USERItem_Email_SetNull( )
   {
      gxTv_SdtB602_SD01_USER_LIST_USERItem_Email = "" ;
   }

   public boolean getgxTv_SdtB602_SD01_USER_LIST_USERItem_Email_IsNull( )
   {
      return false ;
   }
