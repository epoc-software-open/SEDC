...
public final  class SdtTAM05_APPLI_KNGN extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( String AV17TAM04_AUTH_CD ,
                     String AV88TAM03_APP_ID )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {AV17TAM04_AUTH_CD,AV88TAM03_APP_ID});
   }
   ...
   public void tojson( )
   {
      AddObjectProperty("TAM04_AUTH_CD", gxTv_SdtTAM05_APPLI_KNGN_Tam04_auth_cd);
      AddObjectProperty("TAM03_APP_ID", gxTv_SdtTAM05_APPLI_KNGN_Tam03_app_id);
      AddObjectProperty("TAM05_KNGN_FLG", gxTv_SdtTAM05_APPLI_KNGN_Tam05_kngn_flg);
      AddObjectProperty("TAM05_DEL_FLG", gxTv_SdtTAM05_APPLI_KNGN_Tam05_del_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTAM05_APPLI_KNGN_Tam05_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TAM05_CRT_USER_ID", gxTv_SdtTAM05_APPLI_KNGN_Tam05_crt_user_id);
      AddObjectProperty("TAM05_CRT_PROG_NM", gxTv_SdtTAM05_APPLI_KNGN_Tam05_crt_prog_nm);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TAM05_UPD_USER_ID", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_user_id);
      AddObjectProperty("TAM05_UPD_PROG_NM", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_prog_nm);
      AddObjectProperty("TAM05_UPD_CNT", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_cnt);
      AddObjectProperty("Mode", gxTv_SdtTAM05_APPLI_KNGN_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTAM05_APPLI_KNGN_Initialized);
      AddObjectProperty("TAM04_AUTH_CD_Z", gxTv_SdtTAM05_APPLI_KNGN_Tam04_auth_cd_Z);
      AddObjectProperty("TAM03_APP_ID_Z", gxTv_SdtTAM05_APPLI_KNGN_Tam03_app_id_Z);
      AddObjectProperty("TAM05_KNGN_FLG_Z", gxTv_SdtTAM05_APPLI_KNGN_Tam05_kngn_flg_Z);
      AddObjectProperty("TAM05_DEL_FLG_Z", gxTv_SdtTAM05_APPLI_KNGN_Tam05_del_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTAM05_APPLI_KNGN_Tam05_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TAM05_CRT_USER_ID_Z", gxTv_SdtTAM05_APPLI_KNGN_Tam05_crt_user_id_Z);
      AddObjectProperty("TAM05_CRT_PROG_NM_Z", gxTv_SdtTAM05_APPLI_KNGN_Tam05_crt_prog_nm_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TAM05_UPD_USER_ID_Z", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_user_id_Z);
      AddObjectProperty("TAM05_UPD_PROG_NM_Z", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_prog_nm_Z);
      AddObjectProperty("TAM05_UPD_CNT_Z", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_cnt_Z);
      AddObjectProperty("TAM05_KNGN_FLG_N", gxTv_SdtTAM05_APPLI_KNGN_Tam05_kngn_flg_N);
      AddObjectProperty("TAM05_DEL_FLG_N", gxTv_SdtTAM05_APPLI_KNGN_Tam05_del_flg_N);
      AddObjectProperty("TAM05_CRT_DATETIME_N", gxTv_SdtTAM05_APPLI_KNGN_Tam05_crt_datetime_N);
      AddObjectProperty("TAM05_CRT_USER_ID_N", gxTv_SdtTAM05_APPLI_KNGN_Tam05_crt_user_id_N);
      AddObjectProperty("TAM05_CRT_PROG_NM_N", gxTv_SdtTAM05_APPLI_KNGN_Tam05_crt_prog_nm_N);
      AddObjectProperty("TAM05_UPD_DATETIME_N", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_datetime_N);
      AddObjectProperty("TAM05_UPD_USER_ID_N", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_user_id_N);
      AddObjectProperty("TAM05_UPD_PROG_NM_N", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_prog_nm_N);
      AddObjectProperty("TAM05_UPD_CNT_N", gxTv_SdtTAM05_APPLI_KNGN_Tam05_upd_cnt_N);
   }
