...
public final  class SdtTBW06_CRF_MEMO extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( String AV698TBW06_SESSION_ID ,
                     String AV699TBW06_APP_ID ,
                     String AV700TBW06_DISP_DATETIME ,
                     long AV701TBW06_STUDY_ID ,
                     int AV702TBW06_SUBJECT_ID ,
                     short AV703TBW06_INS_NO )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {AV698TBW06_SESSION_ID,AV699TBW06_APP_ID,AV700TBW06_DISP_DATETIME,new Long(AV701TBW06_STUDY_ID),new Integer(AV702TBW06_SUBJECT_ID),new Short(AV703TBW06_INS_NO)});
   }
   ...
   public void tojson( )
   {
      AddObjectProperty("TBW06_SESSION_ID", gxTv_SdtTBW06_CRF_MEMO_Tbw06_session_id);
      AddObjectProperty("TBW06_APP_ID", gxTv_SdtTBW06_CRF_MEMO_Tbw06_app_id);
      AddObjectProperty("TBW06_DISP_DATETIME", gxTv_SdtTBW06_CRF_MEMO_Tbw06_disp_datetime);
      AddObjectProperty("TBW06_STUDY_ID", gxTv_SdtTBW06_CRF_MEMO_Tbw06_study_id);
      AddObjectProperty("TBW06_SUBJECT_ID", gxTv_SdtTBW06_CRF_MEMO_Tbw06_subject_id);
      AddObjectProperty("TBW06_INS_NO", gxTv_SdtTBW06_CRF_MEMO_Tbw06_ins_no);
      AddObjectProperty("TBW06_CRF_ID", gxTv_SdtTBW06_CRF_MEMO_Tbw06_crf_id);
      AddObjectProperty("TBW06_CRF_VERSION", gxTv_SdtTBW06_CRF_MEMO_Tbw06_crf_version);
      AddObjectProperty("TBW06_MEMO", gxTv_SdtTBW06_CRF_MEMO_Tbw06_memo);
      AddObjectProperty("TBW06_STYDY_AUTH_CD", gxTv_SdtTBW06_CRF_MEMO_Tbw06_stydy_auth_cd);
      AddObjectProperty("TBW06_REQUEST_USER_ID", gxTv_SdtTBW06_CRF_MEMO_Tbw06_request_user_id);
      AddObjectProperty("TBW06_EDIT_REQUEST_FLG", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_request_flg);
      AddObjectProperty("TBW06_EDIT_REQUEST_END_FLG", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_request_end_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_req_end_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_req_end_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBW06_EDIT_REQ_END_DATETIME", sDateCnv);
      AddObjectProperty("TBW06_EDIT_REQUEST_END_USER_ID", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_request_end_user_id);
      AddObjectProperty("TBW06_PROC_DIV", gxTv_SdtTBW06_CRF_MEMO_Tbw06_proc_div);
      AddObjectProperty("Mode", gxTv_SdtTBW06_CRF_MEMO_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTBW06_CRF_MEMO_Initialized);
      AddObjectProperty("TBW06_SESSION_ID_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_session_id_Z);
      AddObjectProperty("TBW06_APP_ID_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_app_id_Z);
      AddObjectProperty("TBW06_DISP_DATETIME_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_disp_datetime_Z);
      AddObjectProperty("TBW06_STUDY_ID_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_study_id_Z);
      AddObjectProperty("TBW06_SUBJECT_ID_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_subject_id_Z);
      AddObjectProperty("TBW06_INS_NO_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_ins_no_Z);
      AddObjectProperty("TBW06_CRF_ID_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_crf_id_Z);
      AddObjectProperty("TBW06_CRF_VERSION_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_crf_version_Z);
      AddObjectProperty("TBW06_MEMO_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_memo_Z);
      AddObjectProperty("TBW06_STYDY_AUTH_CD_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_stydy_auth_cd_Z);
      AddObjectProperty("TBW06_REQUEST_USER_ID_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_request_user_id_Z);
      AddObjectProperty("TBW06_EDIT_REQUEST_FLG_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_request_flg_Z);
      AddObjectProperty("TBW06_EDIT_REQUEST_END_FLG_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_request_end_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_req_end_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_req_end_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBW06_EDIT_REQ_END_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBW06_EDIT_REQUEST_END_USER_ID_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_request_end_user_id_Z);
      AddObjectProperty("TBW06_PROC_DIV_Z", gxTv_SdtTBW06_CRF_MEMO_Tbw06_proc_div_Z);
      AddObjectProperty("TBW06_CRF_ID_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_crf_id_N);
      AddObjectProperty("TBW06_CRF_VERSION_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_crf_version_N);
      AddObjectProperty("TBW06_MEMO_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_memo_N);
      AddObjectProperty("TBW06_STYDY_AUTH_CD_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_stydy_auth_cd_N);
      AddObjectProperty("TBW06_REQUEST_USER_ID_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_request_user_id_N);
      AddObjectProperty("TBW06_EDIT_REQUEST_FLG_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_request_flg_N);
      AddObjectProperty("TBW06_EDIT_REQUEST_END_FLG_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_request_end_flg_N);
      AddObjectProperty("TBW06_EDIT_REQ_END_DATETIME_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_req_end_datetime_N);
      AddObjectProperty("TBW06_EDIT_REQUEST_END_USER_ID_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_edit_request_end_user_id_N);
      AddObjectProperty("TBW06_PROC_DIV_N", gxTv_SdtTBW06_CRF_MEMO_Tbw06_proc_div_N);
   }
