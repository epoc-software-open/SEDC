...
public final  class b790_wp01_error_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeText( "共通エラー画面（タブレット）") ;
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("b790_wp01_error") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey)+"\" class=\""+"Form"+"\">") ;
   ...
   public void e13072( )
   {
      ...
      if ( GXutil.strcmp(AV8P_ERRCD, "1") == 0 )
      {
         ...
         new a805_pc02_msg_get(remoteHandle, context).execute( "AX00106", "", "", "", "", "", GXv_char3) ;
         b790_wp01_error_impl.this.GXt_char2 = GXv_char3[0] ;
      ...
      else if ( GXutil.strcmp(AV8P_ERRCD, "2") == 0 )
      {
         GXt_char2 = "" ;
         GXv_char3[0] = GXt_char2 ;
         new a805_pc02_msg_get(remoteHandle, context).execute( "AX00009", "", "", "", "", "", GXv_char3) ;
         b790_wp01_error_impl.this.GXt_char2 = GXv_char3[0] ;
         lblTbl_errmsg_Caption = GXt_char2 ;
         httpContext.ajax_rsp_assign_prop("", false, lblTbl_errmsg_Internalname, "Caption", lblTbl_errmsg_Caption);
      }
   ...
   public void wb_table4_17_072( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_none_Internalname, GXutil.rtrim( AV7D_NONE), GXutil.rtrim( localUtil.format( AV7D_NONE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(20);\"", "", "", "", "", edtavD_none_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_B790_WP01_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\"text-align:"+httpContext.getCssProperty( "Align", "center")+"\">") ;
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTbl_errmsg_Internalname, lblTbl_errmsg_Caption, "", "", lblTbl_errmsg_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(1), "HLP_B790_WP01_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
   ...
   public void wb_table5_26_072( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_end_Internalname, "ログイン（F12）", "", "", lblTxt_btn_end_Jsonclick, "E\\'BTN_END\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_B790_WP01_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?14573719");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b790_wp01_error.js", "?14573719");
