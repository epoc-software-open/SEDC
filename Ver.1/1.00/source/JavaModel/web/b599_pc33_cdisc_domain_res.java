/*
       ...
       Generated on: July 3, 2017 14:51:59.7
...
public final  class b599_pc33_cdisc_domain_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A887TBM42_DEL_FLG = P00252_A887TBM42_DEL_FLG[0] ;
         n887TBM42_DEL_FLG = P00252_n887TBM42_DEL_FLG[0] ;
         A893TBM42_DOM_CD = P00252_A893TBM42_DOM_CD[0] ;
         A886TBM42_STUDY_ID = P00252_A886TBM42_STUDY_ID[0] ;
         A889TBM42_DOM_JNM = P00252_A889TBM42_DOM_JNM[0] ;
         n889TBM42_DOM_JNM = P00252_n889TBM42_DOM_JNM[0] ;
         AV20GXLvl32 = (byte)(1) ;
         GXt_char1 = AV16W_STR ;
         GXv_char2[0] = GXt_char1 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A893TBM42_DOM_CD, GXv_char2) ;
         b599_pc33_cdisc_domain_res.this.GXt_char1 = GXv_char2[0] ;
         GXt_char3 = AV16W_STR ;
         GXv_char4[0] = GXt_char3 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A889TBM42_DOM_JNM, GXv_char4) ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P00252_A887TBM42_DEL_FLG = new String[] {""} ;
      P00252_n887TBM42_DEL_FLG = new boolean[] {false} ;
      P00252_A893TBM42_DOM_CD = new String[] {""} ;
      P00252_A886TBM42_STUDY_ID = new long[1] ;
      P00252_A889TBM42_DOM_JNM = new String[] {""} ;
      P00252_n889TBM42_DOM_JNM = new boolean[] {false} ;
      A889TBM42_DOM_JNM = "" ;
      AV16W_STR = "" ;
      GXt_char1 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc33_cdisc_domain_res__default(),
         new Object[] {
             new Object[] {
            P00252_A887TBM42_DEL_FLG, P00252_n887TBM42_DEL_FLG, P00252_A893TBM42_DOM_CD, P00252_A886TBM42_STUDY_ID, P00252_A889TBM42_DOM_JNM, P00252_n889TBM42_DOM_JNM
            }
         }
      );
   ...
   private String[] P00252_A887TBM42_DEL_FLG ;
   private boolean[] P00252_n887TBM42_DEL_FLG ;
   private String[] P00252_A893TBM42_DOM_CD ;
   private long[] P00252_A886TBM42_STUDY_ID ;
   private String[] P00252_A889TBM42_DOM_JNM ;
   private boolean[] P00252_n889TBM42_DOM_JNM ;
...
{
   protected Object[] conditional_P00252( com.genexus.internet.HttpContext httpContext ,
                                          long AV17P_STUDY_ID ,
                                          String AV9P_DOM_CD ,
                                          long A886TBM42_STUDY_ID ,
                                          String A893TBM42_DOM_CD ,
                                          String A887TBM42_DEL_FLG )
   {
      String sWhereString = "" ;
      String scmdbuf ;
      byte[] GXv_int7 ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00252(httpContext, ((Number) dynConstraints[0]).longValue() , (String)dynConstraints[1] , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (String)dynConstraints[4] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00252", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
