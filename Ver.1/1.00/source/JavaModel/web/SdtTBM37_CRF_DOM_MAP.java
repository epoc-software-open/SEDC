...
public final  class SdtTBM37_CRF_DOM_MAP extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( long AV271TBM37_STUDY_ID ,
                     short AV272TBM37_CRF_ID ,
                     String AV372TBM37_CRF_ITEM_GRP_DIV ,
                     String AV273TBM37_CRF_ITEM_GRP_CD )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {new Long(AV271TBM37_STUDY_ID),new Short(AV272TBM37_CRF_ID),AV372TBM37_CRF_ITEM_GRP_DIV,AV273TBM37_CRF_ITEM_GRP_CD});
   }
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            {
               gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no = (short)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            {
               gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no_Z = (short)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         String sNameSpace )
   {
      ...
      oWriter.writeElement("TBM37_VISIT_NO", GXutil.trim( GXutil.str( gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no, 3, 0)));
      if ( GXutil.strcmp(sNameSpace, "SmartEDC_SHIZUOKA") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SmartEDC_SHIZUOKA");
      }
      ...
      oWriter.writeElement("TBM37_VISIT_NO_Z", GXutil.trim( GXutil.str( gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no_Z, 3, 0)));
      if ( GXutil.strcmp(sNameSpace, "SmartEDC_SHIZUOKA") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SmartEDC_SHIZUOKA");
      }
   ...
   public void tojson( )
   {
      AddObjectProperty("TBM37_STUDY_ID", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_study_id);
      AddObjectProperty("TBM37_CRF_ID", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crf_id);
      AddObjectProperty("TBM37_CRF_ITEM_GRP_DIV", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crf_item_grp_div);
      AddObjectProperty("TBM37_CRF_ITEM_GRP_CD", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crf_item_grp_cd);
      AddObjectProperty("TBM37_VISIT_NO", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no);
      AddObjectProperty("TBM37_DOM_CD", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_cd);
      AddObjectProperty("TBM37_DOM_VAR_NM", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_var_nm);
      AddObjectProperty("TBM37_DOM_ITM_GRP_OID", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_itm_grp_oid);
      AddObjectProperty("TBM37_DOM_ITM_GRP_ATTR_SEQ", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_itm_grp_attr_seq);
      AddObjectProperty("TBM37_DOM_ITM_GRP_ROWNO", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_itm_grp_rowno);
      AddObjectProperty("TBM37_DEL_FLG", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_del_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBM37_CRT_USER_ID", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_user_id);
      AddObjectProperty("TBM37_CRT_PROG_NM", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_prog_nm);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBM37_UPD_USER_ID", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_user_id);
      AddObjectProperty("TBM37_UPD_PROG_NM", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_prog_nm);
      AddObjectProperty("TBM37_UPD_CNT", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_cnt);
      AddObjectProperty("Mode", gxTv_SdtTBM37_CRF_DOM_MAP_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTBM37_CRF_DOM_MAP_Initialized);
      AddObjectProperty("TBM37_STUDY_ID_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_study_id_Z);
      AddObjectProperty("TBM37_CRF_ID_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crf_id_Z);
      AddObjectProperty("TBM37_CRF_ITEM_GRP_DIV_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crf_item_grp_div_Z);
      AddObjectProperty("TBM37_CRF_ITEM_GRP_CD_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crf_item_grp_cd_Z);
      AddObjectProperty("TBM37_VISIT_NO_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no_Z);
      AddObjectProperty("TBM37_DOM_CD_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_cd_Z);
      AddObjectProperty("TBM37_DOM_VAR_NM_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_var_nm_Z);
      AddObjectProperty("TBM37_DOM_ITM_GRP_OID_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_itm_grp_oid_Z);
      AddObjectProperty("TBM37_DOM_ITM_GRP_ATTR_SEQ_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_itm_grp_attr_seq_Z);
      AddObjectProperty("TBM37_DOM_ITM_GRP_ROWNO_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_itm_grp_rowno_Z);
      AddObjectProperty("TBM37_DEL_FLG_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_del_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM37_CRT_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM37_CRT_USER_ID_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_user_id_Z);
      AddObjectProperty("TBM37_CRT_PROG_NM_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_prog_nm_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM37_UPD_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM37_UPD_USER_ID_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_user_id_Z);
      AddObjectProperty("TBM37_UPD_PROG_NM_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_prog_nm_Z);
      AddObjectProperty("TBM37_UPD_CNT_Z", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_cnt_Z);
      AddObjectProperty("TBM37_VISIT_NO_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no_N);
      AddObjectProperty("TBM37_DOM_CD_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_cd_N);
      AddObjectProperty("TBM37_DOM_VAR_NM_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_var_nm_N);
      AddObjectProperty("TBM37_DOM_ITM_GRP_OID_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_itm_grp_oid_N);
      AddObjectProperty("TBM37_DOM_ITM_GRP_ATTR_SEQ_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_itm_grp_attr_seq_N);
      AddObjectProperty("TBM37_DOM_ITM_GRP_ROWNO_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_dom_itm_grp_rowno_N);
      AddObjectProperty("TBM37_DEL_FLG_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_del_flg_N);
      AddObjectProperty("TBM37_CRT_DATETIME_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_datetime_N);
      AddObjectProperty("TBM37_CRT_USER_ID_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_user_id_N);
      AddObjectProperty("TBM37_CRT_PROG_NM_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_crt_prog_nm_N);
      AddObjectProperty("TBM37_UPD_DATETIME_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_datetime_N);
      AddObjectProperty("TBM37_UPD_USER_ID_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_user_id_N);
      AddObjectProperty("TBM37_UPD_PROG_NM_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_prog_nm_N);
      AddObjectProperty("TBM37_UPD_CNT_N", gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_upd_cnt_N);
   }
   ...
   public short getgxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no( )
   {
      return gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no ;
   }

   public void setgxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no( short value )
   {
   ...
   public void setgxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no_SetNull( )
   {
      ...
      gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no = (short)(0) ;
   }
   ...
   public short getgxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no_Z( )
   {
      return gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no_Z ;
   }

   public void setgxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no_Z( short value )
   {
   ...
   {
      gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no_Z = (short)(0) ;
   }
   ...
   private short gxTv_SdtTBM37_CRF_DOM_MAP_Tbm37_visit_no ;
