/*
               File: ab512_pc01_down_system_impl
        Description: システム規定値マスタダウンロード
             Author: GeneXus Java Generator version 10_1_8-58720
       Generated on: July 3, 2017 14:52:33.87
...
public final  class ab512_pc01_down_system_impl extends GXWebProcedure
{
   public ab512_pc01_down_system_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      ab512_pc01_down_system_impl.this.GXt_char1 = GXv_char2[0] ;
      ...
      if ( AV11W_ERR_CD == 0 )
      {
         ...
         new b599_pc24_system_res(remoteHandle, context).execute( "", GXv_objcol_svchar3, GXv_int4, GXv_char2) ;
         AV16W_RTN_CSV = GXv_objcol_svchar3[0] ;
         ab512_pc01_down_system_impl.this.AV11W_ERR_CD = GXv_int4[0] ;
         ab512_pc01_down_system_impl.this.AV12W_ERR_MSG = GXv_char2[0] ;
      }
   ...
   public void S1279( )
   {
      ...
      ab512_pc01_down_system_impl.this.AV9P_USER_ID = GXv_char2[0] ;
      ab512_pc01_down_system_impl.this.AV11W_ERR_CD = GXv_int4[0] ;
      ab512_pc01_down_system_impl.this.AV12W_ERR_MSG = GXv_char6[0] ;
   }
   ...
   public void S1395( )
   {
      ...
      if ( AV11W_ERR_CD == 0 )
      {
         Application.commit(context, remoteHandle, "DEFAULT", "ab512_pc01_down_system");
      }
      else
      {
         Application.rollback(context, remoteHandle, "DEFAULT", "ab512_pc01_down_system");
      }
   ...
   public void initialize( )
   {
      ...
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new ab512_pc01_down_system__default(),
         new Object[] {
         }
      );
      pr_default.setErrorHandler(this);
      AV24Pgmdesc = "システム規定値マスタダウンロード" ;
      AV23Pgmname = "AB512_PC01_DOWN_SYSTEM" ;
      /* GeneXus formulas. */
      AV24Pgmdesc = "システム規定値マスタダウンロード" ;
      AV23Pgmname = "AB512_PC01_DOWN_SYSTEM" ;
      Gx_err = (short)(0) ;
...
final  class ab512_pc01_down_system__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
