...
public final  class SdtTBM34_CRF_AUTH extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( long AV459TBM34_STUDY_ID ,
                     short AV460TBM34_CRF_ID ,
                     String AV461TBM34_STYDY_AUTH_CD )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {new Long(AV459TBM34_STUDY_ID),new Short(AV460TBM34_CRF_ID),AV461TBM34_STYDY_AUTH_CD});
   }
   ...
   public void tojson( )
   {
      AddObjectProperty("TBM34_STUDY_ID", gxTv_SdtTBM34_CRF_AUTH_Tbm34_study_id);
      AddObjectProperty("TBM34_CRF_ID", gxTv_SdtTBM34_CRF_AUTH_Tbm34_crf_id);
      AddObjectProperty("TBM34_STYDY_AUTH_CD", gxTv_SdtTBM34_CRF_AUTH_Tbm34_stydy_auth_cd);
      AddObjectProperty("TBM34_DISPLAY_FLG", gxTv_SdtTBM34_CRF_AUTH_Tbm34_display_flg);
      AddObjectProperty("TBM34_DEL_FLG", gxTv_SdtTBM34_CRF_AUTH_Tbm34_del_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBM34_CRT_USER_ID", gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_user_id);
      AddObjectProperty("TBM34_CRT_PROG_NM", gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_prog_nm);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBM34_UPD_USER_ID", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_user_id);
      AddObjectProperty("TBM34_UPD_PROG_NM", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_prog_nm);
      AddObjectProperty("TBM34_UPD_CNT", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_cnt);
      AddObjectProperty("Mode", gxTv_SdtTBM34_CRF_AUTH_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTBM34_CRF_AUTH_Initialized);
      AddObjectProperty("TBM34_STUDY_ID_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_study_id_Z);
      AddObjectProperty("TBM34_CRF_ID_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_crf_id_Z);
      AddObjectProperty("TBM34_STYDY_AUTH_CD_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_stydy_auth_cd_Z);
      AddObjectProperty("TBM34_DISPLAY_FLG_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_display_flg_Z);
      AddObjectProperty("TBM34_DEL_FLG_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_del_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM34_CRT_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM34_CRT_USER_ID_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_user_id_Z);
      AddObjectProperty("TBM34_CRT_PROG_NM_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_prog_nm_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM34_UPD_DATETIME_Z", sDateCnv);
      AddObjectProperty("TBM34_UPD_USER_ID_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_user_id_Z);
      AddObjectProperty("TBM34_UPD_PROG_NM_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_prog_nm_Z);
      AddObjectProperty("TBM34_UPD_CNT_Z", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_cnt_Z);
      AddObjectProperty("TBM34_DISPLAY_FLG_N", gxTv_SdtTBM34_CRF_AUTH_Tbm34_display_flg_N);
      AddObjectProperty("TBM34_DEL_FLG_N", gxTv_SdtTBM34_CRF_AUTH_Tbm34_del_flg_N);
      AddObjectProperty("TBM34_CRT_DATETIME_N", gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_datetime_N);
      AddObjectProperty("TBM34_CRT_USER_ID_N", gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_user_id_N);
      AddObjectProperty("TBM34_CRT_PROG_NM_N", gxTv_SdtTBM34_CRF_AUTH_Tbm34_crt_prog_nm_N);
      AddObjectProperty("TBM34_UPD_DATETIME_N", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_datetime_N);
      AddObjectProperty("TBM34_UPD_USER_ID_N", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_user_id_N);
      AddObjectProperty("TBM34_UPD_PROG_NM_N", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_prog_nm_N);
      AddObjectProperty("TBM34_UPD_CNT_N", gxTv_SdtTBM34_CRF_AUTH_Tbm34_upd_cnt_N);
   }
