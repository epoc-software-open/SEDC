/*
       ...
       Generated on: July 3, 2017 14:58:12.83
...
public final  class a203_wp01_kngn_mst_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeText( "権限パターンマスタメンテナンス（入力）") ;
      ...
      GXEncryptionTmp = GXutil.URLEncode(GXutil.rtrim(AV16P_TAM04_KNGN_PTN_KBN)) ;
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("a203_wp01_kngn_mst") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey)+"\" class=\""+"Form"+"\">") ;
   ...
   public void start0P2( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         OldWebcomp2 = httpContext.cgiGet( "W0088") ;
         if ( (GXutil.strcmp("", WebComp_Webcomp2_Component)==0) && ! (GXutil.strcmp("", OldWebcomp2)==0) )
         {
            WebComp_Webcomp2 = WebUtils.getWebComponent(getClass(), "" + OldWebcomp2 + "_impl", remoteHandle, context);
            WebComp_Webcomp2_Component = OldWebcomp2 ;
            WebComp_Webcomp2.componentrestorestate("W0088", "");
         }
      }
      wbErr = false ;
      strup0P0( ) ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               else if ( GXutil.strcmp(sEvtType, "W") == 0 )
               {
                  ...
                  else if ( nCmpId == 88 )
                  {
                     ...
                     {
                        WebComp_Webcomp2.componentprocess("W0088", "", sEvt);
                     }
                     WebComp_Webcomp2_Component = OldWebcomp2 ;
                  }
               }
   ...
   public void pa0P2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         if ( ( cmbavCtltam04_auth_lvl.getItemCount() > 0 ) && (0==AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_lvl()) )
         {
            AV6BC_TAM04_KNGN.setgxTv_SdtTAM04_KNGN_Tam04_auth_lvl( (byte)(GXutil.val( cmbavCtltam04_auth_lvl.getItemValue((short)(1)), ".")) );
         }
   ...
   public void e150P2( )
   {
      ...
      if ( GXutil.len( WebComp_Webcomp2_Component) != 0 )
      {
         WebComp_Webcomp2.componentprepare(new Object[] {"W0088",""});
   ...
   public void e170P2( )
   {
      ...
      if ( ! (GXutil.strcmp("", AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_cd())==0) && (GXutil.strcmp("", AV16P_TAM04_KNGN_PTN_KBN)==0) )
      {
         ...
         {
            A17TAM04_AUTH_CD = H000P2_A17TAM04_AUTH_CD[0] ;
            ...
            a203_wp01_kngn_mst_impl.this.GXt_char2 = GXv_char3[0] ;
            AV27W_MSG = GXt_char2 ;
            httpContext.GX_msglist.addItem(AV27W_MSG);
            edtavCtltam04_kngn_ptn_kbn_Backcolor = UIFactory.getColor( 255, 192, 203) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavCtltam04_kngn_ptn_kbn_Internalname, "Backcolor", GXutil.ltrim( GXutil.str( edtavCtltam04_kngn_ptn_kbn_Backcolor, 9, 0)));
            GXt_char2 = AV23W_A819_JS ;
            GXv_char3[0] = GXt_char2 ;
            new a819_pc01_set_focus(remoteHandle, context).execute( edtavCtltam04_kngn_ptn_kbn_Internalname, "0", GXv_char3) ;
            a203_wp01_kngn_mst_impl.this.GXt_char2 = GXv_char3[0] ;
            AV23W_A819_JS = GXt_char2 ;
   ...
   public void e180P2( )
   {
      ...
      if ( AV6BC_TAM04_KNGN.Success() )
      {
         ...
         GXKey = context.getSiteKey( ) ;
         GXEncryptionTmp = GXutil.URLEncode(GXutil.rtrim(AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_cd())) ;
   ...
   public void e200P2( )
   {
      ...
      if ( AV5BC_KNGN_PTN_EXIST.Fail() )
      {
         GXt_char2 = AV27W_MSG ;
         GXv_char3[0] = GXt_char2 ;
         new a805_pc01_msg_get(remoteHandle, context).execute( "AX00101", "", "", "", "", "", GXv_char3) ;
         a203_wp01_kngn_mst_impl.this.GXt_char2 = GXv_char3[0] ;
         AV27W_MSG = GXt_char2 ;
         AV26W_ERRFLG = true ;
         httpContext.GX_msglist.addItem(AV27W_MSG);
   ...
   public void S152( )
   {
      ...
      {
         A54TAS01_DATA_KIND = H000P3_A54TAS01_DATA_KIND[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A54TAS01_DATA_KIND", A54TAS01_DATA_KIND);
         A113TAS01_DEL_FLG = H000P3_A113TAS01_DEL_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A113TAS01_DEL_FLG", A113TAS01_DEL_FLG);
         n113TAS01_DEL_FLG = H000P3_n113TAS01_DEL_FLG[0] ;
         A19TAS01_ITEM_NM = H000P3_A19TAS01_ITEM_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A19TAS01_ITEM_NM", A19TAS01_ITEM_NM);
         n19TAS01_ITEM_NM = H000P3_n19TAS01_ITEM_NM[0] ;
         A55TAS01_ITEM_CD = H000P3_A55TAS01_ITEM_CD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A55TAS01_ITEM_CD", A55TAS01_ITEM_CD);
         A149TAS01_SORT_NO = H000P3_A149TAS01_SORT_NO[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A149TAS01_SORT_NO", GXutil.ltrim( GXutil.str( A149TAS01_SORT_NO, 3, 0)));
         n149TAS01_SORT_NO = H000P3_n149TAS01_SORT_NO[0] ;
         AV28W_AUTH_LVL = (byte)(GXutil.lval( A55TAS01_ITEM_CD)) ;
         cmbavCtltam04_auth_lvl.addItem(GXutil.ltrim( GXutil.str( AV28W_AUTH_LVL, 2, 0)), A19TAS01_ITEM_NM, (short)(0));
   ...
   public void S172( )
   {
      ...
      else
      {
         ...
         {
            A17TAM04_AUTH_CD = H000P4_A17TAM04_AUTH_CD[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A17TAM04_AUTH_CD", A17TAM04_AUTH_CD);
            A41TAM04_UPD_DATETIME = H000P4_A41TAM04_UPD_DATETIME[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A41TAM04_UPD_DATETIME", localUtil.ttoc( A41TAM04_UPD_DATETIME, 10, 8, 0, 1, "/", ":", " "));
            n41TAM04_UPD_DATETIME = H000P4_n41TAM04_UPD_DATETIME[0] ;
            AV43GXLvl353 = (byte)(1) ;
            ...
            {
               if ( !( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_upd_datetime().equals( A41TAM04_UPD_DATETIME ) ) )
               {
                  GXt_char2 = AV27W_MSG ;
                  GXv_char3[0] = GXt_char2 ;
      ...
      new a203_pc01_kngn_mst_chk(remoteHandle, context).execute( AV6BC_TAM04_KNGN, GXv_objcol_SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem4, GXv_objcol_SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem5) ;
      ...
      if ( ! (GXutil.strcmp("", AV16P_TAM04_KNGN_PTN_KBN)==0) )
      {
         ...
         else
         {
            ...
            else
            {
               ...
               {
                  A8TAM07_USER_ID = H000P6_A8TAM07_USER_ID[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A8TAM07_USER_ID", A8TAM07_USER_ID);
                  A2TAM07_USER_NM = H000P6_A2TAM07_USER_NM[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A2TAM07_USER_NM", A2TAM07_USER_NM);
                  n2TAM07_USER_NM = H000P6_n2TAM07_USER_NM[0] ;
                  AV47GXLvl493 = (byte)(1) ;
                  GXt_char2 = AV12D_TAM04_UPD_USER_NM ;
                  GXv_char3[0] = GXt_char2 ;
                  new a803_pc01_htmlescape(remoteHandle, context).execute( A2TAM07_USER_NM, GXv_char3) ;
                  a203_wp01_kngn_mst_impl.this.GXt_char2 = GXv_char3[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A2TAM07_USER_NM", A2TAM07_USER_NM);
                  AV12D_TAM04_UPD_USER_NM = GXt_char2 ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV12D_TAM04_UPD_USER_NM", AV12D_TAM04_UPD_USER_NM);
                  /* Exit For each command. Update data (if necessary), close cursors & exit. */
                  if (true) break;
                  /* Exiting from a For First loop. */
   ...
   public void S112( )
   {
      ...
      a203_wp01_kngn_mst_impl.this.AV25W_ERRCD = GXv_char3[0] ;
   ...
   public void S122( )
   {
      ...
      AV6BC_TAM04_KNGN.setgxTv_SdtTAM04_KNGN_Tam04_crt_datetime( GXt_dtime7 );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV6BC_TAM04_KNGN", AV6BC_TAM04_KNGN);
      AV11D_TAM04_CRT_USER_NM = "" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11D_TAM04_CRT_USER_NM", AV11D_TAM04_CRT_USER_NM);
      ...
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV6BC_TAM04_KNGN", AV6BC_TAM04_KNGN);
      GXt_dtime7 = GXutil.resetTime( GXutil.nullDate() );
      AV6BC_TAM04_KNGN.setgxTv_SdtTAM04_KNGN_Tam04_upd_datetime( GXt_dtime7 );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV6BC_TAM04_KNGN", AV6BC_TAM04_KNGN);
      AV12D_TAM04_UPD_USER_NM = "" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12D_TAM04_UPD_USER_NM", AV12D_TAM04_UPD_USER_NM);
   ...
   public void S132( )
   {
      ...
      new a402_pc01_kengen_check(remoteHandle, context).execute( AV10C_TAM02_APP_ID, GXv_char3, GXv_char8) ;
      a203_wp01_kngn_mst_impl.this.AV14H_KNGN_FLG = GXv_char3[0] ;
      a203_wp01_kngn_mst_impl.this.AV25W_ERRCD = GXv_char8[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14H_KNGN_FLG", AV14H_KNGN_FLG);
      if ( GXutil.strcmp(AV25W_ERRCD, "0") != 0 )
      {
         GXKey = context.getSiteKey( ) ;
   ...
   public void wb_table3_12_0P2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table4_19_0P2( true) ;
      }
      else
      {
         wb_table4_19_0P2( false) ;
      }
      return  ;
   }

   public void wb_table4_19_0P2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         wb_table5_31_0P2( true) ;
      }
      else
      {
         wb_table5_31_0P2( false) ;
      }
      return  ;
   }

   public void wb_table5_31_0P2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table6_79_0P2( true) ;
      }
      else
      {
         wb_table6_79_0P2( false) ;
      }
      return  ;
   }

   public void wb_table6_79_0P2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<td>") ;
         /* WebComponent */
         GxWebStd.gx_hidden_field( httpContext, "W0088"+"", GXutil.rtrim( WebComp_Webcomp2_Component));
         httpContext.writeText( "<div") ;
         httpContext.writeText( " id=\""+"gxHTMLWrpW0088"+""+"\""+"") ;
         httpContext.writeText( ">") ;
         if ( GXutil.len( WebComp_Webcomp2_Component) != 0 )
         {
            if ( GXutil.strcmp(OldWebcomp2, WebComp_Webcomp2_Component) != 0 )
   ...
   public void wb_table6_79_0P2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_js_event_Internalname, lblTxt_js_event_Caption, "", "", lblTxt_js_event_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(1), "HLP_A203_WP01_KNGN_MST.htm");
         ...
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV13H_INIT_FLG), GXutil.rtrim( localUtil.format( AV13H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(83);\"", "", "", "", "", edtavH_init_flg_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV15H_MODE", AV15H_MODE);
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_mode_Internalname, GXutil.rtrim( AV15H_MODE), GXutil.rtrim( localUtil.format( AV15H_MODE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(84);\"", "", "", "", "", edtavH_mode_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV14H_KNGN_FLG", AV14H_KNGN_FLG);
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV14H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV14H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(85);\"", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table6_79_0P2e( true) ;
      }
      else
      {
         wb_table6_79_0P2e( false) ;
      }
   }

   public void wb_table5_31_0P2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table7_37_0P2( true) ;
      }
      else
      {
         wb_table7_37_0P2( false) ;
      }
      return  ;
   }

   public void wb_table7_37_0P2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_31_0P2e( true) ;
      }
      else
      {
         wb_table5_31_0P2e( false) ;
      }
   }

   public void wb_table7_37_0P2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         ClassString = "Image" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgImage1_Internalname, context.getHttpContext().getImagePath( "d5d6aaa9-3daa-4e25-b702-e0d1b5ef483e", "", "Style2"), "", "", "", "Style2", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "&nbsp;権限パターンコード") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:250px\">") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_cd()", AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_cd());
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 44,'',false,'',0)\"" ;
         ClassString = "AttributeImeOff" ;
         StyleString = "background:" + WebUtils.getHTMLColor( edtavCtltam04_kngn_ptn_kbn_Backcolor) + ";" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltam04_kngn_ptn_kbn_Internalname, GXutil.rtrim( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_cd()), GXutil.rtrim( localUtil.format( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_cd(), "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(44);\"", "", "", "", "", edtavCtltam04_kngn_ptn_kbn_Jsonclick, 0, ClassString, StyleString, "", 1, edtavCtltam04_kngn_ptn_kbn_Enabled, 1, 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\"  style=\"width:140px\">") ;
         /* Static images/pictures */
         ClassString = "Image" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgImage5_Internalname, context.getHttpContext().getImagePath( "d5d6aaa9-3daa-4e25-b702-e0d1b5ef483e", "", "Style2"), "", "", "", "Style2", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "権限パターン名") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_nm()", AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_nm());
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 48,'',false,'',0)\"" ;
         ClassString = "AttributeImeOn" ;
         StyleString = "background:" + WebUtils.getHTMLColor( edtavCtltam04_kngn_ptn_nm_Backcolor) + ";" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltam04_kngn_ptn_nm_Internalname, GXutil.rtrim( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_nm()), GXutil.rtrim( localUtil.format( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_nm(), "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(48);\"", "", "", "", "", edtavCtltam04_kngn_ptn_nm_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_lvl()", GXutil.ltrim( GXutil.str( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_lvl(), 2, 0)));
         ClassString = "AttributeImeOff" ;
         StyleString = "" ;
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 52,'',false,'',0)\"" ;
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( httpContext, cmbavCtltam04_auth_lvl, cmbavCtltam04_auth_lvl.getInternalname(), GXutil.str( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_lvl(), 2, 0), 1, cmbavCtltam04_auth_lvl.getJsonclick(), 0, "", "int", "", 1, 1, 0, (short)(0), 2, "chr", 0, "", StyleString, ClassString, TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(52);\"", "", true, "HLP_A203_WP01_KNGN_MST.htm");
         cmbavCtltam04_auth_lvl.setValue( GXutil.str( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_auth_lvl(), 2, 0) );
         ...
         httpContext.writeText( "<td>") ;
         /* Radio button */
         httpContext.ajax_rsp_assign_attri("", false, "AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_del_flg()", AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_del_flg());
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 55,'',false,'',0)\"" ;
         GxWebStd.gx_radio_ctrl( httpContext, radavCtltam04_del_flg, radavCtltam04_del_flg.getInternalname(), AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_del_flg(), "", 1, 1, 0, 0, StyleString, ClassString, 0, radavCtltam04_del_flg.getJsonclick(), "", TempTags+" onclick=\"gx.evt.onchange(this);\" "+" onblur=\""+""+";gx.evt.onblur(55);\"", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"FormTitle\" colspan=\"4\" >") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_crt_datetime()", localUtil.ttoc( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_crt_datetime(), 10, 8, 0, 1, "/", ":", " "));
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltam04_crt_datetime_Internalname, localUtil.format(AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_crt_datetime(), "9999/99/99 99:99:99"), localUtil.format( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_crt_datetime(), "9999/99/99 99:99:99"), "", "", "", "", "", edtavCtltam04_crt_datetime_Jsonclick, 0, ClassString, StyleString, "", edtavCtltam04_crt_datetime_Visible, edtavCtltam04_crt_datetime_Enabled, 0, 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(1), true, "right", "HLP_A203_WP01_KNGN_MST.htm");
         GxWebStd.gx_bitmap( httpContext, edtavCtltam04_crt_datetime_Internalname+"_dp_trigger", "calendar-img.gif", "", "", "", "", ((edtavCtltam04_crt_datetime_Visible==0)||(edtavCtltam04_crt_datetime_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_A203_WP01_KNGN_MST.htm");
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_upd_datetime()", localUtil.ttoc( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_upd_datetime(), 10, 8, 0, 1, "/", ":", " "));
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltam04_upd_datetime_Internalname, localUtil.format(AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_upd_datetime(), "9999/99/99 99:99:99"), localUtil.format( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_upd_datetime(), "9999/99/99 99:99:99"), "", "", "", "", "", edtavCtltam04_upd_datetime_Jsonclick, 0, ClassString, StyleString, "", edtavCtltam04_upd_datetime_Visible, edtavCtltam04_upd_datetime_Enabled, 0, 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(1), true, "right", "HLP_A203_WP01_KNGN_MST.htm");
         GxWebStd.gx_bitmap( httpContext, edtavCtltam04_upd_datetime_Internalname+"_dp_trigger", "calendar-img.gif", "", "", "", "", ((edtavCtltam04_upd_datetime_Visible==0)||(edtavCtltam04_upd_datetime_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeTextNL( "</div>") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam04_crt_user_nm_Internalname, GXutil.rtrim( AV11D_TAM04_CRT_USER_NM), GXutil.rtrim( localUtil.format( AV11D_TAM04_CRT_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(68);\"", "", "", "", "", edtavD_tam04_crt_user_nm_Jsonclick, 0, ClassString, StyleString, "", 1, edtavD_tam04_crt_user_nm_Enabled, 0, 30, "chr", 1, "row", 30, (byte)(0), (short)(1), 0, (byte)(1), (byte)(1), true, "left", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         ...
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam04_upd_user_nm_Internalname, GXutil.rtrim( AV12D_TAM04_UPD_USER_NM), GXutil.rtrim( localUtil.format( AV12D_TAM04_UPD_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(71);\"", "", "", "", "", edtavD_tam04_upd_user_nm_Jsonclick, 0, ClassString, StyleString, "", 1, edtavD_tam04_upd_user_nm_Enabled, 0, 30, "chr", 1, "row", 30, (byte)(0), (short)(1), 0, (byte)(1), (byte)(1), true, "left", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm()", AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm());
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltam04_crt_pg_nm_Internalname, GXutil.rtrim( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm()), GXutil.rtrim( localUtil.format( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm(), "")), "", "", "", "", "", edtavCtltam04_crt_pg_nm_Jsonclick, 0, ClassString, StyleString, "", 1, edtavCtltam04_crt_pg_nm_Enabled, 0, 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(1), true, "left", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm()", AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm());
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltam04_upd_pg_nm_Internalname, GXutil.rtrim( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm()), GXutil.rtrim( localUtil.format( AV6BC_TAM04_KNGN.getgxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm(), "")), "", "", "", "", "", edtavCtltam04_upd_pg_nm_Jsonclick, 0, ClassString, StyleString, "", 1, edtavCtltam04_upd_pg_nm_Enabled, 0, 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(1), true, "left", "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table7_37_0P2e( true) ;
      }
      else
      {
         wb_table7_37_0P2e( false) ;
      }
   }

   public void wb_table4_19_0P2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock44_Internalname, "更新（F4）", "", "", lblTextblock44_Jsonclick, "E\\'BTN_UPD\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock45_Internalname, "削除（F6）", "", "", lblTextblock45_Jsonclick, "E\\'BTN_DLT\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock46_Internalname, "戻る（F11）", "", "", lblTextblock46_Jsonclick, "E\\'BTN_CAN\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_19_0P2e( true) ;
      }
      else
      {
         wb_table4_19_0P2e( false) ;
      }
   }
   ...
   public void wb_table3_12_0P2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock42_Internalname, "登録（F3）", "", "", lblTextblock42_Jsonclick, "E\\'BTN_REG\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         ...
         ClassString = "TextBlockBtn100" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock43_Internalname, "戻る（F11）", "", "", lblTextblock43_Jsonclick, "E\\'BTN_CAN\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_A203_WP01_KNGN_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?14581571");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a203_wp01_kngn_mst.js", "?14581571");
   ...
   public void handleError( )
   {
      if ( context.globals.getErr( ) != 0 )
      {
         ...
         {
               case 1 :
                  /* Execute user subroutine: S22677 */
                  S22677 ();
                  break;
         }
      }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H000P2_A17TAM04_AUTH_CD = new String[] {""} ;
      A17TAM04_AUTH_CD = "" ;
      AV27W_MSG = "" ;
      AV23W_A819_JS = "" ;
      AV24W_A821_JS = "" ;
      ...
      H000P3_A54TAS01_DATA_KIND = new String[] {""} ;
      H000P3_A113TAS01_DEL_FLG = new String[] {""} ;
      H000P3_n113TAS01_DEL_FLG = new boolean[] {false} ;
      H000P3_A19TAS01_ITEM_NM = new String[] {""} ;
      H000P3_n19TAS01_ITEM_NM = new boolean[] {false} ;
      H000P3_A55TAS01_ITEM_CD = new String[] {""} ;
      H000P3_A149TAS01_SORT_NO = new short[1] ;
      H000P3_n149TAS01_SORT_NO = new boolean[] {false} ;
      A54TAS01_DATA_KIND = "" ;
      A113TAS01_DEL_FLG = "" ;
      A19TAS01_ITEM_NM = "" ;
      A55TAS01_ITEM_CD = "" ;
      H000P4_A17TAM04_AUTH_CD = new String[] {""} ;
      H000P4_A41TAM04_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      H000P4_n41TAM04_UPD_DATETIME = new boolean[] {false} ;
      ...
      H000P5_A8TAM07_USER_ID = new String[] {""} ;
      H000P5_A2TAM07_USER_NM = new String[] {""} ;
      H000P5_n2TAM07_USER_NM = new boolean[] {false} ;
      A8TAM07_USER_ID = "" ;
      A2TAM07_USER_NM = "" ;
      H000P6_A8TAM07_USER_ID = new String[] {""} ;
      H000P6_A2TAM07_USER_NM = new String[] {""} ;
      H000P6_n2TAM07_USER_NM = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new a203_wp01_kngn_mst__default(),
         new Object[] {
             new Object[] {
            H000P2_A17TAM04_AUTH_CD
            }
            , new Object[] {
            H000P3_A54TAS01_DATA_KIND, H000P3_A113TAS01_DEL_FLG, H000P3_n113TAS01_DEL_FLG, H000P3_A19TAS01_ITEM_NM, H000P3_n19TAS01_ITEM_NM, H000P3_A55TAS01_ITEM_CD, H000P3_A149TAS01_SORT_NO, H000P3_n149TAS01_SORT_NO
            }
            , new Object[] {
            H000P4_A17TAM04_AUTH_CD, H000P4_A41TAM04_UPD_DATETIME, H000P4_n41TAM04_UPD_DATETIME
            }
            , new Object[] {
            H000P5_A8TAM07_USER_ID, H000P5_A2TAM07_USER_NM, H000P5_n2TAM07_USER_NM
            }
            , new Object[] {
            H000P6_A8TAM07_USER_ID, H000P6_A2TAM07_USER_NM, H000P6_n2TAM07_USER_NM
            }
         }
      );
   ...
   private String[] H000P2_A17TAM04_AUTH_CD ;
   private String[] H000P3_A54TAS01_DATA_KIND ;
   private String[] H000P3_A113TAS01_DEL_FLG ;
   private boolean[] H000P3_n113TAS01_DEL_FLG ;
   private String[] H000P3_A19TAS01_ITEM_NM ;
   private boolean[] H000P3_n19TAS01_ITEM_NM ;
   private String[] H000P3_A55TAS01_ITEM_CD ;
   private short[] H000P3_A149TAS01_SORT_NO ;
   private boolean[] H000P3_n149TAS01_SORT_NO ;
   private String[] H000P4_A17TAM04_AUTH_CD ;
   private java.util.Date[] H000P4_A41TAM04_UPD_DATETIME ;
   private boolean[] H000P4_n41TAM04_UPD_DATETIME ;
   private String[] H000P5_A8TAM07_USER_ID ;
   private String[] H000P5_A2TAM07_USER_NM ;
   private boolean[] H000P5_n2TAM07_USER_NM ;
   private String[] H000P6_A8TAM07_USER_ID ;
   private String[] H000P6_A2TAM07_USER_NM ;
   private boolean[] H000P6_n2TAM07_USER_NM ;
...
final  class a203_wp01_kngn_mst__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000P2", "SELECT `TAM04_AUTH_CD` FROM `TAM04_KNGN` WHERE `TAM04_AUTH_CD` = ? ORDER BY `TAM04_AUTH_CD` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H000P3", "SELECT `TAS01_DATA_KIND`, `TAS01_DEL_FLG`, `TAS01_ITEM_NM`, `TAS01_ITEM_CD`, `TAS01_SORT_NO` FROM `TAS01_CDNM` WHERE (`TAS01_DATA_KIND` = 'B01') AND (`TAS01_DEL_FLG` = '0') ORDER BY `TAS01_DATA_KIND`, `TAS01_SORT_NO`, `TAS01_ITEM_CD` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
         ,new ForEachCursor("H000P4", "SELECT `TAM04_AUTH_CD`, `TAM04_UPD_DATETIME` FROM `TAM04_KNGN` WHERE `TAM04_AUTH_CD` = ? ORDER BY `TAM04_AUTH_CD` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H000P5", "SELECT `TAM07_USER_ID`, `TAM07_USER_NM` FROM `TAM07_USER` WHERE `TAM07_USER_ID` = ? ORDER BY `TAM07_USER_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H000P6", "SELECT `TAM07_USER_ID`, `TAM07_USER_NM` FROM `TAM07_USER` WHERE `TAM07_USER_ID` = ? ORDER BY `TAM07_USER_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
