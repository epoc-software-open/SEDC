/*
       ...
       Generated on: July 3, 2017 14:53:4.76
...
public final  class b704_pc03_remove_crf_val extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A238TBM32_DEL_FLG = P005K2_A238TBM32_DEL_FLG[0] ;
         n238TBM32_DEL_FLG = P005K2_n238TBM32_DEL_FLG[0] ;
         A232TBM32_CRF_ID = P005K2_A232TBM32_CRF_ID[0] ;
         A231TBM32_STUDY_ID = P005K2_A231TBM32_STUDY_ID[0] ;
         A233TBM32_CRF_ITEM_CD = P005K2_A233TBM32_CRF_ITEM_CD[0] ;
         ...
         AV12W_SESSION_KEY = AV12W_SESSION_KEY + A233TBM32_CRF_ITEM_CD ;
   ...
   {
      scmdbuf = "" ;
      P005K2_A238TBM32_DEL_FLG = new String[] {""} ;
      P005K2_n238TBM32_DEL_FLG = new boolean[] {false} ;
      P005K2_A232TBM32_CRF_ID = new short[1] ;
      P005K2_A231TBM32_STUDY_ID = new long[1] ;
      P005K2_A233TBM32_CRF_ITEM_CD = new String[] {""} ;
      A238TBM32_DEL_FLG = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b704_pc03_remove_crf_val__default(),
         new Object[] {
             new Object[] {
            P005K2_A238TBM32_DEL_FLG, P005K2_n238TBM32_DEL_FLG, P005K2_A232TBM32_CRF_ID, P005K2_A231TBM32_STUDY_ID, P005K2_A233TBM32_CRF_ITEM_CD
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] P005K2_A238TBM32_DEL_FLG ;
   private boolean[] P005K2_n238TBM32_DEL_FLG ;
   private short[] P005K2_A232TBM32_CRF_ID ;
   private long[] P005K2_A231TBM32_STUDY_ID ;
   private String[] P005K2_A233TBM32_CRF_ITEM_CD ;
...
final  class b704_pc03_remove_crf_val__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P005K2", "SELECT `TBM32_DEL_FLG`, `TBM32_CRF_ID`, `TBM32_STUDY_ID`, `TBM32_CRF_ITEM_CD` FROM `TBM32_CRF_ITEM` WHERE (`TBM32_STUDY_ID` = ? and `TBM32_CRF_ID` = ?) AND (`TBM32_DEL_FLG` = '0') ORDER BY `TBM32_STUDY_ID`, `TBM32_CRF_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
