/*
               File: gx0040_impl
        Description: Selection List メッセージマスタ
             Author: GeneXus Java Generator version 10_1_8-58720
       Generated on: July 3, 2017 14:57:43.55
...
public final  class gx0040_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            gxgrgrid1_refresh( Grid1_PageSize21, AV6cTAM06_MSG_CD) ;
            return  ;
         }
         else
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      GXEncryptionTmp = GXutil.URLEncode(GXutil.rtrim(AV8pTAM06_MSG_CD)) ;
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx0040") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey)+"\" class=\""+"Form"+"\">") ;
   ...
   {
      return "Selection List メッセージマスタ" ;
   }
   ...
   public String getSelfLink( )
   {
      GXKey = context.getSiteKey( ) ;
      GXEncryptionTmp = GXutil.URLEncode(GXutil.rtrim(AV8pTAM06_MSG_CD)) ;
      return formatLink("gx0040") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey) ;
   }
   ...
   public void start0I2( )
   {
      ...
      Form.getMeta().addItem("Description", "Selection List メッセージマスタ", (short)(0)) ;
      httpContext.wjLoc = "" ;
   ...
   public void rf0I2( )
   {
      ...
      if ( (GXutil.strcmp("", httpContext.wjLoc)==0) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "AV6cTAM06_MSG_CD", AV6cTAM06_MSG_CD);
         /* Using cursor H000I2 */
         pr_default.execute(0, new Object[] {lV6cTAM06_MSG_CD});
         nGXsfl_21_idx = (short)(1) ;
         GRID1_nEOF = (byte)(0) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subgrid1_recordsperpage( ) ) ) ) )
         {
            A20TAM06_MSG = H000I2_A20TAM06_MSG[0] ;
            n20TAM06_MSG = H000I2_n20TAM06_MSG[0] ;
            A21TAM06_MSG_CD = H000I2_A21TAM06_MSG_CD[0] ;
            /* Execute user event: e120I2 */
            e120I2 ();
   ...
   {
      /* Load Routine */
      AV7LinkSelection = context.getHttpContext().getImagePath( "3914535b-0c03-44c5-9538-906a99cdd2bc", "", "Style1") ;
   ...
   {
      /* Enter Routine */
      AV8pTAM06_MSG_CD = A21TAM06_MSG_CD ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8pTAM06_MSG_CD", AV8pTAM06_MSG_CD);
   ...
   public void S112( )
   {
      ...
      gx0040_impl.this.AV10W_ERRCD = GXv_char4[0] ;
      if ( GXutil.strcmp(AV10W_ERRCD, "0") != 0 )
      {
         GXKey = context.getSiteKey( ) ;
   ...
   public void S122( )
   {
      ...
      gx0040_impl.this.AV11W_KNGN_FLG = GXv_char4[0] ;
      gx0040_impl.this.AV10W_ERRCD = GXv_char5[0] ;
      if ( GXutil.strcmp(AV10W_ERRCD, "0") != 0 )
      {
         GXKey = context.getSiteKey( ) ;
   ...
   public void S1393( )
   {
      ...
      httpContext.wjLoc = formatLink("a105_wp01_error") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey) ;
      Application.rollback(context, remoteHandle, "DEFAULT", "gx0040");
   }
   ...
   public void wb_table2_9_0I2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table3_18_0I2( true) ;
      }
      else
      {
         wb_table3_18_0I2( false) ;
      }
      return  ;
   }

   public void wb_table3_18_0I2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</fieldset>") ;
   ...
   public void wb_table3_18_0I2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         if ( Grid1Container.GetWrapped() == 1 )
         {
            ...
            httpContext.writeText( "<th align=\""+"left"+"\" "+" width="+GXutil.ltrim( GXutil.str( 110, 4, 0))+"px"+" class=\""+subGrid1_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
            httpContext.writeValue( "メッセージコード") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" width="+GXutil.ltrim( GXutil.str( 500, 4, 0))+"px"+" class=\""+subGrid1_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
         ...
         else
         {
            ...
            Grid1Column = GXWebColumn.GetNew(httpContext.isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.rtrim( A21TAM06_MSG_CD));
            Grid1Column.AddObjectProperty("Link", GXutil.rtrim( edtTAM06_MSG_CD_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(httpContext.isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.rtrim( A20TAM06_MSG));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      if ( wbEnd == 21 )
      {
         ...
         wb_table4_27_0I2( true) ;
      }
      else
      {
         wb_table4_27_0I2( false) ;
      }
      return  ;
   }

   public void wb_table4_27_0I2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_18_0I2e( true) ;
      }
      else
      {
         wb_table3_18_0I2e( false) ;
      }
   }

   public void wb_table4_27_0I2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 21, 3, 0)+","+"null"+");", "終了", bttBtn_cancel_Jsonclick, 1, "終了", "", StyleString, ClassString, 1, 1, "standard", "ECANCEL.", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0040.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_27_0I2e( true) ;
      }
      else
      {
         wb_table4_27_0I2e( false) ;
      }
   }

   public void wb_table2_9_0I2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam090_msg_cd_Internalname, "メッセージコード", "", "", lblTextblocktam090_msg_cd_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_Gx0040.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         httpContext.ajax_rsp_assign_attri("", false, "AV6cTAM06_MSG_CD", AV6cTAM06_MSG_CD);
         ...
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtam06_msg_cd_Internalname, GXutil.rtrim( AV6cTAM06_MSG_CD), GXutil.rtrim( localUtil.format( AV6cTAM06_MSG_CD, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(14);\"", "", "", "", "", edtavCtam06_msg_cd_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 7, "chr", 1, "row", 7, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_Gx0040.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?14574380");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0040.js", "?14574380");
   ...
   public void sendrow_212( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_21_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.rtrim( A21TAM06_MSG_CD))+"'"+"]);" ;
         ClassString = "Image" ;
         StyleString = "" ;
         ...
         edtTAM06_MSG_CD_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.rtrim( A21TAM06_MSG_CD))+"'"+"]);" ;
         Grid1Row.AddColumnProperties("edit", 1, httpContext.isAjaxCallMode( ), new Object[] {edtTAM06_MSG_CD_Internalname,GXutil.rtrim( A21TAM06_MSG_CD),"","","",edtTAM06_MSG_CD_Link,"","",edtTAM06_MSG_CD_Jsonclick,new Integer(0),ClassString,StyleString,ROClassString,new Integer(-1),new Integer(0),new Integer(0),new Integer(110),"px",new Integer(17),"px",new Integer(7),new Integer(0),new Integer(0),new Integer(21),new Integer(1),new Integer(1),new Boolean(true),"left"});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((-1==0) ? "display:none;" : "")+"\">") ;
         ...
         StyleString = "" ;
         ROClassString = ClassString ;
         Grid1Row.AddColumnProperties("edit", 1, httpContext.isAjaxCallMode( ), new Object[] {edtTAM06_MSG_Internalname,GXutil.rtrim( A20TAM06_MSG),"","","","","","",edtTAM06_MSG_Jsonclick,new Integer(0),ClassString,StyleString,ROClassString,new Integer(-1),new Integer(0),new Integer(0),new Integer(500),"px",new Integer(17),"px",new Integer(1000),new Integer(0),new Integer(0),new Integer(21),new Integer(1),new Integer(1),new Boolean(true),"left"});
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List メッセージマスタ" );
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV6cTAM06_MSG_CD = "" ;
      H000I2_A20TAM06_MSG = new String[] {""} ;
      H000I2_n20TAM06_MSG = new boolean[] {false} ;
      H000I2_A21TAM06_MSG_CD = new String[] {""} ;
      H000I3_AGRID1_nRecordCount = new int[1] ;
      AV5C_TAM02_APP_ID = "" ;
      AV10W_ERRCD = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new gx0040__default(),
         new Object[] {
             new Object[] {
            H000I2_A20TAM06_MSG, H000I2_n20TAM06_MSG, H000I2_A21TAM06_MSG_CD
            }
            , new Object[] {
   ...
   private String[] H000I2_A20TAM06_MSG ;
   private boolean[] H000I2_n20TAM06_MSG ;
   private String[] H000I2_A21TAM06_MSG_CD ;
   private int[] H000I3_AGRID1_nRecordCount ;
...
{
   protected Object[] conditional_H000I2( com.genexus.internet.HttpContext httpContext ,
                                          String AV6cTAM06_MSG_CD ,
                                          String A21TAM06_MSG_CD )
   {
      ...
      scmdbuf = "SELECT `TAM06_MSG`, `TAM06_MSG_CD` FROM `TAM06_MSG`" ;
   ...
   protected Object[] conditional_H000I3( com.genexus.internet.HttpContext httpContext ,
                                          String AV6cTAM06_MSG_CD ,
                                          String A21TAM06_MSG_CD )
   {
      String sWhereString = "" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000I2(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H000I3(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
