/*
       ...
       Generated on: July 3, 2017 14:53:4.26
...
public final  class b704_pc02_get_crf_val extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      else
      {
         ...
         {
            A238TBM32_DEL_FLG = P005H2_A238TBM32_DEL_FLG[0] ;
            n238TBM32_DEL_FLG = P005H2_n238TBM32_DEL_FLG[0] ;
            A232TBM32_CRF_ID = P005H2_A232TBM32_CRF_ID[0] ;
            A231TBM32_STUDY_ID = P005H2_A231TBM32_STUDY_ID[0] ;
            A233TBM32_CRF_ITEM_CD = P005H2_A233TBM32_CRF_ITEM_CD[0] ;
            ...
            AV16W_SESSION_KEY_ITEM = AV16W_SESSION_KEY_ITEM + A233TBM32_CRF_ITEM_CD ;
            ...
            else
            {
               ...
               while ( AV21GXV1 <= AV8SD_B792_SD01_CRF.getgxTv_SdtB792_SD01_CRF_Crf_results().size() )
               {
                  ...
                  if ( GXutil.strcmp(AV9SD_B792_SD02_CRF_RESULT_I.getgxTv_SdtB792_SD02_CRF_RESULT_B792_SD02_CRF_RESULTItem_Tbt12_crf_item_grp_cd(), A233TBM32_CRF_ITEM_CD) == 0 )
                  {
               ...
               if ( GXutil.strcmp(AV12W_FLG, "0") == 0 )
               {
                  ...
                  AV9SD_B792_SD02_CRF_RESULT_I.setgxTv_SdtB792_SD02_CRF_RESULT_B792_SD02_CRF_RESULTItem_Tbt12_crf_item_grp_cd( A233TBM32_CRF_ITEM_CD );
         ...
         pr_default.close(0);
         AV14W_SESSION.setValue(AV15W_SESSION_KEY, AV8SD_B792_SD01_CRF.toxml(false, "B792_SD01_CRF", "SmartEDC_SHIZUOKA"));
      }
      cleanup();
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      P005H2_A238TBM32_DEL_FLG = new String[] {""} ;
      P005H2_n238TBM32_DEL_FLG = new boolean[] {false} ;
      P005H2_A232TBM32_CRF_ID = new short[1] ;
      P005H2_A231TBM32_STUDY_ID = new long[1] ;
      P005H2_A233TBM32_CRF_ITEM_CD = new String[] {""} ;
      A238TBM32_DEL_FLG = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b704_pc02_get_crf_val__default(),
         new Object[] {
             new Object[] {
            P005H2_A238TBM32_DEL_FLG, P005H2_n238TBM32_DEL_FLG, P005H2_A232TBM32_CRF_ID, P005H2_A231TBM32_STUDY_ID, P005H2_A233TBM32_CRF_ITEM_CD
            }
         }
      );
   ...
   private String[] P005H2_A238TBM32_DEL_FLG ;
   private boolean[] P005H2_n238TBM32_DEL_FLG ;
   private short[] P005H2_A232TBM32_CRF_ID ;
   private long[] P005H2_A231TBM32_STUDY_ID ;
   private String[] P005H2_A233TBM32_CRF_ITEM_CD ;
...
final  class b704_pc02_get_crf_val__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P005H2", "SELECT `TBM32_DEL_FLG`, `TBM32_CRF_ID`, `TBM32_STUDY_ID`, `TBM32_CRF_ITEM_CD` FROM `TBM32_CRF_ITEM` WHERE (`TBM32_STUDY_ID` = ? and `TBM32_CRF_ID` = ?) AND (`TBM32_DEL_FLG` = '0') ORDER BY `TBM32_STUDY_ID`, `TBM32_CRF_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
