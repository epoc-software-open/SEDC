...
public final  class SdtB707_SD02_REG_MEMO_RTN extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
   ...
   public void tojson( )
   {
      AddObjectProperty("RESULT_CD", gxTv_SdtB707_SD02_REG_MEMO_RTN_Result_cd);
      AddObjectProperty("ERR_MSG", gxTv_SdtB707_SD02_REG_MEMO_RTN_Err_msg);
      AddObjectProperty("MEMO_NO", gxTv_SdtB707_SD02_REG_MEMO_RTN_Memo_no);
   }
   ...
   public void setgxTv_SdtB707_SD02_REG_MEMO_RTN_Result_cd_SetNull( )
   {
      gxTv_SdtB707_SD02_REG_MEMO_RTN_Result_cd = "" ;
   }

   public boolean getgxTv_SdtB707_SD02_REG_MEMO_RTN_Result_cd_IsNull( )
   {
      return false ;
   }
   ...
   public void setgxTv_SdtB707_SD02_REG_MEMO_RTN_Err_msg_SetNull( )
   {
      gxTv_SdtB707_SD02_REG_MEMO_RTN_Err_msg = "" ;
   }

   public boolean getgxTv_SdtB707_SD02_REG_MEMO_RTN_Err_msg_IsNull( )
   {
      return false ;
   }
   ...
   public void setgxTv_SdtB707_SD02_REG_MEMO_RTN_Memo_no_SetNull( )
   {
      gxTv_SdtB707_SD02_REG_MEMO_RTN_Memo_no = (short)(0) ;
   }

   public boolean getgxTv_SdtB707_SD02_REG_MEMO_RTN_Memo_no_IsNull( )
   {
      return false ;
   }
