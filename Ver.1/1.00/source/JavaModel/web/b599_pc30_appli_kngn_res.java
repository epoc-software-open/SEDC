/*
       ...
       Generated on: July 3, 2017 14:52:44.89
...
public final  class b599_pc30_appli_kngn_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A102TAM05_DEL_FLG = P004Y2_A102TAM05_DEL_FLG[0] ;
         n102TAM05_DEL_FLG = P004Y2_n102TAM05_DEL_FLG[0] ;
         A88TAM03_APP_ID = P004Y2_A88TAM03_APP_ID[0] ;
         A17TAM04_AUTH_CD = P004Y2_A17TAM04_AUTH_CD[0] ;
         A109TAM05_UPD_CNT = P004Y2_A109TAM05_UPD_CNT[0] ;
         n109TAM05_UPD_CNT = P004Y2_n109TAM05_UPD_CNT[0] ;
         A108TAM05_UPD_PROG_NM = P004Y2_A108TAM05_UPD_PROG_NM[0] ;
         n108TAM05_UPD_PROG_NM = P004Y2_n108TAM05_UPD_PROG_NM[0] ;
         A107TAM05_UPD_USER_ID = P004Y2_A107TAM05_UPD_USER_ID[0] ;
         n107TAM05_UPD_USER_ID = P004Y2_n107TAM05_UPD_USER_ID[0] ;
         A106TAM05_UPD_DATETIME = P004Y2_A106TAM05_UPD_DATETIME[0] ;
         n106TAM05_UPD_DATETIME = P004Y2_n106TAM05_UPD_DATETIME[0] ;
         A105TAM05_CRT_PROG_NM = P004Y2_A105TAM05_CRT_PROG_NM[0] ;
         n105TAM05_CRT_PROG_NM = P004Y2_n105TAM05_CRT_PROG_NM[0] ;
         A104TAM05_CRT_USER_ID = P004Y2_A104TAM05_CRT_USER_ID[0] ;
         n104TAM05_CRT_USER_ID = P004Y2_n104TAM05_CRT_USER_ID[0] ;
         A103TAM05_CRT_DATETIME = P004Y2_A103TAM05_CRT_DATETIME[0] ;
         n103TAM05_CRT_DATETIME = P004Y2_n103TAM05_CRT_DATETIME[0] ;
         A101TAM05_KNGN_FLG = P004Y2_A101TAM05_KNGN_FLG[0] ;
         n101TAM05_KNGN_FLG = P004Y2_n101TAM05_KNGN_FLG[0] ;
         AV20GXLvl31 = (byte)(1) ;
         GXt_char1 = AV15W_STR ;
         ...
         new b804_pc01_esc_airres(remoteHandle, context).execute( A88TAM03_APP_ID, GXv_char4) ;
         b599_pc30_appli_kngn_res.this.GXt_char3 = GXv_char4[0] ;
         GXt_char5 = AV15W_STR ;
         GXv_char6[0] = GXt_char5 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A103TAM05_CRT_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char6) ;
         b599_pc30_appli_kngn_res.this.GXt_char5 = GXv_char6[0] ;
         GXt_char7 = AV15W_STR ;
         GXv_char8[0] = GXt_char7 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A104TAM05_CRT_USER_ID, GXv_char8) ;
         b599_pc30_appli_kngn_res.this.GXt_char7 = GXv_char8[0] ;
         GXt_char9 = AV15W_STR ;
         GXv_char10[0] = GXt_char9 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A105TAM05_CRT_PROG_NM, GXv_char10) ;
         b599_pc30_appli_kngn_res.this.GXt_char9 = GXv_char10[0] ;
         GXt_char11 = AV15W_STR ;
         GXv_char12[0] = GXt_char11 ;
         new a802_pc02_datetime_edit(remoteHandle, context).execute( A106TAM05_UPD_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char12) ;
         b599_pc30_appli_kngn_res.this.GXt_char11 = GXv_char12[0] ;
         GXt_char13 = AV15W_STR ;
         GXv_char14[0] = GXt_char13 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A107TAM05_UPD_USER_ID, GXv_char14) ;
         b599_pc30_appli_kngn_res.this.GXt_char13 = GXv_char14[0] ;
         GXt_char15 = AV15W_STR ;
         GXv_char16[0] = GXt_char15 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A108TAM05_UPD_PROG_NM, GXv_char16) ;
         b599_pc30_appli_kngn_res.this.GXt_char15 = GXv_char16[0] ;
         AV15W_STR = GXt_char1 + "," + GXt_char3 + "," + A101TAM05_KNGN_FLG + "," + A102TAM05_DEL_FLG + "," + GXt_char5 + "," + GXt_char7 + "," + GXt_char9 + "," + GXt_char11 + "," + GXt_char13 + "," + GXt_char15 + "," + GXutil.trim( GXutil.str( A109TAM05_UPD_CNT, 10, 0)) ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P004Y2_A102TAM05_DEL_FLG = new String[] {""} ;
      P004Y2_n102TAM05_DEL_FLG = new boolean[] {false} ;
      P004Y2_A88TAM03_APP_ID = new String[] {""} ;
      P004Y2_A17TAM04_AUTH_CD = new String[] {""} ;
      P004Y2_A109TAM05_UPD_CNT = new long[1] ;
      P004Y2_n109TAM05_UPD_CNT = new boolean[] {false} ;
      P004Y2_A108TAM05_UPD_PROG_NM = new String[] {""} ;
      P004Y2_n108TAM05_UPD_PROG_NM = new boolean[] {false} ;
      P004Y2_A107TAM05_UPD_USER_ID = new String[] {""} ;
      P004Y2_n107TAM05_UPD_USER_ID = new boolean[] {false} ;
      P004Y2_A106TAM05_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P004Y2_n106TAM05_UPD_DATETIME = new boolean[] {false} ;
      P004Y2_A105TAM05_CRT_PROG_NM = new String[] {""} ;
      P004Y2_n105TAM05_CRT_PROG_NM = new boolean[] {false} ;
      P004Y2_A104TAM05_CRT_USER_ID = new String[] {""} ;
      P004Y2_n104TAM05_CRT_USER_ID = new boolean[] {false} ;
      P004Y2_A103TAM05_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P004Y2_n103TAM05_CRT_DATETIME = new boolean[] {false} ;
      P004Y2_A101TAM05_KNGN_FLG = new String[] {""} ;
      P004Y2_n101TAM05_KNGN_FLG = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc30_appli_kngn_res__default(),
         new Object[] {
             new Object[] {
            P004Y2_A102TAM05_DEL_FLG, P004Y2_n102TAM05_DEL_FLG, P004Y2_A88TAM03_APP_ID, P004Y2_A17TAM04_AUTH_CD, P004Y2_A109TAM05_UPD_CNT, P004Y2_n109TAM05_UPD_CNT, P004Y2_A108TAM05_UPD_PROG_NM, P004Y2_n108TAM05_UPD_PROG_NM, P004Y2_A107TAM05_UPD_USER_ID, P004Y2_n107TAM05_UPD_USER_ID,
            P004Y2_A106TAM05_UPD_DATETIME, P004Y2_n106TAM05_UPD_DATETIME, P004Y2_A105TAM05_CRT_PROG_NM, P004Y2_n105TAM05_CRT_PROG_NM, P004Y2_A104TAM05_CRT_USER_ID, P004Y2_n104TAM05_CRT_USER_ID, P004Y2_A103TAM05_CRT_DATETIME, P004Y2_n103TAM05_CRT_DATETIME, P004Y2_A101TAM05_KNGN_FLG, P004Y2_n101TAM05_KNGN_FLG
            }
         }
      );
   ...
   private String[] P004Y2_A102TAM05_DEL_FLG ;
   private boolean[] P004Y2_n102TAM05_DEL_FLG ;
   private String[] P004Y2_A88TAM03_APP_ID ;
   private String[] P004Y2_A17TAM04_AUTH_CD ;
   private long[] P004Y2_A109TAM05_UPD_CNT ;
   private boolean[] P004Y2_n109TAM05_UPD_CNT ;
   private String[] P004Y2_A108TAM05_UPD_PROG_NM ;
   private boolean[] P004Y2_n108TAM05_UPD_PROG_NM ;
   private String[] P004Y2_A107TAM05_UPD_USER_ID ;
   private boolean[] P004Y2_n107TAM05_UPD_USER_ID ;
   private java.util.Date[] P004Y2_A106TAM05_UPD_DATETIME ;
   private boolean[] P004Y2_n106TAM05_UPD_DATETIME ;
   private String[] P004Y2_A105TAM05_CRT_PROG_NM ;
   private boolean[] P004Y2_n105TAM05_CRT_PROG_NM ;
   private String[] P004Y2_A104TAM05_CRT_USER_ID ;
   private boolean[] P004Y2_n104TAM05_CRT_USER_ID ;
   private java.util.Date[] P004Y2_A103TAM05_CRT_DATETIME ;
   private boolean[] P004Y2_n103TAM05_CRT_DATETIME ;
   private String[] P004Y2_A101TAM05_KNGN_FLG ;
   private boolean[] P004Y2_n101TAM05_KNGN_FLG ;
...
{
   protected Object[] conditional_P004Y2( com.genexus.internet.HttpContext httpContext ,
                                          String AV16P_AUTH_CD ,
                                          String AV17P_APP_ID ,
                                          String A17TAM04_AUTH_CD ,
                                          String A88TAM03_APP_ID ,
                                          String A102TAM05_DEL_FLG )
   {
      String sWhereString = "" ;
      String scmdbuf ;
      byte[] GXv_int19 ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P004Y2(httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P004Y2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
