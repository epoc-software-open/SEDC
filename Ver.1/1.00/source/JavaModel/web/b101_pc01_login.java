/*
       ...
       Generated on: July 3, 2017 14:52:0.50
...
public final  class b101_pc01_login extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      else
      {
         ...
         if ( AV13W_RTN_CD == 0 )
         {
            ...
            {
               A16TAM07_DEL_FLG = P00282_A16TAM07_DEL_FLG[0] ;
               n16TAM07_DEL_FLG = P00282_n16TAM07_DEL_FLG[0] ;
               A7TAM07_PWD = P00282_A7TAM07_PWD[0] ;
               n7TAM07_PWD = P00282_n7TAM07_PWD[0] ;
               A8TAM07_USER_ID = P00282_A8TAM07_USER_ID[0] ;
               A2TAM07_USER_NM = P00282_A2TAM07_USER_NM[0] ;
               n2TAM07_USER_NM = P00282_n2TAM07_USER_NM[0] ;
               A126TAM07_USER_KANA_NM = P00282_A126TAM07_USER_KANA_NM[0] ;
               n126TAM07_USER_KANA_NM = P00282_n126TAM07_USER_KANA_NM[0] ;
               A14TAM07_AUTH_CD = P00282_A14TAM07_AUTH_CD[0] ;
               n14TAM07_AUTH_CD = P00282_n14TAM07_AUTH_CD[0] ;
               AV19GXLvl62 = (byte)(1) ;
               ...
               AV11W_A_LOGIN_SDT.setgxTv_SdtA_LOGIN_SDT_Tam07_user_id( A8TAM07_USER_ID );
               AV11W_A_LOGIN_SDT.setgxTv_SdtA_LOGIN_SDT_Tam07_user_nm( A2TAM07_USER_NM );
               AV11W_A_LOGIN_SDT.setgxTv_SdtA_LOGIN_SDT_Tam07_user_kana_nm( A126TAM07_USER_KANA_NM );
               AV11W_A_LOGIN_SDT.setgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn( A14TAM07_AUTH_CD );
               ...
               AV15W_SESSION.setValue("Com_Login_Info", AV11W_A_LOGIN_SDT.toxml(false, "A_LOGIN_SDT", "SmartEDC_SHIZUOKA"));
   ...
   public void initialize( )
   {
      ...
      AV12W_PWD = "" ;
      scmdbuf = "" ;
      P00282_A16TAM07_DEL_FLG = new String[] {""} ;
      P00282_n16TAM07_DEL_FLG = new boolean[] {false} ;
      P00282_A7TAM07_PWD = new String[] {""} ;
      P00282_n7TAM07_PWD = new boolean[] {false} ;
      P00282_A8TAM07_USER_ID = new String[] {""} ;
      P00282_A2TAM07_USER_NM = new String[] {""} ;
      P00282_n2TAM07_USER_NM = new boolean[] {false} ;
      P00282_A126TAM07_USER_KANA_NM = new String[] {""} ;
      P00282_n126TAM07_USER_KANA_NM = new boolean[] {false} ;
      P00282_A14TAM07_AUTH_CD = new String[] {""} ;
      P00282_n14TAM07_AUTH_CD = new boolean[] {false} ;
      A16TAM07_DEL_FLG = "" ;
      A7TAM07_PWD = "" ;
      A8TAM07_USER_ID = "" ;
      A2TAM07_USER_NM = "" ;
      ...
      GXt_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem4 = new GxObjectCollection(SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem.class, "A801_SD01_SYS_CONFIG.A801_SD01_SYS_CONFIGItem", "SmartEDC_SHIZUOKA", remoteHandle);
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b101_pc01_login__default(),
         new Object[] {
             new Object[] {
            P00282_A16TAM07_DEL_FLG, P00282_n16TAM07_DEL_FLG, P00282_A7TAM07_PWD, P00282_n7TAM07_PWD, P00282_A8TAM07_USER_ID, P00282_A2TAM07_USER_NM, P00282_n2TAM07_USER_NM, P00282_A126TAM07_USER_KANA_NM, P00282_n126TAM07_USER_KANA_NM, P00282_A14TAM07_AUTH_CD,
            P00282_n14TAM07_AUTH_CD
            }
         }
      );
   ...
   private String[] P00282_A16TAM07_DEL_FLG ;
   private boolean[] P00282_n16TAM07_DEL_FLG ;
   private String[] P00282_A7TAM07_PWD ;
   private boolean[] P00282_n7TAM07_PWD ;
   private String[] P00282_A8TAM07_USER_ID ;
   private String[] P00282_A2TAM07_USER_NM ;
   private boolean[] P00282_n2TAM07_USER_NM ;
   private String[] P00282_A126TAM07_USER_KANA_NM ;
   private boolean[] P00282_n126TAM07_USER_KANA_NM ;
   private String[] P00282_A14TAM07_AUTH_CD ;
   private boolean[] P00282_n14TAM07_AUTH_CD ;
...
final  class b101_pc01_login__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00282", "SELECT `TAM07_DEL_FLG`, `TAM07_PWD`, `TAM07_USER_ID`, `TAM07_USER_NM`, `TAM07_USER_KANA_NM`, `TAM07_AUTH_CD` FROM `TAM07_USER` WHERE (`TAM07_USER_ID` = ?) AND (`TAM07_PWD` = ?) AND (`TAM07_DEL_FLG` = '0') ORDER BY `TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
