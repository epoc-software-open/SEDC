...
public final  class SdtTBW01_FREE_WORK extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( String AV595TBW01_SESSION_ID ,
                     String AV596TBW01_APP_ID ,
                     String AV597TBW01_DISP_DATETIME ,
                     long AV598TBW01_LINE_NO )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {AV595TBW01_SESSION_ID,AV596TBW01_APP_ID,AV597TBW01_DISP_DATETIME,new Long(AV598TBW01_LINE_NO)});
   }
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBW01_FREE_SAVE_1_Z") )
            {
               gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBW01_FREE_SAVE_2_Z") )
            {
               gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         String sNameSpace )
   {
      ...
      oWriter.writeElement("TBW01_FREE_SAVE_1_Z", GXutil.rtrim( gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z));
      if ( GXutil.strcmp(sNameSpace, "SmartEDC_SHIZUOKA") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SmartEDC_SHIZUOKA");
      }
      oWriter.writeElement("TBW01_FREE_SAVE_2_Z", GXutil.rtrim( gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z));
      if ( GXutil.strcmp(sNameSpace, "SmartEDC_SHIZUOKA") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SmartEDC_SHIZUOKA");
      }
   ...
   public void tojson( )
   {
      AddObjectProperty("TBW01_SESSION_ID", gxTv_SdtTBW01_FREE_WORK_Tbw01_session_id);
      AddObjectProperty("TBW01_APP_ID", gxTv_SdtTBW01_FREE_WORK_Tbw01_app_id);
      AddObjectProperty("TBW01_DISP_DATETIME", gxTv_SdtTBW01_FREE_WORK_Tbw01_disp_datetime);
      AddObjectProperty("TBW01_LINE_NO", gxTv_SdtTBW01_FREE_WORK_Tbw01_line_no);
      AddObjectProperty("TBW01_FREE_SAVE_1", gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1);
      AddObjectProperty("TBW01_FREE_SAVE_2", gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2);
      AddObjectProperty("Mode", gxTv_SdtTBW01_FREE_WORK_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTBW01_FREE_WORK_Initialized);
      AddObjectProperty("TBW01_SESSION_ID_Z", gxTv_SdtTBW01_FREE_WORK_Tbw01_session_id_Z);
      AddObjectProperty("TBW01_APP_ID_Z", gxTv_SdtTBW01_FREE_WORK_Tbw01_app_id_Z);
      AddObjectProperty("TBW01_DISP_DATETIME_Z", gxTv_SdtTBW01_FREE_WORK_Tbw01_disp_datetime_Z);
      AddObjectProperty("TBW01_LINE_NO_Z", gxTv_SdtTBW01_FREE_WORK_Tbw01_line_no_Z);
      AddObjectProperty("TBW01_FREE_SAVE_1_Z", gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z);
      AddObjectProperty("TBW01_FREE_SAVE_2_Z", gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z);
      AddObjectProperty("TBW01_FREE_SAVE_1_N", gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_N);
      AddObjectProperty("TBW01_FREE_SAVE_2_N", gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_N);
   }
   ...
   public void setgxTv_SdtTBW01_FREE_WORK_Tbw01_session_id( String value )
   {
      if ( GXutil.strcmp(gxTv_SdtTBW01_FREE_WORK_Tbw01_session_id, value) != 0 )
      {
         ...
         this.setgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z_SetNull( );
         this.setgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z_SetNull( );
      }
   ...
   public String getgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z( )
   {
      return gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z ;
   }

   public void setgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z( String value )
   {
      gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z = value ;
   }

   public void setgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z_SetNull( )
   {
      gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z = "" ;
   }

   public boolean getgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z_IsNull( )
   {
      return false ;
   }

   public String getgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z( )
   {
      return gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z ;
   }

   public void setgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z( String value )
   {
      gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z = value ;
   }

   public void setgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z_SetNull( )
   {
      gxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z = "" ;
   }

   public boolean getgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z_IsNull( )
   {
      return false ;
   }
   ...
   public void setStruct( StructSdtTBW01_FREE_WORK struct )
   {
      ...
      setgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z(struct.getTbw01_free_save_1_Z());
      setgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z(struct.getTbw01_free_save_2_Z());
   ...
   public StructSdtTBW01_FREE_WORK getStruct( )
   {
      ...
      struct.setTbw01_free_save_1_Z(getgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1_Z());
      struct.setTbw01_free_save_2_Z(getgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_2_Z());
