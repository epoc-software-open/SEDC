...
public final  class b790_wp02_error_html_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeText( "共通エラー画面（HTML5連携）") ;
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("b790_wp02_error_html") +"\" class=\""+"Form"+"\">") ;
   ...
   public void e131M2( )
   {
      ...
      if ( (GXutil.strcmp("", AV10W_SESSION.getValue("Com_Login_Info"))==0) )
      {
         ...
         new a805_pc02_msg_get(remoteHandle, context).execute( "AX00106", "", "", "", "", "", GXv_char4) ;
         b790_wp02_error_html_impl.this.GXt_char3 = GXv_char4[0] ;
         lblTbl_errmsg_Caption = GXt_char3 ;
   ...
   public void wb_table1_2_1M2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table2_5_1M2( true) ;
      }
      else
      {
         wb_table2_5_1M2( false) ;
      }
      return  ;
   }

   public void wb_table2_5_1M2e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void wb_table2_5_1M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table3_9_1M2( true) ;
      }
      else
      {
         wb_table3_9_1M2( false) ;
      }
      return  ;
   }

   public void wb_table3_9_1M2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_5_1M2e( true) ;
      }
      else
      {
         wb_table2_5_1M2e( false) ;
      }
   }

   public void wb_table3_9_1M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table4_17_1M2( true) ;
      }
      else
      {
         wb_table4_17_1M2( false) ;
      }
      return  ;
   }

   public void wb_table4_17_1M2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_9_1M2e( true) ;
      }
      else
      {
         wb_table3_9_1M2e( false) ;
      }
   }

   public void wb_table4_17_1M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_none_Internalname, GXutil.rtrim( AV7D_NONE), GXutil.rtrim( localUtil.format( AV7D_NONE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(20);\"", "", "", "", "", edtavD_none_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_B790_WP02_ERROR_HTML.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\"text-align:"+httpContext.getCssProperty( "Align", "center")+"\">") ;
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTbl_errmsg_Internalname, lblTbl_errmsg_Caption, "", "", lblTbl_errmsg_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(1), "HLP_B790_WP02_ERROR_HTML.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\"text-align:"+httpContext.getCssProperty( "Align", "center")+";height:50px\">") ;
         wb_table5_26_1M2( true) ;
      }
      else
      {
         wb_table5_26_1M2( false) ;
      }
      return  ;
   }

   public void wb_table5_26_1M2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_17_1M2e( true) ;
      }
      else
      {
         wb_table4_17_1M2e( false) ;
      }
   }

   public void wb_table5_26_1M2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_end_Internalname, "ログイン（F12）", "", "", lblTxt_btn_end_Jsonclick, "E\\'BTN_END\\'.", StyleString, ClassString, 5, "", 1, 1, (short)(0), "HLP_B790_WP02_ERROR_HTML.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_26_1M2e( true) ;
      }
      else
      {
         wb_table5_26_1M2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?1592233");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b790_wp02_error_html.js", "?1592233");
