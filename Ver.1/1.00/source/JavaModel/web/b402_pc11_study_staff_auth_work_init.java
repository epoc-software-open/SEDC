/*
       ...
       Generated on: July 3, 2017 14:56:42.64
...
public final  class b402_pc11_study_staff_auth_work_init extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A18TAM04_DEL_FLG = P003Z2_A18TAM04_DEL_FLG[0] ;
         n18TAM04_DEL_FLG = P003Z2_n18TAM04_DEL_FLG[0] ;
         A98TAM04_AUTH_NM = P003Z2_A98TAM04_AUTH_NM[0] ;
         n98TAM04_AUTH_NM = P003Z2_n98TAM04_AUTH_NM[0] ;
         A17TAM04_AUTH_CD = P003Z2_A17TAM04_AUTH_CD[0] ;
         ...
         AV19W_STUDY_STAFF_AUTH.setgxTv_SdtB402_SD03_STUDY_STAFF_AUTH_Auth_cd( A17TAM04_AUTH_CD );
         AV19W_STUDY_STAFF_AUTH.setgxTv_SdtB402_SD03_STUDY_STAFF_AUTH_Auth_nm( A98TAM04_AUTH_NM );
         AV14W_CNT = 1 ;
         ...
         AV8BC_FREE_WORK.setgxTv_SdtTBW01_FREE_WORK_Tbw01_free_save_1( AV19W_STUDY_STAFF_AUTH.toxml(false, "B402_SD03_STUDY_STAFF_AUTH", "SmartEDC_SHIZUOKA") );
   ...
   public void initialize( )
   {
      ...
      AV9C_APP_ID = "" ;
      scmdbuf = "" ;
      P003Z2_A18TAM04_DEL_FLG = new String[] {""} ;
      P003Z2_n18TAM04_DEL_FLG = new boolean[] {false} ;
      P003Z2_A98TAM04_AUTH_NM = new String[] {""} ;
      P003Z2_n98TAM04_AUTH_NM = new boolean[] {false} ;
      P003Z2_A17TAM04_AUTH_CD = new String[] {""} ;
      A18TAM04_DEL_FLG = "" ;
      A98TAM04_AUTH_NM = "" ;
      A17TAM04_AUTH_CD = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_pc11_study_staff_auth_work_init__default(),
         new Object[] {
             new Object[] {
            P003Z2_A18TAM04_DEL_FLG, P003Z2_n18TAM04_DEL_FLG, P003Z2_A98TAM04_AUTH_NM, P003Z2_n98TAM04_AUTH_NM, P003Z2_A17TAM04_AUTH_CD
            }
         }
      );
   ...
   private String[] P003Z2_A18TAM04_DEL_FLG ;
   private boolean[] P003Z2_n18TAM04_DEL_FLG ;
   private String[] P003Z2_A98TAM04_AUTH_NM ;
   private boolean[] P003Z2_n98TAM04_AUTH_NM ;
   private String[] P003Z2_A17TAM04_AUTH_CD ;
...
final  class b402_pc11_study_staff_auth_work_init__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P003Z2", "SELECT `TAM04_DEL_FLG`, `TAM04_AUTH_NM`, `TAM04_AUTH_CD` FROM `TAM04_KNGN` WHERE `TAM04_DEL_FLG` = '0' ORDER BY `TAM04_AUTH_CD` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,10,0,false )
      };
   }
