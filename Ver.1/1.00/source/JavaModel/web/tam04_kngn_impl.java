...
public final  class tam04_kngn_impl extends GXWebPanel
{
   ...
   public void wb_table2_5_033e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<legend class=\""+ClassString+"Title"+"\">"+"権限パターンマスタ"+"</legend>") ;
   ...
   public void wb_table4_33_033e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_button_ctrl( httpContext, bttBtn_enter_Internalname, "", "実行", bttBtn_enter_Jsonclick, 5, "実行", "", StyleString, ClassString, bttBtn_enter_Visible, 1, "standard", "EENTER.", TempTags, "", httpContext.getButtonType( ), "HLP_TAM04_KNGN.htm");
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 92,'',false,'',0)\"" ;
         ClassString = "BtnCancel" ;
         StyleString = "" ;
         GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "", "終了", bttBtn_cancel_Jsonclick, 1, "終了", "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "ECANCEL.", TempTags, "", httpContext.getButtonType( ), "HLP_TAM04_KNGN.htm");
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 93,'',false,'',0)\"" ;
         ClassString = "BtnDelete" ;
         StyleString = "" ;
         GxWebStd.gx_button_ctrl( httpContext, bttBtn_delete_Internalname, "", "削除", bttBtn_delete_Jsonclick, 5, "削除", "", StyleString, ClassString, bttBtn_delete_Visible, 1, "standard", "EDELETE.", TempTags, "", httpContext.getButtonType( ), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table4_33_033( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_auth_cd_Internalname, "権限パターン区分", "", "", lblTextblocktam04_auth_cd_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_auth_nm_Internalname, "権限パターン名", "", "", lblTextblocktam04_auth_nm_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_auth_lvl_Internalname, "入力権限レベル", "", "", lblTextblocktam04_auth_lvl_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_del_flg_Internalname, "削除フラグ", "", "", lblTextblocktam04_del_flg_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_crt_datetime_Internalname, "作成日時", "", "", lblTextblocktam04_crt_datetime_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTAM04_CRT_DATETIME_Internalname, localUtil.format(A39TAM04_CRT_DATETIME, "9999/99/99 99:99:99"), localUtil.format( A39TAM04_CRT_DATETIME, "9999/99/99 99:99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'jap',false,0);"+";gx.evt.onblur(58);\"", "", "", "", "", edtTAM04_CRT_DATETIME_Jsonclick, 0, ClassString, StyleString, "", 1, edtTAM04_CRT_DATETIME_Enabled, 0, 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_TAM04_KNGN.htm");
         GxWebStd.gx_bitmap( httpContext, edtTAM04_CRT_DATETIME_Internalname+"_dp_trigger", "calendar-img.gif", "", "", "", "", ((1==0)||(edtTAM04_CRT_DATETIME_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_TAM04_KNGN.htm");
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_crt_user_id_Internalname, "作成ユーザーID", "", "", lblTextblocktam04_crt_user_id_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_single_line_edit( httpContext, edtTAM04_CRT_USER_ID_Internalname, GXutil.rtrim( A78TAM04_CRT_USER_ID), GXutil.rtrim( localUtil.format( A78TAM04_CRT_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(63);\"", "", "", "", "", edtTAM04_CRT_USER_ID_Jsonclick, 0, ClassString, StyleString, "", 1, edtTAM04_CRT_USER_ID_Enabled, 0, 80, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "left", "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td valign=\"top\" class=\"td5\" >") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_crt_prog_nm_Internalname, "作成プログラム名", "", "", lblTextblocktam04_crt_prog_nm_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_upd_datetime_Internalname, "更新日時", "", "", lblTextblocktam04_upd_datetime_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTAM04_UPD_DATETIME_Internalname, localUtil.format(A41TAM04_UPD_DATETIME, "9999/99/99 99:99:99"), localUtil.format( A41TAM04_UPD_DATETIME, "9999/99/99 99:99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'jap',false,0);"+";gx.evt.onblur(73);\"", "", "", "", "", edtTAM04_UPD_DATETIME_Jsonclick, 0, ClassString, StyleString, "", 1, edtTAM04_UPD_DATETIME_Enabled, 0, 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), true, "right", "HLP_TAM04_KNGN.htm");
         GxWebStd.gx_bitmap( httpContext, edtTAM04_UPD_DATETIME_Internalname+"_dp_trigger", "calendar-img.gif", "", "", "", "", ((1==0)||(edtTAM04_UPD_DATETIME_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_TAM04_KNGN.htm");
         httpContext.writeTextNL( "</div>") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_upd_user_id_Internalname, "更新ユーザーID", "", "", lblTextblocktam04_upd_user_id_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_upd_prog_nm_Internalname, "更新プログラム名", "", "", lblTextblocktam04_upd_prog_nm_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         ...
         ClassString = "TextBlock" ;
         StyleString = "" ;
         GxWebStd.gx_label_ctrl( httpContext, lblTextblocktam04_upd_cnt_Internalname, "更新カウント", "", "", lblTextblocktam04_upd_cnt_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, (short)(0), "HLP_TAM04_KNGN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
   ...
   public void wb_table2_5_033( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_first_Internalname, context.getHttpContext().getImagePath( "b9e06284-17ac-4c88-8937-5dbd84ad5d80", "", "Style2"), "", "", "", "Style2", imgBtn_first_Visible, 1, "", "最初へ", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_first_Jsonclick, "EFIRST.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 9,'',false,'',0)\"" ;
         ClassString = "ImageTop" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_first_separator_Internalname, context.getHttpContext().getImagePath( "ea7811ba-4fa2-42da-8591-e6cb10669f1f", "", "Style2"), "", "", "", "Style2", imgBtn_first_separator_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_first_separator_Jsonclick, "EFIRST.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 10,'',false,'',0)\"" ;
         ClassString = "ImageHandCenter" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_previous_Internalname, context.getHttpContext().getImagePath( "7d212604-db7b-4785-9c0d-5faffe71aa33", "", "Style2"), "", "", "", "Style2", imgBtn_previous_Visible, 1, "", "前へ", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_previous_Jsonclick, "EPREVIOUS.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 11,'',false,'',0)\"" ;
         ClassString = "ImageTop" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_previous_separator_Internalname, context.getHttpContext().getImagePath( "ea7811ba-4fa2-42da-8591-e6cb10669f1f", "", "Style2"), "", "", "", "Style2", imgBtn_previous_separator_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_previous_separator_Jsonclick, "EPREVIOUS.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 12,'',false,'',0)\"" ;
         ClassString = "ImageHandCenter" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_next_Internalname, context.getHttpContext().getImagePath( "1ae947cf-1354-41a9-8d59-d91daebf554f", "", "Style2"), "", "", "", "Style2", imgBtn_next_Visible, 1, "", "次へ", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_next_Jsonclick, "ENEXT.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 13,'',false,'',0)\"" ;
         ClassString = "ImageTop" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_next_separator_Internalname, context.getHttpContext().getImagePath( "ea7811ba-4fa2-42da-8591-e6cb10669f1f", "", "Style2"), "", "", "", "Style2", imgBtn_next_separator_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_next_separator_Jsonclick, "ENEXT.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 14,'',false,'',0)\"" ;
         ClassString = "ImageHandCenter" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_last_Internalname, context.getHttpContext().getImagePath( "29211874-e613-48e5-9011-8017d984217e", "", "Style2"), "", "", "", "Style2", imgBtn_last_Visible, 1, "", "最後", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_last_Jsonclick, "ELAST.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"" ;
         ClassString = "ImageTop" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_last_separator_Internalname, context.getHttpContext().getImagePath( "ea7811ba-4fa2-42da-8591-e6cb10669f1f", "", "Style2"), "", "", "", "Style2", imgBtn_last_separator_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_last_separator_Jsonclick, "ELAST.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'',0)\"" ;
         ClassString = "ImageHandCenter" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_select_Internalname, context.getHttpContext().getImagePath( "1ca03f75-9947-4d2c-90a4-e8ab9c5cedea", "", "Style2"), "", "", "", "Style2", imgBtn_select_Visible, 1, "", "選択", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_select_Jsonclick, "ESELECT.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 17,'',false,'',0)\"" ;
         ClassString = "ImageTop" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_select_separator_Internalname, context.getHttpContext().getImagePath( "ea7811ba-4fa2-42da-8591-e6cb10669f1f", "", "Style2"), "", "", "", "Style2", imgBtn_select_separator_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_select_separator_Jsonclick, "ESELECT.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'',0)\"" ;
         ClassString = "ImageHandCenter" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_enter2_Internalname, context.getHttpContext().getImagePath( "2061cf2c-bd33-4433-a13e-34af954142e9", "", "Style2"), "", "", "", "Style2", imgBtn_enter2_Visible, imgBtn_enter2_Enabled, "", "実行", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_enter2_Jsonclick, "EENTER.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 19,'',false,'',0)\"" ;
         ClassString = "ImageTop" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_enter2_separator_Internalname, context.getHttpContext().getImagePath( "ea7811ba-4fa2-42da-8591-e6cb10669f1f", "", "Style2"), "", "", "", "Style2", imgBtn_enter2_separator_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_enter2_separator_Jsonclick, "EENTER.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 20,'',false,'',0)\"" ;
         ClassString = "ImageHandCenter" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_cancel2_Internalname, context.getHttpContext().getImagePath( "0e94ced8-bc34-47ff-9a53-bc683736a686", "", "Style2"), "", "", "", "Style2", imgBtn_cancel2_Visible, 1, "", "終了", 0, 0, 0, "", 0, "", 0, 0, 1, imgBtn_cancel2_Jsonclick, "ECANCEL.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 21,'',false,'',0)\"" ;
         ClassString = "ImageTop" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_cancel2_separator_Internalname, context.getHttpContext().getImagePath( "ea7811ba-4fa2-42da-8591-e6cb10669f1f", "", "Style2"), "", "", "", "Style2", imgBtn_cancel2_separator_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 1, imgBtn_cancel2_separator_Jsonclick, "ECANCEL.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 22,'',false,'',0)\"" ;
         ClassString = "ImageHandCenter" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_delete2_Internalname, context.getHttpContext().getImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", "Style2"), "", "", "", "Style2", imgBtn_delete2_Visible, imgBtn_delete2_Enabled, "", "削除", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_delete2_Jsonclick, "EDELETE.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
         /* Active images/pictures */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 23,'',false,'',0)\"" ;
         ClassString = "ImageTop" ;
         StyleString = "" ;
         GxWebStd.gx_bitmap( httpContext, imgBtn_delete2_separator_Internalname, context.getHttpContext().getImagePath( "ea7811ba-4fa2-42da-8591-e6cb10669f1f", "", "Style2"), "", "", "", "Style2", imgBtn_delete2_separator_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 5, imgBtn_delete2_separator_Jsonclick, "EDELETE.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TAM04_KNGN.htm");
   ...
   public void e12032( )
   {
      ...
      new a802_pc02_datetime_edit(remoteHandle, context).execute( A39TAM04_CRT_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char4) ;
      tam04_kngn_impl.this.GXt_char3 = GXv_char4[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "A39TAM04_CRT_DATETIME", localUtil.ttoc( A39TAM04_CRT_DATETIME, 10, 8, 0, 1, "/", ":", " "));
      ...
      GXt_char3 = AV10W_TXT ;
      GXv_char4[0] = GXt_char3 ;
      new a802_pc02_datetime_edit(remoteHandle, context).execute( A41TAM04_UPD_DATETIME, "YYYY/MM/DD HH:MI:SS", GXv_char4) ;
      tam04_kngn_impl.this.GXt_char3 = GXv_char4[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "A41TAM04_UPD_DATETIME", localUtil.ttoc( A41TAM04_UPD_DATETIME, 10, 8, 0, 1, "/", ":", " "));
      AV10W_TXT = AV10W_TXT + GXt_char3 + GXutil.chr( (short)(9)) ;
   ...
   public void zm033( int GX_JID )
   {
      if ( ( GX_JID == 8 ) || ( GX_JID == 0 ) )
      {
         if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
         {
            Z39TAM04_CRT_DATETIME = T00033_A39TAM04_CRT_DATETIME[0] ;
            Z78TAM04_CRT_USER_ID = T00033_A78TAM04_CRT_USER_ID[0] ;
            Z41TAM04_UPD_DATETIME = T00033_A41TAM04_UPD_DATETIME[0] ;
            Z79TAM04_UPD_USER_ID = T00033_A79TAM04_UPD_USER_ID[0] ;
            Z99TAM04_UPD_CNT = T00033_A99TAM04_UPD_CNT[0] ;
            Z98TAM04_AUTH_NM = T00033_A98TAM04_AUTH_NM[0] ;
            Z601TAM04_AUTH_LVL = T00033_A601TAM04_AUTH_LVL[0] ;
            Z18TAM04_DEL_FLG = T00033_A18TAM04_DEL_FLG[0] ;
            Z40TAM04_CRT_PROG_NM = T00033_A40TAM04_CRT_PROG_NM[0] ;
            Z42TAM04_UPD_PROG_NM = T00033_A42TAM04_UPD_PROG_NM[0] ;
         }
         else
         {
   ...
   public void load033( )
   {
      ...
      {
         RcdFound3 = (short)(1) ;
         A39TAM04_CRT_DATETIME = T00034_A39TAM04_CRT_DATETIME[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A39TAM04_CRT_DATETIME", localUtil.ttoc( A39TAM04_CRT_DATETIME, 10, 8, 0, 1, "/", ":", " "));
         n39TAM04_CRT_DATETIME = T00034_n39TAM04_CRT_DATETIME[0] ;
         A78TAM04_CRT_USER_ID = T00034_A78TAM04_CRT_USER_ID[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A78TAM04_CRT_USER_ID", A78TAM04_CRT_USER_ID);
         n78TAM04_CRT_USER_ID = T00034_n78TAM04_CRT_USER_ID[0] ;
         A41TAM04_UPD_DATETIME = T00034_A41TAM04_UPD_DATETIME[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A41TAM04_UPD_DATETIME", localUtil.ttoc( A41TAM04_UPD_DATETIME, 10, 8, 0, 1, "/", ":", " "));
         n41TAM04_UPD_DATETIME = T00034_n41TAM04_UPD_DATETIME[0] ;
         A79TAM04_UPD_USER_ID = T00034_A79TAM04_UPD_USER_ID[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A79TAM04_UPD_USER_ID", A79TAM04_UPD_USER_ID);
         n79TAM04_UPD_USER_ID = T00034_n79TAM04_UPD_USER_ID[0] ;
         A99TAM04_UPD_CNT = T00034_A99TAM04_UPD_CNT[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A99TAM04_UPD_CNT", GXutil.ltrim( GXutil.str( A99TAM04_UPD_CNT, 10, 0)));
         n99TAM04_UPD_CNT = T00034_n99TAM04_UPD_CNT[0] ;
         A98TAM04_AUTH_NM = T00034_A98TAM04_AUTH_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A98TAM04_AUTH_NM", A98TAM04_AUTH_NM);
         n98TAM04_AUTH_NM = T00034_n98TAM04_AUTH_NM[0] ;
         A601TAM04_AUTH_LVL = T00034_A601TAM04_AUTH_LVL[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A601TAM04_AUTH_LVL", GXutil.ltrim( GXutil.str( A601TAM04_AUTH_LVL, 2, 0)));
         n601TAM04_AUTH_LVL = T00034_n601TAM04_AUTH_LVL[0] ;
         A18TAM04_DEL_FLG = T00034_A18TAM04_DEL_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A18TAM04_DEL_FLG", A18TAM04_DEL_FLG);
         n18TAM04_DEL_FLG = T00034_n18TAM04_DEL_FLG[0] ;
         A40TAM04_CRT_PROG_NM = T00034_A40TAM04_CRT_PROG_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A40TAM04_CRT_PROG_NM", A40TAM04_CRT_PROG_NM);
         n40TAM04_CRT_PROG_NM = T00034_n40TAM04_CRT_PROG_NM[0] ;
         A42TAM04_UPD_PROG_NM = T00034_A42TAM04_UPD_PROG_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A42TAM04_UPD_PROG_NM", A42TAM04_UPD_PROG_NM);
         n42TAM04_UPD_PROG_NM = T00034_n42TAM04_UPD_PROG_NM[0] ;
         zm033( -8) ;
      }
      pr_default.close(2);
      onLoadActions033( ) ;
   ...
   public void getByPrimaryKey( )
   {
      ...
      if ( (pr_default.getStatus(1) != 101) )
      {
         zm033( 8) ;
         RcdFound3 = (short)(1) ;
         A17TAM04_AUTH_CD = T00033_A17TAM04_AUTH_CD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A17TAM04_AUTH_CD", A17TAM04_AUTH_CD);
         A39TAM04_CRT_DATETIME = T00033_A39TAM04_CRT_DATETIME[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A39TAM04_CRT_DATETIME", localUtil.ttoc( A39TAM04_CRT_DATETIME, 10, 8, 0, 1, "/", ":", " "));
         n39TAM04_CRT_DATETIME = T00033_n39TAM04_CRT_DATETIME[0] ;
         A78TAM04_CRT_USER_ID = T00033_A78TAM04_CRT_USER_ID[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A78TAM04_CRT_USER_ID", A78TAM04_CRT_USER_ID);
         n78TAM04_CRT_USER_ID = T00033_n78TAM04_CRT_USER_ID[0] ;
         A41TAM04_UPD_DATETIME = T00033_A41TAM04_UPD_DATETIME[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A41TAM04_UPD_DATETIME", localUtil.ttoc( A41TAM04_UPD_DATETIME, 10, 8, 0, 1, "/", ":", " "));
         n41TAM04_UPD_DATETIME = T00033_n41TAM04_UPD_DATETIME[0] ;
         A79TAM04_UPD_USER_ID = T00033_A79TAM04_UPD_USER_ID[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A79TAM04_UPD_USER_ID", A79TAM04_UPD_USER_ID);
         n79TAM04_UPD_USER_ID = T00033_n79TAM04_UPD_USER_ID[0] ;
         A99TAM04_UPD_CNT = T00033_A99TAM04_UPD_CNT[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A99TAM04_UPD_CNT", GXutil.ltrim( GXutil.str( A99TAM04_UPD_CNT, 10, 0)));
         n99TAM04_UPD_CNT = T00033_n99TAM04_UPD_CNT[0] ;
         A98TAM04_AUTH_NM = T00033_A98TAM04_AUTH_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A98TAM04_AUTH_NM", A98TAM04_AUTH_NM);
         n98TAM04_AUTH_NM = T00033_n98TAM04_AUTH_NM[0] ;
         A601TAM04_AUTH_LVL = T00033_A601TAM04_AUTH_LVL[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A601TAM04_AUTH_LVL", GXutil.ltrim( GXutil.str( A601TAM04_AUTH_LVL, 2, 0)));
         n601TAM04_AUTH_LVL = T00033_n601TAM04_AUTH_LVL[0] ;
         A18TAM04_DEL_FLG = T00033_A18TAM04_DEL_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A18TAM04_DEL_FLG", A18TAM04_DEL_FLG);
         n18TAM04_DEL_FLG = T00033_n18TAM04_DEL_FLG[0] ;
         A40TAM04_CRT_PROG_NM = T00033_A40TAM04_CRT_PROG_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A40TAM04_CRT_PROG_NM", A40TAM04_CRT_PROG_NM);
         n40TAM04_CRT_PROG_NM = T00033_n40TAM04_CRT_PROG_NM[0] ;
         A42TAM04_UPD_PROG_NM = T00033_A42TAM04_UPD_PROG_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A42TAM04_UPD_PROG_NM", A42TAM04_UPD_PROG_NM);
         n42TAM04_UPD_PROG_NM = T00033_n42TAM04_UPD_PROG_NM[0] ;
   ...
   public void move_next( )
   {
      ...
      {
         while ( (pr_default.getStatus(4) != 101) && ( ( GXutil.strcmp(T00036_A17TAM04_AUTH_CD[0], A17TAM04_AUTH_CD) < 0 ) ) )
         {
            pr_default.readNext(4);
         }
         if ( (pr_default.getStatus(4) != 101) && ( ( GXutil.strcmp(T00036_A17TAM04_AUTH_CD[0], A17TAM04_AUTH_CD) > 0 ) ) )
         {
            A17TAM04_AUTH_CD = T00036_A17TAM04_AUTH_CD[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A17TAM04_AUTH_CD", A17TAM04_AUTH_CD);
            RcdFound3 = (short)(1) ;
         }
      }
   ...
   public void move_previous( )
   {
      ...
      {
         while ( (pr_default.getStatus(5) != 101) && ( ( GXutil.strcmp(T00037_A17TAM04_AUTH_CD[0], A17TAM04_AUTH_CD) > 0 ) ) )
         {
            pr_default.readNext(5);
         }
         if ( (pr_default.getStatus(5) != 101) && ( ( GXutil.strcmp(T00037_A17TAM04_AUTH_CD[0], A17TAM04_AUTH_CD) < 0 ) ) )
         {
            A17TAM04_AUTH_CD = T00037_A17TAM04_AUTH_CD[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A17TAM04_AUTH_CD", A17TAM04_AUTH_CD);
            RcdFound3 = (short)(1) ;
         }
      }
   ...
   public void checkOptimisticConcurrency033( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         ...
         Gx_longc = false ;
         if ( (pr_default.getStatus(0) == 101) || !( Z39TAM04_CRT_DATETIME.equals( T00032_A39TAM04_CRT_DATETIME[0] ) ) || ( GXutil.strcmp(Z78TAM04_CRT_USER_ID, T00032_A78TAM04_CRT_USER_ID[0]) != 0 ) || !( Z41TAM04_UPD_DATETIME.equals( T00032_A41TAM04_UPD_DATETIME[0] ) ) || ( GXutil.strcmp(Z79TAM04_UPD_USER_ID, T00032_A79TAM04_UPD_USER_ID[0]) != 0 ) || ( Z99TAM04_UPD_CNT != T00032_A99TAM04_UPD_CNT[0] ) )
         {
            Gx_longc = true ;
         }
         if ( Gx_longc || ( GXutil.strcmp(Z98TAM04_AUTH_NM, T00032_A98TAM04_AUTH_NM[0]) != 0 ) || ( Z601TAM04_AUTH_LVL != T00032_A601TAM04_AUTH_LVL[0] ) || ( GXutil.strcmp(Z18TAM04_DEL_FLG, T00032_A18TAM04_DEL_FLG[0]) != 0 ) || ( GXutil.strcmp(Z40TAM04_CRT_PROG_NM, T00032_A40TAM04_CRT_PROG_NM[0]) != 0 ) || ( GXutil.strcmp(Z42TAM04_UPD_PROG_NM, T00032_A42TAM04_UPD_PROG_NM[0]) != 0 ) )
         {
   ...
   public void scanStart033( )
   {
      ...
      {
         RcdFound3 = (short)(1) ;
         A17TAM04_AUTH_CD = T000314_A17TAM04_AUTH_CD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A17TAM04_AUTH_CD", A17TAM04_AUTH_CD);
      }
   ...
   public void beforeInsert033( )
   {
      ...
      n39TAM04_CRT_DATETIME = false ;
      httpContext.ajax_rsp_assign_attri("", false, "A39TAM04_CRT_DATETIME", localUtil.ttoc( A39TAM04_CRT_DATETIME, 10, 8, 0, 1, "/", ":", " "));
      GXt_char3 = A78TAM04_CRT_USER_ID ;
      GXv_char4[0] = GXt_char3 ;
      new a403_pc01_get_login_user_id(remoteHandle, context).execute( GXv_char4) ;
      tam04_kngn_impl.this.GXt_char3 = GXv_char4[0] ;
      A78TAM04_CRT_USER_ID = GXt_char3 ;
      n78TAM04_CRT_USER_ID = false ;
      httpContext.ajax_rsp_assign_attri("", false, "A78TAM04_CRT_USER_ID", A78TAM04_CRT_USER_ID);
      A41TAM04_UPD_DATETIME = GXutil.now( ) ;
      n41TAM04_UPD_DATETIME = false ;
      httpContext.ajax_rsp_assign_attri("", false, "A41TAM04_UPD_DATETIME", localUtil.ttoc( A41TAM04_UPD_DATETIME, 10, 8, 0, 1, "/", ":", " "));
      GXt_char3 = A79TAM04_UPD_USER_ID ;
      GXv_char4[0] = GXt_char3 ;
      new a403_pc01_get_login_user_id(remoteHandle, context).execute( GXv_char4) ;
      tam04_kngn_impl.this.GXt_char3 = GXv_char4[0] ;
      A79TAM04_UPD_USER_ID = GXt_char3 ;
      n79TAM04_UPD_USER_ID = false ;
      httpContext.ajax_rsp_assign_attri("", false, "A79TAM04_UPD_USER_ID", A79TAM04_UPD_USER_ID);
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeText( "権限パターンマスタ") ;
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("tam04_kngn") +"\" class=\""+"Form"+"\">") ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?14533842");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tam04_kngn.js", "?14533842");
   ...
   public void initialize( )
   {
      ...
      GXEncryptionTmp = "" ;
      AV10W_TXT = "" ;
      T00034_A17TAM04_AUTH_CD = new String[] {""} ;
      T00034_A39TAM04_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      T00034_n39TAM04_CRT_DATETIME = new boolean[] {false} ;
      T00034_A78TAM04_CRT_USER_ID = new String[] {""} ;
      T00034_n78TAM04_CRT_USER_ID = new boolean[] {false} ;
      T00034_A41TAM04_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      T00034_n41TAM04_UPD_DATETIME = new boolean[] {false} ;
      T00034_A79TAM04_UPD_USER_ID = new String[] {""} ;
      T00034_n79TAM04_UPD_USER_ID = new boolean[] {false} ;
      T00034_A99TAM04_UPD_CNT = new long[1] ;
      T00034_n99TAM04_UPD_CNT = new boolean[] {false} ;
      T00034_A98TAM04_AUTH_NM = new String[] {""} ;
      T00034_n98TAM04_AUTH_NM = new boolean[] {false} ;
      T00034_A601TAM04_AUTH_LVL = new byte[1] ;
      T00034_n601TAM04_AUTH_LVL = new boolean[] {false} ;
      T00034_A18TAM04_DEL_FLG = new String[] {""} ;
      T00034_n18TAM04_DEL_FLG = new boolean[] {false} ;
      T00034_A40TAM04_CRT_PROG_NM = new String[] {""} ;
      T00034_n40TAM04_CRT_PROG_NM = new boolean[] {false} ;
      T00034_A42TAM04_UPD_PROG_NM = new String[] {""} ;
      T00034_n42TAM04_UPD_PROG_NM = new boolean[] {false} ;
      T00035_A17TAM04_AUTH_CD = new String[] {""} ;
      T00033_A17TAM04_AUTH_CD = new String[] {""} ;
      T00033_A39TAM04_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      T00033_n39TAM04_CRT_DATETIME = new boolean[] {false} ;
      T00033_A78TAM04_CRT_USER_ID = new String[] {""} ;
      T00033_n78TAM04_CRT_USER_ID = new boolean[] {false} ;
      T00033_A41TAM04_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      T00033_n41TAM04_UPD_DATETIME = new boolean[] {false} ;
      T00033_A79TAM04_UPD_USER_ID = new String[] {""} ;
      T00033_n79TAM04_UPD_USER_ID = new boolean[] {false} ;
      T00033_A99TAM04_UPD_CNT = new long[1] ;
      T00033_n99TAM04_UPD_CNT = new boolean[] {false} ;
      T00033_A98TAM04_AUTH_NM = new String[] {""} ;
      T00033_n98TAM04_AUTH_NM = new boolean[] {false} ;
      T00033_A601TAM04_AUTH_LVL = new byte[1] ;
      T00033_n601TAM04_AUTH_LVL = new boolean[] {false} ;
      T00033_A18TAM04_DEL_FLG = new String[] {""} ;
      T00033_n18TAM04_DEL_FLG = new boolean[] {false} ;
      T00033_A40TAM04_CRT_PROG_NM = new String[] {""} ;
      T00033_n40TAM04_CRT_PROG_NM = new boolean[] {false} ;
      T00033_A42TAM04_UPD_PROG_NM = new String[] {""} ;
      T00033_n42TAM04_UPD_PROG_NM = new boolean[] {false} ;
      sMode3 = "" ;
      T00036_A17TAM04_AUTH_CD = new String[] {""} ;
      T00037_A17TAM04_AUTH_CD = new String[] {""} ;
      T00032_A17TAM04_AUTH_CD = new String[] {""} ;
      T00032_A39TAM04_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      T00032_n39TAM04_CRT_DATETIME = new boolean[] {false} ;
      T00032_A78TAM04_CRT_USER_ID = new String[] {""} ;
      T00032_n78TAM04_CRT_USER_ID = new boolean[] {false} ;
      T00032_A41TAM04_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      T00032_n41TAM04_UPD_DATETIME = new boolean[] {false} ;
      T00032_A79TAM04_UPD_USER_ID = new String[] {""} ;
      T00032_n79TAM04_UPD_USER_ID = new boolean[] {false} ;
      T00032_A99TAM04_UPD_CNT = new long[1] ;
      T00032_n99TAM04_UPD_CNT = new boolean[] {false} ;
      T00032_A98TAM04_AUTH_NM = new String[] {""} ;
      T00032_n98TAM04_AUTH_NM = new boolean[] {false} ;
      T00032_A601TAM04_AUTH_LVL = new byte[1] ;
      T00032_n601TAM04_AUTH_LVL = new boolean[] {false} ;
      T00032_A18TAM04_DEL_FLG = new String[] {""} ;
      T00032_n18TAM04_DEL_FLG = new boolean[] {false} ;
      T00032_A40TAM04_CRT_PROG_NM = new String[] {""} ;
      T00032_n40TAM04_CRT_PROG_NM = new boolean[] {false} ;
      T00032_A42TAM04_UPD_PROG_NM = new String[] {""} ;
      T00032_n42TAM04_UPD_PROG_NM = new boolean[] {false} ;
      T000311_A530TBM07_AUTH_CD = new String[] {""} ;
      T000312_A17TAM04_AUTH_CD = new String[] {""} ;
      T000312_A88TAM03_APP_ID = new String[] {""} ;
      T000313_A8TAM07_USER_ID = new String[] {""} ;
      T000314_A17TAM04_AUTH_CD = new String[] {""} ;
      sDynURL = "" ;
      FormProcess = "" ;
      GXt_char2 = "" ;
      GXt_char1 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new tam04_kngn__default(),
         new Object[] {
             new Object[] {
            T00032_A17TAM04_AUTH_CD, T00032_A39TAM04_CRT_DATETIME, T00032_n39TAM04_CRT_DATETIME, T00032_A78TAM04_CRT_USER_ID, T00032_n78TAM04_CRT_USER_ID, T00032_A41TAM04_UPD_DATETIME, T00032_n41TAM04_UPD_DATETIME, T00032_A79TAM04_UPD_USER_ID, T00032_n79TAM04_UPD_USER_ID, T00032_A99TAM04_UPD_CNT,
            T00032_n99TAM04_UPD_CNT, T00032_A98TAM04_AUTH_NM, T00032_n98TAM04_AUTH_NM, T00032_A601TAM04_AUTH_LVL, T00032_n601TAM04_AUTH_LVL, T00032_A18TAM04_DEL_FLG, T00032_n18TAM04_DEL_FLG, T00032_A40TAM04_CRT_PROG_NM, T00032_n40TAM04_CRT_PROG_NM, T00032_A42TAM04_UPD_PROG_NM,
            T00032_n42TAM04_UPD_PROG_NM
            }
            , new Object[] {
            T00033_A17TAM04_AUTH_CD, T00033_A39TAM04_CRT_DATETIME, T00033_n39TAM04_CRT_DATETIME, T00033_A78TAM04_CRT_USER_ID, T00033_n78TAM04_CRT_USER_ID, T00033_A41TAM04_UPD_DATETIME, T00033_n41TAM04_UPD_DATETIME, T00033_A79TAM04_UPD_USER_ID, T00033_n79TAM04_UPD_USER_ID, T00033_A99TAM04_UPD_CNT,
            T00033_n99TAM04_UPD_CNT, T00033_A98TAM04_AUTH_NM, T00033_n98TAM04_AUTH_NM, T00033_A601TAM04_AUTH_LVL, T00033_n601TAM04_AUTH_LVL, T00033_A18TAM04_DEL_FLG, T00033_n18TAM04_DEL_FLG, T00033_A40TAM04_CRT_PROG_NM, T00033_n40TAM04_CRT_PROG_NM, T00033_A42TAM04_UPD_PROG_NM,
            T00033_n42TAM04_UPD_PROG_NM
            }
            , new Object[] {
            T00034_A17TAM04_AUTH_CD, T00034_A39TAM04_CRT_DATETIME, T00034_n39TAM04_CRT_DATETIME, T00034_A78TAM04_CRT_USER_ID, T00034_n78TAM04_CRT_USER_ID, T00034_A41TAM04_UPD_DATETIME, T00034_n41TAM04_UPD_DATETIME, T00034_A79TAM04_UPD_USER_ID, T00034_n79TAM04_UPD_USER_ID, T00034_A99TAM04_UPD_CNT,
            T00034_n99TAM04_UPD_CNT, T00034_A98TAM04_AUTH_NM, T00034_n98TAM04_AUTH_NM, T00034_A601TAM04_AUTH_LVL, T00034_n601TAM04_AUTH_LVL, T00034_A18TAM04_DEL_FLG, T00034_n18TAM04_DEL_FLG, T00034_A40TAM04_CRT_PROG_NM, T00034_n40TAM04_CRT_PROG_NM, T00034_A42TAM04_UPD_PROG_NM,
            T00034_n42TAM04_UPD_PROG_NM
            }
            , new Object[] {
            T00035_A17TAM04_AUTH_CD
            }
            , new Object[] {
            T00036_A17TAM04_AUTH_CD
            }
            , new Object[] {
            T00037_A17TAM04_AUTH_CD
            }
            , new Object[] {
            }
            , new Object[] {
            ...
            , new Object[] {
            T000311_A530TBM07_AUTH_CD
            }
            , new Object[] {
            T000312_A17TAM04_AUTH_CD, T000312_A88TAM03_APP_ID
            }
            , new Object[] {
            T000313_A8TAM07_USER_ID
            }
            , new Object[] {
            T000314_A17TAM04_AUTH_CD
            }
         }
      );
      AV12Pgmname = "TAM04_KNGN" ;
   ...
   private String[] T00034_A17TAM04_AUTH_CD ;
   private java.util.Date[] T00034_A39TAM04_CRT_DATETIME ;
   private boolean[] T00034_n39TAM04_CRT_DATETIME ;
   private String[] T00034_A78TAM04_CRT_USER_ID ;
   private boolean[] T00034_n78TAM04_CRT_USER_ID ;
   private java.util.Date[] T00034_A41TAM04_UPD_DATETIME ;
   private boolean[] T00034_n41TAM04_UPD_DATETIME ;
   private String[] T00034_A79TAM04_UPD_USER_ID ;
   private boolean[] T00034_n79TAM04_UPD_USER_ID ;
   private long[] T00034_A99TAM04_UPD_CNT ;
   private boolean[] T00034_n99TAM04_UPD_CNT ;
   private String[] T00034_A98TAM04_AUTH_NM ;
   private boolean[] T00034_n98TAM04_AUTH_NM ;
   private byte[] T00034_A601TAM04_AUTH_LVL ;
   private boolean[] T00034_n601TAM04_AUTH_LVL ;
   private String[] T00034_A18TAM04_DEL_FLG ;
   private boolean[] T00034_n18TAM04_DEL_FLG ;
   private String[] T00034_A40TAM04_CRT_PROG_NM ;
   private boolean[] T00034_n40TAM04_CRT_PROG_NM ;
   private String[] T00034_A42TAM04_UPD_PROG_NM ;
   private boolean[] T00034_n42TAM04_UPD_PROG_NM ;
   private String[] T00035_A17TAM04_AUTH_CD ;
   private String[] T00033_A17TAM04_AUTH_CD ;
   private java.util.Date[] T00033_A39TAM04_CRT_DATETIME ;
   private boolean[] T00033_n39TAM04_CRT_DATETIME ;
   private String[] T00033_A78TAM04_CRT_USER_ID ;
   private boolean[] T00033_n78TAM04_CRT_USER_ID ;
   private java.util.Date[] T00033_A41TAM04_UPD_DATETIME ;
   private boolean[] T00033_n41TAM04_UPD_DATETIME ;
   private String[] T00033_A79TAM04_UPD_USER_ID ;
   private boolean[] T00033_n79TAM04_UPD_USER_ID ;
   private long[] T00033_A99TAM04_UPD_CNT ;
   private boolean[] T00033_n99TAM04_UPD_CNT ;
   private String[] T00033_A98TAM04_AUTH_NM ;
   private boolean[] T00033_n98TAM04_AUTH_NM ;
   private byte[] T00033_A601TAM04_AUTH_LVL ;
   private boolean[] T00033_n601TAM04_AUTH_LVL ;
   private String[] T00033_A18TAM04_DEL_FLG ;
   private boolean[] T00033_n18TAM04_DEL_FLG ;
   private String[] T00033_A40TAM04_CRT_PROG_NM ;
   private boolean[] T00033_n40TAM04_CRT_PROG_NM ;
   private String[] T00033_A42TAM04_UPD_PROG_NM ;
   private boolean[] T00033_n42TAM04_UPD_PROG_NM ;
   private String[] T00036_A17TAM04_AUTH_CD ;
   private String[] T00037_A17TAM04_AUTH_CD ;
   private String[] T00032_A17TAM04_AUTH_CD ;
   private java.util.Date[] T00032_A39TAM04_CRT_DATETIME ;
   private boolean[] T00032_n39TAM04_CRT_DATETIME ;
   private String[] T00032_A78TAM04_CRT_USER_ID ;
   private boolean[] T00032_n78TAM04_CRT_USER_ID ;
   private java.util.Date[] T00032_A41TAM04_UPD_DATETIME ;
   private boolean[] T00032_n41TAM04_UPD_DATETIME ;
   private String[] T00032_A79TAM04_UPD_USER_ID ;
   private boolean[] T00032_n79TAM04_UPD_USER_ID ;
   private long[] T00032_A99TAM04_UPD_CNT ;
   private boolean[] T00032_n99TAM04_UPD_CNT ;
   private String[] T00032_A98TAM04_AUTH_NM ;
   private boolean[] T00032_n98TAM04_AUTH_NM ;
   private byte[] T00032_A601TAM04_AUTH_LVL ;
   private boolean[] T00032_n601TAM04_AUTH_LVL ;
   private String[] T00032_A18TAM04_DEL_FLG ;
   private boolean[] T00032_n18TAM04_DEL_FLG ;
   private String[] T00032_A40TAM04_CRT_PROG_NM ;
   private boolean[] T00032_n40TAM04_CRT_PROG_NM ;
   private String[] T00032_A42TAM04_UPD_PROG_NM ;
   private boolean[] T00032_n42TAM04_UPD_PROG_NM ;
   private String[] T000311_A530TBM07_AUTH_CD ;
   private String[] T000312_A17TAM04_AUTH_CD ;
   private String[] T000312_A88TAM03_APP_ID ;
   private String[] T000313_A8TAM07_USER_ID ;
   private String[] T000314_A17TAM04_AUTH_CD ;
}
...
final  class tam04_kngn__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("T000311", "SELECT `TBM07_AUTH_CD` FROM `TBM07_AUTH_BEHAVIOR` WHERE `TBM07_AUTH_CD` = ?  LIMIT 1",true, GX_NOMASK, false, this,1,0,true )
         ,new ForEachCursor("T000312", "SELECT `TAM04_AUTH_CD`, `TAM03_APP_ID` FROM `TAM05_APPLI_KNGN` WHERE `TAM04_AUTH_CD` = ?  LIMIT 1",true, GX_NOMASK, false, this,1,0,true )
         ,new ForEachCursor("T000313", "SELECT `TAM07_USER_ID` FROM `TAM07_USER` WHERE `TAM07_AUTH_CD` = ?  LIMIT 1",true, GX_NOMASK, false, this,1,0,true )
         ,new ForEachCursor("T000314", "SELECT `TAM04_AUTH_CD` FROM `TAM04_KNGN` ORDER BY `TAM04_AUTH_CD` ",true, GX_NOMASK, false, this,10,0,false )
      };
   }
