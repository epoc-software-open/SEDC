...
public final  class SdtTAM04_KNGN extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void tojson( )
   {
      AddObjectProperty("TAM04_AUTH_CD", gxTv_SdtTAM04_KNGN_Tam04_auth_cd);
      AddObjectProperty("TAM04_AUTH_NM", gxTv_SdtTAM04_KNGN_Tam04_auth_nm);
      AddObjectProperty("TAM04_AUTH_LVL", gxTv_SdtTAM04_KNGN_Tam04_auth_lvl);
      AddObjectProperty("TAM04_DEL_FLG", gxTv_SdtTAM04_KNGN_Tam04_del_flg);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTAM04_KNGN_Tam04_crt_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TAM04_CRT_USER_ID", gxTv_SdtTAM04_KNGN_Tam04_crt_user_id);
      AddObjectProperty("TAM04_CRT_PROG_NM", gxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTAM04_KNGN_Tam04_upd_datetime), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TAM04_UPD_USER_ID", gxTv_SdtTAM04_KNGN_Tam04_upd_user_id);
      AddObjectProperty("TAM04_UPD_PROG_NM", gxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm);
      AddObjectProperty("TAM04_UPD_CNT", gxTv_SdtTAM04_KNGN_Tam04_upd_cnt);
      AddObjectProperty("Mode", gxTv_SdtTAM04_KNGN_Mode);
      AddObjectProperty("Initialized", gxTv_SdtTAM04_KNGN_Initialized);
      AddObjectProperty("TAM04_AUTH_CD_Z", gxTv_SdtTAM04_KNGN_Tam04_auth_cd_Z);
      AddObjectProperty("TAM04_AUTH_NM_Z", gxTv_SdtTAM04_KNGN_Tam04_auth_nm_Z);
      AddObjectProperty("TAM04_AUTH_LVL_Z", gxTv_SdtTAM04_KNGN_Tam04_auth_lvl_Z);
      AddObjectProperty("TAM04_DEL_FLG_Z", gxTv_SdtTAM04_KNGN_Tam04_del_flg_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTAM04_KNGN_Tam04_crt_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TAM04_CRT_USER_ID_Z", gxTv_SdtTAM04_KNGN_Tam04_crt_user_id_Z);
      AddObjectProperty("TAM04_CRT_PROG_NM_Z", gxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm_Z);
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTAM04_KNGN_Tam04_upd_datetime_Z), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TAM04_UPD_USER_ID_Z", gxTv_SdtTAM04_KNGN_Tam04_upd_user_id_Z);
      AddObjectProperty("TAM04_UPD_PROG_NM_Z", gxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm_Z);
      AddObjectProperty("TAM04_UPD_CNT_Z", gxTv_SdtTAM04_KNGN_Tam04_upd_cnt_Z);
      AddObjectProperty("TAM04_AUTH_NM_N", gxTv_SdtTAM04_KNGN_Tam04_auth_nm_N);
      AddObjectProperty("TAM04_AUTH_LVL_N", gxTv_SdtTAM04_KNGN_Tam04_auth_lvl_N);
      AddObjectProperty("TAM04_DEL_FLG_N", gxTv_SdtTAM04_KNGN_Tam04_del_flg_N);
      AddObjectProperty("TAM04_CRT_DATETIME_N", gxTv_SdtTAM04_KNGN_Tam04_crt_datetime_N);
      AddObjectProperty("TAM04_CRT_USER_ID_N", gxTv_SdtTAM04_KNGN_Tam04_crt_user_id_N);
      AddObjectProperty("TAM04_CRT_PROG_NM_N", gxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm_N);
      AddObjectProperty("TAM04_UPD_DATETIME_N", gxTv_SdtTAM04_KNGN_Tam04_upd_datetime_N);
      AddObjectProperty("TAM04_UPD_USER_ID_N", gxTv_SdtTAM04_KNGN_Tam04_upd_user_id_N);
      AddObjectProperty("TAM04_UPD_PROG_NM_N", gxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm_N);
      AddObjectProperty("TAM04_UPD_CNT_N", gxTv_SdtTAM04_KNGN_Tam04_upd_cnt_N);
   }
