/*
       ...
       Generated on: July 15, 2020 13:20:1.32
...
public final  class SdtTBT02_CRF extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( long AV89TBT02_STUDY_ID ,
                     int AV90TBT02_SUBJECT_ID ,
                     short AV91TBT02_CRF_ID ,
                     byte AV935TBT02_CRF_EDA_NO )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {new Long(AV89TBT02_STUDY_ID),new Integer(AV90TBT02_SUBJECT_ID),new Short(AV91TBT02_CRF_ID),new Byte(AV935TBT02_CRF_EDA_NO)});
   }

   public Object[][] GetBCKey( )
   {
      return (Object[][])(new Object[][]{new Object[]{"TBT02_STUDY_ID", long.class}, new Object[]{"TBT02_SUBJECT_ID", int.class}, new Object[]{"TBT02_CRF_ID", short.class}, new Object[]{"TBT02_CRF_EDA_NO", byte.class}}) ;
   }
   ...
   public com.genexus.util.GXProperties getMetadata( )
   {
      ...
      metadata.set("Name", "TBT02_CRF");
      metadata.set("BT", "TBT02_CRF");
      metadata.set("PK", "[ \"TBT02_STUDY_ID\",\"TBT02_SUBJECT_ID\",\"TBT02_CRF_ID\",\"TBT02_CRF_EDA_NO\" ]");
      metadata.set("PKAssigned", "[ \"TBT02_STUDY_ID\",\"TBT02_SUBJECT_ID\" ]");
      metadata.set("FKList", "[ { \"FK\":[ \"TBT01_STUDY_ID\",\"TBT01_SUBJECT_ID\" ],\"FKMap\":[ \"TBT02_STUDY_ID-TBT01_STUDY_ID\",\"TBT02_SUBJECT_ID-TBT01_SUBJECT_ID\" ] } ]");
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            {
               gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            {
               gxTv_SdtTBT02_CRF_Tbt02_signature_flg = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT02_SIGNATURE_DATETIME") )
            {
               if ( ( GXutil.strcmp(oReader.getValue(), "0000-00-00T00:00:00") == 0 ) || ( oReader.existsAttribute("xsi:nil") == 1 ) )
               {
                  gxTv_SdtTBT02_CRF_Tbt02_signature_datetime = GXutil.resetTime( GXutil.nullDate() );
               }
               else
               {
                  gxTv_SdtTBT02_CRF_Tbt02_signature_datetime = localUtil.ymdhmsToT( (short)(GXutil.val( GXutil.substring( oReader.getValue(), 1, 4), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 6, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 9, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 12, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 15, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 18, 2), "."))) ;
               }
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
            ...
            {
               gxTv_SdtTBT02_CRF_Tbt02_signature_user_id = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT02_CRF_EDA_NO_Z") )
            {
               gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT02_SIGNATURE_FLG_Z") )
            {
               gxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT02_SIGNATURE_DATETIME_Z") )
            {
               if ( ( GXutil.strcmp(oReader.getValue(), "0000-00-00T00:00:00") == 0 ) || ( oReader.existsAttribute("xsi:nil") == 1 ) )
               {
                  gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z = GXutil.resetTime( GXutil.nullDate() );
               }
               else
               {
                  gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z = localUtil.ymdhmsToT( (short)(GXutil.val( GXutil.substring( oReader.getValue(), 1, 4), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 6, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 9, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 12, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 15, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 18, 2), "."))) ;
               }
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT02_SIGNATURE_USER_ID_Z") )
            {
               gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT02_SIGNATURE_FLG_N") )
            {
               gxTv_SdtTBT02_CRF_Tbt02_signature_flg_N = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT02_SIGNATURE_DATETIME_N") )
            {
               gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT02_SIGNATURE_USER_ID_N") )
            {
               gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("TBT02_CRF_EDA_NO", GXutil.trim( GXutil.str( gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no, 2, 0)));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      ...
      oWriter.writeElement("TBT02_SIGNATURE_FLG", GXutil.rtrim( gxTv_SdtTBT02_CRF_Tbt02_signature_flg));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      if ( GXutil.nullDate().equals(gxTv_SdtTBT02_CRF_Tbt02_signature_datetime) )
      {
      ...
      {
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.month( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.day( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "T" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.hour( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + ":" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.minute( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + ":" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      ...
      oWriter.writeElement("TBT02_SIGNATURE_USER_ID", GXutil.rtrim( gxTv_SdtTBT02_CRF_Tbt02_signature_user_id));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      ...
      if ( sIncludeState )
      {
         ...
         oWriter.writeElement("TBT02_CRF_EDA_NO_Z", GXutil.trim( GXutil.str( gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z, 2, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         ...
         oWriter.writeElement("TBT02_SIGNATURE_FLG_Z", GXutil.rtrim( gxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         if ( GXutil.nullDate().equals(gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z) )
         {
            oWriter.writeStartElement("TBT02_SIGNATURE_DATETIME_Z");
            oWriter.writeAttribute("xmlns:xsi", "http://www.w3.org/2001/XMLSchema-instance");
            oWriter.writeAttribute("xsi:nil", "true");
            oWriter.writeEndElement();
         }
         ...
         {
            sDateCnv = "" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + "-" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.month( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + "-" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.day( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + "T" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.hour( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + ":" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.minute( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + ":" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            oWriter.writeElement("TBT02_SIGNATURE_DATETIME_Z", sDateCnv);
            if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
            {
               oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
            }
         }
         oWriter.writeElement("TBT02_SIGNATURE_USER_ID_Z", GXutil.rtrim( gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         ...
         oWriter.writeElement("TBT02_SIGNATURE_FLG_N", GXutil.trim( GXutil.str( gxTv_SdtTBT02_CRF_Tbt02_signature_flg_N, 1, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         oWriter.writeElement("TBT02_SIGNATURE_DATETIME_N", GXutil.trim( GXutil.str( gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N, 1, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         oWriter.writeElement("TBT02_SIGNATURE_USER_ID_N", GXutil.trim( GXutil.str( gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N, 1, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
   ...
   {
      AddObjectProperty("TBT02_STUDY_ID", gxTv_SdtTBT02_CRF_Tbt02_study_id, false);
      AddObjectProperty("TBT02_SUBJECT_ID", gxTv_SdtTBT02_CRF_Tbt02_subject_id, false);
      AddObjectProperty("TBT02_CRF_ID", gxTv_SdtTBT02_CRF_Tbt02_crf_id, false);
      AddObjectProperty("TBT02_CRF_EDA_NO", gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no, false);
      AddObjectProperty("TBT02_CRF_LATEST_VERSION", gxTv_SdtTBT02_CRF_Tbt02_crf_latest_version, false);
      AddObjectProperty("TBT02_CRF_INPUT_LEVEL", gxTv_SdtTBT02_CRF_Tbt02_crf_input_level, false);
      AddObjectProperty("TBT02_LOCK_FLG", gxTv_SdtTBT02_CRF_Tbt02_lock_flg, false);
      datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_lock_datetime ;
      sDateCnv = "" ;
      ...
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT02_LOCK_DATETIME", sDateCnv, false);
      AddObjectProperty("TBT02_LOCK_USER_ID", gxTv_SdtTBT02_CRF_Tbt02_lock_user_id, false);
      AddObjectProperty("TBT02_LOCK_AUTH_CD", gxTv_SdtTBT02_CRF_Tbt02_lock_auth_cd, false);
      datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_upload_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBT02_UPLOAD_USER_ID", gxTv_SdtTBT02_CRF_Tbt02_upload_user_id, false);
      AddObjectProperty("TBT02_UPLOAD_AUTH_CD", gxTv_SdtTBT02_CRF_Tbt02_upload_auth_cd, false);
      AddObjectProperty("TBT02_DM_ARRIVAL_FLG", gxTv_SdtTBT02_CRF_Tbt02_dm_arrival_flg, false);
      datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_dm_arrival_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBT02_APPROVAL_FLG", gxTv_SdtTBT02_CRF_Tbt02_approval_flg, false);
      datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_approval_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT02_APPROVAL_DATETIME", sDateCnv, false);
      AddObjectProperty("TBT02_APPROVAL_USER_ID", gxTv_SdtTBT02_CRF_Tbt02_approval_user_id, false);
      AddObjectProperty("TBT02_APPROVAL_AUTH_CD", gxTv_SdtTBT02_CRF_Tbt02_approval_auth_cd, false);
      AddObjectProperty("TBT02_SIGNATURE_FLG", gxTv_SdtTBT02_CRF_Tbt02_signature_flg, false);
      datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_signature_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBT02_SIGNATURE_USER_ID", gxTv_SdtTBT02_CRF_Tbt02_signature_user_id, false);
      AddObjectProperty("TBT02_INPUT_END_FLG", gxTv_SdtTBT02_CRF_Tbt02_input_end_flg, false);
      datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_input_end_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT02_INPUT_END_DATETIME", sDateCnv, false);
      AddObjectProperty("TBT02_INPUT_END_USER_ID", gxTv_SdtTBT02_CRF_Tbt02_input_end_user_id, false);
      AddObjectProperty("TBT02_INPUT_END_AUTH_CD", gxTv_SdtTBT02_CRF_Tbt02_input_end_auth_cd, false);
      AddObjectProperty("TBT02_DEL_FLG", gxTv_SdtTBT02_CRF_Tbt02_del_flg, false);
      datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_crt_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBT02_CRT_DATETIME", sDateCnv, false);
      AddObjectProperty("TBT02_CRT_USER_ID", gxTv_SdtTBT02_CRF_Tbt02_crt_user_id, false);
      AddObjectProperty("TBT02_CRT_PROG_NM", gxTv_SdtTBT02_CRF_Tbt02_crt_prog_nm, false);
      datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_upd_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBT02_UPD_USER_ID", gxTv_SdtTBT02_CRF_Tbt02_upd_user_id, false);
      AddObjectProperty("TBT02_UPD_PROG_NM", gxTv_SdtTBT02_CRF_Tbt02_upd_prog_nm, false);
      AddObjectProperty("TBT02_UPD_CNT", gxTv_SdtTBT02_CRF_Tbt02_upd_cnt, false);
      if ( includeState )
      {
         AddObjectProperty("Mode", gxTv_SdtTBT02_CRF_Mode, false);
         AddObjectProperty("Initialized", gxTv_SdtTBT02_CRF_Initialized, false);
         AddObjectProperty("TBT02_STUDY_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_study_id_Z, false);
         AddObjectProperty("TBT02_SUBJECT_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_subject_id_Z, false);
         AddObjectProperty("TBT02_CRF_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_crf_id_Z, false);
         AddObjectProperty("TBT02_CRF_EDA_NO_Z", gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z, false);
         AddObjectProperty("TBT02_CRF_LATEST_VERSION_Z", gxTv_SdtTBT02_CRF_Tbt02_crf_latest_version_Z, false);
         AddObjectProperty("TBT02_CRF_INPUT_LEVEL_Z", gxTv_SdtTBT02_CRF_Tbt02_crf_input_level_Z, false);
         AddObjectProperty("TBT02_LOCK_FLG_Z", gxTv_SdtTBT02_CRF_Tbt02_lock_flg_Z, false);
         datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_lock_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBT02_LOCK_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBT02_LOCK_USER_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_lock_user_id_Z, false);
         AddObjectProperty("TBT02_LOCK_AUTH_CD_Z", gxTv_SdtTBT02_CRF_Tbt02_lock_auth_cd_Z, false);
         datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_upload_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBT02_UPLOAD_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBT02_UPLOAD_USER_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_upload_user_id_Z, false);
         AddObjectProperty("TBT02_UPLOAD_AUTH_CD_Z", gxTv_SdtTBT02_CRF_Tbt02_upload_auth_cd_Z, false);
         AddObjectProperty("TBT02_DM_ARRIVAL_FLG_Z", gxTv_SdtTBT02_CRF_Tbt02_dm_arrival_flg_Z, false);
         datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_dm_arrival_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBT02_DM_ARRIVAL_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBT02_APPROVAL_FLG_Z", gxTv_SdtTBT02_CRF_Tbt02_approval_flg_Z, false);
         datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_approval_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBT02_APPROVAL_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBT02_APPROVAL_USER_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_approval_user_id_Z, false);
         AddObjectProperty("TBT02_APPROVAL_AUTH_CD_Z", gxTv_SdtTBT02_CRF_Tbt02_approval_auth_cd_Z, false);
         AddObjectProperty("TBT02_SIGNATURE_FLG_Z", gxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z, false);
         datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBT02_SIGNATURE_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBT02_SIGNATURE_USER_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z, false);
         AddObjectProperty("TBT02_INPUT_END_FLG_Z", gxTv_SdtTBT02_CRF_Tbt02_input_end_flg_Z, false);
         datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_input_end_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBT02_INPUT_END_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBT02_INPUT_END_USER_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_input_end_user_id_Z, false);
         AddObjectProperty("TBT02_INPUT_END_AUTH_CD_Z", gxTv_SdtTBT02_CRF_Tbt02_input_end_auth_cd_Z, false);
         AddObjectProperty("TBT02_DEL_FLG_Z", gxTv_SdtTBT02_CRF_Tbt02_del_flg_Z, false);
         datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_crt_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBT02_CRT_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBT02_CRT_USER_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_crt_user_id_Z, false);
         AddObjectProperty("TBT02_CRT_PROG_NM_Z", gxTv_SdtTBT02_CRF_Tbt02_crt_prog_nm_Z, false);
         datetime_STZ = gxTv_SdtTBT02_CRF_Tbt02_upd_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBT02_UPD_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBT02_UPD_USER_ID_Z", gxTv_SdtTBT02_CRF_Tbt02_upd_user_id_Z, false);
         AddObjectProperty("TBT02_UPD_PROG_NM_Z", gxTv_SdtTBT02_CRF_Tbt02_upd_prog_nm_Z, false);
         AddObjectProperty("TBT02_UPD_CNT_Z", gxTv_SdtTBT02_CRF_Tbt02_upd_cnt_Z, false);
         AddObjectProperty("TBT02_CRF_LATEST_VERSION_N", gxTv_SdtTBT02_CRF_Tbt02_crf_latest_version_N, false);
         AddObjectProperty("TBT02_CRF_INPUT_LEVEL_N", gxTv_SdtTBT02_CRF_Tbt02_crf_input_level_N, false);
         AddObjectProperty("TBT02_LOCK_FLG_N", gxTv_SdtTBT02_CRF_Tbt02_lock_flg_N, false);
         AddObjectProperty("TBT02_LOCK_DATETIME_N", gxTv_SdtTBT02_CRF_Tbt02_lock_datetime_N, false);
         AddObjectProperty("TBT02_LOCK_USER_ID_N", gxTv_SdtTBT02_CRF_Tbt02_lock_user_id_N, false);
         AddObjectProperty("TBT02_LOCK_AUTH_CD_N", gxTv_SdtTBT02_CRF_Tbt02_lock_auth_cd_N, false);
         AddObjectProperty("TBT02_UPLOAD_DATETIME_N", gxTv_SdtTBT02_CRF_Tbt02_upload_datetime_N, false);
         AddObjectProperty("TBT02_UPLOAD_USER_ID_N", gxTv_SdtTBT02_CRF_Tbt02_upload_user_id_N, false);
         AddObjectProperty("TBT02_UPLOAD_AUTH_CD_N", gxTv_SdtTBT02_CRF_Tbt02_upload_auth_cd_N, false);
         AddObjectProperty("TBT02_DM_ARRIVAL_FLG_N", gxTv_SdtTBT02_CRF_Tbt02_dm_arrival_flg_N, false);
         AddObjectProperty("TBT02_DM_ARRIVAL_DATETIME_N", gxTv_SdtTBT02_CRF_Tbt02_dm_arrival_datetime_N, false);
         AddObjectProperty("TBT02_APPROVAL_FLG_N", gxTv_SdtTBT02_CRF_Tbt02_approval_flg_N, false);
         AddObjectProperty("TBT02_APPROVAL_DATETIME_N", gxTv_SdtTBT02_CRF_Tbt02_approval_datetime_N, false);
         AddObjectProperty("TBT02_APPROVAL_USER_ID_N", gxTv_SdtTBT02_CRF_Tbt02_approval_user_id_N, false);
         AddObjectProperty("TBT02_APPROVAL_AUTH_CD_N", gxTv_SdtTBT02_CRF_Tbt02_approval_auth_cd_N, false);
         AddObjectProperty("TBT02_SIGNATURE_FLG_N", gxTv_SdtTBT02_CRF_Tbt02_signature_flg_N, false);
         AddObjectProperty("TBT02_SIGNATURE_DATETIME_N", gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N, false);
         AddObjectProperty("TBT02_SIGNATURE_USER_ID_N", gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N, false);
         AddObjectProperty("TBT02_INPUT_END_FLG_N", gxTv_SdtTBT02_CRF_Tbt02_input_end_flg_N, false);
         AddObjectProperty("TBT02_INPUT_END_DATETIME_N", gxTv_SdtTBT02_CRF_Tbt02_input_end_datetime_N, false);
         AddObjectProperty("TBT02_INPUT_END_USER_ID_N", gxTv_SdtTBT02_CRF_Tbt02_input_end_user_id_N, false);
         AddObjectProperty("TBT02_INPUT_END_AUTH_CD_N", gxTv_SdtTBT02_CRF_Tbt02_input_end_auth_cd_N, false);
         AddObjectProperty("TBT02_DEL_FLG_N", gxTv_SdtTBT02_CRF_Tbt02_del_flg_N, false);
         AddObjectProperty("TBT02_CRT_DATETIME_N", gxTv_SdtTBT02_CRF_Tbt02_crt_datetime_N, false);
         AddObjectProperty("TBT02_CRT_USER_ID_N", gxTv_SdtTBT02_CRF_Tbt02_crt_user_id_N, false);
         AddObjectProperty("TBT02_CRT_PROG_NM_N", gxTv_SdtTBT02_CRF_Tbt02_crt_prog_nm_N, false);
         AddObjectProperty("TBT02_UPD_DATETIME_N", gxTv_SdtTBT02_CRF_Tbt02_upd_datetime_N, false);
         AddObjectProperty("TBT02_UPD_USER_ID_N", gxTv_SdtTBT02_CRF_Tbt02_upd_user_id_N, false);
         AddObjectProperty("TBT02_UPD_PROG_NM_N", gxTv_SdtTBT02_CRF_Tbt02_upd_prog_nm_N, false);
         AddObjectProperty("TBT02_UPD_CNT_N", gxTv_SdtTBT02_CRF_Tbt02_upd_cnt_N, false);
      }
   }
   ...
   public void setgxTv_SdtTBT02_CRF_Tbt02_study_id( long value )
   {
      if ( gxTv_SdtTBT02_CRF_Tbt02_study_id != value )
      {
         ...
         this.setgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z_SetNull( );
         ...
         this.setgxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z_SetNull( );
         this.setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z_SetNull( );
         this.setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z_SetNull( );
   ...
   public byte getgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no( byte value )
   {
      if ( gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no != value )
      {
         gxTv_SdtTBT02_CRF_Mode = "INS" ;
         this.setgxTv_SdtTBT02_CRF_Tbt02_study_id_Z_SetNull( );
         this.setgxTv_SdtTBT02_CRF_Tbt02_subject_id_Z_SetNull( );
   ...
   public String getgxTv_SdtTBT02_CRF_Tbt02_signature_flg( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_signature_flg ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_flg( String value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_flg_N = (byte)(0) ;
      gxTv_SdtTBT02_CRF_Tbt02_signature_flg = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_flg_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_flg_N = (byte)(1) ;
      gxTv_SdtTBT02_CRF_Tbt02_signature_flg = "" ;
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_signature_flg_IsNull( )
   {
      return false ;
   }

   public java.util.Date getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_signature_datetime ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime( java.util.Date value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N = (byte)(0) ;
      gxTv_SdtTBT02_CRF_Tbt02_signature_datetime = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N = (byte)(1) ;
      gxTv_SdtTBT02_CRF_Tbt02_signature_datetime = GXutil.resetTime( GXutil.nullDate() );
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_IsNull( )
   {
      return false ;
   }

   public String getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_signature_user_id ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id( String value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N = (byte)(0) ;
      gxTv_SdtTBT02_CRF_Tbt02_signature_user_id = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N = (byte)(1) ;
      gxTv_SdtTBT02_CRF_Tbt02_signature_user_id = "" ;
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_IsNull( )
   {
      return false ;
   }
   ...
   public byte getgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z( byte value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z = (byte)(0) ;
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z_IsNull( )
   {
      return false ;
   }
   ...
   public String getgxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z( String value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z = "" ;
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z_IsNull( )
   {
      return false ;
   }

   public java.util.Date getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z( java.util.Date value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z = GXutil.resetTime( GXutil.nullDate() );
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z_IsNull( )
   {
      return false ;
   }

   public String getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z( String value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z = "" ;
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z_IsNull( )
   {
      return false ;
   }
   ...
   public byte getgxTv_SdtTBT02_CRF_Tbt02_signature_flg_N( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_signature_flg_N ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_flg_N( byte value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_flg_N = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_flg_N_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_flg_N = (byte)(0) ;
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_signature_flg_N_IsNull( )
   {
      return false ;
   }

   public byte getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N( byte value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N = (byte)(0) ;
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N_IsNull( )
   {
      return false ;
   }

   public byte getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N( )
   {
      return gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N( byte value )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N = value ;
   }

   public void setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N_SetNull( )
   {
      gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N = (byte)(0) ;
   }

   public boolean getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N_IsNull( )
   {
      return false ;
   }
   ...
   public void setStruct( StructSdtTBT02_CRF struct )
   {
      ...
      setgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no(struct.getTbt02_crf_eda_no());
      ...
      setgxTv_SdtTBT02_CRF_Tbt02_signature_flg(struct.getTbt02_signature_flg());
      setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime(struct.getTbt02_signature_datetime());
      setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id(struct.getTbt02_signature_user_id());
      ...
      setgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z(struct.getTbt02_crf_eda_no_Z());
      ...
      setgxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z(struct.getTbt02_signature_flg_Z());
      setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z(struct.getTbt02_signature_datetime_Z());
      setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z(struct.getTbt02_signature_user_id_Z());
      ...
      setgxTv_SdtTBT02_CRF_Tbt02_signature_flg_N(struct.getTbt02_signature_flg_N());
      setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N(struct.getTbt02_signature_datetime_N());
      setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N(struct.getTbt02_signature_user_id_N());
   ...
   public StructSdtTBT02_CRF getStruct( )
   {
      ...
      struct.setTbt02_crf_eda_no(getgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no());
      ...
      struct.setTbt02_signature_flg(getgxTv_SdtTBT02_CRF_Tbt02_signature_flg());
      struct.setTbt02_signature_datetime(getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime());
      struct.setTbt02_signature_user_id(getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id());
      ...
      struct.setTbt02_crf_eda_no_Z(getgxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z());
      ...
      struct.setTbt02_signature_flg_Z(getgxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z());
      struct.setTbt02_signature_datetime_Z(getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z());
      struct.setTbt02_signature_user_id_Z(getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z());
      ...
      struct.setTbt02_signature_flg_N(getgxTv_SdtTBT02_CRF_Tbt02_signature_flg_N());
      struct.setTbt02_signature_datetime_N(getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N());
      struct.setTbt02_signature_user_id_N(getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N());
   ...
   private byte gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no ;
   private byte gxTv_SdtTBT02_CRF_Tbt02_crf_input_level ;
   private byte gxTv_SdtTBT02_CRF_Tbt02_crf_eda_no_Z ;
   ...
   private byte gxTv_SdtTBT02_CRF_Tbt02_signature_flg_N ;
   private byte gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_N ;
   private byte gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_N ;
   ...
   private java.util.Date gxTv_SdtTBT02_CRF_Tbt02_signature_datetime ;
   ...
   private java.util.Date gxTv_SdtTBT02_CRF_Tbt02_signature_datetime_Z ;
   ...
   private String gxTv_SdtTBT02_CRF_Tbt02_signature_flg ;
   private String gxTv_SdtTBT02_CRF_Tbt02_signature_user_id ;
   ...
   private String gxTv_SdtTBT02_CRF_Tbt02_signature_flg_Z ;
   private String gxTv_SdtTBT02_CRF_Tbt02_signature_user_id_Z ;
