/*
       ...
       Generated on: July 15, 2020 13:31:41.96
...
public final  class SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            {
               gxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Order = (int)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("ORDER", GXutil.trim( GXutil.str( gxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Order, 5, 0)));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
   ...
   public void tojson( boolean includeState )
   {
      ...
      AddObjectProperty("ORDER", gxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Order, false);
   }
   ...
   public int getgxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Order( )
   {
      return gxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Order ;
   }

   public void setgxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Order( int value )
   {
   ...
   public void setStruct( StructSdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem struct )
   {
      ...
      setgxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Order(struct.getOrder());
   }
   ...
   public StructSdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem getStruct( )
   {
      ...
      struct.setOrder(getgxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Order());
      return struct ;
   }
