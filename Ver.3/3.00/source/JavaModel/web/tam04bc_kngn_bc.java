/*
       ...
       Generated on: July 15, 2020 13:18:53.48
...
public final  class tam04bc_kngn_bc extends GXWebPanel implements IGxSilentTrn
{
   ...
   public void getByPrimaryKey( )
   {
      ...
      if ( (pr_default.getStatus(4) != 101) )
      {
         zm0C3( 15) ;
         RcdFound3 = (short)(1) ;
         A13TAM04_AUTH_CD = BC000C6_A13TAM04_AUTH_CD[0] ;
         A233TAM04_CRT_DATETIME = BC000C6_A233TAM04_CRT_DATETIME[0] ;
         n233TAM04_CRT_DATETIME = BC000C6_n233TAM04_CRT_DATETIME[0] ;
         A266TAM04_CRT_USER_ID = BC000C6_A266TAM04_CRT_USER_ID[0] ;
         n266TAM04_CRT_USER_ID = BC000C6_n266TAM04_CRT_USER_ID[0] ;
         A235TAM04_UPD_DATETIME = BC000C6_A235TAM04_UPD_DATETIME[0] ;
         n235TAM04_UPD_DATETIME = BC000C6_n235TAM04_UPD_DATETIME[0] ;
         A267TAM04_UPD_USER_ID = BC000C6_A267TAM04_UPD_USER_ID[0] ;
         n267TAM04_UPD_USER_ID = BC000C6_n267TAM04_UPD_USER_ID[0] ;
         A286TAM04_UPD_CNT = BC000C6_A286TAM04_UPD_CNT[0] ;
         n286TAM04_UPD_CNT = BC000C6_n286TAM04_UPD_CNT[0] ;
         A285TAM04_AUTH_NM = BC000C6_A285TAM04_AUTH_NM[0] ;
         n285TAM04_AUTH_NM = BC000C6_n285TAM04_AUTH_NM[0] ;
         A687TAM04_AUTH_LVL = BC000C6_A687TAM04_AUTH_LVL[0] ;
         n687TAM04_AUTH_LVL = BC000C6_n687TAM04_AUTH_LVL[0] ;
         A215TAM04_DEL_FLG = BC000C6_A215TAM04_DEL_FLG[0] ;
         n215TAM04_DEL_FLG = BC000C6_n215TAM04_DEL_FLG[0] ;
         A234TAM04_CRT_PROG_NM = BC000C6_A234TAM04_CRT_PROG_NM[0] ;
         n234TAM04_CRT_PROG_NM = BC000C6_n234TAM04_CRT_PROG_NM[0] ;
         A236TAM04_UPD_PROG_NM = BC000C6_A236TAM04_UPD_PROG_NM[0] ;
         n236TAM04_UPD_PROG_NM = BC000C6_n236TAM04_UPD_PROG_NM[0] ;
   ...
   public void checkOptimisticConcurrency0C3( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         ...
         Gx_longc = false ;
         if ( (pr_default.getStatus(3) == 101) || !( Z233TAM04_CRT_DATETIME.equals( BC000C5_A233TAM04_CRT_DATETIME[0] ) ) || ( GXutil.strcmp(Z266TAM04_CRT_USER_ID, BC000C5_A266TAM04_CRT_USER_ID[0]) != 0 ) || !( Z235TAM04_UPD_DATETIME.equals( BC000C5_A235TAM04_UPD_DATETIME[0] ) ) || ( GXutil.strcmp(Z267TAM04_UPD_USER_ID, BC000C5_A267TAM04_UPD_USER_ID[0]) != 0 ) || ( Z286TAM04_UPD_CNT != BC000C5_A286TAM04_UPD_CNT[0] ) )
         {
            Gx_longc = true ;
         }
         if ( Gx_longc || ( GXutil.strcmp(Z285TAM04_AUTH_NM, BC000C5_A285TAM04_AUTH_NM[0]) != 0 ) || ( Z687TAM04_AUTH_LVL != BC000C5_A687TAM04_AUTH_LVL[0] ) || ( GXutil.strcmp(Z215TAM04_DEL_FLG, BC000C5_A215TAM04_DEL_FLG[0]) != 0 ) || ( GXutil.strcmp(Z234TAM04_CRT_PROG_NM, BC000C5_A234TAM04_CRT_PROG_NM[0]) != 0 ) || ( GXutil.strcmp(Z236TAM04_UPD_PROG_NM, BC000C5_A236TAM04_UPD_PROG_NM[0]) != 0 ) )
         {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(8, new Object[] {new Boolean(n233TAM04_CRT_DATETIME), A233TAM04_CRT_DATETIME, new Boolean(n266TAM04_CRT_USER_ID), A266TAM04_CRT_USER_ID, new Boolean(n235TAM04_UPD_DATETIME), A235TAM04_UPD_DATETIME, new Boolean(n267TAM04_UPD_USER_ID), A267TAM04_UPD_USER_ID, new Boolean(n286TAM04_UPD_CNT), new Long(A286TAM04_UPD_CNT), new Boolean(n285TAM04_AUTH_NM), A285TAM04_AUTH_NM, new Boolean(n687TAM04_AUTH_LVL), new Byte(A687TAM04_AUTH_LVL), new Boolean(n215TAM04_DEL_FLG), A215TAM04_DEL_FLG, new Boolean(n234TAM04_CRT_PROG_NM), A234TAM04_CRT_PROG_NM, new Boolean(n236TAM04_UPD_PROG_NM), A236TAM04_UPD_PROG_NM, A13TAM04_AUTH_CD});
                  Application.getSmartCacheProvider(remoteHandle).setUpdated("TAM04_KNGN") ;
   ...
   public void scanKeyStart0C3( )
   {
      ...
      {
         RcdFound3 = (short)(1) ;
         A13TAM04_AUTH_CD = BC000C14_A13TAM04_AUTH_CD[0] ;
         A233TAM04_CRT_DATETIME = BC000C14_A233TAM04_CRT_DATETIME[0] ;
         n233TAM04_CRT_DATETIME = BC000C14_n233TAM04_CRT_DATETIME[0] ;
         A266TAM04_CRT_USER_ID = BC000C14_A266TAM04_CRT_USER_ID[0] ;
         n266TAM04_CRT_USER_ID = BC000C14_n266TAM04_CRT_USER_ID[0] ;
         A235TAM04_UPD_DATETIME = BC000C14_A235TAM04_UPD_DATETIME[0] ;
         n235TAM04_UPD_DATETIME = BC000C14_n235TAM04_UPD_DATETIME[0] ;
         A267TAM04_UPD_USER_ID = BC000C14_A267TAM04_UPD_USER_ID[0] ;
         n267TAM04_UPD_USER_ID = BC000C14_n267TAM04_UPD_USER_ID[0] ;
         A286TAM04_UPD_CNT = BC000C14_A286TAM04_UPD_CNT[0] ;
         n286TAM04_UPD_CNT = BC000C14_n286TAM04_UPD_CNT[0] ;
         A285TAM04_AUTH_NM = BC000C14_A285TAM04_AUTH_NM[0] ;
         n285TAM04_AUTH_NM = BC000C14_n285TAM04_AUTH_NM[0] ;
         A687TAM04_AUTH_LVL = BC000C14_A687TAM04_AUTH_LVL[0] ;
         n687TAM04_AUTH_LVL = BC000C14_n687TAM04_AUTH_LVL[0] ;
         A215TAM04_DEL_FLG = BC000C14_A215TAM04_DEL_FLG[0] ;
         n215TAM04_DEL_FLG = BC000C14_n215TAM04_DEL_FLG[0] ;
         A234TAM04_CRT_PROG_NM = BC000C14_A234TAM04_CRT_PROG_NM[0] ;
         n234TAM04_CRT_PROG_NM = BC000C14_n234TAM04_CRT_PROG_NM[0] ;
         A236TAM04_UPD_PROG_NM = BC000C14_A236TAM04_UPD_PROG_NM[0] ;
         n236TAM04_UPD_PROG_NM = BC000C14_n236TAM04_UPD_PROG_NM[0] ;
      }
   ...
   public void load0C9( )
   {
      ...
      pr_default.execute(13, new Object[] {A13TAM04_AUTH_CD, A12TAM03_APP_ID});
      if ( (pr_default.getStatus(13) != 101) )
      {
         RcdFound9 = (short)(1) ;
         A290TAM05_CRT_DATETIME = BC000C15_A290TAM05_CRT_DATETIME[0] ;
         n290TAM05_CRT_DATETIME = BC000C15_n290TAM05_CRT_DATETIME[0] ;
         A291TAM05_CRT_USER_ID = BC000C15_A291TAM05_CRT_USER_ID[0] ;
         n291TAM05_CRT_USER_ID = BC000C15_n291TAM05_CRT_USER_ID[0] ;
         A293TAM05_UPD_DATETIME = BC000C15_A293TAM05_UPD_DATETIME[0] ;
         n293TAM05_UPD_DATETIME = BC000C15_n293TAM05_UPD_DATETIME[0] ;
         A294TAM05_UPD_USER_ID = BC000C15_A294TAM05_UPD_USER_ID[0] ;
         n294TAM05_UPD_USER_ID = BC000C15_n294TAM05_UPD_USER_ID[0] ;
         A296TAM05_UPD_CNT = BC000C15_A296TAM05_UPD_CNT[0] ;
         n296TAM05_UPD_CNT = BC000C15_n296TAM05_UPD_CNT[0] ;
         A288TAM05_KNGN_FLG = BC000C15_A288TAM05_KNGN_FLG[0] ;
         n288TAM05_KNGN_FLG = BC000C15_n288TAM05_KNGN_FLG[0] ;
         A289TAM05_DEL_FLG = BC000C15_A289TAM05_DEL_FLG[0] ;
         n289TAM05_DEL_FLG = BC000C15_n289TAM05_DEL_FLG[0] ;
         A292TAM05_CRT_PROG_NM = BC000C15_A292TAM05_CRT_PROG_NM[0] ;
         n292TAM05_CRT_PROG_NM = BC000C15_n292TAM05_CRT_PROG_NM[0] ;
         A295TAM05_UPD_PROG_NM = BC000C15_A295TAM05_UPD_PROG_NM[0] ;
         n295TAM05_UPD_PROG_NM = BC000C15_n295TAM05_UPD_PROG_NM[0] ;
         zm0C9( -16) ;
      }
      pr_default.close(13);
      onLoadActions0C9( ) ;
   ...
   public void getKey0C9( )
   {
      ...
      pr_default.execute(14, new Object[] {A13TAM04_AUTH_CD, A12TAM03_APP_ID});
   ...
   public void getByPrimaryKey0C9( )
   {
      ...
      if ( (pr_default.getStatus(1) != 101) )
      {
         ...
         RcdFound9 = (short)(1) ;
         initializeNonKey0C9( ) ;
         A290TAM05_CRT_DATETIME = BC000C3_A290TAM05_CRT_DATETIME[0] ;
         n290TAM05_CRT_DATETIME = BC000C3_n290TAM05_CRT_DATETIME[0] ;
         A291TAM05_CRT_USER_ID = BC000C3_A291TAM05_CRT_USER_ID[0] ;
         n291TAM05_CRT_USER_ID = BC000C3_n291TAM05_CRT_USER_ID[0] ;
         A293TAM05_UPD_DATETIME = BC000C3_A293TAM05_UPD_DATETIME[0] ;
         n293TAM05_UPD_DATETIME = BC000C3_n293TAM05_UPD_DATETIME[0] ;
         A294TAM05_UPD_USER_ID = BC000C3_A294TAM05_UPD_USER_ID[0] ;
         n294TAM05_UPD_USER_ID = BC000C3_n294TAM05_UPD_USER_ID[0] ;
         A296TAM05_UPD_CNT = BC000C3_A296TAM05_UPD_CNT[0] ;
         n296TAM05_UPD_CNT = BC000C3_n296TAM05_UPD_CNT[0] ;
         A288TAM05_KNGN_FLG = BC000C3_A288TAM05_KNGN_FLG[0] ;
         n288TAM05_KNGN_FLG = BC000C3_n288TAM05_KNGN_FLG[0] ;
         A289TAM05_DEL_FLG = BC000C3_A289TAM05_DEL_FLG[0] ;
         n289TAM05_DEL_FLG = BC000C3_n289TAM05_DEL_FLG[0] ;
         A292TAM05_CRT_PROG_NM = BC000C3_A292TAM05_CRT_PROG_NM[0] ;
         n292TAM05_CRT_PROG_NM = BC000C3_n292TAM05_CRT_PROG_NM[0] ;
         A295TAM05_UPD_PROG_NM = BC000C3_A295TAM05_UPD_PROG_NM[0] ;
         n295TAM05_UPD_PROG_NM = BC000C3_n295TAM05_UPD_PROG_NM[0] ;
         A12TAM03_APP_ID = BC000C3_A12TAM03_APP_ID[0] ;
   ...
   public void checkOptimisticConcurrency0C9( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         ...
         Gx_longc = false ;
         if ( (pr_default.getStatus(0) == 101) || !( Z290TAM05_CRT_DATETIME.equals( BC000C2_A290TAM05_CRT_DATETIME[0] ) ) || ( GXutil.strcmp(Z291TAM05_CRT_USER_ID, BC000C2_A291TAM05_CRT_USER_ID[0]) != 0 ) || !( Z293TAM05_UPD_DATETIME.equals( BC000C2_A293TAM05_UPD_DATETIME[0] ) ) || ( GXutil.strcmp(Z294TAM05_UPD_USER_ID, BC000C2_A294TAM05_UPD_USER_ID[0]) != 0 ) || ( Z296TAM05_UPD_CNT != BC000C2_A296TAM05_UPD_CNT[0] ) )
         {
            Gx_longc = true ;
         }
         if ( Gx_longc || ( GXutil.strcmp(Z288TAM05_KNGN_FLG, BC000C2_A288TAM05_KNGN_FLG[0]) != 0 ) || ( GXutil.strcmp(Z289TAM05_DEL_FLG, BC000C2_A289TAM05_DEL_FLG[0]) != 0 ) || ( GXutil.strcmp(Z292TAM05_CRT_PROG_NM, BC000C2_A292TAM05_CRT_PROG_NM[0]) != 0 ) || ( GXutil.strcmp(Z295TAM05_UPD_PROG_NM, BC000C2_A295TAM05_UPD_PROG_NM[0]) != 0 ) )
         {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(15, new Object[] {A13TAM04_AUTH_CD, new Boolean(n290TAM05_CRT_DATETIME), A290TAM05_CRT_DATETIME, new Boolean(n291TAM05_CRT_USER_ID), A291TAM05_CRT_USER_ID, new Boolean(n293TAM05_UPD_DATETIME), A293TAM05_UPD_DATETIME, new Boolean(n294TAM05_UPD_USER_ID), A294TAM05_UPD_USER_ID, new Boolean(n296TAM05_UPD_CNT), new Long(A296TAM05_UPD_CNT), new Boolean(n288TAM05_KNGN_FLG), A288TAM05_KNGN_FLG, new Boolean(n289TAM05_DEL_FLG), A289TAM05_DEL_FLG, new Boolean(n292TAM05_CRT_PROG_NM), A292TAM05_CRT_PROG_NM, new Boolean(n295TAM05_UPD_PROG_NM), A295TAM05_UPD_PROG_NM, A12TAM03_APP_ID});
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(16, new Object[] {new Boolean(n290TAM05_CRT_DATETIME), A290TAM05_CRT_DATETIME, new Boolean(n291TAM05_CRT_USER_ID), A291TAM05_CRT_USER_ID, new Boolean(n293TAM05_UPD_DATETIME), A293TAM05_UPD_DATETIME, new Boolean(n294TAM05_UPD_USER_ID), A294TAM05_UPD_USER_ID, new Boolean(n296TAM05_UPD_CNT), new Long(A296TAM05_UPD_CNT), new Boolean(n288TAM05_KNGN_FLG), A288TAM05_KNGN_FLG, new Boolean(n289TAM05_DEL_FLG), A289TAM05_DEL_FLG, new Boolean(n292TAM05_CRT_PROG_NM), A292TAM05_CRT_PROG_NM, new Boolean(n295TAM05_UPD_PROG_NM), A295TAM05_UPD_PROG_NM, A13TAM04_AUTH_CD, A12TAM03_APP_ID});
                  Application.getSmartCacheProvider(remoteHandle).setUpdated("TAM05_APPLI_KNGN") ;
   ...
   public void scanKeyStart0C9( )
   {
      ...
      pr_default.execute(18, new Object[] {A13TAM04_AUTH_CD});
      RcdFound9 = (short)(0) ;
   ...
   public void initialize( )
   {
      ...
      BC000C6_A13TAM04_AUTH_CD = new String[] {""} ;
      BC000C6_A233TAM04_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C6_n233TAM04_CRT_DATETIME = new boolean[] {false} ;
      BC000C6_A266TAM04_CRT_USER_ID = new String[] {""} ;
      BC000C6_n266TAM04_CRT_USER_ID = new boolean[] {false} ;
      BC000C6_A235TAM04_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C6_n235TAM04_UPD_DATETIME = new boolean[] {false} ;
      BC000C6_A267TAM04_UPD_USER_ID = new String[] {""} ;
      BC000C6_n267TAM04_UPD_USER_ID = new boolean[] {false} ;
      BC000C6_A286TAM04_UPD_CNT = new long[1] ;
      BC000C6_n286TAM04_UPD_CNT = new boolean[] {false} ;
      BC000C6_A285TAM04_AUTH_NM = new String[] {""} ;
      BC000C6_n285TAM04_AUTH_NM = new boolean[] {false} ;
      BC000C6_A687TAM04_AUTH_LVL = new byte[1] ;
      BC000C6_n687TAM04_AUTH_LVL = new boolean[] {false} ;
      BC000C6_A215TAM04_DEL_FLG = new String[] {""} ;
      BC000C6_n215TAM04_DEL_FLG = new boolean[] {false} ;
      BC000C6_A234TAM04_CRT_PROG_NM = new String[] {""} ;
      BC000C6_n234TAM04_CRT_PROG_NM = new boolean[] {false} ;
      BC000C6_A236TAM04_UPD_PROG_NM = new String[] {""} ;
      BC000C6_n236TAM04_UPD_PROG_NM = new boolean[] {false} ;
      BC000C5_A13TAM04_AUTH_CD = new String[] {""} ;
      BC000C5_A233TAM04_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C5_n233TAM04_CRT_DATETIME = new boolean[] {false} ;
      BC000C5_A266TAM04_CRT_USER_ID = new String[] {""} ;
      BC000C5_n266TAM04_CRT_USER_ID = new boolean[] {false} ;
      BC000C5_A235TAM04_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C5_n235TAM04_UPD_DATETIME = new boolean[] {false} ;
      BC000C5_A267TAM04_UPD_USER_ID = new String[] {""} ;
      BC000C5_n267TAM04_UPD_USER_ID = new boolean[] {false} ;
      BC000C5_A286TAM04_UPD_CNT = new long[1] ;
      BC000C5_n286TAM04_UPD_CNT = new boolean[] {false} ;
      BC000C5_A285TAM04_AUTH_NM = new String[] {""} ;
      BC000C5_n285TAM04_AUTH_NM = new boolean[] {false} ;
      BC000C5_A687TAM04_AUTH_LVL = new byte[1] ;
      BC000C5_n687TAM04_AUTH_LVL = new boolean[] {false} ;
      BC000C5_A215TAM04_DEL_FLG = new String[] {""} ;
      BC000C5_n215TAM04_DEL_FLG = new boolean[] {false} ;
      BC000C5_A234TAM04_CRT_PROG_NM = new String[] {""} ;
      BC000C5_n234TAM04_CRT_PROG_NM = new boolean[] {false} ;
      BC000C5_A236TAM04_UPD_PROG_NM = new String[] {""} ;
      BC000C5_n236TAM04_UPD_PROG_NM = new boolean[] {false} ;
      BC000C12_A55TAM07_USER_ID = new String[] {""} ;
      BC000C13_A50TBM07_AUTH_CD = new String[] {""} ;
      BC000C14_A13TAM04_AUTH_CD = new String[] {""} ;
      BC000C14_A233TAM04_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C14_n233TAM04_CRT_DATETIME = new boolean[] {false} ;
      BC000C14_A266TAM04_CRT_USER_ID = new String[] {""} ;
      BC000C14_n266TAM04_CRT_USER_ID = new boolean[] {false} ;
      BC000C14_A235TAM04_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C14_n235TAM04_UPD_DATETIME = new boolean[] {false} ;
      BC000C14_A267TAM04_UPD_USER_ID = new String[] {""} ;
      BC000C14_n267TAM04_UPD_USER_ID = new boolean[] {false} ;
      BC000C14_A286TAM04_UPD_CNT = new long[1] ;
      BC000C14_n286TAM04_UPD_CNT = new boolean[] {false} ;
      BC000C14_A285TAM04_AUTH_NM = new String[] {""} ;
      BC000C14_n285TAM04_AUTH_NM = new boolean[] {false} ;
      BC000C14_A687TAM04_AUTH_LVL = new byte[1] ;
      BC000C14_n687TAM04_AUTH_LVL = new boolean[] {false} ;
      BC000C14_A215TAM04_DEL_FLG = new String[] {""} ;
      BC000C14_n215TAM04_DEL_FLG = new boolean[] {false} ;
      BC000C14_A234TAM04_CRT_PROG_NM = new String[] {""} ;
      BC000C14_n234TAM04_CRT_PROG_NM = new boolean[] {false} ;
      BC000C14_A236TAM04_UPD_PROG_NM = new String[] {""} ;
      BC000C14_n236TAM04_UPD_PROG_NM = new boolean[] {false} ;
      BC000C15_A13TAM04_AUTH_CD = new String[] {""} ;
      BC000C15_A290TAM05_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C15_n290TAM05_CRT_DATETIME = new boolean[] {false} ;
      BC000C15_A291TAM05_CRT_USER_ID = new String[] {""} ;
      BC000C15_n291TAM05_CRT_USER_ID = new boolean[] {false} ;
      BC000C15_A293TAM05_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C15_n293TAM05_UPD_DATETIME = new boolean[] {false} ;
      BC000C15_A294TAM05_UPD_USER_ID = new String[] {""} ;
      BC000C15_n294TAM05_UPD_USER_ID = new boolean[] {false} ;
      BC000C15_A296TAM05_UPD_CNT = new long[1] ;
      BC000C15_n296TAM05_UPD_CNT = new boolean[] {false} ;
      BC000C15_A288TAM05_KNGN_FLG = new String[] {""} ;
      BC000C15_n288TAM05_KNGN_FLG = new boolean[] {false} ;
      BC000C15_A289TAM05_DEL_FLG = new String[] {""} ;
      BC000C15_n289TAM05_DEL_FLG = new boolean[] {false} ;
      BC000C15_A292TAM05_CRT_PROG_NM = new String[] {""} ;
      BC000C15_n292TAM05_CRT_PROG_NM = new boolean[] {false} ;
      BC000C15_A295TAM05_UPD_PROG_NM = new String[] {""} ;
      BC000C15_n295TAM05_UPD_PROG_NM = new boolean[] {false} ;
      BC000C15_A12TAM03_APP_ID = new String[] {""} ;
      BC000C4_A12TAM03_APP_ID = new String[] {""} ;
      BC000C16_A13TAM04_AUTH_CD = new String[] {""} ;
      BC000C16_A12TAM03_APP_ID = new String[] {""} ;
      BC000C3_A13TAM04_AUTH_CD = new String[] {""} ;
      BC000C3_A290TAM05_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C3_n290TAM05_CRT_DATETIME = new boolean[] {false} ;
      BC000C3_A291TAM05_CRT_USER_ID = new String[] {""} ;
      BC000C3_n291TAM05_CRT_USER_ID = new boolean[] {false} ;
      BC000C3_A293TAM05_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C3_n293TAM05_UPD_DATETIME = new boolean[] {false} ;
      BC000C3_A294TAM05_UPD_USER_ID = new String[] {""} ;
      BC000C3_n294TAM05_UPD_USER_ID = new boolean[] {false} ;
      BC000C3_A296TAM05_UPD_CNT = new long[1] ;
      BC000C3_n296TAM05_UPD_CNT = new boolean[] {false} ;
      BC000C3_A288TAM05_KNGN_FLG = new String[] {""} ;
      BC000C3_n288TAM05_KNGN_FLG = new boolean[] {false} ;
      BC000C3_A289TAM05_DEL_FLG = new String[] {""} ;
      BC000C3_n289TAM05_DEL_FLG = new boolean[] {false} ;
      BC000C3_A292TAM05_CRT_PROG_NM = new String[] {""} ;
      BC000C3_n292TAM05_CRT_PROG_NM = new boolean[] {false} ;
      BC000C3_A295TAM05_UPD_PROG_NM = new String[] {""} ;
      BC000C3_n295TAM05_UPD_PROG_NM = new boolean[] {false} ;
      BC000C3_A12TAM03_APP_ID = new String[] {""} ;
      sMode9 = "" ;
      BC000C2_A13TAM04_AUTH_CD = new String[] {""} ;
      BC000C2_A290TAM05_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C2_n290TAM05_CRT_DATETIME = new boolean[] {false} ;
      BC000C2_A291TAM05_CRT_USER_ID = new String[] {""} ;
      BC000C2_n291TAM05_CRT_USER_ID = new boolean[] {false} ;
      BC000C2_A293TAM05_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000C2_n293TAM05_UPD_DATETIME = new boolean[] {false} ;
      BC000C2_A294TAM05_UPD_USER_ID = new String[] {""} ;
      BC000C2_n294TAM05_UPD_USER_ID = new boolean[] {false} ;
      BC000C2_A296TAM05_UPD_CNT = new long[1] ;
      BC000C2_n296TAM05_UPD_CNT = new boolean[] {false} ;
      BC000C2_A288TAM05_KNGN_FLG = new String[] {""} ;
      BC000C2_n288TAM05_KNGN_FLG = new boolean[] {false} ;
      BC000C2_A289TAM05_DEL_FLG = new String[] {""} ;
      BC000C2_n289TAM05_DEL_FLG = new boolean[] {false} ;
      BC000C2_A292TAM05_CRT_PROG_NM = new String[] {""} ;
      BC000C2_n292TAM05_CRT_PROG_NM = new boolean[] {false} ;
      BC000C2_A295TAM05_UPD_PROG_NM = new String[] {""} ;
      BC000C2_n295TAM05_UPD_PROG_NM = new boolean[] {false} ;
      BC000C2_A12TAM03_APP_ID = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new tam04bc_kngn_bc__default(),
         new Object[] {
            ...
            , new Object[] {
            BC000C12_A55TAM07_USER_ID
            }
            , new Object[] {
            BC000C13_A50TBM07_AUTH_CD
            }
            , new Object[] {
            BC000C14_A13TAM04_AUTH_CD, BC000C14_A233TAM04_CRT_DATETIME, BC000C14_n233TAM04_CRT_DATETIME, BC000C14_A266TAM04_CRT_USER_ID, BC000C14_n266TAM04_CRT_USER_ID, BC000C14_A235TAM04_UPD_DATETIME, BC000C14_n235TAM04_UPD_DATETIME, BC000C14_A267TAM04_UPD_USER_ID, BC000C14_n267TAM04_UPD_USER_ID, BC000C14_A286TAM04_UPD_CNT,
            BC000C14_n286TAM04_UPD_CNT, BC000C14_A285TAM04_AUTH_NM, BC000C14_n285TAM04_AUTH_NM, BC000C14_A687TAM04_AUTH_LVL, BC000C14_n687TAM04_AUTH_LVL, BC000C14_A215TAM04_DEL_FLG, BC000C14_n215TAM04_DEL_FLG, BC000C14_A234TAM04_CRT_PROG_NM, BC000C14_n234TAM04_CRT_PROG_NM, BC000C14_A236TAM04_UPD_PROG_NM,
            BC000C14_n236TAM04_UPD_PROG_NM
            }
            , new Object[] {
            BC000C15_A13TAM04_AUTH_CD, BC000C15_A290TAM05_CRT_DATETIME, BC000C15_n290TAM05_CRT_DATETIME, BC000C15_A291TAM05_CRT_USER_ID, BC000C15_n291TAM05_CRT_USER_ID, BC000C15_A293TAM05_UPD_DATETIME, BC000C15_n293TAM05_UPD_DATETIME, BC000C15_A294TAM05_UPD_USER_ID, BC000C15_n294TAM05_UPD_USER_ID, BC000C15_A296TAM05_UPD_CNT,
            BC000C15_n296TAM05_UPD_CNT, BC000C15_A288TAM05_KNGN_FLG, BC000C15_n288TAM05_KNGN_FLG, BC000C15_A289TAM05_DEL_FLG, BC000C15_n289TAM05_DEL_FLG, BC000C15_A292TAM05_CRT_PROG_NM, BC000C15_n292TAM05_CRT_PROG_NM, BC000C15_A295TAM05_UPD_PROG_NM, BC000C15_n295TAM05_UPD_PROG_NM, BC000C15_A12TAM03_APP_ID
            }
            , new Object[] {
            BC000C16_A13TAM04_AUTH_CD, BC000C16_A12TAM03_APP_ID
            }
            , new Object[] {
            }
            , new Object[] {
   ...
   private String[] BC000C12_A55TAM07_USER_ID ;
   private String[] BC000C13_A50TBM07_AUTH_CD ;
   private String[] BC000C14_A13TAM04_AUTH_CD ;
   private java.util.Date[] BC000C14_A233TAM04_CRT_DATETIME ;
   private boolean[] BC000C14_n233TAM04_CRT_DATETIME ;
   private String[] BC000C14_A266TAM04_CRT_USER_ID ;
   private boolean[] BC000C14_n266TAM04_CRT_USER_ID ;
   private java.util.Date[] BC000C14_A235TAM04_UPD_DATETIME ;
   private boolean[] BC000C14_n235TAM04_UPD_DATETIME ;
   private String[] BC000C14_A267TAM04_UPD_USER_ID ;
   private boolean[] BC000C14_n267TAM04_UPD_USER_ID ;
   private long[] BC000C14_A286TAM04_UPD_CNT ;
   private boolean[] BC000C14_n286TAM04_UPD_CNT ;
   private String[] BC000C14_A285TAM04_AUTH_NM ;
   private boolean[] BC000C14_n285TAM04_AUTH_NM ;
   private byte[] BC000C14_A687TAM04_AUTH_LVL ;
   private boolean[] BC000C14_n687TAM04_AUTH_LVL ;
   private String[] BC000C14_A215TAM04_DEL_FLG ;
   private boolean[] BC000C14_n215TAM04_DEL_FLG ;
   private String[] BC000C14_A234TAM04_CRT_PROG_NM ;
   private boolean[] BC000C14_n234TAM04_CRT_PROG_NM ;
   private String[] BC000C14_A236TAM04_UPD_PROG_NM ;
   private boolean[] BC000C14_n236TAM04_UPD_PROG_NM ;
   private String[] BC000C15_A13TAM04_AUTH_CD ;
   private java.util.Date[] BC000C15_A290TAM05_CRT_DATETIME ;
   private boolean[] BC000C15_n290TAM05_CRT_DATETIME ;
   private String[] BC000C15_A291TAM05_CRT_USER_ID ;
   private boolean[] BC000C15_n291TAM05_CRT_USER_ID ;
   private java.util.Date[] BC000C15_A293TAM05_UPD_DATETIME ;
   private boolean[] BC000C15_n293TAM05_UPD_DATETIME ;
   private String[] BC000C15_A294TAM05_UPD_USER_ID ;
   private boolean[] BC000C15_n294TAM05_UPD_USER_ID ;
   private long[] BC000C15_A296TAM05_UPD_CNT ;
   private boolean[] BC000C15_n296TAM05_UPD_CNT ;
   private String[] BC000C15_A288TAM05_KNGN_FLG ;
   private boolean[] BC000C15_n288TAM05_KNGN_FLG ;
   private String[] BC000C15_A289TAM05_DEL_FLG ;
   private boolean[] BC000C15_n289TAM05_DEL_FLG ;
   private String[] BC000C15_A292TAM05_CRT_PROG_NM ;
   private boolean[] BC000C15_n292TAM05_CRT_PROG_NM ;
   private String[] BC000C15_A295TAM05_UPD_PROG_NM ;
   private boolean[] BC000C15_n295TAM05_UPD_PROG_NM ;
   private String[] BC000C15_A12TAM03_APP_ID ;
   private String[] BC000C4_A12TAM03_APP_ID ;
   private String[] BC000C16_A13TAM04_AUTH_CD ;
   private String[] BC000C16_A12TAM03_APP_ID ;
...
final  class tam04bc_kngn_bc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("BC000C12", "SELECT `TAM07_USER_ID` FROM `TAM07_USER` WHERE `TAM07_AUTH_CD` = ?  LIMIT 1",true, GX_NOMASK, false, this,1,0,true )
         ,new ForEachCursor("BC000C13", "SELECT `TBM07_AUTH_CD` FROM `TBM07_AUTH_BEHAVIOR` WHERE `TBM07_AUTH_CD` = ?  LIMIT 1",true, GX_NOMASK, false, this,1,0,true )
