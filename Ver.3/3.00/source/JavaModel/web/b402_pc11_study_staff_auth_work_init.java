/*
       ...
       Generated on: July 15, 2020 13:21:31.45
...
public final  class b402_pc11_study_staff_auth_work_init extends GXProcedure
{
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_pc11_study_staff_auth_work_init__default(),
         new Object[] {
             new Object[] {
            P00402_A13TAM04_AUTH_CD, P00402_A215TAM04_DEL_FLG, P00402_n215TAM04_DEL_FLG, P00402_A285TAM04_AUTH_NM, P00402_n285TAM04_AUTH_NM
            }
         }
      );
...
final  class b402_pc11_study_staff_auth_work_init__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00402", "SELECT `TAM04_AUTH_CD`, `TAM04_DEL_FLG`, `TAM04_AUTH_NM` FROM `TAM04_KNGN` WHERE (( `TAM04_AUTH_CD` <> '99' and `TAM04_AUTH_CD` <> '00')) AND (`TAM04_DEL_FLG` = '0') ORDER BY `TAM04_AUTH_CD` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
      };
   }
