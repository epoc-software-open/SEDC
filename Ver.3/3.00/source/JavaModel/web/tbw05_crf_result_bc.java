/*
       ...
       Generated on: July 15, 2020 13:21:51.28
...
public final  class tbw05_crf_result_bc extends GXWebPanel implements IGxSilentTrn
{
   ...
   public void getByPrimaryKey( )
   {
      ...
      if ( (pr_default.getStatus(1) != 101) )
      {
         zm1843( 1) ;
         RcdFound43 = (short)(1) ;
         A129TBW05_SESSION_ID = BC00183_A129TBW05_SESSION_ID[0] ;
         A130TBW05_APP_ID = BC00183_A130TBW05_APP_ID[0] ;
         A131TBW05_DISP_DATETIME = BC00183_A131TBW05_DISP_DATETIME[0] ;
         A132TBW05_STUDY_ID = BC00183_A132TBW05_STUDY_ID[0] ;
         A133TBW05_SUBJECT_ID = BC00183_A133TBW05_SUBJECT_ID[0] ;
         A134TBW05_CRF_ID = BC00183_A134TBW05_CRF_ID[0] ;
         A135TBW05_CRF_ITEM_GRP_DIV = BC00183_A135TBW05_CRF_ITEM_GRP_DIV[0] ;
         A136TBW05_CRF_ITEM_GRP_CD = BC00183_A136TBW05_CRF_ITEM_GRP_CD[0] ;
         A756TBW05_CRF_VALUE = BC00183_A756TBW05_CRF_VALUE[0] ;
         n756TBW05_CRF_VALUE = BC00183_n756TBW05_CRF_VALUE[0] ;
         A757TBW05_EDIT_FLG = BC00183_A757TBW05_EDIT_FLG[0] ;
         n757TBW05_EDIT_FLG = BC00183_n757TBW05_EDIT_FLG[0] ;
         Z129TBW05_SESSION_ID = A129TBW05_SESSION_ID ;
         Z130TBW05_APP_ID = A130TBW05_APP_ID ;
         Z131TBW05_DISP_DATETIME = A131TBW05_DISP_DATETIME ;
         Z132TBW05_STUDY_ID = A132TBW05_STUDY_ID ;
   ...
   public void checkOptimisticConcurrency1843( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         ...
         if ( (pr_default.getStatus(0) == 101) || ( GXutil.strcmp(Z756TBW05_CRF_VALUE, BC00182_A756TBW05_CRF_VALUE[0]) != 0 ) || ( GXutil.strcmp(Z757TBW05_EDIT_FLG, BC00182_A757TBW05_EDIT_FLG[0]) != 0 ) )
         {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(5, new Object[] {new Boolean(n756TBW05_CRF_VALUE), A756TBW05_CRF_VALUE, new Boolean(n757TBW05_EDIT_FLG), A757TBW05_EDIT_FLG, A129TBW05_SESSION_ID, A130TBW05_APP_ID, A131TBW05_DISP_DATETIME, new Long(A132TBW05_STUDY_ID), new Integer(A133TBW05_SUBJECT_ID), new Short(A134TBW05_CRF_ID), A135TBW05_CRF_ITEM_GRP_DIV, A136TBW05_CRF_ITEM_GRP_CD});
                  Application.getSmartCacheProvider(remoteHandle).setUpdated("TBW05_CRF_RESULT") ;
      ...
      if ( AnyError == 0 )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               pr_default.execute(6, new Object[] {A129TBW05_SESSION_ID, A130TBW05_APP_ID, A131TBW05_DISP_DATETIME, new Long(A132TBW05_STUDY_ID), new Integer(A133TBW05_SUBJECT_ID), new Short(A134TBW05_CRF_ID), A135TBW05_CRF_ITEM_GRP_DIV, A136TBW05_CRF_ITEM_GRP_CD});
               Application.getSmartCacheProvider(remoteHandle).setUpdated("TBW05_CRF_RESULT") ;
               if ( AnyError == 0 )
               {
   ...
   public void scanKeyStart1843( )
   {
      ...
      pr_default.execute(7, new Object[] {A129TBW05_SESSION_ID, A130TBW05_APP_ID, A131TBW05_DISP_DATETIME, new Long(A132TBW05_STUDY_ID), new Integer(A133TBW05_SUBJECT_ID), new Short(A134TBW05_CRF_ID), A135TBW05_CRF_ITEM_GRP_DIV, A136TBW05_CRF_ITEM_GRP_CD});
      RcdFound43 = (short)(0) ;
      if ( (pr_default.getStatus(7) != 101) )
      {
         RcdFound43 = (short)(1) ;
         A129TBW05_SESSION_ID = BC00189_A129TBW05_SESSION_ID[0] ;
         A130TBW05_APP_ID = BC00189_A130TBW05_APP_ID[0] ;
         A131TBW05_DISP_DATETIME = BC00189_A131TBW05_DISP_DATETIME[0] ;
         A132TBW05_STUDY_ID = BC00189_A132TBW05_STUDY_ID[0] ;
         A133TBW05_SUBJECT_ID = BC00189_A133TBW05_SUBJECT_ID[0] ;
         A134TBW05_CRF_ID = BC00189_A134TBW05_CRF_ID[0] ;
         A135TBW05_CRF_ITEM_GRP_DIV = BC00189_A135TBW05_CRF_ITEM_GRP_DIV[0] ;
         A136TBW05_CRF_ITEM_GRP_CD = BC00189_A136TBW05_CRF_ITEM_GRP_CD[0] ;
         A756TBW05_CRF_VALUE = BC00189_A756TBW05_CRF_VALUE[0] ;
         n756TBW05_CRF_VALUE = BC00189_n756TBW05_CRF_VALUE[0] ;
         A757TBW05_EDIT_FLG = BC00189_A757TBW05_EDIT_FLG[0] ;
         n757TBW05_EDIT_FLG = BC00189_n757TBW05_EDIT_FLG[0] ;
      }
   ...
   public void initialize( )
   {
      ...
      BC00183_A129TBW05_SESSION_ID = new String[] {""} ;
      BC00183_A130TBW05_APP_ID = new String[] {""} ;
      BC00183_A131TBW05_DISP_DATETIME = new String[] {""} ;
      BC00183_A132TBW05_STUDY_ID = new long[1] ;
      BC00183_A133TBW05_SUBJECT_ID = new int[1] ;
      BC00183_A134TBW05_CRF_ID = new short[1] ;
      BC00183_A135TBW05_CRF_ITEM_GRP_DIV = new String[] {""} ;
      BC00183_A136TBW05_CRF_ITEM_GRP_CD = new String[] {""} ;
      BC00183_A756TBW05_CRF_VALUE = new String[] {""} ;
      BC00183_n756TBW05_CRF_VALUE = new boolean[] {false} ;
      BC00183_A757TBW05_EDIT_FLG = new String[] {""} ;
      BC00183_n757TBW05_EDIT_FLG = new boolean[] {false} ;
      sMode43 = "" ;
      BC00182_A129TBW05_SESSION_ID = new String[] {""} ;
      BC00182_A130TBW05_APP_ID = new String[] {""} ;
      BC00182_A131TBW05_DISP_DATETIME = new String[] {""} ;
      BC00182_A132TBW05_STUDY_ID = new long[1] ;
      BC00182_A133TBW05_SUBJECT_ID = new int[1] ;
      BC00182_A134TBW05_CRF_ID = new short[1] ;
      BC00182_A135TBW05_CRF_ITEM_GRP_DIV = new String[] {""} ;
      BC00182_A136TBW05_CRF_ITEM_GRP_CD = new String[] {""} ;
      BC00182_A756TBW05_CRF_VALUE = new String[] {""} ;
      BC00182_n756TBW05_CRF_VALUE = new boolean[] {false} ;
      BC00182_A757TBW05_EDIT_FLG = new String[] {""} ;
      BC00182_n757TBW05_EDIT_FLG = new boolean[] {false} ;
      BC00189_A129TBW05_SESSION_ID = new String[] {""} ;
      BC00189_A130TBW05_APP_ID = new String[] {""} ;
      BC00189_A131TBW05_DISP_DATETIME = new String[] {""} ;
      BC00189_A132TBW05_STUDY_ID = new long[1] ;
      BC00189_A133TBW05_SUBJECT_ID = new int[1] ;
      BC00189_A134TBW05_CRF_ID = new short[1] ;
      BC00189_A135TBW05_CRF_ITEM_GRP_DIV = new String[] {""} ;
      BC00189_A136TBW05_CRF_ITEM_GRP_CD = new String[] {""} ;
      BC00189_A756TBW05_CRF_VALUE = new String[] {""} ;
      BC00189_n756TBW05_CRF_VALUE = new boolean[] {false} ;
      BC00189_A757TBW05_EDIT_FLG = new String[] {""} ;
      BC00189_n757TBW05_EDIT_FLG = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new tbw05_crf_result_bc__default(),
         new Object[] {
            ...
            , new Object[] {
            BC00189_A129TBW05_SESSION_ID, BC00189_A130TBW05_APP_ID, BC00189_A131TBW05_DISP_DATETIME, BC00189_A132TBW05_STUDY_ID, BC00189_A133TBW05_SUBJECT_ID, BC00189_A134TBW05_CRF_ID, BC00189_A135TBW05_CRF_ITEM_GRP_DIV, BC00189_A136TBW05_CRF_ITEM_GRP_CD, BC00189_A756TBW05_CRF_VALUE, BC00189_n756TBW05_CRF_VALUE,
            BC00189_A757TBW05_EDIT_FLG, BC00189_n757TBW05_EDIT_FLG
            }
         }
      );
   ...
   private String[] BC00189_A129TBW05_SESSION_ID ;
   private String[] BC00189_A130TBW05_APP_ID ;
   private String[] BC00189_A131TBW05_DISP_DATETIME ;
   private long[] BC00189_A132TBW05_STUDY_ID ;
   private int[] BC00189_A133TBW05_SUBJECT_ID ;
   private short[] BC00189_A134TBW05_CRF_ID ;
   private String[] BC00189_A135TBW05_CRF_ITEM_GRP_DIV ;
   private String[] BC00189_A136TBW05_CRF_ITEM_GRP_CD ;
   private String[] BC00189_A756TBW05_CRF_VALUE ;
   private boolean[] BC00189_n756TBW05_CRF_VALUE ;
   private String[] BC00189_A757TBW05_EDIT_FLG ;
   private boolean[] BC00189_n757TBW05_EDIT_FLG ;
}
