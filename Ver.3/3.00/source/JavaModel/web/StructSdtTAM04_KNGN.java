/*
               File: StructSdtTAM04_KNGN
        Description: 権限パターンマスタ
             Author: GeneXus Java Generator version 10_3_3-92797
       Generated on: July 15, 2020 13:18:29.51
       Program type: Callable routine
          Main DBMS: mysql
*/
import com.genexus.*;

public final  class StructSdtTAM04_KNGN implements Cloneable, java.io.Serializable
{
   public StructSdtTAM04_KNGN( )
   {
      ...
      gxTv_SdtTAM04_KNGN_Tam04_crt_datetime = cal.getTime() ;
      gxTv_SdtTAM04_KNGN_Tam04_crt_user_id = "" ;
      gxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm = "" ;
      gxTv_SdtTAM04_KNGN_Tam04_upd_datetime = cal.getTime() ;
      ...
      gxTv_SdtTAM04_KNGN_Tam04_crt_datetime_Z = cal.getTime() ;
      gxTv_SdtTAM04_KNGN_Tam04_crt_user_id_Z = "" ;
      gxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm_Z = "" ;
      gxTv_SdtTAM04_KNGN_Tam04_upd_datetime_Z = cal.getTime() ;
   ...
   protected byte gxTv_SdtTAM04_KNGN_Tam04_auth_lvl ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_auth_lvl_Z ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_auth_nm_N ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_auth_lvl_N ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_del_flg_N ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_crt_datetime_N ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_crt_user_id_N ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm_N ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_upd_datetime_N ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_upd_user_id_N ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm_N ;
   protected byte gxTv_SdtTAM04_KNGN_Tam04_upd_cnt_N ;
   protected short gxTv_SdtTAM04_KNGN_Initialized ;
   protected long gxTv_SdtTAM04_KNGN_Tam04_upd_cnt ;
   protected long gxTv_SdtTAM04_KNGN_Tam04_upd_cnt_Z ;
   protected String gxTv_SdtTAM04_KNGN_Mode ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_auth_cd ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_auth_nm ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_del_flg ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_crt_user_id ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_upd_user_id ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_auth_cd_Z ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_auth_nm_Z ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_del_flg_Z ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_crt_user_id_Z ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_crt_prog_nm_Z ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_upd_user_id_Z ;
   protected String gxTv_SdtTAM04_KNGN_Tam04_upd_prog_nm_Z ;
   protected java.util.Date gxTv_SdtTAM04_KNGN_Tam04_crt_datetime ;
   protected java.util.Date gxTv_SdtTAM04_KNGN_Tam04_upd_datetime ;
   protected java.util.Date gxTv_SdtTAM04_KNGN_Tam04_crt_datetime_Z ;
   protected java.util.Date gxTv_SdtTAM04_KNGN_Tam04_upd_datetime_Z ;
}
