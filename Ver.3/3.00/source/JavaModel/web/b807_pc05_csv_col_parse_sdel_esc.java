/*
               File: B807_PC05_CSV_COL_PARSE_SDEL_ESC
        Description: CSVカラム分解_囲み文字削除(エスケープ解除)
             Author: GeneXus Java Generator version 10_3_3-92797
       Generated on: July 15, 2020 13:18:17.15
...
public final  class b807_pc05_csv_col_parse_sdel_esc extends GXProcedure
{
   public b807_pc05_csv_col_parse_sdel_esc( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( b807_pc05_csv_col_parse_sdel_esc.class ), "" );
   }
   ...
   public String executeUdp( String aP0 ,
                             ...
                             short[] aP4 )
   {
      b807_pc05_csv_col_parse_sdel_esc.this.AV10P_CSV = aP0;
      b807_pc05_csv_col_parse_sdel_esc.this.AV9P_COL_NUM = aP1;
      b807_pc05_csv_col_parse_sdel_esc.this.AV11P_CSV_NAME = aP2;
      b807_pc05_csv_col_parse_sdel_esc.this.aP3 = aP3;
      b807_pc05_csv_col_parse_sdel_esc.this.aP4 = aP4;
      b807_pc05_csv_col_parse_sdel_esc.this.aP5 = aP5;
      b807_pc05_csv_col_parse_sdel_esc.this.aP5 = new String[] {""};
      initialize();
      privateExecute();
      return aP5[0];
   }
   ...
   private void privateExecute( )
   {
      ...
      b807_pc05_csv_col_parse_sdel_esc.this.GXt_char1 = GXv_char2[0] ;
      ...
      while ( AV21GXV1 <= AV13W_CSV_COL.size() )
      {
         ...
         AV17W_STR = GXutil.strReplace( GXutil.trim( AV17W_STR), "\"", "") ;
   ...
   {
      this.aP3[0] = b807_pc05_csv_col_parse_sdel_esc.this.AV14W_RAW_STR;
      this.aP4[0] = b807_pc05_csv_col_parse_sdel_esc.this.AV15W_RTN_CD;
      this.aP5[0] = b807_pc05_csv_col_parse_sdel_esc.this.AV16W_RTN_MSG;
      CloseOpenCursors();
      exitApplication();
   }
