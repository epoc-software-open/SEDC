/*
       ...
       Generated on: July 15, 2020 13:21:27.26
...
public final  class tbm07_auth_behavior_bc extends GXWebPanel implements IGxSilentTrn
{
   ...
   public void getByPrimaryKey( )
   {
      ...
      if ( (pr_default.getStatus(1) != 101) )
      {
         zm1439( 8) ;
         RcdFound39 = (short)(1) ;
         A627TBM07_CRT_DATETIME = BC00143_A627TBM07_CRT_DATETIME[0] ;
         n627TBM07_CRT_DATETIME = BC00143_n627TBM07_CRT_DATETIME[0] ;
         A628TBM07_CRT_USER_ID = BC00143_A628TBM07_CRT_USER_ID[0] ;
         n628TBM07_CRT_USER_ID = BC00143_n628TBM07_CRT_USER_ID[0] ;
         A630TBM07_UPD_DATETIME = BC00143_A630TBM07_UPD_DATETIME[0] ;
         n630TBM07_UPD_DATETIME = BC00143_n630TBM07_UPD_DATETIME[0] ;
         A631TBM07_UPD_USER_ID = BC00143_A631TBM07_UPD_USER_ID[0] ;
         n631TBM07_UPD_USER_ID = BC00143_n631TBM07_UPD_USER_ID[0] ;
         A633TBM07_UPD_CNT = BC00143_A633TBM07_UPD_CNT[0] ;
         n633TBM07_UPD_CNT = BC00143_n633TBM07_UPD_CNT[0] ;
         A623TBM07_CRF_INP_AUTH_FLG = BC00143_A623TBM07_CRF_INP_AUTH_FLG[0] ;
         n623TBM07_CRF_INP_AUTH_FLG = BC00143_n623TBM07_CRF_INP_AUTH_FLG[0] ;
         A624TBM07_CRF_EDIT_AUTH_FLG = BC00143_A624TBM07_CRF_EDIT_AUTH_FLG[0] ;
         n624TBM07_CRF_EDIT_AUTH_FLG = BC00143_n624TBM07_CRF_EDIT_AUTH_FLG[0] ;
         A625TBM07_OTHER_SITE_VIEW_FLG = BC00143_A625TBM07_OTHER_SITE_VIEW_FLG[0] ;
         n625TBM07_OTHER_SITE_VIEW_FLG = BC00143_n625TBM07_OTHER_SITE_VIEW_FLG[0] ;
         A626TBM07_DEL_FLG = BC00143_A626TBM07_DEL_FLG[0] ;
         n626TBM07_DEL_FLG = BC00143_n626TBM07_DEL_FLG[0] ;
         A629TBM07_CRT_PROG_NM = BC00143_A629TBM07_CRT_PROG_NM[0] ;
         n629TBM07_CRT_PROG_NM = BC00143_n629TBM07_CRT_PROG_NM[0] ;
         A632TBM07_UPD_PROG_NM = BC00143_A632TBM07_UPD_PROG_NM[0] ;
         n632TBM07_UPD_PROG_NM = BC00143_n632TBM07_UPD_PROG_NM[0] ;
         A50TBM07_AUTH_CD = BC00143_A50TBM07_AUTH_CD[0] ;
   ...
   public void checkOptimisticConcurrency1439( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         ...
         Gx_longc = false ;
         if ( (pr_default.getStatus(0) == 101) || !( Z627TBM07_CRT_DATETIME.equals( BC00142_A627TBM07_CRT_DATETIME[0] ) ) || ( GXutil.strcmp(Z628TBM07_CRT_USER_ID, BC00142_A628TBM07_CRT_USER_ID[0]) != 0 ) || !( Z630TBM07_UPD_DATETIME.equals( BC00142_A630TBM07_UPD_DATETIME[0] ) ) || ( GXutil.strcmp(Z631TBM07_UPD_USER_ID, BC00142_A631TBM07_UPD_USER_ID[0]) != 0 ) || ( Z633TBM07_UPD_CNT != BC00142_A633TBM07_UPD_CNT[0] ) )
         {
            Gx_longc = true ;
         }
         if ( Gx_longc || ( GXutil.strcmp(Z623TBM07_CRF_INP_AUTH_FLG, BC00142_A623TBM07_CRF_INP_AUTH_FLG[0]) != 0 ) || ( GXutil.strcmp(Z624TBM07_CRF_EDIT_AUTH_FLG, BC00142_A624TBM07_CRF_EDIT_AUTH_FLG[0]) != 0 ) || ( GXutil.strcmp(Z625TBM07_OTHER_SITE_VIEW_FLG, BC00142_A625TBM07_OTHER_SITE_VIEW_FLG[0]) != 0 ) || ( GXutil.strcmp(Z626TBM07_DEL_FLG, BC00142_A626TBM07_DEL_FLG[0]) != 0 ) || ( GXutil.strcmp(Z629TBM07_CRT_PROG_NM, BC00142_A629TBM07_CRT_PROG_NM[0]) != 0 ) )
         {
            Gx_longc = true ;
         }
         if ( Gx_longc || ( GXutil.strcmp(Z632TBM07_UPD_PROG_NM, BC00142_A632TBM07_UPD_PROG_NM[0]) != 0 ) )
         {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(6, new Object[] {new Boolean(n627TBM07_CRT_DATETIME), A627TBM07_CRT_DATETIME, new Boolean(n628TBM07_CRT_USER_ID), A628TBM07_CRT_USER_ID, new Boolean(n630TBM07_UPD_DATETIME), A630TBM07_UPD_DATETIME, new Boolean(n631TBM07_UPD_USER_ID), A631TBM07_UPD_USER_ID, new Boolean(n633TBM07_UPD_CNT), new Long(A633TBM07_UPD_CNT), new Boolean(n623TBM07_CRF_INP_AUTH_FLG), A623TBM07_CRF_INP_AUTH_FLG, new Boolean(n624TBM07_CRF_EDIT_AUTH_FLG), A624TBM07_CRF_EDIT_AUTH_FLG, new Boolean(n625TBM07_OTHER_SITE_VIEW_FLG), A625TBM07_OTHER_SITE_VIEW_FLG, new Boolean(n626TBM07_DEL_FLG), A626TBM07_DEL_FLG, new Boolean(n629TBM07_CRT_PROG_NM), A629TBM07_CRT_PROG_NM, new Boolean(n632TBM07_UPD_PROG_NM), A632TBM07_UPD_PROG_NM, A50TBM07_AUTH_CD});
                  Application.getSmartCacheProvider(remoteHandle).setUpdated("TBM07_AUTH_BEHAVIOR") ;
   ...
   public void scanKeyStart1439( )
   {
      ...
      pr_default.execute(8, new Object[] {A50TBM07_AUTH_CD});
      RcdFound39 = (short)(0) ;
      if ( (pr_default.getStatus(8) != 101) )
      {
         RcdFound39 = (short)(1) ;
         A627TBM07_CRT_DATETIME = BC001410_A627TBM07_CRT_DATETIME[0] ;
         n627TBM07_CRT_DATETIME = BC001410_n627TBM07_CRT_DATETIME[0] ;
         A628TBM07_CRT_USER_ID = BC001410_A628TBM07_CRT_USER_ID[0] ;
         n628TBM07_CRT_USER_ID = BC001410_n628TBM07_CRT_USER_ID[0] ;
         A630TBM07_UPD_DATETIME = BC001410_A630TBM07_UPD_DATETIME[0] ;
         n630TBM07_UPD_DATETIME = BC001410_n630TBM07_UPD_DATETIME[0] ;
         A631TBM07_UPD_USER_ID = BC001410_A631TBM07_UPD_USER_ID[0] ;
         n631TBM07_UPD_USER_ID = BC001410_n631TBM07_UPD_USER_ID[0] ;
         A633TBM07_UPD_CNT = BC001410_A633TBM07_UPD_CNT[0] ;
         n633TBM07_UPD_CNT = BC001410_n633TBM07_UPD_CNT[0] ;
         A623TBM07_CRF_INP_AUTH_FLG = BC001410_A623TBM07_CRF_INP_AUTH_FLG[0] ;
         n623TBM07_CRF_INP_AUTH_FLG = BC001410_n623TBM07_CRF_INP_AUTH_FLG[0] ;
         A624TBM07_CRF_EDIT_AUTH_FLG = BC001410_A624TBM07_CRF_EDIT_AUTH_FLG[0] ;
         n624TBM07_CRF_EDIT_AUTH_FLG = BC001410_n624TBM07_CRF_EDIT_AUTH_FLG[0] ;
         A625TBM07_OTHER_SITE_VIEW_FLG = BC001410_A625TBM07_OTHER_SITE_VIEW_FLG[0] ;
         n625TBM07_OTHER_SITE_VIEW_FLG = BC001410_n625TBM07_OTHER_SITE_VIEW_FLG[0] ;
         A626TBM07_DEL_FLG = BC001410_A626TBM07_DEL_FLG[0] ;
         n626TBM07_DEL_FLG = BC001410_n626TBM07_DEL_FLG[0] ;
         A629TBM07_CRT_PROG_NM = BC001410_A629TBM07_CRT_PROG_NM[0] ;
         n629TBM07_CRT_PROG_NM = BC001410_n629TBM07_CRT_PROG_NM[0] ;
         A632TBM07_UPD_PROG_NM = BC001410_A632TBM07_UPD_PROG_NM[0] ;
         n632TBM07_UPD_PROG_NM = BC001410_n632TBM07_UPD_PROG_NM[0] ;
         A50TBM07_AUTH_CD = BC001410_A50TBM07_AUTH_CD[0] ;
      }
   ...
   public void initialize( )
   {
      ...
      BC00144_A50TBM07_AUTH_CD = new String[] {""} ;
      BC00146_A50TBM07_AUTH_CD = new String[] {""} ;
      BC00143_A627TBM07_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC00143_n627TBM07_CRT_DATETIME = new boolean[] {false} ;
      BC00143_A628TBM07_CRT_USER_ID = new String[] {""} ;
      BC00143_n628TBM07_CRT_USER_ID = new boolean[] {false} ;
      BC00143_A630TBM07_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC00143_n630TBM07_UPD_DATETIME = new boolean[] {false} ;
      BC00143_A631TBM07_UPD_USER_ID = new String[] {""} ;
      BC00143_n631TBM07_UPD_USER_ID = new boolean[] {false} ;
      BC00143_A633TBM07_UPD_CNT = new long[1] ;
      BC00143_n633TBM07_UPD_CNT = new boolean[] {false} ;
      BC00143_A623TBM07_CRF_INP_AUTH_FLG = new String[] {""} ;
      BC00143_n623TBM07_CRF_INP_AUTH_FLG = new boolean[] {false} ;
      BC00143_A624TBM07_CRF_EDIT_AUTH_FLG = new String[] {""} ;
      BC00143_n624TBM07_CRF_EDIT_AUTH_FLG = new boolean[] {false} ;
      BC00143_A625TBM07_OTHER_SITE_VIEW_FLG = new String[] {""} ;
      BC00143_n625TBM07_OTHER_SITE_VIEW_FLG = new boolean[] {false} ;
      BC00143_A626TBM07_DEL_FLG = new String[] {""} ;
      BC00143_n626TBM07_DEL_FLG = new boolean[] {false} ;
      BC00143_A629TBM07_CRT_PROG_NM = new String[] {""} ;
      BC00143_n629TBM07_CRT_PROG_NM = new boolean[] {false} ;
      BC00143_A632TBM07_UPD_PROG_NM = new String[] {""} ;
      BC00143_n632TBM07_UPD_PROG_NM = new boolean[] {false} ;
      BC00143_A50TBM07_AUTH_CD = new String[] {""} ;
      sMode39 = "" ;
      BC00142_A627TBM07_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC00142_n627TBM07_CRT_DATETIME = new boolean[] {false} ;
      BC00142_A628TBM07_CRT_USER_ID = new String[] {""} ;
      BC00142_n628TBM07_CRT_USER_ID = new boolean[] {false} ;
      BC00142_A630TBM07_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC00142_n630TBM07_UPD_DATETIME = new boolean[] {false} ;
      BC00142_A631TBM07_UPD_USER_ID = new String[] {""} ;
      BC00142_n631TBM07_UPD_USER_ID = new boolean[] {false} ;
      BC00142_A633TBM07_UPD_CNT = new long[1] ;
      BC00142_n633TBM07_UPD_CNT = new boolean[] {false} ;
      BC00142_A623TBM07_CRF_INP_AUTH_FLG = new String[] {""} ;
      BC00142_n623TBM07_CRF_INP_AUTH_FLG = new boolean[] {false} ;
      BC00142_A624TBM07_CRF_EDIT_AUTH_FLG = new String[] {""} ;
      BC00142_n624TBM07_CRF_EDIT_AUTH_FLG = new boolean[] {false} ;
      BC00142_A625TBM07_OTHER_SITE_VIEW_FLG = new String[] {""} ;
      BC00142_n625TBM07_OTHER_SITE_VIEW_FLG = new boolean[] {false} ;
      BC00142_A626TBM07_DEL_FLG = new String[] {""} ;
      BC00142_n626TBM07_DEL_FLG = new boolean[] {false} ;
      BC00142_A629TBM07_CRT_PROG_NM = new String[] {""} ;
      BC00142_n629TBM07_CRT_PROG_NM = new boolean[] {false} ;
      BC00142_A632TBM07_UPD_PROG_NM = new String[] {""} ;
      BC00142_n632TBM07_UPD_PROG_NM = new boolean[] {false} ;
      BC00142_A50TBM07_AUTH_CD = new String[] {""} ;
      BC001410_A627TBM07_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC001410_n627TBM07_CRT_DATETIME = new boolean[] {false} ;
      BC001410_A628TBM07_CRT_USER_ID = new String[] {""} ;
      BC001410_n628TBM07_CRT_USER_ID = new boolean[] {false} ;
      BC001410_A630TBM07_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC001410_n630TBM07_UPD_DATETIME = new boolean[] {false} ;
      BC001410_A631TBM07_UPD_USER_ID = new String[] {""} ;
      BC001410_n631TBM07_UPD_USER_ID = new boolean[] {false} ;
      BC001410_A633TBM07_UPD_CNT = new long[1] ;
      BC001410_n633TBM07_UPD_CNT = new boolean[] {false} ;
      BC001410_A623TBM07_CRF_INP_AUTH_FLG = new String[] {""} ;
      BC001410_n623TBM07_CRF_INP_AUTH_FLG = new boolean[] {false} ;
      BC001410_A624TBM07_CRF_EDIT_AUTH_FLG = new String[] {""} ;
      BC001410_n624TBM07_CRF_EDIT_AUTH_FLG = new boolean[] {false} ;
      BC001410_A625TBM07_OTHER_SITE_VIEW_FLG = new String[] {""} ;
      BC001410_n625TBM07_OTHER_SITE_VIEW_FLG = new boolean[] {false} ;
      BC001410_A626TBM07_DEL_FLG = new String[] {""} ;
      BC001410_n626TBM07_DEL_FLG = new boolean[] {false} ;
      BC001410_A629TBM07_CRT_PROG_NM = new String[] {""} ;
      BC001410_n629TBM07_CRT_PROG_NM = new boolean[] {false} ;
      BC001410_A632TBM07_UPD_PROG_NM = new String[] {""} ;
      BC001410_n632TBM07_UPD_PROG_NM = new boolean[] {false} ;
      BC001410_A50TBM07_AUTH_CD = new String[] {""} ;
      GXt_char1 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new tbm07_auth_behavior_bc__default(),
         new Object[] {
            ...
            , new Object[] {
            BC001410_A627TBM07_CRT_DATETIME, BC001410_n627TBM07_CRT_DATETIME, BC001410_A628TBM07_CRT_USER_ID, BC001410_n628TBM07_CRT_USER_ID, BC001410_A630TBM07_UPD_DATETIME, BC001410_n630TBM07_UPD_DATETIME, BC001410_A631TBM07_UPD_USER_ID, BC001410_n631TBM07_UPD_USER_ID, BC001410_A633TBM07_UPD_CNT, BC001410_n633TBM07_UPD_CNT,
            BC001410_A623TBM07_CRF_INP_AUTH_FLG, BC001410_n623TBM07_CRF_INP_AUTH_FLG, BC001410_A624TBM07_CRF_EDIT_AUTH_FLG, BC001410_n624TBM07_CRF_EDIT_AUTH_FLG, BC001410_A625TBM07_OTHER_SITE_VIEW_FLG, BC001410_n625TBM07_OTHER_SITE_VIEW_FLG, BC001410_A626TBM07_DEL_FLG, BC001410_n626TBM07_DEL_FLG, BC001410_A629TBM07_CRT_PROG_NM, BC001410_n629TBM07_CRT_PROG_NM,
            BC001410_A632TBM07_UPD_PROG_NM, BC001410_n632TBM07_UPD_PROG_NM, BC001410_A50TBM07_AUTH_CD
            }
         }
      );
   ...
   private java.util.Date[] BC001410_A627TBM07_CRT_DATETIME ;
   private boolean[] BC001410_n627TBM07_CRT_DATETIME ;
   private String[] BC001410_A628TBM07_CRT_USER_ID ;
   private boolean[] BC001410_n628TBM07_CRT_USER_ID ;
   private java.util.Date[] BC001410_A630TBM07_UPD_DATETIME ;
   private boolean[] BC001410_n630TBM07_UPD_DATETIME ;
   private String[] BC001410_A631TBM07_UPD_USER_ID ;
   private boolean[] BC001410_n631TBM07_UPD_USER_ID ;
   private long[] BC001410_A633TBM07_UPD_CNT ;
   private boolean[] BC001410_n633TBM07_UPD_CNT ;
   private String[] BC001410_A623TBM07_CRF_INP_AUTH_FLG ;
   private boolean[] BC001410_n623TBM07_CRF_INP_AUTH_FLG ;
   private String[] BC001410_A624TBM07_CRF_EDIT_AUTH_FLG ;
   private boolean[] BC001410_n624TBM07_CRF_EDIT_AUTH_FLG ;
   private String[] BC001410_A625TBM07_OTHER_SITE_VIEW_FLG ;
   private boolean[] BC001410_n625TBM07_OTHER_SITE_VIEW_FLG ;
   private String[] BC001410_A626TBM07_DEL_FLG ;
   private boolean[] BC001410_n626TBM07_DEL_FLG ;
   private String[] BC001410_A629TBM07_CRT_PROG_NM ;
   private boolean[] BC001410_n629TBM07_CRT_PROG_NM ;
   private String[] BC001410_A632TBM07_UPD_PROG_NM ;
   private boolean[] BC001410_n632TBM07_UPD_PROG_NM ;
   private String[] BC001410_A50TBM07_AUTH_CD ;
}
