/*
       ...
       Generated on: July 15, 2020 13:16:26.93
...
public final  class b599_pc34_cdisc_item_res extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A919TBM43_DEL_FLG = P00272_A919TBM43_DEL_FLG[0] ;
         n919TBM43_DEL_FLG = P00272_n919TBM43_DEL_FLG[0] ;
         A202TBM43_DOM_VAR_NM = P00272_A202TBM43_DOM_VAR_NM[0] ;
         A201TBM43_DOM_CD = P00272_A201TBM43_DOM_CD[0] ;
         A200TBM43_STUDY_ID = P00272_A200TBM43_STUDY_ID[0] ;
         A910TBM43_VAR_DESC = P00272_A910TBM43_VAR_DESC[0] ;
         n910TBM43_VAR_DESC = P00272_n910TBM43_VAR_DESC[0] ;
         AV22GXLvl32 = (byte)(1) ;
         GXt_char1 = AV18W_STR ;
         GXv_char2[0] = GXt_char1 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A201TBM43_DOM_CD, GXv_char2) ;
         b599_pc34_cdisc_item_res.this.GXt_char1 = GXv_char2[0] ;
         GXt_char3 = AV18W_STR ;
         GXv_char4[0] = GXt_char3 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A202TBM43_DOM_VAR_NM, GXv_char4) ;
         b599_pc34_cdisc_item_res.this.GXt_char3 = GXv_char4[0] ;
         GXt_char5 = AV18W_STR ;
         GXv_char6[0] = GXt_char5 ;
         new b804_pc01_esc_airres(remoteHandle, context).execute( A910TBM43_VAR_DESC, GXv_char6) ;
   ...
   public void initialize( )
   {
      ...
      Gx_ope = "" ;
      Gx_etb = "" ;
      P00272_A919TBM43_DEL_FLG = new String[] {""} ;
      P00272_n919TBM43_DEL_FLG = new boolean[] {false} ;
      P00272_A202TBM43_DOM_VAR_NM = new String[] {""} ;
      P00272_A201TBM43_DOM_CD = new String[] {""} ;
      P00272_A200TBM43_STUDY_ID = new long[1] ;
      P00272_A910TBM43_VAR_DESC = new String[] {""} ;
      P00272_n910TBM43_VAR_DESC = new boolean[] {false} ;
      A910TBM43_VAR_DESC = "" ;
      AV18W_STR = "" ;
      GXt_char1 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b599_pc34_cdisc_item_res__default(),
         new Object[] {
             new Object[] {
            P00272_A919TBM43_DEL_FLG, P00272_n919TBM43_DEL_FLG, P00272_A202TBM43_DOM_VAR_NM, P00272_A201TBM43_DOM_CD, P00272_A200TBM43_STUDY_ID, P00272_A910TBM43_VAR_DESC, P00272_n910TBM43_VAR_DESC
            }
         }
      );
   ...
   private String[] P00272_A919TBM43_DEL_FLG ;
   private boolean[] P00272_n919TBM43_DEL_FLG ;
   private String[] P00272_A202TBM43_DOM_VAR_NM ;
   private String[] P00272_A201TBM43_DOM_CD ;
   private long[] P00272_A200TBM43_STUDY_ID ;
   private String[] P00272_A910TBM43_VAR_DESC ;
   private boolean[] P00272_n910TBM43_VAR_DESC ;
...
final  class b599_pc34_cdisc_item_res__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_P00272(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).longValue() , (String)dynConstraints[1] , (String)dynConstraints[2] , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00272", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
      };
   }
