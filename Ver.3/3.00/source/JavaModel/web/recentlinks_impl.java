...
public final  class recentlinks_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513161146");
      if ( GXutil.len( sPrefix) == 0 )
      {
   ...
   public void renderHtmlCloseForm022( )
   {
      ...
      {
         httpContext.AddJavascriptSource("recentlinks.js", "?202071513161148");
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202071513161161");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("recentlinks.js", "?202071513161161");
      }
