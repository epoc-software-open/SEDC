/*
       ...
       Generated on: July 15, 2020 13:31:43.62
...
public final  class SdtB702_SD01_CRF_DESIGN extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "SIGNER_DISP_FLG") )
            {
               gxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "SIGNER_INFO") )
            {
               gxTv_SdtB702_SD01_CRF_DESIGN_Signer_info = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("SIGNER_DISP_FLG", GXutil.rtrim( gxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      oWriter.writeElement("SIGNER_INFO", GXutil.rtrim( gxTv_SdtB702_SD01_CRF_DESIGN_Signer_info));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
   ...
   public void tojson( boolean includeState )
   {
      ...
      AddObjectProperty("SIGNER_DISP_FLG", gxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg, false);
      AddObjectProperty("SIGNER_INFO", gxTv_SdtB702_SD01_CRF_DESIGN_Signer_info, false);
      if ( gxTv_SdtB702_SD01_CRF_DESIGN_Crf_items != null )
      {
   ...
   public String getgxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg( )
   {
      return gxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg ;
   }

   public void setgxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg( String value )
   {
      gxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg = value ;
   }

   public String getgxTv_SdtB702_SD01_CRF_DESIGN_Signer_info( )
   {
      return gxTv_SdtB702_SD01_CRF_DESIGN_Signer_info ;
   }

   public void setgxTv_SdtB702_SD01_CRF_DESIGN_Signer_info( String value )
   {
      gxTv_SdtB702_SD01_CRF_DESIGN_Signer_info = value ;
   }
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg = "" ;
      gxTv_SdtB702_SD01_CRF_DESIGN_Signer_info = "" ;
      sTagName = "" ;
   }
   ...
   public void setStruct( StructSdtB702_SD01_CRF_DESIGN struct )
   {
      ...
      setgxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg(struct.getSigner_disp_flg());
      setgxTv_SdtB702_SD01_CRF_DESIGN_Signer_info(struct.getSigner_info());
   ...
   public StructSdtB702_SD01_CRF_DESIGN getStruct( )
   {
      ...
      struct.setSigner_disp_flg(getgxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg());
      struct.setSigner_info(getgxTv_SdtB702_SD01_CRF_DESIGN_Signer_info());
   ...
   protected String gxTv_SdtB702_SD01_CRF_DESIGN_Signer_disp_flg ;
   protected String gxTv_SdtB702_SD01_CRF_DESIGN_Signer_info ;
