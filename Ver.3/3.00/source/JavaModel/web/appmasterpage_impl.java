...
public final  class appmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm012( )
   {
      ...
      httpContext.AddJavascriptSource("appmasterpage.js", "?202071513222564");
   ...
   {
      httpContext.AddThemeStyleSheetFile("", context.getHttpContext().getTheme( )+".css", "?1316762");
      if ( ! ( WebComp_Wcrecentlinks == null ) )
      {
         if ( GXutil.len( WebComp_Wcrecentlinks_Component) != 0 )
         {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?202071513222582");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   {
      httpContext.AddJavascriptSource("appmasterpage.js", "?202071513222582");
