/*
       ...
       Generated on: July 15, 2020 13:18:59.11
...
public final  class SdtTAM08_SITE extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( String AV57TAM08_SITE_ID )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {AV57TAM08_SITE_ID});
   }

   public Object[][] GetBCKey( )
   {
      return (Object[][])(new Object[][]{new Object[]{"TAM08_SITE_ID", String.class}}) ;
   }
   ...
   public com.genexus.util.GXProperties getMetadata( )
   {
      ...
      metadata.set("Name", "TAM08_SITE");
      metadata.set("BT", "TAM08_SITE");
      metadata.set("PK", "[ \"TAM08_SITE_ID\" ]");
   ...
   {
      AddObjectProperty("TAM08_SITE_ID", gxTv_SdtTAM08_SITE_Tam08_site_id, false);
      AddObjectProperty("TAM08_SITE_NM", gxTv_SdtTAM08_SITE_Tam08_site_nm, false);
      AddObjectProperty("TAM08_SITE_SNM", gxTv_SdtTAM08_SITE_Tam08_site_snm, false);
      AddObjectProperty("TAM08_OUTER_SITE_ID", gxTv_SdtTAM08_SITE_Tam08_outer_site_id, false);
      AddObjectProperty("TAM08_DEL_FLG", gxTv_SdtTAM08_SITE_Tam08_del_flg, false);
      datetime_STZ = gxTv_SdtTAM08_SITE_Tam08_crt_datetime ;
      sDateCnv = "" ;
      ...
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TAM08_CRT_DATETIME", sDateCnv, false);
      AddObjectProperty("TAM08_CRT_USER_ID", gxTv_SdtTAM08_SITE_Tam08_crt_user_id, false);
      AddObjectProperty("TAM08_CRT_PROG_NM", gxTv_SdtTAM08_SITE_Tam08_crt_prog_nm, false);
      datetime_STZ = gxTv_SdtTAM08_SITE_Tam08_upd_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TAM08_UPD_DATETIME", sDateCnv, false);
      AddObjectProperty("TAM08_UPD_USER_ID", gxTv_SdtTAM08_SITE_Tam08_upd_user_id, false);
      AddObjectProperty("TAM08_UPD_PROG_NM", gxTv_SdtTAM08_SITE_Tam08_upd_prog_nm, false);
      AddObjectProperty("TAM08_UPD_CNT", gxTv_SdtTAM08_SITE_Tam08_upd_cnt, false);
      if ( includeState )
      {
         AddObjectProperty("Mode", gxTv_SdtTAM08_SITE_Mode, false);
         AddObjectProperty("Initialized", gxTv_SdtTAM08_SITE_Initialized, false);
         AddObjectProperty("TAM08_SITE_ID_Z", gxTv_SdtTAM08_SITE_Tam08_site_id_Z, false);
         AddObjectProperty("TAM08_SITE_NM_Z", gxTv_SdtTAM08_SITE_Tam08_site_nm_Z, false);
         AddObjectProperty("TAM08_SITE_SNM_Z", gxTv_SdtTAM08_SITE_Tam08_site_snm_Z, false);
         AddObjectProperty("TAM08_OUTER_SITE_ID_Z", gxTv_SdtTAM08_SITE_Tam08_outer_site_id_Z, false);
         AddObjectProperty("TAM08_DEL_FLG_Z", gxTv_SdtTAM08_SITE_Tam08_del_flg_Z, false);
         datetime_STZ = gxTv_SdtTAM08_SITE_Tam08_crt_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TAM08_CRT_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TAM08_CRT_USER_ID_Z", gxTv_SdtTAM08_SITE_Tam08_crt_user_id_Z, false);
         AddObjectProperty("TAM08_CRT_PROG_NM_Z", gxTv_SdtTAM08_SITE_Tam08_crt_prog_nm_Z, false);
         datetime_STZ = gxTv_SdtTAM08_SITE_Tam08_upd_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TAM08_UPD_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TAM08_UPD_USER_ID_Z", gxTv_SdtTAM08_SITE_Tam08_upd_user_id_Z, false);
         AddObjectProperty("TAM08_UPD_PROG_NM_Z", gxTv_SdtTAM08_SITE_Tam08_upd_prog_nm_Z, false);
         AddObjectProperty("TAM08_UPD_CNT_Z", gxTv_SdtTAM08_SITE_Tam08_upd_cnt_Z, false);
         AddObjectProperty("TAM08_SITE_NM_N", gxTv_SdtTAM08_SITE_Tam08_site_nm_N, false);
         AddObjectProperty("TAM08_SITE_SNM_N", gxTv_SdtTAM08_SITE_Tam08_site_snm_N, false);
         AddObjectProperty("TAM08_OUTER_SITE_ID_N", gxTv_SdtTAM08_SITE_Tam08_outer_site_id_N, false);
         AddObjectProperty("TAM08_DEL_FLG_N", gxTv_SdtTAM08_SITE_Tam08_del_flg_N, false);
         AddObjectProperty("TAM08_CRT_DATETIME_N", gxTv_SdtTAM08_SITE_Tam08_crt_datetime_N, false);
         AddObjectProperty("TAM08_CRT_USER_ID_N", gxTv_SdtTAM08_SITE_Tam08_crt_user_id_N, false);
         AddObjectProperty("TAM08_CRT_PROG_NM_N", gxTv_SdtTAM08_SITE_Tam08_crt_prog_nm_N, false);
         AddObjectProperty("TAM08_UPD_DATETIME_N", gxTv_SdtTAM08_SITE_Tam08_upd_datetime_N, false);
         AddObjectProperty("TAM08_UPD_USER_ID_N", gxTv_SdtTAM08_SITE_Tam08_upd_user_id_N, false);
         AddObjectProperty("TAM08_UPD_PROG_NM_N", gxTv_SdtTAM08_SITE_Tam08_upd_prog_nm_N, false);
         AddObjectProperty("TAM08_UPD_CNT_N", gxTv_SdtTAM08_SITE_Tam08_upd_cnt_N, false);
      }
   }
