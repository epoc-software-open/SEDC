/*
       ...
       Generated on: March 3, 2021 14:42:29.26
...
public final  class b402_wp07_crf_list_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20213314422942");
   ...
   public void renderHtmlCloseForm0Z2( )
   {
      ...
      GxWebStd.gx_boolean_hidden_field( httpContext, "vW_REG_ENABEL2", AV36W_REG_ENABEL2);
   ...
   public void strup0Z0( )
   {
      ...
      AV41Pgmname = "B402_WP07_CRF_LIST" ;
      AV40Pgmdesc = "試験登録（CRF一覧）" ;
      Gx_err = (short)(0) ;
   ...
   private void e340Z2( )
   {
      ...
      pr_default.close(2);
      if ( AV36W_REG_ENABEL2 && ( GXutil.strcmp(A643TBM31_STATUS, "1") != 0 ) && ( GXutil.strcmp(A397TBM31_DEL_FLG, "0") == 0 ) )
      {
         lblTxt_crf_copy_Visible = 1 ;
         lblTxt_btn_edit_Visible = 1 ;
         lblTxt_btn_edit_Linktarget = "_designer_"+GXutil.trim( GXutil.str( A68TBM31_STUDY_ID, 10, 0))+"_"+GXutil.trim( GXutil.str( A69TBM31_CRF_ID, 10, 0)) ;
         GXKey = context.getSiteKey( ) ;
   ...
   public void e110Z2( )
   {
      ...
      if ( AV30W_REG_ENABEL )
      {
         ...
         {
            AV43GXV2 = 1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV43GXV2", GXutil.ltrim( GXutil.str( AV43GXV2, 8, 0)));
            while ( AV43GXV2 <= AV21W_A_RESULT_MSG_SDT.size() )
            {
               AV22W_A_RESULT_MSG_SDT_ITEM = (SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem)((SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem)AV21W_A_RESULT_MSG_SDT.elementAt(-1+AV43GXV2));
   ...
   public void e120Z2( )
   {
      ...
      S192 ();
      if (returnInSub) return;
      if ( AV36W_REG_ENABEL2 )
      {
         AV31W_SESSION.setValue(AV41Pgmname+"_PAGE", GXutil.str( AV10H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no(), 10, 0));
         GXKey = context.getSiteKey( ) ;
   ...
   public void S142( )
   {
      ...
      if ( AV17P_MOVE_KBN == 1 )
      {
         ...
         S212 ();
         if (returnInSub) return;
         AV10H_A_PAGING_SDT.setgxTv_SdtA_PAGING_SDT_Page_no( (short)(GXutil.lval( AV31W_SESSION.getValue(AV41Pgmname+"_PAGE"))) );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV10H_A_PAGING_SDT", AV10H_A_PAGING_SDT);
      }
      else
      {
   ...
   public void S152( )
   {
      ...
      AV53GXV4 = 1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV53GXV4", GXutil.ltrim( GXutil.str( AV53GXV4, 8, 0)));
      AV52GXV3 = gxdomainct_del_flg.getValues() ;
      while ( AV53GXV4 <= AV52GXV3.size() )
      {
         AV26W_DEL_FLG = (String)AV52GXV3.elementAt(-1+AV53GXV4) ;
   ...
   public void S202( )
   {
      ...
      AV31W_SESSION.setValue(AV41Pgmname+"_CRF_NM", AV7D_CRF_NM);
      AV31W_SESSION.setValue(AV41Pgmname+"_STATUS", AV9D_STATUS);
      AV31W_SESSION.setValue(AV41Pgmname+"_DEL_FLG", AV8D_DEL_FLG);
      AV31W_SESSION.setValue(AV41Pgmname+"_SRCH_FLG", AV15H_SRCH_FLG);
   }

   public void S232( )
   {
      /* 'SUB_SESSION_GET' Routine */
      AV7D_CRF_NM = AV31W_SESSION.getValue(AV41Pgmname+"_CRF_NM") ;
      httpContext.ajax_rsp_assign_attri("", false, "AV7D_CRF_NM", AV7D_CRF_NM);
      AV9D_STATUS = AV31W_SESSION.getValue(AV41Pgmname+"_STATUS") ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9D_STATUS", AV9D_STATUS);
      AV8D_DEL_FLG = AV31W_SESSION.getValue(AV41Pgmname+"_DEL_FLG") ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8D_DEL_FLG", AV8D_DEL_FLG);
      AV15H_SRCH_FLG = AV31W_SESSION.getValue(AV41Pgmname+"_SRCH_FLG") ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15H_SRCH_FLG", AV15H_SRCH_FLG);
   }
   ...
   public void S222( )
   {
      ...
      AV31W_SESSION.remove(AV41Pgmname+"_CRF_NM");
      AV31W_SESSION.remove(AV41Pgmname+"_STATUS");
      AV31W_SESSION.remove(AV41Pgmname+"_DEL_FLG");
      AV31W_SESSION.remove(AV41Pgmname+"_SRCH_FLG");
   }
   ...
   public void S192( )
   {
      ...
      GXt_boolean7 = AV36W_REG_ENABEL2 ;
      GXv_boolean8[0] = GXt_boolean7 ;
      new a402_pc02_btn_kengn_check(remoteHandle, context).execute( "REG", AV14H_KNGN_FLG, "", GXv_boolean8) ;
      b402_wp07_crf_list_impl.this.GXt_boolean7 = GXv_boolean8[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14H_KNGN_FLG", AV14H_KNGN_FLG);
      AV36W_REG_ENABEL2 = GXt_boolean7 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV36W_REG_ENABEL2", AV36W_REG_ENABEL2);
   }
   ...
   public void S162( )
   {
      ...
      S192 ();
      if (returnInSub) return;
      lblTxt_btn_reg_Visible = (AV36W_REG_ENABEL2 ? 1 : 0) ;
   ...
   public void wb_table11_164_0Z2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         sStyleString = sStyleString + " width: " + GXutil.ltrim( GXutil.str( 1045, 10, 0)) + "px" + ";" ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20213314423665");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b402_wp07_crf_list.js", "?20213314423666");
   ...
   public void sendrow_1832( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_183_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         /* Table start */
         Grid1Row.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {tblTbl_grid_Internalname+"_"+sGXsfl_183_idx,new Integer(1),"TableGridTM-1","","","","","","",new Integer(0),new Integer(1),"",new Integer(1045),"","px","px"});
   ...
   public void initialize( )
   {
      ...
      AV52GXV3 = new GxObjectCollection(String.class, "internal", "");
      AV26W_DEL_FLG = "" ;
   ...
   private boolean AV36W_REG_ENABEL2 ;
   ...
   private GxObjectCollection AV52GXV3 ;
