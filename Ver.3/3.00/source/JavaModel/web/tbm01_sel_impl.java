...
public final  class tbm01_sel_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513304651");
   ...
   public void rf2C2( )
   {
      ...
      if ( (GXutil.strcmp("", httpContext.wjLoc)==0) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A609TBM01_NOTE = H002C2_A609TBM01_NOTE[0] ;
            n609TBM01_NOTE = H002C2_n609TBM01_NOTE[0] ;
            A608TBM01_SYS_VALUE = H002C2_A608TBM01_SYS_VALUE[0] ;
            n608TBM01_SYS_VALUE = H002C2_n608TBM01_SYS_VALUE[0] ;
            A58TBM01_SYS_ID = H002C2_A58TBM01_SYS_ID[0] ;
            /* Execute user event: e122C2 */
            e122C2 ();
   ...
   public int subgrid1_recordcount( )
   {
      ...
      GRID1_nRecordCount = H002C3_AGRID1_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void wb_table1_2_2C2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table2_9_2C2( true) ;
      }
      else
      {
         wb_table2_9_2C2( false) ;
      }
      return  ;
   }

   public void wb_table2_9_2C2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table3_18_2C2( true) ;
      }
      else
      {
         wb_table3_18_2C2( false) ;
      }
      return  ;
   }

   public void wb_table3_18_2C2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</fieldset>") ;
   ...
   public void wb_table3_18_2C2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
      ...
      if ( wbEnd == 21 )
      {
         ...
         wb_table4_28_2C2( true) ;
      }
      else
      {
         wb_table4_28_2C2( false) ;
      }
      return  ;
   }

   public void wb_table4_28_2C2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_18_2C2e( true) ;
      }
      else
      {
         wb_table3_18_2C2e( false) ;
      }
   }

   public void wb_table4_28_2C2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_28_2C2e( true) ;
      }
      else
      {
         wb_table4_28_2C2e( false) ;
      }
   }

   public void wb_table2_9_2C2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_9_2C2e( true) ;
      }
      else
      {
         wb_table2_9_2C2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202071513304681");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tbm01_sel.js", "?202071513304681");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV6cTBM01_SYS_VALUE = "" ;
      H002C2_A609TBM01_NOTE = new String[] {""} ;
      H002C2_n609TBM01_NOTE = new boolean[] {false} ;
      H002C2_A608TBM01_SYS_VALUE = new String[] {""} ;
      H002C2_n608TBM01_SYS_VALUE = new boolean[] {false} ;
      H002C2_A58TBM01_SYS_ID = new String[] {""} ;
      H002C3_AGRID1_nRecordCount = new long[1] ;
      AV9C_TAM02_APP_ID = "" ;
      AV11W_ERRCD = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new tbm01_sel__default(),
         new Object[] {
             new Object[] {
            H002C2_A609TBM01_NOTE, H002C2_n609TBM01_NOTE, H002C2_A608TBM01_SYS_VALUE, H002C2_n608TBM01_SYS_VALUE, H002C2_A58TBM01_SYS_ID
            }
            , new Object[] {
            H002C3_AGRID1_nRecordCount
            }
         }
      );
   ...
   private String[] H002C2_A609TBM01_NOTE ;
   private boolean[] H002C2_n609TBM01_NOTE ;
   private String[] H002C2_A608TBM01_SYS_VALUE ;
   private boolean[] H002C2_n608TBM01_SYS_VALUE ;
   private String[] H002C2_A58TBM01_SYS_ID ;
   private long[] H002C3_AGRID1_nRecordCount ;
...
final  class tbm01_sel__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H002C2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H002C3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
   ...
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H002C3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
