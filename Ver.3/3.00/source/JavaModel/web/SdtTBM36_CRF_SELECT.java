/*
               File: SdtTBM36_CRF_SELECT
        Description: CRF選択マスタ
             Author: GeneXus Java Generator version 10_3_3-92797
       Generated on: July 15, 2020 13:20:50.93
...
public final  class SdtTBM36_CRF_SELECT extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( long AV35TBM36_STUDY_ID ,
                     short AV36TBM36_CRF_ID ,
                     short AV37TBM36_COND_NO ,
                     short AV38TBM36_SELECT_CRF_ID )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {new Long(AV35TBM36_STUDY_ID),new Short(AV36TBM36_CRF_ID),new Short(AV37TBM36_COND_NO),new Short(AV38TBM36_SELECT_CRF_ID)});
   }

   public Object[][] GetBCKey( )
   {
      return (Object[][])(new Object[][]{new Object[]{"TBM36_STUDY_ID", long.class}, new Object[]{"TBM36_CRF_ID", short.class}, new Object[]{"TBM36_COND_NO", short.class}, new Object[]{"TBM36_SELECT_CRF_ID", short.class}}) ;
   }
   ...
   public com.genexus.util.GXProperties getMetadata( )
   {
      ...
      metadata.set("Name", "TBM36_CRF_SELECT");
      metadata.set("BT", "TBM36_CRF_SELECT");
      metadata.set("PK", "[ \"TBM36_STUDY_ID\",\"TBM36_CRF_ID\",\"TBM36_COND_NO\",\"TBM36_SELECT_CRF_ID\" ]");
   ...
   {
      AddObjectProperty("TBM36_STUDY_ID", gxTv_SdtTBM36_CRF_SELECT_Tbm36_study_id, false);
      AddObjectProperty("TBM36_CRF_ID", gxTv_SdtTBM36_CRF_SELECT_Tbm36_crf_id, false);
      AddObjectProperty("TBM36_COND_NO", gxTv_SdtTBM36_CRF_SELECT_Tbm36_cond_no, false);
      AddObjectProperty("TBM36_SELECT_CRF_ID", gxTv_SdtTBM36_CRF_SELECT_Tbm36_select_crf_id, false);
      AddObjectProperty("TBM36_DEL_FLG", gxTv_SdtTBM36_CRF_SELECT_Tbm36_del_flg, false);
      datetime_STZ = gxTv_SdtTBM36_CRF_SELECT_Tbm36_crt_datetime ;
      sDateCnv = "" ;
      ...
      AddObjectProperty("TBM36_CRT_USER_ID", gxTv_SdtTBM36_CRF_SELECT_Tbm36_crt_user_id, false);
      AddObjectProperty("TBM36_CRT_PROG_NM", gxTv_SdtTBM36_CRF_SELECT_Tbm36_crt_prog_nm, false);
      datetime_STZ = gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBM36_UPD_USER_ID", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_user_id, false);
      AddObjectProperty("TBM36_UPD_PROG_NM", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_prog_nm, false);
      AddObjectProperty("TBM36_UPD_CNT", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_cnt, false);
      if ( includeState )
      {
         AddObjectProperty("Mode", gxTv_SdtTBM36_CRF_SELECT_Mode, false);
         AddObjectProperty("Initialized", gxTv_SdtTBM36_CRF_SELECT_Initialized, false);
         AddObjectProperty("TBM36_STUDY_ID_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_study_id_Z, false);
         AddObjectProperty("TBM36_CRF_ID_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_crf_id_Z, false);
         AddObjectProperty("TBM36_COND_NO_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_cond_no_Z, false);
         AddObjectProperty("TBM36_SELECT_CRF_ID_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_select_crf_id_Z, false);
         AddObjectProperty("TBM36_DEL_FLG_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_del_flg_Z, false);
         datetime_STZ = gxTv_SdtTBM36_CRF_SELECT_Tbm36_crt_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBM36_CRT_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBM36_CRT_USER_ID_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_crt_user_id_Z, false);
         AddObjectProperty("TBM36_CRT_PROG_NM_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_crt_prog_nm_Z, false);
         datetime_STZ = gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBM36_UPD_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBM36_UPD_USER_ID_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_user_id_Z, false);
         AddObjectProperty("TBM36_UPD_PROG_NM_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_prog_nm_Z, false);
         AddObjectProperty("TBM36_UPD_CNT_Z", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_cnt_Z, false);
         AddObjectProperty("TBM36_DEL_FLG_N", gxTv_SdtTBM36_CRF_SELECT_Tbm36_del_flg_N, false);
         AddObjectProperty("TBM36_CRT_DATETIME_N", gxTv_SdtTBM36_CRF_SELECT_Tbm36_crt_datetime_N, false);
         AddObjectProperty("TBM36_CRT_USER_ID_N", gxTv_SdtTBM36_CRF_SELECT_Tbm36_crt_user_id_N, false);
         AddObjectProperty("TBM36_CRT_PROG_NM_N", gxTv_SdtTBM36_CRF_SELECT_Tbm36_crt_prog_nm_N, false);
         AddObjectProperty("TBM36_UPD_DATETIME_N", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_datetime_N, false);
         AddObjectProperty("TBM36_UPD_USER_ID_N", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_user_id_N, false);
         AddObjectProperty("TBM36_UPD_PROG_NM_N", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_prog_nm_N, false);
         AddObjectProperty("TBM36_UPD_CNT_N", gxTv_SdtTBM36_CRF_SELECT_Tbm36_upd_cnt_N, false);
      }
   }
