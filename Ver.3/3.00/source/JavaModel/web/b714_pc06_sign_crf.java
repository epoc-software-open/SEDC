/*
               File: B714_PC06_SIGN_CRF
        Description: CRF署名処理
             Author: GeneXus Java Generator version 10_3_3-92797
       Generated on: March 3, 2021 14:42:28.23
...
public final  class b714_pc06_sign_crf extends GXProcedure
{
   public b714_pc06_sign_crf( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( b714_pc06_sign_crf.class ), "" );
   }
   ...
   public String executeUdp( long aP0 ,
                             ...
                             byte[] aP3 )
   {
      b714_pc06_sign_crf.this.AV16P_STUDY_ID = aP0;
      b714_pc06_sign_crf.this.AV14P_B714_SD1_CRF_INFO = aP1;
      b714_pc06_sign_crf.this.AV24P_AUTH_CD = aP2;
      b714_pc06_sign_crf.this.aP3 = aP3;
      b714_pc06_sign_crf.this.aP4 = aP4;
      b714_pc06_sign_crf.this.aP4 = new String[] {""};
      initialize();
      privateExecute();
      return aP4[0];
   }
   ...
   private void privateExecute( )
   {
      ...
      if ( AV21W_RTN_CD == 0 )
      {
         ...
         while ( AV28GXV1 <= AV14P_B714_SD1_CRF_INFO.size() )
         {
            ...
            {
               A449TBT02_DEL_FLG = P007P2_A449TBT02_DEL_FLG[0] ;
               n449TBT02_DEL_FLG = P007P2_n449TBT02_DEL_FLG[0] ;
               A935TBT02_CRF_EDA_NO = P007P2_A935TBT02_CRF_EDA_NO[0] ;
               A91TBT02_CRF_ID = P007P2_A91TBT02_CRF_ID[0] ;
               A90TBT02_SUBJECT_ID = P007P2_A90TBT02_SUBJECT_ID[0] ;
               A89TBT02_STUDY_ID = P007P2_A89TBT02_STUDY_ID[0] ;
               A456TBT02_UPD_CNT = P007P2_A456TBT02_UPD_CNT[0] ;
               n456TBT02_UPD_CNT = P007P2_n456TBT02_UPD_CNT[0] ;
               A499TBT02_CRF_INPUT_LEVEL = P007P2_A499TBT02_CRF_INPUT_LEVEL[0] ;
               n499TBT02_CRF_INPUT_LEVEL = P007P2_n499TBT02_CRF_INPUT_LEVEL[0] ;
               A655TBT02_DM_ARRIVAL_FLG = P007P2_A655TBT02_DM_ARRIVAL_FLG[0] ;
               n655TBT02_DM_ARRIVAL_FLG = P007P2_n655TBT02_DM_ARRIVAL_FLG[0] ;
               A656TBT02_DM_ARRIVAL_DATETIME = P007P2_A656TBT02_DM_ARRIVAL_DATETIME[0] ;
               n656TBT02_DM_ARRIVAL_DATETIME = P007P2_n656TBT02_DM_ARRIVAL_DATETIME[0] ;
               A657TBT02_APPROVAL_FLG = P007P2_A657TBT02_APPROVAL_FLG[0] ;
               n657TBT02_APPROVAL_FLG = P007P2_n657TBT02_APPROVAL_FLG[0] ;
               A658TBT02_APPROVAL_DATETIME = P007P2_A658TBT02_APPROVAL_DATETIME[0] ;
               n658TBT02_APPROVAL_DATETIME = P007P2_n658TBT02_APPROVAL_DATETIME[0] ;
               A659TBT02_APPROVAL_USER_ID = P007P2_A659TBT02_APPROVAL_USER_ID[0] ;
               n659TBT02_APPROVAL_USER_ID = P007P2_n659TBT02_APPROVAL_USER_ID[0] ;
               A660TBT02_APPROVAL_AUTH_CD = P007P2_A660TBT02_APPROVAL_AUTH_CD[0] ;
               n660TBT02_APPROVAL_AUTH_CD = P007P2_n660TBT02_APPROVAL_AUTH_CD[0] ;
               A661TBT02_INPUT_END_FLG = P007P2_A661TBT02_INPUT_END_FLG[0] ;
               n661TBT02_INPUT_END_FLG = P007P2_n661TBT02_INPUT_END_FLG[0] ;
               A662TBT02_INPUT_END_DATETIME = P007P2_A662TBT02_INPUT_END_DATETIME[0] ;
               n662TBT02_INPUT_END_DATETIME = P007P2_n662TBT02_INPUT_END_DATETIME[0] ;
               A663TBT02_INPUT_END_USER_ID = P007P2_A663TBT02_INPUT_END_USER_ID[0] ;
               n663TBT02_INPUT_END_USER_ID = P007P2_n663TBT02_INPUT_END_USER_ID[0] ;
               A664TBT02_INPUT_END_AUTH_CD = P007P2_A664TBT02_INPUT_END_AUTH_CD[0] ;
               n664TBT02_INPUT_END_AUTH_CD = P007P2_n664TBT02_INPUT_END_AUTH_CD[0] ;
               AV29GXLvl37 = (byte)(1) ;
               if ( AV18W_B714_SD1_CRF_INFO_Item.getgxTv_SdtB714_SD1_CRF_INFO_B714_SD1_CRF_INFOItem_Tbt02_upd_cnt() != A456TBT02_UPD_CNT )
               {
                  ...
                  b714_pc06_sign_crf.this.GXt_char1 = GXv_char2[0] ;
               ...
               AV8BC_TBT02_CRF.setgxTv_SdtTBT02_CRF_Tbt02_upload_auth_cd( AV24P_AUTH_CD );
               AV8BC_TBT02_CRF.setgxTv_SdtTBT02_CRF_Tbt02_signature_flg( "1" );
               AV8BC_TBT02_CRF.setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime( AV19W_DATETIME );
               AV8BC_TBT02_CRF.setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id( AV17W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_user_id() );
               ...
               AV9BC_TBT11_CRF_HISTORY.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg( AV8BC_TBT02_CRF.getgxTv_SdtTBT02_CRF_Tbt02_signature_flg() );
               AV9BC_TBT11_CRF_HISTORY.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime( AV8BC_TBT02_CRF.getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime() );
               AV9BC_TBT11_CRF_HISTORY.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id( AV8BC_TBT02_CRF.getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id() );
               AV9BC_TBT11_CRF_HISTORY.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_upd_riyu( "署名" );
               ...
               {
                  A473TBT12_DEL_FLG = P007P3_A473TBT12_DEL_FLG[0] ;
                  n473TBT12_DEL_FLG = P007P3_n473TBT12_DEL_FLG[0] ;
                  A937TBT12_CRF_EDA_NO = P007P3_A937TBT12_CRF_EDA_NO[0] ;
                  A98TBT12_CRF_ID = P007P3_A98TBT12_CRF_ID[0] ;
                  A97TBT12_SUBJECT_ID = P007P3_A97TBT12_SUBJECT_ID[0] ;
                  A96TBT12_STUDY_ID = P007P3_A96TBT12_STUDY_ID[0] ;
                  A99TBT12_CRF_ITEM_GRP_DIV = P007P3_A99TBT12_CRF_ITEM_GRP_DIV[0] ;
                  A100TBT12_CRF_ITEM_GRP_CD = P007P3_A100TBT12_CRF_ITEM_GRP_CD[0] ;
                  A465TBT12_CRF_VALUE = P007P3_A465TBT12_CRF_VALUE[0] ;
                  n465TBT12_CRF_VALUE = P007P3_n465TBT12_CRF_VALUE[0] ;
               ...
               if ( AV21W_RTN_CD == 0 )
               {
                  ...
                  AV23W_LOGTEXT = AV23W_LOGTEXT + "UPD_RIYU:" + "署名" + GXutil.chr( (short)(9)) ;
   ...
   public void S111( )
   {
      ...
      b714_pc06_sign_crf.this.AV20W_ERRCD = GXv_char2[0] ;
      ...
      b714_pc06_sign_crf.this.AV11C_DM_AUTH_CD = GXv_char2[0] ;
      b714_pc06_sign_crf.this.AV12C_DM_INPUT_LEVEL = GXv_int4[0] ;
   ...
   public void S121( )
   {
      ...
      {
         A369TBM21_DEL_FLG = P007P4_A369TBM21_DEL_FLG[0] ;
         n369TBM21_DEL_FLG = P007P4_n369TBM21_DEL_FLG[0] ;
         A63TBM21_STUDY_ID = P007P4_A63TBM21_STUDY_ID[0] ;
         A607TBM21_STATUS = P007P4_A607TBM21_STATUS[0] ;
         n607TBM21_STATUS = P007P4_n607TBM21_STATUS[0] ;
         AV32GXLvl211 = (byte)(1) ;
   ...
   public void S161( )
   {
      ...
      if ( AV21W_RTN_CD == 0 )
      {
         Application.commit(context, remoteHandle, "DEFAULT", "b714_pc06_sign_crf");
      }
      else
      {
         Application.rollback(context, remoteHandle, "DEFAULT", "b714_pc06_sign_crf");
      }
   }

   protected void cleanup( )
   {
      this.aP3[0] = b714_pc06_sign_crf.this.AV21W_RTN_CD;
      this.aP4[0] = b714_pc06_sign_crf.this.AV22W_RTN_MSG;
      CloseOpenCursors();
      exitApplication();
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      P007P2_A449TBT02_DEL_FLG = new String[] {""} ;
      P007P2_n449TBT02_DEL_FLG = new boolean[] {false} ;
      P007P2_A935TBT02_CRF_EDA_NO = new byte[1] ;
      P007P2_A91TBT02_CRF_ID = new short[1] ;
      P007P2_A90TBT02_SUBJECT_ID = new int[1] ;
      P007P2_A89TBT02_STUDY_ID = new long[1] ;
      P007P2_A456TBT02_UPD_CNT = new long[1] ;
      P007P2_n456TBT02_UPD_CNT = new boolean[] {false} ;
      P007P2_A499TBT02_CRF_INPUT_LEVEL = new byte[1] ;
      P007P2_n499TBT02_CRF_INPUT_LEVEL = new boolean[] {false} ;
      P007P2_A655TBT02_DM_ARRIVAL_FLG = new String[] {""} ;
      P007P2_n655TBT02_DM_ARRIVAL_FLG = new boolean[] {false} ;
      P007P2_A656TBT02_DM_ARRIVAL_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P007P2_n656TBT02_DM_ARRIVAL_DATETIME = new boolean[] {false} ;
      P007P2_A657TBT02_APPROVAL_FLG = new String[] {""} ;
      P007P2_n657TBT02_APPROVAL_FLG = new boolean[] {false} ;
      P007P2_A658TBT02_APPROVAL_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P007P2_n658TBT02_APPROVAL_DATETIME = new boolean[] {false} ;
      P007P2_A659TBT02_APPROVAL_USER_ID = new String[] {""} ;
      P007P2_n659TBT02_APPROVAL_USER_ID = new boolean[] {false} ;
      P007P2_A660TBT02_APPROVAL_AUTH_CD = new String[] {""} ;
      P007P2_n660TBT02_APPROVAL_AUTH_CD = new boolean[] {false} ;
      P007P2_A661TBT02_INPUT_END_FLG = new String[] {""} ;
      P007P2_n661TBT02_INPUT_END_FLG = new boolean[] {false} ;
      P007P2_A662TBT02_INPUT_END_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P007P2_n662TBT02_INPUT_END_DATETIME = new boolean[] {false} ;
      P007P2_A663TBT02_INPUT_END_USER_ID = new String[] {""} ;
      P007P2_n663TBT02_INPUT_END_USER_ID = new boolean[] {false} ;
      P007P2_A664TBT02_INPUT_END_AUTH_CD = new String[] {""} ;
      P007P2_n664TBT02_INPUT_END_AUTH_CD = new boolean[] {false} ;
      A449TBT02_DEL_FLG = "" ;
      ...
      P007P3_A473TBT12_DEL_FLG = new String[] {""} ;
      P007P3_n473TBT12_DEL_FLG = new boolean[] {false} ;
      P007P3_A937TBT12_CRF_EDA_NO = new byte[1] ;
      P007P3_A98TBT12_CRF_ID = new short[1] ;
      P007P3_A97TBT12_SUBJECT_ID = new int[1] ;
      P007P3_A96TBT12_STUDY_ID = new long[1] ;
      P007P3_A99TBT12_CRF_ITEM_GRP_DIV = new String[] {""} ;
      P007P3_A100TBT12_CRF_ITEM_GRP_CD = new String[] {""} ;
      P007P3_A465TBT12_CRF_VALUE = new String[] {""} ;
      P007P3_n465TBT12_CRF_VALUE = new boolean[] {false} ;
      A473TBT12_DEL_FLG = "" ;
      ...
      GXv_int4 = new byte [1] ;
      A607TBM21_STATUS = "" ;
      P007P4_A369TBM21_DEL_FLG = new String[] {""} ;
      P007P4_n369TBM21_DEL_FLG = new boolean[] {false} ;
      P007P4_A63TBM21_STUDY_ID = new long[1] ;
      P007P4_A607TBM21_STATUS = new String[] {""} ;
      P007P4_n607TBM21_STATUS = new boolean[] {false} ;
      A369TBM21_DEL_FLG = "" ;
      GXt_char1 = "" ;
      GXv_char2 = new String [1] ;
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new b714_pc06_sign_crf__default(),
         new Object[] {
             new Object[] {
            P007P2_A449TBT02_DEL_FLG, P007P2_n449TBT02_DEL_FLG, P007P2_A935TBT02_CRF_EDA_NO, P007P2_A91TBT02_CRF_ID, P007P2_A90TBT02_SUBJECT_ID, P007P2_A89TBT02_STUDY_ID, P007P2_A456TBT02_UPD_CNT, P007P2_n456TBT02_UPD_CNT, P007P2_A499TBT02_CRF_INPUT_LEVEL, P007P2_n499TBT02_CRF_INPUT_LEVEL,
            P007P2_A655TBT02_DM_ARRIVAL_FLG, P007P2_n655TBT02_DM_ARRIVAL_FLG, P007P2_A656TBT02_DM_ARRIVAL_DATETIME, P007P2_n656TBT02_DM_ARRIVAL_DATETIME, P007P2_A657TBT02_APPROVAL_FLG, P007P2_n657TBT02_APPROVAL_FLG, P007P2_A658TBT02_APPROVAL_DATETIME, P007P2_n658TBT02_APPROVAL_DATETIME, P007P2_A659TBT02_APPROVAL_USER_ID, P007P2_n659TBT02_APPROVAL_USER_ID,
            P007P2_A660TBT02_APPROVAL_AUTH_CD, P007P2_n660TBT02_APPROVAL_AUTH_CD, P007P2_A661TBT02_INPUT_END_FLG, P007P2_n661TBT02_INPUT_END_FLG, P007P2_A662TBT02_INPUT_END_DATETIME, P007P2_n662TBT02_INPUT_END_DATETIME, P007P2_A663TBT02_INPUT_END_USER_ID, P007P2_n663TBT02_INPUT_END_USER_ID, P007P2_A664TBT02_INPUT_END_AUTH_CD, P007P2_n664TBT02_INPUT_END_AUTH_CD
            }
            , new Object[] {
            P007P3_A473TBT12_DEL_FLG, P007P3_n473TBT12_DEL_FLG, P007P3_A937TBT12_CRF_EDA_NO, P007P3_A98TBT12_CRF_ID, P007P3_A97TBT12_SUBJECT_ID, P007P3_A96TBT12_STUDY_ID, P007P3_A99TBT12_CRF_ITEM_GRP_DIV, P007P3_A100TBT12_CRF_ITEM_GRP_CD, P007P3_A465TBT12_CRF_VALUE, P007P3_n465TBT12_CRF_VALUE
            }
            , new Object[] {
            P007P4_A369TBM21_DEL_FLG, P007P4_n369TBM21_DEL_FLG, P007P4_A63TBM21_STUDY_ID, P007P4_A607TBM21_STATUS, P007P4_n607TBM21_STATUS
            }
         }
      );
      pr_default.setErrorHandler(this);
      AV30Pgmname = "B714_PC06_SIGN_CRF" ;
      /* GeneXus formulas. */
      AV30Pgmname = "B714_PC06_SIGN_CRF" ;
      Gx_err = (short)(0) ;
   }
   ...
   private String[] P007P2_A449TBT02_DEL_FLG ;
   private boolean[] P007P2_n449TBT02_DEL_FLG ;
   private byte[] P007P2_A935TBT02_CRF_EDA_NO ;
   private short[] P007P2_A91TBT02_CRF_ID ;
   private int[] P007P2_A90TBT02_SUBJECT_ID ;
   private long[] P007P2_A89TBT02_STUDY_ID ;
   private long[] P007P2_A456TBT02_UPD_CNT ;
   private boolean[] P007P2_n456TBT02_UPD_CNT ;
   private byte[] P007P2_A499TBT02_CRF_INPUT_LEVEL ;
   private boolean[] P007P2_n499TBT02_CRF_INPUT_LEVEL ;
   private String[] P007P2_A655TBT02_DM_ARRIVAL_FLG ;
   private boolean[] P007P2_n655TBT02_DM_ARRIVAL_FLG ;
   private java.util.Date[] P007P2_A656TBT02_DM_ARRIVAL_DATETIME ;
   private boolean[] P007P2_n656TBT02_DM_ARRIVAL_DATETIME ;
   private String[] P007P2_A657TBT02_APPROVAL_FLG ;
   private boolean[] P007P2_n657TBT02_APPROVAL_FLG ;
   private java.util.Date[] P007P2_A658TBT02_APPROVAL_DATETIME ;
   private boolean[] P007P2_n658TBT02_APPROVAL_DATETIME ;
   private String[] P007P2_A659TBT02_APPROVAL_USER_ID ;
   private boolean[] P007P2_n659TBT02_APPROVAL_USER_ID ;
   private String[] P007P2_A660TBT02_APPROVAL_AUTH_CD ;
   private boolean[] P007P2_n660TBT02_APPROVAL_AUTH_CD ;
   private String[] P007P2_A661TBT02_INPUT_END_FLG ;
   private boolean[] P007P2_n661TBT02_INPUT_END_FLG ;
   private java.util.Date[] P007P2_A662TBT02_INPUT_END_DATETIME ;
   private boolean[] P007P2_n662TBT02_INPUT_END_DATETIME ;
   private String[] P007P2_A663TBT02_INPUT_END_USER_ID ;
   private boolean[] P007P2_n663TBT02_INPUT_END_USER_ID ;
   private String[] P007P2_A664TBT02_INPUT_END_AUTH_CD ;
   private boolean[] P007P2_n664TBT02_INPUT_END_AUTH_CD ;
   private String[] P007P3_A473TBT12_DEL_FLG ;
   private boolean[] P007P3_n473TBT12_DEL_FLG ;
   private byte[] P007P3_A937TBT12_CRF_EDA_NO ;
   private short[] P007P3_A98TBT12_CRF_ID ;
   private int[] P007P3_A97TBT12_SUBJECT_ID ;
   private long[] P007P3_A96TBT12_STUDY_ID ;
   private String[] P007P3_A99TBT12_CRF_ITEM_GRP_DIV ;
   private String[] P007P3_A100TBT12_CRF_ITEM_GRP_CD ;
   private String[] P007P3_A465TBT12_CRF_VALUE ;
   private boolean[] P007P3_n465TBT12_CRF_VALUE ;
   private String[] P007P4_A369TBM21_DEL_FLG ;
   private boolean[] P007P4_n369TBM21_DEL_FLG ;
   private long[] P007P4_A63TBM21_STUDY_ID ;
   private String[] P007P4_A607TBM21_STATUS ;
   private boolean[] P007P4_n607TBM21_STATUS ;
