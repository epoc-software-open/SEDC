...
public final  class ab706_pc01_reg_crf_impl extends GXWebProcedure
{
   ...
   public void webExecute( )
   {
      ...
      if ( ! entryPointCalled )
      {
         ...
         if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
         {
            ...
            AV48P_SIGNATURE_FLG = httpContext.GetNextPar( ) ;
            AV49P_SIGNATURE_USER_ID = httpContext.GetNextPar( ) ;
         }
      }
      /* GeneXus formulas */
   ...
   private void privateExecute( )
   {
      ...
      AV56GXV1 = 1 ;
      while ( AV56GXV1 <= AV22SD_B792_SD01_CRF.getgxTv_SdtB792_SD01_CRF_Crf_results().size() )
      {
         AV23SD_B792_SD02_CRF_RESULT_I = (SdtB792_SD02_CRF_RESULT_B792_SD02_CRF_RESULTItem)((SdtB792_SD02_CRF_RESULT_B792_SD02_CRF_RESULTItem)AV22SD_B792_SD01_CRF.getgxTv_SdtB792_SD01_CRF_Crf_results().elementAt(-1+AV56GXV1));
   ...
   public void S111( )
   {
      ...
      else
      {
         ...
         GXv_char9[0] = AV50W_SIGNATURE_FLG ;
         GXv_dtime10[0] = AV53W_SIGNATURE_DATETIME ;
         GXv_char11[0] = AV51W_SIGNATURE_USER_ID ;
         GXv_char12[0] = AV52W_SIGNATURE_USER_NM ;
         GXv_int1[0] = AV42W_TBM31_GRID_SIZE ;
         GXv_char13[0] = AV27W_ERR_FLG ;
         GXv_char14[0] = AV28W_ERR_MSG ;
         new b702_pc02_header_set(remoteHandle, context).execute( AV24W_A_LOGIN_SDT, AV21SD_B792_SD00_HTML5_EXEC_INFO.getgxTv_SdtB792_SD00_HTML5_EXEC_INFO_Exec_kbn(), AV16P_STUDY_ID, AV17P_SUBJECT_ID, AV12P_CRF_ID, AV46P_CRF_EDA_NO, AV21SD_B792_SD00_HTML5_EXEC_INFO.getgxTv_SdtB792_SD00_HTML5_EXEC_INFO_Auth_cd(), GXv_char5, GXv_char4, GXv_char6, GXv_char7, GXv_char8, GXv_char9, GXv_dtime10, GXv_char11, GXv_char12, GXv_int1, GXv_char13, GXv_char14) ;
         ...
         ab706_pc01_reg_crf_impl.this.AV50W_SIGNATURE_FLG = GXv_char9[0] ;
         ab706_pc01_reg_crf_impl.this.AV53W_SIGNATURE_DATETIME = GXv_dtime10[0] ;
         ab706_pc01_reg_crf_impl.this.AV51W_SIGNATURE_USER_ID = GXv_char11[0] ;
         ab706_pc01_reg_crf_impl.this.AV52W_SIGNATURE_USER_NM = GXv_char12[0] ;
         ab706_pc01_reg_crf_impl.this.AV42W_TBM31_GRID_SIZE = GXv_int1[0] ;
         ab706_pc01_reg_crf_impl.this.AV27W_ERR_FLG = GXv_char13[0] ;
         ab706_pc01_reg_crf_impl.this.AV28W_ERR_MSG = GXv_char14[0] ;
         if ( GXutil.strcmp(AV27W_ERR_FLG, "0") == 0 )
         {
            ...
            {
               if ( ! (GXutil.strcmp("", AV49P_SIGNATURE_USER_ID)==0) && ( GXutil.strcmp(AV49P_SIGNATURE_USER_ID, AV51W_SIGNATURE_USER_ID) != 0 ) )
               {
                  AV36W_REG_FLG = "1" ;
               }
            }
            ...
            {
               AV57GXV2 = 1 ;
               while ( AV57GXV2 <= AV22SD_B792_SD01_CRF.getgxTv_SdtB792_SD01_CRF_Crf_results().size() )
               {
                  AV23SD_B792_SD02_CRF_RESULT_I = (SdtB792_SD02_CRF_RESULT_B792_SD02_CRF_RESULTItem)((SdtB792_SD02_CRF_RESULT_B792_SD02_CRF_RESULTItem)AV22SD_B792_SD01_CRF.getgxTv_SdtB792_SD01_CRF_Crf_results().elementAt(-1+AV57GXV2));
   ...
   public void S121( )
   {
      ...
      while ( (pr_default.getStatus(0) != 101) )
      {
         ...
         A990TBT02_SIGNATURE_FLG = P005V2_A990TBT02_SIGNATURE_FLG[0] ;
         n990TBT02_SIGNATURE_FLG = P005V2_n990TBT02_SIGNATURE_FLG[0] ;
         A991TBT02_SIGNATURE_DATETIME = P005V2_A991TBT02_SIGNATURE_DATETIME[0] ;
         n991TBT02_SIGNATURE_DATETIME = P005V2_n991TBT02_SIGNATURE_DATETIME[0] ;
         A992TBT02_SIGNATURE_USER_ID = P005V2_A992TBT02_SIGNATURE_USER_ID[0] ;
         n992TBT02_SIGNATURE_USER_ID = P005V2_n992TBT02_SIGNATURE_USER_ID[0] ;
         ...
         if ( ( GXutil.strcmp(AV14P_DM_ARRIVAL_FLG, "1") == 0 ) || ( GXutil.strcmp(A655TBT02_DM_ARRIVAL_FLG, "1") == 0 ) )
         {
            if ( GXutil.strcmp(AV48P_SIGNATURE_FLG, "1") == 0 )
            {
               A990TBT02_SIGNATURE_FLG = AV48P_SIGNATURE_FLG ;
               n990TBT02_SIGNATURE_FLG = false ;
               A991TBT02_SIGNATURE_DATETIME = GXutil.now( ) ;
               n991TBT02_SIGNATURE_DATETIME = false ;
               A992TBT02_SIGNATURE_USER_ID = AV49P_SIGNATURE_USER_ID ;
         ...
         A455TBT02_UPD_PROG_NM = AV59Pgmname ;
         ...
         */
         ...
         A993TBT11_SIGNATURE_FLG = A990TBT02_SIGNATURE_FLG ;
         n993TBT11_SIGNATURE_FLG = false ;
         A994TBT11_SIGNATURE_DATETIME = A991TBT02_SIGNATURE_DATETIME ;
         n994TBT11_SIGNATURE_DATETIME = false ;
         A995TBT11_SIGNATURE_USER_ID = A992TBT02_SIGNATURE_USER_ID ;
         ...
         A460TBT11_CRT_PROG_NM = AV59Pgmname ;
         ...
         A463TBT11_UPD_PROG_NM = AV59Pgmname ;
         ...
         if ( (pr_default.getStatus(2) == 1) )
         {
            ...
            GXt_char15 = AV28W_ERR_MSG ;
            GXv_char14[0] = GXt_char15 ;
            new a805_pc01_msg_get(remoteHandle, context).execute( "AE00023", "CRFèCê≥óöó", "", "", "", "", GXv_char14) ;
            ab706_pc01_reg_crf_impl.this.GXt_char15 = GXv_char14[0] ;
            AV28W_ERR_MSG = GXt_char15 ;
         }
         else
         ...
         new a804_pc03_datalog(remoteHandle, context).execute( AV59Pgmname, "UPD", AV31W_LOGTEXT) ;
         /* Exit For each command. Update data (if necessary), close cursors & exit. */
         /* Using cursor P005V5 */
   ...
   public void S131( )
   {
      ...
      AV60GXV3 = 1 ;
      while ( AV60GXV3 <= AV22SD_B792_SD01_CRF.getgxTv_SdtB792_SD01_CRF_Crf_results().size() )
      {
         AV23SD_B792_SD02_CRF_RESULT_I = (SdtB792_SD02_CRF_RESULT_B792_SD02_CRF_RESULTItem)((SdtB792_SD02_CRF_RESULT_B792_SD02_CRF_RESULTItem)AV22SD_B792_SD01_CRF.getgxTv_SdtB792_SD01_CRF_Crf_results().elementAt(-1+AV60GXV3));
         if ( ! (GXutil.strcmp("", AV23SD_B792_SD02_CRF_RESULT_I.getgxTv_SdtB792_SD02_CRF_RESULT_B792_SD02_CRF_RESULTItem_Tbt12_crf_item_grp_cd())==0) )
         {
            ...
            while ( (pr_default.getStatus(5) != 101) )
            {
               ...
               A471TBT12_UPD_PROG_NM = AV59Pgmname ;
            ...
            if ( AV61GXLvl335 == 0 )
            {
               ...
               */
               ...
               A468TBT12_CRT_PROG_NM = AV59Pgmname ;
               ...
               if ( (pr_default.getStatus(8) == 1) )
               {
                  ...
                  GXt_char15 = AV28W_ERR_MSG ;
                  GXv_char14[0] = GXt_char15 ;
                  new a805_pc01_msg_get(remoteHandle, context).execute( "AE00023", "CRFì¸óÕåãâ ", "", "", "", "", GXv_char14) ;
                  ab706_pc01_reg_crf_impl.this.GXt_char15 = GXv_char14[0] ;
                  AV28W_ERR_MSG = GXt_char15 ;
               }
               else
            ...
            */
            ...
            A601TBT13_CRT_PROG_NM = AV59Pgmname ;
            ...
            A604TBT13_UPD_PROG_NM = AV59Pgmname ;
            ...
            if ( ! (GXutil.strcmp("", AV45W_MODE)==0) )
            {
               ...
               AV31W_LOGTEXT = GXutil.strReplace( AV31W_LOGTEXT, GXutil.chr( (short)(13))+GXutil.chr( (short)(10)), "@br@") ;
               new a804_pc03_datalog(remoteHandle, context).execute( AV59Pgmname, AV45W_MODE, AV31W_LOGTEXT) ;
            }
         }
   ...
   public void S151( )
   {
      /* 'SUB_INIT' Routine */
      GXActiveErrHndl = 1 ;
      GXv_SdtA_LOGIN_SDT16[0] = AV24W_A_LOGIN_SDT;
      GXv_char14[0] = AV29W_ERRCD ;
      new a401_pc01_login_check(remoteHandle, context).execute( GXv_SdtA_LOGIN_SDT16, GXv_char14) ;
      AV24W_A_LOGIN_SDT = GXv_SdtA_LOGIN_SDT16[0] ;
      ab706_pc01_reg_crf_impl.this.AV29W_ERRCD = GXv_char14[0] ;
      ...
      GXv_char14[0] = AV8C_DM_AUTH_CD ;
      GXv_int2[0] = (byte)(AV9C_DM_INPUT_LEVEL) ;
      new b799_pc06_dm_info_get(remoteHandle, context).execute( GXv_char14, GXv_int2) ;
      ab706_pc01_reg_crf_impl.this.AV8C_DM_AUTH_CD = GXv_char14[0] ;
      ab706_pc01_reg_crf_impl.this.AV9C_DM_INPUT_LEVEL = GXv_int2[0] ;
      GXt_char15 = AV39W_SESSION_KEY ;
      GXv_char14[0] = GXt_char15 ;
      new b799_pc01_get_session_key(remoteHandle, context).execute( (short)(1), AV24W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_user_id(), GXv_char14) ;
      ab706_pc01_reg_crf_impl.this.GXt_char15 = GXv_char14[0] ;
      AV39W_SESSION_KEY = GXt_char15 ;
      AV21SD_B792_SD00_HTML5_EXEC_INFO.fromxml(AV38W_SESSION.getValue(AV39W_SESSION_KEY), "");
      new a804_pc02_log_start(remoteHandle, context).execute( AV59Pgmname) ;
   }
   ...
   public void initialize( )
   {
      ...
      AV53W_SIGNATURE_DATETIME = GXutil.resetTime( GXutil.nullDate() );
      GXv_dtime10 = new java.util.Date [1] ;
      AV51W_SIGNATURE_USER_ID = "" ;
      GXv_char11 = new String [1] ;
      AV52W_SIGNATURE_USER_NM = "" ;
      ...
      P005V2_A990TBT02_SIGNATURE_FLG = new String[] {""} ;
      P005V2_n990TBT02_SIGNATURE_FLG = new boolean[] {false} ;
      P005V2_A991TBT02_SIGNATURE_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P005V2_n991TBT02_SIGNATURE_DATETIME = new boolean[] {false} ;
      P005V2_A992TBT02_SIGNATURE_USER_ID = new String[] {""} ;
      P005V2_n992TBT02_SIGNATURE_USER_ID = new boolean[] {false} ;
      ...
      GXv_SdtA_LOGIN_SDT16 = new SdtA_LOGIN_SDT [1] ;
      AV29W_ERRCD = "" ;
      AV8C_DM_AUTH_CD = "" ;
      GXv_int2 = new byte [1] ;
      AV39W_SESSION_KEY = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new ab706_pc01_reg_crf__default(),
         new Object[] {
            ...
            P005V2_A663TBT02_INPUT_END_USER_ID, P005V2_n663TBT02_INPUT_END_USER_ID, P005V2_A664TBT02_INPUT_END_AUTH_CD, P005V2_n664TBT02_INPUT_END_AUTH_CD, P005V2_A990TBT02_SIGNATURE_FLG, P005V2_n990TBT02_SIGNATURE_FLG, P005V2_A991TBT02_SIGNATURE_DATETIME, P005V2_n991TBT02_SIGNATURE_DATETIME, P005V2_A992TBT02_SIGNATURE_USER_ID, P005V2_n992TBT02_SIGNATURE_USER_ID,
            P005V2_A449TBT02_DEL_FLG, P005V2_n449TBT02_DEL_FLG, P005V2_A456TBT02_UPD_CNT, P005V2_n456TBT02_UPD_CNT, P005V2_A453TBT02_UPD_DATETIME, P005V2_n453TBT02_UPD_DATETIME, P005V2_A454TBT02_UPD_USER_ID, P005V2_n454TBT02_UPD_USER_ID, P005V2_A455TBT02_UPD_PROG_NM, P005V2_n455TBT02_UPD_PROG_NM
            }
            , new Object[] {
            }
            , new Object[] {
      ...
      AV59Pgmname = "AB706_PC01_REG_CRF" ;
      /* GeneXus formulas. */
      AV59Pgmname = "AB706_PC01_REG_CRF" ;
      Gx_err = (short)(0) ;
   }
   ...
   private java.util.Date AV53W_SIGNATURE_DATETIME ;
   ...
   private String AV48P_SIGNATURE_FLG ;
   private String AV49P_SIGNATURE_USER_ID ;
   ...
   private String AV50W_SIGNATURE_FLG ;
   private String AV51W_SIGNATURE_USER_ID ;
   private String AV52W_SIGNATURE_USER_NM ;
   ...
   private String[] P005V2_A990TBT02_SIGNATURE_FLG ;
   private boolean[] P005V2_n990TBT02_SIGNATURE_FLG ;
   private java.util.Date[] P005V2_A991TBT02_SIGNATURE_DATETIME ;
   private boolean[] P005V2_n991TBT02_SIGNATURE_DATETIME ;
   private String[] P005V2_A992TBT02_SIGNATURE_USER_ID ;
   private boolean[] P005V2_n992TBT02_SIGNATURE_USER_ID ;
   ...
   private SdtA_LOGIN_SDT GXv_SdtA_LOGIN_SDT16[] ;
}
