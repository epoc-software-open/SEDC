/*
       ...
       Generated on: July 15, 2020 13:20:27.75
...
public final  class b202_pc01_image_mst_chk extends GXProcedure
{
   ...
   public void S111( )
   {
      ...
      if ( ! (GXutil.strcmp("", AV9P_BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_image_cd())==0) )
      {
         if ( GXutil.strcmp(AV9P_BC_IMAGE.GetMode(), "INS") == 0 )
         {
            ...
            {
               A62TBM11_IMAGE_CD = P00562_A62TBM11_IMAGE_CD[0] ;
         ...
         else
         {
            ...
            {
               A62TBM11_IMAGE_CD = P00563_A62TBM11_IMAGE_CD[0] ;
               A539TBM11_UPD_DATETIME = P00563_A539TBM11_UPD_DATETIME[0] ;
               n539TBM11_UPD_DATETIME = P00563_n539TBM11_UPD_DATETIME[0] ;
               AV31GXLvl77 = (byte)(1) ;
               if ( !( AV9P_BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_upd_datetime().equals( A539TBM11_UPD_DATETIME ) ) )
               {
                  AV13W_A_CHK_RESULT_SDT_ITEM = (SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem)new SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem(remoteHandle, context);
                  AV13W_A_CHK_RESULT_SDT_ITEM.setgxTv_SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem_Id( "TBM11_IMAGE_CD" );
   ...
   public void S141( )
   {
      ...
      if ( ! (0==AV9P_BC_IMAGE.getgxTv_SdtTBM11_IMAGE_Tbm11_study_id()) )
      {
         ...
         {
            A63TBM21_STUDY_ID = P00564_A63TBM21_STUDY_ID[0] ;
            AV33GXLvl199 = (byte)(1) ;
   ...
   {
      AV12W_A_CHK_RESULT_SDT = new GxObjectCollection(SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem.class, "A_CHK_RESULT_SDT.A_CHK_RESULT_SDTItem", "tablet-EDC_GXXEV3U3", remoteHandle);
      AV15W_A_RESULT_MSG_SDT = new GxObjectCollection(SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem.class, "A_RESULT_MSG_SDT.A_RESULT_MSG_SDTItem", "tablet-EDC_GXXEV3U3", remoteHandle);
      AV8C_APP_ID = "" ;
      AV10W_A_CHK_INFO_SDT = new GxObjectCollection(SdtA_CHK_INFO_SDT_A_CHK_INFO_SDTItem.class, "A_CHK_INFO_SDT.A_CHK_INFO_SDTItem", "tablet-EDC_GXXEV3U3", remoteHandle);
      A539TBM11_UPD_DATETIME = GXutil.resetTime( GXutil.nullDate() );
      scmdbuf = "" ;
      P00562_A62TBM11_IMAGE_CD = new String[] {""} ;
      A62TBM11_IMAGE_CD = "" ;
      ...
      P00563_A62TBM11_IMAGE_CD = new String[] {""} ;
      P00563_A539TBM11_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P00563_n539TBM11_UPD_DATETIME = new boolean[] {false} ;
      ...
      P00564_A63TBM21_STUDY_ID = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b202_pc01_image_mst_chk__default(),
         new Object[] {
             new Object[] {
            P00562_A62TBM11_IMAGE_CD
            }
            , new Object[] {
            P00563_A62TBM11_IMAGE_CD, P00563_A539TBM11_UPD_DATETIME, P00563_n539TBM11_UPD_DATETIME
            }
            , new Object[] {
            P00564_A63TBM21_STUDY_ID
            }
         }
      );
   ...
   private String[] P00562_A62TBM11_IMAGE_CD ;
   private String[] P00563_A62TBM11_IMAGE_CD ;
   private java.util.Date[] P00563_A539TBM11_UPD_DATETIME ;
   private boolean[] P00563_n539TBM11_UPD_DATETIME ;
   private long[] P00564_A63TBM21_STUDY_ID ;
