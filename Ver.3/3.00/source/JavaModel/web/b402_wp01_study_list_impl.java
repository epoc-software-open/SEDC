...
public final  class b402_wp01_study_list_impl extends GXWebPanel
{
   ...
   public void e290X2( )
   {
      ...
      {
         new a804_pc01_syslog(remoteHandle, context).execute( AV41Pgmname, "INFO", "âÊñ ãNìÆ") ;
   ...
   public void S182( )
   {
      ...
      else
      {
         ...
         httpContext.ajax_rsp_assign_prop("", false, tblTbl_list_Internalname, "Visible", GXutil.ltrim( GXutil.str( tblTbl_list_Visible, 5, 0)));
         lblTxt_rec_cnt_Caption = "(ëS"+GXutil.trim( GXutil.str( subgrid2_recordcount( ), 10, 0))+"åè)" ;
   ...
   public void sendrow_1622( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_162_idx <= subgrid2_recordsperpage( ) * 1 ) )
      {
         ...
         /* Text block */
         Grid2Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {lblBtn_sel2_Internalname,"ëIë","","",lblBtn_sel2_Jsonclick,"'"+""+"'"+",false,"+"'"+"E\\'BTN_SEL\\'."+sGXsfl_162_idx+"'","","TextBlockBtn040s",new Integer(5),"",new Integer(1),new Integer(1),new Integer(0)});
         if ( Grid2Container.GetWrapped() == 1 )
         {
