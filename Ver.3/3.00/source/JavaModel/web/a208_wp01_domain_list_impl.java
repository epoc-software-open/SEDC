...
public final  class a208_wp01_domain_list_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20207151330257");
   ...
   public void renderHtmlCloseForm1T2( )
   {
      ...
      GxWebStd.gx_hidden_field( httpContext, "GXH_vH_SORT_ASDC_KBN", GXutil.ltrim( localUtil.ntoc( AV33H_SORT_ASDC_KBN, (byte)(4), (byte)(0), ".", "")));
      GxWebStd.gx_hidden_field( httpContext, "GXH_vH_SORT_ITEM_KBN", GXutil.ltrim( localUtil.ntoc( AV34H_SORT_ITEM_KBN, (byte)(4), (byte)(0), ".", "")));
      /* Send saved values. */
      if ( httpContext.isAjaxRequest( ) )
      {
   ...
   public void wb_table1_2_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_204_1T2( true) ;
      }
      else
      {
         wb_table2_204_1T2( false) ;
      }
      return  ;
   }

   public void wb_table2_204_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
   ...
   public void start1T2( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         OldWebcomp2 = httpContext.cgiGet( "W0202") ;
         if ( (GXutil.strcmp("", WebComp_Webcomp2_Component)==0) && ! (GXutil.strcmp("", OldWebcomp2)==0) )
         {
            WebComp_Webcomp2 = WebUtils.getWebComponent(getClass(), "" + OldWebcomp2 + "_impl", remoteHandle, context);
            WebComp_Webcomp2_Component = OldWebcomp2 ;
            WebComp_Webcomp2.componentrestorestate("W0202", "");
         }
      }
      wbErr = false ;
      strup1T0( ) ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
                        ...
                        if ( GXutil.strcmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                           {
                              ...
                              if ( ! wbErr )
                              {
                                 ...
                                 if ( localUtil.ctol( httpContext.cgiGet( "GXH_vH_SORT_ASDC_KBN"), ".", ",") != AV33H_SORT_ASDC_KBN )
                                 {
                                    Rfr0gs = true ;
                                 }
                                 /* Set Refresh If H_sort_item_kbn Changed */
                                 if ( localUtil.ctol( httpContext.cgiGet( "GXH_vH_SORT_ITEM_KBN"), ".", ",") != AV34H_SORT_ITEM_KBN )
                                 {
                                    Rfr0gs = true ;
                                 }
                                 if ( ! Rfr0gs )
               ...
               else if ( GXutil.strcmp(sEvtType, "W") == 0 )
               {
                  ...
                  else if ( nCmpId == 202 )
                  {
                     ...
                     {
                        WebComp_Webcomp2.componentprocess("W0202", "", sEvt);
                     }
                     WebComp_Webcomp2_Component = OldWebcomp2 ;
                  }
               }
   ...
   public void rf1T2( )
   {
      ...
      if ( (GXutil.strcmp("", httpContext.wjLoc)==0) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              A49TBM02_DOM_CD ,
                                              A611TBM02_DOM_JNM ,
                                              new Short(AV34H_SORT_ITEM_KBN) ,
                                              new Short(AV33H_SORT_ASDC_KBN) ,
                                              AV19H_SRCH_FLG },
                                              new int[] {
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.STRING
                                              }
         });
         lV15H_DOM_CD = GXutil.padr( GXutil.rtrim( AV15H_DOM_CD), 16, "%") ;
   ...
   public void strup1T0( )
   {
      ...
      AV39Pgmname = "A208_WP01_DOMAIN_LIST" ;
      AV38Pgmdesc = "ドメインマスタメンテナンス（一覧）" ;
      Gx_err = (short)(0) ;
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavH_sort_asdc_kbn_Internalname), ".", ",") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavH_sort_asdc_kbn_Internalname), ".", ",") > 9999 ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV33H_SORT_ASDC_KBN = (short)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV33H_SORT_ASDC_KBN", GXutil.ltrim( GXutil.str( AV33H_SORT_ASDC_KBN, 4, 0)));
         }
         else
         {
            AV33H_SORT_ASDC_KBN = (short)(localUtil.ctol( httpContext.cgiGet( edtavH_sort_asdc_kbn_Internalname), ".", ",")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV33H_SORT_ASDC_KBN", GXutil.ltrim( GXutil.str( AV33H_SORT_ASDC_KBN, 4, 0)));
         }
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavH_sort_item_kbn_Internalname), ".", ",") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavH_sort_item_kbn_Internalname), ".", ",") > 9999 ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV34H_SORT_ITEM_KBN = (short)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV34H_SORT_ITEM_KBN", GXutil.ltrim( GXutil.str( AV34H_SORT_ITEM_KBN, 4, 0)));
         }
         else
         {
            AV34H_SORT_ITEM_KBN = (short)(localUtil.ctol( httpContext.cgiGet( edtavH_sort_item_kbn_Internalname), ".", ",")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV34H_SORT_ITEM_KBN", GXutil.ltrim( GXutil.str( AV34H_SORT_ITEM_KBN, 4, 0)));
         }
         /* Read saved values. */
   ...
   public void e391T2( )
   {
      ...
      if ( GXutil.len( WebComp_Webcomp2_Component) != 0 )
      {
         WebComp_Webcomp2.componentprepare(new Object[] {"W0202",""});
   ...
   public void S202( )
   {
      ...
      AV29W_SESSION.setValue("A208_SORT_ITEM_KBN", GXutil.trim( GXutil.str( AV34H_SORT_ITEM_KBN, 4, 0)));
      AV29W_SESSION.setValue("A208_SORT_ASDC_KBN", GXutil.trim( GXutil.str( AV33H_SORT_ASDC_KBN, 4, 0)));
   }
   ...
   public void S282( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV19H_SRCH_FLG", AV19H_SRCH_FLG);
      AV34H_SORT_ITEM_KBN = (short)(GXutil.lval( AV29W_SESSION.getValue("A208_SORT_ITEM_KBN"))) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV34H_SORT_ITEM_KBN", GXutil.ltrim( GXutil.str( AV34H_SORT_ITEM_KBN, 4, 0)));
      AV33H_SORT_ASDC_KBN = (short)(GXutil.lval( AV29W_SESSION.getValue("A208_SORT_ASDC_KBN"))) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV33H_SORT_ASDC_KBN", GXutil.ltrim( GXutil.str( AV33H_SORT_ASDC_KBN, 4, 0)));
   }
   ...
   public void S252( )
   {
      ...
      AV29W_SESSION.remove("A208_SORT_ITEM_KBN");
      AV29W_SESSION.remove("A208_SORT_ASDC_KBN");
   }
   ...
   public void S212( )
   {
      ...
      AV41GXLvl484 = (byte)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV41GXLvl484", GXutil.str( AV41GXLvl484, 1, 0));
   ...
   public void S192( )
   {
      ...
      if ( ( AV34H_SORT_ITEM_KBN == 1 ) && ( AV33H_SORT_ASDC_KBN == 0 ) )
      {
         lblTxt_sort01_asc_Class = "TextBlockSortSel" ;
         httpContext.ajax_rsp_assign_prop("", false, lblTxt_sort01_asc_Internalname, "Class", lblTxt_sort01_asc_Class);
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 1 ) && ( AV33H_SORT_ASDC_KBN == 1 ) )
      {
         lblTxt_sort01_desc_Class = "TextBlockSortSel" ;
         httpContext.ajax_rsp_assign_prop("", false, lblTxt_sort01_desc_Internalname, "Class", lblTxt_sort01_desc_Class);
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 2 ) && ( AV33H_SORT_ASDC_KBN == 0 ) )
      {
         lblTxt_sort02_asc_Class = "TextBlockSortSel" ;
         httpContext.ajax_rsp_assign_prop("", false, lblTxt_sort02_asc_Internalname, "Class", lblTxt_sort02_asc_Class);
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 2 ) && ( AV33H_SORT_ASDC_KBN == 1 ) )
      {
         lblTxt_sort02_desc_Class = "TextBlockSortSel" ;
         httpContext.ajax_rsp_assign_prop("", false, lblTxt_sort02_desc_Internalname, "Class", lblTxt_sort02_desc_Class);
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 3 ) && ( AV33H_SORT_ASDC_KBN == 0 ) )
      {
         lblTxt_sort03_asc_Class = "TextBlockSortSel" ;
         httpContext.ajax_rsp_assign_prop("", false, lblTxt_sort03_asc_Internalname, "Class", lblTxt_sort03_asc_Class);
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 3 ) && ( AV33H_SORT_ASDC_KBN == 1 ) )
      {
         lblTxt_sort03_desc_Class = "TextBlockSortSel" ;
         httpContext.ajax_rsp_assign_prop("", false, lblTxt_sort03_desc_Internalname, "Class", lblTxt_sort03_desc_Class);
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 4 ) && ( AV33H_SORT_ASDC_KBN == 0 ) )
      {
         lblTxt_sort04_asc_Class = "TextBlockSortSel" ;
         httpContext.ajax_rsp_assign_prop("", false, lblTxt_sort04_asc_Internalname, "Class", lblTxt_sort04_asc_Class);
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 4 ) && ( AV33H_SORT_ASDC_KBN == 1 ) )
      {
   ...
   public void wb_table2_204_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV17H_INIT_FLG), GXutil.rtrim( localUtil.format( AV17H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(208);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_init_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 209,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_srch_flg_Internalname, GXutil.rtrim( AV19H_SRCH_FLG), GXutil.rtrim( localUtil.format( AV19H_SRCH_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(209);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_srch_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 210,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_dom_cd_Internalname, GXutil.rtrim( AV15H_DOM_CD), GXutil.rtrim( localUtil.format( AV15H_DOM_CD, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(210);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_dom_cd_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 16, "chr", 1, "row", 16, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A208_WP01_DOMAIN_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 211,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_dom_jnm_Internalname, GXutil.rtrim( AV16H_DOM_JNM), GXutil.rtrim( localUtil.format( AV16H_DOM_JNM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(211);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_dom_jnm_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A208_WP01_DOMAIN_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 212,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV18H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV18H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(212);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A208_WP01_DOMAIN_LIST.htm");
         wb_table3_213_1T2( true) ;
      }
      else
      {
         wb_table3_213_1T2( false) ;
      }
      return  ;
   }

   public void wb_table3_213_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table4_221_1T2( true) ;
      }
      else
      {
         wb_table4_221_1T2( false) ;
      }
      return  ;
   }

   public void wb_table4_221_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         wb_table2_204_1T2e( true) ;
      }
      else
      {
         wb_table2_204_1T2e( false) ;
      }
   }

   public void wb_table4_221_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock2_Internalname, "H_SORT_ASDC_KBN", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 226,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_sort_asdc_kbn_Internalname, GXutil.ltrim( localUtil.ntoc( AV33H_SORT_ASDC_KBN, (byte)(4), (byte)(0), ".", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV33H_SORT_ASDC_KBN), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(226);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_sort_asdc_kbn_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock3_Internalname, "H_SORT_ITEM_KBN", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 231,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_sort_item_kbn_Internalname, GXutil.ltrim( localUtil.ntoc( AV34H_SORT_ITEM_KBN, (byte)(4), (byte)(0), ".", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV34H_SORT_ITEM_KBN), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(231);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_sort_item_kbn_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_221_1T2e( true) ;
      }
      else
      {
         wb_table4_221_1T2e( false) ;
      }
   }

   public void wb_table3_213_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 218,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlmax_row_Internalname, GXutil.ltrim( localUtil.ntoc( AV14H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Max_row(), (byte)(4), (byte)(0), ".", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV14H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Max_row()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(218);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtlmax_row_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_213_1T2e( true) ;
      }
      else
      {
         wb_table3_213_1T2e( false) ;
      }
   }
   ...
   public void wb_table1_2_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table5_6_1T2( true) ;
      }
      else
      {
         wb_table5_6_1T2( false) ;
      }
      return  ;
   }

   public void wb_table5_6_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table5_6_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table6_12_1T2( true) ;
      }
      else
      {
         wb_table6_12_1T2( false) ;
      }
      return  ;
   }

   public void wb_table6_12_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\"vertical-align:top;height:100%\">") ;
         wb_table7_25_1T2( true) ;
      }
      else
      {
         wb_table7_25_1T2( false) ;
      }
      return  ;
   }

   public void wb_table7_25_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<td>") ;
         /* WebComponent */
         GxWebStd.gx_hidden_field( httpContext, "W0202"+"", GXutil.rtrim( WebComp_Webcomp2_Component));
         httpContext.writeText( "<div") ;
         GxWebStd.classAttribute( httpContext, "gxwebcomponent");
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_6_1T2e( true) ;
      }
      else
      {
         wb_table5_6_1T2e( false) ;
      }
   }

   public void wb_table7_25_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table8_28_1T2( true) ;
      }
      else
      {
         wb_table8_28_1T2( false) ;
      }
      return  ;
   }

   public void wb_table8_28_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table7_25_1T2e( true) ;
      }
      else
      {
         wb_table7_25_1T2e( false) ;
      }
   }

   public void wb_table8_28_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table9_31_1T2( true) ;
      }
      else
      {
         wb_table9_31_1T2( false) ;
      }
      return  ;
   }

   public void wb_table9_31_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table10_53_1T2( true) ;
      }
      else
      {
         wb_table10_53_1T2( false) ;
      }
      return  ;
   }

   public void wb_table10_53_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td align=\"right\" >") ;
         wb_table11_145_1T2( true) ;
      }
      else
      {
         wb_table11_145_1T2( false) ;
      }
      return  ;
   }

   public void wb_table11_145_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td colspan=\"2\" >") ;
         wb_table12_158_1T2( true) ;
      }
      else
      {
         wb_table12_158_1T2( false) ;
      }
      return  ;
   }

   public void wb_table12_158_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
      ...
      if ( wbEnd == 182 )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table8_28_1T2e( true) ;
      }
      else
      {
         wb_table8_28_1T2e( false) ;
      }
   }

   public void wb_table12_158_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort01_desc_Internalname, "▼", "", "", lblTxt_sort01_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT01_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort01_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort01_asc_Internalname, "▲", "", "", lblTxt_sort01_asc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT01_ASC\\'."+"'", "", lblTxt_sort01_asc_Class, 5, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort02_desc_Internalname, "▼", "", "", lblTxt_sort02_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT02_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort02_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort02_asc_Internalname, "▲", "", "", lblTxt_sort02_asc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT02_ASC\\'."+"'", "", lblTxt_sort02_asc_Class, 5, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort03_desc_Internalname, "▼", "", "", lblTxt_sort03_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT03_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort03_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort03_asc_Internalname, "▲", "", "", lblTxt_sort03_asc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT03_ASC\\'."+"'", "", lblTxt_sort03_asc_Class, 5, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:100px\">") ;
         /* Text block */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort04_desc_Internalname, "▼", "", "", lblTxt_sort04_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT04_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort04_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort04_asc_Internalname, "▲", "", "", lblTxt_sort04_asc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT04_ASC\\'."+"'", "", lblTxt_sort04_asc_Class, 5, "", 1, 1, (short)(0), "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table12_158_1T2e( true) ;
      }
      else
      {
         wb_table12_158_1T2e( false) ;
      }
   }

   public void wb_table11_145_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 150,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table11_145_1T2e( true) ;
      }
      else
      {
         wb_table11_145_1T2e( false) ;
      }
   }

   public void wb_table10_53_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void wb_table13_59_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table10_53_1T2e( true) ;
      }
      else
      {
         wb_table10_53_1T2e( false) ;
      }
   }
   ...
   public void wb_table9_31_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 35,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_dom_cd_Internalname, GXutil.rtrim( AV7D_DOM_CD), GXutil.rtrim( localUtil.format( AV7D_DOM_CD, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_dom_cd_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 16, "chr", 1, "row", 16, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A208_WP01_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 38,'',false,'" + sGXsfl_182_idx + "',0)\"" ;
   ...
   public void wb_table28_41_1T2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table9_31_1T2e( true) ;
      }
      else
      {
         wb_table9_31_1T2e( false) ;
      }
   }
   ...
   public void wb_table6_12_1T2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table6_12_1T2e( true) ;
      }
      else
      {
         wb_table6_12_1T2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20207151330751");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a208_wp01_domain_list.js", "?20207151330751");
      /* End function include_jscripts */
   }

   public void subsflControlProps_1822( )
   {
      lblBtn_sel_Internalname = "BTN_SEL_"+sGXsfl_182_idx ;
      edtavD_grd_line_Internalname = "vD_GRD_LINE_"+sGXsfl_182_idx ;
      edtTBM02_DOM_CD_Internalname = "TBM02_DOM_CD_"+sGXsfl_182_idx ;
      edtTBM02_DOM_JNM_Internalname = "TBM02_DOM_JNM_"+sGXsfl_182_idx ;
      edtTBM02_ORDER_Internalname = "TBM02_ORDER_"+sGXsfl_182_idx ;
      edtavD_grd_del_Internalname = "vD_GRD_DEL_"+sGXsfl_182_idx ;
      lblBtn_cdisc_item_Internalname = "BTN_CDISC_ITEM_"+sGXsfl_182_idx ;
   }

   public void subsflControlProps_fel_1822( )
   {
      lblBtn_sel_Internalname = "BTN_SEL_"+sGXsfl_182_fel_idx ;
      edtavD_grd_line_Internalname = "vD_GRD_LINE_"+sGXsfl_182_fel_idx ;
      edtTBM02_DOM_CD_Internalname = "TBM02_DOM_CD_"+sGXsfl_182_fel_idx ;
      edtTBM02_DOM_JNM_Internalname = "TBM02_DOM_JNM_"+sGXsfl_182_fel_idx ;
      edtTBM02_ORDER_Internalname = "TBM02_ORDER_"+sGXsfl_182_fel_idx ;
      edtavD_grd_del_Internalname = "vD_GRD_DEL_"+sGXsfl_182_fel_idx ;
      lblBtn_cdisc_item_Internalname = "BTN_CDISC_ITEM_"+sGXsfl_182_fel_idx ;
   }
   ...
   public void sendrow_1822( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_182_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         /* Text block */
         Grid1Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {lblBtn_sel_Internalname,"選択","","",lblBtn_sel_Jsonclick,"'"+""+"'"+",false,"+"'"+"E\\'BTN_SEL\\'."+sGXsfl_182_idx+"'","","TextBlockBtn040s",new Integer(5),"",new Integer(1),new Integer(1),new Integer(0)});
         if ( Grid1Container.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         TempTags = " " + ((edtavD_grd_line_Enabled!=0)&&(edtavD_grd_line_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 187,'',false,'"+sGXsfl_182_idx+"',182)\"" : " ") ;
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_line_Internalname,GXutil.ltrim( localUtil.ntoc( AV10D_GRD_LINE, (byte)(4), (byte)(0), ".", "")),((edtavD_grd_line_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV10D_GRD_LINE), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV10D_GRD_LINE), "ZZZ9")),TempTags+((edtavD_grd_line_Enabled!=0)&&(edtavD_grd_line_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_line_Enabled!=0)&&(edtavD_grd_line_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(187);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_line_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_line_Enabled),new Integer(0),"text","",new Integer(4),"chr",new Integer(1),"row",new Integer(4),new Integer(0),new Integer(0),new Integer(182),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTBM02_DOM_CD_Internalname,GXutil.rtrim( A49TBM02_DOM_CD),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTBM02_DOM_CD_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(0),new Integer(0),"text","",new Integer(16),"chr",new Integer(1),"row",new Integer(16),new Integer(0),new Integer(0),new Integer(182),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"D_DOM_CD","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTBM02_DOM_JNM_Internalname,GXutil.rtrim( A611TBM02_DOM_JNM),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTBM02_DOM_JNM_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(0),new Integer(0),"text","",new Integer(50),"chr",new Integer(1),"row",new Integer(50),new Integer(0),new Integer(0),new Integer(182),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         Grid1Row.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"",""+" style=\"width:100px\""});
         /* Single line edit */
         TempTags = " " + ((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 195,'',false,'"+sGXsfl_182_idx+"',182)\"" : " ") ;
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_del_Internalname,GXutil.rtrim( AV9D_GRD_DEL),"",TempTags+((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(195);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_del_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_del_Enabled),new Integer(0),"text","",new Integer(10),"chr",new Integer(1),"row",new Integer(10),new Integer(0),new Integer(0),new Integer(182),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         /* Text block */
         Grid1Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {lblBtn_cdisc_item_Internalname,"変数一覧","","",lblBtn_cdisc_item_Jsonclick,"'"+""+"'"+",false,"+"'"+"E\\'BTN_CDISC_ITEM\\'."+sGXsfl_182_idx+"'","","TextBlockBtn060s",new Integer(5),"",new Integer(1),new Integer(1),new Integer(0)});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
   ...
   private short AV33H_SORT_ASDC_KBN ;
   private short AV34H_SORT_ITEM_KBN ;
...
final  class a208_wp01_domain_list__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H001T2( ModelContext context ,
                                          ...
                                          short AV34H_SORT_ITEM_KBN ,
                                          short AV33H_SORT_ASDC_KBN ,
                                          String AV19H_SRCH_FLG )
   {
      ...
      if ( ( AV34H_SORT_ITEM_KBN == 0 ) && ( AV33H_SORT_ASDC_KBN == 0 ) )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_DOM_CD`" ;
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 1 ) && ( AV33H_SORT_ASDC_KBN == 0 ) )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_DOM_CD`" ;
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 1 ) && ( AV33H_SORT_ASDC_KBN == 1 ) )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_DOM_CD` DESC" ;
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 2 ) && ( AV33H_SORT_ASDC_KBN == 0 ) )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_DOM_JNM`" ;
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 2 ) && ( AV33H_SORT_ASDC_KBN == 1 ) )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_DOM_JNM` DESC" ;
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 3 ) && ( AV33H_SORT_ASDC_KBN == 0 ) )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_ORDER`" ;
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 3 ) && ( AV33H_SORT_ASDC_KBN == 1 ) )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_ORDER` DESC" ;
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 4 ) && ( AV33H_SORT_ASDC_KBN == 0 ) )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_DEL_FLG`" ;
      }
      else if ( ( AV34H_SORT_ITEM_KBN == 4 ) && ( AV33H_SORT_ASDC_KBN == 1 ) )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_DEL_FLG` DESC" ;
      }
      else if ( true )
      {
         sOrderString = sOrderString + " ORDER BY `TBM02_DOM_CD`" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H001T2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] );
            case 1 :
                  return conditional_H001T3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] );
            case 2 :
                              ...
                              Object[] parms ) throws SQLException
   {
      ...
      switch ( cursor )
      {
            ...
            case 1 :
               ...
               {
                  sIdx = (short)(sIdx+1) ;
                  stmt.setVarchar(sIdx, (String)parms[4], 16);
               }
               if ( ((Number) parms[2]).byteValue() == 0 )
               {
                  sIdx = (short)(sIdx+1) ;
