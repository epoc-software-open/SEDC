/*
       ...
       Generated on: July 15, 2020 13:19:40.56
...
public final  class tbm33_crf_cond_impl extends GXWebPanel
{
   ...
   public void wb_table4_34_0L20( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBM33_PRIOR_NO_Internalname, GXutil.ltrim( localUtil.ntoc( A415TBM33_PRIOR_NO, (byte)(3), (byte)(0), ".", "")), ((edtTBM33_PRIOR_NO_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A415TBM33_PRIOR_NO), "ZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A415TBM33_PRIOR_NO), "ZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(74);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBM33_PRIOR_NO_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBM33_PRIOR_NO_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_TBM33_CRF_COND.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
   ...
   public void standaloneStartupServer( )
   {
      ...
      if ( AnyError == 0 )
      {
         if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( localUtil.ctol( httpContext.cgiGet( edtTBM33_PRIOR_NO_Internalname), ".", ",") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtTBM33_PRIOR_NO_Internalname), ".", ",") > 999 ) ) )
            {
            ...
            {
               A415TBM33_PRIOR_NO = (short)(localUtil.ctol( httpContext.cgiGet( edtTBM33_PRIOR_NO_Internalname), ".", ",")) ;
               n415TBM33_PRIOR_NO = false ;
               httpContext.ajax_rsp_assign_attri("", false, "A415TBM33_PRIOR_NO", GXutil.ltrim( GXutil.str( A415TBM33_PRIOR_NO, 3, 0)));
            }
            ...
            n504TBM33_CRF_ITEM_CD = ((GXutil.strcmp("", A504TBM33_CRF_ITEM_CD)==0) ? true : false) ;
            Z415TBM33_PRIOR_NO = (short)(localUtil.ctol( httpContext.cgiGet( "Z415TBM33_PRIOR_NO"), ".", ",")) ;
            n415TBM33_PRIOR_NO = ((0==A415TBM33_PRIOR_NO) ? true : false) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513194242");
   ...
   public void renderHtmlCloseForm0L20( )
   {
      ...
      GxWebStd.gx_hidden_field( httpContext, "Z415TBM33_PRIOR_NO", GXutil.ltrim( localUtil.ntoc( Z415TBM33_PRIOR_NO, (byte)(3), (byte)(0), ".", "")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202071513194251");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tbm33_crf_cond.js", "?202071513194251");
                                    ...
                                    String GX_Parm21 )
   {
      ...
      isValidOutput.add(GXutil.ltrim( localUtil.ntoc( A415TBM33_PRIOR_NO, (byte)(3), (byte)(0), ".", "")));
      ...
      isValidOutput.add(GXutil.ltrim( localUtil.ntoc( Z415TBM33_PRIOR_NO, (byte)(3), (byte)(0), ".", "")));
   ...
   public void initialize( )
   {
      ...
      T000L4_A415TBM33_PRIOR_NO = new short[1] ;
      ...
      T000L3_A415TBM33_PRIOR_NO = new short[1] ;
      ...
      T000L2_A415TBM33_PRIOR_NO = new short[1] ;
   ...
   private short Z415TBM33_PRIOR_NO ;
   ...
   private short[] T000L4_A415TBM33_PRIOR_NO ;
   ...
   private short[] T000L3_A415TBM33_PRIOR_NO ;
   ...
   private short[] T000L2_A415TBM33_PRIOR_NO ;
