...
public final  class a206_wp01_user_mst_list_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeValue( "ユーザーマスタメンテナンス（一覧）") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20207151322577");
      ...
      GXEncryptionTmp = "a206_wp01_user_mst_list"+GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV19P_MOVE_KBN,1,0))) ;
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" class=\"Form\" action=\""+formatLink("a206_wp01_user_mst_list") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey)+"\">") ;
   ...
   public void renderHtmlCloseForm0U2( )
   {
      ...
      GxWebStd.gx_hidden_field( httpContext, "vC_GRID_ROWS", GXutil.ltrim( localUtil.ntoc( AV30C_GRID_ROWS, (byte)(4), (byte)(0), ".", "")));
      GxWebStd.gx_hidden_field( httpContext, "gxhash_vC_GRID_ROWS", GetHash( "", String.valueOf(AV30C_GRID_ROWS)));
   ...
   {
      return "A206_WP01_USER_MST_LIST" ;
   }
   ...
   public void wb_table1_2_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_190_0U2( true) ;
      }
      else
      {
         wb_table2_190_0U2( false) ;
      }
      return  ;
   }

   public void wb_table2_190_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
   ...
   public void pa0U2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         if ( ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( ( GXutil.strcmp(GXutil.right( GXDecQS, 6), com.genexus.util.Encryption.checksum( GXutil.left( GXDecQS, GXutil.len( GXDecQS)-6), 6)) == 0 ) && ( GXutil.strcmp(GXutil.substring( GXDecQS, 1, GXutil.len( "a206_wp01_user_mst_list")), "a206_wp01_user_mst_list") == 0 ) )
            {
               httpContext.setQueryString( GXutil.right( GXutil.left( GXDecQS, GXutil.len( GXDecQS)-6), GXutil.len( GXutil.left( GXDecQS, GXutil.len( GXDecQS)-6))-GXutil.len( "a206_wp01_user_mst_list"))) ;
            }
            else
            {
               GxWebError = (byte)(1) ;
   ...
   public void rf0U2( )
   {
      ...
      if ( (GXutil.strcmp("", httpContext.wjLoc)==0) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000U2 */
         pr_default.execute(0, new Object[] {AV16H_SRCH_FLG, lV17H_TAM07_USER_ID, lV18H_TAM07_USER_NM, new Integer(GXPagingFrom2), new Long(GXPagingTo2)});
         nGXsfl_171_idx = (short)(1) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subgrid1_recordsperpage( ) ) ) ) )
         {
            A214TAM07_DEL_FLG = H000U2_A214TAM07_DEL_FLG[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A214TAM07_DEL_FLG", A214TAM07_DEL_FLG);
            n214TAM07_DEL_FLG = H000U2_n214TAM07_DEL_FLG[0] ;
            A205TAM07_USER_NM = H000U2_A205TAM07_USER_NM[0] ;
            n205TAM07_USER_NM = H000U2_n205TAM07_USER_NM[0] ;
            A55TAM07_USER_ID = H000U2_A55TAM07_USER_ID[0] ;
            /* Execute user event: e320U2 */
            e320U2 ();
   ...
   public void strup0U0( )
   {
      ...
      AV35Pgmname = "A206_WP01_USER_MST_LIST" ;
      AV34Pgmdesc = "ユーザーマスタメンテナンス（一覧）" ;
      Gx_err = (short)(0) ;
   ...
   public void e300U2( )
   {
      ...
      AV30C_GRID_ROWS = (short)(subGrid1_Rows) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV30C_GRID_ROWS", GXutil.ltrim( GXutil.str( AV30C_GRID_ROWS, 4, 0)));
   ...
   private void e320U2( )
   {
      ...
      if ( AV8D_GRD_LINE == 0 )
      {
         AV8D_GRD_LINE = (short)((subgrid1_currentpage( )-1)*AV30C_GRID_ROWS) ;
      }
      ...
      else if ( GXutil.strcmp(A214TAM07_DEL_FLG, "1") == 0 )
      {
         AV7D_GRD_DEL = "利用不可" ;
      }
      else
   ...
   public void e120U2( )
   {
      ...
      {
         GXKey = context.getSiteKey( ) ;
         GXEncryptionTmp = "aa206_pc01_user_mst_csv"+GXutil.URLEncode(GXutil.rtrim(AV17H_TAM07_USER_ID)) + "," + GXutil.URLEncode(GXutil.rtrim(AV18H_TAM07_USER_NM)) + "," + GXutil.URLEncode(GXutil.rtrim(AV27W_RTN_MSG)) ;
   ...
   public void e150U2( )
   {
      ...
      {
         AV25W_F7FLG = true ;
         httpContext.ajax_rsp_assign_attri("", false, "AV25W_F7FLG", AV25W_F7FLG);
         AV8D_GRD_LINE = (short)(0) ;
         GXt_char1 = AV26W_MSG ;
         GXv_char2[0] = GXt_char1 ;
         new a805_pc01_msg_get(remoteHandle, context).execute( "AE00028", "", "", "", "", "", GXv_char2) ;
         a206_wp01_user_mst_list_impl.this.GXt_char1 = GXv_char2[0] ;
         AV26W_MSG = GXt_char1 ;
         ...
         if ( new a807_pc01_cha_num_check(remoteHandle, context).executeUdp( AV10D_LINE) == 1 )
         {
            ...
            while ( nGXsfl_171_fel_idx < nRC_GXsfl_171 )
            {
               ...
               {
                  AV29W_TAM07_USER_ID = A55TAM07_USER_ID ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV29W_TAM07_USER_ID", AV29W_TAM07_USER_ID);
                  AV26W_MSG = "" ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV26W_MSG", AV26W_MSG);
         ...
         if ( (GXutil.strcmp("", AV26W_MSG)==0) )
         {
            AV28W_SESSION.setValue("A206_PAGE", GXutil.str( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no(), 10, 0));
            GXKey = context.getSiteKey( ) ;
            GXEncryptionTmp = "a207_wp01_user_mst"+GXutil.URLEncode(GXutil.rtrim(AV29W_TAM07_USER_ID)) ;
            httpContext.wjLoc = formatLink("a207_wp01_user_mst") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey) ;
            httpContext.wjLocDisableFrm = (byte)(1) ;
         }
         else
   ...
   public void e330U2( )
   {
      ...
      AV28W_SESSION.setValue("A206_PAGE", GXutil.str( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no(), 10, 0));
      GXKey = context.getSiteKey( ) ;
      GXEncryptionTmp = "a207_wp01_user_mst"+GXutil.URLEncode(GXutil.rtrim(A55TAM07_USER_ID)) ;
      httpContext.wjLoc = formatLink("a207_wp01_user_mst") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey) ;
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S192( )
   {
      ...
      AV37GXLvl407 = (byte)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV37GXLvl407", GXutil.str( AV37GXLvl407, 1, 0));
      ...
      {
         A205TAM07_USER_NM = H000U4_A205TAM07_USER_NM[0] ;
         n205TAM07_USER_NM = H000U4_n205TAM07_USER_NM[0] ;
         A55TAM07_USER_ID = H000U4_A55TAM07_USER_ID[0] ;
         AV37GXLvl407 = (byte)(1) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV37GXLvl407", GXutil.str( AV37GXLvl407, 1, 0));
         AV27W_RTN_MSG = "" ;
         httpContext.ajax_rsp_assign_attri("", false, "AV27W_RTN_MSG", AV27W_RTN_MSG);
         /* Exit For each command. Update data (if necessary), close cursors & exit. */
         if (true) break;
   ...
   public void S112( )
   {
      ...
      a206_wp01_user_mst_list_impl.this.AV23W_ERRCD = GXv_char2[0] ;
   ...
   public void S132( )
   {
      ...
      a206_wp01_user_mst_list_impl.this.AV15H_KNGN_FLG = GXv_char2[0] ;
      a206_wp01_user_mst_list_impl.this.AV23W_ERRCD = GXv_char4[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV6C_TAM02_APP_ID", AV6C_TAM02_APP_ID);
      httpContext.ajax_rsp_assign_attri("", false, "AV15H_KNGN_FLG", AV15H_KNGN_FLG);
      httpContext.ajax_rsp_assign_attri("", false, "AV23W_ERRCD", AV23W_ERRCD);
      if ( GXutil.strcmp(AV23W_ERRCD, "0") != 0 )
   ...
   public void S182( )
   {
      ...
      if ( subgrid1_recordcount( ) <= 0 )
      {
         ...
         if ( ( GXutil.strcmp(AV16H_SRCH_FLG, "1") == 0 ) && ! AV24W_ERRFLG )
         {
            ...
            a206_wp01_user_mst_list_impl.this.GXt_char1 = GXv_char4[0] ;
            AV26W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV26W_MSG", AV26W_MSG);
            httpContext.GX_msglist.addItem(AV26W_MSG);
         }
   ...
   public void S162( )
   {
      ...
      new a402_pc02_btn_kengn_check(remoteHandle, context).execute( "REG", AV15H_KNGN_FLG, "", GXv_boolean7) ;
      a206_wp01_user_mst_list_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15H_KNGN_FLG", AV15H_KNGN_FLG);
   ...
   public void wb_table2_190_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_js_event_Internalname, lblTxt_js_event_Caption, "", "", lblTxt_js_event_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(1), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 194,'',false,'" + sGXsfl_171_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV14H_INIT_FLG), GXutil.rtrim( localUtil.format( AV14H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(194);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_init_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 195,'',false,'" + sGXsfl_171_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_srch_flg_Internalname, GXutil.rtrim( AV16H_SRCH_FLG), GXutil.rtrim( localUtil.format( AV16H_SRCH_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(195);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_srch_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 196,'',false,'" + sGXsfl_171_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_tam07_user_id_Internalname, GXutil.rtrim( AV17H_TAM07_USER_ID), GXutil.rtrim( localUtil.format( AV17H_TAM07_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(196);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_tam07_user_id_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 197,'',false,'" + sGXsfl_171_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_tam07_user_nm_Internalname, GXutil.rtrim( AV18H_TAM07_USER_NM), GXutil.rtrim( localUtil.format( AV18H_TAM07_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(197);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_tam07_user_nm_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 198,'',false,'" + sGXsfl_171_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV15H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV15H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(198);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 199,'',false,'" + sGXsfl_171_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlrec_cnt_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Rec_cnt(), (byte)(10), (byte)(0), ".", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Rec_cnt()), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(199);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtlrec_cnt_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_190_0U2e( true) ;
      }
      else
      {
         wb_table2_190_0U2e( false) ;
      }
   }
   ...
   public void wb_table1_2_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table3_6_0U2( true) ;
      }
      else
      {
         wb_table3_6_0U2( false) ;
      }
      return  ;
   }

   public void wb_table3_6_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table3_6_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table4_12_0U2( true) ;
      }
      else
      {
         wb_table4_12_0U2( false) ;
      }
      return  ;
   }

   public void wb_table4_12_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\"vertical-align:top;height:100%\">") ;
         wb_table5_22_0U2( true) ;
      }
      else
      {
         wb_table5_22_0U2( false) ;
      }
      return  ;
   }

   public void wb_table5_22_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_6_0U2e( true) ;
      }
      else
      {
         wb_table3_6_0U2e( false) ;
      }
   }

   public void wb_table5_22_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table6_25_0U2( true) ;
      }
      else
      {
         wb_table6_25_0U2( false) ;
      }
      return  ;
   }

   public void wb_table6_25_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_22_0U2e( true) ;
      }
      else
      {
         wb_table5_22_0U2e( false) ;
      }
   }

   public void wb_table6_25_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void wb_table7_28_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table8_50_0U2( true) ;
      }
      else
      {
         wb_table8_50_0U2( false) ;
      }
      return  ;
   }

   public void wb_table8_50_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td align=\"right\" >") ;
         wb_table9_142_0U2( true) ;
      }
      else
      {
         wb_table9_142_0U2( false) ;
      }
      return  ;
   }

   public void wb_table9_142_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td colspan=\"2\" >") ;
         wb_table10_155_0U2( true) ;
      }
      else
      {
         wb_table10_155_0U2( false) ;
      }
      return  ;
   }

   public void wb_table10_155_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
      ...
      if ( wbEnd == 171 )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table6_25_0U2e( true) ;
      }
      else
      {
         wb_table6_25_0U2e( false) ;
      }
   }

   public void wb_table10_155_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table11_158_0U2( true) ;
      }
      else
      {
         wb_table11_158_0U2( false) ;
      }
      return  ;
   }

   public void wb_table11_158_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table10_155_0U2e( true) ;
      }
      else
      {
         wb_table10_155_0U2e( false) ;
      }
   }

   public void wb_table11_158_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock34_Internalname, "行", "", "", lblTextblock34_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:200px\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock30_Internalname, "ユーザーID", "", "", lblTextblock30_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:300px\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock31_Internalname, "氏名", "", "", lblTextblock31_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:100px\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock33_Internalname, "削除フラグ", "", "", lblTextblock33_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table11_158_0U2e( true) ;
      }
      else
      {
         wb_table11_158_0U2e( false) ;
      }
   }

   public void wb_table9_142_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock29_Internalname, "行番号：", "", "", lblTextblock29_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 147,'',false,'" + sGXsfl_171_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_line_Internalname, GXutil.rtrim( AV10D_LINE), GXutil.rtrim( localUtil.format( AV10D_LINE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(147);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_line_Jsonclick, 0, "AttributeNum", "background:"+WebUtils.getHTMLColor( edtavD_line_Backcolor)+";", "", "", 1, 1, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:5px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"vertical-align:bottom\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock28_Internalname, "編集（F7）", "", "", lblTextblock28_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_EDIT\\'."+"'", "", "TextBlockBtn060", 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table9_142_0U2e( true) ;
      }
      else
      {
         wb_table9_142_0U2e( false) ;
      }
   }

   public void wb_table8_50_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_rec_cnt_Internalname, lblTxt_rec_cnt_Caption, "", "", lblTxt_rec_cnt_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table12_56_0U2( true) ;
      }
      else
      {
         wb_table12_56_0U2( false) ;
      }
      return  ;
   }

   public void wb_table12_56_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table8_50_0U2e( true) ;
      }
      else
      {
         wb_table8_50_0U2e( false) ;
      }
   }

   public void wb_table12_56_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table13_59_0U2( true) ;
      }
      else
      {
         wb_table13_59_0U2( false) ;
      }
      return  ;
   }

   public void wb_table13_59_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:46px\">") ;
         wb_table14_65_0U2( true) ;
      }
      else
      {
         wb_table14_65_0U2( false) ;
      }
      return  ;
   }

   public void wb_table14_65_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table15_71_0U2( true) ;
      }
      else
      {
         wb_table15_71_0U2( false) ;
      }
      return  ;
   }

   public void wb_table15_71_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table16_77_0U2( true) ;
      }
      else
      {
         wb_table16_77_0U2( false) ;
      }
      return  ;
   }

   public void wb_table16_77_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table17_83_0U2( true) ;
      }
      else
      {
         wb_table17_83_0U2( false) ;
      }
      return  ;
   }

   public void wb_table17_83_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table18_89_0U2( true) ;
      }
      else
      {
         wb_table18_89_0U2( false) ;
      }
      return  ;
   }

   public void wb_table18_89_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table19_95_0U2( true) ;
      }
      else
      {
         wb_table19_95_0U2( false) ;
      }
      return  ;
   }

   public void wb_table19_95_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table20_101_0U2( true) ;
      }
      else
      {
         wb_table20_101_0U2( false) ;
      }
      return  ;
   }

   public void wb_table20_101_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table21_107_0U2( true) ;
      }
      else
      {
         wb_table21_107_0U2( false) ;
      }
      return  ;
   }

   public void wb_table21_107_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table22_113_0U2( true) ;
      }
      else
      {
         wb_table22_113_0U2( false) ;
      }
      return  ;
   }

   public void wb_table22_113_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table23_119_0U2( true) ;
      }
      else
      {
         wb_table23_119_0U2( false) ;
      }
      return  ;
   }

   public void wb_table23_119_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table24_125_0U2( true) ;
      }
      else
      {
         wb_table24_125_0U2( false) ;
      }
      return  ;
   }

   public void wb_table24_125_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table25_131_0U2( true) ;
      }
      else
      {
         wb_table25_131_0U2( false) ;
      }
      return  ;
   }

   public void wb_table25_131_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table26_137_0U2( true) ;
      }
      else
      {
         wb_table26_137_0U2( false) ;
      }
      return  ;
   }

   public void wb_table26_137_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table12_56_0U2e( true) ;
      }
      else
      {
         wb_table12_56_0U2e( false) ;
      }
   }

   public void wb_table26_137_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_last_Internalname, "最後へ", "", "", lblTxt_last_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE_LAST\\'."+"'", "", lblTxt_last_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table26_137_0U2e( true) ;
      }
      else
      {
         wb_table26_137_0U2e( false) ;
      }
   }

   public void wb_table25_131_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_next_Internalname, "次へ", "", "", lblTxt_next_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE_NEXT\\'."+"'", "", lblTxt_next_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table25_131_0U2e( true) ;
      }
      else
      {
         wb_table25_131_0U2e( false) ;
      }
   }

   public void wb_table24_125_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page10_Internalname, lblTxt_page10_Caption, "", "", lblTxt_page10_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE10\\'."+"'", "", lblTxt_page10_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table24_125_0U2e( true) ;
      }
      else
      {
         wb_table24_125_0U2e( false) ;
      }
   }

   public void wb_table23_119_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page09_Internalname, lblTxt_page09_Caption, "", "", lblTxt_page09_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE09\\'."+"'", "", lblTxt_page09_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table23_119_0U2e( true) ;
      }
      else
      {
         wb_table23_119_0U2e( false) ;
      }
   }

   public void wb_table22_113_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page08_Internalname, lblTxt_page08_Caption, "", "", lblTxt_page08_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE08\\'."+"'", "", lblTxt_page08_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table22_113_0U2e( true) ;
      }
      else
      {
         wb_table22_113_0U2e( false) ;
      }
   }

   public void wb_table21_107_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page07_Internalname, lblTxt_page07_Caption, "", "", lblTxt_page07_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE07\\'."+"'", "", lblTxt_page07_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table21_107_0U2e( true) ;
      }
      else
      {
         wb_table21_107_0U2e( false) ;
      }
   }

   public void wb_table20_101_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page06_Internalname, lblTxt_page06_Caption, "", "", lblTxt_page06_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE06\\'."+"'", "", lblTxt_page06_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table20_101_0U2e( true) ;
      }
      else
      {
         wb_table20_101_0U2e( false) ;
      }
   }

   public void wb_table19_95_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page05_Internalname, lblTxt_page05_Caption, "", "", lblTxt_page05_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE05\\'."+"'", "", lblTxt_page05_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table19_95_0U2e( true) ;
      }
      else
      {
         wb_table19_95_0U2e( false) ;
      }
   }

   public void wb_table18_89_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page04_Internalname, lblTxt_page04_Caption, "", "", lblTxt_page04_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE04\\'."+"'", "", lblTxt_page04_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table18_89_0U2e( true) ;
      }
      else
      {
         wb_table18_89_0U2e( false) ;
      }
   }

   public void wb_table17_83_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page03_Internalname, lblTxt_page03_Caption, "", "", lblTxt_page03_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE03\\'."+"'", "", lblTxt_page03_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table17_83_0U2e( true) ;
      }
      else
      {
         wb_table17_83_0U2e( false) ;
      }
   }

   public void wb_table16_77_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page02_Internalname, lblTxt_page02_Caption, "", "", lblTxt_page02_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE02\\'."+"'", "", lblTxt_page02_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table16_77_0U2e( true) ;
      }
      else
      {
         wb_table16_77_0U2e( false) ;
      }
   }

   public void wb_table15_71_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_page01_Internalname, lblTxt_page01_Caption, "", "", lblTxt_page01_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE01\\'."+"'", "", lblTxt_page01_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table15_71_0U2e( true) ;
      }
      else
      {
         wb_table15_71_0U2e( false) ;
      }
   }

   public void wb_table14_65_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_back_Internalname, "前へ", "", "", lblTxt_back_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE_BACK\\'."+"'", "", lblTxt_back_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table14_65_0U2e( true) ;
      }
      else
      {
         wb_table14_65_0U2e( false) ;
      }
   }

   public void wb_table13_59_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_first_Internalname, "最初へ", "", "", lblTxt_first_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE_FIRST\\'."+"'", "", lblTxt_first_Class, 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table13_59_0U2e( true) ;
      }
      else
      {
         wb_table13_59_0U2e( false) ;
      }
   }

   public void wb_table7_28_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_user_id_Internalname, GXutil.rtrim( AV11D_TAM07_USER_ID), GXutil.rtrim( localUtil.format( AV11D_TAM07_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(32);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_tam07_user_id_Jsonclick, 0, "AttributeImeOff", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\"  style=\"width:70px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_user_nm_Internalname, GXutil.rtrim( AV12D_TAM07_USER_NM), GXutil.rtrim( localUtil.format( AV12D_TAM07_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_tam07_user_nm_Jsonclick, 0, "AttributeImeOn", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td align=\"center\" class=\"Submit\" colspan=\"4\" >") ;
         wb_table27_38_0U2( true) ;
      }
      else
      {
         wb_table27_38_0U2( false) ;
      }
      return  ;
   }

   public void wb_table27_38_0U2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table27_38_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock45_Internalname, "検索（F5）", "", "", lblTextblock45_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_SRCH\\'."+"'", "background:transparent;", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock44_Internalname, "クリア（F6）", "", "", lblTextblock44_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_CLER\\'."+"'", "", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table27_38_0U2e( true) ;
      }
      else
      {
         wb_table27_38_0U2e( false) ;
      }
   }

   public void wb_table4_12_0U2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_reg_Internalname, "新規（F3）", "", "", lblTxt_btn_reg_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_REG\\'."+"'", "", "TextBlockBtn100", 5, "", lblTxt_btn_reg_Visible, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_reg2_Internalname, "新規（F3）", "", "", lblTxt_btn_reg2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockBtnList100_Disabled", 0, "", lblTxt_btn_reg2_Visible, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock43_Internalname, "CSV出力（F4）", "", "", lblTextblock43_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_CSV\\'."+"'", "", "TextBlockBtn120", 5, "", 1, 1, (short)(0), "HLP_A206_WP01_USER_MST_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_12_0U2e( true) ;
      }
      else
      {
         wb_table4_12_0U2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20207151323092");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a206_wp01_user_mst_list.js", "?20207151323092");
   ...
   public void sendrow_1712( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_171_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         /* Div Control */
         Grid1Row.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divSection1_Internalname+"_"+sGXsfl_171_idx,new Integer(1),new Integer(195),"px",new Integer(0),"px","SectionWordBreak",""});
         /* Single line edit */
         ROClassString = "ReadonlyAttribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTAM07_USER_ID_Internalname,GXutil.rtrim( A55TAM07_USER_ID),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTAM07_USER_ID_Jsonclick,new Integer(0),"ReadonlyAttribute","",ROClassString,"",new Integer(1),new Integer(0),new Integer(0),"text","",new Integer(10),"chr",new Integer(1),"row",new Integer(128),new Integer(0),new Integer(0),new Integer(171),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"D_USER_ID","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         /* Single line edit */
         ROClassString = "ReadonlyAttribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTAM07_USER_NM_Internalname,GXutil.rtrim( A205TAM07_USER_NM),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTAM07_USER_NM_Jsonclick,new Integer(0),"ReadonlyAttribute","",ROClassString,"",new Integer(1),new Integer(0),new Integer(0),"text","",new Integer(30),"chr",new Integer(1),"row",new Integer(30),new Integer(0),new Integer(0),new Integer(171),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         /* Single line edit */
         TempTags = " " + ((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 183,'',false,'"+sGXsfl_171_idx+"',171)\"" : " ") ;
         ROClassString = "ReadonlyAttribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_del_Internalname,GXutil.rtrim( AV7D_GRD_DEL),"",TempTags+((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(183);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_del_Jsonclick,new Integer(0),"ReadonlyAttribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_del_Enabled),new Integer(0),"text","",new Integer(10),"chr",new Integer(1),"row",new Integer(10),new Integer(0),new Integer(0),new Integer(171),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
   ...
   public void initialize( )
   {
      ...
      lV17H_TAM07_USER_ID = "" ;
      lV18H_TAM07_USER_NM = "" ;
      H000U2_A214TAM07_DEL_FLG = new String[] {""} ;
      H000U2_n214TAM07_DEL_FLG = new boolean[] {false} ;
      H000U2_A205TAM07_USER_NM = new String[] {""} ;
      H000U2_n205TAM07_USER_NM = new boolean[] {false} ;
      H000U2_A55TAM07_USER_ID = new String[] {""} ;
      ...
      AV26W_MSG = "" ;
      AV29W_TAM07_USER_ID = "" ;
      H000U4_A205TAM07_USER_NM = new String[] {""} ;
      H000U4_n205TAM07_USER_NM = new boolean[] {false} ;
      H000U4_A55TAM07_USER_ID = new String[] {""} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new a206_wp01_user_mst_list__default(),
         new Object[] {
             new Object[] {
            H000U2_A214TAM07_DEL_FLG, H000U2_n214TAM07_DEL_FLG, H000U2_A205TAM07_USER_NM, H000U2_n205TAM07_USER_NM, H000U2_A55TAM07_USER_ID
            }
            , new Object[] {
            H000U3_AGRID1_nRecordCount
            }
            , new Object[] {
            H000U4_A205TAM07_USER_NM, H000U4_n205TAM07_USER_NM, H000U4_A55TAM07_USER_ID
            }
         }
      );
   ...
   private String[] H000U2_A214TAM07_DEL_FLG ;
   private boolean[] H000U2_n214TAM07_DEL_FLG ;
   private String[] H000U2_A205TAM07_USER_NM ;
   private boolean[] H000U2_n205TAM07_USER_NM ;
   private String[] H000U2_A55TAM07_USER_ID ;
   private long[] H000U3_AGRID1_nRecordCount ;
   private String[] H000U4_A205TAM07_USER_NM ;
   private boolean[] H000U4_n205TAM07_USER_NM ;
   private String[] H000U4_A55TAM07_USER_ID ;
...
final  class a206_wp01_user_mst_list__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String AV16H_SRCH_FLG )
   {
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " `TAM07_DEL_FLG`, `TAM07_USER_NM`, `TAM07_USER_ID`" ;
      sFromString = " FROM `TAM07_USER`" ;
      sOrderString = "" ;
      ...
      sOrderString = sOrderString + " ORDER BY `TAM07_USER_ID`" ;
   ...
   protected Object[] conditional_H000U4( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.internet.HttpContext httpContext ,
                                          String AV17H_TAM07_USER_ID ,
                                          String AV18H_TAM07_USER_NM ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000U2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] );
            case 1 :
                  return conditional_H000U3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] );
            case 2 :
                  return conditional_H000U4(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] );
      }
   ...
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H000U4", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
                              ...
                              Object[] parms ) throws SQLException
   {
      ...
      switch ( cursor )
      {
            case 0 :
               ...
               {
                  sIdx = (short)(sIdx+1) ;
                  stmt.setVarchar(sIdx, (String)parms[6], 128);
               }
