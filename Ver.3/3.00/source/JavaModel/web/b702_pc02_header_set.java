/*
       ...
       Generated on: July 15, 2020 13:17:18.70
...
public final  class b702_pc02_header_set extends GXProcedure
{
                             ...
                             String[] aP17 )
   {
      ...
      b702_pc02_header_set.this.aP15 = aP15;
      b702_pc02_header_set.this.aP16 = aP16;
      b702_pc02_header_set.this.aP17 = aP17;
      b702_pc02_header_set.this.aP18 = aP18;
      b702_pc02_header_set.this.aP18 = new String[] {""};
      initialize();
      privateExecute();
      return aP18[0];
   }
   ...
   public void S121( )
   {
      ...
      {
         A449TBT02_DEL_FLG = P005L5_A449TBT02_DEL_FLG[0] ;
         n449TBT02_DEL_FLG = P005L5_n449TBT02_DEL_FLG[0] ;
         A935TBT02_CRF_EDA_NO = P005L5_A935TBT02_CRF_EDA_NO[0] ;
         A91TBT02_CRF_ID = P005L5_A91TBT02_CRF_ID[0] ;
         A90TBT02_SUBJECT_ID = P005L5_A90TBT02_SUBJECT_ID[0] ;
         A89TBT02_STUDY_ID = P005L5_A89TBT02_STUDY_ID[0] ;
         A661TBT02_INPUT_END_FLG = P005L5_A661TBT02_INPUT_END_FLG[0] ;
         n661TBT02_INPUT_END_FLG = P005L5_n661TBT02_INPUT_END_FLG[0] ;
         A655TBT02_DM_ARRIVAL_FLG = P005L5_A655TBT02_DM_ARRIVAL_FLG[0] ;
         n655TBT02_DM_ARRIVAL_FLG = P005L5_n655TBT02_DM_ARRIVAL_FLG[0] ;
         A656TBT02_DM_ARRIVAL_DATETIME = P005L5_A656TBT02_DM_ARRIVAL_DATETIME[0] ;
         n656TBT02_DM_ARRIVAL_DATETIME = P005L5_n656TBT02_DM_ARRIVAL_DATETIME[0] ;
         A991TBT02_SIGNATURE_DATETIME = P005L5_A991TBT02_SIGNATURE_DATETIME[0] ;
         n991TBT02_SIGNATURE_DATETIME = P005L5_n991TBT02_SIGNATURE_DATETIME[0] ;
         A992TBT02_SIGNATURE_USER_ID = P005L5_A992TBT02_SIGNATURE_USER_ID[0] ;
         n992TBT02_SIGNATURE_USER_ID = P005L5_n992TBT02_SIGNATURE_USER_ID[0] ;
         A40000TAM07_USER_NM = P005L5_A40000TAM07_USER_NM[0] ;
         n40000TAM07_USER_NM = P005L5_n40000TAM07_USER_NM[0] ;
         A40000TAM07_USER_NM = P005L5_A40000TAM07_USER_NM[0] ;
         n40000TAM07_USER_NM = P005L5_n40000TAM07_USER_NM[0] ;
         AV44GXLvl98 = (byte)(1) ;
         ...
         AV39P_SIGNATURE_DATETIME = A991TBT02_SIGNATURE_DATETIME ;
         AV37P_SIGNATURE_USER_ID = A992TBT02_SIGNATURE_USER_ID ;
         AV38P_SIGNATURE_USER_NM = A40000TAM07_USER_NM ;
         /* Exit For each command. Update data (if necessary), close cursors & exit. */
         if (true) break;
         /* Exiting from a For First loop. */
         if (true) break;
   ...
   public void S131( )
   {
      ...
      {
         A191TBM08_AUTH_CD = P005L6_A191TBM08_AUTH_CD[0] ;
         A863TBM08_DM_MICHAKU_CRF_FLG = P005L6_A863TBM08_DM_MICHAKU_CRF_FLG[0] ;
         n863TBM08_DM_MICHAKU_CRF_FLG = P005L6_n863TBM08_DM_MICHAKU_CRF_FLG[0] ;
         A864TBM08_DM_MICHAKU_MEMO_FLG = P005L6_A864TBM08_DM_MICHAKU_MEMO_FLG[0] ;
         n864TBM08_DM_MICHAKU_MEMO_FLG = P005L6_n864TBM08_DM_MICHAKU_MEMO_FLG[0] ;
         A865TBM08_DM_MICHAKU_DM_FLG = P005L6_A865TBM08_DM_MICHAKU_DM_FLG[0] ;
         n865TBM08_DM_MICHAKU_DM_FLG = P005L6_n865TBM08_DM_MICHAKU_DM_FLG[0] ;
         A866TBM08_DM_ARRI_CRF_FLG = P005L6_A866TBM08_DM_ARRI_CRF_FLG[0] ;
         n866TBM08_DM_ARRI_CRF_FLG = P005L6_n866TBM08_DM_ARRI_CRF_FLG[0] ;
         A867TBM08_DM_ARRI_MEMO_FLG = P005L6_A867TBM08_DM_ARRI_MEMO_FLG[0] ;
         n867TBM08_DM_ARRI_MEMO_FLG = P005L6_n867TBM08_DM_ARRI_MEMO_FLG[0] ;
         A868TBM08_DM_ARRI_DM_FLG = P005L6_A868TBM08_DM_ARRI_DM_FLG[0] ;
         n868TBM08_DM_ARRI_DM_FLG = P005L6_n868TBM08_DM_ARRI_DM_FLG[0] ;
         A869TBM08_DM_KAIJO_CRF_FLG = P005L6_A869TBM08_DM_KAIJO_CRF_FLG[0] ;
         n869TBM08_DM_KAIJO_CRF_FLG = P005L6_n869TBM08_DM_KAIJO_CRF_FLG[0] ;
         A870TBM08_DM_KAIJO_MEMO_FLG = P005L6_A870TBM08_DM_KAIJO_MEMO_FLG[0] ;
         n870TBM08_DM_KAIJO_MEMO_FLG = P005L6_n870TBM08_DM_KAIJO_MEMO_FLG[0] ;
         A871TBM08_DM_KAIJO_DM_FLG = P005L6_A871TBM08_DM_KAIJO_DM_FLG[0] ;
         n871TBM08_DM_KAIJO_DM_FLG = P005L6_n871TBM08_DM_KAIJO_DM_FLG[0] ;
      ...
      {
         A58TBM01_SYS_ID = P005L7_A58TBM01_SYS_ID[0] ;
         A608TBM01_SYS_VALUE = P005L7_A608TBM01_SYS_VALUE[0] ;
         n608TBM01_SYS_VALUE = P005L7_n608TBM01_SYS_VALUE[0] ;
   ...
   public void S146( )
   {
      ...
      {
         A88TBT01_SUBJECT_ID = P005L8_A88TBT01_SUBJECT_ID[0] ;
         A87TBT01_STUDY_ID = P005L8_A87TBT01_STUDY_ID[0] ;
         A698TBT01_SITE_ID = P005L8_A698TBT01_SITE_ID[0] ;
         n698TBT01_SITE_ID = P005L8_n698TBT01_SITE_ID[0] ;
         AV47GXLvl212 = (byte)(1) ;
         ...
         if ( ( GXutil.strcmp(AV30W_TBM21_STATUS, "0") == 0 ) || ( GXutil.strcmp(AV32W_TBM31_STATUS, "0") == 0 ) )
         {
            if ( GXutil.strcmp(AV15W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn(), AV8C_DM_AUTH_CD) == 0 )
            {
               if ( GXutil.strcmp(AV23W_FLG_CRF_INP, "1") == 0 )
               {
                  ...
                  if ( GXutil.strcmp(AV18W_DM_ARRIVAL_JYOTAI, "2") == 0 )
                  {
                     AV36P_SIGNATURE_FLG = "1" ;
                  }
                  else
                  {
                     AV36P_SIGNATURE_FLG = "2" ;
                  }
               }
               else
               {
   ...
   {
      /* 'SUB_ERROR' Routine */
      new a804_pc01_syslog(remoteHandle, context).execute( AV48Pgmname, "ERR", GXutil.trim( GXutil.str( context.globals.Gx_dbe, 10, 0))+":"+context.globals.Gx_dbt) ;
   ...
   protected void cleanup( )
   {
      ...
      this.aP12[0] = b702_pc02_header_set.this.AV36P_SIGNATURE_FLG;
      this.aP13[0] = b702_pc02_header_set.this.AV39P_SIGNATURE_DATETIME;
      this.aP14[0] = b702_pc02_header_set.this.AV37P_SIGNATURE_USER_ID;
      this.aP15[0] = b702_pc02_header_set.this.AV38P_SIGNATURE_USER_NM;
      this.aP16[0] = b702_pc02_header_set.this.AV31W_TBM31_GRID_SIZE;
      this.aP17[0] = b702_pc02_header_set.this.AV21W_ERR_FLG;
      this.aP18[0] = b702_pc02_header_set.this.AV22W_ERR_MSG;
      CloseOpenCursors();
      exitApplication();
   }
   ...
   public void initialize( )
   {
      ...
      AV16W_CRF_SNM = "" ;
      AV36P_SIGNATURE_FLG = "" ;
      AV39P_SIGNATURE_DATETIME = GXutil.resetTime( GXutil.nullDate() );
      AV37P_SIGNATURE_USER_ID = "" ;
      AV38P_SIGNATURE_USER_NM = "" ;
      AV21W_ERR_FLG = "" ;
      AV22W_ERR_MSG = "" ;
      A367TBM21_STUDY_NM = "" ;
      A642TBM31_CRF_SNM = "" ;
      ...
      A40000TAM07_USER_NM = "" ;
      P005L5_A449TBT02_DEL_FLG = new String[] {""} ;
      P005L5_n449TBT02_DEL_FLG = new boolean[] {false} ;
      P005L5_A935TBT02_CRF_EDA_NO = new byte[1] ;
      P005L5_A91TBT02_CRF_ID = new short[1] ;
      P005L5_A90TBT02_SUBJECT_ID = new int[1] ;
      P005L5_A89TBT02_STUDY_ID = new long[1] ;
      P005L5_A661TBT02_INPUT_END_FLG = new String[] {""} ;
      P005L5_n661TBT02_INPUT_END_FLG = new boolean[] {false} ;
      P005L5_A655TBT02_DM_ARRIVAL_FLG = new String[] {""} ;
      P005L5_n655TBT02_DM_ARRIVAL_FLG = new boolean[] {false} ;
      P005L5_A656TBT02_DM_ARRIVAL_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P005L5_n656TBT02_DM_ARRIVAL_DATETIME = new boolean[] {false} ;
      P005L5_A991TBT02_SIGNATURE_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P005L5_n991TBT02_SIGNATURE_DATETIME = new boolean[] {false} ;
      P005L5_A992TBT02_SIGNATURE_USER_ID = new String[] {""} ;
      P005L5_n992TBT02_SIGNATURE_USER_ID = new boolean[] {false} ;
      P005L5_A40000TAM07_USER_NM = new String[] {""} ;
      P005L5_n40000TAM07_USER_NM = new boolean[] {false} ;
      A449TBT02_DEL_FLG = "" ;
      ...
      AV25W_FLG_MEMO_INP = "" ;
      AV24W_FLG_DM_ARRI = "" ;
      P005L6_A191TBM08_AUTH_CD = new String[] {""} ;
      P005L6_A863TBM08_DM_MICHAKU_CRF_FLG = new String[] {""} ;
      P005L6_n863TBM08_DM_MICHAKU_CRF_FLG = new boolean[] {false} ;
      P005L6_A864TBM08_DM_MICHAKU_MEMO_FLG = new String[] {""} ;
      P005L6_n864TBM08_DM_MICHAKU_MEMO_FLG = new boolean[] {false} ;
      P005L6_A865TBM08_DM_MICHAKU_DM_FLG = new String[] {""} ;
      P005L6_n865TBM08_DM_MICHAKU_DM_FLG = new boolean[] {false} ;
      P005L6_A866TBM08_DM_ARRI_CRF_FLG = new String[] {""} ;
      P005L6_n866TBM08_DM_ARRI_CRF_FLG = new boolean[] {false} ;
      P005L6_A867TBM08_DM_ARRI_MEMO_FLG = new String[] {""} ;
      P005L6_n867TBM08_DM_ARRI_MEMO_FLG = new boolean[] {false} ;
      P005L6_A868TBM08_DM_ARRI_DM_FLG = new String[] {""} ;
      P005L6_n868TBM08_DM_ARRI_DM_FLG = new boolean[] {false} ;
      P005L6_A869TBM08_DM_KAIJO_CRF_FLG = new String[] {""} ;
      P005L6_n869TBM08_DM_KAIJO_CRF_FLG = new boolean[] {false} ;
      P005L6_A870TBM08_DM_KAIJO_MEMO_FLG = new String[] {""} ;
      P005L6_n870TBM08_DM_KAIJO_MEMO_FLG = new boolean[] {false} ;
      P005L6_A871TBM08_DM_KAIJO_DM_FLG = new String[] {""} ;
      P005L6_n871TBM08_DM_KAIJO_DM_FLG = new boolean[] {false} ;
      A191TBM08_AUTH_CD = "" ;
      ...
      P005L7_A58TBM01_SYS_ID = new String[] {""} ;
      P005L7_A608TBM01_SYS_VALUE = new String[] {""} ;
      P005L7_n608TBM01_SYS_VALUE = new boolean[] {false} ;
      A58TBM01_SYS_ID = "" ;
      A608TBM01_SYS_VALUE = "" ;
      AV34W_TBT01_SITE_ID = "" ;
      P005L8_A88TBT01_SUBJECT_ID = new int[1] ;
      P005L8_A87TBT01_STUDY_ID = new long[1] ;
      P005L8_A698TBT01_SITE_ID = new String[] {""} ;
      P005L8_n698TBT01_SITE_ID = new boolean[] {false} ;
      AV8C_DM_AUTH_CD = "" ;
      GXt_char1 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b702_pc02_header_set__default(),
         new Object[] {
            ...
            , new Object[] {
            P005L5_A449TBT02_DEL_FLG, P005L5_n449TBT02_DEL_FLG, P005L5_A935TBT02_CRF_EDA_NO, P005L5_A91TBT02_CRF_ID, P005L5_A90TBT02_SUBJECT_ID, P005L5_A89TBT02_STUDY_ID, P005L5_A661TBT02_INPUT_END_FLG, P005L5_n661TBT02_INPUT_END_FLG, P005L5_A655TBT02_DM_ARRIVAL_FLG, P005L5_n655TBT02_DM_ARRIVAL_FLG,
            P005L5_A656TBT02_DM_ARRIVAL_DATETIME, P005L5_n656TBT02_DM_ARRIVAL_DATETIME, P005L5_A991TBT02_SIGNATURE_DATETIME, P005L5_n991TBT02_SIGNATURE_DATETIME, P005L5_A992TBT02_SIGNATURE_USER_ID, P005L5_n992TBT02_SIGNATURE_USER_ID, P005L5_A40000TAM07_USER_NM, P005L5_n40000TAM07_USER_NM
            }
            , new Object[] {
            P005L6_A191TBM08_AUTH_CD, P005L6_A863TBM08_DM_MICHAKU_CRF_FLG, P005L6_n863TBM08_DM_MICHAKU_CRF_FLG, P005L6_A864TBM08_DM_MICHAKU_MEMO_FLG, P005L6_n864TBM08_DM_MICHAKU_MEMO_FLG, P005L6_A865TBM08_DM_MICHAKU_DM_FLG, P005L6_n865TBM08_DM_MICHAKU_DM_FLG, P005L6_A866TBM08_DM_ARRI_CRF_FLG, P005L6_n866TBM08_DM_ARRI_CRF_FLG, P005L6_A867TBM08_DM_ARRI_MEMO_FLG,
            P005L6_n867TBM08_DM_ARRI_MEMO_FLG, P005L6_A868TBM08_DM_ARRI_DM_FLG, P005L6_n868TBM08_DM_ARRI_DM_FLG, P005L6_A869TBM08_DM_KAIJO_CRF_FLG, P005L6_n869TBM08_DM_KAIJO_CRF_FLG, P005L6_A870TBM08_DM_KAIJO_MEMO_FLG, P005L6_n870TBM08_DM_KAIJO_MEMO_FLG, P005L6_A871TBM08_DM_KAIJO_DM_FLG, P005L6_n871TBM08_DM_KAIJO_DM_FLG
            }
            , new Object[] {
            P005L7_A58TBM01_SYS_ID, P005L7_A608TBM01_SYS_VALUE, P005L7_n608TBM01_SYS_VALUE
            }
            , new Object[] {
            P005L8_A88TBT01_SUBJECT_ID, P005L8_A87TBT01_STUDY_ID, P005L8_A698TBT01_SITE_ID, P005L8_n698TBT01_SITE_ID
            }
         }
      );
      pr_default.setErrorHandler(this);
      AV48Pgmname = "B702_PC02_HEADER_SET" ;
      /* GeneXus formulas. */
      AV48Pgmname = "B702_PC02_HEADER_SET" ;
      Gx_err = (short)(0) ;
   }
   ...
   private byte AV42GXLvl60 ;
   private byte A947TBM44_CRF_EDA_NO ;
   private byte AV44GXLvl98 ;
   private byte A935TBT02_CRF_EDA_NO ;
   private byte AV47GXLvl212 ;
   ...
   private java.util.Date AV39P_SIGNATURE_DATETIME ;
   ...
   private String AV36P_SIGNATURE_FLG ;
   private String AV37P_SIGNATURE_USER_ID ;
   private String AV38P_SIGNATURE_USER_NM ;
   ...
   private String[] P005L5_A449TBT02_DEL_FLG ;
   private boolean[] P005L5_n449TBT02_DEL_FLG ;
   private byte[] P005L5_A935TBT02_CRF_EDA_NO ;
   private short[] P005L5_A91TBT02_CRF_ID ;
   private int[] P005L5_A90TBT02_SUBJECT_ID ;
   private long[] P005L5_A89TBT02_STUDY_ID ;
   private String[] P005L5_A661TBT02_INPUT_END_FLG ;
   private boolean[] P005L5_n661TBT02_INPUT_END_FLG ;
   private String[] P005L5_A655TBT02_DM_ARRIVAL_FLG ;
   private boolean[] P005L5_n655TBT02_DM_ARRIVAL_FLG ;
   private java.util.Date[] P005L5_A656TBT02_DM_ARRIVAL_DATETIME ;
   private boolean[] P005L5_n656TBT02_DM_ARRIVAL_DATETIME ;
   private java.util.Date[] P005L5_A991TBT02_SIGNATURE_DATETIME ;
   private boolean[] P005L5_n991TBT02_SIGNATURE_DATETIME ;
   private String[] P005L5_A992TBT02_SIGNATURE_USER_ID ;
   private boolean[] P005L5_n992TBT02_SIGNATURE_USER_ID ;
   private String[] P005L5_A40000TAM07_USER_NM ;
   private boolean[] P005L5_n40000TAM07_USER_NM ;
   private String[] P005L6_A191TBM08_AUTH_CD ;
   private String[] P005L6_A863TBM08_DM_MICHAKU_CRF_FLG ;
   private boolean[] P005L6_n863TBM08_DM_MICHAKU_CRF_FLG ;
   private String[] P005L6_A864TBM08_DM_MICHAKU_MEMO_FLG ;
   private boolean[] P005L6_n864TBM08_DM_MICHAKU_MEMO_FLG ;
   private String[] P005L6_A865TBM08_DM_MICHAKU_DM_FLG ;
   private boolean[] P005L6_n865TBM08_DM_MICHAKU_DM_FLG ;
   private String[] P005L6_A866TBM08_DM_ARRI_CRF_FLG ;
   private boolean[] P005L6_n866TBM08_DM_ARRI_CRF_FLG ;
   private String[] P005L6_A867TBM08_DM_ARRI_MEMO_FLG ;
   private boolean[] P005L6_n867TBM08_DM_ARRI_MEMO_FLG ;
   private String[] P005L6_A868TBM08_DM_ARRI_DM_FLG ;
   private boolean[] P005L6_n868TBM08_DM_ARRI_DM_FLG ;
   private String[] P005L6_A869TBM08_DM_KAIJO_CRF_FLG ;
   private boolean[] P005L6_n869TBM08_DM_KAIJO_CRF_FLG ;
   private String[] P005L6_A870TBM08_DM_KAIJO_MEMO_FLG ;
   private boolean[] P005L6_n870TBM08_DM_KAIJO_MEMO_FLG ;
   private String[] P005L6_A871TBM08_DM_KAIJO_DM_FLG ;
   private boolean[] P005L6_n871TBM08_DM_KAIJO_DM_FLG ;
   private String[] P005L7_A58TBM01_SYS_ID ;
   private String[] P005L7_A608TBM01_SYS_VALUE ;
   private boolean[] P005L7_n608TBM01_SYS_VALUE ;
   private int[] P005L8_A88TBT01_SUBJECT_ID ;
   private long[] P005L8_A87TBT01_STUDY_ID ;
   private String[] P005L8_A698TBT01_SITE_ID ;
   private boolean[] P005L8_n698TBT01_SITE_ID ;
...
final  class b702_pc02_header_set__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("P005L5", "SELECT T1.`TBT02_DEL_FLG`, T1.`TBT02_CRF_EDA_NO`, T1.`TBT02_CRF_ID`, T1.`TBT02_SUBJECT_ID`, T1.`TBT02_STUDY_ID`, T1.`TBT02_INPUT_END_FLG`, T1.`TBT02_DM_ARRIVAL_FLG`, T1.`TBT02_DM_ARRIVAL_DATETIME`, T1.`TBT02_SIGNATURE_DATETIME`, T1.`TBT02_SIGNATURE_USER_ID`, COALESCE( T2.`TAM07_USER_NM`, '') AS TAM07_USER_NM FROM (`TBT02_CRF` T1 LEFT JOIN (SELECT `TAM07_USER_NM` AS TAM07_USER_NM, `TAM07_USER_ID`, `TAM07_DEL_FLG` FROM `TAM07_USER` WHERE `TAM07_DEL_FLG` = '0' ) T2 ON T2.`TAM07_USER_ID` = T1.`TBT02_SIGNATURE_USER_ID`) WHERE (T1.`TBT02_STUDY_ID` = ? and T1.`TBT02_SUBJECT_ID` = ? and T1.`TBT02_CRF_ID` = ? and T1.`TBT02_CRF_EDA_NO` = ?) AND (T1.`TBT02_DEL_FLG` = '0') ORDER BY T1.`TBT02_STUDY_ID`, T1.`TBT02_SUBJECT_ID`, T1.`TBT02_CRF_ID`, T1.`TBT02_CRF_EDA_NO`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("P005L6", "SELECT `TBM08_AUTH_CD`, `TBM08_DM_MICHAKU_CRF_FLG`, `TBM08_DM_MICHAKU_MEMO_FLG`, `TBM08_DM_MICHAKU_DM_FLG`, `TBM08_DM_ARRI_CRF_FLG`, `TBM08_DM_ARRI_MEMO_FLG`, `TBM08_DM_ARRI_DM_FLG`, `TBM08_DM_KAIJO_CRF_FLG`, `TBM08_DM_KAIJO_MEMO_FLG`, `TBM08_DM_KAIJO_DM_FLG` FROM `TBM08_AUTH_INP_LVL` WHERE `TBM08_AUTH_CD` = ? ORDER BY `TBM08_AUTH_CD`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("P005L7", "SELECT `TBM01_SYS_ID`, `TBM01_SYS_VALUE` FROM `TBM01_SYSTEM` WHERE `TBM01_SYS_ID` = '014' ORDER BY `TBM01_SYS_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("P005L8", "SELECT `TBT01_SUBJECT_ID`, `TBT01_STUDY_ID`, `TBT01_SITE_ID` FROM `TBT01_SUBJECT` WHERE `TBT01_STUDY_ID` = ? and `TBT01_SUBJECT_ID` = ? ORDER BY `TBT01_STUDY_ID`, `TBT01_SUBJECT_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
