/*
       ...
       Generated on: July 15, 2020 13:20:8.53
...
public final  class SdtTBT11_CRF_HISTORY extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            {
               gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT11_SIGNATURE_DATETIME") )
            {
               if ( ( GXutil.strcmp(oReader.getValue(), "0000-00-00T00:00:00") == 0 ) || ( oReader.existsAttribute("xsi:nil") == 1 ) )
               {
                  gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime = GXutil.resetTime( GXutil.nullDate() );
               }
               else
               {
                  gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime = localUtil.ymdhmsToT( (short)(GXutil.val( GXutil.substring( oReader.getValue(), 1, 4), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 6, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 9, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 12, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 15, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 18, 2), "."))) ;
               }
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT11_SIGNATURE_USER_ID") )
            {
               gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT11_SIGNATURE_FLG_Z") )
            {
               gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT11_SIGNATURE_DATETIME_Z") )
            {
               if ( ( GXutil.strcmp(oReader.getValue(), "0000-00-00T00:00:00") == 0 ) || ( oReader.existsAttribute("xsi:nil") == 1 ) )
               {
                  gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z = GXutil.resetTime( GXutil.nullDate() );
               }
               else
               {
                  gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z = localUtil.ymdhmsToT( (short)(GXutil.val( GXutil.substring( oReader.getValue(), 1, 4), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 6, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 9, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 12, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 15, 2), ".")), (byte)(GXutil.val( GXutil.substring( oReader.getValue(), 18, 2), "."))) ;
               }
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT11_SIGNATURE_USER_ID_Z") )
            {
               gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT11_SIGNATURE_FLG_N") )
            {
               gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT11_SIGNATURE_DATETIME_N") )
            {
               gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TBT11_SIGNATURE_USER_ID_N") )
            {
               gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("TBT11_SIGNATURE_FLG", GXutil.rtrim( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      if ( GXutil.nullDate().equals(gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime) )
      {
      ...
      {
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.month( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.day( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "T" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.hour( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + ":" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.minute( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + ":" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      ...
      oWriter.writeElement("TBT11_SIGNATURE_USER_ID", GXutil.rtrim( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      ...
      if ( sIncludeState )
      {
         ...
         oWriter.writeElement("TBT11_SIGNATURE_FLG_Z", GXutil.rtrim( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         if ( GXutil.nullDate().equals(gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z) )
         {
            oWriter.writeStartElement("TBT11_SIGNATURE_DATETIME_Z");
            oWriter.writeAttribute("xmlns:xsi", "http://www.w3.org/2001/XMLSchema-instance");
            oWriter.writeAttribute("xsi:nil", "true");
            oWriter.writeEndElement();
         }
         ...
         {
            sDateCnv = "" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.year( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + "-" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.month( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + "-" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.day( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + "T" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.hour( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + ":" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.minute( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            sDateCnv = sDateCnv + ":" ;
            sNumToPad = GXutil.trim( GXutil.str( GXutil.second( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z), 10, 0)) ;
            sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
            oWriter.writeElement("TBT11_SIGNATURE_DATETIME_Z", sDateCnv);
            if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
            {
               oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
            }
         }
         oWriter.writeElement("TBT11_SIGNATURE_USER_ID_Z", GXutil.rtrim( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         ...
         oWriter.writeElement("TBT11_SIGNATURE_FLG_N", GXutil.trim( GXutil.str( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N, 1, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         oWriter.writeElement("TBT11_SIGNATURE_DATETIME_N", GXutil.trim( GXutil.str( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N, 1, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         oWriter.writeElement("TBT11_SIGNATURE_USER_ID_N", GXutil.trim( GXutil.str( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N, 1, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
   ...
   public void tojson( boolean includeState )
   {
      ...
      AddObjectProperty("TBT11_SIGNATURE_FLG", gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg, false);
      datetime_STZ = gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBT11_SIGNATURE_USER_ID", gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id, false);
      ...
      if ( includeState )
      {
         ...
         AddObjectProperty("TBT11_SIGNATURE_FLG_Z", gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z, false);
         datetime_STZ = gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBT11_SIGNATURE_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBT11_SIGNATURE_USER_ID_Z", gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z, false);
         ...
         AddObjectProperty("TBT11_SIGNATURE_FLG_N", gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N, false);
         AddObjectProperty("TBT11_SIGNATURE_DATETIME_N", gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N, false);
         AddObjectProperty("TBT11_SIGNATURE_USER_ID_N", gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N, false);
   ...
   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_study_id( long value )
   {
      if ( gxTv_SdtTBT11_CRF_HISTORY_Tbt11_study_id != value )
      {
         ...
         this.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z_SetNull( );
         this.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z_SetNull( );
         this.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z_SetNull( );
   ...
   public String getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg( )
   {
      return gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg( String value )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N = (byte)(0) ;
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg = value ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_SetNull( )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N = (byte)(1) ;
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg = "" ;
   }

   public boolean getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_IsNull( )
   {
      return false ;
   }

   public java.util.Date getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime( )
   {
      return gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime( java.util.Date value )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N = (byte)(0) ;
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime = value ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_SetNull( )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N = (byte)(1) ;
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime = GXutil.resetTime( GXutil.nullDate() );
   }

   public boolean getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_IsNull( )
   {
      return false ;
   }

   public String getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id( )
   {
      return gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id( String value )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N = (byte)(0) ;
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id = value ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_SetNull( )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N = (byte)(1) ;
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id = "" ;
   }

   public boolean getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_IsNull( )
   {
      return false ;
   }
   ...
   public String getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z( )
   {
      return gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z( String value )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z = value ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z_SetNull( )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z = "" ;
   }

   public boolean getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z_IsNull( )
   {
      return false ;
   }

   public java.util.Date getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z( )
   {
      return gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z( java.util.Date value )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z = value ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z_SetNull( )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z = GXutil.resetTime( GXutil.nullDate() );
   }

   public boolean getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z_IsNull( )
   {
      return false ;
   }

   public String getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z( )
   {
      return gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z( String value )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z = value ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z_SetNull( )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z = "" ;
   }

   public boolean getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z_IsNull( )
   {
      return false ;
   }
   ...
   public byte getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N( )
   {
      return gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N( byte value )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N = value ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N_SetNull( )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N = (byte)(0) ;
   }

   public boolean getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N_IsNull( )
   {
      return false ;
   }

   public byte getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N( )
   {
      return gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N( byte value )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N = value ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N_SetNull( )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N = (byte)(0) ;
   }

   public boolean getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N_IsNull( )
   {
      return false ;
   }

   public byte getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N( )
   {
      return gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N( byte value )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N = value ;
   }

   public void setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N_SetNull( )
   {
      gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N = (byte)(0) ;
   }

   public boolean getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N_IsNull( )
   {
      return false ;
   }
   ...
   public void setStruct( StructSdtTBT11_CRF_HISTORY struct )
   {
      ...
      setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg(struct.getTbt11_signature_flg());
      setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime(struct.getTbt11_signature_datetime());
      setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id(struct.getTbt11_signature_user_id());
      ...
      setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z(struct.getTbt11_signature_flg_Z());
      setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z(struct.getTbt11_signature_datetime_Z());
      setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z(struct.getTbt11_signature_user_id_Z());
      ...
      setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N(struct.getTbt11_signature_flg_N());
      setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N(struct.getTbt11_signature_datetime_N());
      setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N(struct.getTbt11_signature_user_id_N());
   ...
   public StructSdtTBT11_CRF_HISTORY getStruct( )
   {
      ...
      struct.setTbt11_signature_flg(getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg());
      struct.setTbt11_signature_datetime(getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime());
      struct.setTbt11_signature_user_id(getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id());
      ...
      struct.setTbt11_signature_flg_Z(getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z());
      struct.setTbt11_signature_datetime_Z(getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z());
      struct.setTbt11_signature_user_id_Z(getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z());
      ...
      struct.setTbt11_signature_flg_N(getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N());
      struct.setTbt11_signature_datetime_N(getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N());
      struct.setTbt11_signature_user_id_N(getgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N());
   ...
   private byte gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_N ;
   private byte gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_N ;
   private byte gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_N ;
   ...
   private java.util.Date gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime ;
   ...
   private java.util.Date gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime_Z ;
   ...
   private String gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg ;
   private String gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id ;
   ...
   private String gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg_Z ;
   private String gxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id_Z ;
