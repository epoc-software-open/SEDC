...
public final  class promptmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm032( )
   {
      ...
      httpContext.AddJavascriptSource("promptmasterpage.js", "?202071513222593");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?202071513222596");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("promptmasterpage.js", "?202071513222596");
      }
