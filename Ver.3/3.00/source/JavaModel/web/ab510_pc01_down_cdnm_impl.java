/*
               File: ab510_pc01_down_cdnm_impl
        Description: 項目名称マスタダウンロード
             Author: GeneXus Java Generator version 10_3_3-92797
       Generated on: July 15, 2020 13:16:48.28
...
public final  class ab510_pc01_down_cdnm_impl extends GXWebProcedure
{
   public ab510_pc01_down_cdnm_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }
   ...
   private void privateExecute( )
   {
      ...
      ab510_pc01_down_cdnm_impl.this.GXt_char1 = GXv_char2[0] ;
      ...
      if ( AV11W_ERR_CD == 0 )
      {
         ...
         new b599_pc22_cdnm_res(remoteHandle, context).execute( "", "", GXv_objcol_svchar3, GXv_int4, GXv_char2) ;
         AV16W_RTN_CSV = GXv_objcol_svchar3[0] ;
         ab510_pc01_down_cdnm_impl.this.AV11W_ERR_CD = GXv_int4[0] ;
         ab510_pc01_down_cdnm_impl.this.AV12W_ERR_MSG = GXv_char2[0] ;
      }
   ...
   public void S121( )
   {
      ...
      ab510_pc01_down_cdnm_impl.this.AV9P_USER_ID = GXv_char2[0] ;
      ab510_pc01_down_cdnm_impl.this.AV11W_ERR_CD = GXv_int4[0] ;
      ab510_pc01_down_cdnm_impl.this.AV12W_ERR_MSG = GXv_char6[0] ;
   }
   ...
   public void S131( )
   {
      ...
      if ( AV11W_ERR_CD == 0 )
      {
         Application.commit(context, remoteHandle, "DEFAULT", "ab510_pc01_down_cdnm");
      }
      else
      {
         Application.rollback(context, remoteHandle, "DEFAULT", "ab510_pc01_down_cdnm");
      }
   ...
   public void initialize( )
   {
      ...
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new ab510_pc01_down_cdnm__default(),
         new Object[] {
         }
      );
      pr_default.setErrorHandler(this);
      AV24Pgmdesc = "項目名称マスタダウンロード" ;
      AV23Pgmname = "AB510_PC01_DOWN_CDNM" ;
      /* GeneXus formulas. */
      AV24Pgmdesc = "項目名称マスタダウンロード" ;
      AV23Pgmname = "AB510_PC01_DOWN_CDNM" ;
      Gx_err = (short)(0) ;
...
final  class ab510_pc01_down_cdnm__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
