/*
       ...
       Generated on: July 15, 2020 13:18:46.50
...
public final  class SdtTAM07_USER extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( String AV55TAM07_USER_ID )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {AV55TAM07_USER_ID});
   }

   public Object[][] GetBCKey( )
   {
      return (Object[][])(new Object[][]{new Object[]{"TAM07_USER_ID", String.class}}) ;
   }
   ...
   public com.genexus.util.GXProperties getMetadata( )
   {
      ...
      metadata.set("Name", "TAM07_USER");
      metadata.set("BT", "TAM07_USER");
      metadata.set("PK", "[ \"TAM07_USER_ID\" ]");
      metadata.set("FKList", "[ { \"FK\":[ \"TAM04_AUTH_CD\" ],\"FKMap\":[ \"TAM07_AUTH_CD-TAM04_AUTH_CD\" ] } ]");
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            {
               gxTv_SdtTAM07_USER_Tam07_admin_auth_flg = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TAM07_NC_FLG") )
            {
               gxTv_SdtTAM07_USER_Tam07_nc_flg = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TAM07_NOTE") )
            {
               gxTv_SdtTAM07_USER_Tam07_note = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TAM07_ADMIN_AUTH_FLG_Z") )
            {
               gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TAM07_NC_FLG_Z") )
            {
               gxTv_SdtTAM07_USER_Tam07_nc_flg_Z = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TAM07_NOTE_Z") )
            {
               gxTv_SdtTAM07_USER_Tam07_note_Z = oReader.getValue() ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TAM07_ADMIN_AUTH_FLG_N") )
            {
               gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TAM07_NC_FLG_N") )
            {
               gxTv_SdtTAM07_USER_Tam07_nc_flg_N = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TAM07_NOTE_N") )
            {
               gxTv_SdtTAM07_USER_Tam07_note_N = (byte)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("TAM07_ADMIN_AUTH_FLG", GXutil.rtrim( gxTv_SdtTAM07_USER_Tam07_admin_auth_flg));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      oWriter.writeElement("TAM07_NC_FLG", GXutil.rtrim( gxTv_SdtTAM07_USER_Tam07_nc_flg));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      oWriter.writeElement("TAM07_NOTE", GXutil.rtrim( gxTv_SdtTAM07_USER_Tam07_note));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      ...
      if ( sIncludeState )
      {
         ...
         oWriter.writeElement("TAM07_ADMIN_AUTH_FLG_Z", GXutil.rtrim( gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         oWriter.writeElement("TAM07_NC_FLG_Z", GXutil.rtrim( gxTv_SdtTAM07_USER_Tam07_nc_flg_Z));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         oWriter.writeElement("TAM07_NOTE_Z", GXutil.rtrim( gxTv_SdtTAM07_USER_Tam07_note_Z));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         ...
         oWriter.writeElement("TAM07_ADMIN_AUTH_FLG_N", GXutil.trim( GXutil.str( gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N, 1, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         oWriter.writeElement("TAM07_NC_FLG_N", GXutil.trim( GXutil.str( gxTv_SdtTAM07_USER_Tam07_nc_flg_N, 1, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
         oWriter.writeElement("TAM07_NOTE_N", GXutil.trim( GXutil.str( gxTv_SdtTAM07_USER_Tam07_note_N, 1, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
   ...
   {
      AddObjectProperty("TAM07_USER_ID", gxTv_SdtTAM07_USER_Tam07_user_id, false);
      AddObjectProperty("TAM07_USER_NM", gxTv_SdtTAM07_USER_Tam07_user_nm, false);
      AddObjectProperty("TAM07_USER_KANA_NM", gxTv_SdtTAM07_USER_Tam07_user_kana_nm, false);
      AddObjectProperty("TAM07_PWD", gxTv_SdtTAM07_USER_Tam07_pwd, false);
      AddObjectProperty("TAM07_AUTH_CD", gxTv_SdtTAM07_USER_Tam07_auth_cd, false);
      AddObjectProperty("TAM07_SITE_ID", gxTv_SdtTAM07_USER_Tam07_site_id, false);
      AddObjectProperty("TAM07_EMAIL", gxTv_SdtTAM07_USER_Tam07_email, false);
      AddObjectProperty("TAM07_ADMIN_AUTH_FLG", gxTv_SdtTAM07_USER_Tam07_admin_auth_flg, false);
      AddObjectProperty("TAM07_NC_FLG", gxTv_SdtTAM07_USER_Tam07_nc_flg, false);
      AddObjectProperty("TAM07_NOTE", gxTv_SdtTAM07_USER_Tam07_note, false);
      AddObjectProperty("TAM07_DEL_FLG", gxTv_SdtTAM07_USER_Tam07_del_flg, false);
      datetime_STZ = gxTv_SdtTAM07_USER_Tam07_crt_datetime ;
      sDateCnv = "" ;
      ...
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TAM07_CRT_DATETIME", sDateCnv, false);
      AddObjectProperty("TAM07_CRT_USER_ID", gxTv_SdtTAM07_USER_Tam07_crt_user_id, false);
      AddObjectProperty("TAM07_CRT_PROG_NM", gxTv_SdtTAM07_USER_Tam07_crt_prog_nm, false);
      datetime_STZ = gxTv_SdtTAM07_USER_Tam07_upd_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TAM07_UPD_DATETIME", sDateCnv, false);
      AddObjectProperty("TAM07_UPD_USER_ID", gxTv_SdtTAM07_USER_Tam07_upd_user_id, false);
      AddObjectProperty("TAM07_UPD_PROG_NM", gxTv_SdtTAM07_USER_Tam07_upd_prog_nm, false);
      AddObjectProperty("TAM07_UPD_CNT", gxTv_SdtTAM07_USER_Tam07_upd_cnt, false);
      if ( includeState )
      {
         AddObjectProperty("Mode", gxTv_SdtTAM07_USER_Mode, false);
         AddObjectProperty("Initialized", gxTv_SdtTAM07_USER_Initialized, false);
         AddObjectProperty("TAM07_USER_ID_Z", gxTv_SdtTAM07_USER_Tam07_user_id_Z, false);
         AddObjectProperty("TAM07_USER_NM_Z", gxTv_SdtTAM07_USER_Tam07_user_nm_Z, false);
         AddObjectProperty("TAM07_USER_KANA_NM_Z", gxTv_SdtTAM07_USER_Tam07_user_kana_nm_Z, false);
         AddObjectProperty("TAM07_PWD_Z", gxTv_SdtTAM07_USER_Tam07_pwd_Z, false);
         AddObjectProperty("TAM07_AUTH_CD_Z", gxTv_SdtTAM07_USER_Tam07_auth_cd_Z, false);
         AddObjectProperty("TAM07_SITE_ID_Z", gxTv_SdtTAM07_USER_Tam07_site_id_Z, false);
         AddObjectProperty("TAM07_EMAIL_Z", gxTv_SdtTAM07_USER_Tam07_email_Z, false);
         AddObjectProperty("TAM07_ADMIN_AUTH_FLG_Z", gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z, false);
         AddObjectProperty("TAM07_NC_FLG_Z", gxTv_SdtTAM07_USER_Tam07_nc_flg_Z, false);
         AddObjectProperty("TAM07_NOTE_Z", gxTv_SdtTAM07_USER_Tam07_note_Z, false);
         AddObjectProperty("TAM07_DEL_FLG_Z", gxTv_SdtTAM07_USER_Tam07_del_flg_Z, false);
         datetime_STZ = gxTv_SdtTAM07_USER_Tam07_crt_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TAM07_CRT_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TAM07_CRT_USER_ID_Z", gxTv_SdtTAM07_USER_Tam07_crt_user_id_Z, false);
         AddObjectProperty("TAM07_CRT_PROG_NM_Z", gxTv_SdtTAM07_USER_Tam07_crt_prog_nm_Z, false);
         datetime_STZ = gxTv_SdtTAM07_USER_Tam07_upd_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TAM07_UPD_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TAM07_UPD_USER_ID_Z", gxTv_SdtTAM07_USER_Tam07_upd_user_id_Z, false);
         AddObjectProperty("TAM07_UPD_PROG_NM_Z", gxTv_SdtTAM07_USER_Tam07_upd_prog_nm_Z, false);
         AddObjectProperty("TAM07_UPD_CNT_Z", gxTv_SdtTAM07_USER_Tam07_upd_cnt_Z, false);
         AddObjectProperty("TAM07_USER_NM_N", gxTv_SdtTAM07_USER_Tam07_user_nm_N, false);
         AddObjectProperty("TAM07_USER_KANA_NM_N", gxTv_SdtTAM07_USER_Tam07_user_kana_nm_N, false);
         AddObjectProperty("TAM07_PWD_N", gxTv_SdtTAM07_USER_Tam07_pwd_N, false);
         AddObjectProperty("TAM07_AUTH_CD_N", gxTv_SdtTAM07_USER_Tam07_auth_cd_N, false);
         AddObjectProperty("TAM07_SITE_ID_N", gxTv_SdtTAM07_USER_Tam07_site_id_N, false);
         AddObjectProperty("TAM07_EMAIL_N", gxTv_SdtTAM07_USER_Tam07_email_N, false);
         AddObjectProperty("TAM07_ADMIN_AUTH_FLG_N", gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N, false);
         AddObjectProperty("TAM07_NC_FLG_N", gxTv_SdtTAM07_USER_Tam07_nc_flg_N, false);
         AddObjectProperty("TAM07_NOTE_N", gxTv_SdtTAM07_USER_Tam07_note_N, false);
         AddObjectProperty("TAM07_DEL_FLG_N", gxTv_SdtTAM07_USER_Tam07_del_flg_N, false);
         AddObjectProperty("TAM07_CRT_DATETIME_N", gxTv_SdtTAM07_USER_Tam07_crt_datetime_N, false);
         AddObjectProperty("TAM07_CRT_USER_ID_N", gxTv_SdtTAM07_USER_Tam07_crt_user_id_N, false);
         AddObjectProperty("TAM07_CRT_PROG_NM_N", gxTv_SdtTAM07_USER_Tam07_crt_prog_nm_N, false);
         AddObjectProperty("TAM07_UPD_DATETIME_N", gxTv_SdtTAM07_USER_Tam07_upd_datetime_N, false);
         AddObjectProperty("TAM07_UPD_USER_ID_N", gxTv_SdtTAM07_USER_Tam07_upd_user_id_N, false);
         AddObjectProperty("TAM07_UPD_PROG_NM_N", gxTv_SdtTAM07_USER_Tam07_upd_prog_nm_N, false);
         AddObjectProperty("TAM07_UPD_CNT_N", gxTv_SdtTAM07_USER_Tam07_upd_cnt_N, false);
      }
   }
   ...
   public void setgxTv_SdtTAM07_USER_Tam07_user_id( String value )
   {
      if ( GXutil.strcmp(gxTv_SdtTAM07_USER_Tam07_user_id, value) != 0 )
      {
         ...
         this.setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z_SetNull( );
         this.setgxTv_SdtTAM07_USER_Tam07_nc_flg_Z_SetNull( );
         this.setgxTv_SdtTAM07_USER_Tam07_note_Z_SetNull( );
   ...
   public String getgxTv_SdtTAM07_USER_Tam07_admin_auth_flg( )
   {
      return gxTv_SdtTAM07_USER_Tam07_admin_auth_flg ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg( String value )
   {
      gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N = (byte)(0) ;
      gxTv_SdtTAM07_USER_Tam07_admin_auth_flg = value ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_SetNull( )
   {
      gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N = (byte)(1) ;
      gxTv_SdtTAM07_USER_Tam07_admin_auth_flg = "" ;
   }

   public boolean getgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_IsNull( )
   {
      return false ;
   }

   public String getgxTv_SdtTAM07_USER_Tam07_nc_flg( )
   {
      return gxTv_SdtTAM07_USER_Tam07_nc_flg ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_nc_flg( String value )
   {
      gxTv_SdtTAM07_USER_Tam07_nc_flg_N = (byte)(0) ;
      gxTv_SdtTAM07_USER_Tam07_nc_flg = value ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_nc_flg_SetNull( )
   {
      gxTv_SdtTAM07_USER_Tam07_nc_flg_N = (byte)(1) ;
      gxTv_SdtTAM07_USER_Tam07_nc_flg = "" ;
   }

   public boolean getgxTv_SdtTAM07_USER_Tam07_nc_flg_IsNull( )
   {
      return false ;
   }

   public String getgxTv_SdtTAM07_USER_Tam07_note( )
   {
      return gxTv_SdtTAM07_USER_Tam07_note ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_note( String value )
   {
      gxTv_SdtTAM07_USER_Tam07_note_N = (byte)(0) ;
      gxTv_SdtTAM07_USER_Tam07_note = value ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_note_SetNull( )
   {
      gxTv_SdtTAM07_USER_Tam07_note_N = (byte)(1) ;
      gxTv_SdtTAM07_USER_Tam07_note = "" ;
   }

   public boolean getgxTv_SdtTAM07_USER_Tam07_note_IsNull( )
   {
      return false ;
   }
   ...
   public String getgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z( )
   {
      return gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z( String value )
   {
      gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z = value ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z_SetNull( )
   {
      gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z = "" ;
   }

   public boolean getgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z_IsNull( )
   {
      return false ;
   }

   public String getgxTv_SdtTAM07_USER_Tam07_nc_flg_Z( )
   {
      return gxTv_SdtTAM07_USER_Tam07_nc_flg_Z ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_nc_flg_Z( String value )
   {
      gxTv_SdtTAM07_USER_Tam07_nc_flg_Z = value ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_nc_flg_Z_SetNull( )
   {
      gxTv_SdtTAM07_USER_Tam07_nc_flg_Z = "" ;
   }

   public boolean getgxTv_SdtTAM07_USER_Tam07_nc_flg_Z_IsNull( )
   {
      return false ;
   }

   public String getgxTv_SdtTAM07_USER_Tam07_note_Z( )
   {
      return gxTv_SdtTAM07_USER_Tam07_note_Z ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_note_Z( String value )
   {
      gxTv_SdtTAM07_USER_Tam07_note_Z = value ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_note_Z_SetNull( )
   {
      gxTv_SdtTAM07_USER_Tam07_note_Z = "" ;
   }

   public boolean getgxTv_SdtTAM07_USER_Tam07_note_Z_IsNull( )
   {
      return false ;
   }
   ...
   public byte getgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N( )
   {
      return gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N( byte value )
   {
      gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N = value ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N_SetNull( )
   {
      gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N = (byte)(0) ;
   }

   public boolean getgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N_IsNull( )
   {
      return false ;
   }

   public byte getgxTv_SdtTAM07_USER_Tam07_nc_flg_N( )
   {
      return gxTv_SdtTAM07_USER_Tam07_nc_flg_N ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_nc_flg_N( byte value )
   {
      gxTv_SdtTAM07_USER_Tam07_nc_flg_N = value ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_nc_flg_N_SetNull( )
   {
      gxTv_SdtTAM07_USER_Tam07_nc_flg_N = (byte)(0) ;
   }

   public boolean getgxTv_SdtTAM07_USER_Tam07_nc_flg_N_IsNull( )
   {
      return false ;
   }

   public byte getgxTv_SdtTAM07_USER_Tam07_note_N( )
   {
      return gxTv_SdtTAM07_USER_Tam07_note_N ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_note_N( byte value )
   {
      gxTv_SdtTAM07_USER_Tam07_note_N = value ;
   }

   public void setgxTv_SdtTAM07_USER_Tam07_note_N_SetNull( )
   {
      gxTv_SdtTAM07_USER_Tam07_note_N = (byte)(0) ;
   }

   public boolean getgxTv_SdtTAM07_USER_Tam07_note_N_IsNull( )
   {
      return false ;
   }
   ...
   public void setStruct( StructSdtTAM07_USER struct )
   {
      ...
      setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg(struct.getTam07_admin_auth_flg());
      setgxTv_SdtTAM07_USER_Tam07_nc_flg(struct.getTam07_nc_flg());
      setgxTv_SdtTAM07_USER_Tam07_note(struct.getTam07_note());
      ...
      setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z(struct.getTam07_admin_auth_flg_Z());
      setgxTv_SdtTAM07_USER_Tam07_nc_flg_Z(struct.getTam07_nc_flg_Z());
      setgxTv_SdtTAM07_USER_Tam07_note_Z(struct.getTam07_note_Z());
      ...
      setgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N(struct.getTam07_admin_auth_flg_N());
      setgxTv_SdtTAM07_USER_Tam07_nc_flg_N(struct.getTam07_nc_flg_N());
      setgxTv_SdtTAM07_USER_Tam07_note_N(struct.getTam07_note_N());
   ...
   public StructSdtTAM07_USER getStruct( )
   {
      ...
      struct.setTam07_admin_auth_flg(getgxTv_SdtTAM07_USER_Tam07_admin_auth_flg());
      struct.setTam07_nc_flg(getgxTv_SdtTAM07_USER_Tam07_nc_flg());
      struct.setTam07_note(getgxTv_SdtTAM07_USER_Tam07_note());
      ...
      struct.setTam07_admin_auth_flg_Z(getgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z());
      struct.setTam07_nc_flg_Z(getgxTv_SdtTAM07_USER_Tam07_nc_flg_Z());
      struct.setTam07_note_Z(getgxTv_SdtTAM07_USER_Tam07_note_Z());
      ...
      struct.setTam07_admin_auth_flg_N(getgxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N());
      struct.setTam07_nc_flg_N(getgxTv_SdtTAM07_USER_Tam07_nc_flg_N());
      struct.setTam07_note_N(getgxTv_SdtTAM07_USER_Tam07_note_N());
   ...
   private byte gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_N ;
   private byte gxTv_SdtTAM07_USER_Tam07_nc_flg_N ;
   private byte gxTv_SdtTAM07_USER_Tam07_note_N ;
   ...
   private String gxTv_SdtTAM07_USER_Tam07_admin_auth_flg ;
   private String gxTv_SdtTAM07_USER_Tam07_nc_flg ;
   private String gxTv_SdtTAM07_USER_Tam07_note ;
   ...
   private String gxTv_SdtTAM07_USER_Tam07_admin_auth_flg_Z ;
   private String gxTv_SdtTAM07_USER_Tam07_nc_flg_Z ;
   private String gxTv_SdtTAM07_USER_Tam07_note_Z ;
