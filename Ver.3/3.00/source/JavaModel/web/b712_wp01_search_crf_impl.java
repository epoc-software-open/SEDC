...
public final  class b712_wp01_search_crf_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeValue( "CRF検索条件") ;
   ...
   public void start1K2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "CRF検索条件", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e241K2( )
   {
      ...
      while ( (pr_default.getStatus(1) != 101) )
      {
         ...
         AV25W_AUTH_NM = A285TAM04_AUTH_NM + "権限" ;
   ...
   public void e251K2( )
   {
      ...
      {
         new a804_pc01_syslog(remoteHandle, context).execute( AV137Pgmname, "INFO", "画面起動") ;
   ...
   public void S212( )
   {
      ...
      while ( (pr_default.getStatus(12) != 101) )
      {
         ...
         if ( GXutil.strcmp(A607TBM21_STATUS, "2") == 0 )
         {
            GXt_char1 = AV53W_MSG ;
            GXv_char2[0] = GXt_char1 ;
            new a805_pc02_msg_get(remoteHandle, context).execute( "AE00038", "試験の状態", "「終了」", "操作", "", "", GXv_char2) ;
            b712_wp01_search_crf_impl.this.GXt_char1 = GXv_char2[0] ;
            AV53W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV53W_MSG", AV53W_MSG);
         ...
         else if ( GXutil.strcmp(A607TBM21_STATUS, "9") == 0 )
         {
            GXt_char1 = AV53W_MSG ;
            GXv_char2[0] = GXt_char1 ;
            new a805_pc02_msg_get(remoteHandle, context).execute( "AE00038", "試験の状態", "「中止」", "操作", "", "", GXv_char2) ;
            b712_wp01_search_crf_impl.this.GXt_char1 = GXv_char2[0] ;
            AV53W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV53W_MSG", AV53W_MSG);
            httpContext.GX_msglist.addItem(AV53W_MSG);
      ...
      if ( AV152GXLvl921 == 0 )
      {
         GXt_char1 = AV53W_MSG ;
         GXv_char2[0] = GXt_char1 ;
         new a805_pc02_msg_get(remoteHandle, context).execute( "AE00038", "選択された試験", "利用不可", "操作", "", "", GXv_char2) ;
         b712_wp01_search_crf_impl.this.GXt_char1 = GXv_char2[0] ;
         AV53W_MSG = GXt_char1 ;
         httpContext.ajax_rsp_assign_attri("", false, "AV53W_MSG", AV53W_MSG);
         httpContext.GX_msglist.addItem(AV53W_MSG);
      ...
      if ( AV46W_INPCHK_FLG1 )
      {
         ...
         if ( AV38W_CNT == 0 )
         {
            GXt_char1 = AV53W_MSG ;
            GXv_char2[0] = GXt_char1 ;
            new a805_pc02_msg_get(remoteHandle, context).execute( "AE00007", "患者", "", "", "", "", GXv_char2) ;
            b712_wp01_search_crf_impl.this.GXt_char1 = GXv_char2[0] ;
            AV53W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV53W_MSG", AV53W_MSG);
            httpContext.GX_msglist.addItem(AV53W_MSG);
      ...
      if ( AV47W_INPCHK_FLG2 )
      {
         ...
         if ( AV38W_CNT > 1 )
         {
            GXt_char1 = AV53W_MSG ;
            GXv_char2[0] = GXt_char1 ;
            new a805_pc02_msg_get(remoteHandle, context).execute( "AE00082", "患者", "1人", "", "", "", GXv_char2) ;
            b712_wp01_search_crf_impl.this.GXt_char1 = GXv_char2[0] ;
            AV53W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV53W_MSG", AV53W_MSG);
            httpContext.GX_msglist.addItem(AV53W_MSG);
      ...
      if ( AV48W_INPCHK_FLG3 )
      {
         ...
         if ( AV38W_CNT == 0 )
         {
            GXt_char1 = AV53W_MSG ;
            GXv_char2[0] = GXt_char1 ;
            new a805_pc02_msg_get(remoteHandle, context).execute( "AE00007", "施設", "", "", "", "", GXv_char2) ;
            b712_wp01_search_crf_impl.this.GXt_char1 = GXv_char2[0] ;
            AV53W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV53W_MSG", AV53W_MSG);
            httpContext.GX_msglist.addItem(AV53W_MSG);
            ...
            while ( AV40W_ERR_CD == 0 )
            {
               ...
               if ( AV40W_ERR_CD != 9 )
               {
                  if ( GxRegex.IsMatch(AV64W_SUBJECT_ID_GET,"[^0-9]") )
                  {
                     GXt_char1 = AV53W_MSG ;
                     GXv_char2[0] = GXt_char1 ;
                     new a805_pc02_msg_get(remoteHandle, context).execute( "AE00019", "患者ID", "", "", "", "", GXv_char2) ;
                     b712_wp01_search_crf_impl.this.GXt_char1 = GXv_char2[0] ;
                     AV53W_MSG = GXt_char1 ;
                     httpContext.ajax_rsp_assign_attri("", false, "AV53W_MSG", AV53W_MSG);
                     httpContext.GX_msglist.addItem(AV53W_MSG);
      ...
      if ( AV50W_INPCHK_FLG5 )
      {
         ...
         if ( AV38W_CNT == 0 )
         {
            ...
            if ( ! AV116W_CHK_CRF_EXIT )
            {
               GXt_char1 = AV53W_MSG ;
               GXv_char2[0] = GXt_char1 ;
               new a805_pc02_msg_get(remoteHandle, context).execute( "AE00007", "CRF（VISIT番号）を選択するか、患者使用CRFで患者個別にCRF", "", "", "", "", GXv_char2) ;
               b712_wp01_search_crf_impl.this.GXt_char1 = GXv_char2[0] ;
               AV53W_MSG = GXt_char1 ;
               httpContext.ajax_rsp_assign_attri("", false, "AV53W_MSG", AV53W_MSG);
               httpContext.GX_msglist.addItem(AV53W_MSG);
      ...
      if ( AV51W_INPCHK_FLG6 )
      {
         ...
         if ( AV38W_CNT > 1 )
         {
            GXt_char1 = AV53W_MSG ;
            GXv_char2[0] = GXt_char1 ;
            new a805_pc02_msg_get(remoteHandle, context).execute( "AE00082", "簡易検索", "1件", "", "", "", GXv_char2) ;
            b712_wp01_search_crf_impl.this.GXt_char1 = GXv_char2[0] ;
            AV53W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV53W_MSG", AV53W_MSG);
            httpContext.GX_msglist.addItem(AV53W_MSG);
   ...
   public void wb_table11_150_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock33_Internalname, "簡易検索", "", "", lblTextblock33_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "color:#FFFFFF;", "TextBlockGridHeader_s", 0, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table10_128_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td class=\"FormTitle\" >") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock36_Internalname, "患者ID選択", "", "", lblTextblock36_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "color:#FFFFFF;", "TextBlockGridHeader_s", 0, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
   ...
   public void wb_table13_137_1K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock4_Internalname, "※カンマ区切りで複数指定可能", "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_ss", 0, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table13_137_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblBtn_filter_Internalname, "実行", "", "", lblBtn_filter_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_SUBJECT_ID_SEL\\'."+"'", "", "TextBlockBtn040s", 5, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table18_84_1K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock34_Internalname, "使用CRF", "", "", lblTextblock34_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table18_84_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock35_Internalname, "患者：", "", "", lblTextblock35_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader_s", 0, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         /* Single line edit */
   ...
   public void wb_table16_69_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock32_Internalname, "CRF （VISIT番号）", "", "", lblTextblock32_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader_s", 0, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table15_62_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock31_Internalname, "患者No", "", "", lblTextblock31_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader_s", 0, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table14_55_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock30_Internalname, "施設", "", "", lblTextblock30_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader_s", 0, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table7_42_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblBtn_kensaku_Internalname, "検索", "", "", lblBtn_kensaku_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_SRCH\\'."+"'", "background:transparent;", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table19_15_1K2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td style=\"vertical-align:top\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblBtn_memo_Internalname, "メモ情報", "", "", lblBtn_memo_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_MEMO\\'."+"'", "background:transparent;", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table19_15_1K2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblBtn_new_subject_Internalname, "患者新規", "", "", lblBtn_new_subject_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_NEW_SUBJECT\\'."+"'", "background:transparent;", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblBtn_delete_subject_Internalname, "患者削除", "", "", lblBtn_delete_subject_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_DELETE_SUBJECT\\'."+"'", "background:transparent;", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblBtn_chg_subject_site_Internalname, "患者施設変更", "", "", lblBtn_chg_subject_site_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_CHG_SUBJECT_SITE\\'."+"'", "background:transparent;", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblBtn_crf_filter_Internalname, "CRFフィルタ編集", "", "", lblBtn_crf_filter_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_CRF_FILTER\\'."+"'", "", "TextBlockBtn120", 5, "", 1, 1, (short)(0), "HLP_B712_WP01_SEARCH_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
