...
public final  class b402_wp11_crf_designer_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513242961");
   ...
   public void strup1A0( )
   {
      ...
      AV23Pgmname = "B402_WP11_CRF_DESIGNER" ;
      Gx_err = (short)(0) ;
   ...
   public void S142( )
   {
      ...
      AV15W_PATH_NAME = "/" + AV15W_PATH_NAME + "/static/crfdesigner5/Designer5.html" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15W_PATH_NAME", AV15W_PATH_NAME);
      AV19W_ENCRIPT_BEFORE = "study_id=" + GXutil.trim( GXutil.str( AV10P_STUDY_ID, 10, 0)) + "&crf_id=" + GXutil.trim( GXutil.str( AV9P_CRF_ID, 10, 0)) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV19W_ENCRIPT_BEFORE", AV19W_ENCRIPT_BEFORE);
      /* User Code */
       AV20W_ENCRIPT_PARM = (new sun.misc.BASE64Encoder()).encodeBuffer(AV19W_ENCRIPT_BEFORE.getBytes());
      AV15W_PATH_NAME = AV15W_PATH_NAME + "?" + AV20W_ENCRIPT_PARM ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15W_PATH_NAME", AV15W_PATH_NAME);
      httpContext.wjLoc = formatLink(AV15W_PATH_NAME)  ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202071513242973");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("b402_wp11_crf_designer.js", "?202071513242973");
      }
   ...
   private String AV19W_ENCRIPT_BEFORE ;
   private String AV20W_ENCRIPT_PARM ;
