...
public final  class a105_wp01_error_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeValue( "共通エラー画面") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513222640");
      ...
      GXEncryptionTmp = "a105_wp01_error"+GXutil.URLEncode(GXutil.rtrim(AV8P_ERRCD)) ;
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" class=\"Form\" action=\""+formatLink("a105_wp01_error") + "?" + com.genexus.util.Encryption.uriencrypt64( GXEncryptionTmp+com.genexus.util.Encryption.checksum( GXEncryptionTmp, 6), GXKey)+"\">") ;
   ...
   public void pa072( )
   {
      if ( nDonePA == 0 )
      {
         ...
         if ( ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( ( GXutil.strcmp(GXutil.right( GXDecQS, 6), com.genexus.util.Encryption.checksum( GXutil.left( GXDecQS, GXutil.len( GXDecQS)-6), 6)) == 0 ) && ( GXutil.strcmp(GXutil.substring( GXDecQS, 1, GXutil.len( "a105_wp01_error")), "a105_wp01_error") == 0 ) )
            {
               httpContext.setQueryString( GXutil.right( GXutil.left( GXDecQS, GXutil.len( GXDecQS)-6), GXutil.len( GXutil.left( GXDecQS, GXutil.len( GXDecQS)-6))-GXutil.len( "a105_wp01_error"))) ;
            }
            else
            {
               GxWebError = (byte)(1) ;
   ...
   public void e13072( )
   {
      ...
      if ( GXutil.strcmp(AV8P_ERRCD, "1") == 0 )
      {
         ...
         a105_wp01_error_impl.this.GXt_char1 = GXv_char2[0] ;
   ...
   public void wb_table2_5_072e( boolean wbgen )
   {
      if ( wbgen )
      {
   ...
   public void wb_table2_5_072( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table3_9_072( true) ;
      }
      else
      {
         wb_table3_9_072( false) ;
      }
      return  ;
   }

   public void wb_table3_9_072e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table3_9_072( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table4_17_072( true) ;
      }
      else
      {
         wb_table4_17_072( false) ;
      }
      return  ;
   }

   public void wb_table4_17_072e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_9_072e( true) ;
      }
      else
      {
         wb_table3_9_072e( false) ;
      }
   }

   public void wb_table4_17_072( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavD_none_Internalname, GXutil.rtrim( AV7D_NONE), GXutil.rtrim( localUtil.format( AV7D_NONE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(20);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_none_Jsonclick, 0, "AttributeNone", "", "", "", 1, 1, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A105_WP01_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td align=\"center\" >") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTbl_errmsg_Internalname, lblTbl_errmsg_Caption, "", "", lblTbl_errmsg_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockErrMsg", 0, "", 1, 1, (short)(1), "HLP_A105_WP01_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td align=\"center\"  style=\"height:50px\">") ;
         wb_table5_26_072( true) ;
      }
      else
      {
         wb_table5_26_072( false) ;
      }
      return  ;
   }

   public void wb_table5_26_072e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_17_072e( true) ;
      }
      else
      {
         wb_table4_17_072e( false) ;
      }
   }

   public void wb_table5_26_072( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_end_Internalname, "ログイン（F12）", "", "", lblTxt_btn_end_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_END\\'."+"'", "", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_A105_WP01_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_26_072e( true) ;
      }
      else
      {
         wb_table5_26_072e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202071513222656");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a105_wp01_error.js", "?202071513222656");
