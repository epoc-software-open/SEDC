/*
       ...
       Generated on: July 15, 2020 13:20:41.98
...
public final  class b402_pc18_sel_list_mst_reg extends GXProcedure
{
   ...
   public void S151( )
   {
      ...
      while ( AV44GXV1 <= AV9BC_SEL_LIST_C.size() )
      {
         ...
         {
            A24TBM25_LIST_CD = P004G4_A24TBM25_LIST_CD[0] ;
            A23TBM25_STUDY_ID = P004G4_A23TBM25_STUDY_ID[0] ;
            AV45GXLvl161 = (byte)(1) ;
      ...
      while ( AV46GXV2 <= AV11BC_SEL_LIST_ITEM_C.size() )
      {
         ...
         {
            A25TBM26_STUDY_ID = P004G5_A25TBM26_STUDY_ID[0] ;
            A26TBM26_LIST_CD = P004G5_A26TBM26_LIST_CD[0] ;
            A27TBM26_LIST_ITEM_NO = P004G5_A27TBM26_LIST_ITEM_NO[0] ;
            AV47GXLvl179 = (byte)(1) ;
            AV10BC_SEL_LIST_ITEM.setgxTv_SdtTBM26_SEL_LIST_ITEM_Tbm26_list_item_no( (short)(A27TBM26_LIST_ITEM_NO+1) );
            /* Exit For each command. Update data (if necessary), close cursors & exit. */
            if (true) break;
   ...
   public void initialize( )
   {
      ...
      AV9BC_SEL_LIST_C = new GxObjectCollection(SdtTBM25_SEL_LIST.class, "TBM25_SEL_LIST", "tablet-EDC_GXXEV3U3", remoteHandle);
      AV11BC_SEL_LIST_ITEM_C = new GxObjectCollection(SdtTBM26_SEL_LIST_ITEM.class, "TBM26_SEL_LIST_ITEM", "tablet-EDC_GXXEV3U3", remoteHandle);
      Gx_ope = "" ;
      Gx_etb = "" ;
      ...
      scmdbuf = "" ;
      P004G4_A24TBM25_LIST_CD = new String[] {""} ;
      P004G4_A23TBM25_STUDY_ID = new long[1] ;
      A24TBM25_LIST_CD = "" ;
      AV10BC_SEL_LIST_ITEM = new SdtTBM26_SEL_LIST_ITEM(remoteHandle);
      P004G5_A25TBM26_STUDY_ID = new long[1] ;
      P004G5_A26TBM26_LIST_CD = new String[] {""} ;
      P004G5_A27TBM26_LIST_ITEM_NO = new short[1] ;
      A26TBM26_LIST_CD = "" ;
      GXt_char1 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_pc18_sel_list_mst_reg__default(),
         new Object[] {
            ...
            , new Object[] {
            P004G4_A24TBM25_LIST_CD, P004G4_A23TBM25_STUDY_ID
            }
            , new Object[] {
            P004G5_A25TBM26_STUDY_ID, P004G5_A26TBM26_LIST_CD, P004G5_A27TBM26_LIST_ITEM_NO
            }
         }
      );
   ...
   private String[] P004G4_A24TBM25_LIST_CD ;
   private long[] P004G4_A23TBM25_STUDY_ID ;
   private long[] P004G5_A25TBM26_STUDY_ID ;
   private String[] P004G5_A26TBM26_LIST_CD ;
   private short[] P004G5_A27TBM26_LIST_ITEM_NO ;
...
final  class b402_pc18_sel_list_mst_reg__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new UpdateCursor("P004G2", "DELETE FROM `TBM26_SEL_LIST_ITEM`  WHERE `TBM26_STUDY_ID` = ?", GX_NOMASK + GX_MASKLOOPLOCK)
         ,new UpdateCursor("P004G3", "DELETE FROM `TBM25_SEL_LIST`  WHERE `TBM25_STUDY_ID` = ?", GX_NOMASK + GX_MASKLOOPLOCK)
         ,new ForEachCursor("P004G4", "SELECT `TBM25_LIST_CD`, `TBM25_STUDY_ID` FROM `TBM25_SEL_LIST` WHERE `TBM25_STUDY_ID` = ? and `TBM25_LIST_CD` = ? ORDER BY `TBM25_STUDY_ID`, `TBM25_LIST_CD`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("P004G5", "SELECT `TBM26_STUDY_ID`, `TBM26_LIST_CD`, `TBM26_LIST_ITEM_NO` FROM `TBM26_SEL_LIST_ITEM` WHERE (`TBM26_STUDY_ID` = ?) AND (`TBM26_LIST_CD` = ?) ORDER BY `TBM26_LIST_ITEM_NO` DESC  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
