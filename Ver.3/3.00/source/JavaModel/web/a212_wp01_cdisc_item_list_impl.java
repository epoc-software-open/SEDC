...
public final  class a212_wp01_cdisc_item_list_impl extends GXWebPanel
{
   ...
   public void strup1W0( )
   {
      ...
      AV52Pgmdesc = "ドメイン変数マスタメンテナンス（一覧）" ;
      Gx_err = (short)(0) ;
   ...
   public void e451W2( )
   {
      ...
      {
         new a804_pc01_syslog(remoteHandle, context).execute( AV53Pgmname, "INFO", "画面起動") ;
   ...
   public void wb_table13_170_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort01_desc_Internalname, "▼", "", "", lblTxt_sort01_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT01_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort01_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Text block */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort02_desc_Internalname, "▼", "", "", lblTxt_sort02_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT02_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort02_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Text block */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort03_desc_Internalname, "▼", "", "", lblTxt_sort03_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT03_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort03_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Text block */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort04_desc_Internalname, "▼", "", "", lblTxt_sort04_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT04_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort04_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Text block */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort05_desc_Internalname, "▼", "", "", lblTxt_sort05_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT05_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort05_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Text block */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_sort06_desc_Internalname, "▼", "", "", lblTxt_sort06_desc_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'SORT06_DESC\\'."+"'", "font-family:'ＭＳ Ｐゴシック'; font-size:10.0pt; font-weight:normal; font-style:normal;", lblTxt_sort06_desc_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Text block */
   ...
   public void sendrow_2012( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_201_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         /* Text block */
         Grid1Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {lblBtn_sel_Internalname,"選択","","",lblBtn_sel_Jsonclick,"'"+""+"'"+",false,"+"'"+"E\\'BTN_SEL\\'."+sGXsfl_201_idx+"'","","TextBlockBtn040s",new Integer(5),"",new Integer(1),new Integer(1),new Integer(0)});
         if ( Grid1Container.GetWrapped() == 1 )
         {
