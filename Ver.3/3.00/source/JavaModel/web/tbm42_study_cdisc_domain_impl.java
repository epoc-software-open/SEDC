/*
       ...
       Generated on: July 15, 2020 13:22:9.73
...
public final  class tbm42_study_cdisc_domain_impl extends GXWebPanel
{
   ...
   public void wb_table4_34_1I53( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBM42_DOM_CD_Internalname, GXutil.rtrim( A204TBM42_DOM_CD), GXutil.rtrim( localUtil.format( A204TBM42_DOM_CD, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBM42_DOM_CD_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBM42_DOM_CD_Enabled, 0, "text", "", 16, "chr", 1, "row", 16, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_DOM_CD", "left", "HLP_TBM42_STUDY_CDISC_DOMAIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513221095");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20207151322111");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tbm42_study_cdisc_domain.js", "?20207151322111");
                              ...
                              Object[] parms ) throws SQLException
   {
      switch ( cursor )
      {
            ...
            case 4 :
               ...
               stmt.setVarchar(3, (String)parms[2], 16, false);
               return;
            case 5 :
               stmt.setLong(1, ((Number) parms[0]).longValue());
               stmt.setLong(2, ((Number) parms[1]).longValue());
            ...
            case 7 :
               ...
               stmt.setVarchar(15, (String)parms[27], 16, false);
               return;
            case 8 :
               stmt.setLong(1, ((Number) parms[0]).longValue());
               stmt.setVarchar(2, (String)parms[1], 16, false);
