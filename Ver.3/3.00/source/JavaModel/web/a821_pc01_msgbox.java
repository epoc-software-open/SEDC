/*
       ...
       Generated on: July 15, 2020 13:16:14.79
...
public final  class a821_pc01_msgbox extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      if ( GXutil.strcmp(AV8P_BOXTYPE, "OK") == 0 )
      {
         ...
         {
            AV10W_JS = AV10W_JS + " gx.evt.execEvt('',false,'E\\'" + GXutil.trim( AV13P_OK_EVENT) + "\\'.',this);" ;
         }
      }
      else if ( GXutil.strcmp(AV8P_BOXTYPE, "OK_CANCEL") == 0 )
      {
         ...
         if ( ! (GXutil.strcmp("", AV12P_NG_EVENT)==0) )
         {
            ...
            AV10W_JS = AV10W_JS + " gx.evt.execEvt('',false,'E\\'" + GXutil.trim( AV12P_NG_EVENT) + "\\'.',this);" ;
            AV10W_JS = AV10W_JS + " }" ;
         }
      }
      cleanup();
