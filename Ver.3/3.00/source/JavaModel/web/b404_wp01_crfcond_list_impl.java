/*
       ...
       Generated on: July 15, 2020 13:23:45.1
...
public final  class b404_wp01_crfcond_list_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513234515");
   ...
   public void wb_table10_150_112e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A415TBM33_PRIOR_NO, (byte)(3), (byte)(0), ".", "")));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202071513234865");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b404_wp01_crfcond_list.js", "?202071513234865");
   ...
   public void sendrow_1622( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_162_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTBM33_PRIOR_NO_Internalname,GXutil.ltrim( localUtil.ntoc( A415TBM33_PRIOR_NO, (byte)(3), (byte)(0), ".", "")),localUtil.format( DecimalUtil.doubleToDec(A415TBM33_PRIOR_NO), "ZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTBM33_PRIOR_NO_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(0),new Integer(0),"text","",new Integer(3),"chr",new Integer(1),"row",new Integer(3),new Integer(0),new Integer(0),new Integer(162),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
   ...
   public void initialize( )
   {
      ...
      H00112_A415TBM33_PRIOR_NO = new short[1] ;
   ...
   private short[] H00112_A415TBM33_PRIOR_NO ;
