/*
               File: A812_PC04_CSV_OUTPUT_ESC
        Description: CSVファイル出力処理（エスケープ実施）
             Author: GeneXus Java Generator version 10_3_3-92797
       Generated on: July 15, 2020 13:18:17.6
...
public final  class a812_pc04_csv_output_esc extends GXProcedure
{
   public a812_pc04_csv_output_esc( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( a812_pc04_csv_output_esc.class ), "" );
   }
   ...
   public String executeUdp( SdtA_LOGIN_SDT aP0 ,
                             ...
                             String[] aP4 )
   {
      a812_pc04_csv_output_esc.this.AV9P_A_LOGIN_SDT = aP0;
      a812_pc04_csv_output_esc.this.AV12P_SYS_ID = aP1;
      a812_pc04_csv_output_esc.this.AV10P_A812_SD01_CSV_OUTPUT = aP2;
      a812_pc04_csv_output_esc.this.AV11P_FILE_NAME = aP3;
      a812_pc04_csv_output_esc.this.aP4 = aP4;
      a812_pc04_csv_output_esc.this.aP5 = aP5;
      a812_pc04_csv_output_esc.this.aP5 = new String[] {""};
      initialize();
      privateExecute();
      return aP5[0];
   }
   ...
   private void privateExecute( )
   {
      ...
      if ( AV20W_HANDLE != 0 )
      {
         ...
         a812_pc04_csv_output_esc.this.GXt_char1 = GXv_char2[0] ;
      ...
      while ( AV26GXV1 <= AV10P_A812_SD01_CSV_OUTPUT.size() )
      {
         ...
         while ( AV27GXV2 <= AV13W_A812_SD01_CSV_OUTPUT_ITEM.getgxTv_SdtA812_SD01_CSV_OUTPUT_A812_SD01_CSV_OUTPUTItem_Csv_data().size() )
         {
            ...
            GXt_char1 = AV15W_CSV_DATA_ITEM ;
            GXv_char2[0] = GXt_char1 ;
            new b804_pc01_esc_airres(remoteHandle, context).execute( AV15W_CSV_DATA_ITEM, GXv_char2) ;
            a812_pc04_csv_output_esc.this.GXt_char1 = GXv_char2[0] ;
            AV15W_CSV_DATA_ITEM = GXt_char1 ;
            if ( ! AV21W_INIT_FLG )
            {
               AV21W_INIT_FLG = true ;
            }
   ...
   {
      this.aP4[0] = a812_pc04_csv_output_esc.this.AV18W_FILE_PATH;
      this.aP5[0] = a812_pc04_csv_output_esc.this.AV23W_PARM_MSG;
      CloseOpenCursors();
      exitApplication();
   }
