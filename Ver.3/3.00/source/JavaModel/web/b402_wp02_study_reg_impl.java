/*
       ...
       Generated on: July 15, 2020 13:23:10.11
...
public final  class b402_wp02_study_reg_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513231021");
   ...
   public void strup0W0( )
   {
      ...
      AV46Pgmname = "B402_WP02_STUDY_REG" ;
      AV45Pgmdesc = "試験登録（入力）" ;
      Gx_err = (short)(0) ;
   ...
   public void e170W2( )
   {
      ...
      {
         new a804_pc01_syslog(remoteHandle, context).execute( AV46Pgmname, "INFO", "画面起動") ;
      ...
      if ( new a402_pc02_btn_kengn_check(remoteHandle, context).executeUdp( "REG", AV11H_KNGN_FLG, "") )
      {
         if ( GXutil.strcmp(AV12H_MODE, "0") == 0 )
         {
            ...
            if ( ! AV25W_ERRFLG )
            {
               ...
               S182 ();
               if (returnInSub) return;
               if ( AV31W_READY_CRF_FLG )
               {
                  GXt_char1 = AV26W_MSG ;
                  GXv_char2[0] = GXt_char1 ;
                  new a805_pc01_msg_get(remoteHandle, context).execute( "AG00032", "", "", "", "", "", GXv_char2) ;
   ...
   public void e180W2( )
   {
      ...
      if ( new a402_pc02_btn_kengn_check(remoteHandle, context).executeUdp( "REG", AV11H_KNGN_FLG, "") )
      {
         AV5BC_STUDY.setgxTv_SdtTBM21_STUDY_Tbm21_crt_prog_nm( AV46Pgmname );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_STUDY", AV5BC_STUDY);
         AV5BC_STUDY.setgxTv_SdtTBM21_STUDY_Tbm21_upd_prog_nm( AV46Pgmname );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_STUDY", AV5BC_STUDY);
         AV5BC_STUDY.Save();
   ...
   public void e130W2( )
   {
      ...
      {
         AV47GXLvl255 = (byte)(0) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV47GXLvl255", GXutil.str( AV47GXLvl255, 1, 0));
         /* Using cursor H000W2 */
   ...
   public void S172( )
   {
      ...
      if ( AV17W_A_RESULT_MSG_SDT.size() > 0 )
      {
         ...
         while ( AV48GXV12 <= AV17W_A_RESULT_MSG_SDT.size() )
         {
            AV18W_A_RESULT_MSG_SDT_ITEM = (SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem)((SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem)AV17W_A_RESULT_MSG_SDT.elementAt(-1+AV48GXV12));
   ...
   public void S182( )
   {
      /* 'SUB_READY_CRF_CHK' Routine */
      AV31W_READY_CRF_FLG = false ;
      httpContext.ajax_rsp_assign_attri("", false, "AV31W_READY_CRF_FLG", AV31W_READY_CRF_FLG);
      if ( GXutil.strcmp(AV5BC_STUDY.getgxTv_SdtTBM21_STUDY_Tbm21_status(), "1") == 0 )
      {
         /* Using cursor H000W3 */
         pr_default.execute(1, new Object[] {new Long(AV5BC_STUDY.getgxTv_SdtTBM21_STUDY_Tbm21_study_id())});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A397TBM31_DEL_FLG = H000W3_A397TBM31_DEL_FLG[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A397TBM31_DEL_FLG", A397TBM31_DEL_FLG);
            n397TBM31_DEL_FLG = H000W3_n397TBM31_DEL_FLG[0] ;
            A643TBM31_STATUS = H000W3_A643TBM31_STATUS[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A643TBM31_STATUS", A643TBM31_STATUS);
            n643TBM31_STATUS = H000W3_n643TBM31_STATUS[0] ;
            A68TBM31_STUDY_ID = H000W3_A68TBM31_STUDY_ID[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A68TBM31_STUDY_ID", GXutil.ltrim( GXutil.str( A68TBM31_STUDY_ID, 10, 0)));
            AV31W_READY_CRF_FLG = true ;
            httpContext.ajax_rsp_assign_attri("", false, "AV31W_READY_CRF_FLG", AV31W_READY_CRF_FLG);
            /* Exit For each command. Update data (if necessary), close cursors & exit. */
            if (true) break;
   ...
   public void S202( )
   {
      /* 'SUB_ERRDISP' Routine */
      AV50GXV13 = 1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV50GXV13", GXutil.ltrim( GXutil.str( AV50GXV13, 8, 0)));
      while ( AV50GXV13 <= AV14W_A_CHK_RESULT_SDT.size() )
      {
         AV15W_A_CHK_RESULT_SDT_ITEM = (SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem)((SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem)AV14W_A_CHK_RESULT_SDT.elementAt(-1+AV50GXV13));
   ...
   public void S142( )
   {
      ...
      if ( ! (0==AV13P_STUDY_ID) )
      {
         ...
         {
            AV51GXLvl541 = (byte)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV51GXLvl541", GXutil.str( AV51GXLvl541, 1, 0));
            /* Using cursor H000W4 */
            pr_default.execute(2, new Object[] {AV5BC_STUDY.getgxTv_SdtTBM21_STUDY_Tbm21_crt_user_id()});
            if ( Gx_err != 0 )
            {
               AV51GXLvl541 = (byte)(1) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV51GXLvl541", GXutil.str( AV51GXLvl541, 1, 0));
            ...
            {
               AV52GXLvl556 = (byte)(0) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV52GXLvl556", GXutil.str( AV52GXLvl556, 1, 0));
               /* Using cursor H000W5 */
               pr_default.execute(3, new Object[] {AV5BC_STUDY.getgxTv_SdtTBM21_STUDY_Tbm21_upd_user_id()});
               if ( Gx_err != 0 )
               {
                  AV52GXLvl556 = (byte)(1) ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV52GXLvl556", GXutil.str( AV52GXLvl556, 1, 0));
               ...
               {
                  A55TAM07_USER_ID = H000W5_A55TAM07_USER_ID[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A55TAM07_USER_ID", A55TAM07_USER_ID);
                  A205TAM07_USER_NM = H000W5_A205TAM07_USER_NM[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A205TAM07_USER_NM", A205TAM07_USER_NM);
                  n205TAM07_USER_NM = H000W5_n205TAM07_USER_NM[0] ;
                  AV52GXLvl556 = (byte)(1) ;
                  httpContext.ajax_rsp_assign_attri("", false, "AV52GXLvl556", GXutil.str( AV52GXLvl556, 1, 0));
            ...
            httpContext.ajax_rsp_assign_attri("", false, "AV21W_CNT", GXutil.ltrim( GXutil.str( AV21W_CNT, 10, 0)));
            /* Using cursor H000W7 */
            pr_default.execute(5, new Object[] {new Long(AV13P_STUDY_ID)});
            while ( (pr_default.getStatus(5) != 101) )
            {
               A333TAM07_SITE_ID = H000W7_A333TAM07_SITE_ID[0] ;
               httpContext.ajax_rsp_assign_attri("", false, "A333TAM07_SITE_ID", A333TAM07_SITE_ID);
               n333TAM07_SITE_ID = H000W7_n333TAM07_SITE_ID[0] ;
               A214TAM07_DEL_FLG = H000W7_A214TAM07_DEL_FLG[0] ;
               httpContext.ajax_rsp_assign_attri("", false, "A214TAM07_DEL_FLG", A214TAM07_DEL_FLG);
               n214TAM07_DEL_FLG = H000W7_n214TAM07_DEL_FLG[0] ;
               A385TBM23_DEL_FLG = H000W7_A385TBM23_DEL_FLG[0] ;
               httpContext.ajax_rsp_assign_attri("", false, "A385TBM23_DEL_FLG", A385TBM23_DEL_FLG);
               n385TBM23_DEL_FLG = H000W7_n385TBM23_DEL_FLG[0] ;
               A107TBM23_STUDY_ID = H000W7_A107TBM23_STUDY_ID[0] ;
               httpContext.ajax_rsp_assign_attri("", false, "A107TBM23_STUDY_ID", GXutil.ltrim( GXutil.str( A107TBM23_STUDY_ID, 10, 0)));
               A108TBM23_USER_ID = H000W7_A108TBM23_USER_ID[0] ;
               ...
               n214TAM07_DEL_FLG = H000W7_n214TAM07_DEL_FLG[0] ;
               /* Using cursor H000W8 */
               pr_default.execute(6, new Object[] {new Long(AV13P_STUDY_ID), new Boolean(n333TAM07_SITE_ID), A333TAM07_SITE_ID});
               while ( (pr_default.getStatus(6) != 101) )
               {
                  A18TBM22_SITE_ID = H000W8_A18TBM22_SITE_ID[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A18TBM22_SITE_ID", A18TBM22_SITE_ID);
                  A325TAM08_DEL_FLG = H000W8_A325TAM08_DEL_FLG[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A325TAM08_DEL_FLG", A325TAM08_DEL_FLG);
                  n325TAM08_DEL_FLG = H000W8_n325TAM08_DEL_FLG[0] ;
                  A377TBM22_DEL_FLG = H000W8_A377TBM22_DEL_FLG[0] ;
                  httpContext.ajax_rsp_assign_attri("", false, "A377TBM22_DEL_FLG", A377TBM22_DEL_FLG);
                  n377TBM22_DEL_FLG = H000W8_n377TBM22_DEL_FLG[0] ;
                  A17TBM22_STUDY_ID = H000W8_A17TBM22_STUDY_ID[0] ;
            ...
            httpContext.ajax_rsp_assign_attri("", false, "AV21W_CNT", GXutil.ltrim( GXutil.str( AV21W_CNT, 10, 0)));
            /* Optimized group. */
            /* Using cursor H000W10 */
            pr_default.execute(8, new Object[] {new Long(AV13P_STUDY_ID)});
            cV21W_CNT = H000W10_AV21W_CNT[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "cV21W_CNT", GXutil.ltrim( GXutil.str( cV21W_CNT, 10, 0)));
            pr_default.close(8);
            AV21W_CNT = (long)(AV21W_CNT+cV21W_CNT*1) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV21W_CNT", GXutil.ltrim( GXutil.str( AV21W_CNT, 10, 0)));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202071513231573");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b402_wp02_study_reg.js", "?202071513231573");
   ...
   public void initialize( )
   {
      ...
      H000W3_A69TBM31_CRF_ID = new short[1] ;
      H000W3_A397TBM31_DEL_FLG = new String[] {""} ;
      H000W3_n397TBM31_DEL_FLG = new boolean[] {false} ;
      H000W3_A643TBM31_STATUS = new String[] {""} ;
      H000W3_n643TBM31_STATUS = new boolean[] {false} ;
      H000W3_A68TBM31_STUDY_ID = new long[1] ;
      A397TBM31_DEL_FLG = "" ;
      A643TBM31_STATUS = "" ;
      ...
      A55TAM07_USER_ID = "" ;
      H000W5_A55TAM07_USER_ID = new String[] {""} ;
      H000W5_A205TAM07_USER_NM = new String[] {""} ;
      H000W5_n205TAM07_USER_NM = new boolean[] {false} ;
      GXt_char1 = "" ;
      H000W6_AV21W_CNT = new long[1] ;
      H000W7_A333TAM07_SITE_ID = new String[] {""} ;
      H000W7_n333TAM07_SITE_ID = new boolean[] {false} ;
      H000W7_A214TAM07_DEL_FLG = new String[] {""} ;
      H000W7_n214TAM07_DEL_FLG = new boolean[] {false} ;
      H000W7_A385TBM23_DEL_FLG = new String[] {""} ;
      H000W7_n385TBM23_DEL_FLG = new boolean[] {false} ;
      H000W7_A107TBM23_STUDY_ID = new long[1] ;
      H000W7_A108TBM23_USER_ID = new String[] {""} ;
      A333TAM07_SITE_ID = "" ;
      A214TAM07_DEL_FLG = "" ;
      A385TBM23_DEL_FLG = "" ;
      A108TBM23_USER_ID = "" ;
      H000W8_A18TBM22_SITE_ID = new String[] {""} ;
      H000W8_A325TAM08_DEL_FLG = new String[] {""} ;
      H000W8_n325TAM08_DEL_FLG = new boolean[] {false} ;
      H000W8_A377TBM22_DEL_FLG = new String[] {""} ;
      H000W8_n377TBM22_DEL_FLG = new boolean[] {false} ;
      H000W8_A17TBM22_STUDY_ID = new long[1] ;
      A18TBM22_SITE_ID = "" ;
      A325TAM08_DEL_FLG = "" ;
      A377TBM22_DEL_FLG = "" ;
      H000W9_AV21W_CNT = new long[1] ;
      H000W10_AV21W_CNT = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_wp02_study_reg__default(),
         new Object[] {
            ...
            , new Object[] {
            H000W3_A69TBM31_CRF_ID, H000W3_A397TBM31_DEL_FLG, H000W3_n397TBM31_DEL_FLG, H000W3_A643TBM31_STATUS, H000W3_n643TBM31_STATUS, H000W3_A68TBM31_STUDY_ID
            }
            , new Object[] {
            H000W4_A55TAM07_USER_ID, H000W4_A205TAM07_USER_NM, H000W4_n205TAM07_USER_NM
            }
            , new Object[] {
            H000W5_A55TAM07_USER_ID, H000W5_A205TAM07_USER_NM, H000W5_n205TAM07_USER_NM
            }
            , new Object[] {
            H000W6_AV21W_CNT
            }
            , new Object[] {
            H000W7_A333TAM07_SITE_ID, H000W7_n333TAM07_SITE_ID, H000W7_A214TAM07_DEL_FLG, H000W7_n214TAM07_DEL_FLG, H000W7_A385TBM23_DEL_FLG, H000W7_n385TBM23_DEL_FLG, H000W7_A107TBM23_STUDY_ID, H000W7_A108TBM23_USER_ID
            }
            , new Object[] {
            H000W8_A18TBM22_SITE_ID, H000W8_A325TAM08_DEL_FLG, H000W8_n325TAM08_DEL_FLG, H000W8_A377TBM22_DEL_FLG, H000W8_n377TBM22_DEL_FLG, H000W8_A17TBM22_STUDY_ID
            }
            , new Object[] {
            H000W9_AV21W_CNT
            }
   ...
   private byte AV47GXLvl255 ;
   private byte GXv_int4[] ;
   private byte AV51GXLvl541 ;
   private byte AV52GXLvl556 ;
   ...
   private boolean AV31W_READY_CRF_FLG ;
   ...
   private short[] H000W3_A69TBM31_CRF_ID ;
   private String[] H000W3_A397TBM31_DEL_FLG ;
   private boolean[] H000W3_n397TBM31_DEL_FLG ;
   private String[] H000W3_A643TBM31_STATUS ;
   private boolean[] H000W3_n643TBM31_STATUS ;
   private long[] H000W3_A68TBM31_STUDY_ID ;
   private String[] H000W4_A55TAM07_USER_ID ;
   private String[] H000W4_A205TAM07_USER_NM ;
   private boolean[] H000W4_n205TAM07_USER_NM ;
   private String[] H000W5_A55TAM07_USER_ID ;
   private String[] H000W5_A205TAM07_USER_NM ;
   private boolean[] H000W5_n205TAM07_USER_NM ;
   private long[] H000W6_AV21W_CNT ;
   private String[] H000W7_A333TAM07_SITE_ID ;
   private boolean[] H000W7_n333TAM07_SITE_ID ;
   private String[] H000W7_A214TAM07_DEL_FLG ;
   private boolean[] H000W7_n214TAM07_DEL_FLG ;
   private String[] H000W7_A385TBM23_DEL_FLG ;
   private boolean[] H000W7_n385TBM23_DEL_FLG ;
   private long[] H000W7_A107TBM23_STUDY_ID ;
   private String[] H000W7_A108TBM23_USER_ID ;
   private String[] H000W8_A18TBM22_SITE_ID ;
   private String[] H000W8_A325TAM08_DEL_FLG ;
   private boolean[] H000W8_n325TAM08_DEL_FLG ;
   private String[] H000W8_A377TBM22_DEL_FLG ;
   private boolean[] H000W8_n377TBM22_DEL_FLG ;
   private long[] H000W8_A17TBM22_STUDY_ID ;
   private long[] H000W9_AV21W_CNT ;
   private long[] H000W10_AV21W_CNT ;
...
final  class b402_wp02_study_reg__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H000W3", "SELECT `TBM31_CRF_ID`, `TBM31_DEL_FLG`, `TBM31_STATUS`, `TBM31_STUDY_ID` FROM `TBM31_CRF` WHERE (`TBM31_STUDY_ID` = ?) AND (`TBM31_STATUS` = '0') AND (`TBM31_DEL_FLG` = '0') ORDER BY `TBM31_STUDY_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ...
         ,new ForEachCursor("H000W5", "SELECT `TAM07_USER_ID`, `TAM07_USER_NM` FROM `TAM07_USER` WHERE `TAM07_USER_ID` = ? ORDER BY `TAM07_USER_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H000W6", "SELECT COUNT(*) FROM (`TBM22_STUDY_SITE` T1 INNER JOIN `TAM08_SITE` T2 ON T2.`TAM08_SITE_ID` = T1.`TBM22_SITE_ID`) WHERE (T1.`TBM22_STUDY_ID` = ?) AND (T1.`TBM22_DEL_FLG` = '0') AND (T2.`TAM08_DEL_FLG` = '0') ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
         ,new ForEachCursor("H000W7", "SELECT DISTINCT T2.`TAM07_SITE_ID`, T2.`TAM07_DEL_FLG`, T1.`TBM23_DEL_FLG`, T1.`TBM23_STUDY_ID`, T1.`TBM23_USER_ID` AS TBM23_USER_ID FROM (`TBM23_STUDY_STAFF` T1 INNER JOIN `TAM07_USER` T2 ON T2.`TAM07_USER_ID` = T1.`TBM23_USER_ID`) WHERE (T1.`TBM23_STUDY_ID` = ?) AND (T1.`TBM23_DEL_FLG` = '0') AND (T2.`TAM07_DEL_FLG` = '0') ORDER BY T1.`TBM23_STUDY_ID`, T1.`TBM23_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H000W8", "SELECT T1.`TBM22_SITE_ID` AS TBM22_SITE_ID, T2.`TAM08_DEL_FLG`, T1.`TBM22_DEL_FLG`, T1.`TBM22_STUDY_ID` FROM (`TBM22_STUDY_SITE` T1 INNER JOIN `TAM08_SITE` T2 ON T2.`TAM08_SITE_ID` = T1.`TBM22_SITE_ID`) WHERE (T1.`TBM22_STUDY_ID` = ? and T1.`TBM22_SITE_ID` = ?) AND (T1.`TBM22_DEL_FLG` = '0') AND (T2.`TAM08_DEL_FLG` = '0') ORDER BY T1.`TBM22_STUDY_ID`, T1.`TBM22_SITE_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H000W9", "SELECT COUNT(*) FROM `TBM31_CRF` WHERE (`TBM31_STUDY_ID` = ?) AND (`TBM31_DEL_FLG` = '0') ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
         ,new ForEachCursor("H000W10", "SELECT COUNT(*) FROM `TBM42_STUDY_CDISC_DOMAIN` WHERE (`TBM42_STUDY_ID` = ?) AND (`TBM42_DEL_FLG` = '0') ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
