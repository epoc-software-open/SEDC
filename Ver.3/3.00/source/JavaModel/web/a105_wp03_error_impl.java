/*
       ...
       Generated on: July 15, 2020 13:22:26.62
...
public final  class a105_wp03_error_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeValue( "共通エラー画面（DB停止中）") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513222664");
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" class=\"Form\" action=\""+formatLink("a105_wp03_error") +"\">") ;
   ...
   public void wb_table2_5_082( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table3_9_082( true) ;
      }
      else
      {
         wb_table3_9_082( false) ;
      }
      return  ;
   }

   public void wb_table3_9_082e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table3_9_082( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table4_17_082( true) ;
      }
      else
      {
         wb_table4_17_082( false) ;
      }
      return  ;
   }

   public void wb_table4_17_082e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_9_082e( true) ;
      }
      else
      {
         wb_table3_9_082e( false) ;
      }
   }

   public void wb_table4_17_082( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavD_none_Internalname, GXutil.rtrim( AV7D_NONE), GXutil.rtrim( localUtil.format( AV7D_NONE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(20);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_none_Jsonclick, 0, "AttributeNone", "", "", "", 1, 1, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A105_WP03_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td align=\"center\" >") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTbl_errmsg_Internalname, lblTbl_errmsg_Caption, "", "", lblTbl_errmsg_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockErrMsg", 0, "", 1, 1, (short)(1), "HLP_A105_WP03_ERROR.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_17_082e( true) ;
      }
      else
      {
         wb_table4_17_082e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202071513222675");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a105_wp03_error.js", "?202071513222675");
