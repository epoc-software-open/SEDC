/*
       ...
       Generated on: July 15, 2020 13:24:9.51
...
public final  class b402_wp10_crf_ref_crt_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20207151324954");
   ...
   public void S172( )
   {
      ...
      pr_default.dynParam(1, new Object[]{ new Object[]{
                                           ...
                                           AV16W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn() ,
                                           AV16W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg() ,
                                           AV16W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_User_study_sdt().getgxTv_SdtA_USER_STUDY_SDT_Study_id() ,
                                           A607TBM21_STATUS ,
                                           A369TBM21_DEL_FLG },
                                           new int[] {
                                           TypeConstants.LONG, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.OBJECT_COLLECTION, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN
                                           }
      });
      /* Using cursor H00153 */
   ...
   public void S112( )
   {
      ...
      GXv_SdtA_USER_STUDY_SDT5[0] = AV16W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_User_study_sdt();
      new b799_pc13_get_user_study(remoteHandle, context).execute( AV16W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_user_id(), GXv_SdtA_USER_STUDY_SDT5) ;
      AV16W_A_LOGIN_SDT.setgxTv_SdtA_LOGIN_SDT_User_study_sdt( GXv_SdtA_USER_STUDY_SDT5[0] );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV16W_A_LOGIN_SDT", AV16W_A_LOGIN_SDT);
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV16W_A_LOGIN_SDT", AV16W_A_LOGIN_SDT);
      AV30W_SESSION.setValue("Com_Login_Info", AV16W_A_LOGIN_SDT.toxml(false, true, "A_LOGIN_SDT", "tablet-EDC_GXXEV3U3"));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20207151324993");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b402_wp10_crf_ref_crt.js", "?20207151324993");
   ...
   public void initialize( )
   {
      ...
      AV21W_ERRCD = "" ;
      GXv_SdtA_USER_STUDY_SDT5 = new SdtA_USER_STUDY_SDT [1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_wp10_crf_ref_crt__default(),
         new Object[] {
             new Object[] {
            H00152_A643TBM31_STATUS, H00152_n643TBM31_STATUS, H00152_A68TBM31_STUDY_ID, H00152_A393TBM31_CRF_NM, H00152_n393TBM31_CRF_NM, H00152_A69TBM31_CRF_ID
            }
            , new Object[] {
            H00153_A63TBM21_STUDY_ID, H00153_A607TBM21_STATUS, H00153_n607TBM21_STATUS, H00153_A369TBM21_DEL_FLG, H00153_n369TBM21_DEL_FLG, H00153_A367TBM21_STUDY_NM, H00153_n367TBM21_STUDY_NM
            }
         }
      );
   ...
   private String AV16W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn ;
   private String AV16W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg ;
   ...
   private GxObjectCollection AV16W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_User_study_sdt_getgxTv_SdtA_USER_STUDY_SDT_Study_id ;
   private SdtA_LOGIN_SDT AV16W_A_LOGIN_SDT ;
   private SdtA_LOGIN_SDT GXv_SdtA_LOGIN_SDT4[] ;
   private SdtA_USER_STUDY_SDT GXv_SdtA_USER_STUDY_SDT5[] ;
}
...
final  class b402_wp10_crf_ref_crt__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00153( ModelContext context ,
                                          ...
                                          String AV16W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn ,
                                          String AV16W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg ,
                                          GxObjectCollection AV16W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_User_study_sdt_getgxTv_SdtA_USER_STUDY_SDT_Study_id ,
                                          ...
                                          String A369TBM21_DEL_FLG )
   {
      ...
      scmdbuf = "SELECT `TBM21_STUDY_ID`, `TBM21_STATUS`, `TBM21_DEL_FLG`, `TBM21_STUDY_NM` FROM `TBM21_STUDY`" ;
      scmdbuf = scmdbuf + " WHERE (`TBM21_STATUS` <> '9')" ;
      scmdbuf = scmdbuf + " and (`TBM21_DEL_FLG` = '0')" ;
      if ( ( GXutil.strcmp(AV16W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn, "99") != 0 ) && ( GXutil.strcmp(AV16W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg, "1") != 0 ) )
      {
         sWhereString = sWhereString + " and (" + GXutil.toValueList("mysql", AV16W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_User_study_sdt_getgxTv_SdtA_USER_STUDY_SDT_Study_id, "`TBM21_STUDY_ID` IN (", ")") + ")" ;
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 1 :
                  return conditional_H00153(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).longValue() , (String)dynConstraints[1] , (String)dynConstraints[2] , (GxObjectCollection)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00152", "SELECT `TBM31_STATUS`, `TBM31_STUDY_ID`, `TBM31_CRF_NM`, `TBM31_CRF_ID` FROM `TBM31_CRF` WHERE (`TBM31_STUDY_ID` = ?) AND (`TBM31_STATUS` <> '9') ORDER BY `TBM31_STUDY_ID`, `TBM31_CRF_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H00153", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
      };
   }
