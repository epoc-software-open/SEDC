/*
       ...
       Generated on: March 3, 2021 10:37:26.57
...
public final  class b402_pc07_study_staff_work_init extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      while ( (pr_default.getStatus(0) != 101) )
      {
         ...
         if ( AV22W_STUDY_STAFF.getgxTv_SdtB402_SD02_STUDY_STAFF_Sel_auth().size() == 0 )
         {
            AV21W_SEL_AUTH_ITEM = (SdtB402_SD03_STUDY_STAFF_AUTH)new SdtB402_SD03_STUDY_STAFF_AUTH(remoteHandle, context);
            AV21W_SEL_AUTH_ITEM.setgxTv_SdtB402_SD03_STUDY_STAFF_AUTH_Check( true );
            AV23W_AUTH_CD = A56TAM07_AUTH_CD ;
            AV24W_AUTH_NM = A285TAM04_AUTH_NM ;
            ...
            AV21W_SEL_AUTH_ITEM.setgxTv_SdtB402_SD03_STUDY_STAFF_AUTH_Auth_cd( AV23W_AUTH_CD );
            AV21W_SEL_AUTH_ITEM.setgxTv_SdtB402_SD03_STUDY_STAFF_AUTH_Auth_nm( AV24W_AUTH_NM );
   ...
   public void S111( )
   {
      /* 'SUB_GET_DEFAULT_AUTH_CD' Routine */
      if ( GXutil.strcmp(AV23W_AUTH_CD, "99") == 0 )
      {
         AV23W_AUTH_CD = AV25CT_DM_AUTH_CD ;
         AV24W_AUTH_NM = AV26CT_DM_AUTH_NM ;
      }
      else
      {
      }
   ...
   public void S121( )
   {
      ...
      GXt_char2 = AV25CT_DM_AUTH_CD ;
      GXv_char3[0] = GXt_char2 ;
      new b806_pc01_get_ctrl_val(remoteHandle, context).execute( "008", GXv_char3) ;
      b402_pc07_study_staff_work_init.this.GXt_char2 = GXv_char3[0] ;
      AV25CT_DM_AUTH_CD = GXt_char2 ;
      /* Using cursor P003Y4 */
      pr_default.execute(2, new Object[] {AV25CT_DM_AUTH_CD});
      while ( (pr_default.getStatus(2) != 101) )
      {
         A13TAM04_AUTH_CD = P003Y4_A13TAM04_AUTH_CD[0] ;
         A285TAM04_AUTH_NM = P003Y4_A285TAM04_AUTH_NM[0] ;
         n285TAM04_AUTH_NM = P003Y4_n285TAM04_AUTH_NM[0] ;
         AV26CT_DM_AUTH_NM = A285TAM04_AUTH_NM ;
         /* Exit For each command. Update data (if necessary), close cursors & exit. */
         if (true) break;
   ...
   public void initialize( )
   {
      ...
      P003Y4_A13TAM04_AUTH_CD = new String[] {""} ;
      P003Y4_A285TAM04_AUTH_NM = new String[] {""} ;
      P003Y4_n285TAM04_AUTH_NM = new boolean[] {false} ;
      A13TAM04_AUTH_CD = "" ;
      AV32Pgmname = "" ;
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_pc07_study_staff_work_init__default(),
         new Object[] {
             new Object[] {
            P003Y2_A55TAM07_USER_ID, P003Y2_A56TAM07_AUTH_CD, P003Y2_n56TAM07_AUTH_CD, P003Y2_A214TAM07_DEL_FLG, P003Y2_n214TAM07_DEL_FLG, P003Y2_A333TAM07_SITE_ID, P003Y2_n333TAM07_SITE_ID, P003Y2_A205TAM07_USER_NM, P003Y2_n205TAM07_USER_NM, P003Y2_A285TAM04_AUTH_NM,
            ...
            , new Object[] {
            P003Y4_A13TAM04_AUTH_CD, P003Y4_A285TAM04_AUTH_NM, P003Y4_n285TAM04_AUTH_NM
            }
         }
      );
      pr_default.setErrorHandler(this);
      AV32Pgmname = "B402_PC07_STUDY_STAFF_WORK_INIT" ;
      /* GeneXus formulas. */
      AV32Pgmname = "B402_PC07_STUDY_STAFF_WORK_INIT" ;
      Gx_err = (short)(0) ;
   }
   ...
   private String AV24W_AUTH_NM ;
   private String AV25CT_DM_AUTH_CD ;
   private String AV26CT_DM_AUTH_NM ;
   ...
   private String[] P003Y4_A13TAM04_AUTH_CD ;
   private String[] P003Y4_A285TAM04_AUTH_NM ;
   private boolean[] P003Y4_n285TAM04_AUTH_NM ;
...
final  class b402_pc07_study_staff_work_init__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P003Y2", "SELECT T1.`TAM07_USER_ID`, T1.`TAM07_AUTH_CD` AS TAM07_AUTH_CD, T1.`TAM07_DEL_FLG`, T1.`TAM07_SITE_ID`, T1.`TAM07_USER_NM`, T2.`TAM04_AUTH_NM` FROM (`TAM07_USER` T1 LEFT JOIN `TAM04_KNGN` T2 ON T2.`TAM04_AUTH_CD` = T1.`TAM07_AUTH_CD`) WHERE (T1.`TAM07_AUTH_CD` <> '00') AND (T1.`TAM07_SITE_ID` = ?) AND (T1.`TAM07_DEL_FLG` = '0') ORDER BY T1.`TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ...
         ,new ForEachCursor("P003Y4", "SELECT `TAM04_AUTH_CD`, `TAM04_AUTH_NM` FROM `TAM04_KNGN` WHERE `TAM04_AUTH_CD` = ? ORDER BY `TAM04_AUTH_CD`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
