/*
       ...
       Generated on: July 15, 2020 13:21:9.93
...
public final  class b714_pc04_dm_arrival_crf extends GXProcedure
{
                             ...
                             byte[] aP5 )
   {
      ...
      b714_pc04_dm_arrival_crf.this.AV24P_IN_SIGNATURE_CHK = aP3;
      b714_pc04_dm_arrival_crf.this.AV25P_IN_SIGNATURE_USER_ID = aP4;
      b714_pc04_dm_arrival_crf.this.aP5 = aP5;
      b714_pc04_dm_arrival_crf.this.aP6 = aP6;
      b714_pc04_dm_arrival_crf.this.aP6 = new String[] {""};
      initialize();
      privateExecute();
      return aP6[0];
   }
   ...
   private void privateExecute( )
   {
      ...
      {
         AV28GXV1 = 1 ;
         while ( AV28GXV1 <= AV15P_B714_SD1_CRF_INFO.size() )
         {
            AV18W_B714_SD1_CRF_INFO_Item = (SdtB714_SD1_CRF_INFO_B714_SD1_CRF_INFOItem)((SdtB714_SD1_CRF_INFO_B714_SD1_CRF_INFOItem)AV15P_B714_SD1_CRF_INFO.elementAt(-1+AV28GXV1));
            AV29GXLvl40 = (byte)(0) ;
            /* Using cursor P00622 */
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               if ( AV24P_IN_SIGNATURE_CHK == 1 )
               {
                  AV8BC_TBT02_CRF.setgxTv_SdtTBT02_CRF_Tbt02_signature_flg( "1" );
                  AV8BC_TBT02_CRF.setgxTv_SdtTBT02_CRF_Tbt02_signature_datetime( GXutil.now( ) );
                  AV8BC_TBT02_CRF.setgxTv_SdtTBT02_CRF_Tbt02_signature_user_id( AV25P_IN_SIGNATURE_USER_ID );
               }
               ...
               AV9BC_TBT11_CRF_VERSION.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_flg( AV8BC_TBT02_CRF.getgxTv_SdtTBT02_CRF_Tbt02_signature_flg() );
               AV9BC_TBT11_CRF_VERSION.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_datetime( AV8BC_TBT02_CRF.getgxTv_SdtTBT02_CRF_Tbt02_signature_datetime() );
               AV9BC_TBT11_CRF_VERSION.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_signature_user_id( AV8BC_TBT02_CRF.getgxTv_SdtTBT02_CRF_Tbt02_signature_user_id() );
               ...
               AV9BC_TBT11_CRF_VERSION.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_crt_prog_nm( AV30Pgmname );
               AV9BC_TBT11_CRF_VERSION.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_upd_prog_nm( AV30Pgmname );
   ...
   {
      this.aP5[0] = b714_pc04_dm_arrival_crf.this.AV21W_RTN_CD;
      this.aP6[0] = b714_pc04_dm_arrival_crf.this.AV22W_RTN_MSG;
      CloseOpenCursors();
      exitApplication();
   }
   ...
   public void initialize( )
   {
      ...
      AV30Pgmname = "B714_PC04_DM_ARRIVAL_CRF" ;
      /* GeneXus formulas. */
      AV30Pgmname = "B714_PC04_DM_ARRIVAL_CRF" ;
      Gx_err = (short)(0) ;
   }

   private byte AV24P_IN_SIGNATURE_CHK ;
   private byte AV21W_RTN_CD ;
   private byte AV29GXLvl40 ;
   private byte A935TBT02_CRF_EDA_NO ;
   private byte A937TBT12_CRF_EDA_NO ;
   private byte GXv_int4[] ;
   private byte AV32GXLvl221 ;
   ...
   private String AV25P_IN_SIGNATURE_USER_ID ;
