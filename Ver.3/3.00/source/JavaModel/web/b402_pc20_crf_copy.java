/*
       ...
       Generated on: July 15, 2020 13:20:51.68
...
public final  class b402_pc20_crf_copy extends GXProcedure
{
   ...
   public void initialize( )
   {
      ...
      P00544_A415TBM33_PRIOR_NO = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_pc20_crf_copy__default(),
         new Object[] {
             new Object[] {
            P00542_A69TBM31_CRF_ID, P00542_A68TBM31_STUDY_ID, P00542_A528TBM31_DEF_VISIT_NO, P00542_n528TBM31_DEF_VISIT_NO, P00542_A529TBM31_DEF_DOMAIN_CD, P00542_n529TBM31_DEF_DOMAIN_CD
            }
            , new Object[] {
   ...
   private short[] P00544_A415TBM33_PRIOR_NO ;
...
final  class b402_pc20_crf_copy__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P00542", "SELECT `TBM31_CRF_ID`, `TBM31_STUDY_ID`, `TBM31_DEF_VISIT_NO`, `TBM31_DEF_DOMAIN_CD` FROM `TBM31_CRF` WHERE `TBM31_STUDY_ID` = ? and `TBM31_CRF_ID` = ? ORDER BY `TBM31_STUDY_ID`, `TBM31_CRF_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
