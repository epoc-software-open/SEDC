/*
               File: SdtTBM33_CRF_COND
        Description: CRFèåèÉ}ÉXÉ^
             Author: GeneXus Java Generator version 10_3_3-92797
       Generated on: July 15, 2020 13:19:44.0
...
public final  class SdtTBM33_CRF_COND extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( long AV76TBM33_STUDY_ID ,
                     short AV77TBM33_CRF_ID ,
                     short AV78TBM33_COND_NO )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {new Long(AV76TBM33_STUDY_ID),new Short(AV77TBM33_CRF_ID),new Short(AV78TBM33_COND_NO)});
   }

   public Object[][] GetBCKey( )
   {
      return (Object[][])(new Object[][]{new Object[]{"TBM33_STUDY_ID", long.class}, new Object[]{"TBM33_CRF_ID", short.class}, new Object[]{"TBM33_COND_NO", short.class}}) ;
   }
   ...
   public com.genexus.util.GXProperties getMetadata( )
   {
      ...
      metadata.set("Name", "TBM33_CRF_COND");
      metadata.set("BT", "TBM33_CRF_COND");
      metadata.set("PK", "[ \"TBM33_STUDY_ID\",\"TBM33_CRF_ID\",\"TBM33_COND_NO\" ]");
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            {
               gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no = (short)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
            ...
            {
               gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_Z = (short)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("TBM33_PRIOR_NO", GXutil.trim( GXutil.str( gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no, 3, 0)));
      if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
      {
         oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
      }
      ...
      if ( sIncludeState )
      {
         ...
         oWriter.writeElement("TBM33_PRIOR_NO_Z", GXutil.trim( GXutil.str( gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_Z, 3, 0)));
         if ( GXutil.strcmp(sNameSpace, "tablet-EDC_GXXEV3U3") != 0 )
         {
            oWriter.writeAttribute("xmlns", "tablet-EDC_GXXEV3U3");
         }
   ...
   {
      AddObjectProperty("TBM33_STUDY_ID", gxTv_SdtTBM33_CRF_COND_Tbm33_study_id, false);
      AddObjectProperty("TBM33_CRF_ID", gxTv_SdtTBM33_CRF_COND_Tbm33_crf_id, false);
      AddObjectProperty("TBM33_COND_NO", gxTv_SdtTBM33_CRF_COND_Tbm33_cond_no, false);
      AddObjectProperty("TBM33_COND_NM", gxTv_SdtTBM33_CRF_COND_Tbm33_cond_nm, false);
      AddObjectProperty("TBM33_EXPRESSION", gxTv_SdtTBM33_CRF_COND_Tbm33_expression, false);
      AddObjectProperty("TBM33_COND_DIV", gxTv_SdtTBM33_CRF_COND_Tbm33_cond_div, false);
      AddObjectProperty("TBM33_CRF_ITEM_CD", gxTv_SdtTBM33_CRF_COND_Tbm33_crf_item_cd, false);
      AddObjectProperty("TBM33_PRIOR_NO", gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no, false);
      AddObjectProperty("TBM33_ERR_DIV", gxTv_SdtTBM33_CRF_COND_Tbm33_err_div, false);
      AddObjectProperty("TBM33_ERR_MSG", gxTv_SdtTBM33_CRF_COND_Tbm33_err_msg, false);
      AddObjectProperty("TBM33_ENABLED_FLG", gxTv_SdtTBM33_CRF_COND_Tbm33_enabled_flg, false);
      AddObjectProperty("TBM33_REQUIRED_INPUT_FLG", gxTv_SdtTBM33_CRF_COND_Tbm33_required_input_flg, false);
      AddObjectProperty("TBM33_NUMERIC_RANGE_FLG", gxTv_SdtTBM33_CRF_COND_Tbm33_numeric_range_flg, false);
      AddObjectProperty("TBM33_DEL_FLG", gxTv_SdtTBM33_CRF_COND_Tbm33_del_flg, false);
      datetime_STZ = gxTv_SdtTBM33_CRF_COND_Tbm33_crt_datetime ;
      sDateCnv = "" ;
      ...
      AddObjectProperty("TBM33_CRT_USER_ID", gxTv_SdtTBM33_CRF_COND_Tbm33_crt_user_id, false);
      AddObjectProperty("TBM33_CRT_PROG_NM", gxTv_SdtTBM33_CRF_COND_Tbm33_crt_prog_nm, false);
      datetime_STZ = gxTv_SdtTBM33_CRF_COND_Tbm33_upd_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TBM33_UPD_USER_ID", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_user_id, false);
      AddObjectProperty("TBM33_UPD_PROG_NM", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_prog_nm, false);
      AddObjectProperty("TBM33_UPD_CNT", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_cnt, false);
      if ( includeState )
      {
         AddObjectProperty("Mode", gxTv_SdtTBM33_CRF_COND_Mode, false);
         AddObjectProperty("Initialized", gxTv_SdtTBM33_CRF_COND_Initialized, false);
         AddObjectProperty("TBM33_STUDY_ID_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_study_id_Z, false);
         AddObjectProperty("TBM33_CRF_ID_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_crf_id_Z, false);
         AddObjectProperty("TBM33_COND_NO_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_cond_no_Z, false);
         AddObjectProperty("TBM33_COND_NM_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_cond_nm_Z, false);
         AddObjectProperty("TBM33_EXPRESSION_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_expression_Z, false);
         AddObjectProperty("TBM33_COND_DIV_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_cond_div_Z, false);
         AddObjectProperty("TBM33_CRF_ITEM_CD_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_crf_item_cd_Z, false);
         AddObjectProperty("TBM33_PRIOR_NO_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_Z, false);
         AddObjectProperty("TBM33_ERR_DIV_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_err_div_Z, false);
         AddObjectProperty("TBM33_ERR_MSG_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_err_msg_Z, false);
         AddObjectProperty("TBM33_ENABLED_FLG_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_enabled_flg_Z, false);
         AddObjectProperty("TBM33_REQUIRED_INPUT_FLG_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_required_input_flg_Z, false);
         AddObjectProperty("TBM33_NUMERIC_RANGE_FLG_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_numeric_range_flg_Z, false);
         AddObjectProperty("TBM33_DEL_FLG_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_del_flg_Z, false);
         datetime_STZ = gxTv_SdtTBM33_CRF_COND_Tbm33_crt_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBM33_CRT_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBM33_CRT_USER_ID_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_crt_user_id_Z, false);
         AddObjectProperty("TBM33_CRT_PROG_NM_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_crt_prog_nm_Z, false);
         datetime_STZ = gxTv_SdtTBM33_CRF_COND_Tbm33_upd_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBM33_UPD_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBM33_UPD_USER_ID_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_user_id_Z, false);
         AddObjectProperty("TBM33_UPD_PROG_NM_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_prog_nm_Z, false);
         AddObjectProperty("TBM33_UPD_CNT_Z", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_cnt_Z, false);
         AddObjectProperty("TBM33_COND_NM_N", gxTv_SdtTBM33_CRF_COND_Tbm33_cond_nm_N, false);
         AddObjectProperty("TBM33_EXPRESSION_N", gxTv_SdtTBM33_CRF_COND_Tbm33_expression_N, false);
         AddObjectProperty("TBM33_COND_DIV_N", gxTv_SdtTBM33_CRF_COND_Tbm33_cond_div_N, false);
         AddObjectProperty("TBM33_CRF_ITEM_CD_N", gxTv_SdtTBM33_CRF_COND_Tbm33_crf_item_cd_N, false);
         AddObjectProperty("TBM33_PRIOR_NO_N", gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_N, false);
         AddObjectProperty("TBM33_ERR_DIV_N", gxTv_SdtTBM33_CRF_COND_Tbm33_err_div_N, false);
         AddObjectProperty("TBM33_ERR_MSG_N", gxTv_SdtTBM33_CRF_COND_Tbm33_err_msg_N, false);
         AddObjectProperty("TBM33_ENABLED_FLG_N", gxTv_SdtTBM33_CRF_COND_Tbm33_enabled_flg_N, false);
         AddObjectProperty("TBM33_REQUIRED_INPUT_FLG_N", gxTv_SdtTBM33_CRF_COND_Tbm33_required_input_flg_N, false);
         AddObjectProperty("TBM33_NUMERIC_RANGE_FLG_N", gxTv_SdtTBM33_CRF_COND_Tbm33_numeric_range_flg_N, false);
         AddObjectProperty("TBM33_DEL_FLG_N", gxTv_SdtTBM33_CRF_COND_Tbm33_del_flg_N, false);
         AddObjectProperty("TBM33_CRT_DATETIME_N", gxTv_SdtTBM33_CRF_COND_Tbm33_crt_datetime_N, false);
         AddObjectProperty("TBM33_CRT_USER_ID_N", gxTv_SdtTBM33_CRF_COND_Tbm33_crt_user_id_N, false);
         AddObjectProperty("TBM33_CRT_PROG_NM_N", gxTv_SdtTBM33_CRF_COND_Tbm33_crt_prog_nm_N, false);
         AddObjectProperty("TBM33_UPD_DATETIME_N", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_datetime_N, false);
         AddObjectProperty("TBM33_UPD_USER_ID_N", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_user_id_N, false);
         AddObjectProperty("TBM33_UPD_PROG_NM_N", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_prog_nm_N, false);
         AddObjectProperty("TBM33_UPD_CNT_N", gxTv_SdtTBM33_CRF_COND_Tbm33_upd_cnt_N, false);
      }
   }
   ...
   public short getgxTv_SdtTBM33_CRF_COND_Tbm33_prior_no( )
   {
      return gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no ;
   }

   public void setgxTv_SdtTBM33_CRF_COND_Tbm33_prior_no( short value )
   {
   ...
   public void setgxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_SetNull( )
   {
      ...
      gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no = (short)(0) ;
   }
   ...
   public short getgxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_Z( )
   {
      return gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_Z ;
   }

   public void setgxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_Z( short value )
   {
   ...
   {
      gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_Z = (short)(0) ;
   }
   ...
   private short gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no ;
   ...
   private short gxTv_SdtTBM33_CRF_COND_Tbm33_prior_no_Z ;
