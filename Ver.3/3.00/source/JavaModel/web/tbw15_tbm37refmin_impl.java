...
public final  class tbw15_tbm37refmin_impl extends GXWebPanel
{
   ...
   public void draw( )
   {
      ...
      if ( ! GxWebStd.gx_redirect( httpContext) )
      {
         ...
         renderHtmlHeaders( ) ;
         renderHtmlOpenForm( ) ;
         wb_table1_2_1L63( true) ;
      }
      return  ;
   }

   public void wb_table1_2_1L63e( boolean wbgen )
   {
      if ( wbgen )
      {
         renderHtmlCloseForm1L63( ) ;
      }
      /* Execute Exit event if defined. */
   }

   public void wb_table1_2_1L63( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table2_5_1L63( true) ;
      }
      return  ;
   }

   public void wb_table2_5_1L63e( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Control Group */
         ...
         wb_table3_28_1L63( true) ;
      }
      return  ;
   }

   public void wb_table3_28_1L63e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table1_2_1L63e( true) ;
      }
      else
      {
         wb_table1_2_1L63e( false) ;
      }
   }

   public void wb_table3_28_1L63( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table4_34_1L63( true) ;
      }
      return  ;
   }

   public void wb_table4_34_1L63e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_28_1L63e( true) ;
      }
      else
      {
         wb_table3_28_1L63e( false) ;
      }
   }

   public void wb_table4_34_1L63( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_34_1L63e( true) ;
      }
      else
      {
         wb_table4_34_1L63e( false) ;
      }
   }

   public void wb_table2_5_1L63( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_5_1L63e( true) ;
      }
      else
      {
         wb_table2_5_1L63e( false) ;
      }
   }
   ...
   public void onLoadActions1L63( )
   {
   }

   public void checkExtendedTable1L63( )
   {
      Gx_BScreen = (byte)(1) ;
      standaloneModal( ) ;
   ...
   public void closeExtendedTableCursors1L63( )
   {
   }
   ...
   public void checkOptimisticConcurrency1L63( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         /* Using cursor T001L2 */
   ...
   public void insert1L63( )
   {
      beforeValidate1L63( ) ;
      if ( AnyError == 0 )
      {
         checkExtendedTable1L63( ) ;
      }
      if ( AnyError == 0 )
      {
         zm1L63( 0) ;
         checkOptimisticConcurrency1L63( ) ;
         if ( AnyError == 0 )
         {
            afterConfirm1L63( ) ;
            if ( AnyError == 0 )
      ...
      closeExtendedTableCursors1L63( ) ;
   }

   public void update1L63( )
   {
      beforeValidate1L63( ) ;
      if ( AnyError == 0 )
      {
   ...
   public void deferredUpdate1L63( )
   {
   }
   ...
   public void onDeleteControls1L63( )
   {
      standaloneModal( ) ;
      /* No delete mode formulas found. */
   }

   public void endLevel1L63( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         pr_default.close(0);
   ...
   public void scanEnd1L63( )
   {
      pr_default.close(8);
   }

   public void afterConfirm1L63( )
   {
      /* After Confirm Rules */
   }

   public void beforeInsert1L63( )
   {
      /* Before Insert Rules */
   }

   public void beforeUpdate1L63( )
   {
      /* Before Update Rules */
   }

   public void beforeDelete1L63( )
   {
      /* Before Delete Rules */
   }

   public void beforeComplete1L63( )
   {
      /* Before Complete Rules */
   }

   public void beforeValidate1L63( )
   {
      /* Before Validate Rules */
   }

   public void disableAttributes1L63( )
   {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513222168");
   ...
   public void renderHtmlCloseForm1L63( )
   {
   ...
   public void initializeNonKey1L63( )
   {
   }

   public void initAll1L63( )
   {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202071513222170");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tbw15_tbm37refmin.js", "?202071513222170");
