...
public final  class b405_wp01_kanja_crf_list_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202071513245079");
   ...
   public void strup1D0( )
   {
      ...
      AV51Pgmname = "B405_WP01_KANJA_CRF_LIST" ;
      Gx_err = (short)(0) ;
   ...
   private void e311D2( )
   {
      ...
      pr_default.dynParam(2, new Object[]{ new Object[]{
                                           ...
                                           AV25W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn() ,
                                           AV25W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg() ,
                                           AV25W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_User_study_sdt().getgxTv_SdtA_USER_STUDY_SDT_Study_id() ,
                                           new Short(A69TBM31_CRF_ID) ,
                                           A643TBM31_STATUS ,
                                           A397TBM31_DEL_FLG },
                                           new int[] {
                                           TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.OBJECT_COLLECTION, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN
                                           }
      });
      /* Using cursor H001D4 */
      ...
      while ( (pr_default.getStatus(5) != 101) )
      {
         ...
         if ( ( AV27W_B405_WP01_SD01.getgxTv_SdtB405_SD01_Chk() ) && ( AV27W_B405_WP01_SD01.getgxTv_SdtB405_SD01_Chk_visbale() ) )
         {
            ...
            while ( (pr_default.getStatus(6) != 101) )
            {
               ...
               httpContext.ajax_rsp_assign_attri("", false, "A415TBM33_PRIOR_NO", GXutil.ltrim( GXutil.str( A415TBM33_PRIOR_NO, 3, 0)));
               ...
               if ( ( AV30W_COND_HYOKA > 0 ) || (GXutil.strcmp("", A414TBM33_EXPRESSION)==0) )
               {
                  ...
                  while ( (pr_default.getStatus(7) != 101) )
                  {
                     ...
                     AV6BC_TBT02_CRF.setgxTv_SdtTBT02_CRF_Tbt02_crt_prog_nm( AV51Pgmname );
            ...
            {
               AV59GXV3 = 1 ;
               httpContext.ajax_rsp_assign_attri("", false, "AV59GXV3", GXutil.ltrim( GXutil.str( AV59GXV3, 8, 0)));
               while ( AV59GXV3 <= AV33W_CRFID_COLS.size() )
               {
                  AV32W_CRFID_COL = ((Number) AV33W_CRFID_COLS.elementAt(-1+AV59GXV3)).shortValue() ;
   ...
   public void e331D2( )
   {
      ...
      if ( GXutil.strcmp(AV34W_ERR_MSG, "") == 0 )
      {
         AV41W_SESSION.setValue(AV51Pgmname+"_PAGE", GXutil.str( AV17H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Page_no(), 10, 0));
         GXKey = context.getSiteKey( ) ;
   ...
   public void S192( )
   {
      ...
      if ( GXutil.strcmp(AV22H_SRCH_FLG, "1") == 0 )
      {
         ...
         pr_default.dynParam(9, new Object[]{ new Object[]{
                                              ...
                                              A441TBT01_DEL_FLG },
                                              new int[] {
                                              TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.OBJECT_COLLECTION, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN
                                              }
         });
         ...
         while ( (pr_default.getStatus(9) != 101) )
         {
            ...
            while ( (pr_default.getStatus(10) != 101) )
            {
               ...
               AV63GXLvl770 = (byte)(0) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV63GXLvl770", GXutil.str( AV63GXLvl770, 1, 0));
   ...
   public void S142( )
   {
      ...
      if ( AV24P_MOVE_KBN == 1 )
      {
         ...
         S192 ();
         if (returnInSub) return;
         AV17H_A_PAGING_SDT.setgxTv_SdtA_PAGING_SDT_Page_no( (short)(GXutil.lval( AV41W_SESSION.getValue(AV51Pgmname+"_PAGE"))) );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV17H_A_PAGING_SDT", AV17H_A_PAGING_SDT);
      }
      else
      {
   ...
   public void S202( )
   {
      ...
      AV41W_SESSION.setValue(AV51Pgmname+"_STUDY_ID", GXutil.str( AV15D_STUDY_ID, 10, 0));
      AV41W_SESSION.setValue(AV51Pgmname+"_OUTER_SUBJECT_ID", AV16D_TBT01_OUTER_SUBJECT_ID);
      AV41W_SESSION.setValue(AV51Pgmname+"_CRF_SEL_ONLY", GXutil.booltostr( AV9W_CRF_SEL_ONLY));
      AV41W_SESSION.setValue(AV51Pgmname+"_GRD_CHK_ALL", GXutil.booltostr( AV11D_GRD_CHK_ALL));
      AV41W_SESSION.setValue(AV51Pgmname+"_SRCH_FLG", AV22H_SRCH_FLG);
   }

   public void S222( )
   {
      /* 'SUB_SESSION_GET' Routine */
      AV15D_STUDY_ID = GXutil.lval( AV41W_SESSION.getValue(AV51Pgmname+"_STUDY_ID")) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15D_STUDY_ID", GXutil.ltrim( GXutil.str( AV15D_STUDY_ID, 10, 0)));
      AV16D_TBT01_OUTER_SUBJECT_ID = AV41W_SESSION.getValue(AV51Pgmname+"_OUTER_SUBJECT_ID") ;
      httpContext.ajax_rsp_assign_attri("", false, "AV16D_TBT01_OUTER_SUBJECT_ID", AV16D_TBT01_OUTER_SUBJECT_ID);
      if ( GXutil.strcmp(AV41W_SESSION.getValue(AV51Pgmname+"_CRF_SEL_ONLY"), "true") == 0 )
      {
      ...
      if ( GXutil.strcmp(AV41W_SESSION.getValue(AV51Pgmname+"_GRD_CHK_ALL"), "true") == 0 )
      {
      ...
      AV22H_SRCH_FLG = AV41W_SESSION.getValue(AV51Pgmname+"_SRCH_FLG") ;
      httpContext.ajax_rsp_assign_attri("", false, "AV22H_SRCH_FLG", AV22H_SRCH_FLG);
   }
   ...
   public void S212( )
   {
      ...
      AV41W_SESSION.remove(AV51Pgmname+"_STUDY_ID");
      AV41W_SESSION.remove(AV51Pgmname+"_OUTER_SUBJECT_ID");
      AV41W_SESSION.remove(AV51Pgmname+"_CRF_SEL_ONLY");
      AV41W_SESSION.remove(AV51Pgmname+"_GRD_CHK_ALL");
      AV41W_SESSION.remove(AV51Pgmname+"_SRCH_FLG");
   }
   ...
   public void S112( )
   {
      ...
      GXv_SdtA_USER_STUDY_SDT6[0] = AV25W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_User_study_sdt();
      new b799_pc13_get_user_study(remoteHandle, context).execute( AV25W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_user_id(), GXv_SdtA_USER_STUDY_SDT6) ;
      AV25W_A_LOGIN_SDT.setgxTv_SdtA_LOGIN_SDT_User_study_sdt( GXv_SdtA_USER_STUDY_SDT6[0] );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV25W_A_LOGIN_SDT", AV25W_A_LOGIN_SDT);
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV25W_A_LOGIN_SDT", AV25W_A_LOGIN_SDT);
      AV41W_SESSION.setValue("Com_Login_Info", AV25W_A_LOGIN_SDT.toxml(false, true, "A_LOGIN_SDT", "tablet-EDC_GXXEV3U3"));
   ...
   public void S132( )
   {
      ...
      new a402_pc01_kengen_check(remoteHandle, context).execute( AV8C_TAM02_APP_ID, GXv_char2, GXv_char7) ;
   ...
   private void e341D5( )
   {
      /* Grid2_Load Routine */
      AV53GXV2 = 1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV53GXV2", GXutil.ltrim( GXutil.str( AV53GXV2, 8, 0)));
      while ( AV53GXV2 <= AV27W_B405_WP01_SD01.getgxTv_SdtB405_SD01_Crf().size() )
      {
         AV28W_B405_WP01_SD01_CRF_ITEM = (SdtB405_SD01_CRF_Item)((SdtB405_SD01_CRF_Item)AV27W_B405_WP01_SD01.getgxTv_SdtB405_SD01_Crf().elementAt(-1+AV53GXV2));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20207151325078");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b405_wp01_kanja_crf_list.js", "?20207151325079");
   ...
   public void initialize( )
   {
      ...
      H001D8_A415TBM33_PRIOR_NO = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b405_wp01_kanja_crf_list__default(),
         new Object[] {
            ...
            , new Object[] {
            H001D14_A63TBM21_STUDY_ID, H001D14_A369TBM21_DEL_FLG, H001D14_n369TBM21_DEL_FLG, H001D14_A607TBM21_STATUS, H001D14_n607TBM21_STATUS, H001D14_A367TBM21_STUDY_NM, H001D14_n367TBM21_STUDY_NM
            }
         }
      );
   ...
   private String AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn ;
   private String AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg ;
   ...
   private short[] H001D8_A415TBM33_PRIOR_NO ;
   ...
   private GxObjectCollection AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_User_study_sdt_getgxTv_SdtA_USER_STUDY_SDT_Study_id ;
...
final  class b405_wp01_kanja_crf_list__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H001D4( ModelContext context ,
                                          ...
                                          long AV15D_STUDY_ID ,
                                          String AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn ,
                                          String AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg ,
                                          GxObjectCollection AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_User_study_sdt_getgxTv_SdtA_USER_STUDY_SDT_Study_id ,
                                          ...
                                          String A397TBM31_DEL_FLG )
   {
      ...
      if ( ( GXutil.strcmp(AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn, "99") != 0 ) && ( GXutil.strcmp(AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg, "1") != 0 ) )
      {
         sWhereString = sWhereString + " and (" + GXutil.toValueList("mysql", AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_User_study_sdt_getgxTv_SdtA_USER_STUDY_SDT_Study_id, "`TBM31_STUDY_ID` IN (", ")") + ")" ;
      }
                                           ...
                                           String A441TBT01_DEL_FLG )
   {
      ...
      if ( ( GXutil.strcmp(AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn, "99") != 0 ) && ( GXutil.strcmp(AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg, "1") != 0 ) && (0==AV15D_STUDY_ID) )
      {
         sWhereString = sWhereString + " and (" + GXutil.toValueList("mysql", AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_User_study_sdt_getgxTv_SdtA_USER_STUDY_SDT_Study_id, "`TBT01_STUDY_ID` IN (", ")") + ")" ;
      }
   ...
   protected Object[] conditional_H001D14( ModelContext context ,
                                           int remoteHandle ,
                                           com.genexus.internet.HttpContext httpContext ,
                                           ...
                                           String A369TBM21_DEL_FLG )
   {
      ...
      if ( ( GXutil.strcmp(AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn, "99") != 0 ) && ( GXutil.strcmp(AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_Tam07_admin_auth_flg, "1") != 0 ) )
      {
         sWhereString = sWhereString + " and (" + GXutil.toValueList("mysql", AV25W_A_LOGIN_SDT_getgxTv_SdtA_LOGIN_SDT_User_study_sdt_getgxTv_SdtA_USER_STUDY_SDT_Study_id, "`TBM21_STUDY_ID` IN (", ")") + ")" ;
      }
      scmdbuf = scmdbuf + sWhereString ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 2 :
                  return conditional_H001D4(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).longValue() , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (GxObjectCollection)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] , (String)dynConstraints[7] );
            case 4 :
                  return conditional_H001D6(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).longValue() , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (GxObjectCollection)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] , (String)dynConstraints[7] );
            case 7 :
            ...
            case 9 :
                  return conditional_H001D11(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).longValue() , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (GxObjectCollection)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] );
            case 10 :
                  return conditional_H001D12(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).longValue() , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (GxObjectCollection)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] , (String)dynConstraints[7] );
            case 12 :
                  return conditional_H001D14(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , (GxObjectCollection)dynConstraints[4] , (String)dynConstraints[5] );
      }
   ...
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H001D14", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
      };
   }
