/*
               File: SdtTAM04BC_KNGN
        Description: 権限パターンマスタ（ビジネスコンポーネント）
             Author: GeneXus Java Generator version 10_3_3-92797
       Generated on: July 15, 2020 13:18:54.82
...
public final  class SdtTAM04BC_KNGN extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public com.genexus.util.GXProperties getMetadata( )
   {
      ...
      metadata.set("Name", "TAM04BC_KNGN");
      metadata.set("BT", "TAM04_KNGN");
      metadata.set("PK", "[ \"TAM04_AUTH_CD\" ]");
      metadata.set("Levels", "[ \"TAM05_APPLI\" ]");
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            if ( GXutil.strcmp2( oReader.getLocalName(), "TAM05_APPLI") )
            {
               ...
               {
                  gxTv_SdtTAM04BC_KNGN_Tam05_appli = new GxSilentTrnGridCollection(SdtTAM04BC_KNGN_TAM05_APPLI.class, "TAM04BC_KNGN.TAM05_APPLI", "tablet-EDC_GXXEV3U3", remoteHandle);
               }
   ...
   {
      AddObjectProperty("TAM04_AUTH_CD", gxTv_SdtTAM04BC_KNGN_Tam04_auth_cd, false);
      AddObjectProperty("TAM04_AUTH_NM", gxTv_SdtTAM04BC_KNGN_Tam04_auth_nm, false);
      AddObjectProperty("TAM04_AUTH_LVL", gxTv_SdtTAM04BC_KNGN_Tam04_auth_lvl, false);
      AddObjectProperty("TAM04_DEL_FLG", gxTv_SdtTAM04BC_KNGN_Tam04_del_flg, false);
      datetime_STZ = gxTv_SdtTAM04BC_KNGN_Tam04_crt_datetime ;
      sDateCnv = "" ;
      ...
      AddObjectProperty("TAM04_CRT_USER_ID", gxTv_SdtTAM04BC_KNGN_Tam04_crt_user_id, false);
      AddObjectProperty("TAM04_CRT_PROG_NM", gxTv_SdtTAM04BC_KNGN_Tam04_crt_prog_nm, false);
      datetime_STZ = gxTv_SdtTAM04BC_KNGN_Tam04_upd_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      AddObjectProperty("TAM04_UPD_USER_ID", gxTv_SdtTAM04BC_KNGN_Tam04_upd_user_id, false);
      AddObjectProperty("TAM04_UPD_PROG_NM", gxTv_SdtTAM04BC_KNGN_Tam04_upd_prog_nm, false);
      AddObjectProperty("TAM04_UPD_CNT", gxTv_SdtTAM04BC_KNGN_Tam04_upd_cnt, false);
      if ( gxTv_SdtTAM04BC_KNGN_Tam05_appli != null )
      {
         AddObjectProperty("TAM05_APPLI", gxTv_SdtTAM04BC_KNGN_Tam05_appli, includeState);
      }
      if ( includeState )
      {
         AddObjectProperty("Mode", gxTv_SdtTAM04BC_KNGN_Mode, false);
         AddObjectProperty("Initialized", gxTv_SdtTAM04BC_KNGN_Initialized, false);
         AddObjectProperty("TAM04_AUTH_CD_Z", gxTv_SdtTAM04BC_KNGN_Tam04_auth_cd_Z, false);
         AddObjectProperty("TAM04_AUTH_NM_Z", gxTv_SdtTAM04BC_KNGN_Tam04_auth_nm_Z, false);
         AddObjectProperty("TAM04_AUTH_LVL_Z", gxTv_SdtTAM04BC_KNGN_Tam04_auth_lvl_Z, false);
         AddObjectProperty("TAM04_DEL_FLG_Z", gxTv_SdtTAM04BC_KNGN_Tam04_del_flg_Z, false);
         datetime_STZ = gxTv_SdtTAM04BC_KNGN_Tam04_crt_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         AddObjectProperty("TAM04_CRT_USER_ID_Z", gxTv_SdtTAM04BC_KNGN_Tam04_crt_user_id_Z, false);
         AddObjectProperty("TAM04_CRT_PROG_NM_Z", gxTv_SdtTAM04BC_KNGN_Tam04_crt_prog_nm_Z, false);
         datetime_STZ = gxTv_SdtTAM04BC_KNGN_Tam04_upd_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         AddObjectProperty("TAM04_UPD_USER_ID_Z", gxTv_SdtTAM04BC_KNGN_Tam04_upd_user_id_Z, false);
         AddObjectProperty("TAM04_UPD_PROG_NM_Z", gxTv_SdtTAM04BC_KNGN_Tam04_upd_prog_nm_Z, false);
         AddObjectProperty("TAM04_UPD_CNT_Z", gxTv_SdtTAM04BC_KNGN_Tam04_upd_cnt_Z, false);
         AddObjectProperty("TAM04_AUTH_NM_N", gxTv_SdtTAM04BC_KNGN_Tam04_auth_nm_N, false);
         AddObjectProperty("TAM04_AUTH_LVL_N", gxTv_SdtTAM04BC_KNGN_Tam04_auth_lvl_N, false);
         AddObjectProperty("TAM04_DEL_FLG_N", gxTv_SdtTAM04BC_KNGN_Tam04_del_flg_N, false);
         AddObjectProperty("TAM04_CRT_DATETIME_N", gxTv_SdtTAM04BC_KNGN_Tam04_crt_datetime_N, false);
         AddObjectProperty("TAM04_CRT_USER_ID_N", gxTv_SdtTAM04BC_KNGN_Tam04_crt_user_id_N, false);
         AddObjectProperty("TAM04_CRT_PROG_NM_N", gxTv_SdtTAM04BC_KNGN_Tam04_crt_prog_nm_N, false);
         AddObjectProperty("TAM04_UPD_DATETIME_N", gxTv_SdtTAM04BC_KNGN_Tam04_upd_datetime_N, false);
         AddObjectProperty("TAM04_UPD_USER_ID_N", gxTv_SdtTAM04BC_KNGN_Tam04_upd_user_id_N, false);
         AddObjectProperty("TAM04_UPD_PROG_NM_N", gxTv_SdtTAM04BC_KNGN_Tam04_upd_prog_nm_N, false);
         AddObjectProperty("TAM04_UPD_CNT_N", gxTv_SdtTAM04BC_KNGN_Tam04_upd_cnt_N, false);
      }
   }
   ...
   public void setStruct( StructSdtTAM04BC_KNGN struct )
   {
      ...
      setgxTv_SdtTAM04BC_KNGN_Tam05_appli(new GxSilentTrnGridCollection(SdtTAM04BC_KNGN_TAM05_APPLI.class, "TAM04BC_KNGN.TAM05_APPLI", "tablet-EDC_GXXEV3U3", struct.getTam05_appli(), remoteHandle));
