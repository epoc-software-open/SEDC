/*
       ...
       Generated on: July 15, 2020 13:31:44.36
...
public final  class SdtB705_SD03_CHK_COND_B705_SD03_CHK_CONDItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            {
               gxTv_SdtB705_SD03_CHK_COND_B705_SD03_CHK_CONDItem_Prior_no = (short)(GXutil.lval( oReader.getValue())) ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
               }
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("PRIOR_NO", GXutil.trim( GXutil.str( gxTv_SdtB705_SD03_CHK_COND_B705_SD03_CHK_CONDItem_Prior_no, 3, 0)));
   ...
   public short getgxTv_SdtB705_SD03_CHK_COND_B705_SD03_CHK_CONDItem_Prior_no( )
   {
      return gxTv_SdtB705_SD03_CHK_COND_B705_SD03_CHK_CONDItem_Prior_no ;
   }

   public void setgxTv_SdtB705_SD03_CHK_COND_B705_SD03_CHK_CONDItem_Prior_no( short value )
   {
