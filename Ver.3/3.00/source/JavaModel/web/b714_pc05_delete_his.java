/*
       ...
       Generated on: July 15, 2020 13:17:32.1
...
public final  class b714_pc05_delete_his extends GXProcedure
{
   ...
   public String executeUdp( long aP0 ,
                             ...
                             byte[] aP4 )
   {
      b714_pc05_delete_his.this.AV11P_STUDY_ID = aP0;
      b714_pc05_delete_his.this.AV12P_SUBJECT_ID = aP1;
      b714_pc05_delete_his.this.AV10P_CRF_ID = aP2;
      b714_pc05_delete_his.this.AV9P_CRF_EDA_NO = aP3;
   ...
   private void privateExecute( )
   {
      ...
      /* Optimized DELETE. */
      /* Using cursor P006Y2 */
      pr_default.execute(0, new Object[] {new Long(AV11P_STUDY_ID), new Integer(AV12P_SUBJECT_ID), new Short(AV10P_CRF_ID), new Byte(AV9P_CRF_EDA_NO)});
      Application.getSmartCacheProvider(remoteHandle).setUpdated("TBT11_CRF_HISTORY") ;
      /* End optimized DELETE. */
      /* Optimized DELETE. */
      /* Using cursor P006Y3 */
      pr_default.execute(1, new Object[] {new Long(AV11P_STUDY_ID), new Integer(AV12P_SUBJECT_ID), new Short(AV10P_CRF_ID), new Byte(AV9P_CRF_EDA_NO)});
   ...
   public void S111( )
   {
      /* 'SUB_INIT' Routine */
      GXActiveErrHndl = 1 ;
      new a804_pc02_log_start(remoteHandle, context).execute( AV21Pgmname) ;
   }
   ...
   {
      this.aP4[0] = b714_pc05_delete_his.this.AV15W_RTN_CD;
      this.aP5[0] = b714_pc05_delete_his.this.AV16W_RTN_MSG;
      CloseOpenCursors();
      exitApplication();
   }
   ...
   public void initialize( )
   {
      ...
      AV21Pgmname = "B714_PC05_DELETE_HIS" ;
      /* GeneXus formulas. */
      AV21Pgmname = "B714_PC05_DELETE_HIS" ;
      Gx_err = (short)(0) ;
   }

   private byte AV9P_CRF_EDA_NO ;
   private byte AV15W_RTN_CD ;
   private short AV10P_CRF_ID ;
