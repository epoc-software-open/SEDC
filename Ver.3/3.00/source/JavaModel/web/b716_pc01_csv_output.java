/*
       ...
       Generated on: March 3, 2021 14:42:23.98
...
public final  class b716_pc01_csv_output extends GXProcedure
{
   ...
   public void S111( )
   {
      ...
      AV62GXV1 = 1 ;
      while ( AV62GXV1 <= AV18P_B716_SD1_CRF_INFO.size() )
      {
         AV23W_B716_SD1_CRF_INFO_Item = (SdtB716_SD1_CRF_INFO_B716_SD1_CRF_INFOItem)((SdtB716_SD1_CRF_INFO_B716_SD1_CRF_INFOItem)AV18P_B716_SD1_CRF_INFO.elementAt(-1+AV62GXV1));
         /*
   ...
   public void S131( )
   {
      ...
      while ( (pr_default.getStatus(3) != 101) )
      {
         ...
         b716_pc01_csv_output.this.AV55W_SEQ_POS = GXv_int4[0] ;
         AV51W_CSV_DATA = "" ;
         AV65GXV2 = 1 ;
         while ( AV65GXV2 <= AV46B716_SD2_DOM_MAP_C.size() )
         {
            AV47B716_SD2_DOM_MAP_I = (SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem)((SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem)AV46B716_SD2_DOM_MAP_C.elementAt(-1+AV65GXV2));
            AV50W_CNT = (short)(1) ;
            while ( AV50W_CNT <= AV47B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_var().size() )
            {
               AV51W_CSV_DATA = AV51W_CSV_DATA + ((GXutil.strcmp("", AV51W_CSV_DATA)==0) ? "" : AV25W_CSV_SEP) ;
               AV51W_CSV_DATA = AV51W_CSV_DATA + ((SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem)AV47B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_var().elementAt(-1+AV50W_CNT)).getgxTv_SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem_Dom_var_nm() ;
               AV50W_CNT = (short)(AV50W_CNT+1) ;
            }
            if (true) break;
         ...
         while ( (pr_default.getStatus(3) != 101) && ( GXutil.strcmp(P00645_A187TBW13_DOM_CD[0], A187TBW13_DOM_CD) == 0 ) )
         {
            ...
            AV51W_CSV_DATA = "" ;
            AV52W_DATA_OUT_FLG = false ;
            if ( AV55W_SEQ_POS == 0 )
            {
               AV52W_DATA_OUT_FLG = true ;
               AV51W_CSV_DATA = A836TBW13_VALUE ;
            }
            else
            {
               GXv_objcol_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem3[0] = AV53W_RAW_STR ;
               GXv_int4[0] = AV39W_RTN_CD ;
               GXv_char2[0] = AV54W_RTN_MSG ;
               ...
               AV53W_RAW_STR = GXv_objcol_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem3[0] ;
               b716_pc01_csv_output.this.AV39W_RTN_CD = GXv_int4[0] ;
               b716_pc01_csv_output.this.AV54W_RTN_MSG = GXv_char2[0] ;
               AV67GXV3 = 1 ;
               while ( AV67GXV3 <= AV46B716_SD2_DOM_MAP_C.size() )
               {
                  AV47B716_SD2_DOM_MAP_I = (SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem)((SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem)AV46B716_SD2_DOM_MAP_C.elementAt(-1+AV67GXV3));
                  if ( ( AV47B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Visit_no() == A186TBW13_VISIT_NO ) && ( GXutil.strcmp(AV47B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_itm_grp_oid(), A188TBW13_DOM_ITM_GRP_OID) == 0 ) && ( AV47B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_itm_grp_rowno() == A189TBW13_DOM_ITM_GRP_ROWNO ) )
                  {
                     ...
                     while ( AV50W_CNT <= AV47B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_var().size() )
                     {
                        if ( ! (GXutil.strcmp("", ((SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem)AV47B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_var().elementAt(-1+AV50W_CNT)).getgxTv_SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem_Crf_item_grp_cd())==0) )
                        {
                           if ( (GXutil.strcmp("", (String)AV53W_RAW_STR.elementAt(-1+AV50W_CNT))==0) )
                           {
                           }
                           else
                           {
               ...
               if ( AV52W_DATA_OUT_FLG )
               {
                  if ( AV56W_TBW13_SUBJECT_ID != A185TBW13_SUBJECT_ID )
                  {
                     AV56W_TBW13_SUBJECT_ID = A185TBW13_SUBJECT_ID ;
                     AV57W_SEQ = 1 ;
                  }
                  else
                  {
                     AV57W_SEQ = (long)(AV57W_SEQ+1) ;
                  }
                  AV50W_CNT = (short)(1) ;
                  while ( AV50W_CNT <= AV53W_RAW_STR.size() )
                  {
                     AV51W_CSV_DATA = AV51W_CSV_DATA + ((AV50W_CNT==1) ? "" : AV25W_CSV_SEP) ;
                     if ( AV50W_CNT == AV55W_SEQ_POS )
                     {
                        AV51W_CSV_DATA = AV51W_CSV_DATA + GXutil.trim( GXutil.str( AV57W_SEQ, 10, 0)) ;
                     }
                     else
                     {
                        AV51W_CSV_DATA = AV51W_CSV_DATA + GXutil.trim( (String)AV53W_RAW_STR.elementAt(-1+AV50W_CNT)) ;
                     }
                     AV50W_CNT = (short)(AV50W_CNT+1) ;
                  }
               }
   ...
   public void S141( )
   {
      ...
      AV69GXV5 = 1 ;
      AV68GXV4 = (com.genexus.util.GXFileCollection)AV27W_DIR.getFiles("");
      while ( AV69GXV5 <= AV68GXV4.getItemCount() )
      {
         AV33W_FILE = (com.genexus.util.GXFile)AV68GXV4.item(AV69GXV5);
      ...
      if ( AV35W_FILES.size() > 0 )
      {
         ...
         AV50W_CNT = (short)(1) ;
         while ( AV50W_CNT <= AV35W_FILES.size() )
         {
            AV33W_FILE.setSource( (String)AV35W_FILES.elementAt(-1+AV50W_CNT) );
            AV33W_FILE.delete();
            AV50W_CNT = (short)(AV50W_CNT+1) ;
         }
         AV27W_DIR.delete();
   ...
   {
      /* 'SUB_ERROR' Routine */
      new a804_pc01_syslog(remoteHandle, context).execute( AV75Pgmname, "ERR", GXutil.trim( GXutil.str( context.globals.Gx_dbe, 10, 0))+":"+context.globals.Gx_dbt) ;
      GXKey = context.getSiteKey( ) ;
   ...
   public void S181( )
   {
      ...
      else
      {
         ...
         new b808_pc01_dbg_log(remoteHandle, context).execute( AV75Pgmname, (short)(1), AV37W_MSG, GXv_SdtB808_SD01_EXTRA_INFO6, GXv_int4, GXv_char2) ;
   ...
   public void initialize( )
   {
      ...
      AV53W_RAW_STR = new GxObjectCollection(String.class, "internal", "");
      GXv_objcol_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem3 = new GxObjectCollection [1] ;
      AV54W_RTN_MSG = "" ;
      AV68GXV4 = new com.genexus.util.GXFileCollection();
      ...
      AV75Pgmname = "B716_PC01_CSV_OUTPUT" ;
      /* GeneXus formulas. */
      AV75Pgmname = "B716_PC01_CSV_OUTPUT" ;
      Gx_err = (short)(0) ;
   }
   ...
   private short AV55W_SEQ_POS ;
   private short AV50W_CNT ;
   ...
   private int AV56W_TBW13_SUBJECT_ID ;
   ...
   private boolean AV52W_DATA_OUT_FLG ;
