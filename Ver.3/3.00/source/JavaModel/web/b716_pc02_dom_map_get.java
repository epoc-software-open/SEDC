/*
       ...
       Generated on: July 15, 2020 13:17:31.65
...
public final  class b716_pc02_dom_map_get extends GXProcedure
{
   ...
   {
      b716_pc02_dom_map_get.this.AV15P_STUDY_ID = aP0;
      b716_pc02_dom_map_get.this.AV14P_DOM_CD = aP1;
   ...
   {
      AV9B716_SD2_DOM_MAP_C.clear();
      AV11B716_SD3_DOM_VAR_C.clear();
      AV18W_SEQ_POS = (short)(0) ;
      AV16W_CNT = (short)(0) ;
      ...
      /* Using cursor P006X2 */
      pr_default.execute(0, new Object[] {new Long(AV15P_STUDY_ID), AV14P_DOM_CD});
      while ( (pr_default.getStatus(0) != 101) )
      {
         ...
         AV16W_CNT = (short)(AV16W_CNT+1) ;
         AV12B716_SD3_DOM_VAR_I = (SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem)new SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem(remoteHandle, context);
         AV12B716_SD3_DOM_VAR_I.setgxTv_SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem_Dom_var_nm( A202TBM43_DOM_VAR_NM );
         AV11B716_SD3_DOM_VAR_C.add(AV12B716_SD3_DOM_VAR_I, 0);
         if ( GXutil.like( A202TBM43_DOM_VAR_NM , GXutil.padr( "%SEQ" , 50 , "%"),  ' ' ) )
         {
            AV18W_SEQ_POS = AV16W_CNT ;
         }
         pr_default.readNext(0);
      }
      pr_default.close(0);
      AV26W_TBM37_CRF_ID = (short)(0) ;
      AV21W_TBM37_VISIT_NO = 0 ;
      AV19W_TBM37_DOM_ITM_GRP_OID = "" ;
      AV20W_TBM37_DOM_ITM_GRP_ROWNO = (short)(0) ;
      AV27W_DATA_CNT = 0 ;
      /* Using cursor P006X3 */
      pr_default.execute(1, new Object[] {new Long(AV15P_STUDY_ID), AV14P_DOM_CD});
      while ( (pr_default.getStatus(1) != 101) )
      {
         ...
         AV27W_DATA_CNT = (long)(AV27W_DATA_CNT+1) ;
         AV28W_DATA_SET_FLG = true ;
         if ( ( AV26W_TBM37_CRF_ID == A80TBM37_CRF_ID ) && ( AV21W_TBM37_VISIT_NO == A83TBM37_VISIT_NO ) && ( GXutil.strcmp(AV19W_TBM37_DOM_ITM_GRP_OID, A85TBM37_DOM_ITM_GRP_OID) == 0 ) && ( AV20W_TBM37_DOM_ITM_GRP_ROWNO == A86TBM37_DOM_ITM_GRP_ROWNO ) && ( AV27W_DATA_CNT > 1 ) )
         {
            AV28W_DATA_SET_FLG = false ;
         }
         if ( AV28W_DATA_SET_FLG )
         {
            AV26W_TBM37_CRF_ID = A80TBM37_CRF_ID ;
            AV21W_TBM37_VISIT_NO = A83TBM37_VISIT_NO ;
            AV19W_TBM37_DOM_ITM_GRP_OID = A85TBM37_DOM_ITM_GRP_OID ;
            AV20W_TBM37_DOM_ITM_GRP_ROWNO = A86TBM37_DOM_ITM_GRP_ROWNO ;
            /* Using cursor P006X4 */
            ...
            while ( (pr_default.getStatus(2) != 101) )
            {
               ...
               AV23W_TBM31_REPEAT_FLG = A943TBM31_REPEAT_FLG ;
            ...
            else
            {
               ...
               while ( (pr_default.getStatus(3) != 101) )
               {
                  ...
                  AV21W_TBM37_VISIT_NO = A948TBM44_VISIT_NO ;
                  /* Execute user subroutine: S131 */
                  S131 ();
                  if ( returnInSub )
                  {
   ...
   public void S111( )
   {
      ...
      /* Using cursor P006X6 */
      pr_default.execute(4, new Object[] {new Long(AV15P_STUDY_ID), AV14P_DOM_CD});
      while ( (pr_default.getStatus(4) != 101) )
      {
         ...
         while ( (pr_default.getStatus(6) != 101) )
         {
            ...
            if ( AV23W_TBM31_REPEAT_FLG == 0 )
            {
               ...
               AV19W_TBM37_DOM_ITM_GRP_OID = A85TBM37_DOM_ITM_GRP_OID ;
               AV20W_TBM37_DOM_ITM_GRP_ROWNO = A86TBM37_DOM_ITM_GRP_ROWNO ;
               AV25W_TBM37_DOM_VAR_NM = A500TBM37_DOM_VAR_NM ;
               AV24W_TBM37_CRF_ITEM_GRP_CD = A82TBM37_CRF_ITEM_GRP_CD ;
   ...
   {
      /* 'SUB_SD2_ADD' Routine */
      AV22W_DATA_FLG = false ;
      AV39GXV1 = 1 ;
      while ( AV39GXV1 <= AV9B716_SD2_DOM_MAP_C.size() )
      {
         AV10B716_SD2_DOM_MAP_I = (SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem)((SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem)AV9B716_SD2_DOM_MAP_C.elementAt(-1+AV39GXV1));
         if ( ( AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Visit_no() == AV21W_TBM37_VISIT_NO ) && ( GXutil.strcmp(AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_itm_grp_oid(), AV19W_TBM37_DOM_ITM_GRP_OID) == 0 ) && ( AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_itm_grp_rowno() == AV20W_TBM37_DOM_ITM_GRP_ROWNO ) )
         {
            AV22W_DATA_FLG = true ;
            if (true) break;
         }
      ...
      if ( ! AV22W_DATA_FLG )
      {
         AV10B716_SD2_DOM_MAP_I = (SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem)new SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem(remoteHandle, context);
         AV10B716_SD2_DOM_MAP_I.setgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Visit_no( AV21W_TBM37_VISIT_NO );
         AV10B716_SD2_DOM_MAP_I.setgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_itm_grp_oid( AV19W_TBM37_DOM_ITM_GRP_OID );
         AV10B716_SD2_DOM_MAP_I.setgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_itm_grp_rowno( AV20W_TBM37_DOM_ITM_GRP_ROWNO );
         AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_var().clear();
         AV40GXV2 = 1 ;
         while ( AV40GXV2 <= AV11B716_SD3_DOM_VAR_C.size() )
         {
            AV12B716_SD3_DOM_VAR_I = (SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem)((SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem)AV11B716_SD3_DOM_VAR_C.elementAt(-1+AV40GXV2));
            AV13B716_SD3_DOM_VAR_I2 = AV12B716_SD3_DOM_VAR_I.Clone();
            AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_var().add(AV13B716_SD3_DOM_VAR_I2, 0);
            AV40GXV2 = (int)(AV40GXV2+1) ;
         }
         AV9B716_SD2_DOM_MAP_C.add(AV10B716_SD2_DOM_MAP_I, 0);
      }
   }
   ...
   public void S128( )
   {
      /* 'SUB_SD3_UPD' Routine */
      AV41GXV3 = 1 ;
      while ( AV41GXV3 <= AV9B716_SD2_DOM_MAP_C.size() )
      {
         AV10B716_SD2_DOM_MAP_I = (SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem)((SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem)AV9B716_SD2_DOM_MAP_C.elementAt(-1+AV41GXV3));
         if ( ( AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Visit_no() == AV21W_TBM37_VISIT_NO ) && ( GXutil.strcmp(AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_itm_grp_oid(), AV19W_TBM37_DOM_ITM_GRP_OID) == 0 ) && ( AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_itm_grp_rowno() == AV20W_TBM37_DOM_ITM_GRP_ROWNO ) )
         {
            AV42GXV4 = 1 ;
            while ( AV42GXV4 <= AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_var().size() )
            {
               AV12B716_SD3_DOM_VAR_I = (SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem)((SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem)AV10B716_SD2_DOM_MAP_I.getgxTv_SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem_Dom_var().elementAt(-1+AV42GXV4));
               if ( GXutil.strcmp(AV12B716_SD3_DOM_VAR_I.getgxTv_SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem_Dom_var_nm(), AV25W_TBM37_DOM_VAR_NM) == 0 )
               {
                  AV12B716_SD3_DOM_VAR_I.setgxTv_SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem_Crf_item_grp_cd( AV24W_TBM37_CRF_ITEM_GRP_CD );
                  if (true) break;
               }
   ...
   {
      this.aP2[0] = b716_pc02_dom_map_get.this.AV9B716_SD2_DOM_MAP_C;
      this.aP3[0] = b716_pc02_dom_map_get.this.AV18W_SEQ_POS;
      CloseOpenCursors();
      exitApplication();
   }
   ...
   {
      AV9B716_SD2_DOM_MAP_C = new GxObjectCollection(SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem.class, "B716_SD2_DOM_MAP.B716_SD2_DOM_MAPItem", "tablet-EDC_GXXEV3U3", remoteHandle);
      AV11B716_SD3_DOM_VAR_C = new GxObjectCollection(SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem.class, "B716_SD3_DOM_VAR.B716_SD3_DOM_VARItem", "tablet-EDC_GXXEV3U3", remoteHandle);
      scmdbuf = "" ;
      ...
      AV12B716_SD3_DOM_VAR_I = new SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem(remoteHandle, context);
      AV19W_TBM37_DOM_ITM_GRP_OID = "" ;
      ...
      AV25W_TBM37_DOM_VAR_NM = "" ;
      AV24W_TBM37_CRF_ITEM_GRP_CD = "" ;
      ...
      AV10B716_SD2_DOM_MAP_I = new SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem(remoteHandle, context);
      AV13B716_SD3_DOM_VAR_I2 = new SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem(remoteHandle, context);
      AV43Pgmname = "" ;
      GXKey = "" ;
      GXEncryptionTmp = "" ;
      Gx_emsg = "" ;
      ...
      AV43Pgmname = "B716_PC02_DOM_MAP_GET" ;
      /* GeneXus formulas. */
      AV43Pgmname = "B716_PC02_DOM_MAP_GET" ;
      Gx_err = (short)(0) ;
   }
   ...
   private byte AV23W_TBM31_REPEAT_FLG ;
   private byte A947TBM44_CRF_EDA_NO ;
   private short AV18W_SEQ_POS ;
   private short AV16W_CNT ;
   private short AV26W_TBM37_CRF_ID ;
   private short AV20W_TBM37_DOM_ITM_GRP_ROWNO ;
   ...
   private int AV21W_TBM37_VISIT_NO ;
   ...
   private boolean AV28W_DATA_SET_FLG ;
   ...
   private boolean AV22W_DATA_FLG ;
   ...
   private String AV19W_TBM37_DOM_ITM_GRP_OID ;
   ...
   private String AV25W_TBM37_DOM_VAR_NM ;
   private String AV24W_TBM37_CRF_ITEM_GRP_CD ;
   ...
   private GxObjectCollection AV9B716_SD2_DOM_MAP_C ;
   private GxObjectCollection AV11B716_SD3_DOM_VAR_C ;
   private SdtB716_SD2_DOM_MAP_B716_SD2_DOM_MAPItem AV10B716_SD2_DOM_MAP_I ;
   private SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem AV12B716_SD3_DOM_VAR_I ;
   private SdtB716_SD3_DOM_VAR_B716_SD3_DOM_VARItem AV13B716_SD3_DOM_VAR_I2 ;
}
