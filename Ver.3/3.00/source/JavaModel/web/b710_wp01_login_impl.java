...
public final  class b710_wp01_login_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20207151325779");
   ...
   public void S142( )
   {
      ...
      AV23GXLvl161 = (byte)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV23GXLvl161", GXutil.str( AV23GXLvl161, 1, 0));
      /* Using cursor H001G3 */
   ...
   public void S152( )
   {
      ...
      while ( (pr_default.getStatus(2) != 101) )
      {
         ...
         A996TAM07_ADMIN_AUTH_FLG = H001G4_A996TAM07_ADMIN_AUTH_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A996TAM07_ADMIN_AUTH_FLG", A996TAM07_ADMIN_AUTH_FLG);
         n996TAM07_ADMIN_AUTH_FLG = H001G4_n996TAM07_ADMIN_AUTH_FLG[0] ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20207151325828");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b710_wp01_login.js", "?20207151325828");
   ...
   public void initialize( )
   {
      ...
      H001G4_A996TAM07_ADMIN_AUTH_FLG = new String[] {""} ;
      H001G4_n996TAM07_ADMIN_AUTH_FLG = new boolean[] {false} ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b710_wp01_login__default(),
         new Object[] {
            ...
            , new Object[] {
            H001G4_A55TAM07_USER_ID, H001G4_A205TAM07_USER_NM, H001G4_n205TAM07_USER_NM, H001G4_A313TAM07_USER_KANA_NM, H001G4_n313TAM07_USER_KANA_NM, H001G4_A56TAM07_AUTH_CD, H001G4_n56TAM07_AUTH_CD, H001G4_A996TAM07_ADMIN_AUTH_FLG, H001G4_n996TAM07_ADMIN_AUTH_FLG, H001G4_A333TAM07_SITE_ID,
            H001G4_n333TAM07_SITE_ID
            }
         }
      );
   ...
   private String[] H001G4_A996TAM07_ADMIN_AUTH_FLG ;
   private boolean[] H001G4_n996TAM07_ADMIN_AUTH_FLG ;
...
final  class b710_wp01_login__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H001G4", "SELECT `TAM07_USER_ID`, `TAM07_USER_NM`, `TAM07_USER_KANA_NM`, `TAM07_AUTH_CD`, `TAM07_ADMIN_AUTH_FLG`, `TAM07_SITE_ID` FROM `TAM07_USER` WHERE `TAM07_USER_ID` = ? ORDER BY `TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
