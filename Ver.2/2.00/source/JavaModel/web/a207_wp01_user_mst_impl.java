...
public final  class a207_wp01_user_mst_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2017731717343");
   ...
   public void start0V2( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         OldWebcomp2 = httpContext.cgiGet( "W0110") ;
         if ( (GXutil.strcmp("", WebComp_Webcomp2_Component)==0) && ! (GXutil.strcmp("", OldWebcomp2)==0) )
         {
            WebComp_Webcomp2 = WebUtils.getWebComponent(getClass(), "" + OldWebcomp2 + "_impl", remoteHandle, context);
            WebComp_Webcomp2_Component = OldWebcomp2 ;
            WebComp_Webcomp2.componentrestorestate("W0110", "");
         }
      }
      wbErr = false ;
      strup0V0( ) ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               else if ( GXutil.strcmp(sEvtType, "W") == 0 )
               {
                  ...
                  else if ( nCmpId == 110 )
                  {
                     ...
                     {
                        WebComp_Webcomp2.componentprocess("W0110", "", sEvt);
                     }
                     WebComp_Webcomp2_Component = OldWebcomp2 ;
                  }
               }
   ...
   public void strup0V0( )
   {
      ...
      AV43Pgmname = "A207_WP01_USER_MST" ;
      AV42Pgmdesc = "ユーザーマスタメンテナンス（入力）" ;
      Gx_err = (short)(0) ;
   ...
   public void e150V2( )
   {
      ...
      if ( GXutil.len( WebComp_Webcomp2_Component) != 0 )
      {
         WebComp_Webcomp2.componentprepare(new Object[] {"W0110",""});
   ...
   public void e170V2( )
   {
      ...
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_TAM07_USER", AV5BC_TAM07_USER);
      AV5BC_TAM07_USER.setgxTv_SdtTAM07_USER_Tam07_crt_prog_nm( AV43Pgmname );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_TAM07_USER", AV5BC_TAM07_USER);
      AV5BC_TAM07_USER.setgxTv_SdtTAM07_USER_Tam07_upd_user_id( AV20W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_user_id() );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_TAM07_USER", AV5BC_TAM07_USER);
      AV5BC_TAM07_USER.setgxTv_SdtTAM07_USER_Tam07_upd_prog_nm( AV43Pgmname );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_TAM07_USER", AV5BC_TAM07_USER);
      ...
      if ( new a402_pc02_btn_kengn_check(remoteHandle, context).executeUdp( "DLT", AV14H_KNGN_FLG, "") )
      {
         if ( GXutil.strcmp(AV15H_MODE, "1") == 0 )
         {
            ...
            while ( (pr_default.getStatus(2) != 101) )
            {
               ...
               GXt_char1 = AV27W_MSG ;
               GXv_char2[0] = GXt_char1 ;
               new a805_pc01_msg_get(remoteHandle, context).execute( "AE00038", "対象ユーザ", "試験参加スタッフに選択済みの", "削除", "", "", GXv_char2) ;
               a207_wp01_user_mst_impl.this.GXt_char1 = GXv_char2[0] ;
               AV27W_MSG = GXt_char1 ;
               httpContext.ajax_rsp_assign_attri("", false, "AV27W_MSG", AV27W_MSG);
               httpContext.GX_msglist.addItem(AV27W_MSG);
   ...
   public void S172( )
   {
      ...
      {
         AV46GXLvl368 = (byte)(0) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV46GXLvl368", GXutil.str( AV46GXLvl368, 1, 0));
         /* Using cursor H000V6 */
      ...
      {
         AV47GXLvl409 = (byte)(0) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV47GXLvl409", GXutil.str( AV47GXLvl409, 1, 0));
         /* Using cursor H000V7 */
         ...
         if ( AV47GXLvl409 == 0 )
         {
            GXt_char1 = AV27W_MSG ;
            GXv_char2[0] = GXt_char1 ;
            new a805_pc01_msg_get(remoteHandle, context).execute( "AE00042", "選択した施設ID", "", "", "", "", GXv_char2) ;
            a207_wp01_user_mst_impl.this.GXt_char1 = GXv_char2[0] ;
            AV27W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV27W_MSG", AV27W_MSG);
            httpContext.GX_msglist.addItem(AV27W_MSG);
      ...
      {
         AV48GXLvl427 = (byte)(0) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV48GXLvl427", GXutil.str( AV48GXLvl427, 1, 0));
         /* Using cursor H000V8 */
         ...
         if ( AV48GXLvl427 == 0 )
         {
            GXt_char1 = AV27W_MSG ;
            GXv_char2[0] = GXt_char1 ;
            new a805_pc01_msg_get(remoteHandle, context).execute( "AE00042", "選択した権限パターン区分", "", "", "", "", GXv_char2) ;
            a207_wp01_user_mst_impl.this.GXt_char1 = GXv_char2[0] ;
            AV27W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV27W_MSG", AV27W_MSG);
            httpContext.GX_msglist.addItem(AV27W_MSG);
      ...
      new a207_pc01_user_mst_chk(remoteHandle, context).execute( AV5BC_TAM07_USER, AV11D_TAM07_PWD, GXv_objcol_SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem3, GXv_objcol_SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem4) ;
      ...
      if ( AV21W_A_RESULT_MSG_SDT.size() > 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "AV26W_ERRFLG", AV26W_ERRFLG);
         AV49GXV12 = 1 ;
         httpContext.ajax_rsp_assign_attri("", false, "AV49GXV12", GXutil.ltrim( GXutil.str( AV49GXV12, 8, 0)));
         while ( AV49GXV12 <= AV21W_A_RESULT_MSG_SDT.size() )
         {
            AV22W_A_RESULT_MSG_SDT_ITEM = (SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem)((SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem)AV21W_A_RESULT_MSG_SDT.elementAt(-1+AV49GXV12));
   ...
   public void S202( )
   {
      ...
      while ( AV50GXV13 <= AV18W_A_CHK_RESULT_SDT.size() )
      {
         AV19W_A_CHK_RESULT_SDT_ITEM = (SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem)((SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem)AV18W_A_CHK_RESULT_SDT.elementAt(-1+AV50GXV13));
   ...
   public void S142( )
   {
      ...
      if ( ! (GXutil.strcmp("", AV16P_TAM07_USER_ID)==0) )
      {
         ...
         {
            AV51GXLvl552 = (byte)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV51GXLvl552", GXutil.str( AV51GXLvl552, 1, 0));
            /* Using cursor H000V9 */
            ...
            {
               AV52GXLvl567 = (byte)(0) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV52GXLvl567", GXutil.str( AV52GXLvl567, 1, 0));
   ...
   public void S182( )
   {
      ...
      AV53GXV14 = 1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV53GXV14", GXutil.ltrim( GXutil.str( AV53GXV14, 8, 0)));
      while ( AV53GXV14 <= AV7C_BCMSGS.size() )
      {
         AV6C_BCMSG = (SdtMessages_Message)((SdtMessages_Message)AV7C_BCMSGS.elementAt(-1+AV53GXV14));
   ...
   public void S122( )
   {
      ...
      AV5BC_TAM07_USER.setgxTv_SdtTAM07_USER_Tam07_crt_datetime( GXt_dtime6 );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_TAM07_USER", AV5BC_TAM07_USER);
      AV10D_TAM07_CRT_USER_NM = "" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10D_TAM07_CRT_USER_NM", AV10D_TAM07_CRT_USER_NM);
      ...
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_TAM07_USER", AV5BC_TAM07_USER);
      GXt_dtime6 = GXutil.resetTime( GXutil.nullDate() );
      AV5BC_TAM07_USER.setgxTv_SdtTAM07_USER_Tam07_upd_datetime( GXt_dtime6 );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_TAM07_USER", AV5BC_TAM07_USER);
      AV12D_TAM07_UPD_USER_NM = "" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12D_TAM07_UPD_USER_NM", AV12D_TAM07_UPD_USER_NM);
   ...
   public void S132( )
   {
      ...
      a207_wp01_user_mst_impl.this.AV14H_KNGN_FLG = GXv_char2[0] ;
      a207_wp01_user_mst_impl.this.AV25W_ERRCD = GXv_char7[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9C_TAM02_APP_ID", AV9C_TAM02_APP_ID);
      httpContext.ajax_rsp_assign_attri("", false, "AV14H_KNGN_FLG", AV14H_KNGN_FLG);
      httpContext.ajax_rsp_assign_attri("", false, "AV25W_ERRCD", AV25W_ERRCD);
      if ( GXutil.strcmp(AV25W_ERRCD, "0") != 0 )
   ...
   public void wb_table5_34_0V2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table6_98_0V2( true) ;
      }
      else
      {
         wb_table6_98_0V2( false) ;
      }
      return  ;
   }

   public void wb_table6_98_0V2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<td>") ;
         /* WebComponent */
         GxWebStd.gx_hidden_field( httpContext, "W0110"+"", GXutil.rtrim( WebComp_Webcomp2_Component));
         httpContext.writeText( "<div") ;
         GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void wb_table6_98_0V2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV13H_INIT_FLG), GXutil.rtrim( localUtil.format( AV13H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(105);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_init_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_A207_WP01_USER_MST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 106,'',false,'',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_mode_Internalname, GXutil.rtrim( AV15H_MODE), GXutil.rtrim( localUtil.format( AV15H_MODE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(106);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_mode_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A207_WP01_USER_MST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 107,'',false,'',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV14H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV14H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(107);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A207_WP01_USER_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table6_98_0V2e( true) ;
      }
      else
      {
         wb_table6_98_0V2e( false) ;
      }
   }
   ...
   public void wb_table7_40_0V2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltam07_user_nm_Internalname, GXutil.rtrim( AV5BC_TAM07_USER.getgxTv_SdtTAM07_USER_Tam07_user_nm()), GXutil.rtrim( localUtil.format( AV5BC_TAM07_USER.getgxTv_SdtTAM07_USER_Tam07_user_nm(), "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtltam07_user_nm_Jsonclick, 0, "AttributeImeOn", "background:"+WebUtils.getHTMLColor( edtavCtltam07_user_nm_Backcolor)+";", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A207_WP01_USER_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         ...
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( httpContext, dynavCtltam07_site_id, dynavCtltam07_site_id.getInternalname(), GXutil.rtrim( AV5BC_TAM07_USER.getgxTv_SdtTAM07_USER_Tam07_site_id()), 1, dynavCtltam07_site_id.getJsonclick(), 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, 1, 0, (short)(0), 270, "px", 0, "", "background:"+WebUtils.getHTMLColor( dynavCtltam07_site_id.getIBackground())+";", "AttributeImeOff", "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(64);\"", "", true, "HLP_A207_WP01_USER_MST.htm");
         ...
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( httpContext, dynavCtltam07_kngn_ptn_kbn, dynavCtltam07_kngn_ptn_kbn.getInternalname(), GXutil.rtrim( AV5BC_TAM07_USER.getgxTv_SdtTAM07_USER_Tam07_auth_cd()), 1, dynavCtltam07_kngn_ptn_kbn.getJsonclick(), 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, 1, 0, (short)(0), 270, "px", 0, "", "background:"+WebUtils.getHTMLColor( dynavCtltam07_kngn_ptn_kbn.getIBackground())+";", "AttributeImeOff", "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(67);\"", "", true, "HLP_A207_WP01_USER_MST.htm");
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_crt_user_nm_Internalname, GXutil.rtrim( AV10D_TAM07_CRT_USER_NM), GXutil.rtrim( localUtil.format( AV10D_TAM07_CRT_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(87);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_tam07_crt_user_nm_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtavD_tam07_crt_user_nm_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(1), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A207_WP01_USER_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavD_tam07_upd_user_nm_Internalname, GXutil.rtrim( AV12D_TAM07_UPD_USER_NM), GXutil.rtrim( localUtil.format( AV12D_TAM07_UPD_USER_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(90);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_tam07_upd_user_nm_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtavD_tam07_upd_user_nm_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(1), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A207_WP01_USER_MST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2017731717920");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a207_wp01_user_mst.js", "?2017731717922");
   ...
   private byte AV46GXLvl368 ;
   private byte AV47GXLvl409 ;
   private byte AV48GXLvl427 ;
   private byte AV51GXLvl552 ;
   private byte AV52GXLvl567 ;
