/*
       ...
       Generated on: July 3, 2017 17:15:3.58
...
public final  class tbt11_crf_history_impl extends GXWebPanel
{
   ...
   public void inittrn( )
   {
      ...
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxAggSel8"+"_"+"TBT11_CRT_USER_ID") == 0 )
      {
         ...
         gx8asatbt11_crt_user_id0Q56( Gx_mode) ;
         return  ;
      }
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxAggSel10"+"_"+"TBT11_UPD_USER_ID") == 0 )
      {
         ...
         gx10asatbt11_upd_user_id0Q56( Gx_mode) ;
         return  ;
      }
   ...
   public void wb_table4_34_0Q56( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT11_INPUT_END_FLG_Internalname, GXutil.rtrim( A675TBT11_INPUT_END_FLG), GXutil.rtrim( localUtil.format( A675TBT11_INPUT_END_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(114);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT11_INPUT_END_FLG_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT11_INPUT_END_FLG_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_TBT11_CRF_HISTORY.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT11_INPUT_END_DATETIME_Internalname, localUtil.format(A676TBT11_INPUT_END_DATETIME, "9999/99/99 99:99:99"), localUtil.format( A676TBT11_INPUT_END_DATETIME, "9999/99/99 99:99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'jap',false,0);"+";gx.evt.onblur(119);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT11_INPUT_END_DATETIME_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT11_INPUT_END_DATETIME_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_Y4MD_HMS", "right", "HLP_TBT11_CRF_HISTORY.htm");
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT11_INPUT_END_USER_ID_Internalname, GXutil.rtrim( A677TBT11_INPUT_END_USER_ID), GXutil.rtrim( localUtil.format( A677TBT11_INPUT_END_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(124);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT11_INPUT_END_USER_ID_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT11_INPUT_END_USER_ID_Enabled, 0, "text", "", 80, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_USER_ID", "left", "HLP_TBT11_CRF_HISTORY.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         GxWebStd.gx_html_textarea( httpContext, edtTBT11_UPD_RIYU_Internalname, GXutil.rtrim( A891TBT11_UPD_RIYU), "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(134);\"", (short)(0), 1, edtTBT11_UPD_RIYU_Enabled, 0, 80, "chr", 10, "row", StyleString, ClassString, "", "2000", -1, "", "", (byte)(-1), true, "", "HLP_TBT11_CRF_HISTORY.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT11_CRT_USER_ID_Internalname, GXutil.rtrim( A459TBT11_CRT_USER_ID), GXutil.rtrim( localUtil.format( A459TBT11_CRT_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(149);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT11_CRT_USER_ID_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT11_CRT_USER_ID_Enabled, 0, "text", "", 80, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_USER_ID", "left", "HLP_TBT11_CRF_HISTORY.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT11_CRT_PROG_NM_Internalname, GXutil.rtrim( A460TBT11_CRT_PROG_NM), GXutil.rtrim( localUtil.format( A460TBT11_CRT_PROG_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(154);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT11_CRT_PROG_NM_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT11_CRT_PROG_NM_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_PG_NM", "left", "HLP_TBT11_CRF_HISTORY.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT11_UPD_DATETIME_Internalname, localUtil.format(A461TBT11_UPD_DATETIME, "9999/99/99 99:99:99"), localUtil.format( A461TBT11_UPD_DATETIME, "9999/99/99 99:99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'jap',false,0);"+";gx.evt.onblur(159);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT11_UPD_DATETIME_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT11_UPD_DATETIME_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_Y4MD_HMS", "right", "HLP_TBT11_CRF_HISTORY.htm");
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT11_UPD_USER_ID_Internalname, GXutil.rtrim( A462TBT11_UPD_USER_ID), GXutil.rtrim( localUtil.format( A462TBT11_UPD_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(164);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT11_UPD_USER_ID_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT11_UPD_USER_ID_Enabled, 0, "text", "", 80, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_USER_ID", "left", "HLP_TBT11_CRF_HISTORY.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT11_UPD_PROG_NM_Internalname, GXutil.rtrim( A463TBT11_UPD_PROG_NM), GXutil.rtrim( localUtil.format( A463TBT11_UPD_PROG_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(169);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT11_UPD_PROG_NM_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT11_UPD_PROG_NM_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_PG_NM", "left", "HLP_TBT11_CRF_HISTORY.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT11_UPD_CNT_Internalname, GXutil.ltrim( localUtil.ntoc( A464TBT11_UPD_CNT, (byte)(10), (byte)(0), ".", "")), ((edtTBT11_UPD_CNT_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A464TBT11_UPD_CNT), "ZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A464TBT11_UPD_CNT), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(174);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT11_UPD_CNT_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT11_UPD_CNT_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_NO", "right", "HLP_TBT11_CRF_HISTORY.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2017731715722");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2017731715736");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tbt11_crf_history.js", "?2017731715737");
   ...
   public void gx8asatbt11_crt_user_id0Q56( String Gx_mode )
   {
      GXt_char1 = A459TBT11_CRT_USER_ID ;
      GXv_char2[0] = GXt_char1 ;
      new a403_pc01_get_login_user_id(remoteHandle, context).execute( GXv_char2) ;
   ...
   public void gx10asatbt11_upd_user_id0Q56( String Gx_mode )
   {
      GXt_char1 = A462TBT11_UPD_USER_ID ;
      GXv_char2[0] = GXt_char1 ;
      new a403_pc01_get_login_user_id(remoteHandle, context).execute( GXv_char2) ;
                                        ...
                                        String GX_Parm28 )
   {
      ...
      n674TBT11_APPROVAL_AUTH_CD = false ;
      A675TBT11_INPUT_END_FLG = GX_Parm21 ;
      n675TBT11_INPUT_END_FLG = false ;
      A676TBT11_INPUT_END_DATETIME = GX_Parm22 ;
      n676TBT11_INPUT_END_DATETIME = false ;
      A677TBT11_INPUT_END_USER_ID = GX_Parm23 ;
      n677TBT11_INPUT_END_USER_ID = false ;
      A678TBT11_INPUT_END_AUTH_CD = GX_Parm24 ;
      n678TBT11_INPUT_END_AUTH_CD = false ;
      A891TBT11_UPD_RIYU = GX_Parm25 ;
      n891TBT11_UPD_RIYU = false ;
      A457TBT11_DEL_FLG = GX_Parm26 ;
      n457TBT11_DEL_FLG = false ;
      A460TBT11_CRT_PROG_NM = GX_Parm27 ;
      n460TBT11_CRT_PROG_NM = false ;
      A463TBT11_UPD_PROG_NM = GX_Parm28 ;
      n463TBT11_UPD_PROG_NM = false ;
      httpContext.wbHandled = (byte)(1) ;
      afterkeyloadscreen( ) ;
      draw( ) ;
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new tbt11_crf_history__default(),
         new Object[] {
            ...
            T000Q2_n672TBT11_APPROVAL_DATETIME, T000Q2_A673TBT11_APPROVAL_USER_ID, T000Q2_n673TBT11_APPROVAL_USER_ID, T000Q2_A674TBT11_APPROVAL_AUTH_CD, T000Q2_n674TBT11_APPROVAL_AUTH_CD, T000Q2_A675TBT11_INPUT_END_FLG, T000Q2_n675TBT11_INPUT_END_FLG, T000Q2_A676TBT11_INPUT_END_DATETIME, T000Q2_n676TBT11_INPUT_END_DATETIME, T000Q2_A677TBT11_INPUT_END_USER_ID,
            T000Q2_n677TBT11_INPUT_END_USER_ID, T000Q2_A678TBT11_INPUT_END_AUTH_CD, T000Q2_n678TBT11_INPUT_END_AUTH_CD, T000Q2_A891TBT11_UPD_RIYU, T000Q2_n891TBT11_UPD_RIYU, T000Q2_A457TBT11_DEL_FLG, T000Q2_n457TBT11_DEL_FLG, T000Q2_A460TBT11_CRT_PROG_NM, T000Q2_n460TBT11_CRT_PROG_NM, T000Q2_A463TBT11_UPD_PROG_NM,
            T000Q2_n463TBT11_UPD_PROG_NM
            }
            , new Object[] {
            ...
            T000Q3_n672TBT11_APPROVAL_DATETIME, T000Q3_A673TBT11_APPROVAL_USER_ID, T000Q3_n673TBT11_APPROVAL_USER_ID, T000Q3_A674TBT11_APPROVAL_AUTH_CD, T000Q3_n674TBT11_APPROVAL_AUTH_CD, T000Q3_A675TBT11_INPUT_END_FLG, T000Q3_n675TBT11_INPUT_END_FLG, T000Q3_A676TBT11_INPUT_END_DATETIME, T000Q3_n676TBT11_INPUT_END_DATETIME, T000Q3_A677TBT11_INPUT_END_USER_ID,
            T000Q3_n677TBT11_INPUT_END_USER_ID, T000Q3_A678TBT11_INPUT_END_AUTH_CD, T000Q3_n678TBT11_INPUT_END_AUTH_CD, T000Q3_A891TBT11_UPD_RIYU, T000Q3_n891TBT11_UPD_RIYU, T000Q3_A457TBT11_DEL_FLG, T000Q3_n457TBT11_DEL_FLG, T000Q3_A460TBT11_CRT_PROG_NM, T000Q3_n460TBT11_CRT_PROG_NM, T000Q3_A463TBT11_UPD_PROG_NM,
            T000Q3_n463TBT11_UPD_PROG_NM
            }
            , new Object[] {
            ...
            T000Q4_n672TBT11_APPROVAL_DATETIME, T000Q4_A673TBT11_APPROVAL_USER_ID, T000Q4_n673TBT11_APPROVAL_USER_ID, T000Q4_A674TBT11_APPROVAL_AUTH_CD, T000Q4_n674TBT11_APPROVAL_AUTH_CD, T000Q4_A675TBT11_INPUT_END_FLG, T000Q4_n675TBT11_INPUT_END_FLG, T000Q4_A676TBT11_INPUT_END_DATETIME, T000Q4_n676TBT11_INPUT_END_DATETIME, T000Q4_A677TBT11_INPUT_END_USER_ID,
            T000Q4_n677TBT11_INPUT_END_USER_ID, T000Q4_A678TBT11_INPUT_END_AUTH_CD, T000Q4_n678TBT11_INPUT_END_AUTH_CD, T000Q4_A891TBT11_UPD_RIYU, T000Q4_n891TBT11_UPD_RIYU, T000Q4_A457TBT11_DEL_FLG, T000Q4_n457TBT11_DEL_FLG, T000Q4_A460TBT11_CRT_PROG_NM, T000Q4_n460TBT11_CRT_PROG_NM, T000Q4_A463TBT11_UPD_PROG_NM,
            T000Q4_n463TBT11_UPD_PROG_NM
            }
            , new Object[] {
