...
public final  class a103_wp01_system_menu_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317164466");
   ...
   private void e190F4( )
   {
      ...
      while ( (pr_default.getStatus(2) != 101) )
      {
         ...
         n276TAM03_KIDO_PG = H000F4_n276TAM03_KIDO_PG[0] ;
         /* Using cursor H000F5 */
         pr_default.execute(3, new Object[] {AV33W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn(), new Boolean(n5TAM02_APP_ID), A5TAM02_APP_ID});
   ...
   private void e170F7( )
   {
      ...
      while ( (pr_default.getStatus(4) != 101) )
      {
         ...
         n276TAM03_KIDO_PG = H000F6_n276TAM03_KIDO_PG[0] ;
         /* Using cursor H000F7 */
         pr_default.execute(5, new Object[] {AV33W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn(), new Boolean(n5TAM02_APP_ID), A5TAM02_APP_ID});
   ...
   private void e160F10( )
   {
      ...
      while ( (pr_default.getStatus(6) != 101) )
      {
         ...
         n276TAM03_KIDO_PG = H000F8_n276TAM03_KIDO_PG[0] ;
         /* Using cursor H000F9 */
         pr_default.execute(7, new Object[] {AV33W_A_LOGIN_SDT.getgxTv_SdtA_LOGIN_SDT_Tam07_kngn_ptn_kbn(), new Boolean(n5TAM02_APP_ID), A5TAM02_APP_ID});
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317164691");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a103_wp01_system_menu.js", "?20177317164691");
...
final  class a103_wp01_system_menu__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H000F5", "SELECT T1.`TAM03_APP_ID`, T2.`TAM04_DEL_FLG`, T1.`TAM05_KNGN_FLG`, T1.`TAM04_AUTH_CD` FROM (`TAM05_APPLI_KNGN` T1 INNER JOIN `TAM04_KNGN` T2 ON T2.`TAM04_AUTH_CD` = T1.`TAM04_AUTH_CD`) WHERE (T1.`TAM04_AUTH_CD` = ? and T1.`TAM03_APP_ID` = ?) AND (T1.`TAM05_KNGN_FLG` IN ('1','2')) AND (T2.`TAM04_DEL_FLG` = '0') ORDER BY T1.`TAM04_AUTH_CD`, T1.`TAM03_APP_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ...
         ,new ForEachCursor("H000F7", "SELECT T1.`TAM03_APP_ID`, T2.`TAM04_DEL_FLG`, T1.`TAM05_KNGN_FLG`, T1.`TAM04_AUTH_CD` FROM (`TAM05_APPLI_KNGN` T1 INNER JOIN `TAM04_KNGN` T2 ON T2.`TAM04_AUTH_CD` = T1.`TAM04_AUTH_CD`) WHERE (T1.`TAM04_AUTH_CD` = ? and T1.`TAM03_APP_ID` = ?) AND (T1.`TAM05_KNGN_FLG` IN ('1','2')) AND (T2.`TAM04_DEL_FLG` = '0') ORDER BY T1.`TAM04_AUTH_CD`, T1.`TAM03_APP_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ...
         ,new ForEachCursor("H000F9", "SELECT T1.`TAM03_APP_ID`, T2.`TAM04_DEL_FLG`, T1.`TAM05_KNGN_FLG`, T1.`TAM04_AUTH_CD` FROM (`TAM05_APPLI_KNGN` T1 INNER JOIN `TAM04_KNGN` T2 ON T2.`TAM04_AUTH_CD` = T1.`TAM04_AUTH_CD`) WHERE (T1.`TAM04_AUTH_CD` = ? and T1.`TAM03_APP_ID` = ?) AND (T1.`TAM05_KNGN_FLG` IN ('1','2')) AND (T2.`TAM04_DEL_FLG` = '0') ORDER BY T1.`TAM04_AUTH_CD`, T1.`TAM03_APP_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
