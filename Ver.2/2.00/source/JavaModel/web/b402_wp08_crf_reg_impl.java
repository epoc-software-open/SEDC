/*
       ...
       Generated on: July 3, 2017 17:17:53.61
...
public final  class b402_wp08_crf_reg_impl extends GXWebPanel
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            nRC_GXsfl_111 = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            nGXsfl_111_idx = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            sGXsfl_111_idx = httpContext.GetNextPar( ) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            gxnrgrid1_newrow( nRC_GXsfl_111, nGXsfl_111_idx, sGXsfl_111_idx) ;
            return  ;
         }
         else
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317175380");
   ...
   public void renderHtmlCloseForm1B2( )
   {
      ...
      GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_111", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_111, (byte)(4), (byte)(0), ".", "")));
      GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV59Pgmname));
   ...
   public void wb_table1_2_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_160_1B2( true) ;
      }
      else
      {
         wb_table2_160_1B2( false) ;
      }
      return  ;
   }

   public void wb_table2_160_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
   ...
   public void start1B2( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         OldWebcomp2 = httpContext.cgiGet( "W0158") ;
         if ( (GXutil.strcmp("", WebComp_Webcomp2_Component)==0) && ! (GXutil.strcmp("", OldWebcomp2)==0) )
         {
            WebComp_Webcomp2 = WebUtils.getWebComponent(getClass(), "" + OldWebcomp2 + "_impl", remoteHandle, context);
            WebComp_Webcomp2_Component = OldWebcomp2 ;
            WebComp_Webcomp2.componentrestorestate("W0158", "");
         }
      }
      wbErr = false ;
      strup1B0( ) ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "E") == 0 )
               {
                  ...
                  else
                  {
                     ...
                     {
                        nGXsfl_111_idx = (short)(GXutil.lval( sEvtType)) ;
                        sGXsfl_111_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_111_idx, 4, 0)), (short)(4), "0") ;
                        subsflControlProps_1112( ) ;
                        AV51GXV11 = nGXsfl_111_idx ;
                        if ( ( AV34SD_B402_SD07_CRF_VISIT_C.size() >= AV51GXV11 ) && ( AV51GXV11 > 0 ) )
                        {
                           AV34SD_B402_SD07_CRF_VISIT_C.currentItem( ((SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem)AV34SD_B402_SD07_CRF_VISIT_C.elementAt(-1+AV51GXV11)) );
                           ((SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem)AV34SD_B402_SD07_CRF_VISIT_C.elementAt(-1+AV51GXV11)).setgxTv_SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem_Tbm44_crf_eda_no( (byte)(localUtil.ctol( httpContext.cgiGet( edtavCtltbm44_crf_eda_no_Internalname), ".", ",")) );
                           ((SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem)AV34SD_B402_SD07_CRF_VISIT_C.elementAt(-1+AV51GXV11)).setgxTv_SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem_Tbm44_visit_no( (int)(localUtil.ctol( httpContext.cgiGet( edtavCtltbm44_visit_no_Internalname), ".", ",")) );
                        }
                        OldWebcomp1 = httpContext.cgiGet( "W0009") ;
                        if ( (GXutil.strcmp("", WebComp_Webcomp1_Component)==0) && ! (GXutil.strcmp("", OldWebcomp1)==0) )
                        {
               ...
               else if ( GXutil.strcmp(sEvtType, "W") == 0 )
               {
                  ...
                  else if ( nCmpId == 158 )
                  {
                     ...
                     {
                        WebComp_Webcomp2.componentprocess("W0158", "", sEvt);
                     }
                     WebComp_Webcomp2_Component = OldWebcomp2 ;
                  }
               }
   ...
   public void gxnrgrid1_newrow( short nRC_GXsfl_111 ,
                                 short nGXsfl_111_idx ,
                                 String sGXsfl_111_idx )
   {
      ...
      {
         sendrow_1112( ) ;
         nGXsfl_111_idx = (short)(((subGrid1_Islastpage==1)&&(nGXsfl_111_idx+1>subgrid1_recordsperpage( )) ? 1 : nGXsfl_111_idx+1)) ;
         sGXsfl_111_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_111_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_1112( ) ;
      }
   ...
   public void rf1B2( )
   {
      ...
      wbStart = (short)(111) ;
      nGXsfl_111_idx = (short)(1) ;
      sGXsfl_111_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_111_idx, 4, 0)), (short)(4), "0") ;
      subsflControlProps_1112( ) ;
      nGXsfl_111_Refreshing = (short)(1) ;
      /* Execute user event: e191B2 */
      e191B2 ();
   ...
   public void strup1B0( )
   {
      ...
      AV59Pgmname = "B402_WP08_CRF_REG" ;
      AV58Pgmdesc = "試験登録（CRF登録）" ;
      Gx_err = (short)(0) ;
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         /* Read saved values. */
         nRC_GXsfl_111 = (short)(localUtil.ctol( httpContext.cgiGet( "nRC_GXsfl_111"), ".", ",")) ;
         ...
         nRC_GXsfl_111 = (short)(localUtil.ctol( httpContext.cgiGet( "nRC_GXsfl_111"), ".", ",")) ;
         nGXsfl_111_fel_idx = (short)(0) ;
         while ( nGXsfl_111_fel_idx < nRC_GXsfl_111 )
         {
            nGXsfl_111_fel_idx = (short)(((subGrid1_Islastpage==1)&&(nGXsfl_111_fel_idx+1>subgrid1_recordsperpage( )) ? 1 : nGXsfl_111_fel_idx+1)) ;
            sGXsfl_111_fel_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_111_fel_idx, 4, 0)), (short)(4), "0") ;
            subsflControlProps_fel_1112( ) ;
            AV51GXV11 = nGXsfl_111_fel_idx ;
            AV51GXV11 = nGXsfl_111_fel_idx ;
            if ( ( AV34SD_B402_SD07_CRF_VISIT_C.size() >= AV51GXV11 ) && ( AV51GXV11 > 0 ) )
            {
               AV34SD_B402_SD07_CRF_VISIT_C.currentItem( ((SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem)AV34SD_B402_SD07_CRF_VISIT_C.elementAt(-1+AV51GXV11)) );
   ...
   public void e181B2( )
   {
      ...
      if ( GXutil.len( WebComp_Webcomp2_Component) != 0 )
      {
         WebComp_Webcomp2.componentprepare(new Object[] {"W0158",""});
   ...
   public void e151B2( )
   {
      ...
      if ( AV29W_REG_ENABEL )
      {
         ...
         AV5BC_CRF.setgxTv_SdtTBM31_CRF_Tbm31_crt_prog_nm( AV59Pgmname );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_CRF", AV5BC_CRF);
         AV5BC_CRF.setgxTv_SdtTBM31_CRF_Tbm31_upd_prog_nm( AV59Pgmname );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV5BC_CRF", AV5BC_CRF);
         AV5BC_CRF.Save();
         if ( AV5BC_CRF.Success() )
         {
            AV60GXV18 = 1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV60GXV18", GXutil.ltrim( GXutil.str( AV60GXV18, 8, 0)));
            while ( AV60GXV18 <= AV34SD_B402_SD07_CRF_VISIT_C.size() )
            {
               AV35SD_B402_SD07_CRF_VISIT_I = (SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem)((SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem)AV34SD_B402_SD07_CRF_VISIT_C.elementAt(-1+AV60GXV18));
               ...
               httpContext.ajax_rsp_assign_sdt_attri("", false, "AV33BC_TBM44", AV33BC_TBM44);
               AV33BC_TBM44.setgxTv_SdtTBM44_CRF_VISIT_Tbm44_crt_prog_nm( AV59Pgmname );
               httpContext.ajax_rsp_assign_sdt_attri("", false, "AV33BC_TBM44", AV33BC_TBM44);
               AV33BC_TBM44.setgxTv_SdtTBM44_CRF_VISIT_Tbm44_upd_prog_nm( AV59Pgmname );
               httpContext.ajax_rsp_assign_sdt_attri("", false, "AV33BC_TBM44", AV33BC_TBM44);
               AV33BC_TBM44.Save();
   ...
   public void S182( )
   {
      ...
      if ( AV18W_A_RESULT_MSG_SDT.size() > 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "AV27W_ERRFLG", AV27W_ERRFLG);
         AV63GXV20 = 1 ;
         httpContext.ajax_rsp_assign_attri("", false, "AV63GXV20", GXutil.ltrim( GXutil.str( AV63GXV20, 8, 0)));
         while ( AV63GXV20 <= AV18W_A_RESULT_MSG_SDT.size() )
         {
            AV19W_A_RESULT_MSG_SDT_ITEM = (SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem)((SdtA_RESULT_MSG_SDT_A_RESULT_MSG_SDTItem)AV18W_A_RESULT_MSG_SDT.elementAt(-1+AV63GXV20));
   ...
   public void S202( )
   {
      /* 'SUB_ERRDISP' Routine */
      AV64GXV21 = 1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV64GXV21", GXutil.ltrim( GXutil.str( AV64GXV21, 8, 0)));
      while ( AV64GXV21 <= AV15W_A_CHK_RESULT_SDT.size() )
      {
         AV16W_A_CHK_RESULT_SDT_ITEM = (SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem)((SdtA_CHK_RESULT_SDT_A_CHK_RESULT_SDTItem)AV15W_A_CHK_RESULT_SDT.elementAt(-1+AV64GXV21));
         /* Execute user subroutine: S212 */
         S212 ();
         if (returnInSub) return;
         AV64GXV21 = (int)(AV64GXV21+1) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV64GXV21", GXutil.ltrim( GXutil.str( AV64GXV21, 8, 0)));
      }
   }
   ...
   public void S142( )
   {
      ...
      if ( ! (0==AV14P_STUDY_ID) && ! (GXutil.strcmp("", AV13P_CRF_ID)==0) )
      {
         ...
         {
            AV65GXLvl483 = (byte)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV65GXLvl483", GXutil.str( AV65GXLvl483, 1, 0));
            /* Using cursor H001B3 */
            ...
            {
               AV66GXLvl498 = (byte)(0) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV66GXLvl498", GXutil.str( AV66GXLvl498, 1, 0));
               /* Using cursor H001B4 */
   ...
   public void S172( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV14P_STUDY_ID", GXutil.ltrim( GXutil.str( AV14P_STUDY_ID, 10, 0)));
      GXt_boolean8 = AV29W_REG_ENABEL ;
      GXv_boolean9[0] = GXt_boolean8 ;
      new a402_pc02_btn_kengn_check(remoteHandle, context).execute( "REG", AV11H_KNGN_FLG, "", GXv_boolean9) ;
      b402_wp08_crf_reg_impl.this.GXt_boolean8 = GXv_boolean9[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11H_KNGN_FLG", AV11H_KNGN_FLG);
      AV29W_REG_ENABEL = (GXt_boolean6 ? false : GXt_boolean8) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV29W_REG_ENABEL", AV29W_REG_ENABEL);
      GXt_boolean8 = AV24W_DLT_ENABEL ;
      GXv_boolean9[0] = GXt_boolean8 ;
      new b402_pc22_is_study_run(remoteHandle, context).execute( AV14P_STUDY_ID, GXv_boolean9) ;
      b402_wp08_crf_reg_impl.this.GXt_boolean8 = GXv_boolean9[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14P_STUDY_ID", GXutil.ltrim( GXutil.str( AV14P_STUDY_ID, 10, 0)));
      GXt_boolean6 = AV24W_DLT_ENABEL ;
      GXv_boolean7[0] = GXt_boolean6 ;
      new a402_pc02_btn_kengn_check(remoteHandle, context).execute( "DLT", AV11H_KNGN_FLG, "", GXv_boolean7) ;
      b402_wp08_crf_reg_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11H_KNGN_FLG", AV11H_KNGN_FLG);
      AV24W_DLT_ENABEL = (GXt_boolean8 ? false : GXt_boolean6) ;
   ...
   private void e201B2( )
   {
      /* Grid1_Load Routine */
      AV51GXV11 = (short)(1) ;
      while ( AV51GXV11 <= AV34SD_B402_SD07_CRF_VISIT_C.size() )
      {
         AV34SD_B402_SD07_CRF_VISIT_C.currentItem( ((SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem)AV34SD_B402_SD07_CRF_VISIT_C.elementAt(-1+AV51GXV11)) );
         ...
         sendrow_1112( ) ;
         AV51GXV11 = (short)(AV51GXV11+1) ;
      }
   }

   public void wb_table2_160_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 167,'',false,'" + sGXsfl_111_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV10H_INIT_FLG), GXutil.rtrim( localUtil.format( AV10H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(167);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_init_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_B402_WP08_CRF_REG.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 168,'',false,'" + sGXsfl_111_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_mode_Internalname, GXutil.rtrim( AV12H_MODE), GXutil.rtrim( localUtil.format( AV12H_MODE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(168);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_mode_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_B402_WP08_CRF_REG.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 169,'',false,'" + sGXsfl_111_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV11H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV11H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(169);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_B402_WP08_CRF_REG.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_160_1B2e( true) ;
      }
      else
      {
         wb_table2_160_1B2e( false) ;
      }
   }
   ...
   public void wb_table5_24_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* WebComponent */
         GxWebStd.gx_hidden_field( httpContext, "W0158"+"", GXutil.rtrim( WebComp_Webcomp2_Component));
         httpContext.writeText( "<div") ;
         GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void wb_table6_30_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table7_77_1B2( true) ;
      }
      else
      {
         wb_table7_77_1B2( false) ;
      }
      return  ;
   }

   public void wb_table7_77_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table8_94_1B2( true) ;
      }
      else
      {
         wb_table8_94_1B2( false) ;
      }
      return  ;
   }

   public void wb_table8_94_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table9_126_1B2( true) ;
      }
      else
      {
         wb_table9_126_1B2( false) ;
      }
      return  ;
   }

   public void wb_table9_126_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table9_126_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Multiple line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 142,'',false,'" + sGXsfl_111_idx + "',0)\"" ;
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_html_textarea( httpContext, edtavD_crt_user_nm_Internalname, GXutil.rtrim( AV8D_CRT_USER_NM), "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(142);\"", (short)(1), 1, edtavD_crt_user_nm_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "200", -1, "", "", (byte)(-1), true, "", "HLP_B402_WP08_CRF_REG.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         /* Text block */
         ...
         httpContext.writeText( "<td>") ;
         /* Multiple line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 146,'',false,'" + sGXsfl_111_idx + "',0)\"" ;
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         ClassString = "ReadonlyAttribute" ;
         StyleString = "" ;
         GxWebStd.gx_html_textarea( httpContext, edtavD_upd_user_nm_Internalname, GXutil.rtrim( AV9D_UPD_USER_NM), "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(146);\"", (short)(1), 1, edtavD_upd_user_nm_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "200", -1, "", "", (byte)(-1), true, "", "HLP_B402_WP08_CRF_REG.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table9_126_1B2e( true) ;
      }
      else
      {
         wb_table9_126_1B2e( false) ;
      }
   }

   public void wb_table8_94_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table10_99_1B2( true) ;
      }
      else
      {
         wb_table10_99_1B2( false) ;
      }
      return  ;
   }

   public void wb_table10_99_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         {
            httpContext.writeText( "<div id=\""+"Grid1Container"+"DivS\" gxgridid=\"111\">") ;
            sStyleString = "" ;
      ...
      {
         wbEnd = (short)(0) ;
         nRC_GXsfl_111 = (short)(nGXsfl_111_idx-1) ;
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "</table>") ;
            httpContext.writeText( "</div>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table8_94_1B2e( true) ;
      }
      else
      {
         wb_table8_94_1B2e( false) ;
      }
   }

   public void wb_table10_99_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table10_99_1B2e( true) ;
      }
      else
      {
         wb_table10_99_1B2e( false) ;
      }
   }

   public void wb_table7_77_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table11_88_1B2( true) ;
      }
      else
      {
         wb_table11_88_1B2( false) ;
      }
      return  ;
   }

   public void wb_table11_88_1B2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table7_77_1B2e( true) ;
      }
      else
      {
         wb_table7_77_1B2e( false) ;
      }
   }

   public void wb_table11_88_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table11_88_1B2e( true) ;
      }
      else
      {
         wb_table11_88_1B2e( false) ;
      }
   }
   ...
   public void wb_table6_30_1B2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"FormTitle\" colspan=\"6\" >") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 52,'',false,'" + sGXsfl_111_idx + "',0)\"" ;
         ...
         StyleString = "" ;
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 66,'',false,'" + sGXsfl_111_idx + "',0)\"" ;
         ...
         /* Multiple line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 71,'',false,'" + sGXsfl_111_idx + "',0)\"" ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2017731718291");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b402_wp08_crf_reg.js", "?2017731718291");
      /* End function include_jscripts */
   }

   public void subsflControlProps_1112( )
   {
      edtavCtltbm44_crf_eda_no_Internalname = "CTLTBM44_CRF_EDA_NO_"+sGXsfl_111_idx ;
      edtavCtltbm44_visit_no_Internalname = "CTLTBM44_VISIT_NO_"+sGXsfl_111_idx ;
   }

   public void subsflControlProps_fel_1112( )
   {
      edtavCtltbm44_crf_eda_no_Internalname = "CTLTBM44_CRF_EDA_NO_"+sGXsfl_111_fel_idx ;
      edtavCtltbm44_visit_no_Internalname = "CTLTBM44_VISIT_NO_"+sGXsfl_111_fel_idx ;
   }
   ...
   public void sendrow_1112( )
   {
      ...
      else if ( subGrid1_Backcolorstyle == 3 )
      {
         ...
         subGrid1_Backstyle = (byte)(1) ;
         if ( ((int)(((nGXsfl_111_idx-1)/ (double) (0)) % (2))) == 0 )
         {
            subGrid1_Backcolor = (int)(0xFFFFFF) ;
            if ( GXutil.strcmp(subGrid1_Class, "") != 0 )
            {
      ...
      /* Table start */
      Grid1Row.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {tblTable9_Internalname+"_"+sGXsfl_111_idx,new Integer(1),"TableGridLM-1","","","","","","",new Integer(0),new Integer(1),"",new Integer(67),"","px","px"});
      ...
      Grid1Row.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"",""+" style=\"height:28px\""});
      /* Single line edit */
      TempTags = " " + ((edtavCtltbm44_visit_no_Enabled!=0)&&(edtavCtltbm44_visit_no_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 120,'',false,'"+sGXsfl_111_idx+"',111)\"" : " ") ;
      ROClassString = "AttributeNum" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavCtltbm44_visit_no_Internalname,GXutil.ltrim( localUtil.ntoc( ((SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem)AV34SD_B402_SD07_CRF_VISIT_C.elementAt(-1+AV51GXV11)).getgxTv_SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem_Tbm44_visit_no(), (byte)(6), (byte)(0), ".", "")),GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(((SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem)AV34SD_B402_SD07_CRF_VISIT_C.elementAt(-1+AV51GXV11)).getgxTv_SdtB402_SD07_CRF_VISIT_B402_SD07_CRF_VISITItem_Tbm44_visit_no()), "ZZZZZ9")),TempTags+((edtavCtltbm44_visit_no_Enabled!=0)&&(edtavCtltbm44_visit_no_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavCtltbm44_visit_no_Enabled!=0)&&(edtavCtltbm44_visit_no_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(120);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavCtltbm44_visit_no_Jsonclick,new Integer(0),"AttributeNum","",ROClassString,"",new Integer(1),new Integer(1),new Integer(0),"text","",new Integer(6),"chr",new Integer(1),"row",new Integer(6),new Integer(0),new Integer(0),new Integer(111),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right"});
      if ( Grid1Container.GetWrapped() == 1 )
      {
         Grid1Container.CloseTag("cell");
      }
   ...
   private byte AV65GXLvl483 ;
   private byte AV66GXLvl498 ;
   ...
   private short AV51GXV11 ;
   private short nCmpId ;
   private short subGrid1_Borderwidth ;
   private short nGXsfl_111_Refreshing=0 ;
   private short Gx_err ;
   private short nGXsfl_111_fel_idx=1 ;
