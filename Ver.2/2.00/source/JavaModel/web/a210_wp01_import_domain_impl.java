...
public final  class a210_wp01_import_domain_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317202362");
   ...
   public void e111V2( )
   {
      ...
      if ( new a402_pc02_btn_kengn_check(remoteHandle, context).executeUdp( "REG", AV11H_KNGN_FLG, "") )
      {
         ...
         else
         {
            GXt_char1 = AV24W_MSG ;
            GXv_char2[0] = GXt_char1 ;
            new a805_pc02_msg_get(remoteHandle, context).execute( "AG00026", "CSVファイル", "アップロード", "", "", "", GXv_char2) ;
            a210_wp01_import_domain_impl.this.GXt_char1 = GXv_char2[0] ;
            AV24W_MSG = GXt_char1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV24W_MSG", AV24W_MSG);
   ...
   public void wb_table7_35_1V2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock1_Internalname, "【注意事項】", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "color:#0000FF;", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_A210_WP01_IMPORT_DOMAIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock7_Internalname, "取込ファイルは「ドメインマスタメンテナンス（一覧）画面のCSV出力で出力されるCSVフォーマット」に対応しています。", "", "", lblTextblock7_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "color:#0000FF;", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_A210_WP01_IMPORT_DOMAIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock2_Internalname, "CSVデータは全件取込（マスタ全データ削除→CSV全データマスタ登録）でドメインマスタに反映されます。", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "color:#0000FF;", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_A210_WP01_IMPORT_DOMAIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void wb_table6_23_1V2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock16_Internalname, "CSVファイル", "", "", lblTextblock16_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockItemTitle", 0, "", 1, 1, (short)(0), "HLP_A210_WP01_IMPORT_DOMAIN.htm");
         httpContext.writeText( "</td>") ;
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock31_Internalname, "ファイル文字コード", "", "", lblTextblock31_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockItemTitle", 0, "", 1, 1, (short)(0), "HLP_A210_WP01_IMPORT_DOMAIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
   ...
   public void wb_table4_12_1V2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_upload_Internalname, "アップロード（F3）", "", "", lblTxt_btn_upload_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_UPLOAD\\'."+"'", "", "TextBlockBtnList120", 5, "", 1, 1, (short)(0), "HLP_A210_WP01_IMPORT_DOMAIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_can_Internalname, "戻る（F11）", "", "", lblTxt_btn_can_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_CAN\\'."+"'", "", "TextBlockBtnList100", 5, "", 1, 1, (short)(0), "HLP_A210_WP01_IMPORT_DOMAIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317202431");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a210_wp01_import_domain.js", "?20177317202431");
