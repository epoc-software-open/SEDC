/*
       ...
       Generated on: July 3, 2017 17:14:10.66
...
public final  class b603_pc01_import_usrelist extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         A55TAM07_USER_ID = P003L2_A55TAM07_USER_ID[0] ;
         AV9BC_USER.Load(A55TAM07_USER_ID);
         if ( AV9BC_USER.Fail() )
         {
   ...
   public void S111( )
   {
      ...
      {
         A325TAM08_DEL_FLG = P003L3_A325TAM08_DEL_FLG[0] ;
         n325TAM08_DEL_FLG = P003L3_n325TAM08_DEL_FLG[0] ;
         A57TAM08_SITE_ID = P003L3_A57TAM08_SITE_ID[0] ;
         AV26GXLvl86 = (byte)(1) ;
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      P003L2_A55TAM07_USER_ID = new String[] {""} ;
      A55TAM07_USER_ID = "" ;
      ...
      AV16W_SITE_ID = "" ;
      GXv_int5 = new byte [1] ;
      P003L3_A325TAM08_DEL_FLG = new String[] {""} ;
      P003L3_n325TAM08_DEL_FLG = new boolean[] {false} ;
      P003L3_A57TAM08_SITE_ID = new String[] {""} ;
      A325TAM08_DEL_FLG = "" ;
      A57TAM08_SITE_ID = "" ;
      GXt_char4 = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b603_pc01_import_usrelist__default(),
         new Object[] {
             new Object[] {
            P003L2_A55TAM07_USER_ID
            }
            , new Object[] {
            P003L3_A325TAM08_DEL_FLG, P003L3_n325TAM08_DEL_FLG, P003L3_A57TAM08_SITE_ID
            }
         }
      );
   ...
   private String[] P003L2_A55TAM07_USER_ID ;
   private String[] P003L3_A325TAM08_DEL_FLG ;
   private boolean[] P003L3_n325TAM08_DEL_FLG ;
   private String[] P003L3_A57TAM08_SITE_ID ;
...
final  class b603_pc01_import_usrelist__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("P003L2", "SELECT `TAM07_USER_ID` FROM `TAM07_USER` ORDER BY `TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("P003L3", "SELECT `TAM08_DEL_FLG`, `TAM08_SITE_ID` FROM `TAM08_SITE` WHERE (`TAM08_SITE_ID` = ?) AND (`TAM08_DEL_FLG` = '0') ORDER BY `TAM08_SITE_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
