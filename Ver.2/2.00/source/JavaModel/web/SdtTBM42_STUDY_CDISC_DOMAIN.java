/*
               File: SdtTBM42_STUDY_CDISC_DOMAIN
        Description: 試験別CDISCドメインマスタ
             Author: GeneXus Java Generator version 10_3_3-92797
       Generated on: July 3, 2017 17:16:37.57
...
public final  class SdtTBM42_STUDY_CDISC_DOMAIN extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
   ...
   public void Load( long AV203TBM42_STUDY_ID ,
                     String AV204TBM42_DOM_CD )
   {
      IGxSilentTrn obj ;
      obj = getTransaction() ;
      obj.LoadKey(new Object[] {new Long(AV203TBM42_STUDY_ID),AV204TBM42_DOM_CD});
   }

   public Object[][] GetBCKey( )
   {
      return (Object[][])(new Object[][]{new Object[]{"TBM42_STUDY_ID", long.class}, new Object[]{"TBM42_DOM_CD", String.class}}) ;
   }
   ...
   public com.genexus.util.GXProperties getMetadata( )
   {
      ...
      metadata.set("Name", "TBM42_STUDY_CDISC_DOMAIN");
      metadata.set("BT", "TBM42_STUDY_CDISC_DOMAIN");
      metadata.set("PK", "[ \"TBM42_STUDY_ID\",\"TBM42_DOM_CD\" ]");
   ...
   {
      AddObjectProperty("TBM42_STUDY_ID", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_study_id, false);
      AddObjectProperty("TBM42_DOM_CD", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_cd, false);
      AddObjectProperty("TBM42_DOM_ENM", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_enm, false);
      AddObjectProperty("TBM42_DOM_JNM", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_jnm, false);
      AddObjectProperty("TBM42_DOM_GRP_NM", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_grp_nm, false);
      AddObjectProperty("TBM42_NOTE", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_note, false);
      AddObjectProperty("TBM42_ORDER", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_order, false);
      AddObjectProperty("TBM42_DEL_FLG", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_del_flg, false);
      datetime_STZ = gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_datetime ;
      sDateCnv = "" ;
      ...
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM42_CRT_DATETIME", sDateCnv, false);
      AddObjectProperty("TBM42_CRT_USER_ID", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_user_id, false);
      AddObjectProperty("TBM42_CRT_PROG_NM", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_prog_nm, false);
      datetime_STZ = gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_datetime ;
      sDateCnv = "" ;
      sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
      sDateCnv = sDateCnv + "-" ;
      ...
      sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
      sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
      AddObjectProperty("TBM42_UPD_DATETIME", sDateCnv, false);
      AddObjectProperty("TBM42_UPD_USER_ID", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_user_id, false);
      AddObjectProperty("TBM42_UPD_PROG_NM", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_prog_nm, false);
      AddObjectProperty("TBM42_UPD_CNT", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_cnt, false);
      if ( includeState )
      {
         AddObjectProperty("Mode", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Mode, false);
         AddObjectProperty("Initialized", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Initialized, false);
         AddObjectProperty("TBM42_STUDY_ID_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_study_id_Z, false);
         AddObjectProperty("TBM42_DOM_CD_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_cd_Z, false);
         AddObjectProperty("TBM42_DOM_ENM_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_enm_Z, false);
         AddObjectProperty("TBM42_DOM_JNM_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_jnm_Z, false);
         AddObjectProperty("TBM42_DOM_GRP_NM_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_grp_nm_Z, false);
         AddObjectProperty("TBM42_NOTE_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_note_Z, false);
         AddObjectProperty("TBM42_ORDER_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_order_Z, false);
         AddObjectProperty("TBM42_DEL_FLG_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_del_flg_Z, false);
         datetime_STZ = gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBM42_CRT_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBM42_CRT_USER_ID_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_user_id_Z, false);
         AddObjectProperty("TBM42_CRT_PROG_NM_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_prog_nm_Z, false);
         datetime_STZ = gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_datetime_Z ;
         sDateCnv = "" ;
         sNumToPad = GXutil.trim( GXutil.str( GXutil.year( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "0000", 1, 4-GXutil.len( sNumToPad)) + sNumToPad ;
         sDateCnv = sDateCnv + "-" ;
         ...
         sNumToPad = GXutil.trim( GXutil.str( GXutil.second( datetime_STZ), 10, 0)) ;
         sDateCnv = sDateCnv + GXutil.substring( "00", 1, 2-GXutil.len( sNumToPad)) + sNumToPad ;
         AddObjectProperty("TBM42_UPD_DATETIME_Z", sDateCnv, false);
         AddObjectProperty("TBM42_UPD_USER_ID_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_user_id_Z, false);
         AddObjectProperty("TBM42_UPD_PROG_NM_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_prog_nm_Z, false);
         AddObjectProperty("TBM42_UPD_CNT_Z", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_cnt_Z, false);
         AddObjectProperty("TBM42_DOM_ENM_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_enm_N, false);
         AddObjectProperty("TBM42_DOM_JNM_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_jnm_N, false);
         AddObjectProperty("TBM42_DOM_GRP_NM_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_grp_nm_N, false);
         AddObjectProperty("TBM42_NOTE_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_note_N, false);
         AddObjectProperty("TBM42_ORDER_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_order_N, false);
         AddObjectProperty("TBM42_DEL_FLG_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_del_flg_N, false);
         AddObjectProperty("TBM42_CRT_DATETIME_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_datetime_N, false);
         AddObjectProperty("TBM42_CRT_USER_ID_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_user_id_N, false);
         AddObjectProperty("TBM42_CRT_PROG_NM_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_prog_nm_N, false);
         AddObjectProperty("TBM42_UPD_DATETIME_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_datetime_N, false);
         AddObjectProperty("TBM42_UPD_USER_ID_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_user_id_N, false);
         AddObjectProperty("TBM42_UPD_PROG_NM_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_prog_nm_N, false);
         AddObjectProperty("TBM42_UPD_CNT_N", gxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_cnt_N, false);
      }
   }
