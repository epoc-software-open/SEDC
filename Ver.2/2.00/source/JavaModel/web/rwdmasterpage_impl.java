...
public final  class rwdmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm042( )
   {
      ...
      httpContext.AddJavascriptSource("rwdmasterpage.js", "?2017731716434");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?20177317164316");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   {
      httpContext.AddJavascriptSource("rwdmasterpage.js", "?20177317164316");
