/*
       ...
       Generated on: July 3, 2017 17:19:53.79
...
public final  class b402_wp13_domain_reg_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317195385");
   ...
   public void wb_table7_36_1R2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm42_dom_cd_Internalname, GXutil.rtrim( AV5BC_STUDY_DOMAIN.getgxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_cd()), GXutil.rtrim( localUtil.format( AV5BC_STUDY_DOMAIN.getgxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_dom_cd(), "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtltbm42_dom_cd_Jsonclick, 0, "Attribute", "", "", "", 1, edtavCtltbm42_dom_cd_Enabled, 0, "text", "", 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_B402_WP13_DOMAIN_REG.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317195688");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b402_wp13_domain_reg.js", "?20177317195688");
