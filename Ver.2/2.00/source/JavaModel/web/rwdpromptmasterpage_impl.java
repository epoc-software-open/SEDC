...
public final  class rwdpromptmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm062( )
   {
      ...
      httpContext.AddJavascriptSource("rwdpromptmasterpage.js", "?20177317164338");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?20177317164341");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("rwdpromptmasterpage.js", "?20177317164341");
      }
