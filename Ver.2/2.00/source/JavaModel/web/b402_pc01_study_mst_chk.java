/*
       ...
       Generated on: July 3, 2017 17:14:22.27
...
public final  class b402_pc01_study_mst_chk extends GXProcedure
{
   ...
   public void S181( )
   {
      ...
      {
         A397TBM31_DEL_FLG = P001T5_A397TBM31_DEL_FLG[0] ;
         n397TBM31_DEL_FLG = P001T5_n397TBM31_DEL_FLG[0] ;
         A643TBM31_STATUS = P001T5_A643TBM31_STATUS[0] ;
         n643TBM31_STATUS = P001T5_n643TBM31_STATUS[0] ;
         A68TBM31_STUDY_ID = P001T5_A68TBM31_STUDY_ID[0] ;
         A69TBM31_CRF_ID = P001T5_A69TBM31_CRF_ID[0] ;
         AV33GXLvl349 = (byte)(1) ;
         /* Exit For each command. Update data (if necessary), close cursors & exit. */
         if (true) break;
      ...
      /* Using cursor P001T6 */
      pr_default.execute(4, new Object[] {new Byte(W_err_cd_int2_0), new Long(AV12P_STUDY_ID), AV11P_SESSION_ID, AV10P_DATETIME});
      W_err_cd_int2_0 = P001T6_AW_err_cd_int2_0[0] ;
      AV12P_STUDY_ID = P001T6_AV12P_STUDY_ID[0] ;
      AV11P_SESSION_ID = P001T6_AV11P_SESSION_ID[0] ;
      AV10P_DATETIME = P001T6_AV10P_DATETIME[0] ;
      ...
      if ( AV25W_ERR_CD != 0 )
      {
         ...
         {
            A180TBW12_DATETIME = P001T7_A180TBW12_DATETIME[0] ;
            A179TBW12_SESSION_ID = P001T7_A179TBW12_SESSION_ID[0] ;
            A776TBW12_ERR_DIV = P001T7_A776TBW12_ERR_DIV[0] ;
            n776TBW12_ERR_DIV = P001T7_n776TBW12_ERR_DIV[0] ;
            A777TBW12_ERR_MSG = P001T7_A777TBW12_ERR_MSG[0] ;
            n777TBW12_ERR_MSG = P001T7_n777TBW12_ERR_MSG[0] ;
            A181TBW12_SEQ = P001T7_A181TBW12_SEQ[0] ;
            ...
            AV18W_A_RESULT_MSG_SDT.add(AV19W_A_RESULT_MSG_SDT_ITEM, 0);
            /* Using cursor P001T8 */
            pr_default.execute(6, new Object[] {A179TBW12_SESSION_ID, A180TBW12_DATETIME, new Short(A181TBW12_SEQ)});
   ...
   public void initialize( )
   {
      ...
      A397TBM31_DEL_FLG = "" ;
      A643TBM31_STATUS = "" ;
      P001T5_A397TBM31_DEL_FLG = new String[] {""} ;
      P001T5_n397TBM31_DEL_FLG = new boolean[] {false} ;
      P001T5_A643TBM31_STATUS = new String[] {""} ;
      P001T5_n643TBM31_STATUS = new boolean[] {false} ;
      P001T5_A68TBM31_STUDY_ID = new long[1] ;
      P001T5_A69TBM31_CRF_ID = new short[1] ;
      GXt_char1 = "" ;
      AV10P_DATETIME = GXutil.resetTime( GXutil.nullDate() );
      AV11P_SESSION_ID = "" ;
      AV23W_SESSION = httpContext.getWebSession();
      P001T6_AW_err_cd_int2_0 = new byte[1] ;
      P001T6_AV12P_STUDY_ID = new long[1] ;
      P001T6_AV11P_SESSION_ID = new String[] {""} ;
      P001T6_AV10P_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P001T7_A180TBW12_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      P001T7_A179TBW12_SESSION_ID = new String[] {""} ;
      P001T7_A776TBW12_ERR_DIV = new byte[1] ;
      P001T7_n776TBW12_ERR_DIV = new boolean[] {false} ;
      P001T7_A777TBW12_ERR_MSG = new String[] {""} ;
      P001T7_n777TBW12_ERR_MSG = new boolean[] {false} ;
      P001T7_A181TBW12_SEQ = new short[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_pc01_study_mst_chk__default(),
         new Object[] {
            ...
            , new Object[] {
            P001T5_A397TBM31_DEL_FLG, P001T5_n397TBM31_DEL_FLG, P001T5_A643TBM31_STATUS, P001T5_n643TBM31_STATUS, P001T5_A68TBM31_STUDY_ID, P001T5_A69TBM31_CRF_ID
            }
            , new Object[] {
            P001T6_AW_err_cd_int2_0, P001T6_AV12P_STUDY_ID, P001T6_AV11P_SESSION_ID, P001T6_AV10P_DATETIME
            }
            , new Object[] {
            P001T7_A180TBW12_DATETIME, P001T7_A179TBW12_SESSION_ID, P001T7_A776TBW12_ERR_DIV, P001T7_n776TBW12_ERR_DIV, P001T7_A777TBW12_ERR_MSG, P001T7_n777TBW12_ERR_MSG, P001T7_A181TBW12_SEQ
            }
            , new Object[] {
            }
         }
      ...
      AV35Pgmname = "B402_PC01_STUDY_MST_CHK" ;
      /* GeneXus formulas. */
      AV35Pgmname = "B402_PC01_STUDY_MST_CHK" ;
      Gx_err = (short)(0) ;
   }
   ...
   private String[] P001T5_A397TBM31_DEL_FLG ;
   private boolean[] P001T5_n397TBM31_DEL_FLG ;
   private String[] P001T5_A643TBM31_STATUS ;
   private boolean[] P001T5_n643TBM31_STATUS ;
   private long[] P001T5_A68TBM31_STUDY_ID ;
   private short[] P001T5_A69TBM31_CRF_ID ;
   private byte[] P001T6_AW_err_cd_int2_0 ;
   private long[] P001T6_AV12P_STUDY_ID ;
   private String[] P001T6_AV11P_SESSION_ID ;
   private java.util.Date[] P001T6_AV10P_DATETIME ;
   private java.util.Date[] P001T7_A180TBW12_DATETIME ;
   private String[] P001T7_A179TBW12_SESSION_ID ;
   private byte[] P001T7_A776TBW12_ERR_DIV ;
   private boolean[] P001T7_n776TBW12_ERR_DIV ;
   private String[] P001T7_A777TBW12_ERR_MSG ;
   private boolean[] P001T7_n777TBW12_ERR_MSG ;
   private short[] P001T7_A181TBW12_SEQ ;
...
final  class b402_pc01_study_mst_chk__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("P001T4", "SELECT `TBM31_DEL_FLG`, `TBM31_STATUS`, `TBM31_STUDY_ID`, `TBM31_CRF_ID` FROM `TBM31_CRF` WHERE (`TBM31_STUDY_ID` = ?) AND (`TBM31_STATUS` = '0') AND (`TBM31_DEL_FLG` = '0') ORDER BY `TBM31_STUDY_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("P001T5", "SELECT `TBM31_DEL_FLG`, `TBM31_STATUS`, `TBM31_STUDY_ID`, `TBM31_CRF_ID` FROM `TBM31_CRF` WHERE (`TBM31_STUDY_ID` = ?) AND (`TBM31_STATUS` = '1') AND (`TBM31_DEL_FLG` = '0') ORDER BY `TBM31_STUDY_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new CallCursor("P001T6", "CALL PROC_CHK_CRF ( ?, ?, ?, ?)", GX_NOMASK + GX_MASKLOOPLOCK,0)
         ,new ForEachCursor("P001T7", "SELECT `TBW12_DATETIME`, `TBW12_SESSION_ID`, `TBW12_ERR_DIV`, `TBW12_ERR_MSG`, `TBW12_SEQ` FROM `TBW12_CRF_ERR_MSG` WHERE `TBW12_SESSION_ID` = ? and `TBW12_DATETIME` = ? ORDER BY `TBW12_SESSION_ID`, `TBW12_DATETIME`  FOR UPDATE ",true, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
         ,new UpdateCursor("P001T8", "DELETE FROM `TBW12_CRF_ERR_MSG`  WHERE `TBW12_SESSION_ID` = ? AND `TBW12_DATETIME` = ? AND `TBW12_SEQ` = ?", GX_NOMASK + GX_MASKLOOPLOCK)
      };
   }
