/*
       ...
       Generated on: July 3, 2017 17:14:57.61
...
public final  class tbt02_crf_impl extends GXWebPanel
{
   ...
   public void inittrn( )
   {
      ...
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxAggSel9"+"_"+"TBT02_CRT_USER_ID") == 0 )
      {
         ...
         gx9asatbt02_crt_user_id0P55( Gx_mode) ;
         return  ;
      }
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxAggSel11"+"_"+"TBT02_UPD_USER_ID") == 0 )
      {
         ...
         gx11asatbt02_upd_user_id0P55( Gx_mode) ;
         return  ;
      }
      else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_14") == 0 )
      {
         ...
         gxload_14( A89TBT02_STUDY_ID, A90TBT02_SUBJECT_ID) ;
         return  ;
      }
   ...
   public void wb_table4_34_0P55( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_INPUT_END_FLG_Internalname, GXutil.rtrim( A661TBT02_INPUT_END_FLG), GXutil.rtrim( localUtil.format( A661TBT02_INPUT_END_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(134);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_INPUT_END_FLG_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_INPUT_END_FLG_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_TBT02_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_INPUT_END_AUTH_CD_Internalname, GXutil.rtrim( A664TBT02_INPUT_END_AUTH_CD), GXutil.rtrim( localUtil.format( A664TBT02_INPUT_END_AUTH_CD, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(149);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_INPUT_END_AUTH_CD_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_INPUT_END_AUTH_CD_Enabled, 0, "text", "", 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_AUTH_CD", "left", "HLP_TBT02_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_DEL_FLG_Internalname, GXutil.rtrim( A449TBT02_DEL_FLG), GXutil.rtrim( localUtil.format( A449TBT02_DEL_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(154);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_DEL_FLG_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_DEL_FLG_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_TBT02_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_CRT_DATETIME_Internalname, localUtil.format(A450TBT02_CRT_DATETIME, "9999/99/99 99:99:99"), localUtil.format( A450TBT02_CRT_DATETIME, "9999/99/99 99:99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'jap',false,0);"+";gx.evt.onblur(159);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_CRT_DATETIME_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_CRT_DATETIME_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_Y4MD_HMS", "right", "HLP_TBT02_CRF.htm");
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_CRT_USER_ID_Internalname, GXutil.rtrim( A451TBT02_CRT_USER_ID), GXutil.rtrim( localUtil.format( A451TBT02_CRT_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(164);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_CRT_USER_ID_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_CRT_USER_ID_Enabled, 0, "text", "", 80, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_USER_ID", "left", "HLP_TBT02_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_CRT_PROG_NM_Internalname, GXutil.rtrim( A452TBT02_CRT_PROG_NM), GXutil.rtrim( localUtil.format( A452TBT02_CRT_PROG_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(169);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_CRT_PROG_NM_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_CRT_PROG_NM_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_PG_NM", "left", "HLP_TBT02_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_UPD_DATETIME_Internalname, localUtil.format(A453TBT02_UPD_DATETIME, "9999/99/99 99:99:99"), localUtil.format( A453TBT02_UPD_DATETIME, "9999/99/99 99:99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'jap',false,0);"+";gx.evt.onblur(174);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_UPD_DATETIME_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_UPD_DATETIME_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_Y4MD_HMS", "right", "HLP_TBT02_CRF.htm");
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_UPD_USER_ID_Internalname, GXutil.rtrim( A454TBT02_UPD_USER_ID), GXutil.rtrim( localUtil.format( A454TBT02_UPD_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(179);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_UPD_USER_ID_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_UPD_USER_ID_Enabled, 0, "text", "", 80, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_USER_ID", "left", "HLP_TBT02_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_UPD_PROG_NM_Internalname, GXutil.rtrim( A455TBT02_UPD_PROG_NM), GXutil.rtrim( localUtil.format( A455TBT02_UPD_PROG_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(184);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_UPD_PROG_NM_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_UPD_PROG_NM_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_PG_NM", "left", "HLP_TBT02_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBT02_UPD_CNT_Internalname, GXutil.ltrim( localUtil.ntoc( A456TBT02_UPD_CNT, (byte)(10), (byte)(0), ".", "")), ((edtTBT02_UPD_CNT_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A456TBT02_UPD_CNT), "ZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A456TBT02_UPD_CNT), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(189);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBT02_UPD_CNT_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBT02_UPD_CNT_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_NO", "right", "HLP_TBT02_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void gxload_14( long A89TBT02_STUDY_ID ,
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2017731715173");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2017731715194");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tbt02_crf.js", "?2017731715194");
   ...
   public void gx9asatbt02_crt_user_id0P55( String Gx_mode )
   {
      GXt_char1 = A451TBT02_CRT_USER_ID ;
      GXv_char2[0] = GXt_char1 ;
      new a403_pc01_get_login_user_id(remoteHandle, context).execute( GXv_char2) ;
   ...
   public void gx11asatbt02_upd_user_id0P55( String Gx_mode )
   {
      GXt_char1 = A454TBT02_UPD_USER_ID ;
      GXv_char2[0] = GXt_char1 ;
      new a403_pc01_get_login_user_id(remoteHandle, context).execute( GXv_char2) ;
                                       ...
                                       String GX_Parm31 )
   {
      ...
      n660TBT02_APPROVAL_AUTH_CD = false ;
      A661TBT02_INPUT_END_FLG = GX_Parm25 ;
      n661TBT02_INPUT_END_FLG = false ;
      A662TBT02_INPUT_END_DATETIME = GX_Parm26 ;
      n662TBT02_INPUT_END_DATETIME = false ;
      A663TBT02_INPUT_END_USER_ID = GX_Parm27 ;
      n663TBT02_INPUT_END_USER_ID = false ;
      A664TBT02_INPUT_END_AUTH_CD = GX_Parm28 ;
      n664TBT02_INPUT_END_AUTH_CD = false ;
      A449TBT02_DEL_FLG = GX_Parm29 ;
      n449TBT02_DEL_FLG = false ;
      A452TBT02_CRT_PROG_NM = GX_Parm30 ;
      n452TBT02_CRT_PROG_NM = false ;
      A455TBT02_UPD_PROG_NM = GX_Parm31 ;
      n455TBT02_UPD_PROG_NM = false ;
      httpContext.wbHandled = (byte)(1) ;
      afterkeyloadscreen( ) ;
      draw( ) ;
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new tbt02_crf__default(),
         new Object[] {
            ...
            T000P2_A660TBT02_APPROVAL_AUTH_CD, T000P2_n660TBT02_APPROVAL_AUTH_CD, T000P2_A661TBT02_INPUT_END_FLG, T000P2_n661TBT02_INPUT_END_FLG, T000P2_A662TBT02_INPUT_END_DATETIME, T000P2_n662TBT02_INPUT_END_DATETIME, T000P2_A663TBT02_INPUT_END_USER_ID, T000P2_n663TBT02_INPUT_END_USER_ID, T000P2_A664TBT02_INPUT_END_AUTH_CD, T000P2_n664TBT02_INPUT_END_AUTH_CD,
            T000P2_A449TBT02_DEL_FLG, T000P2_n449TBT02_DEL_FLG, T000P2_A452TBT02_CRT_PROG_NM, T000P2_n452TBT02_CRT_PROG_NM, T000P2_A455TBT02_UPD_PROG_NM, T000P2_n455TBT02_UPD_PROG_NM, T000P2_A89TBT02_STUDY_ID, T000P2_A90TBT02_SUBJECT_ID
            }
            , new Object[] {
            ...
            T000P3_A660TBT02_APPROVAL_AUTH_CD, T000P3_n660TBT02_APPROVAL_AUTH_CD, T000P3_A661TBT02_INPUT_END_FLG, T000P3_n661TBT02_INPUT_END_FLG, T000P3_A662TBT02_INPUT_END_DATETIME, T000P3_n662TBT02_INPUT_END_DATETIME, T000P3_A663TBT02_INPUT_END_USER_ID, T000P3_n663TBT02_INPUT_END_USER_ID, T000P3_A664TBT02_INPUT_END_AUTH_CD, T000P3_n664TBT02_INPUT_END_AUTH_CD,
            T000P3_A449TBT02_DEL_FLG, T000P3_n449TBT02_DEL_FLG, T000P3_A452TBT02_CRT_PROG_NM, T000P3_n452TBT02_CRT_PROG_NM, T000P3_A455TBT02_UPD_PROG_NM, T000P3_n455TBT02_UPD_PROG_NM, T000P3_A89TBT02_STUDY_ID, T000P3_A90TBT02_SUBJECT_ID
            }
            , new Object[] {
            ...
            T000P5_A660TBT02_APPROVAL_AUTH_CD, T000P5_n660TBT02_APPROVAL_AUTH_CD, T000P5_A661TBT02_INPUT_END_FLG, T000P5_n661TBT02_INPUT_END_FLG, T000P5_A662TBT02_INPUT_END_DATETIME, T000P5_n662TBT02_INPUT_END_DATETIME, T000P5_A663TBT02_INPUT_END_USER_ID, T000P5_n663TBT02_INPUT_END_USER_ID, T000P5_A664TBT02_INPUT_END_AUTH_CD, T000P5_n664TBT02_INPUT_END_AUTH_CD,
            T000P5_A449TBT02_DEL_FLG, T000P5_n449TBT02_DEL_FLG, T000P5_A452TBT02_CRT_PROG_NM, T000P5_n452TBT02_CRT_PROG_NM, T000P5_A455TBT02_UPD_PROG_NM, T000P5_n455TBT02_UPD_PROG_NM, T000P5_A89TBT02_STUDY_ID, T000P5_A90TBT02_SUBJECT_ID
            }
            , new Object[] {
