...
public final  class b402_wp12_study_domain_list_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317173410");
   ...
   public void wb_table1_2_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_171_122( true) ;
      }
      else
      {
         wb_table2_171_122( false) ;
      }
      return  ;
   }

   public void wb_table2_171_122e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
   ...
   public void rf122( )
   {
      ...
      if ( (GXutil.strcmp("", httpContext.wjLoc)==0) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H00122 */
         pr_default.execute(0, new Object[] {new Integer(GXPagingFrom2), new Long(GXPagingTo2)});
         nGXsfl_153_idx = (short)(1) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subgrid1_recordsperpage( ) ) ) ) )
         {
            A614TBM02_ORDER = H00122_A614TBM02_ORDER[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A614TBM02_ORDER", GXutil.ltrim( GXutil.str( A614TBM02_ORDER, 5, 0)));
            n614TBM02_ORDER = H00122_n614TBM02_ORDER[0] ;
            A615TBM02_DEL_FLG = H00122_A615TBM02_DEL_FLG[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A615TBM02_DEL_FLG", A615TBM02_DEL_FLG);
            n615TBM02_DEL_FLG = H00122_n615TBM02_DEL_FLG[0] ;
            A611TBM02_DOM_JNM = H00122_A611TBM02_DOM_JNM[0] ;
            n611TBM02_DOM_JNM = H00122_n611TBM02_DOM_JNM[0] ;
            A49TBM02_DOM_CD = H00122_A49TBM02_DOM_CD[0] ;
            /* Execute user event: e32122 */
            e32122 ();
   ...
   public void strup120( )
   {
      ...
      AV39Pgmname = "B402_WP12_STUDY_DOMAIN_LIST" ;
      AV38Pgmdesc = "試験登録（ドメイン選択）" ;
      Gx_err = (short)(0) ;
   ...
   private void e32122( )
   {
      /* Grid1_Load Routine */
      AV40GXV2 = 1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV40GXV2", GXutil.ltrim( GXutil.str( AV40GXV2, 8, 0)));
      while ( AV40GXV2 <= AV5B402_SD06_STUDY_DOMAIN_C.size() )
      {
         AV6B402_SD06_STUDY_DOMAIN_I = (SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)((SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)AV5B402_SD06_STUDY_DOMAIN_C.elementAt(-1+AV40GXV2));
         if ( GXutil.strcmp(AV6B402_SD06_STUDY_DOMAIN_I.getgxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Dom_cd(), A49TBM02_DOM_CD) == 0 )
         {
   ...
   public void e33122( )
   {
      /* 'BTN_EDIT' Routine */
      GXKey = context.getSiteKey( ) ;
      GXEncryptionTmp = "b402_wp13_domain_reg"+GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV20P_STUDY_ID,10,0))) + "," + GXutil.URLEncode(GXutil.rtrim(A49TBM02_DOM_CD)) ;
   ...
   public void e34122( )
   {
      ...
      GXKey = context.getSiteKey( ) ;
      GXEncryptionTmp = "b402_wp14_study_cdisc_item_list"+GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV20P_STUDY_ID,10,0))) + "," + GXutil.URLEncode(GXutil.rtrim(A49TBM02_DOM_CD)) ;
   ...
   public void e14122( )
   {
      ...
      AV41GXV3 = 1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV41GXV3", GXutil.ltrim( GXutil.str( AV41GXV3, 8, 0)));
      while ( AV41GXV3 <= AV5B402_SD06_STUDY_DOMAIN_C.size() )
      {
         AV6B402_SD06_STUDY_DOMAIN_I = (SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)((SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)AV5B402_SD06_STUDY_DOMAIN_C.elementAt(-1+AV41GXV3));
   ...
   public void e15122( )
   {
      ...
      if ( new a402_pc02_btn_kengn_check(remoteHandle, context).executeUdp( "REG", AV18H_KNGN_FLG, "") )
      {
         ...
         while ( AV42GXV4 <= AV5B402_SD06_STUDY_DOMAIN_C.size() )
         {
            AV6B402_SD06_STUDY_DOMAIN_I = (SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)((SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)AV5B402_SD06_STUDY_DOMAIN_C.elementAt(-1+AV42GXV4));
            if ( AV6B402_SD06_STUDY_DOMAIN_I.getgxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Btn_disp_flg() )
            {
   ...
   public void S242( )
   {
      ...
      while ( (pr_default.getStatus(4) != 101) )
      {
         ...
         A615TBM02_DEL_FLG = H00126_A615TBM02_DEL_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A615TBM02_DEL_FLG", A615TBM02_DEL_FLG);
         n615TBM02_DEL_FLG = H00126_n615TBM02_DEL_FLG[0] ;
   ...
   public void S212( )
   {
      ...
      AV47GXV5 = 1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV47GXV5", GXutil.ltrim( GXutil.str( AV47GXV5, 8, 0)));
      while ( AV47GXV5 <= AV5B402_SD06_STUDY_DOMAIN_C.size() )
      {
         AV6B402_SD06_STUDY_DOMAIN_I = (SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)((SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)AV5B402_SD06_STUDY_DOMAIN_C.elementAt(-1+AV47GXV5));
         if ( AV6B402_SD06_STUDY_DOMAIN_I.getgxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Check() )
         {
            AV24W_CHK_CNT = 1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV24W_CHK_CNT", GXutil.ltrim( GXutil.str( AV24W_CHK_CNT, 10, 0)));
   ...
   public void S202( )
   {
      ...
      while ( nGXsfl_153_fel_idx < nRC_GXsfl_153 )
      {
         ...
         AV49GXV6 = 1 ;
         httpContext.ajax_rsp_assign_attri("", false, "AV49GXV6", GXutil.ltrim( GXutil.str( AV49GXV6, 8, 0)));
         while ( AV49GXV6 <= AV5B402_SD06_STUDY_DOMAIN_C.size() )
         {
            AV6B402_SD06_STUDY_DOMAIN_I = (SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)((SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem)AV5B402_SD06_STUDY_DOMAIN_C.elementAt(-1+AV49GXV6));
            if ( GXutil.strcmp(AV6B402_SD06_STUDY_DOMAIN_I.getgxTv_SdtB402_SD06_STUDY_DOMAIN_B402_SD06_STUDY_DOMAINItem_Dom_cd(), A49TBM02_DOM_CD) == 0 )
            {
   ...
   public void S222( )
   {
      ...
      {
         A49TBM02_DOM_CD = H00128_A49TBM02_DOM_CD[0] ;
         A610TBM02_DOM_ENM = H00128_A610TBM02_DOM_ENM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A610TBM02_DOM_ENM", A610TBM02_DOM_ENM);
         n610TBM02_DOM_ENM = H00128_n610TBM02_DOM_ENM[0] ;
         A611TBM02_DOM_JNM = H00128_A611TBM02_DOM_JNM[0] ;
         n611TBM02_DOM_JNM = H00128_n611TBM02_DOM_JNM[0] ;
         A612TBM02_DOM_GRP_NM = H00128_A612TBM02_DOM_GRP_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A612TBM02_DOM_GRP_NM", A612TBM02_DOM_GRP_NM);
         n612TBM02_DOM_GRP_NM = H00128_n612TBM02_DOM_GRP_NM[0] ;
         A613TBM02_NOTE = H00128_A613TBM02_NOTE[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A613TBM02_NOTE", A613TBM02_NOTE);
         n613TBM02_NOTE = H00128_n613TBM02_NOTE[0] ;
         A614TBM02_ORDER = H00128_A614TBM02_ORDER[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A614TBM02_ORDER", GXutil.ltrim( GXutil.str( A614TBM02_ORDER, 5, 0)));
         n614TBM02_ORDER = H00128_n614TBM02_ORDER[0] ;
         ...
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV7BC_TBM42_STUDY_DOMAIN", AV7BC_TBM42_STUDY_DOMAIN);
         AV7BC_TBM42_STUDY_DOMAIN.setgxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_crt_prog_nm( AV39Pgmname );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV7BC_TBM42_STUDY_DOMAIN", AV7BC_TBM42_STUDY_DOMAIN);
         ...
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV7BC_TBM42_STUDY_DOMAIN", AV7BC_TBM42_STUDY_DOMAIN);
         AV7BC_TBM42_STUDY_DOMAIN.setgxTv_SdtTBM42_STUDY_CDISC_DOMAIN_Tbm42_upd_prog_nm( AV39Pgmname );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV7BC_TBM42_STUDY_DOMAIN", AV7BC_TBM42_STUDY_DOMAIN);
   ...
   public void S232( )
   {
      ...
      {
         A359TBM03_DEL_FLG = H00129_A359TBM03_DEL_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A359TBM03_DEL_FLG", A359TBM03_DEL_FLG);
         n359TBM03_DEL_FLG = H00129_n359TBM03_DEL_FLG[0] ;
         A59TBM03_DOM_CD = H00129_A59TBM03_DOM_CD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A59TBM03_DOM_CD", A59TBM03_DOM_CD);
         A60TBM03_DOM_VAR_NM = H00129_A60TBM03_DOM_VAR_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A60TBM03_DOM_VAR_NM", A60TBM03_DOM_VAR_NM);
         A346TBM03_VAR_DESC = H00129_A346TBM03_VAR_DESC[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A346TBM03_VAR_DESC", A346TBM03_VAR_DESC);
         n346TBM03_VAR_DESC = H00129_n346TBM03_VAR_DESC[0] ;
         A347TBM03_SDTM_FLG = H00129_A347TBM03_SDTM_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A347TBM03_SDTM_FLG", A347TBM03_SDTM_FLG);
         n347TBM03_SDTM_FLG = H00129_n347TBM03_SDTM_FLG[0] ;
         A348TBM03_CDASH_FLG = H00129_A348TBM03_CDASH_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A348TBM03_CDASH_FLG", A348TBM03_CDASH_FLG);
         n348TBM03_CDASH_FLG = H00129_n348TBM03_CDASH_FLG[0] ;
         A532TBM03_INPUT_TYPE_DIV = H00129_A532TBM03_INPUT_TYPE_DIV[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A532TBM03_INPUT_TYPE_DIV", A532TBM03_INPUT_TYPE_DIV);
         n532TBM03_INPUT_TYPE_DIV = H00129_n532TBM03_INPUT_TYPE_DIV[0] ;
         A349TBM03_REQUIRED_FLG = H00129_A349TBM03_REQUIRED_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A349TBM03_REQUIRED_FLG", A349TBM03_REQUIRED_FLG);
         n349TBM03_REQUIRED_FLG = H00129_n349TBM03_REQUIRED_FLG[0] ;
         A688TBM03_SAS_FIELD_NM = H00129_A688TBM03_SAS_FIELD_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A688TBM03_SAS_FIELD_NM", A688TBM03_SAS_FIELD_NM);
         n688TBM03_SAS_FIELD_NM = H00129_n688TBM03_SAS_FIELD_NM[0] ;
         A709TBM03_ODM_DATA_TYPE = H00129_A709TBM03_ODM_DATA_TYPE[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A709TBM03_ODM_DATA_TYPE", A709TBM03_ODM_DATA_TYPE);
         n709TBM03_ODM_DATA_TYPE = H00129_n709TBM03_ODM_DATA_TYPE[0] ;
         A350TBM03_NOTE = H00129_A350TBM03_NOTE[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A350TBM03_NOTE", A350TBM03_NOTE);
         n350TBM03_NOTE = H00129_n350TBM03_NOTE[0] ;
         A61TBM03_ORDER = H00129_A61TBM03_ORDER[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A61TBM03_ORDER", GXutil.ltrim( GXutil.str( A61TBM03_ORDER, 5, 0)));
         n61TBM03_ORDER = H00129_n61TBM03_ORDER[0] ;
         A932TBM03_VERSION = H00129_A932TBM03_VERSION[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A932TBM03_VERSION", A932TBM03_VERSION);
         n932TBM03_VERSION = H00129_n932TBM03_VERSION[0] ;
         ...
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV8BC_TBM43_STUDY_CDISC_ITEM", AV8BC_TBM43_STUDY_CDISC_ITEM);
         AV8BC_TBM43_STUDY_CDISC_ITEM.setgxTv_SdtTBM43_STUDY_CDISC_ITEM_Tbm43_crt_prog_nm( AV39Pgmname );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV8BC_TBM43_STUDY_CDISC_ITEM", AV8BC_TBM43_STUDY_CDISC_ITEM);
         ...
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV8BC_TBM43_STUDY_CDISC_ITEM", AV8BC_TBM43_STUDY_CDISC_ITEM);
         AV8BC_TBM43_STUDY_CDISC_ITEM.setgxTv_SdtTBM43_STUDY_CDISC_ITEM_Tbm43_upd_prog_nm( AV39Pgmname );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV8BC_TBM43_STUDY_CDISC_ITEM", AV8BC_TBM43_STUDY_CDISC_ITEM);
   ...
   public void S252( )
   {
      ...
      AV52GXLvl547 = (byte)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV52GXLvl547", GXutil.str( AV52GXLvl547, 1, 0));
      ...
      {
         A203TBM42_STUDY_ID = H001210_A203TBM42_STUDY_ID[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A203TBM42_STUDY_ID", GXutil.ltrim( GXutil.str( A203TBM42_STUDY_ID, 10, 0)));
         AV52GXLvl547 = (byte)(1) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV52GXLvl547", GXutil.str( AV52GXLvl547, 1, 0));
         AV30W_MSG = "" ;
   ...
   public void S162( )
   {
      ...
      b402_wp12_study_domain_list_impl.this.GXt_boolean6 = GXv_boolean7[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV18H_KNGN_FLG", AV18H_KNGN_FLG);
      chkavD_grd_check.setEnabled( (GXt_boolean6 ? 1 : 0) );
   }

   public void wb_table2_171_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV17H_INIT_FLG), GXutil.rtrim( localUtil.format( AV17H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(176);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_init_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_B402_WP12_STUDY_DOMAIN_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 177,'',false,'" + sGXsfl_153_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_srch_flg_Internalname, GXutil.rtrim( AV19H_SRCH_FLG), GXutil.rtrim( localUtil.format( AV19H_SRCH_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(177);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_srch_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_B402_WP12_STUDY_DOMAIN_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 178,'',false,'" + sGXsfl_153_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV18H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV18H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(178);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_B402_WP12_STUDY_DOMAIN_LIST.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 179,'',false,'" + sGXsfl_153_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_disp_datetime_Internalname, GXutil.rtrim( AV16H_DISP_DATETIME), GXutil.rtrim( localUtil.format( AV16H_DISP_DATETIME, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(179);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_disp_datetime_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 14, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_B402_WP12_STUDY_DOMAIN_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 180,'',false,'" + sGXsfl_153_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlrec_cnt_Internalname, GXutil.ltrim( localUtil.ntoc( AV15H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Rec_cnt(), (byte)(10), (byte)(0), ".", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV15H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Rec_cnt()), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(180);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtlrec_cnt_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_B402_WP12_STUDY_DOMAIN_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_171_122e( true) ;
      }
      else
      {
         wb_table2_171_122e( false) ;
      }
   }
   ...
   public void wb_table1_2_122( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table3_6_122( true) ;
      }
      else
      {
         wb_table3_6_122( false) ;
      }
      return  ;
   }

   public void wb_table3_6_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table3_6_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table4_12_122( true) ;
      }
      else
      {
         wb_table4_12_122( false) ;
      }
      return  ;
   }

   public void wb_table4_12_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         wb_table5_22_122( true) ;
      }
      else
      {
         wb_table5_22_122( false) ;
      }
      return  ;
   }

   public void wb_table5_22_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_6_122e( true) ;
      }
      else
      {
         wb_table3_6_122e( false) ;
      }
   }

   public void wb_table5_22_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table6_25_122( true) ;
      }
      else
      {
         wb_table6_25_122( false) ;
      }
      return  ;
   }

   public void wb_table6_25_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table5_22_122e( true) ;
      }
      else
      {
         wb_table5_22_122e( false) ;
      }
   }

   public void wb_table6_25_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table7_28_122( true) ;
      }
      else
      {
         wb_table7_28_122( false) ;
      }
      return  ;
   }

   public void wb_table7_28_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         wb_table8_39_122( true) ;
      }
      else
      {
         wb_table8_39_122( false) ;
      }
      return  ;
   }

   public void wb_table8_39_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table6_25_122e( true) ;
      }
      else
      {
         wb_table6_25_122e( false) ;
      }
   }

   public void wb_table8_39_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table9_42_122( true) ;
      }
      else
      {
         wb_table9_42_122( false) ;
      }
      return  ;
   }

   public void wb_table9_42_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         wb_table10_138_122( true) ;
      }
      else
      {
         wb_table10_138_122( false) ;
      }
      return  ;
   }

   public void wb_table10_138_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
      ...
      if ( wbEnd == 153 )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table8_39_122e( true) ;
      }
      else
      {
         wb_table8_39_122e( false) ;
      }
   }

   public void wb_table10_138_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table10_138_122e( true) ;
      }
      else
      {
         wb_table10_138_122e( false) ;
      }
   }

   public void wb_table9_42_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table11_48_122( true) ;
      }
      else
      {
         wb_table11_48_122( false) ;
      }
      return  ;
   }

   public void wb_table11_48_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table9_42_122e( true) ;
      }
      else
      {
         wb_table9_42_122e( false) ;
      }
   }

   public void wb_table11_48_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table12_51_122( true) ;
      }
      else
      {
         wb_table12_51_122( false) ;
      }
      return  ;
   }

   public void wb_table12_51_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table13_57_122( true) ;
      }
      else
      {
         wb_table13_57_122( false) ;
      }
      return  ;
   }

   public void wb_table13_57_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table14_63_122( true) ;
      }
      else
      {
         wb_table14_63_122( false) ;
      }
      return  ;
   }

   public void wb_table14_63_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table15_69_122( true) ;
      }
      else
      {
         wb_table15_69_122( false) ;
      }
      return  ;
   }

   public void wb_table15_69_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table16_75_122( true) ;
      }
      else
      {
         wb_table16_75_122( false) ;
      }
      return  ;
   }

   public void wb_table16_75_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table17_81_122( true) ;
      }
      else
      {
         wb_table17_81_122( false) ;
      }
      return  ;
   }

   public void wb_table17_81_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table18_87_122( true) ;
      }
      else
      {
         wb_table18_87_122( false) ;
      }
      return  ;
   }

   public void wb_table18_87_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table19_93_122( true) ;
      }
      else
      {
         wb_table19_93_122( false) ;
      }
      return  ;
   }

   public void wb_table19_93_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table20_99_122( true) ;
      }
      else
      {
         wb_table20_99_122( false) ;
      }
      return  ;
   }

   public void wb_table20_99_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table21_105_122( true) ;
      }
      else
      {
         wb_table21_105_122( false) ;
      }
      return  ;
   }

   public void wb_table21_105_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table22_111_122( true) ;
      }
      else
      {
         wb_table22_111_122( false) ;
      }
      return  ;
   }

   public void wb_table22_111_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table23_117_122( true) ;
      }
      else
      {
         wb_table23_117_122( false) ;
      }
      return  ;
   }

   public void wb_table23_117_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table24_123_122( true) ;
      }
      else
      {
         wb_table24_123_122( false) ;
      }
      return  ;
   }

   public void wb_table24_123_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table25_129_122( true) ;
      }
      else
      {
         wb_table25_129_122( false) ;
      }
      return  ;
   }

   public void wb_table25_129_122e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table11_48_122e( true) ;
      }
      else
      {
         wb_table11_48_122e( false) ;
      }
   }

   public void wb_table25_129_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table25_129_122e( true) ;
      }
      else
      {
         wb_table25_129_122e( false) ;
      }
   }

   public void wb_table24_123_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table24_123_122e( true) ;
      }
      else
      {
         wb_table24_123_122e( false) ;
      }
   }

   public void wb_table23_117_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table23_117_122e( true) ;
      }
      else
      {
         wb_table23_117_122e( false) ;
      }
   }

   public void wb_table22_111_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table22_111_122e( true) ;
      }
      else
      {
         wb_table22_111_122e( false) ;
      }
   }

   public void wb_table21_105_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table21_105_122e( true) ;
      }
      else
      {
         wb_table21_105_122e( false) ;
      }
   }

   public void wb_table20_99_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table20_99_122e( true) ;
      }
      else
      {
         wb_table20_99_122e( false) ;
      }
   }

   public void wb_table19_93_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table19_93_122e( true) ;
      }
      else
      {
         wb_table19_93_122e( false) ;
      }
   }

   public void wb_table18_87_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table18_87_122e( true) ;
      }
      else
      {
         wb_table18_87_122e( false) ;
      }
   }

   public void wb_table17_81_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table17_81_122e( true) ;
      }
      else
      {
         wb_table17_81_122e( false) ;
      }
   }

   public void wb_table16_75_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table16_75_122e( true) ;
      }
      else
      {
         wb_table16_75_122e( false) ;
      }
   }

   public void wb_table15_69_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table15_69_122e( true) ;
      }
      else
      {
         wb_table15_69_122e( false) ;
      }
   }

   public void wb_table14_63_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table14_63_122e( true) ;
      }
      else
      {
         wb_table14_63_122e( false) ;
      }
   }

   public void wb_table13_57_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table13_57_122e( true) ;
      }
      else
      {
         wb_table13_57_122e( false) ;
      }
   }

   public void wb_table12_51_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table12_51_122e( true) ;
      }
      else
      {
         wb_table12_51_122e( false) ;
      }
   }

   public void wb_table7_28_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table7_28_122e( true) ;
      }
      else
      {
         wb_table7_28_122e( false) ;
      }
   }

   public void wb_table4_12_122( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_12_122e( true) ;
      }
      else
      {
         wb_table4_12_122e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317174087");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b402_wp12_study_domain_list.js", "?20177317174087");
   ...
   public void sendrow_1532( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_153_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         Grid1Row.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"",""+" style=\"height:32px;width:85px\""});
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTBM02_DOM_CD_Internalname,GXutil.rtrim( A49TBM02_DOM_CD),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTBM02_DOM_CD_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(0),new Integer(0),"text","",new Integer(2),"chr",new Integer(1),"row",new Integer(2),new Integer(0),new Integer(0),new Integer(153),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"D_DOM_CD","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTBM02_DOM_JNM_Internalname,GXutil.rtrim( A611TBM02_DOM_JNM),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTBM02_DOM_JNM_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(0),new Integer(0),"text","",new Integer(50),"chr",new Integer(1),"row",new Integer(50),new Integer(0),new Integer(0),new Integer(153),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_del_Internalname,GXutil.rtrim( AV34D_GRD_DEL),"",TempTags+((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(162);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_del_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_del_Enabled),new Integer(0),"text","",new Integer(10),"chr",new Integer(1),"row",new Integer(10),new Integer(0),new Integer(0),new Integer(153),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         Grid1Row.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"",""+" style=\"width:50px\""});
         /* Text block */
         Grid1Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {lblBtn_edit_Internalname,"編集","","",lblBtn_edit_Jsonclick,"'"+""+"'"+",false,"+"'"+"E\\'BTN_EDIT\\'."+sGXsfl_153_idx+"'","","TextBlockBtn040s",new Integer(5),"",new Integer(lblBtn_edit_Visible),new Integer(1),new Integer(0)});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         /* Text block */
         Grid1Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {lblBtn_item_list_Internalname,"変数一覧","","",lblBtn_item_list_Jsonclick,"'"+""+"'"+",false,"+"'"+"E\\'BTN_ITEM_LIST\\'."+sGXsfl_153_idx+"'","","TextBlockBtn060s",new Integer(5),"",new Integer(lblBtn_item_list_Visible),new Integer(1),new Integer(0)});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
   ...
   public void initialize( )
   {
      ...
      Grid1Container = new com.genexus.webpanels.GXWebGrid(context);
      scmdbuf = "" ;
      H00122_A614TBM02_ORDER = new int[1] ;
      H00122_n614TBM02_ORDER = new boolean[] {false} ;
      H00122_A615TBM02_DEL_FLG = new String[] {""} ;
      H00122_n615TBM02_DEL_FLG = new boolean[] {false} ;
      H00122_A611TBM02_DOM_JNM = new String[] {""} ;
      H00122_n611TBM02_DOM_JNM = new boolean[] {false} ;
      H00122_A49TBM02_DOM_CD = new String[] {""} ;
      ...
      AV30W_MSG = "" ;
      H00124_A201TBM43_DOM_CD = new String[] {""} ;
      H00124_A200TBM43_STUDY_ID = new long[1] ;
      H00124_A202TBM43_DOM_VAR_NM = new String[] {""} ;
      A201TBM43_DOM_CD = "" ;
      ...
      AV26W_ERR_MSG = "" ;
      H00125_A63TBM21_STUDY_ID = new long[1] ;
      H00125_A367TBM21_STUDY_NM = new String[] {""} ;
      H00125_n367TBM21_STUDY_NM = new boolean[] {false} ;
      H00126_A49TBM02_DOM_CD = new String[] {""} ;
      H00126_A615TBM02_DEL_FLG = new String[] {""} ;
      H00126_n615TBM02_DEL_FLG = new boolean[] {false} ;
      H00126_A611TBM02_DOM_JNM = new String[] {""} ;
      H00126_n611TBM02_DOM_JNM = new boolean[] {false} ;
      H00127_A204TBM42_DOM_CD = new String[] {""} ;
      H00127_A203TBM42_STUDY_ID = new long[1] ;
      H00127_A893TBM42_DEL_FLG = new String[] {""} ;
      H00127_n893TBM42_DEL_FLG = new boolean[] {false} ;
      AV31W_SESSION = httpContext.getWebSession();
      H00128_A49TBM02_DOM_CD = new String[] {""} ;
      H00128_A610TBM02_DOM_ENM = new String[] {""} ;
      H00128_n610TBM02_DOM_ENM = new boolean[] {false} ;
      H00128_A611TBM02_DOM_JNM = new String[] {""} ;
      H00128_n611TBM02_DOM_JNM = new boolean[] {false} ;
      H00128_A612TBM02_DOM_GRP_NM = new String[] {""} ;
      H00128_n612TBM02_DOM_GRP_NM = new boolean[] {false} ;
      H00128_A613TBM02_NOTE = new String[] {""} ;
      H00128_n613TBM02_NOTE = new boolean[] {false} ;
      H00128_A614TBM02_ORDER = new int[1] ;
      H00128_n614TBM02_ORDER = new boolean[] {false} ;
      A610TBM02_DOM_ENM = "" ;
      A612TBM02_DOM_GRP_NM = "" ;
      A613TBM02_NOTE = "" ;
      H00129_A359TBM03_DEL_FLG = new String[] {""} ;
      H00129_n359TBM03_DEL_FLG = new boolean[] {false} ;
      H00129_A59TBM03_DOM_CD = new String[] {""} ;
      H00129_A60TBM03_DOM_VAR_NM = new String[] {""} ;
      H00129_A346TBM03_VAR_DESC = new String[] {""} ;
      H00129_n346TBM03_VAR_DESC = new boolean[] {false} ;
      H00129_A347TBM03_SDTM_FLG = new String[] {""} ;
      H00129_n347TBM03_SDTM_FLG = new boolean[] {false} ;
      H00129_A348TBM03_CDASH_FLG = new String[] {""} ;
      H00129_n348TBM03_CDASH_FLG = new boolean[] {false} ;
      H00129_A532TBM03_INPUT_TYPE_DIV = new String[] {""} ;
      H00129_n532TBM03_INPUT_TYPE_DIV = new boolean[] {false} ;
      H00129_A349TBM03_REQUIRED_FLG = new String[] {""} ;
      H00129_n349TBM03_REQUIRED_FLG = new boolean[] {false} ;
      H00129_A688TBM03_SAS_FIELD_NM = new String[] {""} ;
      H00129_n688TBM03_SAS_FIELD_NM = new boolean[] {false} ;
      H00129_A709TBM03_ODM_DATA_TYPE = new String[] {""} ;
      H00129_n709TBM03_ODM_DATA_TYPE = new boolean[] {false} ;
      H00129_A350TBM03_NOTE = new String[] {""} ;
      H00129_n350TBM03_NOTE = new boolean[] {false} ;
      H00129_A61TBM03_ORDER = new int[1] ;
      H00129_n61TBM03_ORDER = new boolean[] {false} ;
      H00129_A932TBM03_VERSION = new String[] {""} ;
      H00129_n932TBM03_VERSION = new boolean[] {false} ;
      A359TBM03_DEL_FLG = "" ;
      A59TBM03_DOM_CD = "" ;
      A60TBM03_DOM_VAR_NM = "" ;
      A346TBM03_VAR_DESC = "" ;
      ...
      A350TBM03_NOTE = "" ;
      A932TBM03_VERSION = "" ;
      H001210_A204TBM42_DOM_CD = new String[] {""} ;
      H001210_A203TBM42_STUDY_ID = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b402_wp12_study_domain_list__default(),
         new Object[] {
             new Object[] {
            H00122_A614TBM02_ORDER, H00122_n614TBM02_ORDER, H00122_A615TBM02_DEL_FLG, H00122_n615TBM02_DEL_FLG, H00122_A611TBM02_DOM_JNM, H00122_n611TBM02_DOM_JNM, H00122_A49TBM02_DOM_CD
            }
            , new Object[] {
            H00123_AGRID1_nRecordCount
            }
            , new Object[] {
            H00124_A201TBM43_DOM_CD, H00124_A200TBM43_STUDY_ID, H00124_A202TBM43_DOM_VAR_NM
            }
            , new Object[] {
            H00125_A63TBM21_STUDY_ID, H00125_A367TBM21_STUDY_NM, H00125_n367TBM21_STUDY_NM
            }
            , new Object[] {
            H00126_A49TBM02_DOM_CD, H00126_A615TBM02_DEL_FLG, H00126_n615TBM02_DEL_FLG, H00126_A611TBM02_DOM_JNM, H00126_n611TBM02_DOM_JNM
            }
            , new Object[] {
            H00127_A204TBM42_DOM_CD, H00127_A203TBM42_STUDY_ID, H00127_A893TBM42_DEL_FLG, H00127_n893TBM42_DEL_FLG
            }
            , new Object[] {
            H00128_A49TBM02_DOM_CD, H00128_A610TBM02_DOM_ENM, H00128_n610TBM02_DOM_ENM, H00128_A611TBM02_DOM_JNM, H00128_n611TBM02_DOM_JNM, H00128_A612TBM02_DOM_GRP_NM, H00128_n612TBM02_DOM_GRP_NM, H00128_A613TBM02_NOTE, H00128_n613TBM02_NOTE, H00128_A614TBM02_ORDER,
            H00128_n614TBM02_ORDER
            }
            , new Object[] {
            H00129_A359TBM03_DEL_FLG, H00129_n359TBM03_DEL_FLG, H00129_A59TBM03_DOM_CD, H00129_A60TBM03_DOM_VAR_NM, H00129_A346TBM03_VAR_DESC, H00129_n346TBM03_VAR_DESC, H00129_A347TBM03_SDTM_FLG, H00129_n347TBM03_SDTM_FLG, H00129_A348TBM03_CDASH_FLG, H00129_n348TBM03_CDASH_FLG,
            H00129_A532TBM03_INPUT_TYPE_DIV, H00129_n532TBM03_INPUT_TYPE_DIV, H00129_A349TBM03_REQUIRED_FLG, H00129_n349TBM03_REQUIRED_FLG, H00129_A688TBM03_SAS_FIELD_NM, H00129_n688TBM03_SAS_FIELD_NM, H00129_A709TBM03_ODM_DATA_TYPE, H00129_n709TBM03_ODM_DATA_TYPE, H00129_A350TBM03_NOTE, H00129_n350TBM03_NOTE,
            H00129_A61TBM03_ORDER, H00129_n61TBM03_ORDER, H00129_A932TBM03_VERSION, H00129_n932TBM03_VERSION
            }
            , new Object[] {
            H001210_A204TBM42_DOM_CD, H001210_A203TBM42_STUDY_ID
            }
         }
      );
   ...
   private int[] H00122_A614TBM02_ORDER ;
   private boolean[] H00122_n614TBM02_ORDER ;
   private String[] H00122_A615TBM02_DEL_FLG ;
   private boolean[] H00122_n615TBM02_DEL_FLG ;
   private String[] H00122_A611TBM02_DOM_JNM ;
   private boolean[] H00122_n611TBM02_DOM_JNM ;
   private String[] H00122_A49TBM02_DOM_CD ;
   private long[] H00123_AGRID1_nRecordCount ;
   private String[] H00124_A201TBM43_DOM_CD ;
   private long[] H00124_A200TBM43_STUDY_ID ;
   private String[] H00124_A202TBM43_DOM_VAR_NM ;
   private long[] H00125_A63TBM21_STUDY_ID ;
   private String[] H00125_A367TBM21_STUDY_NM ;
   private boolean[] H00125_n367TBM21_STUDY_NM ;
   private String[] H00126_A49TBM02_DOM_CD ;
   private String[] H00126_A615TBM02_DEL_FLG ;
   private boolean[] H00126_n615TBM02_DEL_FLG ;
   private String[] H00126_A611TBM02_DOM_JNM ;
   private boolean[] H00126_n611TBM02_DOM_JNM ;
   private String[] H00127_A204TBM42_DOM_CD ;
   private long[] H00127_A203TBM42_STUDY_ID ;
   private String[] H00127_A893TBM42_DEL_FLG ;
   private boolean[] H00127_n893TBM42_DEL_FLG ;
   private String[] H00128_A49TBM02_DOM_CD ;
   private String[] H00128_A610TBM02_DOM_ENM ;
   private boolean[] H00128_n610TBM02_DOM_ENM ;
   private String[] H00128_A611TBM02_DOM_JNM ;
   private boolean[] H00128_n611TBM02_DOM_JNM ;
   private String[] H00128_A612TBM02_DOM_GRP_NM ;
   private boolean[] H00128_n612TBM02_DOM_GRP_NM ;
   private String[] H00128_A613TBM02_NOTE ;
   private boolean[] H00128_n613TBM02_NOTE ;
   private int[] H00128_A614TBM02_ORDER ;
   private boolean[] H00128_n614TBM02_ORDER ;
   private String[] H00129_A359TBM03_DEL_FLG ;
   private boolean[] H00129_n359TBM03_DEL_FLG ;
   private String[] H00129_A59TBM03_DOM_CD ;
   private String[] H00129_A60TBM03_DOM_VAR_NM ;
   private String[] H00129_A346TBM03_VAR_DESC ;
   private boolean[] H00129_n346TBM03_VAR_DESC ;
   private String[] H00129_A347TBM03_SDTM_FLG ;
   private boolean[] H00129_n347TBM03_SDTM_FLG ;
   private String[] H00129_A348TBM03_CDASH_FLG ;
   private boolean[] H00129_n348TBM03_CDASH_FLG ;
   private String[] H00129_A532TBM03_INPUT_TYPE_DIV ;
   private boolean[] H00129_n532TBM03_INPUT_TYPE_DIV ;
   private String[] H00129_A349TBM03_REQUIRED_FLG ;
   private boolean[] H00129_n349TBM03_REQUIRED_FLG ;
   private String[] H00129_A688TBM03_SAS_FIELD_NM ;
   private boolean[] H00129_n688TBM03_SAS_FIELD_NM ;
   private String[] H00129_A709TBM03_ODM_DATA_TYPE ;
   private boolean[] H00129_n709TBM03_ODM_DATA_TYPE ;
   private String[] H00129_A350TBM03_NOTE ;
   private boolean[] H00129_n350TBM03_NOTE ;
   private int[] H00129_A61TBM03_ORDER ;
   private boolean[] H00129_n61TBM03_ORDER ;
   private String[] H00129_A932TBM03_VERSION ;
   private boolean[] H00129_n932TBM03_VERSION ;
   private String[] H001210_A204TBM42_DOM_CD ;
   private long[] H001210_A203TBM42_STUDY_ID ;
...
final  class b402_wp12_study_domain_list__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00122", "SELECT `TBM02_ORDER`, `TBM02_DEL_FLG`, `TBM02_DOM_JNM`, `TBM02_DOM_CD` FROM `TBM02_CDISC_DOMAIN` WHERE `TBM02_DEL_FLG` <> '1' ORDER BY `TBM02_ORDER`  LIMIT ?, ?",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00123", "SELECT COUNT(*) FROM `TBM02_CDISC_DOMAIN` WHERE `TBM02_DEL_FLG` <> '1' ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
         ,new ForEachCursor("H00124", "SELECT `TBM43_DOM_CD`, `TBM43_STUDY_ID`, `TBM43_DOM_VAR_NM` FROM `TBM43_STUDY_CDISC_ITEM` WHERE `TBM43_STUDY_ID` = ? and `TBM43_DOM_CD` = ? ORDER BY `TBM43_STUDY_ID`, `TBM43_DOM_CD` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H00125", "SELECT `TBM21_STUDY_ID`, `TBM21_STUDY_NM` FROM `TBM21_STUDY` WHERE `TBM21_STUDY_ID` = ? ORDER BY `TBM21_STUDY_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H00126", "SELECT `TBM02_DOM_CD`, `TBM02_DEL_FLG`, `TBM02_DOM_JNM` FROM `TBM02_CDISC_DOMAIN` WHERE `TBM02_DEL_FLG` <> '1' ORDER BY `TBM02_DOM_CD` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00127", "SELECT `TBM42_DOM_CD`, `TBM42_STUDY_ID`, `TBM42_DEL_FLG` FROM `TBM42_STUDY_CDISC_DOMAIN` WHERE `TBM42_STUDY_ID` = ? and `TBM42_DOM_CD` = ? ORDER BY `TBM42_STUDY_ID`, `TBM42_DOM_CD`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H00128", "SELECT `TBM02_DOM_CD`, `TBM02_DOM_ENM`, `TBM02_DOM_JNM`, `TBM02_DOM_GRP_NM`, `TBM02_NOTE`, `TBM02_ORDER` FROM `TBM02_CDISC_DOMAIN` WHERE `TBM02_DOM_CD` = ? ORDER BY `TBM02_DOM_CD`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H00129", "SELECT `TBM03_DEL_FLG`, `TBM03_DOM_CD`, `TBM03_DOM_VAR_NM`, `TBM03_VAR_DESC`, `TBM03_SDTM_FLG`, `TBM03_CDASH_FLG`, `TBM03_INPUT_TYPE_DIV`, `TBM03_REQUIRED_FLG`, `TBM03_SAS_FIELD_NM`, `TBM03_ODM_DATA_TYPE`, `TBM03_NOTE`, `TBM03_ORDER`, `TBM03_VERSION` FROM `TBM03_CDISC_ITEM` WHERE (`TBM03_DOM_CD` = ?) AND (`TBM03_DEL_FLG` <> '1') ORDER BY `TBM03_DOM_CD` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H001210", "SELECT `TBM42_DOM_CD`, `TBM42_STUDY_ID` FROM `TBM42_STUDY_CDISC_DOMAIN` WHERE `TBM42_STUDY_ID` = ? ORDER BY `TBM42_STUDY_ID`  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
