/*
       ...
       Generated on: July 3, 2017 17:19:45.64
...
public final  class b717_wp01_rekiinfo_crf_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317194575");
   ...
   public void renderHtmlCloseForm1L2( )
   {
      ...
      GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV47Pgmname));
   ...
   public void wb_table1_2_1L2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_191_1L2( true) ;
      }
      else
      {
         wb_table2_191_1L2( false) ;
      }
      return  ;
   }

   public void wb_table2_191_1L2e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
               ...
               if ( GXutil.strcmp(sEvtType, "E") == 0 )
               {
                  ...
                  else
                  {
                     ...
                     if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 10), "GRID1.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                     {
                        ...
                        AV38GXV1 = (short)(nGXsfl_176_idx+GRID1_nFirstRecordOnPage) ;
                        if ( ( AV22W_B717_SD01_REKIINFO_CRF_LIST.size() >= AV38GXV1 ) && ( AV38GXV1 > 0 ) )
                        {
                           AV22W_B717_SD01_REKIINFO_CRF_LIST.currentItem( ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)) );
                           ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).setgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Tbt11_crf_version( (short)(localUtil.ctol( httpContext.cgiGet( edtavCtltbt11_crf_version_Internalname), ".", ",")) );
                           ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).setgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Dm_arrival( httpContext.cgiGet( edtavCtldm_arrival_Internalname) );
                           ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).setgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Input_end( httpContext.cgiGet( edtavCtlinput_end_Internalname) );
                           ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).setgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Tbt11_upload_datetime_vc( httpContext.cgiGet( edtavCtltbt11_upload_datetime_vc_Internalname) );
                           ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).setgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Tam07_user_nm( httpContext.cgiGet( edtavCtltam07_user_nm_Internalname) );
                           ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).setgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Tbt11_upd_riyu( httpContext.cgiGet( edtavCtltbt11_upd_riyu_Internalname) );
                        }
                        sEvtType = GXutil.right( sEvt, 1) ;
                        if ( GXutil.strcmp(sEvtType, ".") == 0 )
                        {
   ...
   public void strup1L0( )
   {
      ...
      AV47Pgmname = "B717_WP01_REKIINFO_CRF" ;
      AV46Pgmdesc = "CRF履歴詳細情報画面" ;
      Gx_err = (short)(0) ;
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         while ( nGXsfl_176_fel_idx < nRC_GXsfl_176 )
         {
            ...
            subsflControlProps_fel_1762( ) ;
            AV38GXV1 = (short)(nGXsfl_176_fel_idx+GRID1_nFirstRecordOnPage) ;
            AV38GXV1 = (short)(nGXsfl_176_fel_idx+GRID1_nFirstRecordOnPage) ;
            if ( ( AV22W_B717_SD01_REKIINFO_CRF_LIST.size() >= AV38GXV1 ) && ( AV38GXV1 > 0 ) )
            {
               AV22W_B717_SD01_REKIINFO_CRF_LIST.currentItem( ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)) );
   ...
   public void e271L2( )
   {
      ...
      {
         new a804_pc01_syslog(remoteHandle, context).execute( AV47Pgmname, "INFO", "画面起動") ;
   ...
   public void S142( )
   {
      ...
      while ( (pr_default.getStatus(5) != 101) )
      {
         ...
         /* Using cursor H001L8 */
         pr_default.execute(6, new Object[] {AV32W_TBT11_UPLOAD_USER_ID});
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV30W_TBT11_CRF_VERSION", GXutil.ltrim( GXutil.str( AV30W_TBT11_CRF_VERSION, 4, 0)));
      AV55GXV9 = 1 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV55GXV9", GXutil.ltrim( GXutil.str( AV55GXV9, 8, 0)));
      while ( AV55GXV9 <= AV22W_B717_SD01_REKIINFO_CRF_LIST.size() )
      {
         AV23W_B717_SD01_REKIINFO_CRF_LIST_Item = (SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV55GXV9));
         AV23W_B717_SD01_REKIINFO_CRF_LIST_Item.setgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Tbt11_crf_version( AV30W_TBT11_CRF_VERSION );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV23W_B717_SD01_REKIINFO_CRF_LIST_Item", AV23W_B717_SD01_REKIINFO_CRF_LIST_Item);
   ...
   private void e281L2( )
   {
      /* Grid1_Load Routine */
      AV38GXV1 = (short)(1) ;
      while ( AV38GXV1 <= AV22W_B717_SD01_REKIINFO_CRF_LIST.size() )
      {
         AV22W_B717_SD01_REKIINFO_CRF_LIST.currentItem( ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)) );
         ...
         AV38GXV1 = (short)(AV38GXV1+1) ;
      }
   }

   public void wb_table2_191_1L2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 195,'',false,'" + sGXsfl_176_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV14H_INIT_FLG), GXutil.rtrim( localUtil.format( AV14H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(195);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_init_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_B717_WP01_REKIINFO_CRF.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 196,'',false,'" + sGXsfl_176_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV15H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV15H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(196);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 30, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_B717_WP01_REKIINFO_CRF.htm");
         httpContext.writeText( "<br>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 197,'',false,'" + sGXsfl_176_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlrec_cnt_Internalname, GXutil.ltrim( localUtil.ntoc( AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Rec_cnt(), (byte)(10), (byte)(0), ".", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV13H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Rec_cnt()), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(197);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtlrec_cnt_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_B717_WP01_REKIINFO_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_191_1L2e( true) ;
      }
      else
      {
         wb_table2_191_1L2e( false) ;
      }
   }
   ...
   public void wb_table9_162_1L2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock35_Internalname, "DM到着", "", "", lblTextblock35_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader_s", 0, "", 1, 1, (short)(0), "HLP_B717_WP01_REKIINFO_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:70px\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock38_Internalname, "データ固定", "", "", lblTextblock38_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader_s", 0, "", 1, 1, (short)(0), "HLP_B717_WP01_REKIINFO_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:155px\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock36_Internalname, "更新日", "", "", lblTextblock36_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader_s", 0, "", 1, 1, (short)(0), "HLP_B717_WP01_REKIINFO_CRF.htm");
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table7_32_1L2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 40,'',false,'" + sGXsfl_176_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_study_nm_Internalname, GXutil.rtrim( AV11D_STUDY_NM), GXutil.rtrim( localUtil.format( AV11D_STUDY_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(40);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_study_nm_Jsonclick, 0, "Attribute", "", "", "", 1, edtavD_study_nm_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_B717_WP01_REKIINFO_CRF.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td class=\"ItemTitle\"  style=\"width:60px\">") ;
         /* Text block */
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 44,'',false,'" + sGXsfl_176_idx + "',0)\"" ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 49,'',false,'" + sGXsfl_176_idx + "',0)\"" ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 53,'',false,'" + sGXsfl_176_idx + "',0)\"" ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 58,'',false,'" + sGXsfl_176_idx + "',0)\"" ;
         ...
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 62,'',false,'" + sGXsfl_176_idx + "',0)\"" ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317195076");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b717_wp01_rekiinfo_crf.js", "?20177317195078");
      /* End function include_jscripts */
   }

   public void subsflControlProps_1762( )
   {
      edtavCtltbt11_crf_version_Internalname = "CTLTBT11_CRF_VERSION_"+sGXsfl_176_idx ;
      edtavCtldm_arrival_Internalname = "CTLDM_ARRIVAL_"+sGXsfl_176_idx ;
      edtavCtlinput_end_Internalname = "CTLINPUT_END_"+sGXsfl_176_idx ;
      edtavCtltbt11_upload_datetime_vc_Internalname = "CTLTBT11_UPLOAD_DATETIME_VC_"+sGXsfl_176_idx ;
      edtavCtltam07_user_nm_Internalname = "CTLTAM07_USER_NM_"+sGXsfl_176_idx ;
      edtavCtltbt11_upd_riyu_Internalname = "CTLTBT11_UPD_RIYU_"+sGXsfl_176_idx ;
   }

   public void subsflControlProps_fel_1762( )
   {
      edtavCtltbt11_crf_version_Internalname = "CTLTBT11_CRF_VERSION_"+sGXsfl_176_fel_idx ;
      edtavCtldm_arrival_Internalname = "CTLDM_ARRIVAL_"+sGXsfl_176_fel_idx ;
      edtavCtlinput_end_Internalname = "CTLINPUT_END_"+sGXsfl_176_fel_idx ;
      edtavCtltbt11_upload_datetime_vc_Internalname = "CTLTBT11_UPLOAD_DATETIME_VC_"+sGXsfl_176_fel_idx ;
      edtavCtltam07_user_nm_Internalname = "CTLTAM07_USER_NM_"+sGXsfl_176_fel_idx ;
      edtavCtltbt11_upd_riyu_Internalname = "CTLTBT11_UPD_RIYU_"+sGXsfl_176_fel_idx ;
   }
   ...
   public void sendrow_1762( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_176_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavCtldm_arrival_Internalname,GXutil.rtrim( ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).getgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Dm_arrival()),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavCtldm_arrival_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavCtldm_arrival_Enabled),new Integer(0),"text","",new Integer(1),"chr",new Integer(1),"row",new Integer(1),new Integer(0),new Integer(0),new Integer(176),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavCtlinput_end_Internalname,GXutil.rtrim( ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).getgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Input_end()),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavCtlinput_end_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavCtlinput_end_Enabled),new Integer(0),"text","",new Integer(1),"chr",new Integer(1),"row",new Integer(1),new Integer(0),new Integer(0),new Integer(176),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavCtltbt11_upload_datetime_vc_Internalname,GXutil.rtrim( ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).getgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Tbt11_upload_datetime_vc()),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavCtltbt11_upload_datetime_vc_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavCtltbt11_upload_datetime_vc_Enabled),new Integer(0),"text","",new Integer(20),"chr",new Integer(1),"row",new Integer(20),new Integer(0),new Integer(0),new Integer(176),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         Grid1Row.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"",""+" style=\"width:210px\""});
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavCtltam07_user_nm_Internalname,GXutil.rtrim( ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).getgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Tam07_user_nm()),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavCtltam07_user_nm_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavCtltam07_user_nm_Enabled),new Integer(0),"text","",new Integer(210),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(176),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         Grid1Row.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"",""+" style=\"width:255px\""});
         /* Multiple line edit */
         ClassString = "Attribute" ;
         StyleString = "" ;
         ClassString = "Attribute" ;
         StyleString = "" ;
         Grid1Row.AddColumnProperties("html_textarea", 1, isAjaxCallMode( ), new Object[] {edtavCtltbt11_upd_riyu_Internalname,GXutil.rtrim( ((SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem)AV22W_B717_SD01_REKIINFO_CRF_LIST.elementAt(-1+AV38GXV1)).getgxTv_SdtB717_SD01_REKIINFO_CRF_LIST_B717_SD01_REKIINFO_CRF_LISTItem_Tbt11_upd_riyu()),"","",new Integer(0),new Integer(1),new Integer(edtavCtltbt11_upd_riyu_Enabled),new Integer(0),new Integer(250),"px",new Integer(3),"row",StyleString,ClassString,"","2000",new Integer(1),"","",new Integer(-1),new Boolean(true),""});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b717_wp01_rekiinfo_crf__default(),
         new Object[] {
            ...
            H001L7_A675TBT11_INPUT_END_FLG, H001L7_n675TBT11_INPUT_END_FLG, H001L7_A666TBT11_UPLOAD_DATETIME, H001L7_n666TBT11_UPLOAD_DATETIME, H001L7_A667TBT11_UPLOAD_USER_ID, H001L7_n667TBT11_UPLOAD_USER_ID, H001L7_A891TBT11_UPD_RIYU, H001L7_n891TBT11_UPD_RIYU, H001L7_A95TBT11_CRF_VERSION
            }
            , new Object[] {
...
final  class b717_wp01_rekiinfo_crf__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H001L7", "SELECT `TBT11_STUDY_ID`, `TBT11_SUBJECT_ID`, `TBT11_CRF_ID`, `TBT11_CRF_EDA_NO`, `TBT11_DEL_FLG`, `TBT11_DM_ARRIVAL_DATETIME`, `TBT11_DM_ARRIVAL_FLG`, `TBT11_INPUT_END_FLG`, `TBT11_UPLOAD_DATETIME`, `TBT11_UPLOAD_USER_ID`, `TBT11_UPD_RIYU`, `TBT11_CRF_VERSION` FROM `TBT11_CRF_HISTORY` WHERE (`TBT11_STUDY_ID` = ? and `TBT11_SUBJECT_ID` = ? and `TBT11_CRF_ID` = ?) AND (Not (`TBT11_DM_ARRIVAL_DATETIME` = '1000-01-01')) AND (`TBT11_CRF_EDA_NO` = ?) AND (`TBT11_DEL_FLG` = '0') ORDER BY `TBT11_STUDY_ID`, `TBT11_SUBJECT_ID`, `TBT11_CRF_ID`, `TBT11_CRF_VERSION` DESC ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
