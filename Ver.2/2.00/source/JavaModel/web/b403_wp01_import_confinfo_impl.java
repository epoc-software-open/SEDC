...
public final  class b403_wp01_import_confinfo_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2017731718641");
   ...
   public void S142( )
   {
      ...
      {
         AV27GXV1 = 1 ;
         httpContext.ajax_rsp_assign_attri("", false, "AV27GXV1", GXutil.ltrim( GXutil.str( AV27GXV1, 8, 0)));
   ...
   public void S122( )
   {
      ...
      GXv_char6[0] = AV16W_ERRCD ;
      new a402_pc01_kengen_check(remoteHandle, context).execute( AV6C_APP_ID, GXv_char1, GXv_char6) ;
      b403_wp01_import_confinfo_impl.this.AV10H_KNGN_FLG = GXv_char1[0] ;
      b403_wp01_import_confinfo_impl.this.AV16W_ERRCD = GXv_char6[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV6C_APP_ID", AV6C_APP_ID);
      httpContext.ajax_rsp_assign_attri("", false, "AV10H_KNGN_FLG", AV10H_KNGN_FLG);
      httpContext.ajax_rsp_assign_attri("", false, "AV16W_ERRCD", AV16W_ERRCD);
      if ( GXutil.strcmp(AV16W_ERRCD, "0") != 0 )
   ...
   public void S172( )
   {
      ...
      b403_wp01_import_confinfo_impl.this.GXt_boolean7 = GXv_boolean8[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV10H_KNGN_FLG", AV10H_KNGN_FLG);
      lblTxt_btn_import_Visible = (GXt_boolean7 ? 1 : 0) ;
      httpContext.ajax_rsp_assign_prop("", false, lblTxt_btn_import_Internalname, "Visible", GXutil.ltrim( GXutil.str( lblTxt_btn_import_Visible, 5, 0)));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2017731718685");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b403_wp01_import_confinfo.js", "?2017731718685");
...
final  class b403_wp01_import_confinfo__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H001F3", "SELECT `TBM21_DEL_FLG`, `TBM21_STATUS`, `TBM21_STUDY_ID`, `TBM21_STUDY_NM` FROM `TBM21_STUDY` WHERE (`TBM21_STUDY_ID` = ?) AND (`TBM21_STATUS` IN ('0','1')) AND (`TBM21_DEL_FLG` = '0') ORDER BY `TBM21_STUDY_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
