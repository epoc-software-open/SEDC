...
public final  class a212_wp01_cdisc_item_list_impl extends GXWebPanel
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            nRC_GXsfl_193 = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            ...
            gxnrgrid1_newrow( nRC_GXsfl_193, nGXsfl_193_idx, sGXsfl_193_idx) ;
            return  ;
         }
         else
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeValue( "ドメイン変数マスタメンテナンス（一覧）") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317202638");
   ...
   public void renderHtmlCloseForm1W2( )
   {
      ...
      GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_193", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_193, (byte)(4), (byte)(0), ".", "")));
      GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV51Pgmname));
   ...
   public void wb_table1_2_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_217_1W2( true) ;
      }
      else
      {
         wb_table2_217_1W2( false) ;
      }
      return  ;
   }

   public void wb_table2_217_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
   ...
   public void pa1W2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         {
            AV15D_SORT = cmbavD_sort.getValidValue(AV15D_SORT) ;
   ...
   public void gxnrgrid1_newrow( short nRC_GXsfl_193 ,
   ...
   public void strup1W0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         /* Read saved values. */
         nRC_GXsfl_193 = (short)(localUtil.ctol( httpContext.cgiGet( "nRC_GXsfl_193"), ".", ",")) ;
   ...
   public void e151W2( )
   {
      ...
      if ( AV44SD_A212_SD01_LIST_C.size() > 0 )
      {
         ...
         {
            AV53GXV3 = 1 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV53GXV3", GXutil.ltrim( GXutil.str( AV53GXV3, 8, 0)));
   ...
   public void S212( )
   {
      ...
      AV56GXLvl559 = (byte)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV56GXLvl559", GXutil.str( AV56GXLvl559, 1, 0));
   ...
   public void wb_table2_217_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV20H_INIT_FLG), GXutil.rtrim( localUtil.format( AV20H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(221);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_init_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 222,'',false,'" + sGXsfl_193_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_srch_flg_Internalname, GXutil.rtrim( AV23H_SRCH_FLG), GXutil.rtrim( localUtil.format( AV23H_SRCH_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(222);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_srch_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 223,'',false,'" + sGXsfl_193_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_kngn_flg_Internalname, GXutil.rtrim( AV21H_KNGN_FLG), GXutil.rtrim( localUtil.format( AV21H_KNGN_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(223);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_kngn_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 224,'',false,'" + sGXsfl_193_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_dom_cd_Internalname, GXutil.rtrim( AV18H_DOM_CD), GXutil.rtrim( localUtil.format( AV18H_DOM_CD, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(224);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_dom_cd_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 225,'',false,'" + sGXsfl_193_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_dom_var_nm_Internalname, GXutil.rtrim( AV19H_DOM_VAR_NM), GXutil.rtrim( localUtil.format( AV19H_DOM_VAR_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(225);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_dom_var_nm_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 226,'',false,'" + sGXsfl_193_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_var_desc_Internalname, GXutil.rtrim( AV24H_VAR_DESC), GXutil.rtrim( localUtil.format( AV24H_VAR_DESC, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(226);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_var_desc_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 227,'',false,'" + sGXsfl_193_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_sort_Internalname, GXutil.rtrim( AV22H_SORT), GXutil.rtrim( localUtil.format( AV22H_SORT, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(227);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_sort_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         wb_table3_228_1W2( true) ;
      }
      else
      {
         wb_table3_228_1W2( false) ;
      }
      return  ;
   }

   public void wb_table3_228_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         wb_table2_217_1W2e( true) ;
      }
      else
      {
         wb_table2_217_1W2e( false) ;
      }
   }

   public void wb_table3_228_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavCtlmax_row_Internalname, GXutil.ltrim( localUtil.ntoc( AV17H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Max_row(), (byte)(4), (byte)(0), ".", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV17H_A_PAGING_SDT.getgxTv_SdtA_PAGING_SDT_Max_row()), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(233);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtlmax_row_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_228_1W2e( true) ;
      }
      else
      {
         wb_table3_228_1W2e( false) ;
      }
   }
   ...
   public void wb_table5_12_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\"vertical-align:top;height:100%\">") ;
         wb_table6_28_1W2( true) ;
      }
      else
      {
         wb_table6_28_1W2( false) ;
      }
      return  ;
   }

   public void wb_table6_28_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table6_28_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table7_31_1W2( true) ;
      }
      else
      {
         wb_table7_31_1W2( false) ;
      }
      return  ;
   }

   public void wb_table7_31_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table6_28_1W2e( true) ;
      }
      else
      {
         wb_table6_28_1W2e( false) ;
      }
   }

   public void wb_table7_31_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table8_34_1W2( true) ;
      }
      else
      {
         wb_table8_34_1W2( false) ;
      }
      return  ;
   }

   public void wb_table8_34_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table9_65_1W2( true) ;
      }
      else
      {
         wb_table9_65_1W2( false) ;
      }
      return  ;
   }

   public void wb_table9_65_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td align=\"right\" >") ;
         wb_table10_157_1W2( true) ;
      }
      else
      {
         wb_table10_157_1W2( false) ;
      }
      return  ;
   }

   public void wb_table10_157_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td colspan=\"2\" >") ;
         wb_table11_171_1W2( true) ;
      }
      else
      {
         wb_table11_171_1W2( false) ;
      }
      return  ;
   }

   public void wb_table11_171_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
      ...
      {
         wbEnd = (short)(0) ;
         nRC_GXsfl_193 = (short)(nGXsfl_193_idx-1) ;
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "</table>") ;
            httpContext.writeText( "</div>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table7_31_1W2e( true) ;
      }
      else
      {
         wb_table7_31_1W2e( false) ;
      }
   }

   public void wb_table11_171_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table12_174_1W2( true) ;
      }
      else
      {
         wb_table12_174_1W2( false) ;
      }
      return  ;
   }

   public void wb_table12_174_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table11_171_1W2e( true) ;
      }
      else
      {
         wb_table11_171_1W2e( false) ;
      }
   }

   public void wb_table12_174_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock34_Internalname, "行", "", "", lblTextblock34_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:85px\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock30_Internalname, "ドメインコード", "", "", lblTextblock30_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:150px\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock31_Internalname, "ドメイン変数名", "", "", lblTextblock31_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:300px\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock32_Internalname, "ドメイン変数説明", "", "", lblTextblock32_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:50px\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock35_Internalname, "表示順", "", "", lblTextblock35_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock33_Internalname, "削除フラグ", "", "", lblTextblock33_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockGridHeader", 0, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table12_174_1W2e( true) ;
      }
      else
      {
         wb_table12_174_1W2e( false) ;
      }
   }

   public void wb_table10_157_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock29_Internalname, "行番号：", "", "", lblTextblock29_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 162,'',false,'" + sGXsfl_193_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavD_line_Internalname, GXutil.rtrim( AV14D_LINE), GXutil.rtrim( localUtil.format( AV14D_LINE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(162);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavD_line_Jsonclick, 0, "AttributeNum", "background:"+WebUtils.getHTMLColor( edtavD_line_Backcolor)+";", "", "", 1, 1, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:5px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"vertical-align:bottom\">") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock28_Internalname, "編集（F7）", "", "", lblTextblock28_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_EDIT\\'."+"'", "", "TextBlockBtn060", 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table10_157_1W2e( true) ;
      }
      else
      {
         wb_table10_157_1W2e( false) ;
      }
   }

   public void wb_table9_65_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table13_71_1W2( true) ;
      }
      else
      {
         wb_table13_71_1W2( false) ;
      }
      return  ;
   }

   public void wb_table13_71_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table9_65_1W2e( true) ;
      }
      else
      {
         wb_table9_65_1W2e( false) ;
      }
   }

   public void wb_table13_71_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table14_74_1W2( true) ;
      }
      else
      {
         wb_table14_74_1W2( false) ;
      }
      return  ;
   }

   public void wb_table14_74_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:46px\">") ;
         wb_table15_80_1W2( true) ;
      }
      else
      {
         wb_table15_80_1W2( false) ;
      }
      return  ;
   }

   public void wb_table15_80_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table16_86_1W2( true) ;
      }
      else
      {
         wb_table16_86_1W2( false) ;
      }
      return  ;
   }

   public void wb_table16_86_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table17_92_1W2( true) ;
      }
      else
      {
         wb_table17_92_1W2( false) ;
      }
      return  ;
   }

   public void wb_table17_92_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table18_98_1W2( true) ;
      }
      else
      {
         wb_table18_98_1W2( false) ;
      }
      return  ;
   }

   public void wb_table18_98_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table19_104_1W2( true) ;
      }
      else
      {
         wb_table19_104_1W2( false) ;
      }
      return  ;
   }

   public void wb_table19_104_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table20_110_1W2( true) ;
      }
      else
      {
         wb_table20_110_1W2( false) ;
      }
      return  ;
   }

   public void wb_table20_110_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table21_116_1W2( true) ;
      }
      else
      {
         wb_table21_116_1W2( false) ;
      }
      return  ;
   }

   public void wb_table21_116_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table22_122_1W2( true) ;
      }
      else
      {
         wb_table22_122_1W2( false) ;
      }
      return  ;
   }

   public void wb_table22_122_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table23_128_1W2( true) ;
      }
      else
      {
         wb_table23_128_1W2( false) ;
      }
      return  ;
   }

   public void wb_table23_128_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table24_134_1W2( true) ;
      }
      else
      {
         wb_table24_134_1W2( false) ;
      }
      return  ;
   }

   public void wb_table24_134_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table25_140_1W2( true) ;
      }
      else
      {
         wb_table25_140_1W2( false) ;
      }
      return  ;
   }

   public void wb_table25_140_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table26_146_1W2( true) ;
      }
      else
      {
         wb_table26_146_1W2( false) ;
      }
      return  ;
   }

   public void wb_table26_146_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table27_152_1W2( true) ;
      }
      else
      {
         wb_table27_152_1W2( false) ;
      }
      return  ;
   }

   public void wb_table27_152_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table13_71_1W2e( true) ;
      }
      else
      {
         wb_table13_71_1W2e( false) ;
      }
   }

   public void wb_table27_152_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_last_Internalname, "最後へ", "", "", lblTxt_last_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE_LAST\\'."+"'", "", lblTxt_last_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table27_152_1W2e( true) ;
      }
      else
      {
         wb_table27_152_1W2e( false) ;
      }
   }

   public void wb_table26_146_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_next_Internalname, "次へ", "", "", lblTxt_next_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE_NEXT\\'."+"'", "", lblTxt_next_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table26_146_1W2e( true) ;
      }
      else
      {
         wb_table26_146_1W2e( false) ;
      }
   }

   public void wb_table25_140_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table25_140_1W2e( true) ;
      }
      else
      {
         wb_table25_140_1W2e( false) ;
      }
   }

   public void wb_table24_134_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table24_134_1W2e( true) ;
      }
      else
      {
         wb_table24_134_1W2e( false) ;
      }
   }

   public void wb_table23_128_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table23_128_1W2e( true) ;
      }
      else
      {
         wb_table23_128_1W2e( false) ;
      }
   }

   public void wb_table22_122_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table22_122_1W2e( true) ;
      }
      else
      {
         wb_table22_122_1W2e( false) ;
      }
   }

   public void wb_table21_116_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table21_116_1W2e( true) ;
      }
      else
      {
         wb_table21_116_1W2e( false) ;
      }
   }

   public void wb_table20_110_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table20_110_1W2e( true) ;
      }
      else
      {
         wb_table20_110_1W2e( false) ;
      }
   }

   public void wb_table19_104_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table19_104_1W2e( true) ;
      }
      else
      {
         wb_table19_104_1W2e( false) ;
      }
   }

   public void wb_table18_98_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table18_98_1W2e( true) ;
      }
      else
      {
         wb_table18_98_1W2e( false) ;
      }
   }

   public void wb_table17_92_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table17_92_1W2e( true) ;
      }
      else
      {
         wb_table17_92_1W2e( false) ;
      }
   }

   public void wb_table16_86_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table16_86_1W2e( true) ;
      }
      else
      {
         wb_table16_86_1W2e( false) ;
      }
   }

   public void wb_table15_80_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_back_Internalname, "前へ", "", "", lblTxt_back_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE_BACK\\'."+"'", "", lblTxt_back_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table15_80_1W2e( true) ;
      }
      else
      {
         wb_table15_80_1W2e( false) ;
      }
   }

   public void wb_table14_74_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_first_Internalname, "最初へ", "", "", lblTxt_first_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGE_FIRST\\'."+"'", "", lblTxt_first_Class, 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:3px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table14_74_1W2e( true) ;
      }
      else
      {
         wb_table14_74_1W2e( false) ;
      }
   }

   public void wb_table8_34_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( httpContext, cmbavD_dom_cd, cmbavD_dom_cd.getInternalname(), GXutil.rtrim( AV7D_DOM_CD), 1, cmbavD_dom_cd.getJsonclick(), 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, 1, 0, (short)(0), 2, "chr", 0, "", "", "Attribute", "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(38);\"", "", true, "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         ...
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( httpContext, cmbavD_sort, cmbavD_sort.getInternalname(), GXutil.rtrim( AV15D_SORT), 1, cmbavD_sort.getJsonclick(), 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, 1, 0, (short)(0), 1, "chr", 0, "", "", "Attribute", "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(50);\"", "", true, "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         cmbavD_sort.setValue( GXutil.rtrim( AV15D_SORT) );
         ...
         wb_table28_53_1W2( true) ;
      }
      else
      {
         wb_table28_53_1W2( false) ;
      }
      return  ;
   }

   public void wb_table28_53_1W2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table8_34_1W2e( true) ;
      }
      else
      {
         wb_table8_34_1W2e( false) ;
      }
   }

   public void wb_table28_53_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock45_Internalname, "検索（F5）", "", "", lblTextblock45_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_SRCH\\'."+"'", "background:transparent;", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock44_Internalname, "クリア（F6）", "", "", lblTextblock44_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_CLER\\'."+"'", "", "TextBlockBtn100", 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table28_53_1W2e( true) ;
      }
      else
      {
         wb_table28_53_1W2e( false) ;
      }
   }
   ...
   public void wb_table5_12_1W2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_reg_Internalname, "新規（F3）", "", "", lblTxt_btn_reg_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_REG\\'."+"'", "", "TextBlockBtn100", 5, "", lblTxt_btn_reg_Visible, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_btn_reg2_Internalname, "新規（F3）", "", "", lblTxt_btn_reg2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockBtnList100_Disabled", 0, "", lblTxt_btn_reg2_Visible, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock43_Internalname, "CSV出力（F4）", "", "", lblTextblock43_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_CSV\\'."+"'", "", "TextBlockBtn120", 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTextblock47_Internalname, "ドメイン変数取込（F8）", "", "", lblTextblock47_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_IMPORT_CDISC_ITEM\\'."+"'", "", "TextBlockBtn150", 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td style=\"width:10px\">") ;
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblBtn_domain_Internalname, "ドメインマスタメンテナンス（F9）", "", "", lblBtn_domain_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BTN_DOMAIN\\'."+"'", "", "TextBlockBtnList200", 5, "", 1, 1, (short)(0), "HLP_A212_WP01_CDISC_ITEM_LIST.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317203271");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a212_wp01_cdisc_item_list.js", "?20177317203271");
      /* End function include_jscripts */
   }

   public void subsflControlProps_1932( )
   {
   ...
   public void subsflControlProps_fel_1932( )
   {
      lblBtn_sel_Internalname = "BTN_SEL_"+sGXsfl_193_fel_idx ;
      edtavD_grd_line_Internalname = "vD_GRD_LINE_"+sGXsfl_193_fel_idx ;
      edtavD_grd_dom_cd_Internalname = "vD_GRD_DOM_CD_"+sGXsfl_193_fel_idx ;
      edtavD_grd_dom_var_nm_Internalname = "vD_GRD_DOM_VAR_NM_"+sGXsfl_193_fel_idx ;
      edtavD_grd_var_desc_Internalname = "vD_GRD_VAR_DESC_"+sGXsfl_193_fel_idx ;
      edtavD_grd_order_Internalname = "vD_GRD_ORDER_"+sGXsfl_193_fel_idx ;
      edtavD_grd_version_Internalname = "vD_GRD_VERSION_"+sGXsfl_193_fel_idx ;
      edtavD_grd_del_Internalname = "vD_GRD_DEL_"+sGXsfl_193_fel_idx ;
   }
   ...
   public void sendrow_1932( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_193_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         else if ( subGrid1_Backcolorstyle == 3 )
         {
            ...
            subGrid1_Backstyle = (byte)(1) ;
            if ( ((int)(((nGXsfl_193_idx-1)/ (double) (1)) % (2))) == 0 )
            {
               subGrid1_Backcolor = (int)(0xFFFFFF) ;
               if ( GXutil.strcmp(subGrid1_Class, "") != 0 )
               {
         ...
         /* Text block */
         Grid1Row.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {lblBtn_sel_Internalname,"選択","","",lblBtn_sel_Jsonclick,"'"+""+"'"+",false,"+"'"+"E\\'BTN_SEL\\'."+sGXsfl_193_idx+"'","","TextBlockBtn040s",new Integer(5),"",new Integer(1),new Integer(1),new Integer(0)});
         if ( Grid1Container.GetWrapped() == 1 )
         {
         ...
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_line_Internalname,GXutil.ltrim( localUtil.ntoc( AV11D_GRD_LINE, (byte)(4), (byte)(0), ".", "")),((edtavD_grd_line_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV11D_GRD_LINE), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV11D_GRD_LINE), "ZZZ9")),TempTags+((edtavD_grd_line_Enabled!=0)&&(edtavD_grd_line_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_line_Enabled!=0)&&(edtavD_grd_line_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(198);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_line_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_line_Enabled),new Integer(0),"text","",new Integer(4),"chr",new Integer(1),"row",new Integer(4),new Integer(0),new Integer(0),new Integer(193),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_dom_cd_Internalname,GXutil.rtrim( AV39D_GRD_DOM_CD),"",TempTags+((edtavD_grd_dom_cd_Enabled!=0)&&(edtavD_grd_dom_cd_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_dom_cd_Enabled!=0)&&(edtavD_grd_dom_cd_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(200);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_dom_cd_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_dom_cd_Enabled),new Integer(0),"text","",new Integer(2),"chr",new Integer(1),"row",new Integer(2),new Integer(0),new Integer(0),new Integer(193),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_dom_var_nm_Internalname,GXutil.rtrim( AV40D_GRD_DOM_VAR_NM),"",TempTags+((edtavD_grd_dom_var_nm_Enabled!=0)&&(edtavD_grd_dom_var_nm_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_dom_var_nm_Enabled!=0)&&(edtavD_grd_dom_var_nm_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(202);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_dom_var_nm_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_dom_var_nm_Enabled),new Integer(0),"text","",new Integer(50),"chr",new Integer(1),"row",new Integer(50),new Integer(0),new Integer(0),new Integer(193),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_var_desc_Internalname,GXutil.rtrim( AV41D_GRD_VAR_DESC),"",TempTags+((edtavD_grd_var_desc_Enabled!=0)&&(edtavD_grd_var_desc_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_var_desc_Enabled!=0)&&(edtavD_grd_var_desc_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(204);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_var_desc_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_var_desc_Enabled),new Integer(0),"text","",new Integer(80),"chr",new Integer(1),"row",new Integer(100),new Integer(0),new Integer(0),new Integer(193),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_version_Internalname,GXutil.rtrim( AV43D_GRD_VERSION),"",TempTags+((edtavD_grd_version_Enabled!=0)&&(edtavD_grd_version_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_version_Enabled!=0)&&(edtavD_grd_version_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(208);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_version_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_version_Enabled),new Integer(0),"text","",new Integer(20),"chr",new Integer(1),"row",new Integer(20),new Integer(0),new Integer(0),new Integer(193),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
         ...
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_del_Internalname,GXutil.rtrim( AV10D_GRD_DEL),"",TempTags+((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavD_grd_del_Enabled!=0)&&(edtavD_grd_del_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(210);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_del_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(edtavD_grd_del_Enabled),new Integer(0),"text","",new Integer(10),"chr",new Integer(1),"row",new Integer(10),new Integer(0),new Integer(0),new Integer(193),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
            Grid1Container.CloseTag("cell");
         }
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new a212_wp01_cdisc_item_list__default(),
         new Object[] {
            ...
            , new Object[] {
            H001W3_A346TBM03_VAR_DESC, H001W3_n346TBM03_VAR_DESC, H001W3_A60TBM03_DOM_VAR_NM, H001W3_A59TBM03_DOM_CD, H001W3_A359TBM03_DEL_FLG, H001W3_n359TBM03_DEL_FLG, H001W3_A61TBM03_ORDER, H001W3_n61TBM03_ORDER, H001W3_A932TBM03_VERSION, H001W3_n932TBM03_VERSION
            }
            , new Object[] {
   ...
   private short nGXsfl_193_Refreshing=0 ;
...
final  class a212_wp01_cdisc_item_list__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 1 :
                  return conditional_H001W3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] );
            case 2 :
