...
public final  class a104_wp01_header_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317123851");
      if ( GXutil.len( sPrefix) == 0 )
      {
   ...
   public void renderHtmlCloseForm0A2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("a104_wp01_header.js", "?20177317123853");
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317123893");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   {
      httpContext.AddJavascriptSource("a104_wp01_header.js", "?20177317123893");
