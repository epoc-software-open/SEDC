...
public final  class b404_wp02_crfcond_reg_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317174368");
   ...
   public void wb_table6_30_192( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtavCtltbm33_prior_no_Internalname, GXutil.ltrim( localUtil.ntoc( AV5BC_CRF_COND.getgxTv_SdtTBM33_CRF_COND_Tbm33_prior_no(), (byte)(2), (byte)(0), ".", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV5BC_CRF_COND.getgxTv_SdtTBM33_CRF_COND_Tbm33_prior_no()), "Z9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtltbm33_prior_no_Jsonclick, 0, "AttributeNum", "", "", "", 1, 1, 0, "text", "", 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_B404_WP02_CRFCOND_REG.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"ItemTitle\" >") ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317174978");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b404_wp02_crfcond_reg.js", "?20177317174978");
