...
public final  class tbw16_dom_map_visit_impl extends GXWebPanel
{
   ...
   public void draw( )
   {
      ...
      if ( ! GxWebStd.gx_redirect( httpContext) )
      {
         ...
         renderHtmlHeaders( ) ;
         renderHtmlOpenForm( ) ;
         wb_table1_2_1M65( true) ;
      }
      return  ;
   }

   public void wb_table1_2_1M65e( boolean wbgen )
   {
      if ( wbgen )
      {
         renderHtmlCloseForm1M65( ) ;
      }
      /* Execute Exit event if defined. */
   }

   public void wb_table1_2_1M65( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table2_5_1M65( true) ;
      }
      return  ;
   }

   public void wb_table2_5_1M65e( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Control Group */
         ...
         wb_table3_28_1M65( true) ;
      }
      return  ;
   }

   public void wb_table3_28_1M65e( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table1_2_1M65e( true) ;
      }
      else
      {
         wb_table1_2_1M65e( false) ;
      }
   }

   public void wb_table3_28_1M65( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td>") ;
         wb_table4_34_1M65( true) ;
      }
      return  ;
   }

   public void wb_table4_34_1M65e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_28_1M65e( true) ;
      }
      else
      {
         wb_table3_28_1M65e( false) ;
      }
   }

   public void wb_table4_34_1M65( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBW16_CRF_ITEM_GRP_CD_Internalname, GXutil.rtrim( A968TBW16_CRF_ITEM_GRP_CD), GXutil.rtrim( localUtil.format( A968TBW16_CRF_ITEM_GRP_CD, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(64);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBW16_CRF_ITEM_GRP_CD_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBW16_CRF_ITEM_GRP_CD_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_CRF_ITEM_GRP_CD", "left", "HLP_TBW16_DOM_MAP_VISIT.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTBW16_VISIT_NO_Internalname, GXutil.ltrim( localUtil.ntoc( A969TBW16_VISIT_NO, (byte)(6), (byte)(0), ".", "")), ((edtTBW16_VISIT_NO_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A969TBW16_VISIT_NO), "ZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A969TBW16_VISIT_NO), "ZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTBW16_VISIT_NO_Jsonclick, 0, "Attribute", "", "", "", 1, edtTBW16_VISIT_NO_Enabled, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_VISIT_NO", "right", "HLP_TBW16_DOM_MAP_VISIT.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_34_1M65e( true) ;
      }
      else
      {
         wb_table4_34_1M65e( false) ;
      }
   }

   public void wb_table2_5_1M65( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_5_1M65e( true) ;
      }
      else
      {
         wb_table2_5_1M65e( false) ;
      }
   }
   ...
   public void standaloneStartupServer( )
   {
      ...
      if ( AnyError == 0 )
      {
         if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
         {
            ...
            A968TBW16_CRF_ITEM_GRP_CD = httpContext.cgiGet( edtTBW16_CRF_ITEM_GRP_CD_Internalname) ;
            httpContext.ajax_rsp_assign_attri("", false, "A968TBW16_CRF_ITEM_GRP_CD", A968TBW16_CRF_ITEM_GRP_CD);
            if ( ( ( localUtil.ctol( httpContext.cgiGet( edtTBW16_VISIT_NO_Internalname), ".", ",") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtTBW16_VISIT_NO_Internalname), ".", ",") > 999999 ) ) )
            {
               ...
               httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true ;
               A969TBW16_VISIT_NO = 0 ;
               n969TBW16_VISIT_NO = false ;
               httpContext.ajax_rsp_assign_attri("", false, "A969TBW16_VISIT_NO", GXutil.ltrim( GXutil.str( A969TBW16_VISIT_NO, 6, 0)));
            }
            else
            {
               A969TBW16_VISIT_NO = (int)(localUtil.ctol( httpContext.cgiGet( edtTBW16_VISIT_NO_Internalname), ".", ",")) ;
               n969TBW16_VISIT_NO = false ;
               httpContext.ajax_rsp_assign_attri("", false, "A969TBW16_VISIT_NO", GXutil.ltrim( GXutil.str( A969TBW16_VISIT_NO, 6, 0)));
            }
            n969TBW16_VISIT_NO = ((0==A969TBW16_VISIT_NO) ? true : false) ;
            ...
            Z968TBW16_CRF_ITEM_GRP_CD = httpContext.cgiGet( "Z968TBW16_CRF_ITEM_GRP_CD") ;
            Z969TBW16_VISIT_NO = (int)(localUtil.ctol( httpContext.cgiGet( "Z969TBW16_VISIT_NO"), ".", ",")) ;
            n969TBW16_VISIT_NO = ((0==A969TBW16_VISIT_NO) ? true : false) ;
         ...
         else
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri("", false, "A967TBW16_CRF_EDA_NO", GXutil.ltrim( GXutil.str( A967TBW16_CRF_EDA_NO, 2, 0)));
               A968TBW16_CRF_ITEM_GRP_CD = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri("", false, "A968TBW16_CRF_ITEM_GRP_CD", A968TBW16_CRF_ITEM_GRP_CD);
               getEqualNoModal( ) ;
               Gx_mode = "DSP" ;
               httpContext.ajax_rsp_assign_attri("", false, "Gx_mode", Gx_mode);
   ...
   public void zm1M65( int GX_JID )
   {
      if ( ( GX_JID == 2 ) || ( GX_JID == 0 ) )
      {
         if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
         {
            Z969TBW16_VISIT_NO = T001M3_A969TBW16_VISIT_NO[0] ;
         ...
         {
            Z969TBW16_VISIT_NO = A969TBW16_VISIT_NO ;
      ...
      if ( GX_JID == -2 )
      {
         ...
         Z968TBW16_CRF_ITEM_GRP_CD = A968TBW16_CRF_ITEM_GRP_CD ;
         Z969TBW16_VISIT_NO = A969TBW16_VISIT_NO ;
         Z970TBW16_DOM_CD = A970TBW16_DOM_CD ;
         Z971TBW16_DOM_VAR_NM = A971TBW16_DOM_VAR_NM ;
         Z972TBW16_DOM_ITM_GRP_OID = A972TBW16_DOM_ITM_GRP_OID ;
   ...
   public void load1M65( )
   {
      /* Using cursor T001M4 */
      pr_default.execute(2, new Object[] {A963TBW16_SESSION_ID, A964TBW16_DATETIME, new Long(A965TBW16_STUDY_ID), new Short(A966TBW16_CRF_ID), new Byte(A967TBW16_CRF_EDA_NO), A968TBW16_CRF_ITEM_GRP_CD});
      if ( (pr_default.getStatus(2) != 101) )
      {
         RcdFound65 = (short)(1) ;
         A969TBW16_VISIT_NO = T001M4_A969TBW16_VISIT_NO[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A969TBW16_VISIT_NO", GXutil.ltrim( GXutil.str( A969TBW16_VISIT_NO, 6, 0)));
         n969TBW16_VISIT_NO = T001M4_n969TBW16_VISIT_NO[0] ;
   ...
   public void onLoadActions1M65( )
   {
   }

   public void checkExtendedTable1M65( )
   {
      Gx_BScreen = (byte)(1) ;
      standaloneModal( ) ;
   ...
   public void closeExtendedTableCursors1M65( )
   {
   }
   ...
   public void getKey1M65( )
   {
      /* Using cursor T001M5 */
      pr_default.execute(3, new Object[] {A963TBW16_SESSION_ID, A964TBW16_DATETIME, new Long(A965TBW16_STUDY_ID), new Short(A966TBW16_CRF_ID), new Byte(A967TBW16_CRF_EDA_NO), A968TBW16_CRF_ITEM_GRP_CD});
   ...
   {
      /* Using cursor T001M3 */
      pr_default.execute(1, new Object[] {A963TBW16_SESSION_ID, A964TBW16_DATETIME, new Long(A965TBW16_STUDY_ID), new Short(A966TBW16_CRF_ID), new Byte(A967TBW16_CRF_EDA_NO), A968TBW16_CRF_ITEM_GRP_CD});
      if ( (pr_default.getStatus(1) != 101) )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "A967TBW16_CRF_EDA_NO", GXutil.ltrim( GXutil.str( A967TBW16_CRF_EDA_NO, 2, 0)));
         A968TBW16_CRF_ITEM_GRP_CD = T001M3_A968TBW16_CRF_ITEM_GRP_CD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A968TBW16_CRF_ITEM_GRP_CD", A968TBW16_CRF_ITEM_GRP_CD);
         A969TBW16_VISIT_NO = T001M3_A969TBW16_VISIT_NO[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A969TBW16_VISIT_NO", GXutil.ltrim( GXutil.str( A969TBW16_VISIT_NO, 6, 0)));
         n969TBW16_VISIT_NO = T001M3_n969TBW16_VISIT_NO[0] ;
   ...
   public void move_next( )
   {
      ...
      if ( (pr_default.getStatus(4) != 101) )
      {
         ...
         if ( (pr_default.getStatus(4) != 101) && ( ( GXutil.strcmp(T001M6_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) > 0 ) || ( GXutil.strcmp(T001M6_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && T001M6_A964TBW16_DATETIME[0].after( A964TBW16_DATETIME ) || T001M6_A964TBW16_DATETIME[0].equals( A964TBW16_DATETIME ) && ( GXutil.strcmp(T001M6_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && ( T001M6_A965TBW16_STUDY_ID[0] > A965TBW16_STUDY_ID ) || ( T001M6_A965TBW16_STUDY_ID[0] == A965TBW16_STUDY_ID ) && T001M6_A964TBW16_DATETIME[0].equals( A964TBW16_DATETIME ) && ( GXutil.strcmp(T001M6_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && ( T001M6_A966TBW16_CRF_ID[0] > A966TBW16_CRF_ID ) || ( T001M6_A966TBW16_CRF_ID[0] == A966TBW16_CRF_ID ) && ( T001M6_A965TBW16_STUDY_ID[0] == A965TBW16_STUDY_ID ) && T001M6_A964TBW16_DATETIME[0].equals( A964TBW16_DATETIME ) && ( GXutil.strcmp(T001M6_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && ( T001M6_A967TBW16_CRF_EDA_NO[0] > A967TBW16_CRF_EDA_NO ) || ( T001M6_A967TBW16_CRF_EDA_NO[0] == A967TBW16_CRF_EDA_NO ) && ( T001M6_A966TBW16_CRF_ID[0] == A966TBW16_CRF_ID ) && ( T001M6_A965TBW16_STUDY_ID[0] == A965TBW16_STUDY_ID ) && T001M6_A964TBW16_DATETIME[0].equals( A964TBW16_DATETIME ) && ( GXutil.strcmp(T001M6_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && ( GXutil.strcmp(T001M6_A968TBW16_CRF_ITEM_GRP_CD[0], A968TBW16_CRF_ITEM_GRP_CD) > 0 ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "A967TBW16_CRF_EDA_NO", GXutil.ltrim( GXutil.str( A967TBW16_CRF_EDA_NO, 2, 0)));
            A968TBW16_CRF_ITEM_GRP_CD = T001M6_A968TBW16_CRF_ITEM_GRP_CD[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A968TBW16_CRF_ITEM_GRP_CD", A968TBW16_CRF_ITEM_GRP_CD);
            RcdFound65 = (short)(1) ;
         }
      }
   ...
   public void move_previous( )
   {
      ...
      if ( (pr_default.getStatus(5) != 101) )
      {
         ...
         if ( (pr_default.getStatus(5) != 101) && ( ( GXutil.strcmp(T001M7_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) < 0 ) || ( GXutil.strcmp(T001M7_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && T001M7_A964TBW16_DATETIME[0].before( A964TBW16_DATETIME ) || T001M7_A964TBW16_DATETIME[0].equals( A964TBW16_DATETIME ) && ( GXutil.strcmp(T001M7_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && ( T001M7_A965TBW16_STUDY_ID[0] < A965TBW16_STUDY_ID ) || ( T001M7_A965TBW16_STUDY_ID[0] == A965TBW16_STUDY_ID ) && T001M7_A964TBW16_DATETIME[0].equals( A964TBW16_DATETIME ) && ( GXutil.strcmp(T001M7_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && ( T001M7_A966TBW16_CRF_ID[0] < A966TBW16_CRF_ID ) || ( T001M7_A966TBW16_CRF_ID[0] == A966TBW16_CRF_ID ) && ( T001M7_A965TBW16_STUDY_ID[0] == A965TBW16_STUDY_ID ) && T001M7_A964TBW16_DATETIME[0].equals( A964TBW16_DATETIME ) && ( GXutil.strcmp(T001M7_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && ( T001M7_A967TBW16_CRF_EDA_NO[0] < A967TBW16_CRF_EDA_NO ) || ( T001M7_A967TBW16_CRF_EDA_NO[0] == A967TBW16_CRF_EDA_NO ) && ( T001M7_A966TBW16_CRF_ID[0] == A966TBW16_CRF_ID ) && ( T001M7_A965TBW16_STUDY_ID[0] == A965TBW16_STUDY_ID ) && T001M7_A964TBW16_DATETIME[0].equals( A964TBW16_DATETIME ) && ( GXutil.strcmp(T001M7_A963TBW16_SESSION_ID[0], A963TBW16_SESSION_ID) == 0 ) && ( GXutil.strcmp(T001M7_A968TBW16_CRF_ITEM_GRP_CD[0], A968TBW16_CRF_ITEM_GRP_CD) < 0 ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "A967TBW16_CRF_EDA_NO", GXutil.ltrim( GXutil.str( A967TBW16_CRF_EDA_NO, 2, 0)));
            A968TBW16_CRF_ITEM_GRP_CD = T001M7_A968TBW16_CRF_ITEM_GRP_CD[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A968TBW16_CRF_ITEM_GRP_CD", A968TBW16_CRF_ITEM_GRP_CD);
            RcdFound65 = (short)(1) ;
         }
      }
   ...
   public void btn_enter( )
   {
      ...
      else
      {
         if ( RcdFound65 == 1 )
         {
            if ( ( GXutil.strcmp(A963TBW16_SESSION_ID, Z963TBW16_SESSION_ID) != 0 ) || !( A964TBW16_DATETIME.equals( Z964TBW16_DATETIME ) ) || ( A965TBW16_STUDY_ID != Z965TBW16_STUDY_ID ) || ( A966TBW16_CRF_ID != Z966TBW16_CRF_ID ) || ( A967TBW16_CRF_EDA_NO != Z967TBW16_CRF_EDA_NO ) || ( GXutil.strcmp(A968TBW16_CRF_ITEM_GRP_CD, Z968TBW16_CRF_ITEM_GRP_CD) != 0 ) )
            {
               ...
               httpContext.ajax_rsp_assign_attri("", false, "A967TBW16_CRF_EDA_NO", GXutil.ltrim( GXutil.str( A967TBW16_CRF_EDA_NO, 2, 0)));
               A968TBW16_CRF_ITEM_GRP_CD = Z968TBW16_CRF_ITEM_GRP_CD ;
               httpContext.ajax_rsp_assign_attri("", false, "A968TBW16_CRF_ITEM_GRP_CD", A968TBW16_CRF_ITEM_GRP_CD);
   ...
   public void checkOptimisticConcurrency1M65( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         /* Using cursor T001M2 */
         pr_default.execute(0, new Object[] {A963TBW16_SESSION_ID, A964TBW16_DATETIME, new Long(A965TBW16_STUDY_ID), new Short(A966TBW16_CRF_ID), new Byte(A967TBW16_CRF_EDA_NO), A968TBW16_CRF_ITEM_GRP_CD});
   ...
   public void insert1M65( )
   {
      beforeValidate1M65( ) ;
      if ( AnyError == 0 )
      {
         checkExtendedTable1M65( ) ;
      }
      if ( AnyError == 0 )
      {
         zm1M65( 0) ;
         checkOptimisticConcurrency1M65( ) ;
         if ( AnyError == 0 )
         {
            afterConfirm1M65( ) ;
            if ( AnyError == 0 )
            {
               ...
               {
                  /* Using cursor T001M8 */
                  pr_default.execute(6, new Object[] {A963TBW16_SESSION_ID, A964TBW16_DATETIME, new Long(A965TBW16_STUDY_ID), new Short(A966TBW16_CRF_ID), new Byte(A967TBW16_CRF_EDA_NO), A968TBW16_CRF_ITEM_GRP_CD, new Boolean(n969TBW16_VISIT_NO), new Integer(A969TBW16_VISIT_NO), new Boolean(n970TBW16_DOM_CD), A970TBW16_DOM_CD, new Boolean(n971TBW16_DOM_VAR_NM), A971TBW16_DOM_VAR_NM, new Boolean(n972TBW16_DOM_ITM_GRP_OID), A972TBW16_DOM_ITM_GRP_OID, new Boolean(n973TBW16_DOM_ITM_GRP_ATTR_SEQ), new Short(A973TBW16_DOM_ITM_GRP_ATTR_SEQ), new Boolean(n974TBW16_DOM_ITM_GRP_ROWNO), new Short(A974TBW16_DOM_ITM_GRP_ROWNO)});
      ...
      closeExtendedTableCursors1M65( ) ;
   }

   public void update1M65( )
   {
      beforeValidate1M65( ) ;
      if ( AnyError == 0 )
      {
      ...
      if ( AnyError == 0 )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               {
                  /* Using cursor T001M9 */
                  pr_default.execute(7, new Object[] {new Boolean(n969TBW16_VISIT_NO), new Integer(A969TBW16_VISIT_NO), new Boolean(n970TBW16_DOM_CD), A970TBW16_DOM_CD, new Boolean(n971TBW16_DOM_VAR_NM), A971TBW16_DOM_VAR_NM, new Boolean(n972TBW16_DOM_ITM_GRP_OID), A972TBW16_DOM_ITM_GRP_OID, new Boolean(n973TBW16_DOM_ITM_GRP_ATTR_SEQ), new Short(A973TBW16_DOM_ITM_GRP_ATTR_SEQ), new Boolean(n974TBW16_DOM_ITM_GRP_ROWNO), new Short(A974TBW16_DOM_ITM_GRP_ROWNO), A963TBW16_SESSION_ID, A964TBW16_DATETIME, new Long(A965TBW16_STUDY_ID), new Short(A966TBW16_CRF_ID), new Byte(A967TBW16_CRF_EDA_NO), A968TBW16_CRF_ITEM_GRP_CD});
                  Application.getSmartCacheProvider(remoteHandle).setUpdated("TBW16_DOM_MAP_VISIT") ;
   ...
   public void deferredUpdate1M65( )
   {
   }
      ...
      if ( AnyError == 0 )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               pr_default.execute(8, new Object[] {A963TBW16_SESSION_ID, A964TBW16_DATETIME, new Long(A965TBW16_STUDY_ID), new Short(A966TBW16_CRF_ID), new Byte(A967TBW16_CRF_EDA_NO), A968TBW16_CRF_ITEM_GRP_CD});
               Application.getSmartCacheProvider(remoteHandle).setUpdated("TBW16_DOM_MAP_VISIT") ;
               if ( AnyError == 0 )
               {
   ...
   public void onDeleteControls1M65( )
   {
      standaloneModal( ) ;
      /* No delete mode formulas found. */
   }

   public void endLevel1M65( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         pr_default.close(0);
   ...
   public void scanStart1M65( )
   {
      ...
      if ( (pr_default.getStatus(9) != 101) )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "A967TBW16_CRF_EDA_NO", GXutil.ltrim( GXutil.str( A967TBW16_CRF_EDA_NO, 2, 0)));
         A968TBW16_CRF_ITEM_GRP_CD = T001M11_A968TBW16_CRF_ITEM_GRP_CD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A968TBW16_CRF_ITEM_GRP_CD", A968TBW16_CRF_ITEM_GRP_CD);
      }
      /* Load Subordinate Levels */
   }

   public void scanNext1M65( )
   {
      /* Scan next routine */
   ...
   public void scanEnd1M65( )
   {
      pr_default.close(9);
   }

   public void afterConfirm1M65( )
   {
      /* After Confirm Rules */
   }

   public void beforeInsert1M65( )
   {
      /* Before Insert Rules */
   }

   public void beforeUpdate1M65( )
   {
      /* Before Update Rules */
   }

   public void beforeDelete1M65( )
   {
      /* Before Delete Rules */
   }

   public void beforeComplete1M65( )
   {
      /* Before Complete Rules */
   }

   public void beforeValidate1M65( )
   {
      /* Before Validate Rules */
   }

   public void disableAttributes1M65( )
   {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317164257");
   ...
   public void renderHtmlCloseForm1M65( )
   {
      ...
      GxWebStd.gx_hidden_field( httpContext, "Z968TBW16_CRF_ITEM_GRP_CD", GXutil.rtrim( Z968TBW16_CRF_ITEM_GRP_CD));
      GxWebStd.gx_hidden_field( httpContext, "Z969TBW16_VISIT_NO", GXutil.ltrim( localUtil.ntoc( Z969TBW16_VISIT_NO, (byte)(6), (byte)(0), ".", "")));
   ...
   public void initializeNonKey1M65( )
   {
      A969TBW16_VISIT_NO = 0 ;
      n969TBW16_VISIT_NO = false ;
      httpContext.ajax_rsp_assign_attri("", false, "A969TBW16_VISIT_NO", GXutil.ltrim( GXutil.str( A969TBW16_VISIT_NO, 6, 0)));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317164262");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tbw16_dom_map_visit.js", "?20177317164262");
                                            ...
                                            short GX_Parm12 )
   {
      ...
      A968TBW16_CRF_ITEM_GRP_CD = GX_Parm6 ;
      A969TBW16_VISIT_NO = GX_Parm7 ;
      n969TBW16_VISIT_NO = false ;
      ...
      isValidOutput.add(GXutil.ltrim( localUtil.ntoc( A969TBW16_VISIT_NO, (byte)(6), (byte)(0), ".", "")));
      ...
      isValidOutput.add(GXutil.rtrim( Z968TBW16_CRF_ITEM_GRP_CD));
      isValidOutput.add(GXutil.ltrim( localUtil.ntoc( Z969TBW16_VISIT_NO, (byte)(6), (byte)(0), ".", "")));
   ...
   public void initialize( )
   {
      ...
      T001M4_A968TBW16_CRF_ITEM_GRP_CD = new String[] {""} ;
      T001M4_A969TBW16_VISIT_NO = new int[1] ;
      T001M4_n969TBW16_VISIT_NO = new boolean[] {false} ;
      ...
      T001M5_A968TBW16_CRF_ITEM_GRP_CD = new String[] {""} ;
      ...
      T001M3_A968TBW16_CRF_ITEM_GRP_CD = new String[] {""} ;
      T001M3_A969TBW16_VISIT_NO = new int[1] ;
      T001M3_n969TBW16_VISIT_NO = new boolean[] {false} ;
      ...
      T001M6_A968TBW16_CRF_ITEM_GRP_CD = new String[] {""} ;
      ...
      T001M7_A968TBW16_CRF_ITEM_GRP_CD = new String[] {""} ;
      ...
      T001M2_A968TBW16_CRF_ITEM_GRP_CD = new String[] {""} ;
      T001M2_A969TBW16_VISIT_NO = new int[1] ;
      T001M2_n969TBW16_VISIT_NO = new boolean[] {false} ;
      ...
      T001M11_A968TBW16_CRF_ITEM_GRP_CD = new String[] {""} ;
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new tbw16_dom_map_visit__default(),
         new Object[] {
             new Object[] {
            T001M2_A963TBW16_SESSION_ID, T001M2_A964TBW16_DATETIME, T001M2_A965TBW16_STUDY_ID, T001M2_A966TBW16_CRF_ID, T001M2_A967TBW16_CRF_EDA_NO, T001M2_A968TBW16_CRF_ITEM_GRP_CD, T001M2_A969TBW16_VISIT_NO, T001M2_n969TBW16_VISIT_NO, T001M2_A970TBW16_DOM_CD, T001M2_n970TBW16_DOM_CD,
            ...
            , new Object[] {
            T001M3_A963TBW16_SESSION_ID, T001M3_A964TBW16_DATETIME, T001M3_A965TBW16_STUDY_ID, T001M3_A966TBW16_CRF_ID, T001M3_A967TBW16_CRF_EDA_NO, T001M3_A968TBW16_CRF_ITEM_GRP_CD, T001M3_A969TBW16_VISIT_NO, T001M3_n969TBW16_VISIT_NO, T001M3_A970TBW16_DOM_CD, T001M3_n970TBW16_DOM_CD,
            ...
            , new Object[] {
            T001M4_A963TBW16_SESSION_ID, T001M4_A964TBW16_DATETIME, T001M4_A965TBW16_STUDY_ID, T001M4_A966TBW16_CRF_ID, T001M4_A967TBW16_CRF_EDA_NO, T001M4_A968TBW16_CRF_ITEM_GRP_CD, T001M4_A969TBW16_VISIT_NO, T001M4_n969TBW16_VISIT_NO, T001M4_A970TBW16_DOM_CD, T001M4_n970TBW16_DOM_CD,
            ...
            , new Object[] {
            T001M5_A963TBW16_SESSION_ID, T001M5_A964TBW16_DATETIME, T001M5_A965TBW16_STUDY_ID, T001M5_A966TBW16_CRF_ID, T001M5_A967TBW16_CRF_EDA_NO, T001M5_A968TBW16_CRF_ITEM_GRP_CD
            }
            , new Object[] {
            T001M6_A963TBW16_SESSION_ID, T001M6_A964TBW16_DATETIME, T001M6_A965TBW16_STUDY_ID, T001M6_A966TBW16_CRF_ID, T001M6_A967TBW16_CRF_EDA_NO, T001M6_A968TBW16_CRF_ITEM_GRP_CD
            }
            , new Object[] {
            T001M7_A963TBW16_SESSION_ID, T001M7_A964TBW16_DATETIME, T001M7_A965TBW16_STUDY_ID, T001M7_A966TBW16_CRF_ID, T001M7_A967TBW16_CRF_EDA_NO, T001M7_A968TBW16_CRF_ITEM_GRP_CD
            }
            , new Object[] {
            }
            , new Object[] {
            ...
            , new Object[] {
            T001M11_A963TBW16_SESSION_ID, T001M11_A964TBW16_DATETIME, T001M11_A965TBW16_STUDY_ID, T001M11_A966TBW16_CRF_ID, T001M11_A967TBW16_CRF_EDA_NO, T001M11_A968TBW16_CRF_ITEM_GRP_CD
            }
         }
      );
   }
   ...
   private int Z969TBW16_VISIT_NO ;
   ...
   private int A969TBW16_VISIT_NO ;
   ...
   private boolean n969TBW16_VISIT_NO ;
   ...
   private String Z968TBW16_CRF_ITEM_GRP_CD ;
   ...
   private String A968TBW16_CRF_ITEM_GRP_CD ;
   ...
   private String[] T001M4_A968TBW16_CRF_ITEM_GRP_CD ;
   private int[] T001M4_A969TBW16_VISIT_NO ;
   private boolean[] T001M4_n969TBW16_VISIT_NO ;
   ...
   private String[] T001M5_A968TBW16_CRF_ITEM_GRP_CD ;
   ...
   private String[] T001M3_A968TBW16_CRF_ITEM_GRP_CD ;
   private int[] T001M3_A969TBW16_VISIT_NO ;
   private boolean[] T001M3_n969TBW16_VISIT_NO ;
   ...
   private String[] T001M6_A968TBW16_CRF_ITEM_GRP_CD ;
   ...
   private String[] T001M7_A968TBW16_CRF_ITEM_GRP_CD ;
   ...
   private String[] T001M2_A968TBW16_CRF_ITEM_GRP_CD ;
   private int[] T001M2_A969TBW16_VISIT_NO ;
   private boolean[] T001M2_n969TBW16_VISIT_NO ;
   ...
   private String[] T001M11_A968TBW16_CRF_ITEM_GRP_CD ;
}
                              ...
                              Object[] parms ) throws SQLException
   {
      switch ( cursor )
      {
            ...
            case 6 :
               ...
               {
                  stmt.setVarchar(8, (String)parms[9], 2);
               }
