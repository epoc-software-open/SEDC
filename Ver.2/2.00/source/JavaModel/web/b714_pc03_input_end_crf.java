/*
       ...
       Generated on: July 3, 2017 17:15:47.98
...
public final  class b714_pc03_input_end_crf extends GXProcedure
{
      ...
      if ( AV21W_RTN_CD == 0 )
      {
         ...
         while ( AV27GXV1 <= AV14P_B714_SD1_CRF_INFO.size() )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               if ( AV15P_SHOR_KBN == 0 )
               {
                  AV9BC_TBT11_CRF_HISTORY.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_upd_riyu( "CRF固定解除" );
               }
               else
               {
                  AV9BC_TBT11_CRF_HISTORY.setgxTv_SdtTBT11_CRF_HISTORY_Tbt11_upd_riyu( "CRF固定" );
               }
               ...
               if ( AV21W_RTN_CD == 0 )
               {
                  ...
                  if ( AV15P_SHOR_KBN == 0 )
                  {
                     AV23W_LOGTEXT = AV23W_LOGTEXT + "UPD_RIYU:" + "CRF固定解除" + GXutil.chr( (short)(9)) ;
                  }
                  else
                  {
                     AV23W_LOGTEXT = AV23W_LOGTEXT + "UPD_RIYU:" + "CRF固定" + GXutil.chr( (short)(9)) ;
                  }
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b714_pc03_input_end_crf__default(),
         new Object[] {
             new Object[] {
            P00612_A449TBT02_DEL_FLG, P00612_n449TBT02_DEL_FLG, P00612_A935TBT02_CRF_EDA_NO, P00612_A91TBT02_CRF_ID, P00612_A90TBT02_SUBJECT_ID, P00612_A89TBT02_STUDY_ID, P00612_A456TBT02_UPD_CNT, P00612_n456TBT02_UPD_CNT, P00612_A499TBT02_CRF_INPUT_LEVEL, P00612_n499TBT02_CRF_INPUT_LEVEL,
            P00612_A655TBT02_DM_ARRIVAL_FLG, P00612_n655TBT02_DM_ARRIVAL_FLG, P00612_A656TBT02_DM_ARRIVAL_DATETIME, P00612_n656TBT02_DM_ARRIVAL_DATETIME, P00612_A657TBT02_APPROVAL_FLG, P00612_n657TBT02_APPROVAL_FLG, P00612_A658TBT02_APPROVAL_DATETIME, P00612_n658TBT02_APPROVAL_DATETIME, P00612_A659TBT02_APPROVAL_USER_ID, P00612_n659TBT02_APPROVAL_USER_ID,
