...
public final  class tam07_user_impl extends GXWebPanel
{
   ...
   public void wb_table4_34_0A10( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTAM07_CRT_DATETIME_Internalname, localUtil.format(A229TAM07_CRT_DATETIME, "9999/99/99 99:99:99"), localUtil.format( A229TAM07_CRT_DATETIME, "9999/99/99 99:99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'jap',false,0);"+";gx.evt.onblur(79);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTAM07_CRT_DATETIME_Jsonclick, 0, "Attribute", "", "", "", 1, edtTAM07_CRT_DATETIME_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_Y4MD_HMS", "right", "HLP_TAM07_USER.htm");
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTAM07_CRT_USER_ID_Internalname, GXutil.rtrim( A264TAM07_CRT_USER_ID), GXutil.rtrim( localUtil.format( A264TAM07_CRT_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTAM07_CRT_USER_ID_Jsonclick, 0, "Attribute", "", "", "", 1, edtTAM07_CRT_USER_ID_Enabled, 0, "text", "", 80, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_USER_ID", "left", "HLP_TAM07_USER.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTAM07_CRT_PROG_NM_Internalname, GXutil.rtrim( A230TAM07_CRT_PROG_NM), GXutil.rtrim( localUtil.format( A230TAM07_CRT_PROG_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTAM07_CRT_PROG_NM_Jsonclick, 0, "Attribute", "", "", "", 1, edtTAM07_CRT_PROG_NM_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_PG_NM", "left", "HLP_TAM07_USER.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTAM07_UPD_DATETIME_Internalname, localUtil.format(A231TAM07_UPD_DATETIME, "9999/99/99 99:99:99"), localUtil.format( A231TAM07_UPD_DATETIME, "9999/99/99 99:99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'jap',false,0);"+";gx.evt.onblur(94);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTAM07_UPD_DATETIME_Jsonclick, 0, "Attribute", "", "", "", 1, edtTAM07_UPD_DATETIME_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_Y4MD_HMS", "right", "HLP_TAM07_USER.htm");
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTAM07_UPD_USER_ID_Internalname, GXutil.rtrim( A265TAM07_UPD_USER_ID), GXutil.rtrim( localUtil.format( A265TAM07_UPD_USER_ID, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(99);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTAM07_UPD_USER_ID_Jsonclick, 0, "Attribute", "", "", "", 1, edtTAM07_UPD_USER_ID_Enabled, 0, "text", "", 80, "chr", 1, "row", 128, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_USER_ID", "left", "HLP_TAM07_USER.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTAM07_UPD_PROG_NM_Internalname, GXutil.rtrim( A232TAM07_UPD_PROG_NM), GXutil.rtrim( localUtil.format( A232TAM07_UPD_PROG_NM, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(104);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTAM07_UPD_PROG_NM_Jsonclick, 0, "Attribute", "", "", "", 1, edtTAM07_UPD_PROG_NM_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_TS_PG_NM", "left", "HLP_TAM07_USER.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td class=\"td5\"  style=\"vertical-align:top;width:40px\">") ;
         ...
         GxWebStd.gx_single_line_edit( httpContext, edtTAM07_UPD_CNT_Internalname, GXutil.ltrim( localUtil.ntoc( A299TAM07_UPD_CNT, (byte)(10), (byte)(0), ".", "")), ((edtTAM07_UPD_CNT_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A299TAM07_UPD_CNT), "ZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A299TAM07_UPD_CNT), "ZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(109);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTAM07_UPD_CNT_Jsonclick, 0, "Attribute", "", "", "", 1, edtTAM07_UPD_CNT_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "D_NO", "right", "HLP_TAM07_USER.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
   ...
   public void checkOptimisticConcurrency0A10( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         ...
         if ( Gx_longc || ( GXutil.strcmp(Z214TAM07_DEL_FLG, T000A2_A214TAM07_DEL_FLG[0]) != 0 ) || ( GXutil.strcmp(Z230TAM07_CRT_PROG_NM, T000A2_A230TAM07_CRT_PROG_NM[0]) != 0 ) || ( GXutil.strcmp(Z232TAM07_UPD_PROG_NM, T000A2_A232TAM07_UPD_PROG_NM[0]) != 0 ) || ( GXutil.strcmp(Z56TAM07_AUTH_CD, T000A2_A56TAM07_AUTH_CD[0]) != 0 ) )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201773171445");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2017731714415");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("tam07_user.js", "?2017731714416");
                                    ...
                                    String GX_Parm15 )
   {
      ...
      n683TAM07_EMAIL = false ;
      A214TAM07_DEL_FLG = GX_Parm12 ;
      n214TAM07_DEL_FLG = false ;
      A230TAM07_CRT_PROG_NM = GX_Parm13 ;
      n230TAM07_CRT_PROG_NM = false ;
      A232TAM07_UPD_PROG_NM = GX_Parm14 ;
      n232TAM07_UPD_PROG_NM = false ;
      A56TAM07_AUTH_CD = GX_Parm15 ;
      n56TAM07_AUTH_CD = false ;
      httpContext.wbHandled = (byte)(1) ;
      afterkeyloadscreen( ) ;
      draw( ) ;
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new tam07_user__default(),
         new Object[] {
            ...
            T000A2_n683TAM07_EMAIL, T000A2_A214TAM07_DEL_FLG, T000A2_n214TAM07_DEL_FLG, T000A2_A230TAM07_CRT_PROG_NM, T000A2_n230TAM07_CRT_PROG_NM, T000A2_A232TAM07_UPD_PROG_NM, T000A2_n232TAM07_UPD_PROG_NM, T000A2_A56TAM07_AUTH_CD, T000A2_n56TAM07_AUTH_CD
            }
            , new Object[] {
            ...
            T000A3_n683TAM07_EMAIL, T000A3_A214TAM07_DEL_FLG, T000A3_n214TAM07_DEL_FLG, T000A3_A230TAM07_CRT_PROG_NM, T000A3_n230TAM07_CRT_PROG_NM, T000A3_A232TAM07_UPD_PROG_NM, T000A3_n232TAM07_UPD_PROG_NM, T000A3_A56TAM07_AUTH_CD, T000A3_n56TAM07_AUTH_CD
            }
            , new Object[] {
            ...
            T000A5_n683TAM07_EMAIL, T000A5_A214TAM07_DEL_FLG, T000A5_n214TAM07_DEL_FLG, T000A5_A230TAM07_CRT_PROG_NM, T000A5_n230TAM07_CRT_PROG_NM, T000A5_A232TAM07_UPD_PROG_NM, T000A5_n232TAM07_UPD_PROG_NM, T000A5_A56TAM07_AUTH_CD, T000A5_n56TAM07_AUTH_CD
            }
            , new Object[] {
...
final  class tam07_user__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new UpdateCursor("T000A9", "INSERT INTO `TAM07_USER`(`TAM07_USER_ID`, `TAM07_CRT_DATETIME`, `TAM07_CRT_USER_ID`, `TAM07_UPD_DATETIME`, `TAM07_UPD_USER_ID`, `TAM07_UPD_CNT`, `TAM07_USER_NM`, `TAM07_USER_KANA_NM`, `TAM07_PWD`, `TAM07_SITE_ID`, `TAM07_EMAIL`, `TAM07_DEL_FLG`, `TAM07_CRT_PROG_NM`, `TAM07_UPD_PROG_NM`, `TAM07_AUTH_CD`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", GX_NOMASK)
         ,new UpdateCursor("T000A10", "UPDATE `TAM07_USER` SET `TAM07_CRT_DATETIME`=?, `TAM07_CRT_USER_ID`=?, `TAM07_UPD_DATETIME`=?, `TAM07_UPD_USER_ID`=?, `TAM07_UPD_CNT`=?, `TAM07_USER_NM`=?, `TAM07_USER_KANA_NM`=?, `TAM07_PWD`=?, `TAM07_SITE_ID`=?, `TAM07_EMAIL`=?, `TAM07_DEL_FLG`=?, `TAM07_CRT_PROG_NM`=?, `TAM07_UPD_PROG_NM`=?, `TAM07_AUTH_CD`=?  WHERE `TAM07_USER_ID` = ?", GX_NOMASK)
