/*
       ...
       Generated on: July 3, 2017 17:15:32.69
...
public final  class tbm24_map_item_bc extends GXWebPanel implements IGxSilentTrn
{
   ...
   public void checkExtendedTable0W31( )
   {
      ...
      pr_default.execute(4, new Object[] {new Long(A64TBM24_STUDY_ID)});
   ...
   public void getKey0W31( )
   {
      ...
      pr_default.execute(5, new Object[] {new Long(A64TBM24_STUDY_ID), A65TBM24_DOM_CD, A66TBM24_DOM_VAR_NM, A67TBM24_CRF_ITEM_DIV});
   ...
   public void scanKeyStart0W31( )
   {
      ...
      {
         RcdFound31 = (short)(1) ;
         A65TBM24_DOM_CD = BC000W11_A65TBM24_DOM_CD[0] ;
         A66TBM24_DOM_VAR_NM = BC000W11_A66TBM24_DOM_VAR_NM[0] ;
         A67TBM24_CRF_ITEM_DIV = BC000W11_A67TBM24_CRF_ITEM_DIV[0] ;
         A545TBM24_CRT_DATETIME = BC000W11_A545TBM24_CRT_DATETIME[0] ;
         n545TBM24_CRT_DATETIME = BC000W11_n545TBM24_CRT_DATETIME[0] ;
         A546TBM24_CRT_USER_ID = BC000W11_A546TBM24_CRT_USER_ID[0] ;
         n546TBM24_CRT_USER_ID = BC000W11_n546TBM24_CRT_USER_ID[0] ;
         A548TBM24_UPD_DATETIME = BC000W11_A548TBM24_UPD_DATETIME[0] ;
         n548TBM24_UPD_DATETIME = BC000W11_n548TBM24_UPD_DATETIME[0] ;
         A549TBM24_UPD_USER_ID = BC000W11_A549TBM24_UPD_USER_ID[0] ;
         n549TBM24_UPD_USER_ID = BC000W11_n549TBM24_UPD_USER_ID[0] ;
         A551TBM24_UPD_CNT = BC000W11_A551TBM24_UPD_CNT[0] ;
         n551TBM24_UPD_CNT = BC000W11_n551TBM24_UPD_CNT[0] ;
         A702TBM24_DOM_ITM_GRP_OID = BC000W11_A702TBM24_DOM_ITM_GRP_OID[0] ;
         n702TBM24_DOM_ITM_GRP_OID = BC000W11_n702TBM24_DOM_ITM_GRP_OID[0] ;
         A703TBM24_DOM_ITM_GRP_ATTR_SEQ = BC000W11_A703TBM24_DOM_ITM_GRP_ATTR_SEQ[0] ;
         n703TBM24_DOM_ITM_GRP_ATTR_SEQ = BC000W11_n703TBM24_DOM_ITM_GRP_ATTR_SEQ[0] ;
         A704TBM24_DOM_ITM_GRP_ROWNO = BC000W11_A704TBM24_DOM_ITM_GRP_ROWNO[0] ;
         n704TBM24_DOM_ITM_GRP_ROWNO = BC000W11_n704TBM24_DOM_ITM_GRP_ROWNO[0] ;
         A705TBM24_CRF_ITEM_NM = BC000W11_A705TBM24_CRF_ITEM_NM[0] ;
         n705TBM24_CRF_ITEM_NM = BC000W11_n705TBM24_CRF_ITEM_NM[0] ;
         A635TBM24_IDENTIFICATION_CD = BC000W11_A635TBM24_IDENTIFICATION_CD[0] ;
         n635TBM24_IDENTIFICATION_CD = BC000W11_n635TBM24_IDENTIFICATION_CD[0] ;
         A636TBM24_TEXT_MAXLENGTH = BC000W11_A636TBM24_TEXT_MAXLENGTH[0] ;
         n636TBM24_TEXT_MAXLENGTH = BC000W11_n636TBM24_TEXT_MAXLENGTH[0] ;
         A637TBM24_TEXT_MAXROWS = BC000W11_A637TBM24_TEXT_MAXROWS[0] ;
         n637TBM24_TEXT_MAXROWS = BC000W11_n637TBM24_TEXT_MAXROWS[0] ;
         A638TBM24_DECIMAL_DIGITS = BC000W11_A638TBM24_DECIMAL_DIGITS[0] ;
         n638TBM24_DECIMAL_DIGITS = BC000W11_n638TBM24_DECIMAL_DIGITS[0] ;
         A639TBM24_TEXT = BC000W11_A639TBM24_TEXT[0] ;
         n639TBM24_TEXT = BC000W11_n639TBM24_TEXT[0] ;
         A640TBM24_FIXED_VALUE = BC000W11_A640TBM24_FIXED_VALUE[0] ;
         n640TBM24_FIXED_VALUE = BC000W11_n640TBM24_FIXED_VALUE[0] ;
         A641TBM24_CHK_FALSE_INNER_VALUE = BC000W11_A641TBM24_CHK_FALSE_INNER_VALUE[0] ;
         n641TBM24_CHK_FALSE_INNER_VALUE = BC000W11_n641TBM24_CHK_FALSE_INNER_VALUE[0] ;
         A706TBM24_REQUIRED_INPUT_FLG = BC000W11_A706TBM24_REQUIRED_INPUT_FLG[0] ;
         n706TBM24_REQUIRED_INPUT_FLG = BC000W11_n706TBM24_REQUIRED_INPUT_FLG[0] ;
         A707TBM24_MIN_VALUE = BC000W11_A707TBM24_MIN_VALUE[0] ;
         n707TBM24_MIN_VALUE = BC000W11_n707TBM24_MIN_VALUE[0] ;
         A708TBM24_MAX_VALUE = BC000W11_A708TBM24_MAX_VALUE[0] ;
         n708TBM24_MAX_VALUE = BC000W11_n708TBM24_MAX_VALUE[0] ;
         A543TBM24_ORDER = BC000W11_A543TBM24_ORDER[0] ;
         n543TBM24_ORDER = BC000W11_n543TBM24_ORDER[0] ;
         A544TBM24_DEL_FLG = BC000W11_A544TBM24_DEL_FLG[0] ;
         n544TBM24_DEL_FLG = BC000W11_n544TBM24_DEL_FLG[0] ;
         A547TBM24_CRT_PROG_NM = BC000W11_A547TBM24_CRT_PROG_NM[0] ;
         n547TBM24_CRT_PROG_NM = BC000W11_n547TBM24_CRT_PROG_NM[0] ;
         A550TBM24_UPD_PROG_NM = BC000W11_A550TBM24_UPD_PROG_NM[0] ;
         n550TBM24_UPD_PROG_NM = BC000W11_n550TBM24_UPD_PROG_NM[0] ;
         A64TBM24_STUDY_ID = BC000W11_A64TBM24_STUDY_ID[0] ;
      }
   ...
   public void LoadKey( Object[] obj )
   {
      ...
      if ( RcdFound31 == 0 )
      {
         ...
         pr_default.execute(10, new Object[] {new Long(A64TBM24_STUDY_ID)});
   ...
   public void initialize( )
   {
      ...
      BC000W7_A64TBM24_STUDY_ID = new long[1] ;
      BC000W7_A65TBM24_DOM_CD = new String[] {""} ;
      BC000W7_A66TBM24_DOM_VAR_NM = new String[] {""} ;
      BC000W7_A67TBM24_CRF_ITEM_DIV = new String[] {""} ;
      ...
      BC000W11_A65TBM24_DOM_CD = new String[] {""} ;
      BC000W11_A66TBM24_DOM_VAR_NM = new String[] {""} ;
      BC000W11_A67TBM24_CRF_ITEM_DIV = new String[] {""} ;
      BC000W11_A545TBM24_CRT_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000W11_n545TBM24_CRT_DATETIME = new boolean[] {false} ;
      BC000W11_A546TBM24_CRT_USER_ID = new String[] {""} ;
      BC000W11_n546TBM24_CRT_USER_ID = new boolean[] {false} ;
      BC000W11_A548TBM24_UPD_DATETIME = new java.util.Date[] {GXutil.nullDate()} ;
      BC000W11_n548TBM24_UPD_DATETIME = new boolean[] {false} ;
      BC000W11_A549TBM24_UPD_USER_ID = new String[] {""} ;
      BC000W11_n549TBM24_UPD_USER_ID = new boolean[] {false} ;
      BC000W11_A551TBM24_UPD_CNT = new long[1] ;
      BC000W11_n551TBM24_UPD_CNT = new boolean[] {false} ;
      BC000W11_A702TBM24_DOM_ITM_GRP_OID = new String[] {""} ;
      BC000W11_n702TBM24_DOM_ITM_GRP_OID = new boolean[] {false} ;
      BC000W11_A703TBM24_DOM_ITM_GRP_ATTR_SEQ = new short[1] ;
      BC000W11_n703TBM24_DOM_ITM_GRP_ATTR_SEQ = new boolean[] {false} ;
      BC000W11_A704TBM24_DOM_ITM_GRP_ROWNO = new short[1] ;
      BC000W11_n704TBM24_DOM_ITM_GRP_ROWNO = new boolean[] {false} ;
      BC000W11_A705TBM24_CRF_ITEM_NM = new String[] {""} ;
      BC000W11_n705TBM24_CRF_ITEM_NM = new boolean[] {false} ;
      BC000W11_A635TBM24_IDENTIFICATION_CD = new String[] {""} ;
      BC000W11_n635TBM24_IDENTIFICATION_CD = new boolean[] {false} ;
      BC000W11_A636TBM24_TEXT_MAXLENGTH = new short[1] ;
      BC000W11_n636TBM24_TEXT_MAXLENGTH = new boolean[] {false} ;
      BC000W11_A637TBM24_TEXT_MAXROWS = new byte[1] ;
      BC000W11_n637TBM24_TEXT_MAXROWS = new boolean[] {false} ;
      BC000W11_A638TBM24_DECIMAL_DIGITS = new byte[1] ;
      BC000W11_n638TBM24_DECIMAL_DIGITS = new boolean[] {false} ;
      BC000W11_A639TBM24_TEXT = new String[] {""} ;
      BC000W11_n639TBM24_TEXT = new boolean[] {false} ;
      BC000W11_A640TBM24_FIXED_VALUE = new String[] {""} ;
      BC000W11_n640TBM24_FIXED_VALUE = new boolean[] {false} ;
      BC000W11_A641TBM24_CHK_FALSE_INNER_VALUE = new String[] {""} ;
      BC000W11_n641TBM24_CHK_FALSE_INNER_VALUE = new boolean[] {false} ;
      BC000W11_A706TBM24_REQUIRED_INPUT_FLG = new String[] {""} ;
      BC000W11_n706TBM24_REQUIRED_INPUT_FLG = new boolean[] {false} ;
      BC000W11_A707TBM24_MIN_VALUE = new String[] {""} ;
      BC000W11_n707TBM24_MIN_VALUE = new boolean[] {false} ;
      BC000W11_A708TBM24_MAX_VALUE = new String[] {""} ;
      BC000W11_n708TBM24_MAX_VALUE = new boolean[] {false} ;
      BC000W11_A543TBM24_ORDER = new int[1] ;
      BC000W11_n543TBM24_ORDER = new boolean[] {false} ;
      BC000W11_A544TBM24_DEL_FLG = new String[] {""} ;
      BC000W11_n544TBM24_DEL_FLG = new boolean[] {false} ;
      BC000W11_A547TBM24_CRT_PROG_NM = new String[] {""} ;
      BC000W11_n547TBM24_CRT_PROG_NM = new boolean[] {false} ;
      BC000W11_A550TBM24_UPD_PROG_NM = new String[] {""} ;
      BC000W11_n550TBM24_UPD_PROG_NM = new boolean[] {false} ;
      BC000W11_A64TBM24_STUDY_ID = new long[1] ;
      GXt_char1 = "" ;
      GXv_char2 = new String [1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      BC000W12_A64TBM24_STUDY_ID = new long[1] ;
      BC000W13_A64TBM24_STUDY_ID = new long[1] ;
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new tbm24_map_item_bc__default(),
         new Object[] {
            ...
            , new Object[] {
            BC000W6_A64TBM24_STUDY_ID
            }
            , new Object[] {
            BC000W7_A64TBM24_STUDY_ID, BC000W7_A65TBM24_DOM_CD, BC000W7_A66TBM24_DOM_VAR_NM, BC000W7_A67TBM24_CRF_ITEM_DIV
            }
            , new Object[] {
            }
            , new Object[] {
            ...
            , new Object[] {
            BC000W11_A65TBM24_DOM_CD, BC000W11_A66TBM24_DOM_VAR_NM, BC000W11_A67TBM24_CRF_ITEM_DIV, BC000W11_A545TBM24_CRT_DATETIME, BC000W11_n545TBM24_CRT_DATETIME, BC000W11_A546TBM24_CRT_USER_ID, BC000W11_n546TBM24_CRT_USER_ID, BC000W11_A548TBM24_UPD_DATETIME, BC000W11_n548TBM24_UPD_DATETIME, BC000W11_A549TBM24_UPD_USER_ID,
            BC000W11_n549TBM24_UPD_USER_ID, BC000W11_A551TBM24_UPD_CNT, BC000W11_n551TBM24_UPD_CNT, BC000W11_A702TBM24_DOM_ITM_GRP_OID, BC000W11_n702TBM24_DOM_ITM_GRP_OID, BC000W11_A703TBM24_DOM_ITM_GRP_ATTR_SEQ, BC000W11_n703TBM24_DOM_ITM_GRP_ATTR_SEQ, BC000W11_A704TBM24_DOM_ITM_GRP_ROWNO, BC000W11_n704TBM24_DOM_ITM_GRP_ROWNO, BC000W11_A705TBM24_CRF_ITEM_NM,
            BC000W11_n705TBM24_CRF_ITEM_NM, BC000W11_A635TBM24_IDENTIFICATION_CD, BC000W11_n635TBM24_IDENTIFICATION_CD, BC000W11_A636TBM24_TEXT_MAXLENGTH, BC000W11_n636TBM24_TEXT_MAXLENGTH, BC000W11_A637TBM24_TEXT_MAXROWS, BC000W11_n637TBM24_TEXT_MAXROWS, BC000W11_A638TBM24_DECIMAL_DIGITS, BC000W11_n638TBM24_DECIMAL_DIGITS, BC000W11_A639TBM24_TEXT,
            BC000W11_n639TBM24_TEXT, BC000W11_A640TBM24_FIXED_VALUE, BC000W11_n640TBM24_FIXED_VALUE, BC000W11_A641TBM24_CHK_FALSE_INNER_VALUE, BC000W11_n641TBM24_CHK_FALSE_INNER_VALUE, BC000W11_A706TBM24_REQUIRED_INPUT_FLG, BC000W11_n706TBM24_REQUIRED_INPUT_FLG, BC000W11_A707TBM24_MIN_VALUE, BC000W11_n707TBM24_MIN_VALUE, BC000W11_A708TBM24_MAX_VALUE,
            BC000W11_n708TBM24_MAX_VALUE, BC000W11_A543TBM24_ORDER, BC000W11_n543TBM24_ORDER, BC000W11_A544TBM24_DEL_FLG, BC000W11_n544TBM24_DEL_FLG, BC000W11_A547TBM24_CRT_PROG_NM, BC000W11_n547TBM24_CRT_PROG_NM, BC000W11_A550TBM24_UPD_PROG_NM, BC000W11_n550TBM24_UPD_PROG_NM, BC000W11_A64TBM24_STUDY_ID
            }
            , new Object[] {
            BC000W12_A64TBM24_STUDY_ID
            }
            , new Object[] {
            BC000W13_A64TBM24_STUDY_ID
            }
         }
      );
   ...
   private long[] BC000W7_A64TBM24_STUDY_ID ;
   private String[] BC000W7_A65TBM24_DOM_CD ;
   private String[] BC000W7_A66TBM24_DOM_VAR_NM ;
   private String[] BC000W7_A67TBM24_CRF_ITEM_DIV ;
   ...
   private String[] BC000W11_A65TBM24_DOM_CD ;
   private String[] BC000W11_A66TBM24_DOM_VAR_NM ;
   private String[] BC000W11_A67TBM24_CRF_ITEM_DIV ;
   private java.util.Date[] BC000W11_A545TBM24_CRT_DATETIME ;
   private boolean[] BC000W11_n545TBM24_CRT_DATETIME ;
   private String[] BC000W11_A546TBM24_CRT_USER_ID ;
   private boolean[] BC000W11_n546TBM24_CRT_USER_ID ;
   private java.util.Date[] BC000W11_A548TBM24_UPD_DATETIME ;
   private boolean[] BC000W11_n548TBM24_UPD_DATETIME ;
   private String[] BC000W11_A549TBM24_UPD_USER_ID ;
   private boolean[] BC000W11_n549TBM24_UPD_USER_ID ;
   private long[] BC000W11_A551TBM24_UPD_CNT ;
   private boolean[] BC000W11_n551TBM24_UPD_CNT ;
   private String[] BC000W11_A702TBM24_DOM_ITM_GRP_OID ;
   private boolean[] BC000W11_n702TBM24_DOM_ITM_GRP_OID ;
   private short[] BC000W11_A703TBM24_DOM_ITM_GRP_ATTR_SEQ ;
   private boolean[] BC000W11_n703TBM24_DOM_ITM_GRP_ATTR_SEQ ;
   private short[] BC000W11_A704TBM24_DOM_ITM_GRP_ROWNO ;
   private boolean[] BC000W11_n704TBM24_DOM_ITM_GRP_ROWNO ;
   private String[] BC000W11_A705TBM24_CRF_ITEM_NM ;
   private boolean[] BC000W11_n705TBM24_CRF_ITEM_NM ;
   private String[] BC000W11_A635TBM24_IDENTIFICATION_CD ;
   private boolean[] BC000W11_n635TBM24_IDENTIFICATION_CD ;
   private short[] BC000W11_A636TBM24_TEXT_MAXLENGTH ;
   private boolean[] BC000W11_n636TBM24_TEXT_MAXLENGTH ;
   private byte[] BC000W11_A637TBM24_TEXT_MAXROWS ;
   private boolean[] BC000W11_n637TBM24_TEXT_MAXROWS ;
   private byte[] BC000W11_A638TBM24_DECIMAL_DIGITS ;
   private boolean[] BC000W11_n638TBM24_DECIMAL_DIGITS ;
   private String[] BC000W11_A639TBM24_TEXT ;
   private boolean[] BC000W11_n639TBM24_TEXT ;
   private String[] BC000W11_A640TBM24_FIXED_VALUE ;
   private boolean[] BC000W11_n640TBM24_FIXED_VALUE ;
   private String[] BC000W11_A641TBM24_CHK_FALSE_INNER_VALUE ;
   private boolean[] BC000W11_n641TBM24_CHK_FALSE_INNER_VALUE ;
   private String[] BC000W11_A706TBM24_REQUIRED_INPUT_FLG ;
   private boolean[] BC000W11_n706TBM24_REQUIRED_INPUT_FLG ;
   private String[] BC000W11_A707TBM24_MIN_VALUE ;
   private boolean[] BC000W11_n707TBM24_MIN_VALUE ;
   private String[] BC000W11_A708TBM24_MAX_VALUE ;
   private boolean[] BC000W11_n708TBM24_MAX_VALUE ;
   private int[] BC000W11_A543TBM24_ORDER ;
   private boolean[] BC000W11_n543TBM24_ORDER ;
   private String[] BC000W11_A544TBM24_DEL_FLG ;
   private boolean[] BC000W11_n544TBM24_DEL_FLG ;
   private String[] BC000W11_A547TBM24_CRT_PROG_NM ;
   private boolean[] BC000W11_n547TBM24_CRT_PROG_NM ;
   private String[] BC000W11_A550TBM24_UPD_PROG_NM ;
   private boolean[] BC000W11_n550TBM24_UPD_PROG_NM ;
   private long[] BC000W11_A64TBM24_STUDY_ID ;
   private long[] BC000W12_A64TBM24_STUDY_ID ;
   private long[] BC000W13_A64TBM24_STUDY_ID ;
...
final  class tbm24_map_item_bc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("BC000W6", "SELECT `TBM21_STUDY_ID` AS TBM24_STUDY_ID FROM `TBM21_STUDY` WHERE `TBM21_STUDY_ID` = ? ",true, GX_NOMASK, false, this,1,0,false )
         ,new ForEachCursor("BC000W7", "SELECT `TBM24_STUDY_ID` AS TBM24_STUDY_ID, `TBM24_DOM_CD`, `TBM24_DOM_VAR_NM`, `TBM24_CRF_ITEM_DIV` FROM `TBM24_MAP_ITEM` WHERE `TBM24_STUDY_ID` = ? AND `TBM24_DOM_CD` = ? AND `TBM24_DOM_VAR_NM` = ? AND `TBM24_CRF_ITEM_DIV` = ? ",true, GX_NOMASK, false, this,1,0,false )
         ,new UpdateCursor("BC000W8", "INSERT INTO `TBM24_MAP_ITEM`(`TBM24_DOM_CD`, `TBM24_DOM_VAR_NM`, `TBM24_CRF_ITEM_DIV`, `TBM24_CRT_DATETIME`, `TBM24_CRT_USER_ID`, `TBM24_UPD_DATETIME`, `TBM24_UPD_USER_ID`, `TBM24_UPD_CNT`, `TBM24_DOM_ITM_GRP_OID`, `TBM24_DOM_ITM_GRP_ATTR_SEQ`, `TBM24_DOM_ITM_GRP_ROWNO`, `TBM24_CRF_ITEM_NM`, `TBM24_IDENTIFICATION_CD`, `TBM24_TEXT_MAXLENGTH`, `TBM24_TEXT_MAXROWS`, `TBM24_DECIMAL_DIGITS`, `TBM24_TEXT`, `TBM24_FIXED_VALUE`, `TBM24_CHK_FALSE_INNER_VALUE`, `TBM24_REQUIRED_INPUT_FLG`, `TBM24_MIN_VALUE`, `TBM24_MAX_VALUE`, `TBM24_ORDER`, `TBM24_DEL_FLG`, `TBM24_CRT_PROG_NM`, `TBM24_UPD_PROG_NM`, `TBM24_STUDY_ID`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", GX_NOMASK)
         ,new UpdateCursor("BC000W9", "UPDATE `TBM24_MAP_ITEM` SET `TBM24_CRT_DATETIME`=?, `TBM24_CRT_USER_ID`=?, `TBM24_UPD_DATETIME`=?, `TBM24_UPD_USER_ID`=?, `TBM24_UPD_CNT`=?, `TBM24_DOM_ITM_GRP_OID`=?, `TBM24_DOM_ITM_GRP_ATTR_SEQ`=?, `TBM24_DOM_ITM_GRP_ROWNO`=?, `TBM24_CRF_ITEM_NM`=?, `TBM24_IDENTIFICATION_CD`=?, `TBM24_TEXT_MAXLENGTH`=?, `TBM24_TEXT_MAXROWS`=?, `TBM24_DECIMAL_DIGITS`=?, `TBM24_TEXT`=?, `TBM24_FIXED_VALUE`=?, `TBM24_CHK_FALSE_INNER_VALUE`=?, `TBM24_REQUIRED_INPUT_FLG`=?, `TBM24_MIN_VALUE`=?, `TBM24_MAX_VALUE`=?, `TBM24_ORDER`=?, `TBM24_DEL_FLG`=?, `TBM24_CRT_PROG_NM`=?, `TBM24_UPD_PROG_NM`=?  WHERE `TBM24_STUDY_ID` = ? AND `TBM24_DOM_CD` = ? AND `TBM24_DOM_VAR_NM` = ? AND `TBM24_CRF_ITEM_DIV` = ?", GX_NOMASK)
         ,new UpdateCursor("BC000W10", "DELETE FROM `TBM24_MAP_ITEM`  WHERE `TBM24_STUDY_ID` = ? AND `TBM24_DOM_CD` = ? AND `TBM24_DOM_VAR_NM` = ? AND `TBM24_CRF_ITEM_DIV` = ?", GX_NOMASK)
         ,new ForEachCursor("BC000W11", "SELECT TM1.`TBM24_DOM_CD`, TM1.`TBM24_DOM_VAR_NM`, TM1.`TBM24_CRF_ITEM_DIV`, TM1.`TBM24_CRT_DATETIME`, TM1.`TBM24_CRT_USER_ID`, TM1.`TBM24_UPD_DATETIME`, TM1.`TBM24_UPD_USER_ID`, TM1.`TBM24_UPD_CNT`, TM1.`TBM24_DOM_ITM_GRP_OID`, TM1.`TBM24_DOM_ITM_GRP_ATTR_SEQ`, TM1.`TBM24_DOM_ITM_GRP_ROWNO`, TM1.`TBM24_CRF_ITEM_NM`, TM1.`TBM24_IDENTIFICATION_CD`, TM1.`TBM24_TEXT_MAXLENGTH`, TM1.`TBM24_TEXT_MAXROWS`, TM1.`TBM24_DECIMAL_DIGITS`, TM1.`TBM24_TEXT`, TM1.`TBM24_FIXED_VALUE`, TM1.`TBM24_CHK_FALSE_INNER_VALUE`, TM1.`TBM24_REQUIRED_INPUT_FLG`, TM1.`TBM24_MIN_VALUE`, TM1.`TBM24_MAX_VALUE`, TM1.`TBM24_ORDER`, TM1.`TBM24_DEL_FLG`, TM1.`TBM24_CRT_PROG_NM`, TM1.`TBM24_UPD_PROG_NM`, TM1.`TBM24_STUDY_ID` AS TBM24_STUDY_ID FROM `TBM24_MAP_ITEM` TM1 WHERE TM1.`TBM24_STUDY_ID` = ? and TM1.`TBM24_DOM_CD` = ? and TM1.`TBM24_DOM_VAR_NM` = ? and TM1.`TBM24_CRF_ITEM_DIV` = ? ORDER BY TM1.`TBM24_STUDY_ID`, TM1.`TBM24_DOM_CD`, TM1.`TBM24_DOM_VAR_NM`, TM1.`TBM24_CRF_ITEM_DIV` ",true, GX_NOMASK, false, this,100,0,false )
         ,new ForEachCursor("BC000W12", "SELECT `TBM21_STUDY_ID` AS TBM24_STUDY_ID FROM `TBM21_STUDY` WHERE `TBM21_STUDY_ID` = ? ",true, GX_NOMASK, false, this,1,0,false )
         ,new ForEachCursor("BC000W13", "SELECT `TBM21_STUDY_ID` AS TBM24_STUDY_ID FROM `TBM21_STUDY` WHERE `TBM21_STUDY_ID` = ? ",true, GX_NOMASK, false, this,1,0,false )
      };
   }
