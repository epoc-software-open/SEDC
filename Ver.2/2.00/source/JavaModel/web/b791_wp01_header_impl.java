...
public final  class b791_wp01_header_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2017731712407");
      if ( GXutil.len( sPrefix) == 0 )
      {
   ...
   public void renderHtmlCloseForm1H2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("b791_wp01_header.js", "?2017731712409");
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317124050");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   {
      httpContext.AddJavascriptSource("b791_wp01_header.js", "?20177317124051");
