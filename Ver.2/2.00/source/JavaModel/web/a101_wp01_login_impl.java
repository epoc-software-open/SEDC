/*
       ...
       Generated on: July 3, 2017 17:16:43.77
...
public final  class a101_wp01_login_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20177317164379");
   ...
   public void S142( )
   {
      ...
      AV23GXLvl162 = (byte)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV23GXLvl162", GXutil.str( AV23GXLvl162, 1, 0));
      /* Using cursor H000C3 */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20177317164434");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("a101_wp01_login.js", "?20177317164434");
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new a101_wp01_login__default(),
         new Object[] {
            ...
            , new Object[] {
            H000C4_A55TAM07_USER_ID, H000C4_A205TAM07_USER_NM, H000C4_n205TAM07_USER_NM, H000C4_A313TAM07_USER_KANA_NM, H000C4_n313TAM07_USER_KANA_NM, H000C4_A56TAM07_AUTH_CD, H000C4_n56TAM07_AUTH_CD
            }
         }
      );
...
final  class a101_wp01_login__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H000C4", "SELECT `TAM07_USER_ID`, `TAM07_USER_NM`, `TAM07_USER_KANA_NM`, `TAM07_AUTH_CD` FROM `TAM07_USER` WHERE `TAM07_USER_ID` = ? ORDER BY `TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
