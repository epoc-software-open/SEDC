...
public final  class aa811_pc01_download_dialog_impl extends GXWebProcedure
{
   ...
   public void webExecute( )
   {
      ...
      if ( GxWebError == 0 )
      {
         ...
         if ( ( GXutil.strcmp(GXutil.right( GXDecQS, 6), com.genexus.util.Encryption.checksum( GXutil.left( GXDecQS, GXutil.len( GXDecQS)-6), 6)) == 0 ) && ( GXutil.strcmp(GXutil.substring( GXDecQS, 1, GXutil.len( "aa811_pc01_download_dialog")), "aa811_pc01_download_dialog") == 0 ) )
         {
            httpContext.setQueryString( GXutil.right( GXutil.left( GXDecQS, GXutil.len( GXDecQS)-6), GXutil.len( GXutil.left( GXDecQS, GXutil.len( GXDecQS)-6))-GXutil.len( "aa811_pc01_download_dialog"))) ;
         }
         else
         {
            GxWebError = (byte)(1) ;
