...
public final  class b710_wp01_login_impl extends GXWebPanel
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2017731718838");
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" class=\"Form\" action=\""+formatLink("b710_wp01_login") +"\">") ;
   ...
   public void wb_table1_2_1G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         wb_table2_56_1G2( true) ;
      }
      else
      {
         wb_table2_56_1G2( false) ;
      }
      return  ;
   }

   public void wb_table2_56_1G2e( boolean wbgen )
   {
      if ( wbgen )
      {
      }
   ...
   public void rf1G2( )
   {
      ...
      if ( (GXutil.strcmp("", httpContext.wjLoc)==0) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A304TAT01_DEL_FLG = H001G2_A304TAT01_DEL_FLG[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A304TAT01_DEL_FLG", A304TAT01_DEL_FLG);
            n304TAT01_DEL_FLG = H001G2_n304TAT01_DEL_FLG[0] ;
            A209TAT01_INFO = H001G2_A209TAT01_INFO[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A209TAT01_INFO", A209TAT01_INFO);
            n209TAT01_INFO = H001G2_n209TAT01_INFO[0] ;
            A880TAT01_INFO_KBN = H001G2_A880TAT01_INFO_KBN[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A880TAT01_INFO_KBN", A880TAT01_INFO_KBN);
            n880TAT01_INFO_KBN = H001G2_n880TAT01_INFO_KBN[0] ;
            A208TAT01_DATE_END = H001G2_A208TAT01_DATE_END[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A208TAT01_DATE_END", localUtil.format(A208TAT01_DATE_END, "9999/99/99"));
            n208TAT01_DATE_END = H001G2_n208TAT01_DATE_END[0] ;
            A207TAT01_DATE_START = H001G2_A207TAT01_DATE_START[0] ;
            n207TAT01_DATE_START = H001G2_n207TAT01_DATE_START[0] ;
            /* Execute user event: e141G2 */
            e141G2 ();
   ...
   private void e141G2( )
   {
      ...
      b710_wp01_login_impl.this.GXt_char1 = GXv_char2[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "A209TAT01_INFO", A209TAT01_INFO);
   ...
   public void e111G2( )
   {
      ...
      if ( GXutil.strcmp(AV16W_ERRFLG, "0") == 0 )
      {
         ...
         if ( (GXutil.strcmp("", AV18W_MSG)==0) )
         {
            ...
            GXKey = context.getSiteKey( ) ;
            GXEncryptionTmp = "b711_wp01_search_study"+GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))) ;
   ...
   public void S142( )
   {
      ...
      AV23GXLvl160 = (byte)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV23GXLvl160", GXutil.str( AV23GXLvl160, 1, 0));
      /* Using cursor H001G3 */
      ...
      {
         A214TAM07_DEL_FLG = H001G3_A214TAM07_DEL_FLG[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A214TAM07_DEL_FLG", A214TAM07_DEL_FLG);
         n214TAM07_DEL_FLG = H001G3_n214TAM07_DEL_FLG[0] ;
         A210TAM07_PWD = H001G3_A210TAM07_PWD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A210TAM07_PWD", A210TAM07_PWD);
         n210TAM07_PWD = H001G3_n210TAM07_PWD[0] ;
         A55TAM07_USER_ID = H001G3_A55TAM07_USER_ID[0] ;
   ...
   public void S152( )
   {
      ...
      {
         A55TAM07_USER_ID = H001G4_A55TAM07_USER_ID[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A55TAM07_USER_ID", A55TAM07_USER_ID);
         A205TAM07_USER_NM = H001G4_A205TAM07_USER_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A205TAM07_USER_NM", A205TAM07_USER_NM);
         n205TAM07_USER_NM = H001G4_n205TAM07_USER_NM[0] ;
         A313TAM07_USER_KANA_NM = H001G4_A313TAM07_USER_KANA_NM[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A313TAM07_USER_KANA_NM", A313TAM07_USER_KANA_NM);
         n313TAM07_USER_KANA_NM = H001G4_n313TAM07_USER_KANA_NM[0] ;
         A56TAM07_AUTH_CD = H001G4_A56TAM07_AUTH_CD[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A56TAM07_AUTH_CD", A56TAM07_AUTH_CD);
         n56TAM07_AUTH_CD = H001G4_n56TAM07_AUTH_CD[0] ;
         A333TAM07_SITE_ID = H001G4_A333TAM07_SITE_ID[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A333TAM07_SITE_ID", A333TAM07_SITE_ID);
         n333TAM07_SITE_ID = H001G4_n333TAM07_SITE_ID[0] ;
         ...
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV14W_A_LOGIN_SDT", AV14W_A_LOGIN_SDT);
         AV14W_A_LOGIN_SDT.setgxTv_SdtA_LOGIN_SDT_Tam07_site_id( A333TAM07_SITE_ID );
         httpContext.ajax_rsp_assign_sdt_attri("", false, "AV14W_A_LOGIN_SDT", AV14W_A_LOGIN_SDT);
         /* Exiting from a For First loop. */
         if (true) break;
      }
      pr_default.close(2);
      GXt_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem3 = new GxObjectCollection() ;
      GXv_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem4[0] = GXt_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem3 ;
      new a801_pc01_sys_config_init(remoteHandle, context).execute( GXv_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem4) ;
      GXt_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem3 = GXv_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem4[0] ;
      AV14W_A_LOGIN_SDT.setgxTv_SdtA_LOGIN_SDT_A801_sys_config( GXt_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem3 );
      httpContext.ajax_rsp_assign_sdt_attri("", false, "AV14W_A_LOGIN_SDT", AV14W_A_LOGIN_SDT);
   ...
   public void wb_table2_56_1G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblTxt_js_event_Internalname, lblTxt_js_event_Caption, "", "", lblTxt_js_event_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(1), "HLP_B710_WP01_LOGIN.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 60,'',false,'" + sGXsfl_40_idx + "',0)\"" ;
         GxWebStd.gx_single_line_edit( httpContext, edtavH_init_flg_Internalname, GXutil.rtrim( AV13H_INIT_FLG), GXutil.rtrim( localUtil.format( AV13H_INIT_FLG, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(60);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavH_init_flg_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "D_FLG", "left", "HLP_B710_WP01_LOGIN.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         httpContext.writeText( "</tbody>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_56_1G2e( true) ;
      }
      else
      {
         wb_table2_56_1G2e( false) ;
      }
   }
   ...
   public void wb_table1_2_1G2( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         wb_table3_5_1G2( true) ;
      }
      else
      {
         wb_table3_5_1G2( false) ;
      }
      return  ;
   }

   public void wb_table3_5_1G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
   ...
   public void wb_table3_5_1G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table4_9_1G2( true) ;
      }
      else
      {
         wb_table4_9_1G2( false) ;
      }
      return  ;
   }

   public void wb_table4_9_1G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table3_5_1G2e( true) ;
      }
      else
      {
         wb_table3_5_1G2e( false) ;
      }
   }

   public void wb_table4_9_1G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         wb_table5_19_1G2( true) ;
      }
      else
      {
         wb_table5_19_1G2( false) ;
      }
      return  ;
   }

   public void wb_table5_19_1G2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
      ...
      if ( wbEnd == 40 )
      {
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table4_9_1G2e( true) ;
      }
      else
      {
         wb_table4_9_1G2e( false) ;
      }
   }

   public void wb_table5_19_1G2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2017731718893");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("b710_wp01_login.js", "?2017731718893");
   ...
   public void sendrow_402( )
   {
      ...
      Grid1Row.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"",""+" style=\"vertical-align:top;height:35px;width:110px\""});
      /* Single line edit */
      ROClassString = "ReadonlyAttributeInfo" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTAT01_DATE_START_Internalname,localUtil.format(A207TAT01_DATE_START, "9999/99/99"),localUtil.format( A207TAT01_DATE_START, "9999/99/99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTAT01_DATE_START_Jsonclick,new Integer(0),"ReadonlyAttributeInfo","font-family:'ＭＳ Ｐゴシック'; font-size:9.0pt; font-weight:normal; font-style:normal;",ROClassString,"",new Integer(1),new Integer(0),new Integer(0),"text","",new Integer(10),"chr",new Integer(1),"row",new Integer(10),new Integer(0),new Integer(0),new Integer(40),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"D_Y4MD","right"});
      if ( Grid1Container.GetWrapped() == 1 )
      {
      ...
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavD_grd_tat01_info_Internalname,GXutil.rtrim( AV10D_GRD_TAT01_INFO),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavD_grd_tat01_info_Jsonclick,new Integer(0),"ReadonlyAttribute","font-family:'ＭＳ Ｐゴシック'; font-size:9.0pt; font-weight:normal; font-style:normal;",ROClassString,"",new Integer(1),new Integer(edtavD_grd_tat01_info_Enabled),new Integer(0),"text","",new Integer(80),"chr",new Integer(1),"row",new Integer(2000),new Integer(0),new Integer(1),new Integer(40),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left"});
      if ( Grid1Container.GetWrapped() == 1 )
      {
         Grid1Container.CloseTag("cell");
      }
   ...
   public void initialize( )
   {
      ...
      Grid1Container = new com.genexus.webpanels.GXWebGrid(context);
      scmdbuf = "" ;
      H001G2_A11TAT01_INFO_NO = new int[1] ;
      H001G2_A304TAT01_DEL_FLG = new String[] {""} ;
      H001G2_n304TAT01_DEL_FLG = new boolean[] {false} ;
      H001G2_A209TAT01_INFO = new String[] {""} ;
      H001G2_n209TAT01_INFO = new boolean[] {false} ;
      H001G2_A880TAT01_INFO_KBN = new String[] {""} ;
      H001G2_n880TAT01_INFO_KBN = new boolean[] {false} ;
      H001G2_A208TAT01_DATE_END = new java.util.Date[] {GXutil.nullDate()} ;
      H001G2_n208TAT01_DATE_END = new boolean[] {false} ;
      H001G2_A207TAT01_DATE_START = new java.util.Date[] {GXutil.nullDate()} ;
      H001G2_n207TAT01_DATE_START = new boolean[] {false} ;
      A304TAT01_DEL_FLG = "" ;
      A880TAT01_INFO_KBN = "" ;
      ...
      GXEncryptionTmp = "" ;
      AV20W_TAM07_PWD = "" ;
      H001G3_A214TAM07_DEL_FLG = new String[] {""} ;
      H001G3_n214TAM07_DEL_FLG = new boolean[] {false} ;
      H001G3_A210TAM07_PWD = new String[] {""} ;
      H001G3_n210TAM07_PWD = new boolean[] {false} ;
      H001G3_A55TAM07_USER_ID = new String[] {""} ;
      A214TAM07_DEL_FLG = "" ;
      A210TAM07_PWD = "" ;
      A55TAM07_USER_ID = "" ;
      GXt_char1 = "" ;
      GXv_char2 = new String [1] ;
      H001G4_A55TAM07_USER_ID = new String[] {""} ;
      H001G4_A205TAM07_USER_NM = new String[] {""} ;
      H001G4_n205TAM07_USER_NM = new boolean[] {false} ;
      H001G4_A313TAM07_USER_KANA_NM = new String[] {""} ;
      H001G4_n313TAM07_USER_KANA_NM = new boolean[] {false} ;
      H001G4_A56TAM07_AUTH_CD = new String[] {""} ;
      H001G4_n56TAM07_AUTH_CD = new boolean[] {false} ;
      H001G4_A333TAM07_SITE_ID = new String[] {""} ;
      H001G4_n333TAM07_SITE_ID = new boolean[] {false} ;
      A205TAM07_USER_NM = "" ;
      A313TAM07_USER_KANA_NM = "" ;
      A56TAM07_AUTH_CD = "" ;
      A333TAM07_SITE_ID = "" ;
      GXt_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem3 = new GxObjectCollection(SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem.class, "A801_SD01_SYS_CONFIG.A801_SD01_SYS_CONFIGItem", "tablet-EDC_GXXEV3U3", remoteHandle);
      GXv_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem4 = new GxObjectCollection [1] ;
      sStyleString = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new b710_wp01_login__default(),
         new Object[] {
             new Object[] {
            H001G2_A11TAT01_INFO_NO, H001G2_A304TAT01_DEL_FLG, H001G2_n304TAT01_DEL_FLG, H001G2_A209TAT01_INFO, H001G2_n209TAT01_INFO, H001G2_A880TAT01_INFO_KBN, H001G2_n880TAT01_INFO_KBN, H001G2_A208TAT01_DATE_END, H001G2_n208TAT01_DATE_END, H001G2_A207TAT01_DATE_START,
            H001G2_n207TAT01_DATE_START
            }
            , new Object[] {
            H001G3_A214TAM07_DEL_FLG, H001G3_n214TAM07_DEL_FLG, H001G3_A210TAM07_PWD, H001G3_n210TAM07_PWD, H001G3_A55TAM07_USER_ID
            }
            , new Object[] {
            H001G4_A55TAM07_USER_ID, H001G4_A205TAM07_USER_NM, H001G4_n205TAM07_USER_NM, H001G4_A313TAM07_USER_KANA_NM, H001G4_n313TAM07_USER_KANA_NM, H001G4_A56TAM07_AUTH_CD, H001G4_n56TAM07_AUTH_CD, H001G4_A333TAM07_SITE_ID, H001G4_n333TAM07_SITE_ID
            }
         }
      );
   ...
   private int[] H001G2_A11TAT01_INFO_NO ;
   private String[] H001G2_A304TAT01_DEL_FLG ;
   private boolean[] H001G2_n304TAT01_DEL_FLG ;
   private String[] H001G2_A209TAT01_INFO ;
   private boolean[] H001G2_n209TAT01_INFO ;
   private String[] H001G2_A880TAT01_INFO_KBN ;
   private boolean[] H001G2_n880TAT01_INFO_KBN ;
   private java.util.Date[] H001G2_A208TAT01_DATE_END ;
   private boolean[] H001G2_n208TAT01_DATE_END ;
   private java.util.Date[] H001G2_A207TAT01_DATE_START ;
   private boolean[] H001G2_n207TAT01_DATE_START ;
   private String[] H001G3_A214TAM07_DEL_FLG ;
   private boolean[] H001G3_n214TAM07_DEL_FLG ;
   private String[] H001G3_A210TAM07_PWD ;
   private boolean[] H001G3_n210TAM07_PWD ;
   private String[] H001G3_A55TAM07_USER_ID ;
   private String[] H001G4_A55TAM07_USER_ID ;
   private String[] H001G4_A205TAM07_USER_NM ;
   private boolean[] H001G4_n205TAM07_USER_NM ;
   private String[] H001G4_A313TAM07_USER_KANA_NM ;
   private boolean[] H001G4_n313TAM07_USER_KANA_NM ;
   private String[] H001G4_A56TAM07_AUTH_CD ;
   private boolean[] H001G4_n56TAM07_AUTH_CD ;
   private String[] H001G4_A333TAM07_SITE_ID ;
   private boolean[] H001G4_n333TAM07_SITE_ID ;
   private com.genexus.webpanels.WebSession AV19W_SESSION ;
   private GxObjectCollection GXt_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem3 ;
   private GxObjectCollection GXv_objcol_SdtA801_SD01_SYS_CONFIG_A801_SD01_SYS_CONFIGItem4[] ;
...
final  class b710_wp01_login__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H001G2", "SELECT `TAT01_INFO_NO`, `TAT01_DEL_FLG`, `TAT01_INFO`, `TAT01_INFO_KBN`, `TAT01_DATE_END`, `TAT01_DATE_START` FROM `TAT01_INFO` WHERE (`TAT01_DATE_START` <= ?) AND (`TAT01_DATE_START` <= ?) AND (`TAT01_DATE_END` >= ? or (`TAT01_DATE_END` = '1000-01-01')) AND (( `TAT01_INFO_KBN` = '1' or `TAT01_INFO_KBN` = '9')) AND (`TAT01_DEL_FLG` = '0') ORDER BY `TAT01_DATE_START` DESC ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H001G3", "SELECT `TAM07_DEL_FLG`, `TAM07_PWD`, `TAM07_USER_ID` FROM `TAM07_USER` WHERE (`TAM07_USER_ID` = ?) AND (`TAM07_PWD` = ?) AND (`TAM07_DEL_FLG` = '0') ORDER BY `TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H001G4", "SELECT `TAM07_USER_ID`, `TAM07_USER_NM`, `TAM07_USER_KANA_NM`, `TAM07_AUTH_CD`, `TAM07_SITE_ID` FROM `TAM07_USER` WHERE `TAM07_USER_ID` = ? ORDER BY `TAM07_USER_ID` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
